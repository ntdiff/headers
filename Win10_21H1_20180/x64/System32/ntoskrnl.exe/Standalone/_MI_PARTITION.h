...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x02d8 */ unsigned __int64 BootSlabPages;
  /* 0x02e0 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x02f0 */ volatile long PageFileTraceIndex;
  /* 0x02f8 */ struct _MI_PAGEFILE_TRACES PageFileTraces[32];
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x2140 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x2180 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x2208 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x2398 */ void* WorkingSetControl;
  /* 0x23a0 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x23b0 */ unsigned long SessionDetachTimeStamp;
  /* 0x23c0 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x35c0 */
