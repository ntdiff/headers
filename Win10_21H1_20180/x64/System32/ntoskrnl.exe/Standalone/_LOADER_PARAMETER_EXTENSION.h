...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  /* 0x0bac */ unsigned long Reserved1;
  ...
  /* 0x0dac */ unsigned long RetpolineReserveSize;
  struct
  {
  ...
  struct
  {
    /* 0x0eb0 */ struct _INSTALLED_MEMORY_RANGE* Ranges;
    /* 0x0eb8 */ unsigned long RangeCount;
    /* 0x0ebc */ long __PADDING__[1];
  } /* size: 0x0010 */ InstalledMemory;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0ec0 */
