...
} EXT_IOMMU_FUNCTION_TABLE_EXTENDED, *PEXT_IOMMU_FUNCTION_TABLE_EXTENDED; /* size: 0x00a8 */
...
typedef struct _REGISTERED_IOMMU
{
  ...
  /* 0x0168 */ unsigned long Flags;
  /* 0x0170 */ struct _LIST_ENTRY PasidTableListHead;
  /* 0x0180 */ struct _IOMMU_PAGE_HANDLING_DATA PageHandling;
  /* 0x01a8 */ unsigned long MaximumDomainIds;
  /* 0x01b0 */ unsigned __int64 DomainIdBitmapLock;
  /* 0x01b8 */ struct _RTL_BITMAP DomainIdBitmap;
  /* 0x01c8 */ unsigned long Capabilities;
  /* 0x01cc */ enum _EXT_IOMMU_KNOWN_IOMMU_TYPE KnownType;
  /* 0x01d0 */ unsigned long PciSegment;
  /* 0x01d4 */ unsigned long PciBus;
  /* 0x01d8 */ struct _PCI_SLOT_NUMBER PciSlot;
  /* 0x01e0 */ union _LARGE_INTEGER MsiAddress;
  /* 0x01e8 */ unsigned __int64 MsiData;
  /* 0x01f0 */ unsigned long MaximumAsids;
  /* 0x01f4 */ unsigned long FaultPacketBytes;
  /* 0x01f8 */ unsigned long Identifier;
