...
typedef struct _MMSECTION_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned int Spare : 1; /* bit position: 30 */
...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0170 */ struct _MMPFN* DanglingExtentPages;
  /* 0x0178 */ struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem;
  /* 0x0198 */ struct _MI_EXTENT_DELETION_WAIT_BLOCK DanglingExtentsDeletionWaitList;
  /* 0x01b8 */ unsigned char FileOnlyMemoryPfnsCreated;
  /* 0x01b9 */ unsigned char DanglingExtentsWorkerActive;
  /* 0x01ba */ unsigned char PurgingExtentsNeedWatchdog;
  /* 0x01c0 */ struct _RTL_AVL_TREE PrototypePtesTree;
  /* 0x01c8 */ volatile long PrototypePtesTreeSpinLock;
  /* 0x01d0 */ struct _EX_PUSH_LOCK RelocateBitmapsLock;
  /* 0x01d8 */ struct _RTL_BITMAP_EX ImageBitMapNative;
  /* 0x01e8 */ unsigned __int64 ImageBiasNative;
  /* 0x01f0 */ struct _MI_DLL_OVERFLOW_AREA OverflowArea;
  /* 0x0210 */ struct _MI_SECTION_WOW_STATE Wow[1];
  /* 0x0250 */ unsigned __int64 ImageBiasWow;
  /* 0x0258 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  /* 0x0268 */ struct _RTL_BITMAP_EX ImageBitMap64Low;
  /* 0x0278 */ unsigned __int64 ImageBias64Low;
  /* 0x0280 */ void* ApiSetSection;
  /* 0x0288 */ void* ApiSetSchema;
  /* 0x0290 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x0298 */ unsigned long LostDataFiles;
  /* 0x029c */ unsigned long LostDataPages;
  /* 0x02a0 */ unsigned long ImageFailureReason;
  /* 0x02a8 */ struct _SECTION* CfgBitMapSection;
  /* 0x02b0 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x02b8 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x02c8 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x02d0 */ unsigned long ImageCfgFailure;
  /* 0x02d4 */ unsigned long RetpolineReservePages;
  /* 0x02d8 */ struct _MDL* RetpolineStubMdl;
  /* 0x02e0 */ struct _RTL_BITMAP_EX KernelRetpolineBitMap;
  /* 0x02f0 */ struct _RTL_RETPOLINE_ROUTINES* RetpolineRoutines;
  /* 0x02f8 */ struct _MMPTE* RetpolineRevertPte;
  /* 0x0300 */ struct _LIST_ENTRY NonRetpolineImageLoadList;
  /* 0x0310 */ unsigned long RetpolineStubPages;
  /* 0x0314 */ long RetpolineBootStatus;
  /* 0x0318 */ unsigned long ImageBreakpointEnabled;
  /* 0x031c */ unsigned long ImageBreakpointChecksum;
  /* 0x0320 */ unsigned long ImageBreakpointSize;
  /* 0x0324 */ volatile long ImageValidationFailed;
  /* 0x0328 */ struct _RTL_AVL_TREE ExtentTree;
  /* 0x0330 */ struct _EX_PUSH_LOCK ExtentTreeLock;
  /* 0x0338 */ unsigned long HotPatchReserveSize;
  /* 0x033c */ long __PADDING__[1];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1530 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1580 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1740 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x1c00 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x1c20 */ struct _MI_PAGELIST_STATE PageLists;
  ...
  /* 0x2400 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x24b0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2580 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x25c0 */ struct _MI_SYSTEM_ZEROING Zeroing;
  /* 0x25e0 */ struct _MI_ENCLAVE_STATE Enclaves;
  /* 0x2628 */ unsigned __int64 Cookie;
  /* 0x2630 */ void* volatile* BootRegistryRuns;
  /* 0x2638 */ volatile long ZeroingDisabled;
  /* 0x263c */ unsigned char FullyInitialized;
  /* 0x263d */ unsigned char SafeBooted;
  /* 0x2640 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x2680 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3340 */
