...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1096 */ char Padding_180[2];
  /* 0x1098 */ unsigned long DirectOidRequestCount;
  /* 0x109c */ long Padding_181;
  ...
  union
  {
    union
    {
      ...
      struct
      {
        /* 0x0008 */ struct _IO_SECURITY_CONTEXT* SecurityContext;
        /* 0x0010 */ unsigned long Options;
        /* 0x000c */ long Padding_210;
        /* 0x0018 */ unsigned short Reserved;
        /* 0x001a */ unsigned short ShareAccess;
        /* 0x0014 */ long Padding_211;
      ...
      struct
      {
        ...
        /* 0x000c */ long Padding_224;
        /* 0x0018 */ unsigned long FsControlCode;
        /* 0x0014 */ long Padding_225;
      ...
      struct
      {
        ...
        /* 0x0010 */ unsigned long InputBufferLength;
        /* 0x000c */ long Padding_228;
        /* 0x0018 */ unsigned long IoControlCode;
        /* 0x0014 */ long Padding_229;
        /* 0x0020 */ void* Type3InputBuffer;
      ...
      struct
      {
        ...
        /* 0x000c */ long Padding_238;
        /* 0x0018 */ union _POWER_STATE State;
        /* 0x0014 */ long Padding_239;
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_279;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_280[2];
...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0060 */ long Padding_360[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_361[12];
...
{
  /* 0x0000 */ long Padding_362[8];
  /* 0x0020 */ unsigned long ItemLength;
  /* 0x0024 */ long Padding_363;
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_454;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_455[2];
...
{
  /* 0x0000 */ long Padding_478[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_479;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_480;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
...
??$MakePoolPtrNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@YA?AV?$unique_ptr@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@U?$KFreePoolNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@@wistd@@K@Z
...
??$ndisCallNextDatapathHandler@$00AEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@ZAEAPEAXAEAPEAU1@AEAKAEAKAEAK@@YAXAEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z0AEAPEAU0@AEAK55@Z
...
??$ndisCallNextDatapathHandler@$02AEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@ZAEAPEAXAEAPEAU1@AEAKAEAKAEAK@@YAXAEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z0AEAPEAU0@AEAK55@Z
??$ndisCallNextDatapathHandler@$0A@AEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@KK@ZAEAPEAXAEAPEAU1@AEAKAEAKAEAK@@YAXAEAPEAXAEAP6AXPEAXPEAU_NET_BUFFER_LIST@@KK@Z0AEAPEAU0@AEAK55@Z
...
??$reset@PEAE@?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@wistd@@@wistd@@QEAAXPEAE@Z
??$swprintf_s@$0CI@@@YAHAEAY0CI@_WPEB_WZZ
??0?$KHashTableBase@$00@Rtl@@QEAA@_K@Z
...
??0NdisStatisticalStopwatch@@QEAA@W4NDIS_GLOBAL_STATISTIC@@@Z
...
??1?$unique_call@P6AXXZ$1?KeLeaveCriticalRegion@@YAXXZ$00@wil@@QEAA@XZ
??1?$unique_ptr@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@U?$KFreePoolNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@@wistd@@QEAA@XZ
??1?$unique_ptr@_WU?$KFreePool@_W@@@wistd@@QEAA@XZ
...
??1NdisStatisticalStopwatch@@QEAA@XZ
...
??3?$KALLOCATOR@$0GHGIEEEO@$00@@SAXPEAX@Z
??3@YAXPEAX@Z
??4?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@QEAAAEAV0@$$QEAV0@@Z
??4NBL_QUEUE_t@@QEAAAEAU0@$$QEAU0@@Z
??B?$unique_ptr@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@U?$KFreePoolNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@@wistd@@QEBA_NXZ
...
?InitializeBase@?$KWaitEventBase@U?$integral_constant@W4_EVENT_TYPE@@$0A@@wistd@@@@IEAAXXZ
...
?NdisBufferLength@@YAKPEAU_MDL@@@Z
?NdisClassifyNblChain2@@YAXPEAU_NET_BUFFER_LIST@@P6A_KPEAX0@Z1PEAUNBL_QUEUE_t@@3@Z
?NdisClassifyNblChainByCancelId@@YAXPEAU_NET_BUFFER_LIST@@PEAXPEAUNBL_QUEUE_t@@2@Z
?NdisGetVersion640Shim@@YAIXZ
?NdisIMInitializeDeviceInstance@@YAHPEAXPEAU_UNICODE_STRING@@@Z
?NdisLastNblInNblChain@@YAPEAU_NET_BUFFER_LIST@@PEAU1@@Z
...
?NdisNumNblsInNblChain@@YAKPEBU_NET_BUFFER_LIST@@@Z
...
?NdisReadEisaSlotInformation@@YAXPEAHPEAXPEAIPEAU_CM_EISA_FUNCTION_INFORMATION@@@Z
?NdisReadEisaSlotInformationEx@@YAXPEAHPEAXPEAIPEAPEAU_CM_EISA_FUNCTION_INFORMATION@@2@Z
?NdisSend@@YAXPEAHPEAXPEAU_NDIS_PACKET@@@Z
?NdisSetJobObjectCompartmentId@@YAJPEAU_EJOB@@I@Z
?NdisSetStatusInNblChain@@YAXPEAU_NET_BUFFER_LIST@@H@Z
...
?enter_critical_region@wil@@YA?AV?$unique_call@P6AXXZ$1?KeLeaveCriticalRegion@@YAXXZ$00@1@XZ
...
?is_valid@?$unique_storage@U?$resource_policy@PEAXP6AJPEAX@Z$1?ZwClose@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEBA_NXZ
...
?ndisAzAllocateSharedMemoryForGenericDriver@@YAHPEAU_NDIS_SHARED_MEMORY_PARAMETERS@@PEAPEAX@Z
?ndisAzDmaInterceptAllocation@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_SHARED_MEMORY_PARAMETERS@@PEAPEAX@Z
...
?ndisMStopPowerSavingsForBindings@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z
...
?ndisNblTrackerCanNblBeTracked@@YA_NPEAU_NET_BUFFER_LIST@@@Z
...
?ndisReadSoftwareHiveRegistry@@_Y2PAGE@@AXPEAX@Z
...
?reset@?$unique_ptr@UKString@Rtl@@U?$default_delete@UKString@Rtl@@@wistd@@@wistd@@QEAAXPEAUKString@Rtl@@@Z
...
?wil_RtlStagingConfig_QueryFeatureState@@YAHPEAUwil_FeatureState@@IHPEAH@Z
...
?wil_details_FeatureStateCache_GetCachedFeatureEnabledState@@YA?ATwil_details_FeatureStateCache@@PEAT1@PEBUwil_details_FeatureDescriptor@@@Z
?wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState@@YA?ATwil_details_FeatureStateCache@@PEAT1@T1@PEBUwil_details_FeatureDescriptor@@@Z
?wil_details_GetCurrentFeatureEnabledState@@YA?ATwil_details_FeatureStateCache@@PEBUwil_details_FeatureDescriptor@@PEAH@Z
