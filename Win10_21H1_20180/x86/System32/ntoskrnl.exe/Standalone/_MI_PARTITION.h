...
{
  /* 0x0000 */ unsigned long Array[16];
} MI_STANDBY_LOOKASIDE, *PMI_STANDBY_LOOKASIDE; /* size: 0x0040 */
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0500 */ struct _MI_STANDBY_LOOKASIDE OldestStandbyPageCache[8];
  /* 0x0700 */ struct _MI_STANDBY_LOOKASIDE NewestStandbyPageCache[8];
  /* 0x0900 */ struct _MI_DECAY_TIMER_LINK DecayClusterTimerHeads[4];
  /* 0x0910 */ unsigned long DecayHand;
  /* 0x0914 */ unsigned char StandbyListDiscard;
  /* 0x0915 */ unsigned char FreeListDiscard;
  /* 0x0916 */ unsigned char PfnBitMapsReady;
  /* 0x0918 */ unsigned __int64 LastDecayHandUpdateTime;
  /* 0x0920 */ struct _MI_LDW_WORK_CONTEXT LastChanceLdwContext;
  /* 0x0940 */ unsigned long AvailableEventsLock;
  /* 0x0944 */ struct _MI_AVAILABLE_PAGE_WAIT_STATES AvailablePageWaitStates[3];
  /* 0x0980 */ volatile unsigned long TransitionPrivatePages;
  /* 0x0984 */ struct _RTL_BITMAP LargePfnBitMap[1];
  /* 0x098c */ struct _MI_FREE_LARGE_PAGE_LIST* LargePageListHeads;
  /* 0x0990 */ unsigned char* MediumPagesOnFreeZeroList;
  /* 0x0994 */ struct _RTL_BITMAP LargePageRebuildCandidates;
  /* 0x099c */ struct _KEVENT LargePageCandidatesExistEvent;
  /* 0x09ac */ unsigned long LowMemoryThreshold;
  /* 0x09b0 */ unsigned long HighMemoryThreshold;
  /* 0x09b8 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[5][2];
  /* 0x0c88 */ struct _RTL_BITMAP SlabPfnBitMap;
  /* 0x0c90 */ long __PADDING__[12];
...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x01ec */ unsigned long BootSlabPages;
  /* 0x01f0 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x0200 */ volatile long PageFileTraceIndex;
  /* 0x0208 */ struct _MI_PAGEFILE_TRACES PageFileTraces[32];
  /* 0x0c08 */ long __PADDING__[14];
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1200 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1224 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1280 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1360 */ void* WorkingSetControl;
  /* 0x1364 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x136c */ unsigned long SessionDetachTimeStamp;
  /* 0x1380 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x1fc0 */
