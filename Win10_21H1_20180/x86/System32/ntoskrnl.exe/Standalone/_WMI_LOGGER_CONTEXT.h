...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  /* 0x02b8 */ struct _RTL_BITMAP HookIdMap;
  /* 0x02c0 */ struct _ETW_STACK_CACHE* StackCache;
  /* 0x02c4 */ struct _ETW_PMC_SUPPORT* PmcData;
  /* 0x02c8 */ struct _ETW_LBR_SUPPORT* LbrData;
  /* 0x02cc */ struct _ETW_IPT_SUPPORT* IptData;
  /* 0x02d0 */ struct _LIST_ENTRY BinaryTrackingList;
  /* 0x02d8 */ struct _WMI_BUFFER_HEADER** ScratchArray;
  /* 0x02dc */ struct _DISALLOWED_GUIDS DisallowedGuids;
  /* 0x02e8 */ __int64 RelativeTimerDueTime;
  /* 0x02f0 */ struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;
  /* 0x02f8 */ struct _EX_TIMER* PeriodicCaptureStateTimer;
  /* 0x02fc */ enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;
  /* 0x0300 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x0304 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x0308 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x0318 */ long CompressionWorkItemState;
  /* 0x031c */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x0320 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x0324 */ void* CompressionWorkspace;
  /* 0x0328 */ long CompressionOn;
  /* 0x032c */ unsigned long CompressionRatioGuess;
  /* 0x0330 */ unsigned long PartialBufferCompressionLevel;
  /* 0x0334 */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x0338 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x033c */ struct _KDPC CompressionDpc;
  /* 0x0360 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0368 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0370 */ union _LARGE_INTEGER BufferCompressDuration;
  /* 0x0378 */ __int64 ReferenceQpcDelta;
  /* 0x0380 */ struct _ETW_EVENT_CALLBACK_CONTEXT* CallbackContext;
  /* 0x0384 */ union _LARGE_INTEGER* LastDroppedTime;
  /* 0x0388 */ union _LARGE_INTEGER* FlushingLastDroppedTime;
  /* 0x0390 */ __int64 FlushingSequenceNumber;
  /* 0x0398 */ struct _ETW_PARTITION_CONTEXT PartitionContext;
  /* 0x039c */ struct _MDL* BufferMdl;
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x03a0 */
