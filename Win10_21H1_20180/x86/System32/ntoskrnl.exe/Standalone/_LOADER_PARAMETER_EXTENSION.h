...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0054 */ unsigned long Unused : 4; /* bit position: 17 */
  ...
  struct
  {
    /* 0x0d50 */ struct _INSTALLED_MEMORY_RANGE* Ranges;
    /* 0x0d54 */ unsigned long RangeCount;
  } /* size: 0x0008 */ InstalledMemory;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0d58 */
