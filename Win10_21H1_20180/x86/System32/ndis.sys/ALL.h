...
typedef struct _DOT11_ASSOCIATION_INFO_EX
{
  ...
  /* 0x010f */ char Padding_9;
  /* 0x0110 */ unsigned short usAssociationID;
  /* 0x0112 */ char Padding_10[2];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_42;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_43[2];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_52;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_53[2];
...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0048 */ long Padding_55[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_56[14];
...
{
  /* 0x0000 */ long Padding_194[4];
  /* 0x0010 */ unsigned char ProtocolId;
  /* 0x0011 */ char Padding_195;
...
?Feature_NdisDatapathVerifier__private_GetCachedFeatureEnabledState@@YG?ATwil_details_FeatureStateCache@@XZ
...
?IsAddressContained@STACK_SEGMENT@@QBE_NK@Z
...
?ndisAzAllocateSharedMemoryForGenericDriver@@YGHPAU_NDIS_SHARED_MEMORY_PARAMETERS@@PAPAX@Z
?ndisAzDmaInterceptAllocation@@YG_NPAU_NDIS_MINIPORT_BLOCK@@PAU_NDIS_SHARED_MEMORY_PARAMETERS@@PAPAX@Z
...
?ndisReadSoftwareHiveRegistry@@_Y2PAGE@@GXPAX@Z
...
?wil_details_FeatureStateCache_GetCachedFeatureEnabledState@@YG?ATwil_details_FeatureStateCache@@PAT1@PBUwil_details_FeatureDescriptor@@@Z
?wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState@@YG?ATwil_details_FeatureStateCache@@PAT1@T1@PBUwil_details_FeatureDescriptor@@@Z
?wil_details_GetCurrentFeatureEnabledState@@YG?ATwil_details_FeatureStateCache@@PBUwil_details_FeatureDescriptor@@PAH@Z
