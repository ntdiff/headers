...
typedef struct _GIC3_DATA
{
  ...
  /* 0x0034 */ unsigned long GsiBase;
  /* 0x0038 */ struct _MAPIC* Madt;
  /* 0x0040 */ unsigned long LocalUnitCount;
  /* 0x0048 */ struct _LIST_ENTRY HalpGic3V2MLines;
  /* 0x0058 */ struct _GIC3_LOCALUNIT_INFO LocalUnitInfo[1];
} GIC3_DATA, *PGIC3_DATA; /* size: 0x00a0 */
