...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0210 */ struct _MI_SECTION_WOW_STATE Wow[2];
  /* 0x0290 */ unsigned __int64 ImageBiasWow;
  /* 0x0298 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  /* 0x02a8 */ void* ApiSetSection;
  /* 0x02b0 */ void* ApiSetSchema;
  /* 0x02b8 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x02c0 */ unsigned long LostDataFiles;
  /* 0x02c4 */ unsigned long LostDataPages;
  /* 0x02c8 */ unsigned long ImageFailureReason;
  /* 0x02d0 */ struct _SECTION* CfgBitMapSection;
  /* 0x02d8 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x02e0 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x02f0 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x02f8 */ unsigned long ImageCfgFailure;
  /* 0x02fc */ unsigned long ImageBreakpointEnabled;
  /* 0x0300 */ unsigned long ImageBreakpointChecksum;
  /* 0x0304 */ unsigned long ImageBreakpointSize;
  /* 0x0308 */ volatile long ImageValidationFailed;
  /* 0x0310 */ struct _RTL_AVL_TREE ExtentTree;
  /* 0x0318 */ struct _EX_PUSH_LOCK ExtentTreeLock;
  /* 0x0320 */ unsigned long HotPatchReserveSize;
  /* 0x0324 */ long __PADDING__[23];
