...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0084 */ unsigned long Unused : 4; /* bit position: 17 */
  ...
  struct
  {
    /* 0x0e68 */ struct _INSTALLED_MEMORY_RANGE* Ranges;
    /* 0x0e70 */ unsigned long RangeCount;
    /* 0x0e74 */ long __PADDING__[1];
  } /* size: 0x0010 */ InstalledMemory;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0e78 */
