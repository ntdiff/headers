...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0c00 */ struct _MI_STANDBY_LOOKASIDE OldestStandbyPageCache[8];
  /* 0x1000 */ struct _MI_STANDBY_LOOKASIDE NewestStandbyPageCache[8];
  /* 0x1400 */ struct _MI_DECAY_TIMER_LINK DecayClusterTimerHeads[4];
  /* 0x1420 */ unsigned long DecayHand;
  /* 0x1424 */ unsigned char StandbyListDiscard;
  /* 0x1425 */ unsigned char FreeListDiscard;
  /* 0x1426 */ unsigned char PfnBitMapsReady;
  /* 0x1428 */ unsigned __int64 LastDecayHandUpdateTime;
  /* 0x1430 */ struct _MI_LDW_WORK_CONTEXT LastChanceLdwContext;
  /* 0x1480 */ unsigned __int64 AvailableEventsLock;
  /* 0x1488 */ struct _MI_AVAILABLE_PAGE_WAIT_STATES AvailablePageWaitStates[3];
  /* 0x1500 */ volatile unsigned __int64 TransitionPrivatePages;
  /* 0x1508 */ struct _RTL_BITMAP_EX LargePfnBitMap[2];
  /* 0x1528 */ struct _MI_FREE_LARGE_PAGE_LIST* LargePageListHeads;
  /* 0x1530 */ unsigned char* MediumPagesOnFreeZeroList;
  /* 0x1538 */ struct _RTL_BITMAP_EX LargePageRebuildCandidates;
  /* 0x1548 */ wchar_t* LargePagesOnFreeZeroList;
  /* 0x1550 */ volatile long HugePageRebuildCandidatesExist;
  /* 0x1558 */ struct _KEVENT LargePageCandidatesExistEvent;
  /* 0x1570 */ unsigned __int64 LowMemoryThreshold;
  /* 0x1578 */ unsigned __int64 HighMemoryThreshold;
  /* 0x1580 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[5][2];
  /* 0x1a30 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x1a40 */ void* HugePfnLists;
  /* 0x1a48 */ unsigned __int64 AvailableHugeIoRanges;
  /* 0x1a50 */ long __PADDING__[12];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x1a80 */
...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x03d8 */ unsigned __int64 BootSlabPages;
  /* 0x03e0 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x03f0 */ volatile long PageFileTraceIndex;
  /* 0x03f8 */ struct _MI_PAGEFILE_TRACES PageFileTraces[32];
  /* 0x12f8 */ long __PADDING__[2];
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x2380 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x23c0 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x2448 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x25d8 */ void* WorkingSetControl;
  /* 0x25e0 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x25f0 */ unsigned long SessionDetachTimeStamp;
  /* 0x2600 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x3900 */
