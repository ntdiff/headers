...
class CAsyncCall
{
  union
  {
    struct
    {
      ...
      /* 0x0188 */ unsigned long _iRefCount;
      /* 0x0190 */ class CChannelObject* _pChnlObj;
      /* 0x0198 */ void* _pRequestBuffer;
      /* 0x01a0 */ unsigned long _lApt;
      /* 0x01a4 */ enum tagAPTKIND _clientAptKind;
      /* 0x01a8 */ struct _RPC_ASYNC_STATE _AsyncState;
      /* 0x0218 */ struct HWND__* _hwndSTA;
      /* 0x0220 */ class CAsyncCall* _pNext;
      /* 0x0228 */ unsigned long _lFlags;
      /* 0x022c */ enum ESignalState _eSignalState;
    }; /* size: 0x00a8 */
