...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      /* 0x0074 */ unsigned long SpareMiscFlag0 : 1; /* bit position: 0 */
      ...
      /* 0x0074 */ unsigned long TimerSuspended : 1; /* bit position: 19 */
      /* 0x0074 */ unsigned long SuspendedWaitMode : 1; /* bit position: 20 */
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0078 */ unsigned long EtwStackTraceApcInserted : 8; /* bit position: 17 */
      /* 0x0078 */ unsigned long ReservedFlags : 7; /* bit position: 25 */
    }; /* bitfield */
...
typedef struct _KPRCB
{
  ...
  /* 0x5b40 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x5b94 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x5be8 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x5ce8 */ unsigned long TimerExpirationTraceCount;
  /* 0x5cec */ long Padding_54[5];
  /* 0x5d00 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x5d08 */ long Padding_55[14];
  /* 0x5d40 */ struct _REQUEST_MAILBOX RequestMailbox[1];
} KPRCB, *PKPRCB; /* size: 0x5d80 */
...
typedef struct _ENODE
{
  ...
  /* 0x0100 */ struct _EX_WORK_QUEUE ExWorkQueue;
  /* 0x03d0 */ struct _KEVENT ExpThreadSetManagerEvent;
  /* 0x03e8 */ struct _KTIMER ExpDeadlockTimer;
  /* 0x0428 */ struct _KEVENT ExpThreadReaperEvent;
  /* 0x0440 */ struct _KWAIT_BLOCK WaitBlocks[3];
  /* 0x04d0 */ struct _ETHREAD* ExpWorkerThreadBalanceManagerPtr;
  /* 0x04d8 */ unsigned long ExpWorkerSeed;
  union
  {
    struct /* bitfield */
    {
      /* 0x04dc */ volatile unsigned long ExWorkerFullInit : 1; /* bit position: 0 */
      /* 0x04dc */ volatile unsigned long ExWorkerStructInit : 1; /* bit position: 1 */
    }; /* bitfield */
    /* 0x04dc */ volatile unsigned long ExWorkerFlags;
  }; /* size: 0x0004 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x04d0 */ volatile unsigned __int64 CommitCharge;
  /* 0x04d8 */ struct _MMSUPPORT Vm;
  ...
  /* 0x06b8 */ unsigned __int64 DeepFreezeStartTime;
  /* 0x06c0 */ unsigned __int64 CommitChargeLimit;
  /* 0x06c8 */ volatile unsigned __int64 CommitChargePeak;
  /* 0x06d0 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x06d4 */ long __PADDING__[1];
} EPROCESS, *PEPROCESS; /* size: 0x06d8 */
...
LdrpIncrementNodeDependencyCount
...
RtlpSetProtectedPolicy
RtlpSetProtectedPolicyStub
