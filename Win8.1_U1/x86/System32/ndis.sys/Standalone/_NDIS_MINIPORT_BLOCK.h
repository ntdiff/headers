...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  union
  {
    /* 0x0018 */ volatile long PcwDatapathEventMask;
  ...
  union
  {
    /* 0x0028 */ volatile long PcwDatapathCycleMask;
  ...
  /* 0x0354 */ struct _IRP* pIrpWaitWake;
  /* 0x0358 */ enum _SYSTEM_POWER_STATE WaitWakeSystemState;
  /* 0x0360 */ union _LARGE_INTEGER VcIndex;
  /* 0x0368 */ unsigned long VcCountLock;
  /* 0x036c */ struct _LIST_ENTRY WmiEnabledVcs;
  /* 0x0374 */ struct _NDIS_GUID* pNdisGuidMap;
  /* 0x0378 */ struct _NDIS_GUID* pCustomGuidMap;
  /* 0x037c */ unsigned short VcCount;
  /* 0x037e */ unsigned short cNdisGuidMap;
  /* 0x0380 */ unsigned short cCustomGuidMap;
  /* 0x0388 */ struct _NDIS_TIMER MediaDisconnectTimer;
  /* 0x03d0 */ enum _NDIS_PNP_DEVICE_STATE PnPDeviceState;
  /* 0x03d4 */ enum _NDIS_PNP_DEVICE_STATE OldPnPDeviceState;
  /* 0x03d8 */ struct _KDPC DeferredDpc;
  /* 0x03f8 */ union _LARGE_INTEGER StartTicks;
  /* 0x0400 */ struct _NDIS_PACKET** IndicatedPacket;
  /* 0x0404 */ struct _KEVENT* RemoveReadyEvent;
  /* 0x0408 */ struct _KEVENT* AllRequestsCompletedEvent;
  /* 0x040c */ unsigned long InitTimeMs;
  /* 0x0410 */ struct _NDIS_MINIPORT_WORK_ITEM WorkItemBuffer[6];
  /* 0x0458 */ struct _OID_LIST* OidList;
  /* 0x045c */ unsigned short InternalResetCount;
  /* 0x045e */ unsigned short MiniportResetCount;
  /* 0x0460 */ unsigned short MediaSenseConnectCount;
  /* 0x0462 */ unsigned short MediaSenseDisconnectCount;
  /* 0x0464 */ struct _NDIS_PACKET** xPackets;
  /* 0x0468 */ unsigned long UserModeOpenReferences;
  /* 0x046c */ void* WSendPacketsHandler /* function */;
  /* 0x0470 */ unsigned long MiniportAttributes;
  /* 0x0474 */ unsigned short NumOpens;
  /* 0x0476 */ unsigned short CFHangXTicks;
  /* 0x0478 */ unsigned long RequestCount;
  /* 0x047c */ unsigned long IndicatedPacketsCount;
  /* 0x0480 */ enum _NDIS_PHYSICAL_MEDIUM PhysicalMediumType;
  /* 0x0484 */ enum _NDIS_MEDIUM MiniportMediaType;
  /* 0x0488 */ struct _NDIS_REQUEST* LastRequest;
  /* 0x048c */ void* FakeMac;
  /* 0x0490 */ unsigned long LockDbg;
  /* 0x0494 */ unsigned long LockDbgX;
  /* 0x0498 */ void* LockThread;
  /* 0x049c */ unsigned long InfoFlags;
  /* 0x04a0 */ unsigned long TimerQueueLock;
  /* 0x04a4 */ struct _KEVENT* ResetCompletedEvent;
  /* 0x04a8 */ void* SavedPacketIndicateHandler /* function */;
  /* 0x04ac */ long RegisteredInterrupts;
  /* 0x04b0 */ unsigned long SetOid;
  /* 0x04b4 */ struct _KEVENT CFHCompletedEvent;
  /* 0x04c4 */ struct _WORK_QUEUE_ITEM CFHWorkItem;
  /* 0x04d4 */ volatile long CFHWorkItemQueued;
  /* 0x04d8 */ void* DeviceContext;
  /* 0x04dc */ struct _NDIS_MINIPORT_RSS_PARAMETERS_CACHE* RssParametersBuffer;
  /* 0x04e0 */ unsigned char UsingMSIX;
  /* 0x04e1 */ unsigned char Miniport5InNdis6Mode;
  /* 0x04e2 */ unsigned char Miniport5HasNdis6Component;
  /* 0x04e3 */ unsigned char InitMode;
  /* 0x04e4 */ unsigned char InitModeNotNeededAnymore;
  /* 0x04e5 */ char MediaChangeFilters;
  /* 0x04e6 */ unsigned char CheckPacketFilters;
  /* 0x04e7 */ unsigned char ReceiveFilters;
  /* 0x04e8 */ unsigned long RecvLock;
  /* 0x04ec */ enum _NDIS_MINIPORT_STATE RecvState;
  /* 0x04f0 */ unsigned long OutstandingReceives;
  /* 0x04f4 */ void* MiniportRecvLockThread;
  /* 0x04f8 */ unsigned long RecvLockDbg;
  /* 0x04fc */ void* NextSendPacketsHandler /* function */;
  /* 0x0500 */ void* FinalSendPacketsHandler /* function */;
  /* 0x0504 */ struct _NDIS_FILTER_BLOCK* LowestFilter;
  /* 0x0508 */ struct _NDIS_FILTER_BLOCK* HighestFilter;
  /* 0x050c */ void* ShutdownContext;
  /* 0x0510 */ void* ShutdownHandler /* function */;
  /* 0x0514 */ struct _KBUGCHECK_CALLBACK_RECORD BugcheckCallbackRecord;
  /* 0x0534 */ void* TopIndicateNetBufferListsHandler /* function */;
  /* 0x0538 */ void* TopIndicateLoopbackNetBufferListsHandler /* function */;
  /* 0x053c */ void* Ndis5PacketIndicateHandler /* function */;
  /* 0x0540 */ void* MiniportReturnPacketHandler /* function */;
  /* 0x0544 */ void* MiniportReturnPacketContext;
  /* 0x0548 */ void* SynchronousReturnPacketHandler /* function */;
  /* 0x054c */ void* SynchronousReturnPacketContext;
  /* 0x0550 */ struct _LIST_ENTRY OidRequestList;
  /* 0x0558 */ struct _NDIS_OID_REQUEST* PendingOidRequest;
  /* 0x055c */ struct _NDIS_OID_REQUEST* ProcessedOidRequest;
  /* 0x0560 */ void* NextCoOidRequestHandle;
  /* 0x0564 */ unsigned long Ndis6ProtocolsBound;
  /* 0x0568 */ unsigned long PmodeOpen6;
  /* 0x056c */ enum _NDIS_MINIPORT_STATE State;
  /* 0x0570 */ struct _KEVENT* AsyncOpCompletionEvent;
  /* 0x0574 */ int AsyncOpCompletionStatus;
  /* 0x0578 */ unsigned __int64 MaxXmitLinkSpeed;
  /* 0x0580 */ unsigned __int64 MaxRcvLinkSpeed;
  /* 0x0588 */ unsigned long SupportedPacketFilters;
  /* 0x058c */ struct _NDIS_MINIPORT_HANDLERS NoFilter;
  /* 0x05e8 */ struct _NDIS_MINIPORT_HANDLERS Next;
  /* 0x0644 */ unsigned char ReceivePathEnabled;
  /* 0x0645 */ unsigned char NormalTopReceive;
  /* 0x0648 */ enum _NDIS_SEND_PATH_TYPE SendPathType;
  /* 0x064c */ enum _NDIS_SEND_PATH_TYPE SavedSendPathType;
  /* 0x0650 */ unsigned char SavedReceivePathEnabled;
  /* 0x0654 */ unsigned long FilterPnPFlags;
  /* 0x0658 */ unsigned long SupportedStatistics;
  /* 0x065c */ unsigned long cDpcSendCompletes;
  /* 0x0660 */ unsigned long cDpcRcvIndications;
  /* 0x0664 */ unsigned long cDpcRcvIndicationCalls;
  /* 0x0668 */ unsigned long cDpcNbSendCompletes;
  /* 0x066c */ unsigned long cDpcNblSendCompletes;
  /* 0x0670 */ unsigned long cDpcNblIndications;
  /* 0x0674 */ unsigned long cDpcMaxPacketsIndicated;
  /* 0x0678 */ unsigned long cDpcTotalDpcCount;
  /* 0x067c */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x0690 */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x0694 */ struct _LIST_ENTRY PortList;
  /* 0x069c */ unsigned char* AllocatedPortIndices;
  /* 0x06a0 */ unsigned long AllocatedPortIndicesLength;
  /* 0x06a4 */ unsigned long NumberOfPorts;
  /* 0x06a8 */ unsigned long NumberOfActivePorts;
  ...
  /* 0x0a3c */ struct _REENUMERATE_SELF_INTERFACE_STANDARD* ReenumerateSelfInterface;
  ...
  /* 0x0a6c */ unsigned char RssEnable;
  /* 0x0a6d */ unsigned char ChimneyEnable;
  /* 0x0a70 */ unsigned long PhysicalMediumInInf;
  /* 0x0a74 */ struct _UNICODE_STRING ExportName;
  /* 0x0a7c */ struct _UNICODE_STRING FilterClass;
  /* 0x0a84 */ void* StatusProcessingThread;
  /* 0x0a88 */ unsigned long StatusProcessingDbgX;
  /* 0x0a8c */ struct _UNICODE_STRING FdoName;
  /* 0x0a94 */ struct _KEVENT PowerD0CompleteEvent;
  /* 0x0aa4 */ long LastD0CompleteStatus;
  /* 0x0aa8 */ enum _NDIS_MINIPORT_EVENT LastD0Reason;
  /* 0x0aac */ unsigned long DirectOidRequestCount;
  /* 0x0ab0 */ struct _KEVENT* AllDirectRequestsCompletedEvent;
  /* 0x0ab4 */ struct _NDIS_HD_SPLIT_CURRENT_CONFIG* HDSplitCurrentConfig;
  /* 0x0ab8 */ void* MSIXConfigContext;
  /* 0x0abc */ void* SetMSIXTableEntry /* function */;
  /* 0x0ac0 */ void* MaskMSIXTableEntry /* function */;
  /* 0x0ac4 */ void* UnmaskMSIXTableEntry /* function */;
  /* 0x0ac8 */ struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;
  /* 0x0ad8 */ struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;
  /* 0x0ae8 */ struct _NDIS_RECEIVE_QUEUE_BLOCK* DefaultReceiveQueue;
  /* 0x0aec */ unsigned long MaxNumRssProcessors;
  /* 0x0af0 */ struct _PROCESSOR_NUMBER RssBaseProcessor;
  /* 0x0af4 */ struct _PROCESSOR_NUMBER RssMaxProcessor;
  /* 0x0af8 */ enum _NDIS_RSS_PROFILE RssProfile;
  /* 0x0afc */ unsigned short NumaNodeId;
  /* 0x0b00 */ unsigned short* NumaDistances;
  /* 0x0b04 */ struct _UNICODE_STRING* pModifiedInstanceName;
  /* 0x0b08 */ unsigned long SyncFlags;
  /* 0x0b0c */ unsigned long WSyncFlags;
  /* 0x0b10 */ unsigned long InterlockedFlags;
  /* 0x0b14 */ struct _ULONG_REFERENCE Ref;
  /* 0x0b20 */ struct _NDIS_SELECTIVE_SUSPEND* SelectiveSuspend;
  /* 0x0b24 */ struct _NDIS_MINIPORT_AOAC* AoAc;
  /* 0x0b28 */ enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;
  /* 0x0b2c */ struct NDIS_EVENT_LOG_HANDLE__* PnpEventLog;
  /* 0x0b30 */ struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;
  /* 0x0b60 */ struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS* PhysicalPerformanceCounters;
  /* 0x0b68 */ union _LARGE_INTEGER TimeOfInitialization;
  /* 0x0b70 */ union _LARGE_INTEGER LastSystemSleepTime;
  /* 0x0b78 */ unsigned __int64 TotalSystemSleepTimeMs;
  /* 0x0b80 */ struct _NDIS_SRIOV_CAPABILITIES* SriovHwCapabilities;
  /* 0x0b84 */ struct _NDIS_SRIOV_CAPABILITIES* SriovCurrentCapabilities;
  /* 0x0b88 */ unsigned __int64 InvalidateBlockMask;
  /* 0x0b90 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x0b94 */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x0b98 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x0ba0 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x0bb0 */ unsigned short InvalidateVfId;
  /* 0x0bb2 */ unsigned char InvalidateBlockCancelling;
  /* 0x0bb4 */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x0bb8 */ unsigned long NumSwitches;
  /* 0x0bbc */ struct _LIST_ENTRY NicSwitchList;
  /* 0x0bc4 */ unsigned long NumAllocatedVFs;
  /* 0x0bc8 */ struct _LIST_ENTRY VFList;
  /* 0x0bd0 */ unsigned long NumActiveVPorts;
  /* 0x0bd4 */ struct _LIST_ENTRY VPortList;
  /* 0x0bdc */ unsigned char* AllocatedVPortIndices;
  /* 0x0be0 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x0be4 */ void* SetVirtualFunctionData /* function */;
  /* 0x0be8 */ void* GetVirtualFunctionData /* function */;
  /* 0x0bec */ void* EnableVirtualization /* function */;
  /* 0x0bf0 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x0bf4 */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x0bf8 */ void* VirtInterfaceContext;
  /* 0x0bfc */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x0c04 */ void* VpciInterfaceDereference /* function */;
  /* 0x0c08 */ void* WriteVfConfigBlock /* function */;
  /* 0x0c0c */ void* ReadVfConfigBlock /* function */;
  /* 0x0c10 */ void* VpciInterfaceContext;
  /* 0x0c14 */ unsigned int VfSerialNumber;
  /* 0x0c18 */ struct _LUID SriovLuid;
  /* 0x0c20 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x0c24 */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x0c28 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x0c2c */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x0c30 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x0c34 */ unsigned long QosOperationalParametersBufferSize;
  /* 0x0c38 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x0c3c */ unsigned long QosRemoteParametersBufferSize;
  /* 0x0c40 */ unsigned __int64 DeviceFlags;
  /* 0x0c48 */ void* VerifierContext;
  /* 0x0c4c */ struct _WORK_QUEUE_ITEM SurpriseRemovalWorkItem;
  /* 0x0c5c */ struct Ndis::BindStack Bindings;
  /* 0x0cb8 */ struct Ndis::BindEngine BindEngine;
  /* 0x0d04 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x0d1c */ BOOL PmInterruptedByPnp;
  /* 0x0d1d */ BOOL DoNotBlockOnMiniportLock;
  /* 0x0d1e */ char __PADDING__[2];
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x0d20 */
