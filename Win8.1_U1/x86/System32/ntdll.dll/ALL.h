...
typedef struct _ENODE
{
  ...
  /* 0x00c0 */ struct _EX_WORK_QUEUE* volatile ExWorkQueues[8];
  ...
  /* 0x02e0 */ struct _KWAIT_BLOCK WaitBlocks[3];
  ...
  union
  {
    struct /* bitfield */
    {
      /* 0x0330 */ volatile unsigned long ExWorkerFullInit : 1; /* bit position: 0 */
      /* 0x0330 */ volatile unsigned long ExWorkerStructInit : 1; /* bit position: 1 */
    }; /* bitfield */
...
typedef struct _KINTERRUPT
{
  ...
  /* 0x005c */ long Padding_50;
  /* 0x0060 */ struct _ISRDPCSTATS IsrDpcStats;
  /* 0x00a0 */ struct _INTERRUPT_CONNECTION_DATA* ConnectionData;
  /* 0x00a4 */ long __PADDING__[1];
} KINTERRUPT, *PKINTERRUPT; /* size: 0x00a8 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x01e8 */ volatile unsigned long CommitCharge;
  /* 0x01ec */ struct _MMSUPPORT Vm;
  ...
  /* 0x02f4 */ long Padding_61;
  /* 0x02f8 */ unsigned __int64 DeepFreezeStartTime;
  /* 0x0300 */ unsigned long CommitChargeLimit;
  /* 0x0304 */ volatile unsigned long CommitChargePeak;
  /* 0x0308 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x030c */ long __PADDING__[1];
} EPROCESS, *PEPROCESS; /* size: 0x0310 */
...
typedef struct _EJOB
{
  ...
  /* 0x01a4 */ long Padding_64;
  union
  {
    /* 0x01a8 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x01a8 */ struct _PS_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0038 */
  /* 0x01e0 */ struct _JOBOBJECT_WAKE_FILTER WakeFilter;
  /* 0x01e8 */ unsigned long LowEdgeLatchFilter;
  /* 0x01ec */ unsigned long OwnedHighEdgeFilters;
  /* 0x01f0 */ struct _EJOB* NotificationLink;
  /* 0x01f4 */ long Padding_65;
  /* 0x01f8 */ unsigned __int64 CurrentJobMemoryUsed;
  /* 0x0200 */ struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
  /* 0x0204 */ void* NotificationInfoQuotaReference;
  /* 0x0208 */ struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
  /* 0x020c */ struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
  /* 0x0210 */ void* EffectiveSchedulingGroup;
  /* 0x0214 */ long Padding_66;
  /* 0x0218 */ unsigned __int64 ReadyTime;
  /* 0x0220 */ struct _EX_PUSH_LOCK MemoryLimitsLock;
  /* 0x0224 */ struct _LIST_ENTRY SiblingJobLinks;
  /* 0x022c */ struct _LIST_ENTRY ChildJobListHead;
  /* 0x0234 */ struct _EJOB* ParentJob;
  /* 0x0238 */ struct _EJOB* volatile RootJob;
  /* 0x023c */ struct _LIST_ENTRY IteratorListHead;
  /* 0x0244 */ unsigned long AncestorCount;
  /* 0x0248 */ struct _EJOB** Ancestors;
  /* 0x024c */ long Padding_67;
  /* 0x0250 */ struct _EPROCESS_VALUES Accounting;
  /* 0x02a0 */ unsigned long ShadowActiveProcessCount;
  /* 0x02a4 */ unsigned long SequenceNumber;
  /* 0x02a8 */ unsigned long TimerListLock;
  /* 0x02ac */ struct _LIST_ENTRY TimerListHead;
  union
  {
    /* 0x02b4 */ unsigned long JobFlags;
    struct /* bitfield */
    {
      /* 0x02b4 */ unsigned long CloseDone : 1; /* bit position: 0 */
      /* 0x02b4 */ unsigned long MultiGroup : 1; /* bit position: 1 */
      /* 0x02b4 */ unsigned long OutstandingNotification : 1; /* bit position: 2 */
      /* 0x02b4 */ unsigned long NotificationInProgress : 1; /* bit position: 3 */
      /* 0x02b4 */ unsigned long UILimits : 1; /* bit position: 4 */
      /* 0x02b4 */ unsigned long CpuRateControlActive : 1; /* bit position: 5 */
      /* 0x02b4 */ unsigned long OwnCpuRateControl : 1; /* bit position: 6 */
      /* 0x02b4 */ unsigned long Terminating : 1; /* bit position: 7 */
      /* 0x02b4 */ unsigned long WorkingSetLock : 1; /* bit position: 8 */
      /* 0x02b4 */ unsigned long JobFrozen : 1; /* bit position: 9 */
      /* 0x02b4 */ unsigned long Background : 1; /* bit position: 10 */
      /* 0x02b4 */ unsigned long WakeNotificationAllocated : 1; /* bit position: 11 */
      /* 0x02b4 */ unsigned long WakeNotificationEnabled : 1; /* bit position: 12 */
      /* 0x02b4 */ unsigned long WakeNotificationPending : 1; /* bit position: 13 */
      /* 0x02b4 */ unsigned long LimitNotificationRequired : 1; /* bit position: 14 */
      /* 0x02b4 */ unsigned long ZeroCountNotificationRequired : 1; /* bit position: 15 */
      /* 0x02b4 */ unsigned long CycleTimeNotificationRequired : 1; /* bit position: 16 */
      /* 0x02b4 */ unsigned long CycleTimeNotificationPending : 1; /* bit position: 17 */
      /* 0x02b4 */ unsigned long TimersVirtualized : 1; /* bit position: 18 */
      /* 0x02b4 */ unsigned long JobSwapped : 1; /* bit position: 19 */
      /* 0x02b4 */ unsigned long ViolationDetected : 1; /* bit position: 20 */
      /* 0x02b4 */ unsigned long EmptyJobNotified : 1; /* bit position: 21 */
      /* 0x02b4 */ unsigned long NoSystemCharge : 1; /* bit position: 22 */
      /* 0x02b4 */ unsigned long DropNoWakeCharges : 1; /* bit position: 23 */
      /* 0x02b4 */ unsigned long NoWakeChargePolicyDecided : 1; /* bit position: 24 */
      /* 0x02b4 */ unsigned long SpareJobFlags : 7; /* bit position: 25 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02b8 */ unsigned long EffectiveHighEdgeFilters;
  /* 0x02bc */ long __PADDING__[1];
} EJOB, *PEJOB; /* size: 0x02c0 */
...
typedef struct _DEVOBJ_EXTENSION
{
  ...
  /* 0x0030 */ void* VerifierContext;
} DEVOBJ_EXTENSION, *PDEVOBJ_EXTENSION; /* size: 0x0034 */
...
_LdrpInsertDependencyRecord@12
...
_WinSqmStartSessionInternal@16
