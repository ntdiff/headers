...
class ActivationPropertiesOut::OutSerializer
{
  ...
  /* 0x0020 */ void** _ppvObj;
  /* 0x0024 */ unsigned long _size;
  /* 0x0028 */ struct tagCOMVERSION* _pClientCOMVersion;
  /* 0x002c */ struct _GUID _pIIDs[10];
  /* 0x00cc */ struct IUnknown* _pObject;
  /* 0x00d0 */ int _fBrokenRefCount;
  /* 0x00d4 */ int _fLockedClassFactory;
}; /* size: 0x00d8 */
