...
class CDllHost
{
  ...
  /* 0x001c */ volatile unsigned long _hCOMActivator;
  /* 0x0020 */ volatile unsigned long _hWinRTActivator;
  /* 0x0024 */ unsigned long _dwTid;
  /* 0x0028 */ HRESULT _hrMarshal;
  /* 0x002c */ void* _hEvent;
  /* 0x0030 */ void* _hEventWakeUp;
  /* 0x0034 */ HRESULT _hr;
