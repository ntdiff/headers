...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0d68 */ struct _MMWSLE* Wsle;
  /* 0x0d6c */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  ...
  /* 0x1f90 */ struct _FAST_MUTEX SessionPteLock;
  /* 0x1fb0 */ long PoolBigEntriesInUse;
  /* 0x1fb4 */ unsigned long PagedPoolPdeCount;
  /* 0x1fb8 */ unsigned long SpecialPoolPdeCount;
  /* 0x1fbc */ unsigned long DynamicSessionPdeCount;
  /* 0x1fc0 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1ff8 */ void* PoolTrackTableExpansion;
  /* 0x1ffc */ unsigned long PoolTrackTableExpansionSize;
  /* 0x2000 */ void* PoolTrackBigPages;
  /* 0x2004 */ unsigned long PoolTrackBigPagesSize;
  /* 0x2008 */ enum _IO_SESSION_STATE IoState;
  /* 0x200c */ unsigned long IoStateSequence;
  /* 0x2010 */ struct _KEVENT IoNotificationEvent;
  /* 0x2020 */ long __PADDING__[8];
} MM_SESSION_SPACE, *PMM_SESSION_SPACE; /* size: 0x2040 */
