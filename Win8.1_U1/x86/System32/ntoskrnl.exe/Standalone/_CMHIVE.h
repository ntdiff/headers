...
typedef struct _HHIVE
{
  ...
  /* 0x006c */ unsigned long LogFileSizeCap;
  /* 0x0070 */ unsigned char LogDataPresent[2];
  /* 0x0072 */ unsigned char PrimaryFileValid;
  /* 0x0073 */ unsigned char BaseBlockDirty;
  union
  {
    struct /* bitfield */
    {
      /* 0x0074 */ unsigned short FirstLogFile : 3; /* bit position: 0 */
      /* 0x0074 */ unsigned short SecondLogFile : 3; /* bit position: 3 */
      /* 0x0074 */ unsigned short HeaderRecovered : 1; /* bit position: 6 */
      /* 0x0074 */ unsigned short LegacyRecoveryIndicated : 1; /* bit position: 7 */
      /* 0x0074 */ unsigned short RecoveryInformationReserved : 8; /* bit position: 8 */
    }; /* bitfield */
    /* 0x0074 */ unsigned short RecoveryInformation;
  }; /* size: 0x0002 */
  /* 0x0076 */ unsigned char LogEntriesRecovered[2];
  /* 0x0078 */ unsigned long RefreshCount;
  /* 0x007c */ unsigned long StorageTypeCount;
  /* 0x0080 */ unsigned long Version;
  /* 0x0084 */ struct _DUAL Storage[2];
} HHIVE, *PHHIVE; /* size: 0x03bc */
...
typedef struct _CMHIVE
{
  ...
  /* 0x03bc */ void* FileHandles[6];
  /* 0x03d4 */ struct _LIST_ENTRY NotifyList;
  /* 0x03dc */ struct _LIST_ENTRY HiveList;
  /* 0x03e4 */ struct _LIST_ENTRY PreloadedHiveList;
  /* 0x03ec */ struct _EX_RUNDOWN_REF HiveRundown;
  /* 0x03f0 */ struct _LIST_ENTRY ParseCacheEntries;
  /* 0x03f8 */ struct _CM_KEY_HASH_TABLE_ENTRY* KcbCacheTable;
  /* 0x03fc */ unsigned long KcbCacheTableSize;
  /* 0x0400 */ struct _CM_KEY_HASH_TABLE_ENTRY* DeletedKcbTable;
  /* 0x0404 */ unsigned long DeletedKcbTableSize;
  /* 0x0408 */ unsigned long Identity;
  /* 0x040c */ struct _FAST_MUTEX* HiveLock;
  /* 0x0410 */ struct _FAST_MUTEX* WriterLock;
  /* 0x0414 */ struct _ERESOURCE* FlusherLock;
  /* 0x0418 */ struct _RTL_BITMAP FlushDirtyVector;
  /* 0x0420 */ unsigned long FlushDirtyVectorSize;
  /* 0x0424 */ unsigned char* FlushLogEntry;
  /* 0x0428 */ unsigned long FlushLogEntrySize;
  /* 0x042c */ unsigned long FlushHiveTruncated;
  /* 0x0430 */ unsigned char FlushBaseBlockDirty;
  /* 0x0434 */ struct _RTL_BITMAP CapturedUnreconciledVector;
  /* 0x043c */ unsigned long CapturedUnreconciledVectorSize;
  /* 0x0440 */ struct CMP_OFFSET_ARRAY* UnreconciledOffsetArray;
  /* 0x0444 */ unsigned long UnreconciledOffsetArrayCount;
  /* 0x0448 */ struct _HBASE_BLOCK* UnreconciledBaseBlock;
  /* 0x044c */ struct _EX_PUSH_LOCK SecurityLock;
  /* 0x0450 */ unsigned long UseCount;
  /* 0x0454 */ unsigned long LastShrinkHiveSize;
