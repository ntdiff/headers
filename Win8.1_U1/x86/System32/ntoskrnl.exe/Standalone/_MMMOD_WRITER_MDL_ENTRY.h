...
typedef struct _MMMOD_WRITER_MDL_ENTRY
{
  ...
  /* 0x0050 */ struct _MMPAGING_FILE* PagingFile;
  /* 0x0054 */ struct _FILE_OBJECT* File;
  /* 0x0058 */ struct _CONTROL_AREA* ControlArea;
  /* 0x005c */ struct _ERESOURCE* FileResource;
  /* 0x0060 */ union _LARGE_INTEGER WriteOffset;
  /* 0x0068 */ union _LARGE_INTEGER IssueTime;
  /* 0x0070 */ struct _MDL* PointerMdl;
  /* 0x0074 */ struct _MDL Mdl;
  /* 0x0090 */ unsigned long Page[1];
  /* 0x0094 */ long __PADDING__[1];
} MMMOD_WRITER_MDL_ENTRY, *PMMMOD_WRITER_MDL_ENTRY; /* size: 0x0098 */
