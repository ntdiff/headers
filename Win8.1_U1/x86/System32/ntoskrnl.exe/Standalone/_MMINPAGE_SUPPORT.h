...
typedef struct _MMINPAGE_FLAGS
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0003 */ unsigned char CoalescedIo : 1; /* bit position: 7 */
  }; /* bitfield */
...
typedef struct _MMINPAGE_SUPPORT
{
  ...
  /* 0x0040 */ struct _MMPTE PteContents;
  /* 0x0048 */ struct _ETHREAD* Thread;
  /* 0x004c */ struct _MMPFN* LockedProtoPfn;
  /* 0x0050 */ volatile long WaitCount;
  /* 0x0054 */ unsigned long ByteCount;
  union // _TAG_UNNAMED_21
  {
    union
    {
      /* 0x0058 */ unsigned long ImagePteOffset;
      /* 0x0058 */ unsigned long TossPage;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u3;
  union // _TAG_UNNAMED_22
  {
    union
    {
      /* 0x005c */ struct _MMINPAGE_FLAGS e1;
      /* 0x005c */ unsigned long LongFlags;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u1;
  /* 0x0060 */ struct _FILE_OBJECT* FilePointer;
  /* 0x0064 */ struct _CONTROL_AREA* ControlArea;
  /* 0x0068 */ void* Autoboost;
