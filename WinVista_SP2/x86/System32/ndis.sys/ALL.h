...
typedef struct _NDIS_IF_BLOCK
{
  ...
  /* 0x0024 */ unsigned long LowerLayerIfCount;
  /* 0x0028 */ unsigned long HigherLayerIfCount;
  /* 0x002c */ long Ref;
  /* 0x0030 */ long MiniportRef;
  /* 0x0034 */ long Padding_8;
  ...
  /* 0x054a */ char Padding_14[2];
  /* 0x054c */ unsigned long SupportedStatistics;
} NDIS_IF_BLOCK, *PNDIS_IF_BLOCK; /* size: 0x0550 */
...
} NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES, *PNDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES; /* size: 0x00c8 */
...
typedef struct _NET_BUFFER_LIST
{
  ...
  /* 0x0048 */ unsigned long Flags;
  /* 0x004c */ int Status;
  /* 0x0050 */ void* NetBufferListInfo[13];
  /* 0x0084 */ long __PADDING__[1];
} NET_BUFFER_LIST, *PNET_BUFFER_LIST; /* size: 0x0088 */
...
} NDIS_PROTOCOL_BLOCK, *PNDIS_PROTOCOL_BLOCK; /* size: 0x017c */
...
} NDIS_BIND_PARAMETERS, *PNDIS_BIND_PARAMETERS; /* size: 0x00d0 */
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x0718 */ struct _NDIS_MINIPORT_HANDLERS Next;
  /* 0x0764 */ long NumOfPauseRestartRequests;
  /* 0x0768 */ unsigned long FilterPnPFlags;
  /* 0x076c */ unsigned long SupportedStatistics;
  /* 0x0770 */ unsigned long cDpcSendCompletes;
  /* 0x0774 */ unsigned long cDpcRcvIndications;
  /* 0x0778 */ unsigned long cDpcRcvIndicationCalls;
  /* 0x077c */ unsigned long cDpcNbSendCompletes;
  /* 0x0780 */ unsigned long cDpcNblSendCompletes;
  /* 0x0784 */ unsigned long cDpcNblIndications;
  /* 0x0788 */ unsigned long cDpcMaxPacketsIndicated;
  /* 0x078c */ unsigned long cDpcTotalDpcCount;
  /* 0x0790 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x07a0 */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x07a4 */ struct _LIST_ENTRY PortList;
  /* 0x07ac */ unsigned char* AllocatedPortIndices;
  /* 0x07b0 */ unsigned long AllocatedPortIndicesLength;
  /* 0x07b4 */ unsigned long NumberOfPorts;
  /* 0x07b8 */ unsigned long NumberOfActivePorts;
  /* 0x07bc */ long Padding_41;
  /* 0x07c0 */ unsigned __int64 MiniportXmitLinkSpeed;
  /* 0x07c8 */ unsigned __int64 MiniportRcvLinkSpeed;
  /* 0x07d0 */ struct _KEVENT RestoreStackTimerEvent;
  /* 0x07e0 */ struct _NDIS_TIMER RestoreStackTimer;
  /* 0x0828 */ struct _NDIS_WORK_ITEM RestoreStackWorkItem;
  /* 0x0850 */ unsigned long RestoreStackBindRefCount;
  /* 0x0854 */ unsigned long ProtocolsToBind;
  /* 0x0858 */ struct _NDIS_DPC_TRACKER* DpcTrackers;
  /* 0x085c */ struct _NDIS_DPC_TRACKER* CurrentDpcTracker;
  /* 0x0860 */ unsigned char DpcTrackerIndex;
  /* 0x0861 */ unsigned char SupportedRss;
  /* 0x0862 */ char Padding_42[6];
  /* 0x0868 */ unsigned __int64 DpcWatchDogCycleCount;
  /* 0x0870 */ unsigned long DataBackFillSize;
  /* 0x0874 */ unsigned long ContextBackFillSize;
  /* 0x0878 */ unsigned long SupportedPauseFunctions;
  /* 0x087c */ long Padding_43;
  /* 0x0880 */ struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;
  /* 0x08d0 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;
  /* 0x08e0 */ long NumOfOpenPauseRestartRequests;
  /* 0x08e4 */ long MiniportStackPauseCount;
  /* 0x08e8 */ unsigned long NsiOpenReferences;
  /* 0x08ec */ struct _KEVENT* NsiRequestsCompletedEvent;
  /* 0x08f0 */ enum _DEVICE_POWER_STATE QueryPowerDeviceState;
  /* 0x08f4 */ unsigned char MinimumNdisMajorVersion;
  /* 0x08f5 */ unsigned char MinimumNdisMinorVersion;
  /* 0x08f6 */ unsigned short NumOfMinimumVersionDrivers;
  /* 0x08f8 */ struct _NDIS_MINIPORT_STATS* BottomIfStats;
  /* 0x08fc */ struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;
  /* 0x094c */ enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;
  /* 0x0950 */ enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;
  /* 0x0954 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;
  /* 0x0958 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;
  /* 0x095c */ enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;
  /* 0x0960 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;
  /* 0x0964 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;
  /* 0x0968 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;
  /* 0x096c */ struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;
  /* 0x0994 */ void* TopNdis5PacketIndicateHandler /* function */;
  /* 0x0998 */ unsigned long* ndisSupportedOidList;
  /* 0x099c */ unsigned long ndisSupportedOidListLength;
  /* 0x09a0 */ unsigned long MsiIntCount;
  /* 0x09a4 */ struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;
  /* 0x09b4 */ long Padding_44;
  /* 0x09b8 */ unsigned __int64 InvalidFrames;
  /* 0x09c0 */ long PagingPathCount;
  union
  {
    /* 0x09c4 */ unsigned char BeginSavedFields;
    /* 0x09c4 */ unsigned long NumUserOpens;
  }; /* size: 0x0004 */
  /* 0x09c8 */ struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;
  /* 0x09cc */ unsigned short MediaDisconnectTimeOut;
  /* 0x09ce */ unsigned short SGMapRegistersNeeded;
  /* 0x09d0 */ unsigned long DriverVerifyFlags;
  /* 0x09d4 */ void* SetBusData /* function */;
  /* 0x09d8 */ void* GetBusData /* function */;
  /* 0x09dc */ void* BusDataContext;
  /* 0x09e0 */ enum _NDIS_INTERFACE_TYPE BusType;
  /* 0x09e4 */ unsigned long BusNumber;
  /* 0x09e8 */ unsigned long SlotNumber;
  /* 0x09ec */ struct _NDIS_EVENT OpenReadyEvent;
  /* 0x09fc */ unsigned long NumAdminOpens;
  /* 0x0a00 */ struct _NDIS_M_DRIVER_BLOCK* DriverHandle;
  /* 0x0a04 */ struct _NDIS_BIND_PATHS* BindPaths;
  /* 0x0a08 */ struct _NDIS_BIND_PATHS* LWFilterList;
  /* 0x0a0c */ struct _NDIS_PROTOCOL_BLOCK** ProtocolsFailToBind;
  /* 0x0a10 */ unsigned long MiniportPhysicalMediumType;
  /* 0x0a14 */ struct _NDIS_FILTER_ATTACH_LIST* LWFilterAttachList;
  /* 0x0a18 */ unsigned long NumFilters;
  /* 0x0a1c */ unsigned int NetLuidIndex;
  /* 0x0a20 */ struct _KMUTANT LWFilterMutex;
  /* 0x0a40 */ void* SecurityDescriptor;
  /* 0x0a44 */ struct _UNICODE_STRING BaseName;
  /* 0x0a4c */ struct _UNICODE_STRING MiniportName;
  /* 0x0a54 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0a58 */ struct _DEVICE_OBJECT* PhysicalDeviceObject;
  /* 0x0a5c */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x0a60 */ struct _NDIS_MINIPORT_BLOCK* NextGlobalMiniport;
  /* 0x0a64 */ struct _UNICODE_STRING* pAdapterInstanceName;
  /* 0x0a68 */ unsigned long PnPCapabilities;
  /* 0x0a6c */ enum _DEVICE_POWER_STATE CurrentDevicePowerState;
  /* 0x0a70 */ void* BusInterface;
  /* 0x0a74 */ unsigned short InstanceNumber;
  /* 0x0a76 */ char Padding_45[2];
  /* 0x0a78 */ void* ConfigurationHandle;
  /* 0x0a7c */ struct _GUID InterfaceGuid;
  /* 0x0a8c */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x0a90 */ unsigned int IfIndex;
  /* 0x0a94 */ enum _NET_IF_ADMIN_STATUS AdminStatus;
  /* 0x0a98 */ enum _NET_IF_OPER_STATUS OperStatus;
  /* 0x0a9c */ unsigned long OperStatusFlags;
  union
  {
    /* 0x0aa0 */ void* SendHandler /* function */;
    /* 0x0aa0 */ void* WanSendHandler /* function */;
  }; /* size: 0x0004 */
  /* 0x0aa4 */ struct _NDIS_MINIPORT_OFFLOAD* Offload;
  /* 0x0aa8 */ void* AddDeviceContext;
  /* 0x0aac */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x0ac4 */ struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;
  /* 0x0acc */ unsigned char RssEnable;
  /* 0x0acd */ unsigned char ChimneyEnable;
  /* 0x0ace */ char Padding_46[2];
  /* 0x0ad0 */ unsigned long PhysicalMediumInInf;
  /* 0x0ad4 */ struct _UNICODE_STRING ExportName;
  /* 0x0adc */ struct _UNICODE_STRING FilterClass;
  /* 0x0ae4 */ void* StatusProcessingThread;
  /* 0x0ae8 */ unsigned long StatusProcessingDbgX;
  /* 0x0aec */ struct _UNICODE_STRING FdoName;
  /* 0x0af4 */ struct _NDIS_MINIPORT_BLOCK* NextOrphanedMiniport;
  /* 0x0af8 */ struct _KEVENT PowerEvent;
  /* 0x0b08 */ struct _KEVENT* pPowerEvent;
  /* 0x0b0c */ unsigned long DirectOidRequestCount;
  /* 0x0b10 */ struct _KEVENT* AllDirectRequestsCompletedEvent;
  /* 0x0b14 */ struct _NDIS_HD_SPLIT_CURRENT_CONFIG* HDSplitCurrentConfig;
  /* 0x0b18 */ void* MSIXConfigContext;
  /* 0x0b1c */ void* SetMSIXTableEntry /* function */;
  /* 0x0b20 */ void* MaskMSIXTableEntry /* function */;
  /* 0x0b24 */ void* UnmaskMSIXTableEntry /* function */;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x0b28 */
...
typedef struct _NDIS_OPEN_BLOCK
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x03a4 */ void* DirectOidRequestCompleteHandler /* function */;
      /* 0x03a8 */ void* DirectOidRequestHandler /* function */;
      /* 0x03ac */ void* DirectOidRequestCompleteContext;
      /* 0x03b0 */ struct _NDIS_CO_AF_BLOCK* NextAf;
      /* 0x03b4 */ void* MiniportCoCreateVcHandler /* function */;
      /* 0x03b8 */ void* MiniportCoRequestHandler /* function */;
      /* 0x03bc */ void* CoCreateVcHandler /* function */;
      /* 0x03c0 */ void* CoDeleteVcHandler /* function */;
      /* 0x03c4 */ void* CmActivateVcCompleteHandler /* function */;
      /* 0x03c8 */ void* CmDeactivateVcCompleteHandler /* function */;
      /* 0x03cc */ void* CoRequestCompleteHandler /* function */;
      /* 0x03d0 */ void* CoRequestHandler /* function */;
      /* 0x03d4 */ struct _LIST_ENTRY ActiveVcHead;
      /* 0x03dc */ struct _LIST_ENTRY InactiveVcHead;
      /* 0x03e4 */ long PendingAfNotifications;
      /* 0x03e8 */ struct _KEVENT* AfNotifyCompleteEvent;
      /* 0x03ec */ void* MiniportCoOidRequestHandler /* function */;
      /* 0x03f0 */ void* CoOidRequestCompleteHandler /* function */;
      /* 0x03f4 */ void* CoOidRequestHandler /* function */;
    }; /* size: 0x0310 */
  }; /* size: 0x0310 */
} NDIS_OPEN_BLOCK, *PNDIS_OPEN_BLOCK; /* size: 0x03f8 */
...
} NDIS_COMMON_OPEN_BLOCK, *PNDIS_COMMON_OPEN_BLOCK; /* size: 0x03b0 */
...
typedef struct _NDIS_FILTER_DRIVER_BLOCK
{
  ...
  /* 0x00f8 */ void* SetInfoBuf;
  /* 0x00fc */ unsigned long RequestBuffer;
  /* 0x0100 */ unsigned short SetInfoBufLen;
  /* 0x0102 */ char Padding_58[2];
  /* 0x0104 */ enum _NDIS_FILTER_TYPE FilterType;
  /* 0x0108 */ enum _NDIS_FILTER_RUN_TYPE FilterRunType;
  /* 0x010c */ struct _UNICODE_STRING FilterClass;
} NDIS_FILTER_DRIVER_BLOCK, *PNDIS_FILTER_DRIVER_BLOCK; /* size: 0x0114 */
...
_ComputeLargerOrEqualPowerOfTwo@4
...
_ndisAcquireMiniportFilterPnPLocalLock@8
...
_ndisCreateAcl@28
_ndisCreateAdapterInstanceName@12
...
_ndisFillMiniportIndicateLists@0
...
_ndisReadBindPaths@8
_ndisReadMiniportDefaultPortAuthStates@4
_ndisReadMiniportFilterList@4
...
_ndisReferenceSap@4
_ndisReferenceTopMiniportByNameForNsi@8
...
_ndisWorkerThread@4
_ndisWriteMiniportParameters@20
