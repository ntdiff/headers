...
{
  /* 0x0018 */ class Microsoft::WRL::Wrappers::CriticalSection m_CallCS;
  /* 0x0030 */ class CancellableCall* m_pOutstandingCalls;
  /* 0x0034 */ struct _TP_TIMER* m_pCancellationTimer;
  /* 0x0038 */ volatile BOOL m_fTaskActive;
  /* 0x003c */ volatile unsigned long m_dwCancellationThreadId;
  /* 0x0040 */ BOOL m_fReleaseOnTimeout;
  /* 0x0044 */ class Microsoft::WRL::ComPtr<IOSTaskCompletion> m_spTaskCompletion;
}; /* size: 0x0048 */
