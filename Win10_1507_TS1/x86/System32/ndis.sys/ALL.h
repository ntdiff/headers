...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0048 */ long Padding_14[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_15[14];
...
{
  /* 0x0000 */ long Padding_16[4];
  /* 0x0010 */ unsigned short ItemLength;
  /* 0x0012 */ char Padding_17[2];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_186;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_187[2];
