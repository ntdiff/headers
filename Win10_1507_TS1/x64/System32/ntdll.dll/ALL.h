...
typedef struct _PPM_IDLE_STATES
{
  ...
  /* 0x0190 */ void* IdlePreExecute /* function */;
  /* 0x0198 */ void* IdleExecute /* function */;
  /* 0x01a0 */ void* IdlePreselect /* function */;
  /* 0x01a8 */ void* IdleTest /* function */;
  /* 0x01b0 */ void* IdleAvailabilityCheck /* function */;
  /* 0x01b8 */ void* IdleComplete /* function */;
  /* 0x01c0 */ void* IdleCancel /* function */;
  /* 0x01c8 */ void* IdleIsHalted /* function */;
  /* 0x01d0 */ void* IdleInitiateWake /* function */;
  ...
  /* 0x02e0 */ struct _PERFINFO_PPM_STATE_SELECTION* CoordinatedTracing;
  ...
  /* 0x0320 */ struct _PPM_IDLE_STATE State[1];
} PPM_IDLE_STATES, *PPPM_IDLE_STATES; /* size: 0x0418 */
...
typedef struct _KPRCB
{
  ...
  /* 0x6864 */ long Padding_88;
  /* 0x6868 */ void* ExSaPageArray;
  /* 0x6870 */ long Padding_89[4];
  /* 0x6880 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x6888 */ long Padding_90[14];
...
typedef struct _KLOCK_ENTRY
{
            ...
            struct
            {
              ...
              union
              {
                ...
                struct /* bitfield */
                {
                  ...
                  /* 0x001b */ unsigned char Spare1 : 6; /* bit position: 2 */
                }; /* bitfield */
              }; /* size: 0x0001 */
            }; /* size: 0x0002 */
          }; /* size: 0x0002 */
  ...
  /* 0x005c */ unsigned short SparePad;
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0078 */ unsigned long ThreadFlagsSpare0 : 1; /* bit position: 2 */
      ...
      /* 0x0078 */ unsigned long CommitFailTerminateRequest : 1; /* bit position: 17 */
      /* 0x0078 */ unsigned long ProcessStackCountDecremented : 1; /* bit position: 18 */
      /* 0x0078 */ unsigned long ThreadFlagsSpare : 5; /* bit position: 19 */
  ...
  /* 0x0588 */ volatile short KeReferenceCount;
  /* 0x058a */ unsigned char AbOrphanedEntrySummary;
  /* 0x058b */ unsigned char AbOwnedEntryCount;
...
typedef struct _KSCB
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0070 */ unsigned char Spare1 : 3; /* bit position: 5 */
  }; /* bitfield */
  /* 0x0071 */ unsigned char Depth;
  /* 0x0072 */ unsigned short ReadySummary;
  /* 0x0074 */ unsigned long Rank;
  /* 0x0078 */ struct _LIST_ENTRY ReadyListHead[16];
  /* 0x0178 */ struct _RTL_RB_TREE ChildScbQueue;
  /* 0x0188 */ struct _KSCB* Parent;
  /* 0x0190 */ struct _KSCB* Root;
} KSCB, *PKSCB; /* size: 0x0198 */
...
typedef struct _KNODE
{
  ...
  /* 0x0060 */ long Padding_118[8];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_119;
  union
  {
...
typedef struct _KSCHEDULING_GROUP
{
  ...
  /* 0x0040 */ struct _LIST_ENTRY ChildList;
  /* 0x0050 */ struct _KSCHEDULING_GROUP* Parent;
  /* 0x0058 */ long Padding_124[10];
  /* 0x0080 */ struct _KSCB PerProcessor[1];
  /* 0x0218 */ long __PADDING__[10];
...
typedef struct _ETHREAD
{
  ...
  /* 0x05d8 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x05e0 */ union _LARGE_INTEGER ExitTime;
    /* 0x05e0 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  /* 0x05f0 */ void* ChargeOnlySession;
  union
  {
    /* 0x05f8 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x05f8 */ void* ForwardLinkShadow;
      /* 0x0600 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x0608 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0608 */ struct _ETHREAD* ReaperLink;
    /* 0x0608 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x0610 */ unsigned __int64 ActiveTimerListLock;
  /* 0x0618 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0628 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0638 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0638 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x0658 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x0660 */ struct _LIST_ENTRY IrpList;
  /* 0x0670 */ unsigned __int64 TopLevelIrp;
  /* 0x0678 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x0680 */ void* Win32StartAddress;
  /* 0x0688 */ void* LegacyPowerObject;
  /* 0x0690 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06a0 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x06a8 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x06b0 */ unsigned long ReadClusterSize;
  /* 0x06b4 */ volatile long MmLockOrdering;
  /* 0x06b8 */ volatile long CmLockOrdering;
  union
  {
    /* 0x06bc */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x06bc */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x06bc */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x06bc */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x06bc */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x06bc */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x06bc */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x06bc */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x06bc */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x06bc */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x06bc */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x06bc */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x06bc */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x06bc */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x06bc */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x06bc */ unsigned long ReservedCrossThreadFlags : 14; /* bit position: 18 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06c0 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x06c0 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x06c0 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x06c0 */ unsigned long ClonedThread : 1; /* bit position: 2 */
      /* 0x06c0 */ unsigned long KeyedEventInUse : 1; /* bit position: 3 */
      /* 0x06c0 */ unsigned long SelfTerminate : 1; /* bit position: 4 */
      /* 0x06c0 */ unsigned long RespectIoPriority : 1; /* bit position: 5 */
      /* 0x06c0 */ unsigned long ReservedSameThreadPassiveFlags : 26; /* bit position: 6 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06c4 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x06c4 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x06c4 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x06c4 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x06c4 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x06c4 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x06c4 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x06c4 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x06c4 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x06c5 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x06c5 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x06c8 */ unsigned char CacheManagerActive;
  /* 0x06c9 */ unsigned char DisablePageFaultClustering;
  /* 0x06ca */ unsigned char ActiveFaultCount;
  /* 0x06cb */ unsigned char LockOrderState;
  /* 0x06cc */ long Padding_140;
  /* 0x06d0 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x06d8 */ void* AlpcMessage;
    /* 0x06d8 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x06e0 */ long ExitStatus;
  /* 0x06e4 */ long Padding_141;
  /* 0x06e8 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x06f8 */ unsigned long CacheManagerCount;
  /* 0x06fc */ unsigned long IoBoostCount;
  /* 0x0700 */ struct _LIST_ENTRY BoostList;
  /* 0x0710 */ struct _LIST_ENTRY DeboostList;
  /* 0x0720 */ unsigned __int64 BoostListLock;
  /* 0x0728 */ unsigned __int64 IrpListLock;
  /* 0x0730 */ void* ReservedForSynchTracking;
  /* 0x0738 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0740 */ const struct _GUID* ActivityId;
  /* 0x0748 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0750 */ void* VerifierContext;
  /* 0x0758 */ unsigned long KernelStackReference;
  /* 0x075c */ long Padding_142;
  /* 0x0760 */ void* AdjustedClientToken;
  /* 0x0768 */ void* WorkingOnBehalfClient;
  /* 0x0770 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x0788 */ void* PicoContext;
  /* 0x0790 */ unsigned long UserFsBase;
  /* 0x0794 */ long Padding_143;
  /* 0x0798 */ unsigned __int64 UserGsBase;
  /* 0x07a0 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x07a8 */ volatile unsigned long CmCellReferences;
  /* 0x07ac */ long Padding_144;
  union
  {
    /* 0x07b0 */ unsigned __int64 SelectedCpuSets;
    /* 0x07b0 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x07b8 */ struct _ESILO* Silo;
} ETHREAD, *PETHREAD; /* size: 0x07c0 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x0428 */ void* Wow64Process;
  /* 0x0430 */ void* DeviceMap;
  /* 0x0438 */ void* EtwDataSource;
  /* 0x0440 */ unsigned __int64 PageDirectoryPte;
  /* 0x0448 */ unsigned char ImageFileName[15];
  /* 0x0457 */ unsigned char PriorityClass;
  /* 0x0458 */ void* SecurityPort;
  /* 0x0460 */ struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;
  /* 0x0468 */ struct _LIST_ENTRY JobLinks;
  /* 0x0478 */ void* HighestUserAddress;
  /* 0x0480 */ struct _LIST_ENTRY ThreadListHead;
  /* 0x0490 */ volatile unsigned long ActiveThreads;
  /* 0x0494 */ unsigned long ImagePathHash;
  /* 0x0498 */ unsigned long DefaultHardErrorProcessing;
  /* 0x049c */ long LastThreadExitStatus;
  /* 0x04a0 */ struct _EX_FAST_REF PrefetchTrace;
  /* 0x04a8 */ void* LockedPagesList;
  /* 0x04b0 */ union _LARGE_INTEGER ReadOperationCount;
  /* 0x04b8 */ union _LARGE_INTEGER WriteOperationCount;
  /* 0x04c0 */ union _LARGE_INTEGER OtherOperationCount;
  /* 0x04c8 */ union _LARGE_INTEGER ReadTransferCount;
  /* 0x04d0 */ union _LARGE_INTEGER WriteTransferCount;
  /* 0x04d8 */ union _LARGE_INTEGER OtherTransferCount;
  /* 0x04e0 */ unsigned __int64 CommitChargeLimit;
  /* 0x04e8 */ volatile unsigned __int64 CommitCharge;
  /* 0x04f0 */ volatile unsigned __int64 CommitChargePeak;
  /* 0x04f8 */ struct _MMSUPPORT Vm;
  /* 0x05f0 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0600 */ unsigned long ModifiedPageCount;
  /* 0x0604 */ long ExitStatus;
  /* 0x0608 */ struct _RTL_AVL_TREE VadRoot;
  /* 0x0610 */ void* VadHint;
  /* 0x0618 */ unsigned __int64 VadCount;
  /* 0x0620 */ volatile unsigned __int64 VadPhysicalPages;
  /* 0x0628 */ unsigned __int64 VadPhysicalPagesLimit;
  /* 0x0630 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x0650 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x0660 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x0668 */ unsigned long RequestedTimerResolution;
  /* 0x066c */ unsigned long SmallestTimerResolution;
  /* 0x0670 */ union _LARGE_INTEGER ExitTime;
  /* 0x0678 */ struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
  /* 0x0680 */ struct _EX_PUSH_LOCK InvertedFunctionTableLock;
  /* 0x0688 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x068c */ unsigned long LargePrivateVadCount;
  /* 0x0690 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x0698 */ void* WnfContext;
  /* 0x06a0 */ unsigned __int64 Spare0;
  /* 0x06a8 */ unsigned char SignatureLevel;
  /* 0x06a9 */ unsigned char SectionSignatureLevel;
  /* 0x06aa */ struct _PS_PROTECTION Protection;
  /* 0x06ab */ unsigned char HangCount;
  union
  {
    /* 0x06ac */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x06ac */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x06ac */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x06ac */ unsigned long DisableNonSystemFonts : 1; /* bit position: 2 */
      /* 0x06ac */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 3 */
      /* 0x06ac */ unsigned long Crashed : 1; /* bit position: 4 */
      /* 0x06ac */ unsigned long JobVadsAreTracked : 1; /* bit position: 5 */
      /* 0x06ac */ unsigned long VadTrackingDisabled : 1; /* bit position: 6 */
      /* 0x06ac */ unsigned long AuxiliaryProcess : 1; /* bit position: 7 */
      /* 0x06ac */ unsigned long SubsystemProcess : 1; /* bit position: 8 */
      /* 0x06ac */ unsigned long IndirectCpuSets : 1; /* bit position: 9 */
      /* 0x06ac */ unsigned long InPrivate : 1; /* bit position: 10 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x06b0 */ long DeviceAsid;
  /* 0x06b4 */ long Padding_161;
  /* 0x06b8 */ void* SvmData;
  /* 0x06c0 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x06c8 */ unsigned __int64 SvmLock;
  /* 0x06d0 */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x06e0 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x06e8 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x06f0 */ void* PicoContext;
  /* 0x06f8 */ unsigned __int64 TrustletIdentity;
  /* 0x0700 */ unsigned long KeepAliveCounter;
  /* 0x0704 */ unsigned long NoWakeKeepAliveCounter;
  /* 0x0708 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x070c */ long Padding_162;
  /* 0x0710 */ struct _PROCESS_ENERGY_VALUES* EnergyValues;
  /* 0x0718 */ void* VmContext;
  /* 0x0720 */ struct _ESILO* Silo;
  /* 0x0728 */ struct _LIST_ENTRY SiloEntry;
...
} EPROCESS, *PEPROCESS; /* size: 0x0798 */
...
typedef struct _EJOB
{
  ...
  /* 0x0340 */ struct _EJOB* EffectiveDiskIoRateLimitJob;
  /* 0x0348 */ struct _EJOB* EffectiveNetIoRateLimitJob;
  /* 0x0350 */ struct _EJOB* EffectiveHeapAttributionJob;
  /* 0x0358 */ unsigned long EffectiveLimitFlags;
  /* 0x035c */ unsigned long EffectiveSchedulingClass;
  /* 0x0360 */ unsigned long EffectiveFreezeCount;
  /* 0x0364 */ unsigned long EffectiveBackgroundCount;
  /* 0x0368 */ unsigned long EffectiveSwapCount;
  /* 0x036c */ unsigned long EffectiveNotificationLimitCount;
  /* 0x0370 */ unsigned char EffectivePriorityClass;
  /* 0x0371 */ unsigned char PriorityClass;
  /* 0x0372 */ unsigned char NestingDepth;
  /* 0x0373 */ unsigned char Reserved1[1];
  ...
  /* 0x03b0 */ struct _JOBOBJECT_WAKE_FILTER WakeFilter;
  /* 0x03b8 */ unsigned long LowEdgeLatchFilter;
  /* 0x03bc */ unsigned long OwnedHighEdgeFilters;
  /* 0x03c0 */ struct _EJOB* NotificationLink;
  /* 0x03c8 */ unsigned __int64 CurrentJobMemoryUsed;
  /* 0x03d0 */ struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
  /* 0x03d8 */ void* NotificationInfoQuotaReference;
  /* 0x03e0 */ struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
  /* 0x03e8 */ struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
  /* 0x03f0 */ void* EffectiveSchedulingGroup;
  /* 0x03f8 */ unsigned __int64 ReadyTime;
  /* 0x0400 */ struct _EX_PUSH_LOCK MemoryLimitsLock;
  /* 0x0408 */ struct _LIST_ENTRY SiblingJobLinks;
  /* 0x0418 */ struct _LIST_ENTRY ChildJobListHead;
  /* 0x0428 */ struct _EJOB* ParentJob;
  /* 0x0430 */ struct _EJOB* volatile RootJob;
  /* 0x0438 */ struct _LIST_ENTRY IteratorListHead;
  /* 0x0448 */ unsigned __int64 AncestorCount;
  union
  {
    /* 0x0450 */ struct _EJOB** Ancestors;
    /* 0x0450 */ void* SessionObject;
  }; /* size: 0x0008 */
  /* 0x0458 */ struct _EPROCESS_VALUES Accounting;
  /* 0x04a8 */ unsigned long ShadowActiveProcessCount;
  /* 0x04ac */ unsigned long ActiveAuxiliaryProcessCount;
  /* 0x04b0 */ unsigned long SequenceNumber;
  /* 0x04b4 */ long Padding_163;
  /* 0x04b8 */ unsigned __int64 TimerListLock;
  /* 0x04c0 */ struct _LIST_ENTRY TimerListHead;
  /* 0x04d0 */ struct _GUID ContainerId;
  /* 0x04e0 */ struct _ESILO* Container;
  /* 0x04e8 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x0500 */ struct _JOB_NET_RATE_CONTROL* NetRateControl;
  /* 0x0508 */ struct _JOB_IO_RATE_CONTROL* IoRateControl;
  union
  {
    /* 0x0510 */ unsigned long JobFlags;
    struct /* bitfield */
    {
      /* 0x0510 */ unsigned long CloseDone : 1; /* bit position: 0 */
      /* 0x0510 */ unsigned long MultiGroup : 1; /* bit position: 1 */
      /* 0x0510 */ unsigned long OutstandingNotification : 1; /* bit position: 2 */
      /* 0x0510 */ unsigned long NotificationInProgress : 1; /* bit position: 3 */
      /* 0x0510 */ unsigned long UILimits : 1; /* bit position: 4 */
      /* 0x0510 */ unsigned long CpuRateControlActive : 1; /* bit position: 5 */
      /* 0x0510 */ unsigned long OwnCpuRateControl : 1; /* bit position: 6 */
      /* 0x0510 */ unsigned long Terminating : 1; /* bit position: 7 */
      /* 0x0510 */ unsigned long WorkingSetLock : 1; /* bit position: 8 */
      /* 0x0510 */ unsigned long JobFrozen : 1; /* bit position: 9 */
      /* 0x0510 */ unsigned long Background : 1; /* bit position: 10 */
      /* 0x0510 */ unsigned long WakeNotificationAllocated : 1; /* bit position: 11 */
      /* 0x0510 */ unsigned long WakeNotificationEnabled : 1; /* bit position: 12 */
      /* 0x0510 */ unsigned long WakeNotificationPending : 1; /* bit position: 13 */
      /* 0x0510 */ unsigned long LimitNotificationRequired : 1; /* bit position: 14 */
      /* 0x0510 */ unsigned long ZeroCountNotificationRequired : 1; /* bit position: 15 */
      /* 0x0510 */ unsigned long CycleTimeNotificationRequired : 1; /* bit position: 16 */
      /* 0x0510 */ unsigned long CycleTimeNotificationPending : 1; /* bit position: 17 */
      /* 0x0510 */ unsigned long TimersVirtualized : 1; /* bit position: 18 */
      /* 0x0510 */ unsigned long JobSwapped : 1; /* bit position: 19 */
      /* 0x0510 */ unsigned long ViolationDetected : 1; /* bit position: 20 */
      /* 0x0510 */ unsigned long EmptyJobNotified : 1; /* bit position: 21 */
      /* 0x0510 */ unsigned long NoSystemCharge : 1; /* bit position: 22 */
      /* 0x0510 */ unsigned long DropNoWakeCharges : 1; /* bit position: 23 */
      /* 0x0510 */ unsigned long NoWakeChargePolicyDecided : 1; /* bit position: 24 */
      /* 0x0510 */ unsigned long NetRateControlActive : 1; /* bit position: 25 */
      /* 0x0510 */ unsigned long OwnNetRateControl : 1; /* bit position: 26 */
      /* 0x0510 */ unsigned long IoRateControlActive : 1; /* bit position: 27 */
      /* 0x0510 */ unsigned long OwnIoRateControl : 1; /* bit position: 28 */
      /* 0x0510 */ unsigned long IsContainerRoot : 1; /* bit position: 29 */
      /* 0x0510 */ unsigned long SpareJobFlags : 2; /* bit position: 30 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0514 */ unsigned long EffectiveHighEdgeFilters;
  /* 0x0518 */ struct _PROCESS_ENERGY_VALUES* EnergyValues;
  /* 0x0520 */ volatile unsigned __int64 SharedCommitCharge;
} EJOB, *PEJOB; /* size: 0x0528 */
...
typedef struct _HEAP_LFH_CONTEXT
{
  ...
  /* 0x0039 */ char Padding_170[7];
  /* 0x0040 */ const unsigned char* AffinityModArray;
  /* 0x0048 */ long Padding_171[2];
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x0088 */ unsigned __int64 VirtualizationKey;
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x016a */ char Padding_191[6];
  /* 0x0170 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x0208 */ long Padding_192[2];
...
RtlpHpVirtAllocateHeap
RtlpHpVirtFindHeapByAlloc
RtlpHpVirtFreeHeap
RtlpHpVirtGetProcessHeap
RtlpHpVirtGetUserInfoHeap
RtlpHpVirtHeapTableDereferenceHeap
RtlpHpVirtHeapTableFindByHeap
RtlpHpVirtHeapTableFindById
RtlpHpVirtHeapTableFindEntry
RtlpHpVirtHeapTableFindOrCreateHeap
RtlpHpVirtLargeTreeFind
RtlpHpVirtLargeTreeInsert
RtlpHpVirtLargeTreeInsertNode
RtlpHpVirtQueryHeaps
RtlpHpVirtQueryHeapsRemote
RtlpHpVirtReAllocateHeap
RtlpHpVirtRunOnceInit
RtlpHpVirtSetUserFlagsHeap
RtlpHpVirtSetUserValueHeap
RtlpHpVirtTableAllocRoutine
RtlpHpVirtTableFreeRoutine
RtlpHpVirtUnlockHeap
RtlpHpVirtValidateHeap
...
RtlpSetUserFlagsHeapInternal
RtlpSetUserValueHeapInternal
