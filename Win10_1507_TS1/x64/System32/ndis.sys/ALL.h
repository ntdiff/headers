...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x10d6 */ char Padding_89[2];
  /* 0x10d8 */ unsigned long DirectOidRequestCount;
  /* 0x10dc */ long Padding_90;
...
} NDIS_SFA_CLIENT_DISPATCH, *PNDIS_SFA_CLIENT_DISPATCH; /* size: 0x0008 */
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_252;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_253[2];
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_277[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_278[12];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_425;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_426[2];
...
?NdisPDPIOffRssReceiveQueues@@YAXPEAUNDIS_PD_PROVIDER_HANDLE__@@@Z
?NdisPDPIOnRssReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ON_RSS_QUEUE_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z
...
?NdisTraceLoggingCompletedDxState@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z
...
?ndisIfUpdateInterfaceIsolationNetworkId@@YAJPEAU_NDIS_IF_BLOCK@@AEBU_GUID@@@Z
?ndisIfUpdateInterfaceIsolationNetworkIdLocked@@YAJPEAU_NDIS_IF_BLOCK@@AEBU_GUID@@@Z
...
?ndisPcwGetRssInstanceName@@YAJPEAU_NDIS_MINIPORT_BLOCK@@KPEAU_UNICODE_STRING@@@Z
