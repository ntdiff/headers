...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x14e0 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x1508 */ BOOL PmInterruptedByPnp;
  /* 0x1509 */ BOOL DoNotBlockOnMiniportLock;
  /* 0x1510 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x1518 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x1538 */ BOOL InterfaceUpdateInProgress;
  /* 0x1539 */ BOOL MacAddressUpdateQueued;
  /* 0x153a */ BOOL MtuUpdateQueued;
  /* 0x153c */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x1560 */ unsigned long PendingMtuSize;
  /* 0x1568 */ struct RECORDER_LOG__* BlackBoxHandle;
  /* 0x1570 */ struct _KEVENT* PowerCompleteEvent;
  /* 0x1578 */ long PowerCompleteStatus;
  /* 0x1580 */ struct _NDIS_PD_BLOCK* PDBlock;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x1588 */
