...
typedef struct _NDIS_M_DRIVER_BLOCK
{
  ...
  /* 0x0160 */ class KPtr<_NDIS_MINIPORT_DRIVER_CHARACTERISTICS,KDeletePtr<_NDIS_MINIPORT_DRIVER_CHARACTERISTICS> > UnhookedCharacteristics;
  ...
  /* 0x0330 */ struct _NDIS_MINIPORT_BLOCK* CompositeBusDefaultMiniport;
  /* 0x0338 */ void* OpenNDKAdapterHandler /* function */;
  /* 0x0340 */ void* CloseNDKAdapterHandler /* function */;
  /* 0x0348 */ void* SysPowerNotifyHandler /* function */;
  /* 0x0350 */ void* IdleNotificationHandler /* function */;
  /* 0x0358 */ void* CancelIdleNotificationHandler /* function */;
  ...
  /* 0x0460 */ void* PDExtProviderSetupBufferFromMemoryHandle /* function */;
  /* 0x0468 */ void* PDExtProviderGrowPDBufferDestinations /* function */;
  /* 0x0470 */ void* PDExtProviderGetSwitchInfo /* function */;
  /* 0x0478 */ struct NDIS_SFA_HANDLE__* SfaHandle;
  /* 0x0480 */ void* SfaRegisterClientHandler /* function */;
  /* 0x0488 */ void* SfaDeRegisterClientHandler /* function */;
  /* 0x0490 */ void* SfaCreateContextHandler /* function */;
  /* 0x0498 */ void* SfaDeleteContextHandler /* function */;
  /* 0x04a0 */ void* SfaAddRuleHandler /* function */;
  /* 0x04a8 */ void* SfaRemoveRuleHandler /* function */;
  /* 0x04b0 */ void* SfaGetMeterDataHandler /* function */;
  /* 0x04b8 */ void* PDBMCreateDomain /* function */;
  /* 0x04c0 */ void* PDBMAddMemberToDomain /* function */;
  /* 0x04c8 */ void* PDBMRemoveMemberFromDomain /* function */;
  /* 0x04d0 */ void* PDBMDeleteDomain /* function */;
  /* 0x04d8 */ void* PDBMAllocateCommonBuffer /* function */;
  /* 0x04e0 */ void* PDBMFreeCommonBuffer /* function */;
} NDIS_M_DRIVER_BLOCK, *PNDIS_M_DRIVER_BLOCK; /* size: 0x04e8 */
