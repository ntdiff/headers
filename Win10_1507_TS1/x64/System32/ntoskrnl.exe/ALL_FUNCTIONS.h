...
?SmKmProbeAndLockAddress@@YAJPEAX_KPEAU_MDL@@@Z
...
?SmStTrimWsStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@@Z
?SmStTrimWsStoreBatch@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAU1@PEAKPEAPEAXKK@Z
...
EtwpSendTraceEvent
EtwpServerSiloContextCleanupNotify
...
HvlpExtendedFastHypercallWithOutput
...
PspWowGetContextThread
PspWowGetProcessMachine
PspWowSetContextThread
