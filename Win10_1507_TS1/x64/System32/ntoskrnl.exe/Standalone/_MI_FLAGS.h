typedef union _MI_FLAGS
{
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0000 */ unsigned long ZeroNonCachedByConverting : 1; /* bit position: 13 */
      /* 0x0000 */ unsigned long ZeroWriteCombinedByConverting : 1; /* bit position: 14 */
      /* 0x0000 */ unsigned long ProtectedPagesEnabled : 1; /* bit position: 15 */
      /* 0x0000 */ unsigned long StrongCodeGuarantees : 2; /* bit position: 16 */
      /* 0x0000 */ unsigned long HardCodeGuarantees : 1; /* bit position: 18 */
      /* 0x0000 */ unsigned long StrongPageIdentity : 1; /* bit position: 19 */
      /* 0x0000 */ unsigned long SecureRelocations : 1; /* bit position: 20 */
    }; /* bitfield */
  }; /* size: 0x0004 */
