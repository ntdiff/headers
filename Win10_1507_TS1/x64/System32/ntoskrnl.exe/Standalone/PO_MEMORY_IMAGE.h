...
struct PO_MEMORY_IMAGE
{
  ...
  /* 0x0268 */ unsigned long FirmwareRuntimeInformationPages;
  /* 0x0270 */ unsigned __int64 FirmwareRuntimeInformation[1];
  /* 0x0278 */ unsigned long SiLogOffset;
  /* 0x027c */ unsigned long NoBootLoaderLogPages;
  /* 0x0280 */ unsigned __int64 BootLoaderLogPages[24];
  /* 0x0340 */ unsigned long NotUsed;
  /* 0x0344 */ unsigned long ResumeContextCheck;
  /* 0x0348 */ unsigned long ResumeContextPages;
  /* 0x034c */ unsigned char Hiberboot;
  /* 0x0350 */ unsigned __int64 HvCr3;
  /* 0x0358 */ unsigned __int64 HvEntryPoint;
  /* 0x0360 */ unsigned __int64 HvReservedTransitionAddress;
  /* 0x0368 */ unsigned __int64 HvReservedTransitionAddressSize;
  /* 0x0370 */ unsigned __int64 BootFlags;
  /* 0x0378 */ unsigned __int64 HalEntryPointPhysical;
  /* 0x0380 */ unsigned __int64 HighestPhysicalPage;
  /* 0x0388 */ unsigned __int64 BitlockerKeyPfns[4];
  /* 0x03a8 */ unsigned long HardwareSignature;
  /* 0x03ac */ long __PADDING__[1];
}; /* size: 0x03b0 */
