...
typedef struct _MI_PARTITION_CORE
{
  ...
  /* 0x0040 */ struct _MI_PARTITION_STATISTICS Stats;
  /* 0x0090 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* MemoryRuns;
  /* 0x0098 */ struct _KEVENT ExitEvent;
  /* 0x00b0 */ void* SystemThreadHandles[5];
  /* 0x00d8 */ void* PartitionObject;
  /* 0x00e0 */ void* PartitionObjectHandle;
  /* 0x00e8 */ struct _EX_PUSH_LOCK DynamicMemoryPushLock;
  /* 0x00f0 */ volatile long DynamicMemoryLock;
  /* 0x00f8 */ struct _KEVENT TemporaryMemoryEvent;
  /* 0x0110 */ struct _KEVENT* MemoryEvents[11];
} MI_PARTITION_CORE, *PMI_PARTITION_CORE; /* size: 0x0168 */
...
typedef struct _MI_PARTITION_MODWRITES
{
  ...
  /* 0x0150 */ volatile long WriteAllPagefilePages;
  /* 0x0154 */ volatile long WriteAllMappedPages;
  /* 0x0158 */ struct _KEVENT MappedPageWriterEvent;
  /* 0x0170 */ struct _MI_MODWRITE_DATA ModWriteData;
  /* 0x01b0 */ struct _KEVENT RescanPageFilesEvent;
  /* 0x01c8 */ struct _MMMOD_WRITER_LISTHEAD PagingFileHeader;
  /* 0x01f0 */ struct _ETHREAD* ModifiedPageWriterThread;
  /* 0x01f8 */ struct _EX_RUNDOWN_REF ModifiedPageWriterRundown;
  /* 0x0200 */ struct _WORK_QUEUE_ITEM PagefileScanWorkItem;
  /* 0x0220 */ unsigned long PagefileScanCount;
  /* 0x0224 */ volatile long ClusterWritesDisabled[2];
  /* 0x022c */ volatile unsigned char DelayMappedWrite;
  /* 0x0230 */ volatile unsigned long PagefileReservationsEnabled;
  /* 0x0238 */ struct _EX_PUSH_LOCK PageFileCreationLock;
  /* 0x0240 */ struct _WORK_QUEUE_ITEM TrimPagefileWorkItem;
  /* 0x0260 */ unsigned __int64 LastTrimPagefileTime;
  /* 0x0268 */ struct _WORK_QUEUE_ITEM WsSwapPagefileContractWorkItem;
  /* 0x0288 */ volatile long WsSwapPageFileContractionInProgress;
  /* 0x0290 */ struct _EX_PUSH_LOCK WorkingSetSwapLock;
  /* 0x0298 */ volatile long WorkingSetInswapLock;
  /* 0x029c */ long __PADDING__[1];
} MI_PARTITION_MODWRITES, *PMI_PARTITION_MODWRITES; /* size: 0x02a0 */
...
} MI_PARTITION_SEGMENTS, *PMI_PARTITION_SEGMENTS; /* size: 0x0110 */
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x07a8 */ struct _MMPFNLIST* PageLocationList[8];
  /* 0x07e8 */ volatile unsigned long StandbyRepurposedByPriority[8];
  /* 0x0808 */ struct _KEVENT MappedPageListHeadEvent[16];
  /* 0x0988 */ struct _MI_DECAY_TIMER_LINK DecayClusterTimerHeads[4];
  /* 0x09a8 */ unsigned long DecayHand;
  /* 0x09b0 */ unsigned __int64 LastDecayHandUpdateTime;
  /* 0x09b8 */ struct _MI_LDW_WORK_CONTEXT LastChanceLdwContext;
  /* 0x0a00 */ unsigned __int64 AvailableEventsLock;
  /* 0x0a08 */ struct _MI_AVAILABLE_PAGE_WAIT_STATES AvailablePageWaitStates[2];
  /* 0x0a48 */ unsigned __int64 LowMemoryThreshold;
  /* 0x0a50 */ unsigned __int64 HighMemoryThreshold;
  /* 0x0a80 */ volatile unsigned __int64 TransitionPrivatePages;
  /* 0x0a88 */ unsigned char RebuildLargePagesInitialized;
  /* 0x0a90 */ struct _MI_REBUILD_LARGE_PAGES RebuildLargePagesItem;
  /* 0x0cb8 */ long __PADDING__[2];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x0cc0 */
...
} MI_PARTITION_COMMIT, *PMI_PARTITION_COMMIT; /* size: 0x0038 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0168 */ struct _MI_PARTITION_MODWRITES Modwriter;
  /* 0x0410 */ struct _MI_PARTITION_STORES Store;
  /* 0x0490 */ struct _MI_PARTITION_SEGMENTS Segments;
  /* 0x05c0 */ struct _MI_PARTITION_PAGE_LISTS PageLists;
  /* 0x1280 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x12b8 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1300 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1488 */ void* WorkingSetControl;
  /* 0x1490 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x14c0 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x25c0 */
