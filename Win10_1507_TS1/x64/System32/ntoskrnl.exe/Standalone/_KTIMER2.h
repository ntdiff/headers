...
typedef struct _KTIMER2
{
  ...
  /* 0x0048 */ unsigned __int64 DueTime;
  /* 0x0050 */ unsigned __int64 MaximumDueTime;
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      /* 0x0081 */ unsigned char Plain : 1; /* bit position: 0 */
      ...
      /* 0x0081 */ unsigned char NoWakeFinite : 1; /* bit position: 4 */
      /* 0x0081 */ unsigned char Unused : 3; /* bit position: 5 */
    }; /* bitfield */
  }; /* size: 0x0001 */
