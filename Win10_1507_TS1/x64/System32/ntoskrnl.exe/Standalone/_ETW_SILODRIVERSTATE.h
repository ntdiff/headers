...
typedef struct _ETW_GUID_ENTRY
{
  ...
  /* 0x0178 */ struct _ESILO* ServerSilo;
} ETW_GUID_ENTRY, *PETW_GUID_ENTRY; /* size: 0x0180 */
...
typedef struct _ETW_SILODRIVERSTATE
{
  ...
  /* 0x0188 */ unsigned long AuditLoggerId;
  /* 0x0190 */ unsigned __int64 EtwPsProvRegHandle;
  /* 0x0198 */ unsigned short EtwpSecurityLoggers[8];
  /* 0x01a8 */ unsigned char EtwpSecurityProviderEnableMask;
  /* 0x01a9 */ unsigned char EtwpShutdownInProgress;
  /* 0x01aa */ char __PADDING__[6];
} ETW_SILODRIVERSTATE, *PETW_SILODRIVERSTATE; /* size: 0x01b0 */
