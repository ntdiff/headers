  ...
  union // _TAG_UNNAMED_176
  {
    union
    {
      ...
      struct // _TAG_UNNAMED_182
      {
        ...
        /* 0x0060 */ char RequestorMode;
        /* 0x0064 */ unsigned long NestingLevel;
      } /* size: 0x0058 */ AsyncRead;
    }; /* size: 0x0058 */
  } /* size: 0x0058 */ Parameters;
  /* 0x0068 */ unsigned char Function;
  /* 0x0069 */ char __PADDING__[7];
} WORK_QUEUE_ENTRY, *PWORK_QUEUE_ENTRY; /* size: 0x0070 */
