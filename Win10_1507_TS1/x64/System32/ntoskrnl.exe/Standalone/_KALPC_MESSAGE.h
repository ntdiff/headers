    ...
    union
    {
      struct
      {
        struct /* bitfield */
        {
          ...
          /* 0x0028 */ unsigned long ReserveReference : 1; /* bit position: 13 */
          /* 0x0028 */ unsigned long ReceiverReference : 1; /* bit position: 14 */
          /* 0x0028 */ unsigned long ViewAttributeRetrieved : 1; /* bit position: 15 */
