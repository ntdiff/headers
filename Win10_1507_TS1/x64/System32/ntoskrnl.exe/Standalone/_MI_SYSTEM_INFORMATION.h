...
} MI_SYSTEM_IMAGE_STATE, *PMI_SYSTEM_IMAGE_STATE; /* size: 0x00b0 */
...
} MI_PARTITION_STATE, *PMI_PARTITION_STATE; /* size: 0x0058 */
...
typedef struct _MI_SHUTDOWN_STATE
{
  ...
  /* 0x0048 */ unsigned char FreeListDiscard;
  /* 0x0050 */ struct _ETHREAD* MirrorHoldsPfn;
  /* 0x0058 */ unsigned long MirroringActive;
  /* 0x0060 */ struct _RTL_BITMAP_EX* MirrorBitMap;
  /* 0x0068 */ struct _RTL_BITMAP_EX* MirrorBitMapInterlocked;
  /* 0x0070 */ void* MirrorListLocks;
...
typedef struct _MI_ERROR_STATE
{
  ...
  /* 0x007c */ unsigned long WsleFailures[2];
  /* 0x0084 */ unsigned long WsLinear;
  /* 0x0088 */ unsigned long PageHashErrors;
  /* 0x008c */ unsigned long CheckZeroCount;
  /* 0x0090 */ volatile long ZeroedPageSingleBitErrorsDetected;
  /* 0x0094 */ volatile long BadPagesDetected;
  /* 0x0098 */ long ScrubPasses;
  /* 0x009c */ long ScrubBadPagesFound;
...
typedef struct _MI_COMMON_PAGE_STATE
{
  ...
  /* 0x0078 */ unsigned __int64 PageTableOfOnes;
  /* 0x0080 */ struct _MMPTE PdeOfOnes;
} MI_COMMON_PAGE_STATE, *PMI_COMMON_PAGE_STATE; /* size: 0x0088 */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x046c */ unsigned long LastUnloadedDriver;
  /* 0x0470 */ struct _UNLOADED_DRIVERS* UnloadedDrivers;
  /* 0x0478 */ unsigned __int64 PagefileHashPages;
  /* 0x0480 */ struct _SYSPTES_HEADER PteHeader;
  /* 0x0598 */ struct _MI_SPECIAL_POOL* SessionSpecialPool;
  /* 0x05a0 */ unsigned __int64 SystemVaTypeCount[14];
  /* 0x0610 */ long __PADDING__[12];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0430 */ struct _MI_SESSION_STATE Sessions;
  /* 0x04c0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x0520 */ struct _MI_HARDWARE_STATE Hardware;
  ...
  /* 0x0ab8 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x0b38 */ struct _MI_ERROR_STATE Errors;
  ...
  /* 0x1140 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x1180 */ struct _MI_RESAVAIL_TRACKER ResTrack;
