...
typedef struct _CM_KEY_CONTROL_BLOCK
{
  ...
  /* 0x0028 */ struct _EX_PUSH_LOCK KcbPushlock;
  union
  {
    /* 0x0030 */ struct _KTHREAD* Owner;
    /* 0x0030 */ long SharedCount;
  }; /* size: 0x0008 */
  struct /* bitfield */
  {
    /* 0x0038 */ unsigned char DelayedDeref : 1; /* bit position: 0 */
    /* 0x0038 */ unsigned char DelayedClose : 1; /* bit position: 1 */
    /* 0x0038 */ unsigned char Parking : 1; /* bit position: 2 */
  }; /* bitfield */
  /* 0x0039 */ unsigned char LayerSemantics;
  /* 0x003a */ short LayerHeight;
  /* 0x003c */ unsigned long Spare1;
  /* 0x0040 */ struct _CM_KEY_CONTROL_BLOCK* ParentKcb;
  /* 0x0048 */ struct _CM_NAME_CONTROL_BLOCK* NameBlock;
  /* 0x0050 */ struct _CM_KEY_SECURITY_CACHE* CachedSecurity;
  /* 0x0058 */ struct _CACHED_CHILD_LIST ValueCache;
  union
  {
    /* 0x0068 */ struct _CM_INDEX_HINT_BLOCK* IndexHint;
    /* 0x0068 */ unsigned long HashKey;
    /* 0x0068 */ unsigned long SubKeyCount;
  }; /* size: 0x0008 */
  union
  {
    /* 0x0070 */ struct _LIST_ENTRY KeyBodyListHead;
    /* 0x0070 */ struct _LIST_ENTRY ClonedListEntry;
  }; /* size: 0x0010 */
  /* 0x0080 */ struct _CM_KEY_BODY* KeyBodyArray[4];
  /* 0x00a0 */ union _LARGE_INTEGER KcbLastWriteTime;
  /* 0x00a8 */ unsigned short KcbMaxNameLen;
  /* 0x00aa */ unsigned short KcbMaxValueNameLen;
  /* 0x00ac */ unsigned long KcbMaxValueDataLen;
  struct /* bitfield */
  {
    /* 0x00b0 */ unsigned long KcbUserFlags : 4; /* bit position: 0 */
    /* 0x00b0 */ unsigned long KcbVirtControlFlags : 4; /* bit position: 4 */
    /* 0x00b0 */ unsigned long KcbDebug : 8; /* bit position: 8 */
    /* 0x00b0 */ unsigned long Flags : 16; /* bit position: 16 */
  }; /* bitfield */
  /* 0x00b4 */ unsigned long Spare3;
  /* 0x00b8 */ struct _CM_KCB_LAYER_INFO* LayerInfo;
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      /* 0x0120 */ unsigned __int64 FullKCBNameStale : 1; /* bit position: 0 */
      /* 0x0120 */ unsigned __int64 Reserved : 63; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0008 */
  /* 0x0128 */ unsigned __int64 SequenceNumber;
} CM_KEY_CONTROL_BLOCK, *PCM_KEY_CONTROL_BLOCK; /* size: 0x0130 */
