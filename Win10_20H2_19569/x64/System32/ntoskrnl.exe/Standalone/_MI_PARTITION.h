...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1908 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1a98 */ void* WorkingSetControl;
  /* 0x1aa0 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1ab0 */ unsigned long SessionDetachTimeStamp;
