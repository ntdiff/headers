...
class CCliModalLoop
{
  ...
  /* 0x0038 */ unsigned long _dwBlockTime;
  /* 0x003c */ unsigned long _dwCancelTimeout;
  /* 0x0040 */ int _fUseOldModalLoop;
  /* 0x0044 */ class CAptCallCtrl* _pACC;
  /* 0x0048 */ void* _hToken;
  /* 0x004c */ int _fCoWaitCalled;
}; /* size: 0x0050 */
