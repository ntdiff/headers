...
} HEAP_PERFORMANCE_COUNTERS_INFORMATION, *PHEAP_PERFORMANCE_COUNTERS_INFORMATION; /* size: 0x0044 */
...
typedef struct _HEAP_INFORMATION_ITEM
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x000c */ long __PADDING__[16];
    }; /* size: 0x0044 */
  }; /* size: 0x0044 */
} HEAP_INFORMATION_ITEM, *PHEAP_INFORMATION_ITEM; /* size: 0x004c */
