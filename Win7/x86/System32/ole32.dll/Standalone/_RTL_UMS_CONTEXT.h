...
typedef struct _RTL_UMS_CONTEXT
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x02d8 */ volatile unsigned long HasQuantumReq : 1; /* bit position: 1 */
      /* 0x02d8 */ volatile unsigned long HasAffinityReq : 1; /* bit position: 2 */
      /* 0x02d8 */ volatile unsigned long HasPriorityReq : 1; /* bit position: 3 */
      /* 0x02d8 */ volatile unsigned long Suspended : 1; /* bit position: 4 */
      /* 0x02d8 */ volatile unsigned long VolatileContext : 1; /* bit position: 5 */
      /* 0x02d8 */ volatile unsigned long Terminated : 1; /* bit position: 6 */
      /* 0x02d8 */ volatile unsigned long DebugActive : 1; /* bit position: 7 */
      /* 0x02d8 */ volatile unsigned long RunningOnSelfThread : 1; /* bit position: 8 */
      /* 0x02d8 */ volatile unsigned long DenyRunningOnSelfThread : 1; /* bit position: 9 */
      /* 0x02d8 */ volatile unsigned long ReservedFlags : 22; /* bit position: 10 */
    }; /* bitfield */
  ...
  union
  {
    struct /* bitfield */
    {
      /* 0x02e0 */ volatile unsigned __int64 KernelUpdateLock : 1; /* bit position: 0 */
      /* 0x02e0 */ volatile unsigned __int64 Reserved : 1; /* bit position: 1 */
      /* 0x02e0 */ volatile unsigned __int64 PrimaryClientID : 62; /* bit position: 2 */
    }; /* bitfield */
    /* 0x02e0 */ volatile unsigned __int64 ContextLock;
  }; /* size: 0x0008 */
  /* 0x02e8 */ unsigned __int64 QuantumValue;
  /* 0x02f0 */ struct _GROUP_AFFINITY AffinityMask;
  /* 0x02fc */ long Priority;
  /* 0x0300 */ struct _RTL_UMS_CONTEXT* PrimaryUmsContext;
  /* 0x0304 */ unsigned long SwitchCount;
  /* 0x0308 */ unsigned long KernelYieldCount;
  /* 0x030c */ unsigned long MixedYieldCount;
  /* 0x0310 */ unsigned long YieldCount;
  /* 0x0314 */ long __PADDING__[1];
} RTL_UMS_CONTEXT, *PRTL_UMS_CONTEXT; /* size: 0x0318 */
