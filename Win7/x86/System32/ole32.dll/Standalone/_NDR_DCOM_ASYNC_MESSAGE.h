...
typedef struct _NDR_DCOM_ASYNC_MESSAGE
{
  ...
  /* 0x0014 */ long nFinishParams;
  /* 0x0018 */ void* FinishParams;
  /* 0x001c */ unsigned char* BeginStack;
  /* 0x0020 */ unsigned char* FinishStack;
  /* 0x0024 */ unsigned long BeginStackSize;
  /* 0x0028 */ unsigned long FinishStackSize;
  /* 0x002c */ struct _Flags Flags;
  /* 0x0030 */ void* pThis;
  /* 0x0034 */ void* pAsyncPB;
  /* 0x0038 */ void* pAsyncSB;
  /* 0x003c */ unsigned long* pdwStubPhase;
  /* 0x0040 */ unsigned short StubPhase;
  /* 0x0044 */ unsigned long ErrorCode;
  /* 0x0048 */ struct _RPC_MESSAGE RpcMsg;
  /* 0x0074 */ struct _MIDL_STUB_MESSAGE StubMsg;
  /* 0x0150 */ struct _NDR_PROC_CONTEXT ProcContext;
  /* 0x03f4 */ unsigned char* pArg;
  /* 0x03f8 */ unsigned __int64 AppStack;
} NDR_DCOM_ASYNC_MESSAGE, *PNDR_DCOM_ASYNC_MESSAGE; /* size: 0x0400 */
