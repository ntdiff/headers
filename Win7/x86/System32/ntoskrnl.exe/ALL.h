...
typedef struct _MMVAD_LONG
{
  ...
  /* 0x0030 */ struct _LIST_ENTRY ViewLinks;
  /* 0x0038 */ struct _EPROCESS* VadsProcess;
  union // _TAG_UNNAMED_13
  {
    union
    {
      /* 0x003c */ struct _LIST_ENTRY List;
      /* 0x003c */ struct _MMADDRESS_LIST Secured;
    }; /* size: 0x0008 */
  } /* size: 0x0008 */ u3;
  union // _TAG_UNNAMED_14
  {
    union
    {
      /* 0x0044 */ struct _MMBANKED_SECTION* Banked;
      /* 0x0044 */ struct _MMEXTEND_INFO* ExtendedInfo;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u4;
} MMVAD_LONG, *PMMVAD_LONG; /* size: 0x0048 */
...
} RELATION_LIST_ENTRY, *PRELATION_LIST_ENTRY; /* size: 0x000c */
...
typedef struct _KINTERRUPT
{
  ...
  /* 0x0039 */ char Pad[3];
  /* 0x003c */ enum _KINTERRUPT_MODE Mode;
  /* 0x0040 */ enum _KINTERRUPT_POLARITY Polarity;
  /* 0x0044 */ unsigned long ServiceCount;
  /* 0x0048 */ unsigned long DispatchCount;
  /* 0x004c */ long Padding_4;
  /* 0x0050 */ unsigned __int64 Rsvd1;
  /* 0x0058 */ unsigned long DispatchCode[135];
  /* 0x0274 */ long __PADDING__[1];
} KINTERRUPT, *PKINTERRUPT; /* size: 0x0278 */
...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0050 */ unsigned __int64 ProgrammedRTCTime;
  /* 0x0058 */ unsigned char WakeOnRTC;
  /* 0x0059 */ char Padding_9[3];
  /* 0x005c */ struct _DIAGNOSTIC_BUFFER* WakeTimerInfo;
  /* 0x0060 */ struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;
  /* 0x00ac */ long __PADDING__[1];
} POP_POWER_ACTION, *PPOP_POWER_ACTION; /* size: 0x00b0 */
...
} SHARED_CACHE_MAP, *PSHARED_CACHE_MAP; /* size: 0x0158 */
...
typedef struct _HEAP_COUNTERS
{
  ...
  /* 0x0040 */ unsigned long AllocAndFreeOps;
  /* 0x0044 */ unsigned long InBlockDeccommits;
  /* 0x0048 */ unsigned long InBlockDeccomitSize;
  /* 0x004c */ unsigned long HighWatermarkSize;
  /* 0x0050 */ unsigned long LastPolledSize;
} HEAP_COUNTERS, *PHEAP_COUNTERS; /* size: 0x0054 */
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x003c */ unsigned long Reserved : 19; /* bit position: 13 */
    }; /* bitfield */
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x00b8 */ volatile unsigned long ReservedFlags : 23; /* bit position: 9 */
    }; /* bitfield */
...
typedef struct _PO_DEVICE_NOTIFY_ORDER
{
  ...
  /* 0x0001 */ char Padding_51[3];
  /* 0x0004 */ struct _DEVICE_OBJECT** WarmEjectPdoPointer;
  /* 0x0008 */ struct _PO_NOTIFY_ORDER_LEVEL OrderLevel[9];
} PO_DEVICE_NOTIFY_ORDER, *PPO_DEVICE_NOTIFY_ORDER; /* size: 0x0170 */
...
typedef struct _PPM_IDLE_STATES
{
  ...
  /* 0x0015 */ char Padding_57[3];
  /* 0x0018 */ struct _KAFFINITY_EX TargetProcessors;
  /* 0x0024 */ long Padding_58;
  /* 0x0028 */ struct _PPM_IDLE_STATE State[1];
} PPM_IDLE_STATES, *PPPM_IDLE_STATES; /* size: 0x0068 */
...
typedef struct _HANDLE_TABLE
{
  ...
  /* 0x0028 */ unsigned long FirstFreeHandle;
  /* 0x002c */ struct _HANDLE_TABLE_ENTRY* LastFreeHandleEntry;
  /* 0x0030 */ unsigned long HandleCount;
  /* 0x0034 */ unsigned long NextHandleNeedingPool;
  /* 0x0038 */ unsigned long HandleCountHighWatermark;
} HANDLE_TABLE, *PHANDLE_TABLE; /* size: 0x003c */
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0280 */ unsigned long SystemThread : 1; /* bit position: 4 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x015c */ long Padding_64;
  union
  {
    /* 0x0160 */ struct _HARDWARE_PTE PageDirectoryPte;
...
typedef struct _PENDING_RELATIONS_LIST_ENTRY
{
  ...
  /* 0x0032 */ char Padding_71[2];
  /* 0x0034 */ enum _SYSTEM_POWER_STATE LightestSleepState;
  /* 0x0038 */ struct DOCK_INTERFACE* DockInterface;
} PENDING_RELATIONS_LIST_ENTRY, *PPENDING_RELATIONS_LIST_ENTRY; /* size: 0x003c */
...
} DEVICE_OBJECT_POWER_EXTENSION, *PDEVICE_OBJECT_POWER_EXTENSION; /* size: 0x0040 */
...
} FSRTL_ADVANCED_FCB_HEADER, *PFSRTL_ADVANCED_FCB_HEADER; /* size: 0x0040 */
...
typedef struct _OPEN_PACKET
{
  ...
  /* 0x005c */ struct _IO_DRIVER_CREATE_CONTEXT DriverCreateContext;
  /* 0x006c */ long __PADDING__[1];
...
typedef struct _CONTROL_AREA
{
  ...
  /* 0x0020 */ unsigned long FlushInProgressCount;
  /* 0x0024 */ struct _EX_FAST_REF FilePointer;
  /* 0x0028 */ volatile long ControlAreaLock;
  union
  {
    /* 0x002c */ unsigned long ModifiedWriteCount;
  ...
  /* 0x0048 */ struct _LIST_ENTRY ViewList;
...
} PNP_DEVICE_EVENT_ENTRY, *PPNP_DEVICE_EVENT_ENTRY; /* size: 0x0064 */
...
typedef struct _ETW_GUID_ENTRY
{
  ...
  /* 0x0158 */ struct _EVENT_FILTER_HEADER* FilterData[8];
...
} HIVE_LIST_ENTRY, *PHIVE_LIST_ENTRY; /* size: 0x0058 */
...
typedef struct _KALPC_MESSAGE
{
    ...
    union
    {
      struct // _TAG_UNNAMED_167
      {
        struct /* bitfield */
        {
          ...
          /* 0x0018 */ unsigned long ViewAttributeRetrieved : 1; /* bit position: 14 */
          /* 0x0018 */ unsigned long InDispatch : 1; /* bit position: 15 */
        }; /* bitfield */
      } /* size: 0x0004 */ s1;
  ...
  /* 0x0040 */ struct _KALPC_MESSAGE_ATTRIBUTES MessageAttributes;
  /* 0x005c */ void* DataUserVa;
  /* 0x0060 */ void* DataSystemVa;
...
typedef struct _OBJECT_TYPE
{
  ...
  /* 0x0078 */ struct _EX_PUSH_LOCK TypeLock;
  /* 0x007c */ unsigned long Key;
  /* 0x0080 */ struct _LIST_ENTRY CallbackList;
} OBJECT_TYPE, *POBJECT_TYPE; /* size: 0x0088 */
...
typedef struct _TOKEN
{
  ...
  /* 0x00b1 */ char Padding_123[3];
  /* 0x00b4 */ unsigned long IntegrityLevelIndex;
  /* 0x00b8 */ unsigned long MandatoryPolicy;
  /* 0x00bc */ struct _SEP_LOGON_SESSION_REFERENCES* LogonSession;
  /* 0x00c0 */ struct _LUID OriginatingLogonSession;
  /* 0x00c8 */ struct _SID_AND_ATTRIBUTES_HASH SidHash;
  /* 0x0150 */ struct _SID_AND_ATTRIBUTES_HASH RestrictedSidHash;
  /* 0x01d8 */ struct _AUTHZBASEP_SECURITY_ATTRIBUTES_INFORMATION* pSecurityAttributes;
  /* 0x01dc */ unsigned long VariablePart;
} TOKEN, *PTOKEN; /* size: 0x01e0 */
...
typedef struct _VF_TARGET_DRIVER
{
  ...
  /* 0x0014 */ struct _VF_TARGET_VERIFIED_DRIVER_DATA* VerifiedData;
} VF_TARGET_DRIVER, *PVF_TARGET_DRIVER; /* size: 0x0018 */
...
typedef struct _VF_TARGET_VERIFIED_DRIVER_DATA
{
  ...
  /* 0x0030 */ volatile unsigned long PeakPagedPoolAllocations;
  /* 0x0034 */ volatile unsigned long PeakNonPagedPoolAllocations;
  /* 0x0038 */ volatile unsigned long PagedBytes;
  /* 0x003c */ volatile unsigned long NonPagedBytes;
  /* 0x0040 */ volatile unsigned long PeakPagedBytes;
  /* 0x0044 */ volatile unsigned long PeakNonPagedBytes;
...
typedef struct _PNP_DEVICE_COMPLETION_REQUEST
{
  ...
  /* 0x0030 */ struct _DRIVER_OBJECT* FailingDriver;
  /* 0x0034 */ long ReferenceCount;
} PNP_DEVICE_COMPLETION_REQUEST, *PPNP_DEVICE_COMPLETION_REQUEST; /* size: 0x0038 */
...
typedef struct _POP_DEVICE_SYS_STATE
{
  ...
  /* 0x001d */ char Padding_135[3];
  /* 0x0020 */ struct _PO_DEVICE_NOTIFY_ORDER Order;
  /* 0x0190 */ struct _LIST_ENTRY Pending;
  /* 0x0198 */ long Status;
  /* 0x019c */ struct _DEVICE_OBJECT* FailedDevice;
  /* 0x01a0 */ unsigned char Waking;
  /* 0x01a1 */ unsigned char Cancelled;
  /* 0x01a2 */ unsigned char IgnoreErrors;
  /* 0x01a3 */ unsigned char IgnoreNotImplemented;
  /* 0x01a4 */ unsigned char TimeRefreshLockAcquired;
  /* 0x01a5 */ char __PADDING__[3];
} POP_DEVICE_SYS_STATE, *PPOP_DEVICE_SYS_STATE; /* size: 0x01a8 */
...
} VF_AVL_TABLE, *PVF_AVL_TABLE; /* size: 0x003c */
