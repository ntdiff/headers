...
typedef struct _PPM_IDLE_STATES
{
  ...
  /* 0x0015 */ char Padding_29[3];
  /* 0x0018 */ struct _KAFFINITY_EX TargetProcessors;
  /* 0x0024 */ struct _PPM_IDLE_STATE State[1];
} PPM_IDLE_STATES, *PPPM_IDLE_STATES; /* size: 0x0054 */
