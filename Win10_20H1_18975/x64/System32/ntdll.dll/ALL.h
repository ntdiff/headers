...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_54[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_55[2];
...
typedef struct _KPCR
{
  ...
  /* 0x0178 */ long Padding_68[2];
  /* 0x0180 */ struct _KPRCB Prcb;
} KPCR, *PKPCR; /* size: 0xb080 */
...
typedef struct _KNODE
{
  ...
  /* 0x0070 */ long Padding_82[4];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_83;
  union
  {
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x016d */ char Padding_87[3];
  /* 0x0170 */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[5];
  /* 0x01fc */ unsigned long QosDisableReasons[5];
  /* 0x0210 */ unsigned short QosEquivalencyMasks[5];
  /* 0x021a */ unsigned char QosSupported;
  /* 0x021b */ char Padding_88;
  /* 0x021c */ volatile unsigned long SelectionGeneration;
  /* 0x0220 */ struct _PERF_CONTROL_STATE_SELECTION QosSelection[5];
  /* 0x02e8 */ unsigned __int64 PerfChangeTime;
  /* 0x02f0 */ unsigned long PerfChangeIntervalCount;
  /* 0x02f4 */ unsigned char Force;
  /* 0x02f5 */ unsigned char Update;
  /* 0x02f6 */ unsigned char Apply;
  /* 0x02f7 */ char __PADDING__[1];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x02f8 */
