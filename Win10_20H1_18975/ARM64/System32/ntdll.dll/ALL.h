...
typedef struct _KNODE
{
  ...
  /* 0x00b0 */ long Padding_12[20];
  /* 0x0100 */ unsigned long SiblingMask;
  /* 0x0104 */ long Padding_13;
  union
  {
...
typedef struct _KPRCB
{
  ...
  /* 0x162c */ long Padding_51;
  /* 0x1630 */ void* HyperPte;
  /* 0x1638 */ void* MmInternal;
  /* 0x1640 */ unsigned __int64 GenerationTarget;
  /* 0x1648 */ unsigned __int64 PcbPad21[4];
  ...
  /* 0x16a8 */ long Padding_52[22];
  /* 0x1700 */ struct _SYNCH_COUNTERS SynchCounters;
  /* 0x17b8 */ unsigned __int64 PteBitCache;
  /* 0x17c0 */ unsigned long PteBitOffset;
  /* 0x17c4 */ long Padding_53;
  /* 0x17c8 */ struct _FILESYSTEM_DISK_COUNTERS FsCounters;
  /* 0x17d8 */ unsigned __int64 PanicStackBase;
  /* 0x17e0 */ void* IsrStack;
  /* 0x17e8 */ long Padding_54[6];
  /* 0x1800 */ struct _KTIMER_TABLE TimerTable;
  /* 0x5a18 */ long Padding_55[26];
  /* 0x5a80 */ struct _GENERAL_LOOKASIDE_POOL PPNxPagedLookasideList[32];
  /* 0x6680 */ struct _GENERAL_LOOKASIDE_POOL PPNPagedLookasideList[32];
  /* 0x7280 */ struct _GENERAL_LOOKASIDE_POOL PPPagedLookasideList[32];
  /* 0x7e80 */ struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;
  /* 0x7e88 */ struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;
  /* 0x7e90 */ struct _KDPC AbDpc;
  /* 0x7ed0 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x7f24 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x7f78 */ long Padding_56[2];
  /* 0x7f80 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x81f0 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x82f0 */ unsigned long TimerExpirationTraceCount;
  /* 0x82f4 */ long Padding_57;
  /* 0x82f8 */ void* ExSaPageArray;
  /* 0x8300 */ volatile long FreezePowerOff;
  /* 0x8304 */ long Padding_58;
  /* 0x8308 */ struct _KSTATIC_AFFINITY_BLOCK StaticAffinity;
  /* 0x85a8 */ struct _KSECURE_FAULT_INFORMATION SecureFault;
  /* 0x85b8 */ unsigned __int64 ImportantCycles;
  /* 0x85c0 */ unsigned __int64 UnimportantCycles;
  /* 0x85c8 */ unsigned long ReadyThreadCount;
  /* 0x85cc */ long Padding_59;
  /* 0x85d0 */ unsigned __int64 ReadyQueueExpectedRunTime;
  /* 0x85d8 */ unsigned long DpcWatchdogProfileCumulativeDpcThreshold;
  /* 0x85dc */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x85e0 */ void** DpcWatchdogProfile;
  /* 0x85e8 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x85f0 */ void* SchedulerAssist;
  /* 0x85f8 */ struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
  /* 0x8658 */ long Padding_60[10];
  /* 0x8680 */ struct _REQUEST_MAILBOX RequestMailbox[1];
  /* 0x86c0 */ long __PADDING__[16];
} KPRCB, *PKPRCB; /* size: 0x8700 */
...
typedef struct _KPROCESS
{
  ...
  /* 0x034e */ char Padding_108[2];
  /* 0x0350 */ volatile union _KSTACK_COUNT StackCount;
  /* 0x0354 */ long Padding_109;
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_121[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_122[2];
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0488 */ unsigned char IsDownlevelContainer;
  /* 0x0489 */ char __PADDING__[7];
} ESERVERSILO_GLOBALS, *PESERVERSILO_GLOBALS; /* size: 0x0490 */
