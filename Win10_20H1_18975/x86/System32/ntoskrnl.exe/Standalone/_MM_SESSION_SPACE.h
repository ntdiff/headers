...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0200 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x0300 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0304 */ unsigned long TopLevelPteLockBits[128];
  /* 0x0508 */ struct _MMPTE PageTables[1024];
  /* 0x2508 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x250c */ long PoolBigEntriesInUse;
  /* 0x2510 */ volatile long PagedPoolPdeCount;
  /* 0x2514 */ unsigned long DynamicSessionPdeCount;
  /* 0x2518 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x254c */ void* PoolTrackTableExpansion;
  /* 0x2550 */ unsigned long PoolTrackTableExpansionSize;
  /* 0x2554 */ void* PoolTrackBigPages;
  /* 0x2558 */ unsigned long PoolTrackBigPagesSize;
  /* 0x255c */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x2560 */ enum _IO_SESSION_STATE IoState;
  /* 0x2564 */ unsigned long IoStateSequence;
  /* 0x2568 */ struct _KEVENT IoNotificationEvent;
  /* 0x2578 */ struct _EJOB* ServerSilo;
  /* 0x2580 */ unsigned __int64 CreateTime;
