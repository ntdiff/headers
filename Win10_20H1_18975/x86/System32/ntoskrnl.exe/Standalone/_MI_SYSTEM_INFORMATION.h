...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x41c0 */ unsigned long Cookie;
  /* 0x41c4 */ void* volatile* BootRegistryRuns;
  /* 0x41c8 */ volatile long ZeroingDisabled;
  /* 0x41cc */ unsigned char FullyInitialized;
  /* 0x41cd */ unsigned char SafeBooted;
  /* 0x41d0 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x41d8 */ const struct _tlgProvider_t* TraceLogging;
