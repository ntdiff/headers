...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x0478 */ volatile long DirectedTransitionCallCount;
  /* 0x0480 */ void* DirectedTransitionCompletionContext;
  /* 0x0488 */ enum _DEVICE_POWER_STATE DirectedPowerDownState;
  /* 0x0490 */ struct _POP_DEVICE_POWER_PROFILE* PowerProfile;
  /* 0x0498 */ struct _UNICODE_STRING FriendlyName;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x04a8 */
