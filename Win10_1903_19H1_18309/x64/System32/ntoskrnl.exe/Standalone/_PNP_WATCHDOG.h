...
typedef struct _PNP_WATCHDOG
{
  ...
  /* 0x0088 */ unsigned char WatchdogEnabled;
  /* 0x0089 */ unsigned char WatchdogSecondChance;
  /* 0x0090 */ struct _KEVENT WatchdogComplete;
  /* 0x00a8 */ struct _WORK_QUEUE_ITEM WatchdogWorkItem;
  /* 0x00c8 */ enum _PNP_WATCHDOG_TYPE WatchdogContextType;
  /* 0x00d0 */ struct _FAST_MUTEX WatchdogLock;
  /* 0x0108 */ void* WatchdogContext;
} PNP_WATCHDOG, *PPNP_WATCHDOG; /* size: 0x0110 */
