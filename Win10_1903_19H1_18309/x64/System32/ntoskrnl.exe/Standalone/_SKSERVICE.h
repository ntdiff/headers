typedef enum _SKSERVICE
{
  ...
  SECURESERVICE_LOAD_ENCLAVE_MODULE = 45,
  SECURESERVICE_INITIALIZE_ENCLAVE = 46,
  SECURESERVICE_TERMINATE_ENCLAVE = 47,
  SECURESERVICE_DELETE_ENCLAVE = 48,
  SECURESERVICE_CONNECT_SW_INTERRUPT = 49,
  SECURESERVICE_RELAX_HYPERGUARD_QUOTA = 50,
  SECURESERVICE_LIVEDUMP_QUERY_SECONDARYDATA_SIZE = 51,
  SECURESERVICE_LIVEDUMP_START = 52,
  SECURESERVICE_LIVEDUMP_ADD_BUFFER = 53,
  SECURESERVICE_LIVEDUMP_SETUP_BUFFER = 54,
  SECURESERVICE_LIVEDUMP_FINALIZE = 55,
  SECURESERVICE_LIVEDUMP_ABORT = 56,
  SECURESERVICE_LIVEDUMP_CAPTURE_PROCESS = 57,
  SECURESERVICE_NOTIFY_POWER_STATE = 58,
  SECURESERVICE_QUERY_PROFILE_INFORMATION = 59,
  SECURESERVICE_UPDATE_FREEZE_BIAS = 60,
  SECURESERVICE_CREATE_SECURE_SECTION = 61,
  SECURESERVICE_DELETE_SECURE_SECTION = 62,
  SECURESERVICE_QUERY_SECURE_DEVICE = 63,
  SECURESERVICE_UNPROTECT_SECURE_DEVICE = 64,
  SECURESERVICE_DETERMINE_HOT_PATCH_TYPE = 65,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE_SIZE = 66,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE = 67,
  SECURESERVICE_APPLY_HOT_PATCH = 68,
  SECURESERVICE_REVERT_HOT_PATCH = 69,
  SECURESERVICE_PROVISION_DUMP_KEYS = 70,
  SECURESERVICE_CAPTURE_PGO_DATA = 71,
  SECURESERVICE_SET_BREAKPOINT = 72,
  ...
  SECURESERVICE_MAKE_PROTECTED_PAGE_WRITABLE = 246,
  SECURESERVICE_MAKE_PROTECTED_PAGE_EXECUTABLE = 247,
  SECURESERVICE_QUERY_STRONG_CODE_FEATURES = 248,
  SECURESERVICE_INVOKE_EFI_RUNTIME_SERVICE = 249,
  SECURESERVICE_LIVEDUMP_COLLECT_LIVE_DUMP = 250,
  SECURESERVICE_REGISTER_LOG_PAGES = 251,
  SECURESERVICE_RECLAIM_PARTITION_PAGES = 252,
  SECURESERVICE_BIND_NT_KERNEL_IMPORTS = 253,
  SECURESERVICE_SET_PLACEHOLDER_PAGES = 254,
  SECURESERVICE_VERIFY_PAGE = 255,
  SECURESERVICE_PREPARE_FOR_HIBERNATION = 256,
  SECURESERVICE_PREPARE_FOR_CRASHDUMP = 257,
  SECURESERVICE_REPORT_BUGCHECK_PROGRESS = 258,
  SECURESERVICE_SHUTDOWN = 259,
  SECURESERVICE_QUERY_SECURE_PCI_INFO = 260,
  SECURESERVICE_ACCESS_PCI_DEVICE = 261,
  SECURESERVICE_REINITIALIZE_DEBUGGER_TRANSPORT = 262,
  SECURESERVICE_KSR_CALL = 263,
  SECURESERVICE_SVC_CALL = 264,
