...
typedef struct _KPRCB
{
  ...
  /* 0x6eaa */ unsigned short PrcbPad138e;
  /* 0x6eac */ unsigned long DbgMceNestingLevel;
  /* 0x6eb0 */ unsigned long DbgMceFlags;
  /* 0x6eb4 */ unsigned long PrcbPad139b;
...
typedef struct _KPROCESS
{
  ...
  /* 0x01c4 */ unsigned long ThreadSeed[20];
...
typedef struct _PROC_PERF_CONSTRAINT
{
  ...
  /* 0x0010 */ unsigned char HiddenProcessor;
  /* 0x0011 */ char Padding_86[3];
  /* 0x0014 */ unsigned long HiddenProcessorId;
  /* 0x0018 */ unsigned long PlatformCap;
  /* 0x001c */ unsigned long ThermalCap;
  /* 0x0020 */ unsigned long LimitReasons;
  /* 0x0024 */ long Padding_87;
  ...
  /* 0x0079 */ unsigned char UseQosUpdateLock;
  /* 0x007a */ char Padding_89[6];
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x0120 */ void* PerfControlHandlerHidden /* function */;
  ...
  /* 0x0161 */ char Padding_109[3];
  /* 0x0164 */ unsigned long DesiredPercent;
  /* 0x0168 */ unsigned long GuaranteedPercent;
  /* 0x016c */ unsigned char EngageResponsivenessOverrides;
  /* 0x016d */ char Padding_110[3];
  /* 0x0170 */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[4];
  /* 0x01e0 */ unsigned long QosDisableReasons[4];
  /* 0x01f0 */ unsigned short QosEquivalencyMasks[4];
  /* 0x01f8 */ unsigned char QosSupported;
  /* 0x01f9 */ char Padding_111[3];
  /* 0x01fc */ volatile unsigned long SelectionGeneration;
  /* 0x0200 */ struct _PERF_CONTROL_STATE_SELECTION QosSelection[4];
  /* 0x02a0 */ unsigned __int64 PerfChangeTime;
  /* 0x02a8 */ unsigned long PerfChangeIntervalCount;
  /* 0x02ac */ unsigned char Force;
  /* 0x02ad */ unsigned char Update;
  /* 0x02ae */ unsigned char Apply;
  /* 0x02af */ char __PADDING__[1];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x02b0 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x02e0 */ struct _EX_PUSH_LOCK ProcessLock;
  /* 0x02e8 */ void* UniqueProcessId;
  /* 0x02f0 */ struct _LIST_ENTRY ActiveProcessLinks;
  /* 0x0300 */ struct _EX_RUNDOWN_REF RundownProtect;
  union
  {
    /* 0x0308 */ unsigned long Flags2;
    struct /* bitfield */
    {
      /* 0x0308 */ unsigned long JobNotReallyActive : 1; /* bit position: 0 */
      /* 0x0308 */ unsigned long AccountingFolded : 1; /* bit position: 1 */
      /* 0x0308 */ unsigned long NewProcessReported : 1; /* bit position: 2 */
      /* 0x0308 */ unsigned long ExitProcessReported : 1; /* bit position: 3 */
      /* 0x0308 */ unsigned long ReportCommitChanges : 1; /* bit position: 4 */
      /* 0x0308 */ unsigned long LastReportMemory : 1; /* bit position: 5 */
      /* 0x0308 */ unsigned long ForceWakeCharge : 1; /* bit position: 6 */
      /* 0x0308 */ unsigned long CrossSessionCreate : 1; /* bit position: 7 */
      /* 0x0308 */ unsigned long NeedsHandleRundown : 1; /* bit position: 8 */
      /* 0x0308 */ unsigned long RefTraceEnabled : 1; /* bit position: 9 */
      /* 0x0308 */ unsigned long PicoCreated : 1; /* bit position: 10 */
      /* 0x0308 */ unsigned long EmptyJobEvaluated : 1; /* bit position: 11 */
      /* 0x0308 */ unsigned long DefaultPagePriority : 3; /* bit position: 12 */
      /* 0x0308 */ unsigned long PrimaryTokenFrozen : 1; /* bit position: 15 */
      /* 0x0308 */ unsigned long ProcessVerifierTarget : 1; /* bit position: 16 */
      /* 0x0308 */ unsigned long RestrictSetThreadContext : 1; /* bit position: 17 */
      /* 0x0308 */ unsigned long AffinityPermanent : 1; /* bit position: 18 */
      /* 0x0308 */ unsigned long AffinityUpdateEnable : 1; /* bit position: 19 */
      /* 0x0308 */ unsigned long PropagateNode : 1; /* bit position: 20 */
      /* 0x0308 */ unsigned long ExplicitAffinity : 1; /* bit position: 21 */
      /* 0x0308 */ unsigned long ProcessExecutionState : 2; /* bit position: 22 */
      /* 0x0308 */ unsigned long EnableReadVmLogging : 1; /* bit position: 24 */
      /* 0x0308 */ unsigned long EnableWriteVmLogging : 1; /* bit position: 25 */
      /* 0x0308 */ unsigned long FatalAccessTerminationRequested : 1; /* bit position: 26 */
      /* 0x0308 */ unsigned long DisableSystemAllowedCpuSet : 1; /* bit position: 27 */
      /* 0x0308 */ unsigned long ProcessStateChangeRequest : 2; /* bit position: 28 */
      /* 0x0308 */ unsigned long ProcessStateChangeInProgress : 1; /* bit position: 30 */
      /* 0x0308 */ unsigned long InPrivate : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x030c */ unsigned long Flags;
    struct /* bitfield */
    {
      /* 0x030c */ unsigned long CreateReported : 1; /* bit position: 0 */
      /* 0x030c */ unsigned long NoDebugInherit : 1; /* bit position: 1 */
      /* 0x030c */ unsigned long ProcessExiting : 1; /* bit position: 2 */
      /* 0x030c */ unsigned long ProcessDelete : 1; /* bit position: 3 */
      /* 0x030c */ unsigned long ManageExecutableMemoryWrites : 1; /* bit position: 4 */
      /* 0x030c */ unsigned long VmDeleted : 1; /* bit position: 5 */
      /* 0x030c */ unsigned long OutswapEnabled : 1; /* bit position: 6 */
      /* 0x030c */ unsigned long Outswapped : 1; /* bit position: 7 */
      /* 0x030c */ unsigned long FailFastOnCommitFail : 1; /* bit position: 8 */
      /* 0x030c */ unsigned long Wow64VaSpace4Gb : 1; /* bit position: 9 */
      /* 0x030c */ unsigned long AddressSpaceInitialized : 2; /* bit position: 10 */
      /* 0x030c */ unsigned long SetTimerResolution : 1; /* bit position: 12 */
      /* 0x030c */ unsigned long BreakOnTermination : 1; /* bit position: 13 */
      /* 0x030c */ unsigned long DeprioritizeViews : 1; /* bit position: 14 */
      /* 0x030c */ unsigned long WriteWatch : 1; /* bit position: 15 */
      /* 0x030c */ unsigned long ProcessInSession : 1; /* bit position: 16 */
      /* 0x030c */ unsigned long OverrideAddressSpace : 1; /* bit position: 17 */
      /* 0x030c */ unsigned long HasAddressSpace : 1; /* bit position: 18 */
      /* 0x030c */ unsigned long LaunchPrefetched : 1; /* bit position: 19 */
      /* 0x030c */ unsigned long Background : 1; /* bit position: 20 */
      /* 0x030c */ unsigned long VmTopDown : 1; /* bit position: 21 */
      /* 0x030c */ unsigned long ImageNotifyDone : 1; /* bit position: 22 */
      /* 0x030c */ unsigned long PdeUpdateNeeded : 1; /* bit position: 23 */
      /* 0x030c */ unsigned long VdmAllowed : 1; /* bit position: 24 */
      /* 0x030c */ unsigned long ProcessRundown : 1; /* bit position: 25 */
      /* 0x030c */ unsigned long ProcessInserted : 1; /* bit position: 26 */
      /* 0x030c */ unsigned long DefaultIoPriority : 3; /* bit position: 27 */
      /* 0x030c */ unsigned long ProcessSelfDelete : 1; /* bit position: 30 */
      /* 0x030c */ unsigned long SetTimerResolutionLink : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0310 */ union _LARGE_INTEGER CreateTime;
  /* 0x0318 */ unsigned __int64 ProcessQuotaUsage[2];
  /* 0x0328 */ unsigned __int64 ProcessQuotaPeak[2];
  /* 0x0338 */ unsigned __int64 PeakVirtualSize;
  /* 0x0340 */ unsigned __int64 VirtualSize;
  /* 0x0348 */ struct _LIST_ENTRY SessionProcessLinks;
  union
  {
    /* 0x0358 */ void* ExceptionPortData;
    /* 0x0358 */ unsigned __int64 ExceptionPortValue;
    /* 0x0358 */ unsigned __int64 ExceptionPortState : 3; /* bit position: 0 */
  }; /* size: 0x0008 */
  /* 0x0360 */ struct _EX_FAST_REF Token;
  /* 0x0368 */ unsigned __int64 MmReserved;
  /* 0x0370 */ struct _EX_PUSH_LOCK AddressCreationLock;
  /* 0x0378 */ struct _EX_PUSH_LOCK PageTableCommitmentLock;
  /* 0x0380 */ struct _ETHREAD* RotateInProgress;
  /* 0x0388 */ struct _ETHREAD* ForkInProgress;
  /* 0x0390 */ struct _EJOB* volatile CommitChargeJob;
  /* 0x0398 */ struct _RTL_AVL_TREE CloneRoot;
  /* 0x03a0 */ volatile unsigned __int64 NumberOfPrivatePages;
  /* 0x03a8 */ volatile unsigned __int64 NumberOfLockedPages;
  /* 0x03b0 */ void* Win32Process;
  /* 0x03b8 */ struct _EJOB* volatile Job;
  /* 0x03c0 */ void* SectionObject;
  /* 0x03c8 */ void* SectionBaseAddress;
  /* 0x03d0 */ unsigned long Cookie;
  /* 0x03d4 */ long Padding_117;
  /* 0x03d8 */ struct _PAGEFAULT_HISTORY* WorkingSetWatch;
  /* 0x03e0 */ void* Win32WindowStation;
  /* 0x03e8 */ void* InheritedFromUniqueProcessId;
  /* 0x03f0 */ void* Spare0;
  /* 0x03f8 */ volatile unsigned __int64 OwnerProcessId;
  /* 0x0400 */ struct _PEB* Peb;
  /* 0x0408 */ struct _MM_SESSION_SPACE* Session;
  /* 0x0410 */ void* Spare1;
  /* 0x0418 */ struct _EPROCESS_QUOTA_BLOCK* QuotaBlock;
  /* 0x0420 */ struct _HANDLE_TABLE* ObjectTable;
  /* 0x0428 */ void* DebugPort;
  /* 0x0430 */ struct _EWOW64PROCESS* WoW64Process;
  /* 0x0438 */ void* DeviceMap;
  /* 0x0440 */ void* EtwDataSource;
  /* 0x0448 */ unsigned __int64 PageDirectoryPte;
  /* 0x0450 */ struct _FILE_OBJECT* ImageFilePointer;
  /* 0x0458 */ unsigned char ImageFileName[15];
  /* 0x0467 */ unsigned char PriorityClass;
  /* 0x0468 */ void* SecurityPort;
  /* 0x0470 */ struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;
  /* 0x0478 */ struct _LIST_ENTRY JobLinks;
  /* 0x0488 */ void* HighestUserAddress;
  /* 0x0490 */ struct _LIST_ENTRY ThreadListHead;
  /* 0x04a0 */ volatile unsigned long ActiveThreads;
  /* 0x04a4 */ unsigned long ImagePathHash;
  /* 0x04a8 */ unsigned long DefaultHardErrorProcessing;
  /* 0x04ac */ long LastThreadExitStatus;
  /* 0x04b0 */ struct _EX_FAST_REF PrefetchTrace;
  /* 0x04b8 */ void* LockedPagesList;
  /* 0x04c0 */ union _LARGE_INTEGER ReadOperationCount;
  /* 0x04c8 */ union _LARGE_INTEGER WriteOperationCount;
  /* 0x04d0 */ union _LARGE_INTEGER OtherOperationCount;
  /* 0x04d8 */ union _LARGE_INTEGER ReadTransferCount;
  /* 0x04e0 */ union _LARGE_INTEGER WriteTransferCount;
  /* 0x04e8 */ union _LARGE_INTEGER OtherTransferCount;
  /* 0x04f0 */ unsigned __int64 CommitChargeLimit;
  /* 0x04f8 */ volatile unsigned __int64 CommitCharge;
  /* 0x0500 */ volatile unsigned __int64 CommitChargePeak;
  /* 0x0508 */ struct _MMSUPPORT_FULL Vm;
  /* 0x0618 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0628 */ unsigned long ModifiedPageCount;
  /* 0x062c */ long ExitStatus;
  /* 0x0630 */ struct _RTL_AVL_TREE VadRoot;
  /* 0x0638 */ void* VadHint;
  /* 0x0640 */ unsigned __int64 VadCount;
  /* 0x0648 */ volatile unsigned __int64 VadPhysicalPages;
  /* 0x0650 */ unsigned __int64 VadPhysicalPagesLimit;
  /* 0x0658 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x0678 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x0688 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x0690 */ unsigned long RequestedTimerResolution;
  /* 0x0694 */ unsigned long SmallestTimerResolution;
  /* 0x0698 */ union _LARGE_INTEGER ExitTime;
  /* 0x06a0 */ struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
  /* 0x06a8 */ struct _EX_PUSH_LOCK InvertedFunctionTableLock;
  /* 0x06b0 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x06b4 */ unsigned long LargePrivateVadCount;
  /* 0x06b8 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x06c0 */ void* WnfContext;
  /* 0x06c8 */ struct _EJOB* ServerSilo;
  /* 0x06d0 */ unsigned char SignatureLevel;
  /* 0x06d1 */ unsigned char SectionSignatureLevel;
  /* 0x06d2 */ struct _PS_PROTECTION Protection;
  struct /* bitfield */
  {
    /* 0x06d3 */ unsigned char HangCount : 3; /* bit position: 0 */
    /* 0x06d3 */ unsigned char GhostCount : 3; /* bit position: 3 */
    /* 0x06d3 */ unsigned char PrefilterException : 1; /* bit position: 6 */
  }; /* bitfield */
  union
  {
    /* 0x06d4 */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x06d4 */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x06d4 */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x06d4 */ unsigned long Crashed : 1; /* bit position: 2 */
      /* 0x06d4 */ unsigned long JobVadsAreTracked : 1; /* bit position: 3 */
      /* 0x06d4 */ unsigned long VadTrackingDisabled : 1; /* bit position: 4 */
      /* 0x06d4 */ unsigned long AuxiliaryProcess : 1; /* bit position: 5 */
      /* 0x06d4 */ unsigned long SubsystemProcess : 1; /* bit position: 6 */
      /* 0x06d4 */ unsigned long IndirectCpuSets : 1; /* bit position: 7 */
      /* 0x06d4 */ unsigned long RelinquishedCommit : 1; /* bit position: 8 */
      /* 0x06d4 */ unsigned long HighGraphicsPriority : 1; /* bit position: 9 */
      /* 0x06d4 */ unsigned long CommitFailLogged : 1; /* bit position: 10 */
      /* 0x06d4 */ unsigned long ReserveFailLogged : 1; /* bit position: 11 */
      /* 0x06d4 */ unsigned long SystemProcess : 1; /* bit position: 12 */
      /* 0x06d4 */ unsigned long HideImageBaseAddresses : 1; /* bit position: 13 */
      /* 0x06d4 */ unsigned long AddressPolicyFrozen : 1; /* bit position: 14 */
      /* 0x06d4 */ unsigned long ProcessFirstResume : 1; /* bit position: 15 */
      /* 0x06d4 */ unsigned long ForegroundExternal : 1; /* bit position: 16 */
      /* 0x06d4 */ unsigned long ForegroundSystem : 1; /* bit position: 17 */
      /* 0x06d4 */ unsigned long HighMemoryPriority : 1; /* bit position: 18 */
      /* 0x06d4 */ unsigned long EnableProcessSuspendResumeLogging : 1; /* bit position: 19 */
      /* 0x06d4 */ unsigned long EnableThreadSuspendResumeLogging : 1; /* bit position: 20 */
      /* 0x06d4 */ unsigned long SecurityDomainChanged : 1; /* bit position: 21 */
      /* 0x06d4 */ unsigned long SecurityFreezeComplete : 1; /* bit position: 22 */
      /* 0x06d4 */ unsigned long VmProcessorHost : 1; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x06d8 */ long DeviceAsid;
  /* 0x06dc */ long Padding_118;
  /* 0x06e0 */ void* SvmData;
  /* 0x06e8 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x06f0 */ unsigned __int64 SvmLock;
  /* 0x06f8 */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x0708 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x0710 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x0718 */ void* PicoContext;
  /* 0x0720 */ void* EnclaveTable;
  /* 0x0728 */ unsigned __int64 EnclaveNumber;
  /* 0x0730 */ struct _EX_PUSH_LOCK EnclaveLock;
  /* 0x0738 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x073c */ long Padding_119;
  /* 0x0740 */ struct _PO_PROCESS_ENERGY_CONTEXT* EnergyContext;
  /* 0x0748 */ void* VmContext;
  /* 0x0750 */ unsigned __int64 SequenceNumber;
  /* 0x0758 */ unsigned __int64 CreateInterruptTime;
  /* 0x0760 */ unsigned __int64 CreateUnbiasedInterruptTime;
  /* 0x0768 */ unsigned __int64 TotalUnbiasedFrozenTime;
  /* 0x0770 */ unsigned __int64 LastAppStateUpdateTime;
  struct /* bitfield */
  {
    /* 0x0778 */ unsigned __int64 LastAppStateUptime : 61; /* bit position: 0 */
    /* 0x0778 */ unsigned __int64 LastAppState : 3; /* bit position: 61 */
  }; /* bitfield */
  /* 0x0780 */ volatile unsigned __int64 SharedCommitCharge;
  /* 0x0788 */ struct _EX_PUSH_LOCK SharedCommitLock;
  /* 0x0790 */ struct _LIST_ENTRY SharedCommitLinks;
  union
  {
    struct
    {
      /* 0x07a0 */ unsigned __int64 AllowedCpuSets;
      /* 0x07a8 */ unsigned __int64 DefaultCpuSets;
    }; /* size: 0x0010 */
    struct
    {
      /* 0x07a0 */ unsigned __int64* AllowedCpuSetsIndirect;
      /* 0x07a8 */ unsigned __int64* DefaultCpuSetsIndirect;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  /* 0x07b0 */ void* DiskIoAttribution;
  /* 0x07b8 */ void* DxgProcess;
  /* 0x07c0 */ unsigned long Win32KFilterSet;
  /* 0x07c4 */ long Padding_120;
  /* 0x07c8 */ volatile union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;
  /* 0x07d0 */ volatile unsigned long KTimerSets;
  /* 0x07d4 */ volatile unsigned long KTimer2Sets;
  /* 0x07d8 */ volatile unsigned long ThreadTimerSets;
  /* 0x07dc */ long Padding_121;
  /* 0x07e0 */ unsigned __int64 VirtualTimerListLock;
  /* 0x07e8 */ struct _LIST_ENTRY VirtualTimerListHead;
  union
  {
    /* 0x07f8 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x07f8 */ struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0030 */
  union
  {
    /* 0x0828 */ unsigned long MitigationFlags;
    struct // _TAG_UNNAMED_52
    {
      struct /* bitfield */
      {
        /* 0x0828 */ unsigned long ControlFlowGuardEnabled : 1; /* bit position: 0 */
        /* 0x0828 */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 1 */
        /* 0x0828 */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 2 */
        /* 0x0828 */ unsigned long DisallowStrippedImages : 1; /* bit position: 3 */
        /* 0x0828 */ unsigned long ForceRelocateImages : 1; /* bit position: 4 */
        /* 0x0828 */ unsigned long HighEntropyASLREnabled : 1; /* bit position: 5 */
        /* 0x0828 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 6 */
        /* 0x0828 */ unsigned long ExtensionPointDisable : 1; /* bit position: 7 */
        /* 0x0828 */ unsigned long DisableDynamicCode : 1; /* bit position: 8 */
        /* 0x0828 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 9 */
        /* 0x0828 */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 10 */
        /* 0x0828 */ unsigned long AuditDisableDynamicCode : 1; /* bit position: 11 */
        /* 0x0828 */ unsigned long DisallowWin32kSystemCalls : 1; /* bit position: 12 */
        /* 0x0828 */ unsigned long AuditDisallowWin32kSystemCalls : 1; /* bit position: 13 */
        /* 0x0828 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 14 */
        /* 0x0828 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 15 */
        /* 0x0828 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 16 */
        /* 0x0828 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 17 */
        /* 0x0828 */ unsigned long PreferSystem32Images : 1; /* bit position: 18 */
        /* 0x0828 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 19 */
        /* 0x0828 */ unsigned long AuditProhibitRemoteImageMap : 1; /* bit position: 20 */
        /* 0x0828 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 21 */
        /* 0x0828 */ unsigned long AuditProhibitLowILImageMap : 1; /* bit position: 22 */
        /* 0x0828 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 23 */
        /* 0x0828 */ unsigned long AuditBlockNonMicrosoftBinaries : 1; /* bit position: 24 */
        /* 0x0828 */ unsigned long AuditBlockNonMicrosoftBinariesAllowStore : 1; /* bit position: 25 */
        /* 0x0828 */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 26 */
        /* 0x0828 */ unsigned long AuditLoaderIntegrityContinuity : 1; /* bit position: 27 */
        /* 0x0828 */ unsigned long EnableModuleTamperingProtection : 1; /* bit position: 28 */
        /* 0x0828 */ unsigned long EnableModuleTamperingProtectionNoInherit : 1; /* bit position: 29 */
        /* 0x0828 */ unsigned long RestrictIndirectBranchPrediction : 1; /* bit position: 30 */
        /* 0x0828 */ unsigned long IsolateSecurityDomain : 1; /* bit position: 31 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlagsValues;
  }; /* size: 0x0004 */
  union
  {
    /* 0x082c */ unsigned long MitigationFlags2;
    struct // _TAG_UNNAMED_53
    {
      struct /* bitfield */
      {
        /* 0x082c */ unsigned long EnableExportAddressFilter : 1; /* bit position: 0 */
        /* 0x082c */ unsigned long AuditExportAddressFilter : 1; /* bit position: 1 */
        /* 0x082c */ unsigned long EnableExportAddressFilterPlus : 1; /* bit position: 2 */
        /* 0x082c */ unsigned long AuditExportAddressFilterPlus : 1; /* bit position: 3 */
        /* 0x082c */ unsigned long EnableRopStackPivot : 1; /* bit position: 4 */
        /* 0x082c */ unsigned long AuditRopStackPivot : 1; /* bit position: 5 */
        /* 0x082c */ unsigned long EnableRopCallerCheck : 1; /* bit position: 6 */
        /* 0x082c */ unsigned long AuditRopCallerCheck : 1; /* bit position: 7 */
        /* 0x082c */ unsigned long EnableRopSimExec : 1; /* bit position: 8 */
        /* 0x082c */ unsigned long AuditRopSimExec : 1; /* bit position: 9 */
        /* 0x082c */ unsigned long EnableImportAddressFilter : 1; /* bit position: 10 */
        /* 0x082c */ unsigned long AuditImportAddressFilter : 1; /* bit position: 11 */
        /* 0x082c */ unsigned long DisablePageCombine : 1; /* bit position: 12 */
        /* 0x082c */ unsigned long SpeculativeStoreBypassDisable : 1; /* bit position: 13 */
        /* 0x082c */ unsigned long CetShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x0830 */ void* PartitionObject;
  /* 0x0838 */ unsigned __int64 SecurityDomain;
  /* 0x0840 */ unsigned __int64 ParentSecurityDomain;
  /* 0x0848 */ void* CoverageSamplerContext;
  /* 0x0850 */ void* MmHotPatchContext;
} EPROCESS, *PEPROCESS; /* size: 0x0858 */
...
typedef struct _ETHREAD
{
  ...
  /* 0x05f8 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0600 */ union _LARGE_INTEGER ExitTime;
    /* 0x0600 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  union
  {
    /* 0x0610 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0610 */ void* ForwardLinkShadow;
      /* 0x0618 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x0620 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0620 */ struct _ETHREAD* ReaperLink;
    /* 0x0620 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x0628 */ unsigned __int64 ActiveTimerListLock;
  /* 0x0630 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0640 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0650 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0650 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x0670 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x0678 */ struct _LIST_ENTRY IrpList;
  /* 0x0688 */ unsigned __int64 TopLevelIrp;
  /* 0x0690 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x0698 */ void* Win32StartAddress;
  /* 0x06a0 */ void* ChargeOnlySession;
  /* 0x06a8 */ void* LegacyPowerObject;
  /* 0x06b0 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06c0 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x06c8 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x06d0 */ unsigned long ReadClusterSize;
  /* 0x06d4 */ volatile long MmLockOrdering;
  union
  {
    /* 0x06d8 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x06d8 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x06d8 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x06d8 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x06d8 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x06d8 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x06d8 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x06d8 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x06d8 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x06d8 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x06d8 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x06d8 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x06d8 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x06d8 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x06d8 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x06d8 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x06d8 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x06d8 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x06d8 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x06d8 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x06d8 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x06d8 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06dc */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x06dc */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x06dc */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x06dc */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x06dc */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x06dc */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x06dc */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x06dc */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x06dc */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x06dc */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x06dc */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x06dc */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x06dc */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06e0 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x06e0 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x06e0 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x06e0 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x06e0 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x06e0 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x06e0 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x06e0 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x06e0 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x06e1 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x06e1 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x06e1 */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x06e1 */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x06e1 */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x06e4 */ unsigned char CacheManagerActive;
  /* 0x06e5 */ unsigned char DisablePageFaultClustering;
  /* 0x06e6 */ unsigned char ActiveFaultCount;
  /* 0x06e7 */ unsigned char LockOrderState;
  /* 0x06e8 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x06f0 */ void* AlpcMessage;
    /* 0x06f0 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x06f8 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x0708 */ long ExitStatus;
  /* 0x070c */ unsigned long CacheManagerCount;
  /* 0x0710 */ unsigned long IoBoostCount;
  /* 0x0714 */ unsigned long IoQoSBoostCount;
  /* 0x0718 */ unsigned long IoQoSThrottleCount;
  /* 0x071c */ unsigned long KernelStackReference;
  /* 0x0720 */ struct _LIST_ENTRY BoostList;
  /* 0x0730 */ struct _LIST_ENTRY DeboostList;
  /* 0x0740 */ unsigned __int64 BoostListLock;
  /* 0x0748 */ unsigned __int64 IrpListLock;
  /* 0x0750 */ void* ReservedForSynchTracking;
  /* 0x0758 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0760 */ const struct _GUID* ActivityId;
  /* 0x0768 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0770 */ void* VerifierContext;
  /* 0x0778 */ void* AdjustedClientToken;
  /* 0x0780 */ void* WorkOnBehalfThread;
  /* 0x0788 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x07a0 */ void* PicoContext;
  /* 0x07a8 */ unsigned __int64 UserFsBase;
  /* 0x07b0 */ unsigned __int64 UserGsBase;
  /* 0x07b8 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x07c0 */ void* CmDbgInfo;
  union
  {
    /* 0x07c8 */ unsigned __int64 SelectedCpuSets;
    /* 0x07c8 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x07d0 */ struct _EJOB* Silo;
  /* 0x07d8 */ struct _UNICODE_STRING* ThreadName;
  /* 0x07e0 */ struct _CONTEXT* SetContextState;
  /* 0x07e8 */ unsigned long LastExpectedRunTime;
  /* 0x07ec */ unsigned long HeapData;
  /* 0x07f0 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x0800 */ unsigned __int64 DisownedOwnerEntryListLock;
  /* 0x0808 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
} ETHREAD, *PETHREAD; /* size: 0x0818 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_178[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_179[2];
