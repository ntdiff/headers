...
typedef struct _WORK_QUEUE_ENTRY
{
  ...
  union // _TAG_UNNAMED_218
  {
    union
    {
      ...
      } /* size: 0x0040 */ AsyncRead;
    }; /* size: 0x0040 */
  } /* size: 0x0040 */ Parameters;
  /* 0x0048 */ unsigned char Function;
  /* 0x004c */ struct _CC_PARTITION* Partition;
} WORK_QUEUE_ENTRY, *PWORK_QUEUE_ENTRY; /* size: 0x0050 */
