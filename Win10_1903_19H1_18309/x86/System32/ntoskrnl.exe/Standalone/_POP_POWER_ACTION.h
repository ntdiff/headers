...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0004 */ enum _TAG_UNNAMED_29 Action;
  /* 0x0008 */ enum _SYSTEM_POWER_STATE LightestState;
  /* 0x000c */ unsigned long Flags;
  /* 0x0010 */ long Status;
  /* 0x0014 */ enum _TAG_UNNAMED_195 DeviceType;
  ...
  /* 0x0058 */ enum _TAG_UNNAMED_198 WakeAlarmSignaled;
  /* 0x0060 */ struct // _TAG_UNNAMED_199
  {
  ...
  /* 0x0159 */ unsigned char WatchdogEnabled;
...
} POP_POWER_ACTION, *PPOP_POWER_ACTION; /* size: 0x0170 */
