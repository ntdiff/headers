...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x00fc */ unsigned char DanglingExtentsWorkerActive;
  /* 0x00fd */ unsigned char PurgingExtentsNeedWatchdog;
  ...
  /* 0x0118 */ void* ApiSetSection;
  /* 0x011c */ void* ApiSetSchema;
  /* 0x0120 */ unsigned long ApiSetSchemaSize;
  /* 0x0124 */ unsigned long LostDataFiles;
  /* 0x0128 */ unsigned long LostDataPages;
  /* 0x012c */ unsigned long ImageFailureReason;
  /* 0x0130 */ struct _SECTION* CfgBitMapSection;
  /* 0x0134 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0138 */ unsigned long ImageCfgFailure;
  /* 0x013c */ unsigned long ImageBreakpointEnabled;
  /* 0x0140 */ unsigned long ImageBreakpointChecksum;
  /* 0x0144 */ unsigned long ImageBreakpointSize;
  /* 0x0148 */ volatile long ImageValidationFailed;
  /* 0x014c */ struct _RTL_AVL_TREE ImageExtentTree;
  /* 0x0150 */ struct _EX_PUSH_LOCK ImageExtentTreeLock;
  /* 0x0154 */ unsigned long HotPatchReserveSize;
...
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x4b40 */
