...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x02e8 */ volatile long DirectedTransitionCallCount;
  /* 0x02ec */ void* DirectedTransitionCompletionContext;
  /* 0x02f0 */ enum _DEVICE_POWER_STATE DirectedPowerDownState;
  /* 0x02f4 */ struct _POP_DEVICE_POWER_PROFILE* PowerProfile;
  /* 0x02f8 */ struct _UNICODE_STRING FriendlyName;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x0300 */
