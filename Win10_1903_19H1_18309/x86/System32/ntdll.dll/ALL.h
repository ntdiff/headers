...
typedef struct _PEB
{
  ...
  union
  {
    /* 0x047c */ unsigned long Win32Flags;
    /* 0x047c */ unsigned char IsPosixDeleteDisabled : 1; /* bit position: 0 */
  }; /* size: 0x0004 */
  /* 0x0480 */ unsigned long ReservedWin32Flags : 31; /* bit position: 0 */
  /* 0x0484 */ long __PADDING__[1];
} PEB, *PPEB; /* size: 0x0488 */
  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x03d5 */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x03d5 */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x03d5 */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
