...
typedef struct _PEB
{
  ...
  union
  {
    /* 0x07c8 */ unsigned long Win32Flags;
    /* 0x07c8 */ unsigned char IsPosixDeleteDisabled : 1; /* bit position: 0 */
  }; /* size: 0x0004 */
  /* 0x07cc */ unsigned long ReservedWin32Flags : 31; /* bit position: 0 */
...
typedef struct _KPROCESS
{
  ...
  /* 0x0246 */ char Padding_89[2];
  /* 0x0248 */ volatile union _KSTACK_COUNT StackCount;
  /* 0x024c */ long Padding_90;
...
typedef struct _IO_STACK_LOCATION
{
  ...
  union
  {
    union
    {
      ...
      struct
      {
        /* 0x0008 */ enum _TAG_UNNAMED_1 IdType;
      } /* size: 0x0004 */ QueryId;
      struct
      {
        /* 0x0008 */ enum _TAG_UNNAMED_2 DeviceTextType;
      ...
      struct
      {
        ...
        /* 0x0020 */ enum _TAG_UNNAMED_3 ShutdownType;
        /* 0x0024 */ long __PADDING__[1];
      } /* size: 0x0020 */ Power;
      struct
      {
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_138[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_139[2];
...
typedef struct _PROC_IDLE_ACCOUNTING
{
  ...
  /* 0x0020 */ enum _TAG_UNNAMED_7 TimeUnit;
  /* 0x0024 */ long Padding_154;
...
typedef struct _EPROCESS
{
  ...
  /* 0x04b8 */ struct _MMSUPPORT_FULL Vm;
  /* 0x05c8 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x05d8 */ unsigned long ModifiedPageCount;
  /* 0x05dc */ long ExitStatus;
  /* 0x05e0 */ struct _RTL_AVL_TREE VadRoot;
  /* 0x05e8 */ void* VadHint;
  /* 0x05f0 */ unsigned __int64 VadCount;
  /* 0x05f8 */ volatile unsigned __int64 VadPhysicalPages;
  /* 0x0600 */ unsigned __int64 VadPhysicalPagesLimit;
  /* 0x0608 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x0628 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x0638 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x0640 */ unsigned long RequestedTimerResolution;
  /* 0x0644 */ unsigned long SmallestTimerResolution;
  /* 0x0648 */ union _LARGE_INTEGER ExitTime;
  /* 0x0650 */ struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
  /* 0x0658 */ struct _EX_PUSH_LOCK InvertedFunctionTableLock;
  /* 0x0660 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x0664 */ unsigned long LargePrivateVadCount;
  /* 0x0668 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x0670 */ void* WnfContext;
  /* 0x0678 */ struct _EJOB* ServerSilo;
  /* 0x0680 */ unsigned char SignatureLevel;
  /* 0x0681 */ unsigned char SectionSignatureLevel;
  /* 0x0682 */ struct _PS_PROTECTION Protection;
  struct /* bitfield */
  {
    /* 0x0683 */ unsigned char HangCount : 3; /* bit position: 0 */
    /* 0x0683 */ unsigned char GhostCount : 3; /* bit position: 3 */
    /* 0x0683 */ unsigned char PrefilterException : 1; /* bit position: 6 */
  }; /* bitfield */
  union
  {
    /* 0x0684 */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x0684 */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x0684 */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x0684 */ unsigned long Crashed : 1; /* bit position: 2 */
      /* 0x0684 */ unsigned long JobVadsAreTracked : 1; /* bit position: 3 */
      /* 0x0684 */ unsigned long VadTrackingDisabled : 1; /* bit position: 4 */
      /* 0x0684 */ unsigned long AuxiliaryProcess : 1; /* bit position: 5 */
      /* 0x0684 */ unsigned long SubsystemProcess : 1; /* bit position: 6 */
      /* 0x0684 */ unsigned long IndirectCpuSets : 1; /* bit position: 7 */
      /* 0x0684 */ unsigned long RelinquishedCommit : 1; /* bit position: 8 */
      /* 0x0684 */ unsigned long HighGraphicsPriority : 1; /* bit position: 9 */
      /* 0x0684 */ unsigned long CommitFailLogged : 1; /* bit position: 10 */
      /* 0x0684 */ unsigned long ReserveFailLogged : 1; /* bit position: 11 */
      /* 0x0684 */ unsigned long SystemProcess : 1; /* bit position: 12 */
      /* 0x0684 */ unsigned long HideImageBaseAddresses : 1; /* bit position: 13 */
      /* 0x0684 */ unsigned long AddressPolicyFrozen : 1; /* bit position: 14 */
      /* 0x0684 */ unsigned long ProcessFirstResume : 1; /* bit position: 15 */
      /* 0x0684 */ unsigned long ForegroundExternal : 1; /* bit position: 16 */
      /* 0x0684 */ unsigned long ForegroundSystem : 1; /* bit position: 17 */
      /* 0x0684 */ unsigned long HighMemoryPriority : 1; /* bit position: 18 */
      /* 0x0684 */ unsigned long EnableProcessSuspendResumeLogging : 1; /* bit position: 19 */
      /* 0x0684 */ unsigned long EnableThreadSuspendResumeLogging : 1; /* bit position: 20 */
      /* 0x0684 */ unsigned long SecurityDomainChanged : 1; /* bit position: 21 */
      /* 0x0684 */ unsigned long SecurityFreezeComplete : 1; /* bit position: 22 */
      /* 0x0684 */ unsigned long VmProcessorHost : 1; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0688 */ long DeviceAsid;
  /* 0x068c */ long Padding_173;
  /* 0x0690 */ void* SvmData;
  /* 0x0698 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x06a0 */ unsigned __int64 SvmLock;
  /* 0x06a8 */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x06b8 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x06c0 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x06c8 */ void* PicoContext;
  /* 0x06d0 */ void* EnclaveTable;
  /* 0x06d8 */ unsigned __int64 EnclaveNumber;
  /* 0x06e0 */ struct _EX_PUSH_LOCK EnclaveLock;
  /* 0x06e8 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x06ec */ long Padding_174;
  /* 0x06f0 */ struct _PO_PROCESS_ENERGY_CONTEXT* EnergyContext;
  /* 0x06f8 */ void* VmContext;
  /* 0x0700 */ unsigned __int64 SequenceNumber;
  /* 0x0708 */ unsigned __int64 CreateInterruptTime;
  /* 0x0710 */ unsigned __int64 CreateUnbiasedInterruptTime;
  /* 0x0718 */ unsigned __int64 TotalUnbiasedFrozenTime;
  /* 0x0720 */ unsigned __int64 LastAppStateUpdateTime;
  struct /* bitfield */
  {
    /* 0x0728 */ unsigned __int64 LastAppStateUptime : 61; /* bit position: 0 */
    /* 0x0728 */ unsigned __int64 LastAppState : 3; /* bit position: 61 */
  }; /* bitfield */
  /* 0x0730 */ volatile unsigned __int64 SharedCommitCharge;
  /* 0x0738 */ struct _EX_PUSH_LOCK SharedCommitLock;
  /* 0x0740 */ struct _LIST_ENTRY SharedCommitLinks;
  union
  {
    struct
    {
      /* 0x0750 */ unsigned __int64 AllowedCpuSets;
      /* 0x0758 */ unsigned __int64 DefaultCpuSets;
    }; /* size: 0x0010 */
    struct
    {
      /* 0x0750 */ unsigned __int64* AllowedCpuSetsIndirect;
      /* 0x0758 */ unsigned __int64* DefaultCpuSetsIndirect;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  /* 0x0760 */ void* DiskIoAttribution;
  /* 0x0768 */ void* DxgProcess;
  /* 0x0770 */ unsigned long Win32KFilterSet;
  /* 0x0774 */ long Padding_175;
  /* 0x0778 */ volatile union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;
  /* 0x0780 */ volatile unsigned long KTimerSets;
  /* 0x0784 */ volatile unsigned long KTimer2Sets;
  /* 0x0788 */ volatile unsigned long ThreadTimerSets;
  /* 0x078c */ long Padding_176;
  /* 0x0790 */ unsigned __int64 VirtualTimerListLock;
  /* 0x0798 */ struct _LIST_ENTRY VirtualTimerListHead;
  union
  {
    /* 0x07a8 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x07a8 */ struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0030 */
  union
  {
    /* 0x07d8 */ unsigned long MitigationFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x07d8 */ unsigned long ControlFlowGuardEnabled : 1; /* bit position: 0 */
        /* 0x07d8 */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 1 */
        /* 0x07d8 */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 2 */
        /* 0x07d8 */ unsigned long DisallowStrippedImages : 1; /* bit position: 3 */
        /* 0x07d8 */ unsigned long ForceRelocateImages : 1; /* bit position: 4 */
        /* 0x07d8 */ unsigned long HighEntropyASLREnabled : 1; /* bit position: 5 */
        /* 0x07d8 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 6 */
        /* 0x07d8 */ unsigned long ExtensionPointDisable : 1; /* bit position: 7 */
        /* 0x07d8 */ unsigned long DisableDynamicCode : 1; /* bit position: 8 */
        /* 0x07d8 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 9 */
        /* 0x07d8 */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 10 */
        /* 0x07d8 */ unsigned long AuditDisableDynamicCode : 1; /* bit position: 11 */
        /* 0x07d8 */ unsigned long DisallowWin32kSystemCalls : 1; /* bit position: 12 */
        /* 0x07d8 */ unsigned long AuditDisallowWin32kSystemCalls : 1; /* bit position: 13 */
        /* 0x07d8 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 14 */
        /* 0x07d8 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 15 */
        /* 0x07d8 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 16 */
        /* 0x07d8 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 17 */
        /* 0x07d8 */ unsigned long PreferSystem32Images : 1; /* bit position: 18 */
        /* 0x07d8 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 19 */
        /* 0x07d8 */ unsigned long AuditProhibitRemoteImageMap : 1; /* bit position: 20 */
        /* 0x07d8 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 21 */
        /* 0x07d8 */ unsigned long AuditProhibitLowILImageMap : 1; /* bit position: 22 */
        /* 0x07d8 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 23 */
        /* 0x07d8 */ unsigned long AuditBlockNonMicrosoftBinaries : 1; /* bit position: 24 */
        /* 0x07d8 */ unsigned long AuditBlockNonMicrosoftBinariesAllowStore : 1; /* bit position: 25 */
        /* 0x07d8 */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 26 */
        /* 0x07d8 */ unsigned long AuditLoaderIntegrityContinuity : 1; /* bit position: 27 */
        /* 0x07d8 */ unsigned long EnableModuleTamperingProtection : 1; /* bit position: 28 */
        /* 0x07d8 */ unsigned long EnableModuleTamperingProtectionNoInherit : 1; /* bit position: 29 */
        /* 0x07d8 */ unsigned long RestrictIndirectBranchPrediction : 1; /* bit position: 30 */
        /* 0x07d8 */ unsigned long IsolateSecurityDomain : 1; /* bit position: 31 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlagsValues;
  }; /* size: 0x0004 */
  union
  {
    /* 0x07dc */ unsigned long MitigationFlags2;
    struct
    {
      struct /* bitfield */
      {
        /* 0x07dc */ unsigned long EnableExportAddressFilter : 1; /* bit position: 0 */
        /* 0x07dc */ unsigned long AuditExportAddressFilter : 1; /* bit position: 1 */
        /* 0x07dc */ unsigned long EnableExportAddressFilterPlus : 1; /* bit position: 2 */
        /* 0x07dc */ unsigned long AuditExportAddressFilterPlus : 1; /* bit position: 3 */
        /* 0x07dc */ unsigned long EnableRopStackPivot : 1; /* bit position: 4 */
        /* 0x07dc */ unsigned long AuditRopStackPivot : 1; /* bit position: 5 */
        /* 0x07dc */ unsigned long EnableRopCallerCheck : 1; /* bit position: 6 */
        /* 0x07dc */ unsigned long AuditRopCallerCheck : 1; /* bit position: 7 */
        /* 0x07dc */ unsigned long EnableRopSimExec : 1; /* bit position: 8 */
        /* 0x07dc */ unsigned long AuditRopSimExec : 1; /* bit position: 9 */
        /* 0x07dc */ unsigned long EnableImportAddressFilter : 1; /* bit position: 10 */
        /* 0x07dc */ unsigned long AuditImportAddressFilter : 1; /* bit position: 11 */
        /* 0x07dc */ unsigned long DisablePageCombine : 1; /* bit position: 12 */
        /* 0x07dc */ unsigned long SpeculativeStoreBypassDisable : 1; /* bit position: 13 */
        /* 0x07dc */ unsigned long CetShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x07e0 */ void* PartitionObject;
  /* 0x07e8 */ unsigned __int64 SecurityDomain;
  /* 0x07f0 */ unsigned __int64 ParentSecurityDomain;
  /* 0x07f8 */ void* CoverageSamplerContext;
  /* 0x0800 */ void* MmHotPatchContext;
} EPROCESS, *PEPROCESS; /* size: 0x0808 */
...
typedef struct _ETHREAD
{
  ...
  /* 0x0618 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0620 */ union _LARGE_INTEGER ExitTime;
    /* 0x0620 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  union
  {
    /* 0x0630 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0630 */ void* ForwardLinkShadow;
      /* 0x0638 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x0640 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0640 */ struct _ETHREAD* ReaperLink;
    /* 0x0640 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x0648 */ unsigned __int64 ActiveTimerListLock;
  /* 0x0650 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0660 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0670 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0670 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x0690 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x0698 */ struct _LIST_ENTRY IrpList;
  /* 0x06a8 */ unsigned __int64 TopLevelIrp;
  /* 0x06b0 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x06b8 */ void* Win32StartAddress;
  /* 0x06c0 */ void* ChargeOnlySession;
  /* 0x06c8 */ void* LegacyPowerObject;
  /* 0x06d0 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06e0 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x06e8 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x06f0 */ unsigned long ReadClusterSize;
  /* 0x06f4 */ volatile long MmLockOrdering;
  union
  {
    /* 0x06f8 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x06f8 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x06f8 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x06f8 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x06f8 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x06f8 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x06f8 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x06f8 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x06f8 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x06f8 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x06f8 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x06f8 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x06f8 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x06f8 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x06f8 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x06f8 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x06f8 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x06f8 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x06f8 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x06f8 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x06f8 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x06f8 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06fc */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x06fc */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x06fc */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x06fc */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x06fc */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x06fc */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x06fc */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x06fc */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x06fc */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x06fc */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x06fc */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x06fc */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x06fc */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0700 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x0700 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x0700 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x0700 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x0700 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x0700 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x0700 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x0700 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x0700 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x0701 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x0701 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x0701 */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x0701 */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x0701 */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x0704 */ unsigned char CacheManagerActive;
  /* 0x0705 */ unsigned char DisablePageFaultClustering;
  /* 0x0706 */ unsigned char ActiveFaultCount;
  /* 0x0707 */ unsigned char LockOrderState;
  /* 0x0708 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x0710 */ void* AlpcMessage;
    /* 0x0710 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x0718 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x0728 */ long ExitStatus;
  /* 0x072c */ unsigned long CacheManagerCount;
  /* 0x0730 */ unsigned long IoBoostCount;
  /* 0x0734 */ unsigned long IoQoSBoostCount;
  /* 0x0738 */ unsigned long IoQoSThrottleCount;
  /* 0x073c */ unsigned long KernelStackReference;
  /* 0x0740 */ struct _LIST_ENTRY BoostList;
  /* 0x0750 */ struct _LIST_ENTRY DeboostList;
  /* 0x0760 */ unsigned __int64 BoostListLock;
  /* 0x0768 */ unsigned __int64 IrpListLock;
  /* 0x0770 */ void* ReservedForSynchTracking;
  /* 0x0778 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0780 */ const struct _GUID* ActivityId;
  /* 0x0788 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0790 */ void* VerifierContext;
  /* 0x0798 */ void* AdjustedClientToken;
  /* 0x07a0 */ void* WorkOnBehalfThread;
  /* 0x07a8 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x07c0 */ void* PicoContext;
  /* 0x07c8 */ unsigned __int64 UserRoBase;
  /* 0x07d0 */ unsigned __int64 UserRwBase;
  /* 0x07d8 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x07e0 */ void* CmDbgInfo;
  union
  {
    /* 0x07e8 */ unsigned __int64 SelectedCpuSets;
    /* 0x07e8 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x07f0 */ struct _EJOB* Silo;
  /* 0x07f8 */ struct _UNICODE_STRING* ThreadName;
  /* 0x0800 */ unsigned long LastExpectedRunTime;
  /* 0x0804 */ unsigned long HeapData;
  /* 0x0808 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x0818 */ unsigned __int64 DisownedOwnerEntryListLock;
  /* 0x0820 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
} ETHREAD, *PETHREAD; /* size: 0x0830 */
