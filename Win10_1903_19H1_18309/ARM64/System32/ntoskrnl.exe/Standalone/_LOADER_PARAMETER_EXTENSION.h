...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  /* 0x0ae8 */ void* BootOptions;
  /* 0x0af0 */ unsigned long IumEnablement;
  /* 0x0af4 */ unsigned long IumPolicy;
  /* 0x0af8 */ long IumStatus;
  /* 0x0afc */ unsigned long BootId;
  /* 0x0b00 */ struct _LOADER_PARAMETER_CI_EXTENSION* CodeIntegrityData;
  /* 0x0b08 */ unsigned long CodeIntegrityDataSize;
  /* 0x0b0c */ struct _LOADER_HIVE_RECOVERY_INFO SystemHiveRecoveryInfo;
  /* 0x0b20 */ unsigned long SoftRestartCount;
  /* 0x0b28 */ __int64 SoftRestartTime;
  /* 0x0b30 */ void* HalVirtualAddress;
  /* 0x0b38 */ unsigned __int64 HalNumberOfBytes;
  /* 0x0b40 */ struct _LEAP_SECOND_DATA* LeapSecondData;
  /* 0x0b48 */ unsigned long MajorRelease;
  /* 0x0b4c */ unsigned long Reserved1;
  /* 0x0b50 */ char NtBuildLab[224];
  /* 0x0c30 */ char NtBuildLabEx[224];
  /* 0x0d10 */ struct _LOADER_RESET_REASON ResetReason;
  /* 0x0d40 */ unsigned long MaxPciBusNumber;
  /* 0x0d44 */ unsigned long FeatureSettings;
  /* 0x0d48 */ unsigned long HotPatchReserveSize;
  /* 0x0d4c */ unsigned long RetpolineReserveSize;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0d50 */
