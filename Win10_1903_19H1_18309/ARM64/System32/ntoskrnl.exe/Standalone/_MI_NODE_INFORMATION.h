...
typedef struct _MI_NODE_INFORMATION
{
  ...
  /* 0x0718 */ unsigned long MmShiftedColor;
  /* 0x071c */ unsigned long Color;
  /* 0x0720 */ volatile unsigned __int64 ChannelFreeCount[2][4];
  struct // _TAG_UNNAMED_191
  {
    struct /* bitfield */
    {
      /* 0x0760 */ unsigned long ChannelsHotCold : 1; /* bit position: 0 */
      /* 0x0760 */ unsigned long Spare : 31; /* bit position: 1 */
    }; /* bitfield */
  } /* size: 0x0004 */ Flags;
  /* 0x0768 */ struct _EX_PUSH_LOCK NodeLock;
  /* 0x0770 */ unsigned __int64 ZeroThreadHugeMapLock;
  /* 0x0778 */ volatile unsigned char LargeListMoveInProgress;
  /* 0x0779 */ unsigned char ChannelStatus;
  /* 0x077a */ unsigned char ChannelOrdering[4];
  /* 0x077e */ unsigned char LockedChannelOrdering[4];
  /* 0x0782 */ unsigned char PowerAttribute[4];
  /* 0x0788 */ unsigned __int64 LargePageLock;
  /* 0x0790 */ struct _MI_PAGE_COLORS PageColorTable;
  /* 0x07a0 */ long __PADDING__[24];
} MI_NODE_INFORMATION, *PMI_NODE_INFORMATION; /* size: 0x0800 */
