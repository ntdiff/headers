...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x000c */ unsigned long UnusedSubsectionPagedPool;
  /* 0x0010 */ unsigned long UnusedSegmentForceFree;
  /* 0x0014 */ unsigned long DataSectionProtectionMask;
  /* 0x0018 */ void* HighSectionBase;
  /* 0x001c */ struct _MSUBSECTION PhysicalSubsection;
  /* 0x0060 */ struct _CONTROL_AREA PhysicalControlArea;
  /* 0x00b0 */ struct _MMPFN* DanglingExtentsPages;
  /* 0x00b4 */ volatile long DanglingExtentsLock;
  /* 0x00b8 */ struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem;
  /* 0x00c8 */ unsigned char DanglingExtentsWorkerActive;
  /* 0x00cc */ struct _RTL_AVL_TREE PageFileSectionHead;
  /* 0x00d0 */ volatile long PageFileSectionListSpinLock;
  /* 0x00d4 */ unsigned long ImageBias;
  /* 0x00d8 */ struct _EX_PUSH_LOCK RelocateBitmapsLock;
  /* 0x00dc */ struct _RTL_BITMAP ImageBitMap;
  /* 0x00e4 */ void* ApiSetSection;
  /* 0x00e8 */ void* ApiSetSchema;
  /* 0x00ec */ unsigned long ApiSetSchemaSize;
  /* 0x00f0 */ unsigned long LostDataFiles;
  /* 0x00f4 */ unsigned long LostDataPages;
  /* 0x00f8 */ unsigned long ImageFailureReason;
  /* 0x00fc */ struct _SECTION* CfgBitMapSection32;
  /* 0x0100 */ struct _CONTROL_AREA* CfgBitMapControlArea32;
  /* 0x0104 */ unsigned long ImageCfgFailure;
  /* 0x0108 */ unsigned long ImageChecksumBreakpoint;
  /* 0x010c */ unsigned long ImageSizeBreakpoint;
...
typedef struct _MI_PROCESS_STATE
{
  ...
  /* 0x0024 */ unsigned long FreePaeEntries;
  /* 0x0028 */ struct _PAE_ENTRY FirstFreePae;
  /* 0x0048 */ volatile long AllocatedPaePages;
  /* 0x004c */ unsigned long PaeLock;
  /* 0x0050 */ union _SLIST_HEADER PaeEntrySList;
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x0110 */ unsigned long StackGrowthFailures;
  /* 0x0114 */ unsigned char KernelStackPages;
  /* 0x0115 */ unsigned char TrackPtesAborted;
  /* 0x0116 */ unsigned char AdjustCounter;
  /* 0x0118 */ volatile long ReservedMappingLock;
  /* 0x011c */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x0120 */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x0124 */ struct _RTL_AVL_TREE OutswappedKernelStackRoot;
  /* 0x0128 */ volatile long OutswappedKernelStackLock;
  /* 0x012c */ long __PADDING__[5];
} MI_SYSTEM_PTE_STATE, *PMI_SYSTEM_PTE_STATE; /* size: 0x0140 */
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1740 */ struct _MI_HARDWARE_STATE Hardware;
  ...
  /* 0x2f90 */ struct _MI_STANDBY_STATE Standby;
  /* 0x3000 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x3140 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x3180 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x31b8 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x3200 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x3240 */ unsigned long Cookie;
  /* 0x3244 */ void* volatile* BootRegistryRuns;
  /* 0x3248 */ volatile long ZeroingDisabled;
  /* 0x324c */ unsigned char FullyInitialized;
  /* 0x324d */ unsigned char SafeBooted;
  /* 0x3250 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x3258 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x3280 */ struct _MI_VISIBLE_STATE Vs;
