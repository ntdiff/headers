...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x0184 */ unsigned long LogEntries;
  /* 0x0188 */ struct _POP_FX_LOG_ENTRY* Log;
  /* 0x018c */ volatile long LogIndex;
  /* 0x0190 */ struct _DRIVER_OBJECT* DripsWatchdogDriverObject;
  /* 0x0194 */ long __PADDING__[1];
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x0198 */
