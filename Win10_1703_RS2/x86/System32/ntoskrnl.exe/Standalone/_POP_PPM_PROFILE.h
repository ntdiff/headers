...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x0070 */ unsigned char HeteroDecreaseThreshold[32];
  /* 0x0090 */ unsigned char HeteroIncreaseThreshold[32];
  /* 0x00b0 */ unsigned char Class0FloorPerformance;
  /* 0x00b1 */ unsigned char Class1InitialPerformance;
  /* 0x00b2 */ char __PADDING__[6];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x00b8 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x0190 */ unsigned __int64 StartTime;
  /* 0x0198 */ unsigned __int64 Count;
  /* 0x01a0 */ unsigned __int64 MaxDuration;
  /* 0x01a8 */ unsigned __int64 MinDuration;
  /* 0x01b0 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x01b8 */
