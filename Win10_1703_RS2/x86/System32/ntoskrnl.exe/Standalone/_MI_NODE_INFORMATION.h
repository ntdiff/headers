...
typedef struct _MI_NODE_INFORMATION
{
  ...
  /* 0x0084 */ volatile unsigned long FreeCount[2];
  /* 0x008c */ unsigned long TotalPages[1];
  /* 0x0090 */ unsigned long TotalPagesEntireNode;
  ...
  struct
  {
    struct /* bitfield */
    {
      /* 0x00a4 */ unsigned long ChannelsHotCold : 1; /* bit position: 0 */
      /* 0x00a4 */ unsigned long Spare : 31; /* bit position: 1 */
    }; /* bitfield */
  } /* size: 0x0004 */ Flags;
  /* 0x00a8 */ struct _EX_PUSH_LOCK NodeLock;
  /* 0x00ac */ unsigned char ChannelStatus;
  /* 0x00ad */ unsigned char ChannelOrdering[1];
  /* 0x00ae */ unsigned char LockedChannelOrdering[1];
  /* 0x00af */ unsigned char PowerAttribute[1];
  /* 0x00b0 */ unsigned long LargePageLock;
} MI_NODE_INFORMATION, *PMI_NODE_INFORMATION; /* size: 0x00b4 */
