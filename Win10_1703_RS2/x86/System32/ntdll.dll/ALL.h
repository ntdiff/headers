...
typedef struct _TEB64
{
  ...
  /* 0x0190 */ unsigned __int64 SystemReserved1[32];
...
typedef struct _KUSER_SHARED_DATA
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x02f0 */ unsigned long SpareBits : 22; /* bit position: 10 */
    }; /* bitfield */
  }; /* size: 0x0004 */
...
typedef struct _TEB
{
  ...
  /* 0x010c */ void* SystemReserved1[30];
...
typedef struct _PEB
{
  ...
  /* 0x045c */ long __PADDING__[1];
} PEB, *PPEB; /* size: 0x0460 */

typedef struct _PEB_LDR_DATA
{
  /* 0x0000 */ unsigned long Length;
  /* 0x0004 */ unsigned char Initialized;
  /* 0x0005 */ char Padding_14[3];
...
typedef struct _KPRCB
{
  ...
  /* 0x3eb0 */ struct _KDPC ForceIdleDpc;
  /* 0x3ed0 */ unsigned long PrcbPad91[8];
  /* 0x3ef0 */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x3ef4 */ struct _KDPC DpcWatchdogDpc;
  /* 0x3f14 */ long Padding_30;
  ...
  /* 0x3fe0 */ void** DpcWatchdogProfile;
  /* 0x3fe4 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x3fe8 */ unsigned long PrcbPad92[1];
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x005c */ unsigned long BamEppImportant : 1; /* bit position: 2 */
      ...
      /* 0x005c */ unsigned long TerminateRequestReason : 2; /* bit position: 17 */
      /* 0x005c */ unsigned long ProcessStackCountDecremented : 1; /* bit position: 19 */
      /* 0x005c */ unsigned long RestrictedGuiThread : 1; /* bit position: 20 */
      /* 0x005c */ unsigned long ThreadFlagsSpare : 3; /* bit position: 21 */
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0064 */ unsigned long PpmPolicy : 2; /* bit position: 6 */
...
typedef struct _TEB32
{
  ...
  /* 0x010c */ unsigned long SystemReserved1[30];
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x03cc */ unsigned long ReservedCrossThreadFlags : 10; /* bit position: 22 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x03d0 */ unsigned long ReservedSameThreadPassiveFlags : 23; /* bit position: 9 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
...
typedef struct _EPROCESS
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x00c8 */ unsigned long DisableDynamicCode : 1; /* bit position: 10 */
      ...
      /* 0x00c8 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 17 */
      ...
      /* 0x00c8 */ unsigned long DisallowStrippedImages : 1; /* bit position: 24 */
      /* 0x00c8 */ unsigned long HighEntropyASLREnabled : 1; /* bit position: 25 */
      /* 0x00c8 */ unsigned long ExtensionPointDisable : 1; /* bit position: 26 */
      /* 0x00c8 */ unsigned long ForceRelocateImages : 1; /* bit position: 27 */
      ...
      /* 0x00c8 */ unsigned long DisallowWin32kSystemCalls : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x00cc */ unsigned long ControlFlowGuardEnabled : 1; /* bit position: 4 */
  ...
  /* 0x02ef */ unsigned char HangCount;
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x02f0 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 2 */
      /* 0x02f0 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 3 */
      /* 0x02f0 */ unsigned long Crashed : 1; /* bit position: 4 */
      /* 0x02f0 */ unsigned long JobVadsAreTracked : 1; /* bit position: 5 */
      /* 0x02f0 */ unsigned long VadTrackingDisabled : 1; /* bit position: 6 */
      /* 0x02f0 */ unsigned long AuxiliaryProcess : 1; /* bit position: 7 */
      /* 0x02f0 */ unsigned long SubsystemProcess : 1; /* bit position: 8 */
      /* 0x02f0 */ unsigned long IndirectCpuSets : 1; /* bit position: 9 */
      /* 0x02f0 */ unsigned long InPrivate : 1; /* bit position: 10 */
      /* 0x02f0 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 11 */
      /* 0x02f0 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 12 */
      /* 0x02f0 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 13 */
      /* 0x02f0 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 14 */
      /* 0x02f0 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 15 */
      /* 0x02f0 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 16 */
      /* 0x02f0 */ unsigned long PreferSystem32Images : 1; /* bit position: 17 */
      /* 0x02f0 */ unsigned long RelinquishedCommit : 1; /* bit position: 18 */
      /* 0x02f0 */ unsigned long AutomaticallyOverrideChildProcessPolicy : 1; /* bit position: 19 */
      /* 0x02f0 */ unsigned long HighGraphicsPriority : 1; /* bit position: 20 */
      /* 0x02f0 */ unsigned long CommitFailLogged : 1; /* bit position: 21 */
      /* 0x02f0 */ unsigned long ReserveFailLogged : 1; /* bit position: 22 */
      /* 0x02f0 */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 23 */
      /* 0x02f0 */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 24 */
      /* 0x02f0 */ unsigned long LoaderIntegrityContinuityAudit : 1; /* bit position: 25 */
      /* 0x02f0 */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 26 */
      /* 0x02f0 */ unsigned long FatalAccessTerminationRequested : 1; /* bit position: 27 */
      /* 0x02f0 */ unsigned long DisableSystemAllowedCpuSet : 1; /* bit position: 28 */
      /* 0x02f0 */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 29 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  ...
  union
  {
    /* 0x03d8 */ unsigned long Flags4;
    struct /* bitfield */
    {
      /* 0x03d8 */ unsigned long PicoCreated : 1; /* bit position: 0 */
      /* 0x03d8 */ unsigned long RestrictSetThreadContext : 1; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x03dc */ long __PADDING__[1];
} EPROCESS, *PEPROCESS; /* size: 0x03e0 */
...
typedef struct _EJOB
{
  ...
  /* 0x0370 */ struct _EX_PUSH_LOCK IoControlLock;
  /* 0x0374 */ unsigned long SiloHardReferenceCount;
  /* 0x0378 */ struct _WORK_QUEUE_ITEM RundownWorkItem;
  /* 0x0388 */ void* MemoryPartitionObject;
  /* 0x038c */ long Padding_63;
  /* 0x0390 */ union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;
} EJOB, *PEJOB; /* size: 0x0398 */
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0204 */ long Padding_67;
  /* 0x0208 */ struct _WNF_SILODRIVERSTATE WnfSiloState;
  /* 0x0238 */ struct _UNICODE_STRING PsProtectedCurrentDirectory;
  /* 0x0240 */ struct _UNICODE_STRING PsProtectedEnvironment;
  /* 0x0248 */ void* ApiSetSection;
  /* 0x024c */ void* ApiSetSchema;
  /* 0x0250 */ unsigned char OneCoreForwardersEnabled;
  /* 0x0251 */ char Padding_68[3];
  /* 0x0254 */ struct _UNICODE_STRING NtSystemRoot;
  /* 0x025c */ struct _UNICODE_STRING SiloRootDirectoryName;
  /* 0x0264 */ struct _PSP_STORAGE* Storage;
  /* 0x0268 */ enum _SERVERSILO_STATE State;
  /* 0x026c */ long ExitStatus;
  /* 0x0270 */ struct _KEVENT* DeleteEvent;
  /* 0x0274 */ struct _SILO_USER_SHARED_DATA* UserSharedData;
  /* 0x0278 */ void* UserSharedSection;
  /* 0x027c */ struct _WORK_QUEUE_ITEM TerminateWorkItem;
  /* 0x028c */ long __PADDING__[1];
} ESERVERSILO_GLOBALS, *PESERVERSILO_GLOBALS; /* size: 0x0290 */
...
typedef struct _HEAP_LFH_BUCKET
{
  ...
  /* 0x0029 */ char Padding_74[3];
  /* 0x002c */ struct _RTL_SRWLOCK AffinityMappingLock;
  /* 0x0030 */ unsigned long ContentionCount;
  /* 0x0034 */ unsigned char* ProcAffinityMapping;
  /* 0x0038 */ struct _HEAP_LFH_AFFINITY_SLOT** AffinitySlots;
} HEAP_LFH_BUCKET, *PHEAP_LFH_BUCKET; /* size: 0x003c */
...
_LdrpLogIntegrityContinuityTelemetry@12
...
_RtlDosPathNameToRelativeNtPathName@32
...
_RtlIsPlaceholderFileHandle@8
_RtlIsPlaceholderFileInfo@12
...
_RtlSparseBitmapCtxCheckBit@12
_RtlSparseBitmapCtxCheckBitsInternal@24
_RtlSparseBitmapCtxClearBits@24
...
_RtlpDosPathNameToRelativeNtPathName_U@24
...
_RtlpGetImageBaseViaQueryVirtualMemory@8
...
_RtlpHpLargeSparseBmpAlloc@4
_RtlpHpLargeSparseBmpFree@4
_RtlpHpLargeSparseBmpInitialize@0
...
_RtlpHpLfhContextInitialize@16
...
_RtlpHpLfhSubsegmentDecBlockCounts@16
_RtlpHpLfhSubsegmentDecommitPages@20
_RtlpHpLfhSubsegmentFree@16
_RtlpHpLfhSubsegmentFreeBlock@16
_RtlpHpLfhSubsegmentIncBlockCounts@16
_RtlpHpLfhSubsegmentInitialize@12
_RtlpHpLfhSubsegmentLockOwner@4
_RtlpHpLfhSubsegmentReserveBlock@16
...
_RtlpHpSegAlloc@16
_RtlpHpSegAllocSize@16
_RtlpHpSegAllocSizeInternal@20
...
_RtlpHpVsSubsegmentCommitPages@28
...
_RtlpSparseBitmapCheckRangeArrayPage@8
_RtlpSparseBitmapCommitRangeArrayPage@8
