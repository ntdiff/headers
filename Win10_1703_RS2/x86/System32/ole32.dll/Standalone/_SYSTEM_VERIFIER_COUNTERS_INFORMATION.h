...
typedef struct _SYSTEM_VERIFIER_COUNTERS_INFORMATION
{
  ...
  /* 0x00bc */ unsigned long UnsupportedRelocs;
  /* 0x00c0 */ unsigned long IATInExecutableSection;
} SYSTEM_VERIFIER_COUNTERS_INFORMATION, *PSYSTEM_VERIFIER_COUNTERS_INFORMATION; /* size: 0x00c4 */
