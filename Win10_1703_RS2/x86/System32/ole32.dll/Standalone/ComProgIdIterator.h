...
{
  /* 0x000c */ class RegistryKey _registryClassesRootKey;
  /* 0x0010 */ unsigned long _registryClassesRootIndex;
  /* 0x0014 */ class Microsoft::WRL::ComPtr<IComCatalogSCM> _comCatalog;
  /* 0x0018 */ class Microsoft::WRL::ComPtr<IPackagedComProgIdIterator> _packagedComProgIdIterator;
}; /* size: 0x001c */
