...
typedef struct _CRYPT_PROVIDER_DATA
{
  ...
  /* 0x0080 */ struct _CRYPT_PROVIDER_SIGSTATE* pSigState;
  /* 0x0084 */ struct WINTRUST_SIGNATURE_SETTINGS_* pSigSettings;
} CRYPT_PROVIDER_DATA, *PCRYPT_PROVIDER_DATA; /* size: 0x0088 */
