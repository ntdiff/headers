...
{
  /* 0x0018 */ struct _GUID _typeLibId;
  /* 0x0028 */ wchar_t _version[256];
  /* 0x0228 */ unsigned long _localeId;
  /* 0x022c */ class Microsoft::WRL::ComPtr<ReferencedRegistryKey> _versionKey;
  /* 0x0230 */ class RegistryKey _localeKey;
}; /* size: 0x0234 */
