...
typedef struct _NDIS_NIC_SWITCH_BLOCK
{
  ...
  /* 0x0260 */ unsigned long NumActiveDefaultVPortMacAddresses;
  /* 0x0264 */ unsigned long NumActiveNonDefaultVPortMacAddresses;
  /* 0x0268 */ unsigned long NumActiveDefaultVPortVlanIds;
  /* 0x026c */ unsigned long NumActiveNonDefaultVPortVlanIds;
} NDIS_NIC_SWITCH_BLOCK, *PNDIS_NIC_SWITCH_BLOCK; /* size: 0x0270 */
