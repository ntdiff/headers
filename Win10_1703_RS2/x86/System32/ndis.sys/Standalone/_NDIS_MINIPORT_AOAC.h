...
typedef struct _NDIS_MINIPORT_AOAC
{
  ...
  /* 0x00e8 */ struct _KEVENT WdfAoAcDisengagedEvent;
  /* 0x00f8 */ unsigned char WdfAoAcTransition;
  /* 0x00fc */ struct _KEVENT NicQuietCheckCompleteEvent;
  ...
  /* 0x012c */ long ComponentRefCounts[16];
  /* 0x0170 */ struct _NDIS_AOAC_COMPONENT_REF_TIME CsRefTimes[16];
  /* 0x0270 */ long CsPowerTransitions;
  /* 0x0278 */ unsigned __int64 TotalCsActiveTime;
  /* 0x0280 */ unsigned __int64 TotalCsResiliencyTime;
  /* 0x0288 */ unsigned __int64 CurrentActiveStartTime;
  /* 0x0290 */ unsigned __int64 CurrentCsResiliencyStartTime;
  /* 0x0298 */ unsigned long CsSurpriseWakes;
  /* 0x029c */ unsigned long CsSpuriousWakes;
  /* 0x02a0 */ struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];
  /* 0x0330 */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;
  /* 0x035c */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX CsSpuriousWakeStatsEx;
  /* 0x036c */ unsigned char DirectedMacPatternPlumbed;
  /* 0x036d */ unsigned char IsInCsResiliency;
  /* 0x036e */ char __PADDING__[2];
} NDIS_MINIPORT_AOAC, *PNDIS_MINIPORT_AOAC; /* size: 0x0370 */
