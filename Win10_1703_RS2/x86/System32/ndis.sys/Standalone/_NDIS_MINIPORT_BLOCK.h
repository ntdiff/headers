...
class Rtl::KArray<wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK> > >
{
...
class Rtl::KArray<wistd::unique_ptr<NDIS_BIND_FILTER_LINK,wistd::default_delete<NDIS_BIND_FILTER_LINK> > >
{
  /* 0x0000 */ unsigned long m_bufferSize;
  /* 0x0004 */ unsigned long m_numElements;
...
{
  /* 0x0000 */ class Rtl::KArray<wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK> > > Protocols;
  /* 0x000c */ class Rtl::KArray<wistd::unique_ptr<NDIS_BIND_FILTER_LINK,wistd::default_delete<NDIS_BIND_FILTER_LINK> > > Filters;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x0674 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x0688 */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x068c */ struct _LIST_ENTRY PortList;
  /* 0x0694 */ unsigned char* AllocatedPortIndices;
  /* 0x0698 */ unsigned long AllocatedPortIndicesLength;
  /* 0x069c */ unsigned long NumberOfPorts;
  /* 0x06a0 */ unsigned long NumberOfActivePorts;
  ...
  /* 0x0d28 */ struct RECORDER_LOG__* BlackBoxHandle;
  /* 0x0d2c */ struct _KEVENT* PowerCompleteEvent;
  /* 0x0d30 */ long PowerCompleteStatus;
  /* 0x0d34 */ struct _POWER_WORK_ITEM DevicePowerOnWorkItem;
  /* 0x0d60 */ struct _POWER_WORK_ITEM DevicePowerDownWorkItem;
  /* 0x0d8c */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x0d90 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x0d94 */ void* PdcHandle;
  /* 0x0d98 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x0de0 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x0e08 */ volatile long PdcTaskClientMode;
  /* 0x0e0c */ unsigned long ModernStandbyWoLMagicPacketEnable;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x0e10 */
