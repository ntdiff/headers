...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  /* 0x0380 */ __int64 RelativeTimerDueTime;
  /* 0x0388 */ struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;
  /* 0x0398 */ struct _EX_TIMER* PeriodicCaptureStateTimer;
  /* 0x03a0 */ enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;
  /* 0x03a8 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x03b0 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x03b8 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x03d8 */ long CompressionWorkItemState;
  /* 0x03e0 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x03e8 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x03f0 */ void* CompressionWorkspace;
  /* 0x03f8 */ long CompressionOn;
  /* 0x03fc */ unsigned long CompressionRatioGuess;
  /* 0x0400 */ unsigned long PartialBufferCompressionLevel;
  /* 0x0404 */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x0408 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x0410 */ struct _KDPC CompressionDpc;
  /* 0x0450 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0458 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0460 */ union _LARGE_INTEGER BufferCompressDuration;
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0468 */
