  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x0004 */ unsigned long Spare : 21; /* bit position: 11 */
      }; /* bitfield */
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x0070 */ unsigned char HeteroDecreaseThreshold[640];
  /* 0x02f0 */ unsigned char HeteroIncreaseThreshold[640];
  /* 0x0570 */ unsigned char Class0FloorPerformance;
  /* 0x0571 */ unsigned char Class1InitialPerformance;
  /* 0x0572 */ char __PADDING__[6];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x0578 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x0b18 */ unsigned __int64 StartTime;
  /* 0x0b20 */ unsigned __int64 Count;
  /* 0x0b28 */ unsigned __int64 MaxDuration;
  /* 0x0b30 */ unsigned __int64 MinDuration;
  /* 0x0b38 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x0b40 */
