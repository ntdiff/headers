...
typedef struct _MI_PARTITION_CORE
{
  ...
  /* 0x0010 */ unsigned __int64 ReferenceCount;
  /* 0x0018 */ struct _MI_PARTITION* ParentPartition;
  /* 0x0020 */ struct _LIST_ENTRY ListEntry;
  /* 0x0030 */ struct _MI_NODE_INFORMATION* NodeInformation;
  /* 0x0038 */ struct _RTL_AVL_TREE PageRoot;
  /* 0x0040 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* MemoryNodeRuns;
  /* 0x0048 */ unsigned __int64 MemoryBlockReferences;
  /* 0x0050 */ struct _WORK_QUEUE_ITEM PfnUnmapWorkItem;
  ...
  /* 0x00d8 */ struct _EX_PUSH_LOCK PartitionSystemThreadsLock;
  /* 0x00e0 */ struct _EX_PUSH_LOCK DynamicMemoryPushLock;
  /* 0x00e8 */ volatile long DynamicMemoryLock;
  /* 0x00ec */ unsigned char PfnUnmapActive;
  /* 0x00f0 */ struct _KEVENT TemporaryMemoryEvent;
  /* 0x0108 */ void* RootDirectory;
  /* 0x0110 */ void* KernelObjectsDirectory;
  /* 0x0118 */ struct _KEVENT* MemoryEvents[11];
  /* 0x0170 */ void* MemoryEventHandles[11];
} MI_PARTITION_CORE, *PMI_PARTITION_CORE; /* size: 0x01c8 */
...
typedef struct _MI_PARTITION_STORES
{
  ...
  /* 0x0050 */ struct _KEVENT EvictFlushCompleteEvent;
  /* 0x0068 */ struct _RTL_BITMAP* ModifiedWriteFailedBitmap;
  /* 0x0070 */ struct _EPROCESS* StoreProcess;
...
typedef struct _MI_PARTITION_SEGMENTS
{
  ...
  /* 0x0050 */ struct _MMDEREFERENCE_SEGMENT_HEADER DereferenceSegmentHeader;
  /* 0x0080 */ struct _LIST_ENTRY DeleteOnCloseList;
  /* 0x0090 */ struct _KTIMER DeleteOnCloseTimer;
  /* 0x00d0 */ unsigned char DeleteOnCloseTimerActive;
  /* 0x00d8 */ struct _LIST_ENTRY UnusedSegmentList;
  /* 0x00e8 */ struct _LIST_ENTRY UnusedSubsectionList;
  /* 0x00f8 */ struct _LIST_ENTRY DeleteSubsectionList;
  /* 0x0108 */ struct _KEVENT ControlAreaDeleteEvent;
  /* 0x0120 */ struct _SINGLE_LIST_ENTRY ControlAreaDeleteList;
  /* 0x0128 */ struct _MI_PTE_CHAIN_HEAD FreeSystemCache;
  /* 0x0140 */ struct _KEVENT CloneDereferenceEvent;
  /* 0x0160 */ union _SLIST_HEADER CloneProtosSListHead;
  /* 0x0170 */ struct _EX_PUSH_LOCK SystemCacheInitLock;
  /* 0x0178 */ struct _MI_CROSS_PARTITION_CHARGES SharedCharges[4];
  /* 0x01f8 */ struct _KEVENT* SharedChargesDrainEvent;
  /* 0x0200 */ struct _KEVENT* PagefileControlAreasDrainEvent;
  /* 0x0208 */ long __PADDING__[14];
} MI_PARTITION_SEGMENTS, *PMI_PARTITION_SEGMENTS; /* size: 0x0240 */
...
} MI_PARTITION_ZEROING, *PMI_PARTITION_ZEROING; /* size: 0x0060 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x01c8 */ struct _MI_PARTITION_MODWRITES Modwriter;
  /* 0x04a0 */ struct _MI_PARTITION_STORES Store;
  /* 0x0540 */ struct _MI_PARTITION_SEGMENTS Segments;
  /* 0x0780 */ struct _MI_PARTITION_PAGE_LISTS PageLists;
  /* 0x1340 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x13c0 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1420 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x15a8 */ void* WorkingSetControl;
  /* 0x15b0 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x15c0 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x27c0 */
