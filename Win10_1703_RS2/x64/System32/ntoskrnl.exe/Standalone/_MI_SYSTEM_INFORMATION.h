...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0018 */ unsigned __int64 UnusedSubsectionPagedPool;
  /* 0x0020 */ unsigned long UnusedSegmentForceFree;
  /* 0x0024 */ unsigned long DataSectionProtectionMask;
  /* 0x0028 */ void* HighSectionBase;
  /* 0x0030 */ struct _MSUBSECTION PhysicalSubsection;
  /* 0x00a0 */ struct _CONTROL_AREA PhysicalControlArea;
  /* 0x0120 */ struct _MMPFN* DanglingExtentsPages;
  /* 0x0128 */ volatile long DanglingExtentsLock;
  /* 0x0130 */ struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem;
  /* 0x0150 */ unsigned char DanglingExtentsWorkerActive;
  /* 0x0158 */ struct _RTL_AVL_TREE PageFileSectionHead;
  /* 0x0160 */ volatile long PageFileSectionListSpinLock;
  /* 0x0164 */ unsigned long ImageBias;
  /* 0x0168 */ struct _EX_PUSH_LOCK RelocateBitmapsLock;
  /* 0x0170 */ struct _RTL_BITMAP ImageBitMap;
  /* 0x0180 */ unsigned long ImageBias64Low;
  /* 0x0184 */ unsigned long ImageBias64High;
  /* 0x0188 */ struct _RTL_BITMAP ImageBitMap64Low;
  /* 0x0198 */ struct _RTL_BITMAP ImageBitMap64High;
  /* 0x01a8 */ struct _RTL_BITMAP ImageBitMapWow64Dll;
  /* 0x01b8 */ void* ApiSetSection;
  /* 0x01c0 */ void* ApiSetSchema;
  /* 0x01c8 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x01d0 */ unsigned long LostDataFiles;
  /* 0x01d4 */ unsigned long LostDataPages;
  /* 0x01d8 */ unsigned long ImageFailureReason;
  /* 0x01e0 */ struct _SECTION* CfgBitMapSection32;
  /* 0x01e8 */ struct _CONTROL_AREA* CfgBitMapControlArea32;
  /* 0x01f0 */ struct _SECTION* CfgBitMapSection64;
  /* 0x01f8 */ struct _CONTROL_AREA* CfgBitMapControlArea64;
  /* 0x0200 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x0210 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x0218 */ unsigned long ImageCfgFailure;
  /* 0x021c */ unsigned long ImageChecksumBreakpoint;
  /* 0x0220 */ unsigned long ImageSizeBreakpoint;
  /* 0x0224 */ volatile long ImageValidationFailed;
  /* 0x0228 */ long __PADDING__[6];
} MI_SECTION_STATE, *PMI_SECTION_STATE; /* size: 0x0240 */
...
} MI_SYSTEM_IMAGE_STATE, *PMI_SYSTEM_IMAGE_STATE; /* size: 0x00b8 */
...
typedef struct _MI_PROCESS_STATE
{
  ...
  /* 0x0028 */ struct _MMPTE* SharedUserDataPte;
} MI_PROCESS_STATE, *PMI_PROCESS_STATE; /* size: 0x0030 */
...
typedef struct _MI_SYSTEM_VA_STATE
{
  ...
  /* 0x0058 */ struct _MI_DYNAMIC_BITMAP DynamicBitMapDriverImages[2];
  /* 0x00e8 */ struct _MI_DYNAMIC_BITMAP DynamicBitMapPagedPool;
  /* 0x0130 */ struct _MI_DYNAMIC_BITMAP DynamicBitMapSpecialPool[2];
  ...
  /* 0x023c */ volatile long DeleteKvaLock;
  /* 0x0240 */ struct _MI_WSLE* WsleArrays[5];
  /* 0x0268 */ struct _MI_HYPER_SPACE* PagableHyperSpace;
  /* 0x0270 */ void* HyperSpaceEnd;
  /* 0x0278 */ struct _KEVENT FreeSystemCacheVa;
  /* 0x0290 */ unsigned __int64 SystemVaLock;
  /* 0x0298 */ unsigned __int64 SystemCacheViewLock;
  /* 0x02a0 */ struct _MMWSL_INSTANCE SystemWorkingSetList[5];
  /* 0x0368 */ long __PADDING__[6];
} MI_SYSTEM_VA_STATE, *PMI_SYSTEM_VA_STATE; /* size: 0x0380 */
...
} MI_STANDBY_STATE, *PMI_STANDBY_STATE; /* size: 0x0070 */
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x0118 */ unsigned long StackGrowthFailures;
  /* 0x011c */ unsigned char KernelStackPages;
  /* 0x011d */ unsigned char TrackPtesAborted;
  /* 0x011e */ unsigned char AdjustCounter;
  /* 0x0120 */ volatile long ReservedMappingLock;
  /* 0x0128 */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x0130 */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x0138 */ struct _RTL_AVL_TREE OutswappedKernelStackRoot;
  /* 0x0140 */ volatile long OutswappedKernelStackLock;
...
typedef struct _MMPTE_SOFTWARE
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned __int64 Unused : 8; /* bit position: 24 */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0108 */ volatile unsigned __int64 NonPagedPoolCommit;
  /* 0x0110 */ volatile unsigned __int64 SmallNonPagedPtesCommit;
  ...
  /* 0x0138 */ volatile unsigned __int64 ProcessCommit;
  /* 0x0140 */ volatile long DriverCommit;
  /* 0x0148 */ unsigned __int64 PfnDatabaseCommit;
  ...
  /* 0x0560 */ unsigned long MapCacheFailures;
  /* 0x0568 */ unsigned __int64 PagefileHashPages;
  /* 0x0570 */ struct _SYSPTES_HEADER PteHeader;
  /* 0x0688 */ struct _MI_SPECIAL_POOL* SessionSpecialPool;
  /* 0x0690 */ unsigned __int64 SystemVaTypeCount[14];
  /* 0x0700 */ unsigned char SystemVaType[256];
  /* 0x0800 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[13];
  /* 0x08d0 */ long __PADDING__[12];
} MI_VISIBLE_STATE, *PMI_VISIBLE_STATE; /* size: 0x0900 */

typedef struct _MI_SYSTEM_INFORMATION
{
  /* 0x0000 */ struct _MI_POOL_STATE Pools;
  /* 0x0100 */ struct _MI_SECTION_STATE Sections;
  /* 0x0340 */ struct _MI_SYSTEM_IMAGE_STATE SystemImages;
  /* 0x03f8 */ struct _MI_SESSION_STATE Sessions;
  /* 0x0480 */ struct _MI_PROCESS_STATE Processes;
  /* 0x04b0 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x05c0 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  ...
  /* 0x0bc8 */ struct _MI_ERROR_STATE Errors;
  /* 0x0c80 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x0d00 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x0e20 */ struct _MI_STANDBY_STATE Standby;
  /* 0x0ec0 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x1040 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x10b0 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x1100 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x11c0 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x1200 */ unsigned __int64 Cookie;
  /* 0x1208 */ void* volatile* BootRegistryRuns;
  /* 0x1210 */ volatile long ZeroingDisabled;
  /* 0x1214 */ unsigned char FullyInitialized;
  /* 0x1215 */ unsigned char SafeBooted;
  /* 0x1218 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x1240 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x1b40 */
