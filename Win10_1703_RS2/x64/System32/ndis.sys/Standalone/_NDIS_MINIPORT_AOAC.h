...
typedef struct _NDIS_MINIPORT_AOAC
{
  ...
  /* 0x01ec */ long ComponentRefCounts[16];
  /* 0x0230 */ struct _NDIS_AOAC_COMPONENT_REF_TIME CsRefTimes[16];
  /* 0x0330 */ long CsPowerTransitions;
  /* 0x0338 */ unsigned __int64 TotalCsActiveTime;
  /* 0x0340 */ unsigned __int64 TotalCsResiliencyTime;
  /* 0x0348 */ unsigned __int64 CurrentActiveStartTime;
  /* 0x0350 */ unsigned __int64 CurrentCsResiliencyStartTime;
  /* 0x0358 */ unsigned long CsSurpriseWakes;
  /* 0x035c */ unsigned long CsSpuriousWakes;
  /* 0x0360 */ struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];
  /* 0x03f0 */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;
  /* 0x041c */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX CsSpuriousWakeStatsEx;
  /* 0x042c */ unsigned char DirectedMacPatternPlumbed;
  /* 0x042d */ unsigned char IsInCsResiliency;
  /* 0x042e */ char __PADDING__[2];
} NDIS_MINIPORT_AOAC, *PNDIS_MINIPORT_AOAC; /* size: 0x0430 */
