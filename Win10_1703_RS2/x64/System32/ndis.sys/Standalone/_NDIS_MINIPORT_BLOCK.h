...
class Ndis::BindState
{
  ...
  /* 0x0030 */ class Rtl::KArray<void *> m_bindContext;
}; /* size: 0x0040 */
...
struct Ndis::BindStack
{
  ...
  /* 0x0010 */ class Rtl::KArray<wistd::unique_ptr<NDIS_BIND_FILTER_LINK,wistd::default_delete<NDIS_BIND_FILTER_LINK> > > Filters;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1510 */ struct RECORDER_LOG__* BlackBoxHandle;
  /* 0x1518 */ struct _KEVENT* PowerCompleteEvent;
  /* 0x1520 */ long PowerCompleteStatus;
  /* 0x1528 */ struct _POWER_WORK_ITEM DevicePowerOnWorkItem;
  /* 0x1580 */ struct _POWER_WORK_ITEM DevicePowerDownWorkItem;
  /* 0x15d8 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x15e0 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x15e8 */ struct _NDIS_PD_BLOCK* PDBlock;
  /* 0x15f0 */ void* PdcHandle;
  /* 0x15f8 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x1678 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x16c8 */ volatile long PdcTaskClientMode;
  /* 0x16cc */ unsigned long ModernStandbyWoLMagicPacketEnable;
