...
struct NDIS_SETUP_DEVICE_EXTENSION
{
  ...
  /* 0x0008 */ struct NDIS_SETUP_DEVICE_EXTENSION* Next;
  /* 0x0010 */ BOOL IsDeviceInterfaceActive;
  /* 0x0011 */ BOOL IsSurpriseRemoved;
  /* 0x0012 */ BOOL LowPowerRequested;
  /* 0x0013 */ BOOL LowPowerRequestCompleted;
  /* 0x0014 */ BOOL LowPowerRequestSucceeded;
  /* 0x0018 */ struct _DEVICE_OBJECT* Fdo;
  /* 0x0020 */ struct _DEVICE_OBJECT* Pdo;
  /* 0x0028 */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x0030 */ struct _UNICODE_STRING SymbolicName;
  /* 0x0040 */ struct _KTIMER IdleTimer;
  /* 0x0080 */ struct _KDPC IdleDpc;
  /* 0x00c0 */ struct _IO_REMOVE_LOCK RemoveLock;
}; /* size: 0x00e0 */
