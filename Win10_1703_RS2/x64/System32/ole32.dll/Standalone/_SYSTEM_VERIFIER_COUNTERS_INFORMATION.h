...
typedef struct _SYSTEM_VERIFIER_COUNTERS_INFORMATION
{
  ...
  /* 0x00fc */ unsigned long UnsupportedRelocs;
  /* 0x0100 */ unsigned long IATInExecutableSection;
  /* 0x0104 */ long __PADDING__[1];
} SYSTEM_VERIFIER_COUNTERS_INFORMATION, *PSYSTEM_VERIFIER_COUNTERS_INFORMATION; /* size: 0x0108 */
