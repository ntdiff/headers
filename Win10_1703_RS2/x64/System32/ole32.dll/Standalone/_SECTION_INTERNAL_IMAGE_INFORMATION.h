...
typedef struct _SECTION_INTERNAL_IMAGE_INFORMATION
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      /* 0x0040 */ unsigned long ImageReturnFlowGuardEnabled : 1; /* bit position: 0 */
      /* 0x0040 */ unsigned long ImageReturnFlowGuardStrict : 1; /* bit position: 1 */
      /* 0x0040 */ unsigned long ImageExportSuppressionEnabled : 1; /* bit position: 2 */
      /* 0x0040 */ unsigned long Reserved : 29; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0004 */
