...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x00d9 */ char Padding_85[7];
  /* 0x00e0 */ unsigned long MapRegistersPerChannel;
  /* 0x00e4 */ long Padding_86;
  ...
  /* 0x01f8 */ unsigned char AdapterInUse;
  /* 0x01f9 */ char Padding_91[7];
  /* 0x0200 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0208 */ struct _MDL* ScatterGatherMdl;
  /* 0x0210 */ unsigned long ScatterGatherBufferLength;
  /* 0x0214 */ long Padding_92;
  /* 0x0218 */ struct _SCATTER_GATHER_LIST ScatterGatherBuffer;
} ADAPTER_OBJECT, *PADAPTER_OBJECT; /* size: 0x0228 */
...
} HAL_INTEL_ENLIGHTENMENT_INFORMATION, *PHAL_INTEL_ENLIGHTENMENT_INFORMATION; /* size: 0x0180 */
