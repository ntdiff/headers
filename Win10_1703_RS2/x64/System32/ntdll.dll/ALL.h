...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x01a0 */ unsigned char GuaranteedPerformancePercent;
  /* 0x01a1 */ unsigned char HvTargetState;
  /* 0x01a2 */ unsigned char Parked;
  /* 0x01a3 */ char Padding_24;
  /* 0x01a4 */ unsigned long LatestPerformancePercent;
  /* 0x01a8 */ unsigned long AveragePerformancePercent;
  /* 0x01ac */ unsigned long LatestAffinitizedPercent;
...
} PROCESSOR_POWER_STATE, *PPROCESSOR_POWER_STATE; /* size: 0x01d8 */
...
typedef struct _KPRCB
{
  ...
  /* 0x2db0 */ unsigned long PrcbPad41[20];
  ...
  /* 0x5b9b */ unsigned char PrcbPad80[5];
  /* 0x5ba0 */ unsigned long DpcTimeCount;
  /* 0x5ba4 */ unsigned long DpcTimeLimit;
  /* 0x5ba8 */ unsigned long PeriodicCount;
  /* 0x5bac */ unsigned long PeriodicBias;
  /* 0x5bb0 */ unsigned long AvailableTime;
  /* 0x5bb4 */ unsigned long KeExceptionDispatchCount;
  /* 0x5bb8 */ unsigned long ReadyThreadCount;
  /* 0x5bbc */ long Padding_30;
  ...
  /* 0x5c00 */ unsigned __int64 ReadyQueueExpectedRunTime;
  /* 0x5c08 */ unsigned long PrcbPad81[21];
  /* 0x5c5c */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x5c60 */ volatile long MmSpinLockOrdering;
  /* 0x5c64 */ unsigned long PageColor;
  /* 0x5c68 */ unsigned long NodeColor;
  /* 0x5c6c */ unsigned long NodeShiftedColor;
  /* 0x5c70 */ unsigned long SecondaryColorMask;
  /* 0x5c74 */ unsigned long PrcbPad83;
  /* 0x5c78 */ unsigned __int64 CycleTime;
  /* 0x5c80 */ unsigned __int64 Cycles[2][4];
  /* 0x5cc0 */ unsigned long PrcbPad84[16];
  /* 0x5d00 */ unsigned long CcFastMdlReadNoWait;
  /* 0x5d04 */ unsigned long CcFastMdlReadWait;
  /* 0x5d08 */ unsigned long CcFastMdlReadNotPossible;
  /* 0x5d0c */ unsigned long CcMapDataNoWait;
  /* 0x5d10 */ unsigned long CcMapDataWait;
  /* 0x5d14 */ unsigned long CcPinMappedDataCount;
  /* 0x5d18 */ unsigned long CcPinReadNoWait;
  /* 0x5d1c */ unsigned long CcPinReadWait;
  /* 0x5d20 */ unsigned long CcMdlReadNoWait;
  /* 0x5d24 */ unsigned long CcMdlReadWait;
  /* 0x5d28 */ unsigned long CcLazyWriteHotSpots;
  /* 0x5d2c */ unsigned long CcLazyWriteIos;
  /* 0x5d30 */ unsigned long CcLazyWritePages;
  /* 0x5d34 */ unsigned long CcDataFlushes;
  /* 0x5d38 */ unsigned long CcDataPages;
  /* 0x5d3c */ unsigned long CcLostDelayedWrites;
  /* 0x5d40 */ unsigned long CcFastReadResourceMiss;
  /* 0x5d44 */ unsigned long CcCopyReadWaitMiss;
  /* 0x5d48 */ unsigned long CcFastMdlReadResourceMiss;
  /* 0x5d4c */ unsigned long CcMapDataNoWaitMiss;
  /* 0x5d50 */ unsigned long CcMapDataWaitMiss;
  /* 0x5d54 */ unsigned long CcPinReadNoWaitMiss;
  /* 0x5d58 */ unsigned long CcPinReadWaitMiss;
  /* 0x5d5c */ unsigned long CcMdlReadNoWaitMiss;
  /* 0x5d60 */ unsigned long CcMdlReadWaitMiss;
  /* 0x5d64 */ unsigned long CcReadAheadIos;
  /* 0x5d68 */ volatile long MmCacheTransitionCount;
  /* 0x5d6c */ volatile long MmCacheReadCount;
  /* 0x5d70 */ volatile long MmCacheIoCount;
  /* 0x5d74 */ unsigned long PrcbPad91[3];
  /* 0x5d80 */ struct _PROCESSOR_POWER_STATE PowerState;
  /* 0x5f58 */ struct _LIST_ENTRY ScbList;
  /* 0x5f68 */ struct _KDPC ForceIdleDpc;
  /* 0x5fa8 */ unsigned long PrcbPad92[18];
  /* 0x5ff0 */ unsigned long KeAlignmentFixupCount;
  /* 0x5ff4 */ long Padding_31;
  /* 0x5ff8 */ struct _KDPC DpcWatchdogDpc;
  /* 0x6038 */ struct _KTIMER DpcWatchdogTimer;
  /* 0x6078 */ struct _CACHE_DESCRIPTOR Cache[5];
  /* 0x60b4 */ unsigned long CacheCount;
  /* 0x60b8 */ volatile unsigned long CachedCommit;
  /* 0x60bc */ volatile unsigned long CachedResidentAvailable;
  /* 0x60c0 */ void* HyperPte;
  /* 0x60c8 */ void* WheaInfo;
  /* 0x60d0 */ void* EtwSupport;
  /* 0x60d8 */ long Padding_32[2];
  /* 0x60e0 */ union _SLIST_HEADER InterruptObjectPool;
  /* 0x60f0 */ union _SLIST_HEADER HypercallPageList;
  /* 0x6100 */ void* HypercallCachedPages;
  /* 0x6108 */ void* VirtualApicAssist;
  /* 0x6110 */ unsigned __int64* StatisticsPage;
  /* 0x6118 */ struct _KAFFINITY_EX PackageProcessorSet;
  /* 0x61c0 */ unsigned __int64 SharedReadyQueueMask;
  /* 0x61c8 */ struct _KSHARED_READY_QUEUE* SharedReadyQueue;
  /* 0x61d0 */ unsigned long SharedQueueScanOwner;
  /* 0x61d4 */ unsigned long ScanSiblingIndex;
  /* 0x61d8 */ unsigned __int64 CoreProcessorSet;
  /* 0x61e0 */ unsigned __int64 ScanSiblingMask;
  /* 0x61e8 */ unsigned __int64 LLCMask;
  /* 0x61f0 */ unsigned __int64 CacheProcessorMask[5];
  /* 0x6218 */ struct _PROCESSOR_PROFILE_CONTROL_AREA* ProcessorProfileControlArea;
  /* 0x6220 */ void* ProfileEventIndexAddress;
  /* 0x6228 */ void** DpcWatchdogProfile;
  /* 0x6230 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x6238 */ unsigned __int64 PrcbPad94[9];
  /* 0x6280 */ struct _SYNCH_COUNTERS SynchCounters;
  /* 0x6338 */ unsigned __int64 PteBitCache;
  /* 0x6340 */ unsigned long PteBitOffset;
  /* 0x6344 */ long Padding_33;
  /* 0x6348 */ struct _FILESYSTEM_DISK_COUNTERS FsCounters;
  /* 0x6358 */ unsigned char VendorString[13];
  /* 0x6365 */ unsigned char PrcbPad100[2];
  /* 0x6367 */ unsigned char PendingVirtualLittle;
  /* 0x6368 */ unsigned __int64 FeatureBits;
  /* 0x6370 */ unsigned long PrcbPad110;
  /* 0x6374 */ long Padding_34;
  /* 0x6378 */ union _LARGE_INTEGER UpdateSignature;
  /* 0x6380 */ struct _CONTEXT* Context;
  /* 0x6388 */ unsigned long ContextFlagsInit;
  /* 0x638c */ long Padding_35;
  /* 0x6390 */ struct _XSAVE_AREA* ExtendedState;
  /* 0x6398 */ void* IsrStack;
  /* 0x63a0 */ struct _KENTROPY_TIMING_STATE EntropyTimingState;
  /* 0x64f0 */ struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;
  /* 0x64f8 */ struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;
  /* 0x6500 */ struct _KDPC AbDpc;
  /* 0x6540 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x6594 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x65e8 */ long Padding_36[6];
  /* 0x6600 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x6870 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x6970 */ unsigned long TimerExpirationTraceCount;
  /* 0x6974 */ long Padding_37;
  /* 0x6978 */ void* ExSaPageArray;
  /* 0x6980 */ struct _KSECURE_FAULT_INFORMATION SecureFault;
  /* 0x6990 */ long Padding_38[12];
  /* 0x69c0 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x69c8 */ long Padding_39[14];
  /* 0x6a00 */ struct _REQUEST_MAILBOX RequestMailbox[1];
} KPRCB, *PKPRCB; /* size: 0x6a40 */
...
typedef struct _TEB
{
  ...
  /* 0x0190 */ void* SystemReserved1[32];
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0074 */ unsigned long Reserved : 12; /* bit position: 20 */
    }; /* bitfield */
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0078 */ unsigned long BamEppImportant : 1; /* bit position: 2 */
      ...
      /* 0x0078 */ unsigned long KernelStackResident : 1; /* bit position: 16 */
      /* 0x0078 */ unsigned long TerminateRequestReason : 2; /* bit position: 17 */
      /* 0x0078 */ unsigned long ProcessStackCountDecremented : 1; /* bit position: 19 */
      /* 0x0078 */ unsigned long RestrictedGuiThread : 1; /* bit position: 20 */
      /* 0x0078 */ unsigned long ThreadFlagsSpare : 3; /* bit position: 21 */
...
typedef struct _HEAP
{
  ...
  /* 0x0183 */ unsigned char RequestedFrontEndHeapType;
  /* 0x0184 */ long Padding_62;
  /* 0x0188 */ unsigned short* FrontEndHeapUsageData;
  /* 0x0190 */ unsigned short FrontEndHeapMaximumIndex;
  /* 0x0192 */ volatile unsigned char FrontEndHeapStatusBitmap[129];
  /* 0x0213 */ char Padding_63[5];
  /* 0x0218 */ struct _HEAP_COUNTERS Counters;
  /* 0x0290 */ struct _HEAP_TUNING_PARAMETERS TuningParameters;
} HEAP, *PHEAP; /* size: 0x02a0 */
...
typedef struct _KNODE
{
  ...
  /* 0x0060 */ long Padding_119[8];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_120;
  union
  {
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x01b8 */ unsigned long PpmPolicy : 2; /* bit position: 6 */
  ...
  /* 0x0278 */ unsigned char Spare2[80];
...
typedef struct _EPROCESS
{
  ...
  /* 0x06cb */ unsigned char HangCount;
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x06cc */ unsigned long DisableNonSystemFonts : 1; /* bit position: 2 */
      /* 0x06cc */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 3 */
      /* 0x06cc */ unsigned long Crashed : 1; /* bit position: 4 */
      /* 0x06cc */ unsigned long JobVadsAreTracked : 1; /* bit position: 5 */
      /* 0x06cc */ unsigned long VadTrackingDisabled : 1; /* bit position: 6 */
      /* 0x06cc */ unsigned long AuxiliaryProcess : 1; /* bit position: 7 */
      /* 0x06cc */ unsigned long SubsystemProcess : 1; /* bit position: 8 */
      /* 0x06cc */ unsigned long IndirectCpuSets : 1; /* bit position: 9 */
      /* 0x06cc */ unsigned long InPrivate : 1; /* bit position: 10 */
      /* 0x06cc */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 11 */
      /* 0x06cc */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 12 */
      /* 0x06cc */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 13 */
      /* 0x06cc */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 14 */
      /* 0x06cc */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 15 */
      /* 0x06cc */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 16 */
      /* 0x06cc */ unsigned long PreferSystem32Images : 1; /* bit position: 17 */
      /* 0x06cc */ unsigned long RelinquishedCommit : 1; /* bit position: 18 */
      /* 0x06cc */ unsigned long AutomaticallyOverrideChildProcessPolicy : 1; /* bit position: 19 */
      /* 0x06cc */ unsigned long HighGraphicsPriority : 1; /* bit position: 20 */
      /* 0x06cc */ unsigned long CommitFailLogged : 1; /* bit position: 21 */
      /* 0x06cc */ unsigned long ReserveFailLogged : 1; /* bit position: 22 */
      /* 0x06cc */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 23 */
      /* 0x06cc */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 24 */
      /* 0x06cc */ unsigned long LoaderIntegrityContinuityAudit : 1; /* bit position: 25 */
      /* 0x06cc */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 26 */
      /* 0x06cc */ unsigned long FatalAccessTerminationRequested : 1; /* bit position: 27 */
      /* 0x06cc */ unsigned long DisableSystemAllowedCpuSet : 1; /* bit position: 28 */
      /* 0x06cc */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 29 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x06d0 */ long DeviceAsid;
  /* 0x06d4 */ long Padding_127;
  /* 0x06d8 */ void* SvmData;
  ...
  /* 0x0718 */ unsigned __int64 TrustletIdentity;
  /* 0x0720 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x0724 */ long Padding_128;
  ...
  union
  {
    /* 0x0810 */ unsigned long Flags4;
    struct /* bitfield */
    {
      /* 0x0810 */ unsigned long PicoCreated : 1; /* bit position: 0 */
      /* 0x0810 */ unsigned long RestrictSetThreadContext : 1; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0814 */ long __PADDING__[1];
} EPROCESS, *PEPROCESS; /* size: 0x0818 */
...
typedef struct _EJOB
{
  ...
  /* 0x05d0 */ struct _EX_PUSH_LOCK IoControlLock;
  /* 0x05d8 */ unsigned __int64 SiloHardReferenceCount;
  /* 0x05e0 */ struct _WORK_QUEUE_ITEM RundownWorkItem;
  /* 0x0600 */ void* MemoryPartitionObject;
  /* 0x0608 */ union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;
} EJOB, *PEJOB; /* size: 0x0610 */
...
typedef struct _ETHREAD
{
  ...
  /* 0x05e8 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x05f0 */ union _LARGE_INTEGER ExitTime;
    /* 0x05f0 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  /* 0x0600 */ void* ChargeOnlySession;
  union
  {
  ...
  /* 0x0698 */ void* LegacyPowerObject;
  /* 0x06a0 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06b0 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x06b8 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x06c0 */ unsigned long ReadClusterSize;
  /* 0x06c4 */ volatile long MmLockOrdering;
  union
  {
    /* 0x06c8 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x06c8 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x06c8 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x06c8 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x06c8 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x06c8 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x06c8 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x06c8 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x06c8 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x06c8 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x06c8 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x06c8 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x06c8 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x06c8 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x06c8 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x06c8 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x06c8 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x06c8 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x06c8 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x06c8 */ unsigned long ReservedCrossThreadFlags : 10; /* bit position: 22 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06cc */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x06cc */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x06cc */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x06cc */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x06cc */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x06cc */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x06cc */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x06cc */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x06cc */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x06cc */ unsigned long ReservedSameThreadPassiveFlags : 23; /* bit position: 9 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06d0 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x06d0 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x06d0 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x06d0 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x06d0 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x06d0 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x06d0 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x06d0 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x06d0 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x06d1 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x06d1 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x06d4 */ unsigned char CacheManagerActive;
  /* 0x06d5 */ unsigned char DisablePageFaultClustering;
  /* 0x06d6 */ unsigned char ActiveFaultCount;
  /* 0x06d7 */ unsigned char LockOrderState;
  /* 0x06d8 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x06e0 */ void* AlpcMessage;
    /* 0x06e0 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x06e8 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x06f8 */ long ExitStatus;
  /* 0x06fc */ unsigned long CacheManagerCount;
  /* 0x0700 */ unsigned long IoBoostCount;
  /* 0x0704 */ unsigned long IoQoSBoostCount;
  /* 0x0708 */ unsigned long IoQoSThrottleCount;
  /* 0x070c */ long Padding_134;
  /* 0x0710 */ struct _LIST_ENTRY BoostList;
  /* 0x0720 */ struct _LIST_ENTRY DeboostList;
  /* 0x0730 */ unsigned __int64 BoostListLock;
  /* 0x0738 */ unsigned __int64 IrpListLock;
  /* 0x0740 */ void* ReservedForSynchTracking;
  /* 0x0748 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0750 */ const struct _GUID* ActivityId;
  /* 0x0758 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0760 */ void* VerifierContext;
  /* 0x0768 */ unsigned long KernelStackReference;
  /* 0x076c */ long Padding_135;
...
typedef struct _ENODE
{
  ...
  /* 0x0140 */ struct _EX_WORK_QUEUE* volatile ExWorkQueues[8];
  /* 0x0180 */ struct _EX_WORK_QUEUE ExWorkQueue;
  /* 0x0450 */ struct _EX_WORK_QUEUE IoWorkQueue;
  /* 0x0720 */ struct _KEVENT ExpThreadSetManagerEvent;
  /* 0x0738 */ struct _KTIMER ExpDeadlockTimer;
  /* 0x0778 */ struct _KEVENT ExpThreadReaperEvent;
  /* 0x0790 */ struct _KWAIT_BLOCK WaitBlocks[3];
  /* 0x0820 */ struct _ETHREAD* ExpWorkerThreadBalanceManagerPtr;
  /* 0x0828 */ unsigned long ExpWorkerSeed;
  union
  {
    struct /* bitfield */
    {
      /* 0x082c */ volatile unsigned long ExWorkerFullInit : 1; /* bit position: 0 */
      /* 0x082c */ volatile unsigned long ExWorkerStructInit : 1; /* bit position: 1 */
    }; /* bitfield */
    /* 0x082c */ volatile unsigned long ExWorkerFlags;
  }; /* size: 0x0004 */
  /* 0x0830 */ long __PADDING__[4];
} ENODE, *PENODE; /* size: 0x0840 */
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0384 */ long Padding_179;
  /* 0x0388 */ struct _WNF_SILODRIVERSTATE WnfSiloState;
  /* 0x03c0 */ struct _UNICODE_STRING PsProtectedCurrentDirectory;
  /* 0x03d0 */ struct _UNICODE_STRING PsProtectedEnvironment;
  /* 0x03e0 */ void* ApiSetSection;
  /* 0x03e8 */ void* ApiSetSchema;
  /* 0x03f0 */ unsigned char OneCoreForwardersEnabled;
  /* 0x03f1 */ char Padding_180[7];
  /* 0x03f8 */ struct _UNICODE_STRING NtSystemRoot;
  /* 0x0408 */ struct _UNICODE_STRING SiloRootDirectoryName;
  /* 0x0418 */ struct _PSP_STORAGE* Storage;
  /* 0x0420 */ enum _SERVERSILO_STATE State;
  /* 0x0424 */ long ExitStatus;
  /* 0x0428 */ struct _KEVENT* DeleteEvent;
  /* 0x0430 */ struct _SILO_USER_SHARED_DATA* UserSharedData;
  /* 0x0438 */ void* UserSharedSection;
  /* 0x0440 */ struct _WORK_QUEUE_ITEM TerminateWorkItem;
} ESERVERSILO_GLOBALS, *PESERVERSILO_GLOBALS; /* size: 0x0460 */
...
typedef struct _MM_DRIVER_VERIFIER_DATA
{
  ...
  /* 0x00a4 */ volatile unsigned long UnsupportedRelocs;
  /* 0x00a8 */ volatile unsigned long IATInExecutableSection;
...
typedef struct _HEAP_LFH_CONTEXT
{
  ...
  /* 0x0039 */ char Padding_200[7];
  /* 0x0040 */ const unsigned char* AffinityModArray;
  /* 0x0048 */ long Padding_201[2];
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x0088 */ union _RTL_RUN_ONCE StackTraceInitVar;
  /* 0x0090 */ struct _RTL_SRWLOCK ContextExtendLock;
  /* 0x0098 */ unsigned char* AllocatedBase;
  /* 0x00a0 */ unsigned char* UncommittedBase;
  /* 0x00a8 */ unsigned char* ReservedLimit;
  /* 0x00b0 */ struct _HEAP_VS_CONTEXT VsContext;
  /* 0x0120 */ struct _HEAP_LFH_CONTEXT LfhContext;
} SEGMENT_HEAP, *PSEGMENT_HEAP; /* size: 0x05f0 */
...
typedef struct _HEAP_LARGE_ALLOC_DATA
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0020 */ unsigned __int64 Spare : 11; /* bit position: 1 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x0168 */ unsigned char HeapMajorVersion;
  /* 0x0169 */ unsigned char HeapMinorVersion;
  /* 0x016a */ char Padding_216[6];
  /* 0x0170 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x0208 */ long Padding_217[2];
  /* 0x0210 */ struct _CONTEXT ContextRecord;
} HEAP_FAILURE_INFORMATION, *PHEAP_FAILURE_INFORMATION; /* size: 0x06e0 */
...
typedef struct _RTLP_HP_STACKTRACKING_CONTEXT
{
  ...
  /* 0x0010 */ struct _RTL_STACKDB_CONTEXT StackDbContext;
} RTLP_HP_STACKTRACKING_CONTEXT, *PRTLP_HP_STACKTRACKING_CONTEXT; /* size: 0x0058 */
...
RtlpHpLargeFree
RtlpHpLargeMetadataNodeCompare
RtlpHpLargeReAlloc
