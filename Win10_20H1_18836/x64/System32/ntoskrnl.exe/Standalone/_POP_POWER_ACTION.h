...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x019c */ enum _POP_POWER_ACTION_WATCHDOG_STATE WatchdogState;
  ...
  /* 0x01b8 */ struct _KTHREAD* UnlockAfterSleepWorkerThread;
} POP_POWER_ACTION, *PPOP_POWER_ACTION; /* size: 0x01c0 */
