...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0041 */ char Padding_242[7];
  /* 0x0048 */ struct _REFERENCE_EX Ref;
  /* 0x0060 */ int FakeStatus;
  /* 0x0064 */ long Padding_243;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1096 */ char Padding_287[2];
  /* 0x1098 */ unsigned long DirectOidRequestCount;
  /* 0x109c */ long Padding_288;
...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0060 */ long Padding_496[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_497[12];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_515;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_516[2];
...
{
  /* 0x0000 */ long Padding_545[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_546;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_547;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
...
?NDIS_BUFFER_TO_SPAN_PAGES@@YAKPEAU_MDL@@@Z
...
?NdisAdjustBufferLength@@YAXPEAU_MDL@@I@Z
?NdisAnsiStringToUnicodeString@@YAHPEAU_UNICODE_STRING@@PEAU_STRING@@@Z
?NdisBufferVirtualAddress@@YAPEAXPEAU_MDL@@@Z
?NdisGetBufferPhysicalArraySize@@YAXPEAU_MDL@@PEAI@Z
?NdisGetCurrentSystemTime@@YAXPEAT_LARGE_INTEGER@@@Z
?NdisGetFirstBufferFromPacketSafe@@YAXPEAU_NDIS_PACKET@@PEAPEAU_MDL@@PEAPEAXPEAI3W4_MM_PAGE_PRIORITY@@@Z
?NdisGetPacketCancelId@@YAPEAXPEAU_NDIS_PACKET@@@Z
?NdisGetPacketFromNetBufferList@@YAPEAU_NDIS_PACKET@@PEAU_NET_BUFFER_LIST@@PEAX@Z
?NdisGetVersion640Shim@@YAIXZ
?NdisMGetMiniportInitAttributes@@YAHPEAX0@Z
?NdisMRequestDpc@@YAKPEAU_NDIS_MINIPORT_INTERRUPT@@K@Z
?NdisMSetAttributes@@YAXPEAX0EW4_NDIS_INTERFACE_TYPE@@@Z
?NdisMWanIndicateReceive@@YAXPEAHPEAX1PEAEK@Z
?NdisMWanIndicateReceiveComplete@@YAXPEAX0@Z
?NdisMWanSendComplete@@YAXPEAXPEAU_NDIS_WAN_PACKET@@H@Z
...
?NdisQueryBufferOffset@@YAXPEAU_MDL@@PEAI1@Z
?NdisQueryBufferSafe@@YAXPEAU_MDL@@PEAPEAXPEAIW4_MM_PAGE_PRIORITY@@@Z
?NdisQueryPacket@@YAXPEAU_NDIS_PACKET@@PEAI1PEAPEAU_MDL@@1@Z
?NdisSendPackets@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z
?NdisSetJobObjectCompartmentId@@YAJPEAU_EJOB@@I@Z
?NdisSetPacketCancelId@@YAXPEAU_NDIS_PACKET@@PEAX@Z
...
?NdisTransferData@@YAXPEAHPEAX1IIPEAU_NDIS_PACKET@@PEAI@Z
?NdisUnexpectedAoAcError@@YAXPEAU_NDIS_MINIPORT_BLOCK@@GJ@Z
?NdisUnicodeStringToAnsiString@@YAHPEAU_STRING@@PEAU_UNICODE_STRING@@@Z
?NdisUpcaseUnicodeString@@YAHPEAU_UNICODE_STRING@@0@Z
...
?ndis5InterruptDpc@@YAXPEAU_KDPC@@PEAX11@Z
?ndis5QueuedMiniportDpcWorkItem@@YAXPEAX@Z
...
?ndisAllocateConfigurationString@@YAHPEBU_UNICODE_STRING@@00PEAU1@@Z
...
?ndisBootDriverReinit@@YAXPEAU_DRIVER_OBJECT@@PEAXK@Z
...
?ndisCaptureProcessorConfigurationAtBoot@@YAXXZ
...
?ndisCmCleanupDpcRoutine@@YAXPEAU_KDPC@@PEAX11@Z
?ndisCmCleanupSessionState@@YAXXZ
?ndisCmCleanupWorkRoutine@@_Y2PAGE@@AXPEAX@Z
...
?ndisCoIndicateStatusInternal@@YAXPEAX0PEAU_NDIS_STATUS_INDICATION@@@Z
...
?ndisCompareProcNumInit@@_Y2INIT@@AHPEBX0@Z
...
?ndisCpuHotAddHandler@@YAXPEAXPEAU_KE_PROCESSOR_CHANGE_NOTIFY_CONTEXT@@PEAJ@Z
?ndisCreateReceiveWorkerThreadPool@@YAHXZ
?ndisCreateRssV1Parameters@@YAXPEAU_NDIS_RECEIVE_SCALE_PARAMETERS@@KK@Z
?ndisCreateThread@@YAHP6AXPEAX@Z0JPEAPEAU_KTHREAD@@@Z
?ndisCsResiliencyCallback@@YAJPEBU_GUID@@PEAXK1@Z
...
?ndisDispatchRequest@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z
...
?ndisDriverReinit@@YAXPEAU_DRIVER_OBJECT@@PEAXK@Z
?ndisDriverSystemDispatch@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z
...
?ndisEnumerateInterfaces32@@_Y2PAGENPNP@@AJPEAU_NDIS_ENUM_INTF32@@IPEAI@Z
?ndisEnumerateInterfaces@@_Y2PAGENPNP@@AJPEAU_NDIS_ENUM_INTF@@IPEAI@Z
?ndisEtwRegisterGuids@@YAJPEAUWMIREGINFOW@@KPEAK@Z
...
?ndisFreeToNPagedPool@@YAXPEAXPEAU_LOOKASIDE_LIST_EX@@@Z
?ndisFreeWatchdog@@YAXPEAUNDISWATCHDOG__@@@Z
?ndisGenerateCorrelationIds@@YAKKK@Z
...
?ndisGetDpcWatchdogInfo@@_Y2INIT@@AXPEAU_KDPC@@PEAX11@Z
?ndisGetFilterAltitude@@YAJAEAVNetSetupPropertyBag@@AEAK@Z
?ndisGetLogicalProcessorInformation@@YAJPEAU_NDIS_SYSTEM_PROCESSOR_INFO_EX@@@Z
...
?ndisGetProcessorInfo@@_Y2INIT@@AHXZ
...
?ndisGetSetBusConfigSpace@@YAKPEAU_NDIS_MINIPORT_BLOCK@@KPEAXKKE@Z
...
?ndisHandleBindNotification@@YAJPEAU_UNICODE_STRING@@@Z
?ndisHandleLegacyBindIoctl@@YAXPEAU_UNICODE_STRING@@KPEBU1@@Z
?ndisHandleLegacyTransport@@YAJPEBU_UNICODE_STRING@@@Z
?ndisHandleProtocolReconfigNotification@@_Y2PAGENPNP@@AJPEAU_UNICODE_STRING@@0PEAXII@Z
?ndisHandleProtocolUnloadNotification@@YAJPEBU_UNICODE_STRING@@@Z
...
?ndisIfDetachMiniportBlock@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z
...
?ndisImmediateReadWritePort@@YAXPEAXK0KE@Z
...
?ndisInitializePeriodicReceives@@_Y2INIT@@AHXZ
...
?ndisInterruptDpc@@YAXPEAU_KDPC@@PEAX11@Z
...
?ndisKillReceiveWorkerThreadPool@@YAXXZ
?ndisLWM5IndicateReceive@@YAXPEAU_X_FILTER@@PEAX1I1II@Z
...
?ndisLiveDumpAddSecondaryData@@YAJPEAUNDIS_MEMORYDUMP_HANDLE__@@PEBU_GUID@@PEAXK@Z
?ndisLoadNetworkInterfaceFromPersistedState@@YAJAEBU_GUID@@AEAVKRegKey@@1@Z
?ndisLowPowerEpochCallback@@YAJPEBU_GUID@@PEAXK1@Z
...
?ndisMDpc@@YAXPEAU_KDPC@@PEAX11@Z
?ndisMDpcX@@YAXPEAU_KDPC@@PEAX11@Z
...
?ndisMIndicateSplitNblChain@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKKK@Z
...
?ndisMInvokeReset@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAE@Z
?ndisMIsLoopbackNetBuffer@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NET_BUFFER@@PEAU_NET_BUFFER_LIST@@PEAE3@Z
?ndisMIsLoopbackPacket@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PACKET@@PEAPEAU2@@Z
?ndisMIsr@@YAEPEAU_KINTERRUPT@@PEAX@Z
...
?ndisMQueueReceiveNetBufferLists@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z
...
?ndisMTimerObjectDpc@@YAXPEAU_KDPC@@PEAX11@Z
...
?ndisMapOpenByName@@YAPEAU_NDIS_OPEN_BLOCK@@PEBU_UNICODE_STRING@@PEAU_NDIS_PROTOCOL_BLOCK@@W4_NDIS_MP_REFTAG@@W4_NDIS_OPEN_REFTAG@@@Z
...
?ndisMiniportIsr@@YAEPEAU_KINTERRUPT@@PEAX@Z
?ndisMiniportMessageIsr@@YAEPEAU_KINTERRUPT@@PEAXK@Z
...
?ndisNsiSyncMiniportMediaConnectStateNotification@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z
...
?ndisOpenProtocolSubkey@@YAHPEAU_NDIS_CONFIGURATION_HANDLE@@@Z
...
?ndisPplCreatePool@@YAPEAXK_KKGP6AXPEAXPEAU_LOOKASIDE_LIST_EX@@@Z@Z
?ndisPplDestroyPool@@YAXPEAXK@Z
...
?ndisQueryCustomGuids@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAPEAU_NDIS_GUID@@PEAG@Z
...
?ndisQueryGuidData@@YAJPEAEKPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAU_NDIS_CO_VC_PTR_BLOCK@@PEAU_GUID@@1@Z
?ndisQueryGuidDataSize@@YAJPEAKPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAU_NDIS_CO_VC_PTR_BLOCK@@PEAU_GUID@@1@Z
...
?ndisQuerySupportedGuidToOidList@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z
...
?ndisReadUpperBindings@@YAHPEAU_NDIS_M_DRIVER_BLOCK@@PEAPEA_WPEAK@Z
?ndisReceiveQueueingOff@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z
?ndisReceiveQueueingOn@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z
...
?ndisReferenceNextUnprocessedMiniport@@_Y2PAGENPNP@@APEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_M_DRIVER_BLOCK@@@Z
...
?ndisReturnPacketToNetBufferList@@YAXPEAXPEAU_NDIS_PACKET@@@Z
...
?ndisStartMapping@@YAJW4_INTERFACE_TYPE@@KKKKPEAPEAXPEAE@Z
?ndisStartNsiClient@@YAJXZ
?ndisStartNsiProvider@@_Y2PAGE@@AJXZ
?ndisStopNsiProvider@@YAXXZ
?ndisSumDataBlock@@YAXPEA_K0@Z
?ndisSwitchMiniportReceiveFunction@@YAJW4_NDIS_M_PERIODIC_RECEIVE_ACTION@@@Z
...
?ndisUnloadPeriodicReceives@@_Y2INIT@@AXXZ
?ndisUnprocessAllMiniports@@_Y2PAGENPNP@@AXPEAU_NDIS_M_DRIVER_BLOCK@@@Z
...
?ndisWmiDisableEvents@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_GUID@@@Z
?ndisWmiEnableEvents@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_GUID@@@Z
?ndisWmiFindInstanceName@@YAJPEAPEAU_NDIS_CO_VC_PTR_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@PEA_WG@Z
?ndisWmiGuidIsAdapterSpecific@@YAEPEAU_GUID@@@Z
?ndisWmiMapOids@@YAGPEAU_NDIS_GUID@@GPEBKG0K@Z
?ndisWmiRegister@@YAJPEAU_NDIS_MINIPORT_BLOCK@@_KPEAUWMIREGINFOW@@KPEAK@Z
?ndisWmiXlateEnumNdisRecvQueuesToWmiRecvQueues@@YAHPEAU_NDIS_RECEIVE_QUEUE_INFO_ARRAY@@KKPEAK@Z
?ndisWmiXlateNdisOffloadToWmiOffload@@YAXPEAU_NDIS_OFFLOAD@@@Z
?ndisWmiXlateNdisRecvQueueParamsToWmiRecvQueueParams@@YAXPEAU_NDIS_RECEIVE_QUEUE_PARAMETERS@@@Z
?ndisWnfPdcCallback@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z
?ndisWorkItemHandler@@YAXPEAX@Z
...
?wil_RecordFeatureVariantUsage@@YAXIIH@Z
...
ndisIMInitializeDeviceInstanceInternal
...
ndisMiniportQueryDevicePropertyData
ndisMiniportXStateClearFlag
ndisMoveLinkedList
ndisNDKCheckIfEnabledOnMiniport
ndisNDKCleanup
...
ndisSynchronousOidRequestInternal
...
ndisWakeUpDevice
ndisWdfDeviceObjectCleanup
ndisWdfGetGuidToOidList
ndisWdfNotifyDevicePower
ndisWdfNotifySystemPower
ndisWdfPostReleaseHardware
ndisWdfPowerResumeComplete
ndisWdfPreReleaseHardware
ndisWdfSendPmParametersForSuspend
