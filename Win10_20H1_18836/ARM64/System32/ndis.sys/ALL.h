...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x107e */ char Padding_158[2];
  /* 0x1080 */ unsigned long DirectOidRequestCount;
  /* 0x1084 */ long Padding_159;
...
struct wil_details_StagingConfig
{
  ...
  /* 0x000d */ char Padding_347[3];
  /* 0x0010 */ int modified;
  /* 0x0014 */ long Padding_348;
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_497;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_498[2];
...
typedef struct _TCP_OFFLOAD_STATE_DELEGATED
{
  ...
  /* 0x004e */ char Padding_524[2];
  struct
  {
    /* 0x0050 */ unsigned char ProbeCount;
    /* 0x0001 */ char Padding_525[3];
...
{
  /* 0x0000 */ long Padding_540[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_541;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_542;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
...
?ndisIPsecNblInfoToPktInfo@@YAXPEAU_NDIS_IPSEC_OFFLOAD_V1_NET_BUFFER_LIST_INFO@@W4_NDIS_XLATE_TYPE@@PEAU_NDIS_IPSEC_PACKET_INFO@@PEAPEAU3@@Z
...
?ndisMiniportDpc@@YAXPEAU_KDPC@@PEAX11@Z
...
ndisWMIDispatch
ndisWMIIrpDispatch
ndisWaitForPendingNblReturnLock
