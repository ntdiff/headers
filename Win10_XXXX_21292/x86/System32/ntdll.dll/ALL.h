...
typedef struct _KSCHEDULER_SUBNODE
{
  ...
  /* 0x005c */ long Padding_5[9];
  union
  {
    /* 0x0080 */ struct _GROUP_AFFINITY Affinity;
    struct
    {
      /* 0x0080 */ unsigned char AffinityFill[6];
      /* 0x0086 */ unsigned short ParentNodeNumber;
      /* 0x0088 */ unsigned short SubNodeNumber;
      /* 0x008a */ unsigned short Spare;
    }; /* size: 0x000c */
  }; /* size: 0x000c */
  /* 0x008c */ unsigned long SiblingMask;
  /* 0x0090 */ unsigned long SharedReadyQueueMask;
  /* 0x0094 */ unsigned long StrideMask;
  /* 0x0098 */ unsigned long LLCLeaders;
  /* 0x009c */ unsigned long Lowest;
  /* 0x00a0 */ unsigned long Highest;
  /* 0x00a4 */ struct _flags Flags;
  /* 0x00a5 */ char Padding_6[3];
  ...
  /* 0x0100 */ unsigned long QosPreemptibleSet;
  /* 0x0104 */ long __PADDING__[15];
} KSCHEDULER_SUBNODE, *PKSCHEDULER_SUBNODE; /* size: 0x0140 */
...
typedef struct _PROC_FEEDBACK
{
  ...
  /* 0x0082 */ unsigned char CounterReadOptimize;
  /* 0x0083 */ char __PADDING__[5];
...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x0018 */ volatile unsigned __int64 IdleSequenceNumber;
  ...
  /* 0x00d8 */ unsigned long WmiDispatchPtr;
  /* 0x00dc */ long WmiInterfaceEnabled;
  /* 0x00e0 */ struct _PPM_FFH_THROTTLE_STATE_INFO FFHThrottleStateInfo;
  /* 0x0100 */ struct _KDPC PerfActionDpc;
  /* 0x0120 */ volatile long PerfActionMask;
  /* 0x0124 */ long Padding_12;
  /* 0x0128 */ struct _PROC_IDLE_SNAP HvIdleCheck;
  /* 0x0138 */ struct _PROC_PERF_CHECK_CONTEXT CheckContext;
  /* 0x0164 */ struct _PPM_CONCURRENCY_ACCOUNTING* Concurrency;
  /* 0x0168 */ struct _PPM_CONCURRENCY_ACCOUNTING* ClassConcurrency;
  /* 0x016c */ unsigned char ArchitecturalEfficiencyClass;
  /* 0x016d */ unsigned char PerformanceSchedulingClass;
  /* 0x016e */ unsigned char EfficiencySchedulingClass;
  /* 0x016f */ unsigned char Unused;
  /* 0x0170 */ unsigned char Parked;
  /* 0x0171 */ unsigned char LongPriorQosPeriod;
  /* 0x0172 */ char Padding_13[6];
  union
  {
    /* 0x0178 */ unsigned __int64 SnapTimeLast;
    /* 0x0178 */ unsigned __int64 EnergyConsumed;
  }; /* size: 0x0008 */
  /* 0x0180 */ unsigned __int64 ActiveTime;
  /* 0x0188 */ unsigned __int64 TotalTime;
  /* 0x0190 */ struct _POP_FX_DEVICE* FxDevice;
  /* 0x0194 */ long Padding_14;
  /* 0x0198 */ unsigned __int64 LastQosTranstionTsc;
  /* 0x01a0 */ unsigned __int64 QosTransitionHysteresis;
  /* 0x01a8 */ enum _KHETERO_CPU_QOS RequestedQosClass;
  /* 0x01ac */ enum _KHETERO_CPU_QOS ResolvedQosClass;
  /* 0x01b0 */ unsigned short QosEquivalencyMask;
  /* 0x01b2 */ unsigned short HwFeedbackTableIndex;
  /* 0x01b4 */ unsigned char HwFeedbackParkHint;
  /* 0x01b5 */ unsigned char HwFeedbackPerformanceClass;
  /* 0x01b6 */ unsigned char HwFeedbackEfficiencyClass;
  /* 0x01b7 */ unsigned char HeteroCoreType;
} PROCESSOR_POWER_STATE, *PPROCESSOR_POWER_STATE; /* size: 0x01b8 */
  ...
  union
  {
    union
    {
      struct /* bitfield */
      {
        ...
        /* 0x0009 */ unsigned char LargeHeapFirstSegment : 1; /* bit position: 5 */
      }; /* bitfield */
      /* 0x0009 */ unsigned char AllFlags;
    }; /* size: 0x0001 */
  } /* size: 0x0001 */ Flags;
  /* 0x000a */ char Padding_15[2];
...
typedef struct _KSINGLE_DPC_SOFT_TIMEOUT_EVENT_INFO
{
  ...
  /* 0x0020 */ void* DeferredRoutine;
  /* 0x0024 */ volatile unsigned long TickCount;
} KSINGLE_DPC_SOFT_TIMEOUT_EVENT_INFO, *PKSINGLE_DPC_SOFT_TIMEOUT_EVENT_INFO; /* size: 0x0028 */
...
typedef struct _KSHARED_READY_QUEUE
{
  ...
  /* 0x0108 */ struct _KPRIORITY_STATE RunningSummary[32];
...
typedef struct _REQUEST_MAILBOX
{
  ...
  /* 0x0018 */ volatile long* SubNodeTargetCountAddr;
  /* 0x001c */ volatile long SubNodeTargetCount;
...
typedef struct _KPRCB
{
  ...
  /* 0x0338 */ struct _KSCHEDULER_SUBNODE* SchedulerSubNode;
  /* 0x033c */ struct _KPRIORITY_STATE* PriorityState;
  ...
  /* 0x04d0 */ unsigned long DpcTimeLimitTicks;
  ...
  /* 0x04f8 */ volatile long PrcbPad94;
  ...
  /* 0x21a8 */ volatile __int64 MmSpinLockOrdering;
  ...
  /* 0x2274 */ unsigned long SingleDpcSoftTimeLimitTicks;
  /* 0x2278 */ struct _KSINGLE_DPC_SOFT_TIMEOUT_EVENT_INFO* SingleDpcSoftTimeoutEventInfo;
  /* 0x227c */ unsigned long CumulativeDpcSoftTimeLimitTicks;
  /* 0x2280 */ unsigned long PrcbPad41[7];
  /* 0x229c */ long Padding_44;
  ...
  /* 0x3b48 */ long DpcWatchdogPeriodTicks;
  /* 0x3b4c */ long DpcWatchdogCount;
  /* 0x3b50 */ volatile long KeSpinLockOrdering;
  /* 0x3b54 */ unsigned long DpcWatchdogProfileCumulativeDpcThresholdTicks;
  ...
  /* 0x3b7c */ long Padding_45;
  /* 0x3b80 */ unsigned __int64 StartCycles;
  /* 0x3b88 */ unsigned __int64 TaggedCycles[4];
  ...
  /* 0x3c14 */ volatile unsigned long HighStartCycles;
  ...
  /* 0x3fa8 */ struct _KDPC ForceIdleDpc;
  /* 0x3fc8 */ unsigned __int64 PrcbPad96[6];
  /* 0x3ff8 */ unsigned long PrcbPad91[7];
  ...
  /* 0x4034 */ unsigned long DpcWatchdogProfileSingleDpcThresholdTicks;
  ...
  /* 0x4874 */ long Padding_47;
  /* 0x4878 */ struct _KCLOCK_TIMER_STATE ClockTimerState;
  /* 0x4d90 */ void* ExSaPageArray;
  /* 0x4d94 */ struct _XSAVE_AREA_HEADER* ExtendedSupervisorState;
  /* 0x4d98 */ unsigned long PrcbPad100[1];
  /* 0x4d9c */ long Padding_48;
  /* 0x4da0 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x4ee0 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x4ee4 */ unsigned char PrcbPad[4092];
  /* 0x5ee0 */ unsigned long KernelDirectoryTableBase;
  /* 0x5ee4 */ unsigned long EspBaseShadow;
  /* 0x5ee8 */ unsigned long UserEspShadow;
  /* 0x5eec */ unsigned long ShadowFlags;
  /* 0x5ef0 */ unsigned long UserDS;
  /* 0x5ef4 */ unsigned long UserES;
  /* 0x5ef8 */ unsigned long UserFS;
  /* 0x5efc */ void* EspIretd;
  /* 0x5f00 */ unsigned long RestoreSegOption;
  /* 0x5f04 */ unsigned long SavedEsi;
  /* 0x5f08 */ unsigned long PrcbShadowPad;
  /* 0x5f0c */ unsigned long TaskSwitchCount;
  /* 0x5f10 */ unsigned long DbgLogs[512];
  /* 0x6710 */ unsigned long DbgCount;
  /* 0x6714 */ struct _KAFFINITY_EX DieProcessorSet;
  /* 0x6720 */ unsigned char CoresPerPhysicalDie;
  /* 0x6721 */ char Padding_49[3];
  /* 0x6724 */ unsigned long PrcbPadRemainingPage[495];
  /* 0x6ee0 */ struct _REQUEST_MAILBOX RequestMailbox[1];
} KPRCB, *PKPRCB; /* size: 0x6f00 */
...
typedef struct _TEB
{
  ...
  /* 0x1000 */ unsigned __int64 LastSleepCounter;
  /* 0x1008 */ unsigned long DelayBackoff;
  /* 0x100c */ long Padding_53;
  /* 0x1010 */ unsigned __int64 ExtendedFeatureDisableMask;
} TEB, *PTEB; /* size: 0x1018 */
...
typedef struct _PEB
{
  ...
  /* 0x0040 */ struct _RTL_BITMAP* TlsBitmap;
  ...
  /* 0x0150 */ struct _RTL_BITMAP* TlsExpansionBitmap;
  ...
  /* 0x020c */ void* SparePointers[2];
  /* 0x0214 */ void* PatchLoaderData;
  /* 0x0218 */ struct _CHPEV2_PROCESS_INFO* ChpeV2ProcessInfo;
...
typedef struct _HEAP_VAMGR_ALLOCATOR
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x001a */ unsigned char MemoryType : 3; /* bit position: 1 */
    /* 0x001a */ unsigned char ConstrainedVA : 1; /* bit position: 4 */
    /* 0x001a */ unsigned char AllowFreeHead : 1; /* bit position: 5 */
    /* 0x001a */ unsigned char Spare0 : 2; /* bit position: 6 */
  }; /* bitfield */
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0058 */ unsigned long Spare1 : 1; /* bit position: 8 */
      ...
      /* 0x0058 */ unsigned long Spare2 : 1; /* bit position: 16 */
      ...
      /* 0x0058 */ unsigned long CetKernelShadowStack : 1; /* bit position: 22 */
      /* 0x0058 */ unsigned long StateSaveAreaDecoupled : 1; /* bit position: 23 */
      /* 0x0058 */ unsigned long Reserved : 8; /* bit position: 24 */
    }; /* bitfield */
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x005c */ unsigned long EtwStackTraceCrimsonApcDisabled : 1; /* bit position: 23 */
  ...
  /* 0x0154 */ struct _KAFFINITY_EX* UserAffinity;
  /* 0x0158 */ unsigned short UserAffinityPrimaryGroup;
  ...
  /* 0x0164 */ struct _KAFFINITY_EX* Affinity;
  /* 0x0168 */ unsigned short AffinityPrimaryGroup;
  ...
  /* 0x01f4 */ unsigned char PriorityFloorCounts[32];
  ...
  /* 0x0260 */ long RealtimePriorityFloor;
  /* 0x0264 */ unsigned long Spare28[5];
  /* 0x0278 */ struct _SINGLE_LIST_ENTRY SystemAffinityTokenListHead;
  /* 0x027c */ void* IptSaveArea;
  /* 0x0280 */ unsigned long Spare29[2];
  /* 0x0288 */ unsigned long EndPadding[8];
} KTHREAD, *PKTHREAD; /* size: 0x02a8 */
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0064 */ unsigned long MultiGroup : 1; /* bit position: 11 */
  ...
  /* 0x00cc */ unsigned short PrimaryGroup;
  /* 0x00ce */ unsigned short Spare3;
  /* 0x00d0 */ unsigned long EndPadding[4];
...
typedef struct _RTLP_HP_HEAP_MANAGER
{
  ...
  /* 0x1c50 */ struct _RTLP_HP_METADATA_HEAP_CTX MetadataHeaps[4];
  /* 0x1c70 */ struct _RTL_HP_SUB_ALLOCATOR_CONFIGS SubAllocConfigs;
} RTLP_HP_HEAP_MANAGER, *PRTLP_HP_HEAP_MANAGER; /* size: 0x1c78 */
...
} PS_DYNAMIC_ENFORCED_ADDRESS_RANGES, *PPS_DYNAMIC_ENFORCED_ADDRESS_RANGES; /* size: 0x0008 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x0194 */ void* PaeTop;
  /* 0x0198 */ struct _EX_FAST_REF DeviceMap;
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x03a8 */ unsigned long DisallowUserTerminate : 1; /* bit position: 27 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  ...
  /* 0x043c */ unsigned short Machine;
  /* 0x043e */ unsigned short Spare0;
  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0494 */ unsigned long CetUserShadowStacksStrictMode : 1; /* bit position: 20 */
        /* 0x0494 */ unsigned long BlockNonCetBinaries : 1; /* bit position: 21 */
        /* 0x0494 */ unsigned long BlockNonCetBinariesNonEhcont : 1; /* bit position: 22 */
        /* 0x0494 */ unsigned long AuditBlockNonCetBinaries : 1; /* bit position: 23 */
        /* 0x0494 */ unsigned long AuditBlockNonCetBinariesLogged : 1; /* bit position: 24 */
        /* 0x0494 */ unsigned long XtendedControlFlowGuard : 1; /* bit position: 25 */
        /* 0x0494 */ unsigned long AuditXtendedControlFlowGuard : 1; /* bit position: 26 */
        /* 0x0494 */ unsigned long PointerAuthUserIp : 1; /* bit position: 27 */
        /* 0x0494 */ unsigned long AuditPointerAuthUserIp : 1; /* bit position: 28 */
        /* 0x0494 */ unsigned long AuditPointerAuthUserIpLogged : 1; /* bit position: 29 */
        /* 0x0494 */ unsigned long CetDynamicApisOutOfProcOnly : 1; /* bit position: 30 */
        /* 0x0494 */ unsigned long UserCetSetContextIpValidationRelaxedMode : 1; /* bit position: 31 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x0498 */ void* PartitionObject;
  /* 0x049c */ long Padding_89;
  ...
  /* 0x04dc */ struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES DynamicEnforcedCetCompatibleRanges;
  /* 0x04e4 */ unsigned long DisabledComponentFlags;
  /* 0x04e8 */ long __PADDING__[6];
...
typedef struct _ETHREAD
{
  ...
  /* 0x02a8 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x02b0 */ union _LARGE_INTEGER ExitTime;
    /* 0x02b0 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0008 */
  /* 0x02b8 */ void* ChargeOnlySession;
  union
  {
    /* 0x02bc */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x02bc */ void* ForwardLinkShadow;
      /* 0x02c0 */ void* StartAddress;
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
  union
  {
    /* 0x02c4 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x02c4 */ struct _ETHREAD* ReaperLink;
    /* 0x02c4 */ void* KeyedWaitValue;
  }; /* size: 0x0004 */
  /* 0x02c8 */ unsigned long ActiveTimerListLock;
  /* 0x02cc */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x02d4 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x02dc */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x02dc */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0014 */
  /* 0x02f0 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x02f4 */ struct _LIST_ENTRY IrpList;
  /* 0x02fc */ unsigned long TopLevelIrp;
  /* 0x0300 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x0304 */ void* Win32StartAddress;
  /* 0x0308 */ void* LegacyPowerObject;
  /* 0x030c */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x0314 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x0318 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x031c */ unsigned long ReadClusterSize;
  /* 0x0320 */ volatile long MmLockOrdering;
  union
  {
    /* 0x0324 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x0324 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x0324 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x0324 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x0324 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x0324 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x0324 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x0324 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x0324 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x0324 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x0324 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x0324 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x0324 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x0324 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x0324 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x0324 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x0324 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x0324 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x0324 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x0324 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x0324 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x0324 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0328 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x0328 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x0328 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x0328 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x0328 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x0328 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x0328 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x0328 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x0328 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x0328 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x0328 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x0328 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x0328 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x032c */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x032c */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x032c */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x032c */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x032c */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x032c */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x032c */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x032c */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x032c */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x032d */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x032d */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x032d */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x032d */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x032d */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
        /* 0x032d */ unsigned char SessionAttachActive : 1; /* bit position: 7 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x0330 */ unsigned char CacheManagerActive;
  /* 0x0331 */ unsigned char DisablePageFaultClustering;
  /* 0x0332 */ unsigned char ActiveFaultCount;
  /* 0x0333 */ unsigned char LockOrderState;
  /* 0x0334 */ unsigned long PerformanceCountLowReserved;
  /* 0x0338 */ long PerformanceCountHighReserved;
  /* 0x033c */ unsigned long AlpcMessageId;
  union
  {
    /* 0x0340 */ void* AlpcMessage;
    /* 0x0340 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0004 */
  /* 0x0344 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x034c */ long ExitStatus;
  /* 0x0350 */ unsigned long CacheManagerCount;
  /* 0x0354 */ unsigned long IoBoostCount;
  /* 0x0358 */ unsigned long IoQoSBoostCount;
  /* 0x035c */ unsigned long IoQoSThrottleCount;
  /* 0x0360 */ unsigned long KernelStackReference;
  /* 0x0364 */ struct _LIST_ENTRY BoostList;
  /* 0x036c */ struct _LIST_ENTRY DeboostList;
  /* 0x0374 */ unsigned long BoostListLock;
  /* 0x0378 */ unsigned long IrpListLock;
  /* 0x037c */ void* ReservedForSynchTracking;
  /* 0x0380 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0384 */ const struct _GUID* ActivityId;
  /* 0x0388 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x038c */ void* VerifierContext;
  /* 0x0390 */ void* AdjustedClientToken;
  /* 0x0394 */ void* WorkOnBehalfThread;
  /* 0x0398 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x03a4 */ void* PicoContext;
  /* 0x03a8 */ unsigned long UserFsBase;
  /* 0x03ac */ unsigned long UserGsBase;
  /* 0x03b0 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  union
  {
    /* 0x03b4 */ unsigned long SelectedCpuSets;
    /* 0x03b4 */ unsigned long* SelectedCpuSetsIndirect;
  }; /* size: 0x0004 */
  /* 0x03b8 */ struct _EJOB* Silo;
  /* 0x03bc */ struct _UNICODE_STRING* ThreadName;
  /* 0x03c0 */ void* SparePointer;
  /* 0x03c4 */ unsigned long LastExpectedRunTime;
  /* 0x03c8 */ unsigned long HeapData;
  /* 0x03cc */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x03d4 */ unsigned long DisownedOwnerEntryListLock;
  /* 0x03d8 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
  /* 0x03e0 */ struct _KLOCK_ENTRY LockEntries[6];
  /* 0x0530 */ void* CmThreadInfo;
  /* 0x0534 */ void* FlsData;
} ETHREAD, *PETHREAD; /* size: 0x0538 */
...
typedef union _FS_FILTER_PARAMETERS
{
  union
  {
    ...
    } /* size: 0x0014 */ AcquireForSectionSynchronization;
    struct
    {
...
typedef struct _MM_DRIVER_VERIFIER_DATA
{
  ...
  /* 0x0054 */ volatile unsigned long PagedBytes;
  /* 0x0058 */ volatile unsigned long NonPagedBytes;
  /* 0x005c */ unsigned long PeakPagedBytes;
  /* 0x0060 */ unsigned long PeakNonPagedBytes;
  /* 0x0064 */ volatile unsigned long BurstAllocationsFailedDeliberately;
  /* 0x0068 */ unsigned long SessionTrims;
  /* 0x006c */ volatile unsigned long OptionChanges;
  /* 0x0070 */ volatile unsigned long VerifyMode;
  /* 0x0074 */ struct _UNICODE_STRING PreviousBucketName;
  /* 0x007c */ volatile unsigned long ExecutePoolTypes;
  /* 0x0080 */ volatile unsigned long ExecutePageProtections;
  /* 0x0084 */ volatile unsigned long ExecutePageMappings;
  /* 0x0088 */ volatile unsigned long ExecuteWriteSections;
  /* 0x008c */ volatile unsigned long SectionAlignmentFailures;
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x00c4 */ unsigned char* ReservedRegionEnd;
  /* 0x00c8 */ long Padding_106[14];
...
typedef struct _LDR_DATA_TABLE_ENTRY
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0034 */ unsigned long ChpeEmulatorImage : 1; /* bit position: 26 */
      /* 0x0034 */ unsigned long ReservedFlags5 : 1; /* bit position: 27 */
  ...
  /* 0x00a5 */ char Padding_109[3];
  /* 0x00a8 */ unsigned long CheckSum;
  /* 0x00ac */ void* ActivePatchImageBase;
  /* 0x00b0 */ enum _LDR_HOT_PATCH_STATE HotPatchState;
  /* 0x00b4 */ long __PADDING__[1];
} LDR_DATA_TABLE_ENTRY, *PLDR_DATA_TABLE_ENTRY; /* size: 0x00b8 */
...
_A_SHAInit@4
_A_SHAUpdate@12
_AllocateOrValidateCharStringBuffer@16
_AllocateOrValidateUnicodeStringBuffer@16
...
_Feature_TreatDosDevicePathsAsNormalFiles__private_IsEnabled@0
...
_GetModuleFullPathName@12
_GetModuleFullPathNameUnicode@12
...
_LdrpApplyFileNameRedirection@20
_LdrpApplyPatchImage@4
...
_LdrpCfgCheckRoutineCallback@8
_LdrpCfgProcessLoadConfig@12
_LdrpCfgProcessLoadConfigEntry@16
...
_LdrpIncludeAlternateForwarders@0
...
_LdrpLoadDependentModuleA@24
_LdrpLoadDependentModuleW@24
_LdrpLoadDll@16
_LdrpLoadDllInternal@36
_LdrpLoadForwardedDll@24
_LdrpLoadKnownDll@4
_LdrpLoadPatchImage@4
...
_LdrpThreadTokenSetImpersonationToken@4
_LdrpThreadTokenSetMainThreadToken@0
_LdrpThreadTokenUnsetMainThreadToken@0
_LdrpThumbProcessRelocation@16
_LdrpTouchThreadStack@4
_LdrpTraceLoadMUIDll@8
_LdrpTryAcquireLoaderLock@0
_LdrpUndoPatchImage@4
_LdrpUnloadNode@4
...
_MD5Update@12
_MatchAll@12
_MicrosoftTelemetryAssertTriggeredUM@4
_MicrosoftTelemetryAssertTriggeredWorker@4
_NLS_DOWNCASE@8
_NLS_UPCASE@8
...
_NtChangeProcessState@24
_NtChangeThreadState@24
_NtClearEvent@4
_NtClose@4
...
_NtCreateProcessStateChange@20
_NtCreateProfile@36
...
_RtlCompareExchangePointerMapping@16
_RtlCompareExchangePropertyStore@16
...
_RtlGetSystemGlobalData@12
_RtlGetSystemPreferredUILanguages@20
_RtlGetSystemTimeAndBias@12
...
_RtlRemovePointerMapping@8
_RtlRemovePrivileges@12
_RtlRemovePropertyStore@8
...
_RtlValidateProcessHeapsCallback@8
...
_RtlpAllocateEnvironmentHashTable@8
...
_RtlpAreLegacyDosDeviceNamesEnabled@0
...
_RtlpClearEnvironmentHashTable@4
...
_RtlpCreateAndInsertEnvironmentHashTableEntry@20
...
_RtlpFindEntry@8
_RtlpFindEnvironmentHashEntry@12
...
_RtlpFindWnfNameSubscription@8
_RtlpFlsAlloc@16
_RtlpFlsCloneComplete@8
_RtlpFlsClonePrepare@4
_RtlpFlsDataCleanup@12
_RtlpFlsFree@8
_RtlpFlushHeap@4
...
_RtlpFreeEnvironmentHashTable@8
...
_RtlpGetFileSize@8
_RtlpGetFirstWnfNameSubscription@4
_RtlpGetHeapBlock@4
...
_RtlpGetNextWnfNameSubscription@4
...
_RtlpHpHeapWalk@12
_RtlpHpInitializePerfPolicies@4
...
_RtlpHpLfhSubsegmentAllocateBlock@20
...
_RtlpHpSegContextInitialize@40
...
_RtlpInitializeLegacyDosDevicePathState@4
...
_RtlpInsertEnvironmentHashTableEntry@8
...
_RtlpQueryNlsSystemCodePages@8
...
_RtlpSetupEnvironmentHashTable@8
...
_RtlpWnfNameSubscriptionCompareByStateName@8
...
_ZwChangeProcessState@24
_ZwChangeThreadState@24
_ZwClearEvent@4
_ZwClose@4
...
_ZwCreateProcessStateChange@20
_ZwCreateProfile@36
...
_wil_RtlStagingConfig_RecordFeatureUsage@12
