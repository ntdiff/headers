...
class wil::unique_call<void (__stdcall*)(void),&KeLeaveCriticalRegion,1>;
...
class wil::details::unique_storage<wil::details::resource_policy<_EX_PUSH_LOCK *,void (__stdcall*)(_EX_PUSH_LOCK *) noexcept,&wil::details::release_push_lock_shared,wistd::integral_constant<unsigned int,1>,_EX_PUSH_LOCK *,_EX_PUSH_LOCK *,0,std::nullptr_t> >;
...
class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_EX_PUSH_LOCK *,void (__stdcall*)(_EX_PUSH_LOCK *) noexcept,&wil::details::release_push_lock_exclusive,wistd::integral_constant<unsigned int,1>,_EX_PUSH_LOCK *,_EX_PUSH_LOCK *,0,std::nullptr_t> > >;
...
struct Rtl::KString;
class wil::details::unique_storage<wil::details::resource_policy<_FAST_MUTEX *,void __stdcall(_FAST_MUTEX *) noexcept,&wil::details::release_fast_mutex_with_critical_region,wistd::integral_constant<unsigned int,2>,_FAST_MUTEX *,_FAST_MUTEX *,0,std::nullptr_t> >;
...
class wil::details::unique_storage<wil::details::resource_policy<_EX_PUSH_LOCK *,void (__stdcall*)(_EX_PUSH_LOCK *) noexcept,&wil::details::release_push_lock_exclusive,wistd::integral_constant<unsigned int,1>,_EX_PUSH_LOCK *,_EX_PUSH_LOCK *,0,std::nullptr_t> >;
...
class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_FAST_MUTEX *,void __fastcall(_FAST_MUTEX *),&ExReleaseFastMutex,wistd::integral_constant<unsigned int,2>,_FAST_MUTEX *,_FAST_MUTEX *,0,std::nullptr_t> > >;
...
class wil::details::unique_storage<wil::details::resource_policy<_FAST_MUTEX *,void __fastcall(_FAST_MUTEX *),&ExReleaseFastMutex,wistd::integral_constant<unsigned int,2>,_FAST_MUTEX *,_FAST_MUTEX *,0,std::nullptr_t> >;
class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_FAST_MUTEX *,void __stdcall(_FAST_MUTEX *) noexcept,&wil::details::release_fast_mutex_with_critical_region,wistd::integral_constant<unsigned int,2>,_FAST_MUTEX *,_FAST_MUTEX *,0,std::nullptr_t> > >;
class wil::unique_call<void (__stdcall*)(void),&KeLeaveGuardedRegion,1>;
class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<_EX_PUSH_LOCK *,void (__stdcall*)(_EX_PUSH_LOCK *) noexcept,&wil::details::release_push_lock_shared,wistd::integral_constant<unsigned int,1>,_EX_PUSH_LOCK *,_EX_PUSH_LOCK *,0,std::nullptr_t> > >;
...
struct wil::details::resource_policy<_EX_PUSH_LOCK *,void (__stdcall*)(_EX_PUSH_LOCK *) noexcept,&wil::details::release_push_lock_shared,wistd::integral_constant<unsigned int,1>,_EX_PUSH_LOCK *,_EX_PUSH_LOCK *,0,std::nullptr_t>;
...
struct wil::details::resource_policy<_EX_PUSH_LOCK *,void (__stdcall*)(_EX_PUSH_LOCK *) noexcept,&wil::details::release_push_lock_exclusive,wistd::integral_constant<unsigned int,1>,_EX_PUSH_LOCK *,_EX_PUSH_LOCK *,0,std::nullptr_t>;
...
struct wil::details::resource_policy<_FAST_MUTEX *,void __stdcall(_FAST_MUTEX *) noexcept,&wil::details::release_fast_mutex_with_critical_region,wistd::integral_constant<unsigned int,2>,_FAST_MUTEX *,_FAST_MUTEX *,0,std::nullptr_t>;
struct wil::details::resource_policy<_FAST_MUTEX *,void __fastcall(_FAST_MUTEX *),&ExReleaseFastMutex,wistd::integral_constant<unsigned int,2>,_FAST_MUTEX *,_FAST_MUTEX *,0,std::nullptr_t>;
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_3;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_4[2];
...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0180 */ struct NDIS_NBL_TRACKER_HANDLE__* NblTracker;
  /* 0x0184 */ struct _NDIS_FILTER_TASK_OFFLOAD* Offload;
  /* 0x0188 */ struct _GUID InterfaceGuid;
  /* 0x0198 */ unsigned long IfIndex;
  /* 0x019c */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x01a0 */ void* NextDirectRequestHandle;
  /* 0x01a4 */ unsigned long DirectOidRequestCount;
  /* 0x01a8 */ struct _SINGLE_LIST_ENTRY WOLPatternList;
  /* 0x01ac */ struct _SINGLE_LIST_ENTRY PMProtocolOffloadList;
  /* 0x01b0 */ struct _NDIS_PM_PARAMETERS PMCurrentParameters;
  /* 0x01c4 */ struct NDIS_BIND_FILTER_LINK* Bind;
  /* 0x01c8 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCapabilities;
  /* 0x01cc */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCurrentConfig;
  /* 0x01d0 */ void* VerifierContext;
  /* 0x01d4 */ struct _PKTMON_COMPONENT_CONTEXT PktMonComp;
  /* 0x01e0 */ struct _PKTMON_EDGE_CONTEXT PktMonEdgeLower;
  /* 0x01ec */ struct _PKTMON_EDGE_CONTEXT PktMonEdgeUpper;
} NDIS_FILTER_BLOCK, *PNDIS_FILTER_BLOCK; /* size: 0x01f8 */
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_45;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_46[2];
...
class KAcquireSpinLock
{
  ...
  /* 0x0001 */ char Padding_74[3];
  /* 0x0004 */ class KSpinLockBase& m_lock;
}; /* size: 0x0008 */
...
typedef struct _NDIS_FILTER_DRIVER_BLOCK
{
  ...
  /* 0x00ac */ class KRef<NDIS_BIND_FILTER_DRIVER> Bind;
  /* 0x00b0 */ struct _UNICODE_STRING ImageName;
} NDIS_FILTER_DRIVER_BLOCK, *PNDIS_FILTER_DRIVER_BLOCK; /* size: 0x00b8 */
...
typedef struct _NDIS_WDF_COMPLETE_ADD_PARAMS
{
  ...
  /* 0x001c */ struct _UNICODE_STRING DriverImageName;
  /* 0x0024 */ long __PADDING__[1];
} NDIS_WDF_COMPLETE_ADD_PARAMS, *PNDIS_WDF_COMPLETE_ADD_PARAMS; /* size: 0x0028 */
...
typedef struct _NDK_RESULT_EX
{
  ...
  /* 0x0014 */ unsigned long ProviderErrorCode;
  /* 0x0018 */ unsigned long TypeSpecificCompletionOutput;
} NDK_RESULT_EX, *PNDK_RESULT_EX; /* size: 0x001c */
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x0c2c */ struct WORKITEM_WITH_IRP SurpriseRemovalWorkItem;
  /* 0x0c40 */ struct Ndis::BindStack Bindings;
  /* 0x0c88 */ struct Ndis::BindEngine BindEngine;
  /* 0x0cc8 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x0ce0 */ BOOL PmInterruptedByPnp;
  /* 0x0ce1 */ BOOL DoNotBlockOnMiniportLock;
  /* 0x0ce2 */ BOOL PoFxDStateReportingEnabled;
  /* 0x0ce3 */ char Padding_106;
  /* 0x0ce4 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x0ce8 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x0cf8 */ BOOL InterfaceUpdateInProgress;
  /* 0x0cf9 */ BOOL MacAddressUpdateQueued;
  /* 0x0cfa */ BOOL MtuUpdateQueued;
  /* 0x0cfb */ char Padding_107;
  /* 0x0cfc */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x0d1e */ char Padding_108[2];
  /* 0x0d20 */ unsigned long PendingMtuSize;
  /* 0x0d24 */ wchar_t* PnPInstanceId;
  /* 0x0d28 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x0d3c */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x0d50 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,int,-1,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x0d54 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,int,-1,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x0d58 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,int,-1,std::nullptr_t> > > ReenumerateWatchdog;
  /* 0x0d5c */ void* PdcHandle;
  ...
  /* 0x0dd8 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x0ddc */ volatile long RssV2CompletionCount;
  /* 0x0de0 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x0df0 */ unsigned char RssV2Initialized;
  /* 0x0df1 */ char Padding_109[3];
  /* 0x0df4 */ struct _LIST_ENTRY SynchronousOidCalls;
  /* 0x0dfc */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCapabilities;
  /* 0x0e00 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCurrentConfig;
  /* 0x0e04 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopTimestampConfig;
  /* 0x0e08 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopHwTimestampCapabilities;
  /* 0x0e0c */ struct _PKTMON_COMPONENT_CONTEXT PktMonComp;
  /* 0x0e18 */ struct _PKTMON_EDGE_CONTEXT PktMonEdge;
  /* 0x0e24 */ unsigned char WdfCxPowerManagement;
  /* 0x0e25 */ char __PADDING__[3];
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x0e28 */
...
typedef struct _DMA_OPERATIONS
{
  ...
  /* 0x009c */ void* CreateCommonBufferFromMdl /* function */;
} DMA_OPERATIONS, *PDMA_OPERATIONS; /* size: 0x00a0 */
...
typedef struct _NDIS_M_DRIVER_BLOCK
{
  ...
  /* 0x0148 */ struct _NDIS_CO_CALL_MANAGER_OPTIONAL_HANDLERS CallMgrChars;
  /* 0x0194 */ void* AddDeviceHandler /* function */;
  /* 0x0198 */ void* RemoveDeviceHandler /* function */;
  /* 0x019c */ void* FilterResourceRequirementsHandler /* function */;
  /* 0x01a0 */ void* StartDeviceHandler /* function */;
  ...
  /* 0x01b8 */ void* DevicePowerNotifyHandler /* function */;
  /* 0x01bc */ void* ReenumerateFailedAdapterHandler /* function */;
  /* 0x01c0 */ void* LiveDumpCallback /* function */;
  /* 0x01c4 */ struct _UNICODE_STRING ImageName;
  /* 0x01cc */ struct NDIS_MINIPORT_HOOK_DRIVER_HANDLE__* HookDriverHandle;
  /* 0x01d0 */ enum _NDIS_MINIPORT_HOOK_DRIVER_TYPE HookType;
  /* 0x01d4 */ BOOL HookRegistered;
  /* 0x01d5 */ char Padding_130[3];
  /* 0x01d8 */ void* AllocateNetBufferListForwardingContextHandler /* function */;
  /* 0x01dc */ void* FreeNetBufferListForwardingContextHandler /* function */;
  /* 0x01e0 */ void* AddNetBufferListDestinationHandler /* function */;
  /* 0x01e4 */ void* SetNetBufferListSourceHandler /* function */;
  /* 0x01e8 */ void* GrowNetBufferListDestinationsHandler /* function */;
  /* 0x01ec */ void* GetNetBufferListDestinationsHandler /* function */;
  /* 0x01f0 */ void* UpdateNetBufferListDestinationsHandler /* function */;
  /* 0x01f4 */ void* CopyNetBufferListInfoHandler /* function */;
  /* 0x01f8 */ void* ReferenceSwitchNicHandler /* function */;
  /* 0x01fc */ void* DereferenceSwitchNicHandler /* function */;
  /* 0x0200 */ void* ReferenceSwitchPortHandler /* function */;
  /* 0x0204 */ void* DereferenceSwitchPortHandler /* function */;
  /* 0x0208 */ void* ReportFilteredNetBufferListsHandler /* function */;
  /* 0x020c */ void* SetNetBufferListSwitchContextHandler /* function */;
  /* 0x0210 */ void* GetNetBufferListSwitchContextHandler /* function */;
} NDIS_M_DRIVER_BLOCK, *PNDIS_M_DRIVER_BLOCK; /* size: 0x0214 */
...
typedef struct _NDIS_SHARED_MEMORY_BLOCK
{
  ...
  /* 0x0034 */ long Padding_143;
  /* 0x0038 */ union _LARGE_INTEGER PhysicalAddress;
  /* 0x0040 */ struct _NDIS_SHARED_MEMORY_PARAMETERS SharedMemoryParameters;
  /* 0x006c */ struct _MDL* PhysicalPagesMdl;
  /* 0x0070 */ struct _MDL* CommonBufferMdl;
  /* 0x0074 */ long __PADDING__[1];
} NDIS_SHARED_MEMORY_BLOCK, *PNDIS_SHARED_MEMORY_BLOCK; /* size: 0x0078 */
...
{
  /* 0x0000 */ struct _NDIS_OBJECT_HEADER Header;
  /* 0x0004 */ class KSpinLock ListLock;
...
typedef struct _NDK_CONNECTOR_DISPATCH
{
  ...
  /* 0x002c */ void* NdkCompleteConnectEx /* function */;
  /* 0x0030 */ void* NdkAcceptEx /* function */;
} NDK_CONNECTOR_DISPATCH, *PNDK_CONNECTOR_DISPATCH; /* size: 0x0034 */
...
typedef struct _NDIS_SG_DMA_DESCRIPTION
{
  ...
  /* 0x0018 */ struct _DEVICE_OBJECT* PdoOverride;
} NDIS_SG_DMA_DESCRIPTION, *PNDIS_SG_DMA_DESCRIPTION; /* size: 0x001c */
...
{
  /* 0x0000 */ long Padding_176[4];
  /* 0x0010 */ unsigned char ProtocolId;
  /* 0x0011 */ char Padding_177;
  /* 0x0012 */ unsigned short ContextSize;
  /* 0x0014 */ void* OwnerHandle;
  /* 0x0018 */ void* Allocator;
  /* 0x001c */ unsigned long Tag;
  /* 0x0020 */ unsigned long Flags;
  /* 0x0024 */ class KSpinLockManualConstruct Lock;
...
??$MakePoolPtrNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@YG?AV?$unique_ptr@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@U?$KFreePoolNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@@wistd@@K@Z
??$MakePoolPtrNP@U_NDIS_SG_DMA_BLOCK@@@@YG?AV?$unique_ptr@U_NDIS_SG_DMA_BLOCK@@U?$KFreePoolNP@U_NDIS_SG_DMA_BLOCK@@@@@wistd@@K@Z
...
??$MakeSizedPoolPtr@VNetSetupKnobCollection@@@@YG?AV?$unique_ptr@VNetSetupKnobCollection@@U?$KFreePool@VNetSetupKnobCollection@@@@@wistd@@KI@Z
??$MakeSizedPoolPtr@VRegistryKnobCollection@@@@YG?AV?$unique_ptr@VRegistryKnobCollection@@U?$KFreePool@VRegistryKnobCollection@@@@@wistd@@KI@Z
??$ReadAcquire@EX@mem@@YGEPDE@Z
??$ReadNoFence@EX@mem@@YGEPDE@Z
??$ReadNoFence@KX@mem@@YGKPDK@Z
??$Serialize@UNDIS_COLLECT_HISTOGRAM_OUT@@@Hub@Statistics@@QBEJPAUNDIS_COLLECT_HISTOGRAM_OUT@@KAAK@Z
??$Serialize@UNDIS_SINGLE_HISTOGRAM_ENTRY@@@Histogram@Statistics@@QBEJPAUNDIS_SINGLE_HISTOGRAM_ENTRY@@KAAK@Z
??$SerializedSize@UNDIS_SINGLE_HISTOGRAM_ENTRY@@@Histogram@Statistics@@QBEKXZ
...
??$WriteRelease@PAU_NDIS_PCW_DATA_BLOCK@@X@mem@@YGXPCRAU_NDIS_PCW_DATA_BLOCK@@PAU1@@Z
...
??$make_unique_nothrow@VExecutionContext@@ABKABW4_EXECUTION_CONTEXT_FLAGS@@@wil@@YG?AV?$unique_ptr@VExecutionContext@@U?$default_delete@VExecutionContext@@@wistd@@@wistd@@ABKABW4_EXECUTION_CONTEXT_FLAGS@@@Z
??$make_unique_nothrow@VNdisPoll@@AAPAXAAPAXABQ6GXPAXPAU_NDIS_POLL_NOTIFICATION@@@ZABQ6GX0PAU_NDIS_POLL_DATA@@@ZABI@wil@@YG?AV?$unique_ptr@VNdisPoll@@U?$default_delete@VNdisPoll@@@wistd@@@wistd@@AAPAX0ABQ6GXPAXPAU_NDIS_POLL_NOTIFICATION@@@ZABQ6GX1PAU_NDIS_POLL_DATA@@@ZABI@Z
??$ndisCallNextDatapathHandler@$00AAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@K@ZAAPAXAAPAU1@AAKAAKAAK@@YGXAAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@K@Z0AAPAU0@AAK55@Z
??$ndisCallNextDatapathHandler@$01AAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@KKK@ZAAPAXAAPAU1@AAKAAKAAK@@YGXAAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@KKK@Z0AAPAU0@AAK55@Z
??$ndisCallNextDatapathHandler@$02AAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@K@ZAAPAXAAPAU1@AAKAAKAAK@@YGXAAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@K@Z0AAPAU0@AAK55@Z
??$ndisCallNextDatapathHandler@$0A@AAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@KK@ZAAPAXAAPAU1@AAKAAKAAK@@YGXAAPAXAAP6GXPAXPAU_NET_BUFFER_LIST@@KK@Z0AAPAU0@AAK55@Z
??$ndisDataPathExpandStackCallback@$00$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGXPAX@Z
??$ndisDataPathExpandStackCallback@$01$$A6GXPAXPAU_NET_BUFFER_LIST@@KKK@Z@@YGXPAX@Z
??$ndisDataPathExpandStackCallback@$02$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGXPAX@Z
??$ndisDataPathExpandStackCallback@$0A@$$A6GXPAXPAU_NET_BUFFER_LIST@@KK@Z@@YGXPAX@Z
??$ndisExpandDataPathStack@$00$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGJPAU_NET_BUFFER_LIST@@KKKPAX1P6GX10K@Z@Z
??$ndisExpandDataPathStack@$01$$A6GXPAXPAU_NET_BUFFER_LIST@@KKK@Z@@YGJPAU_NET_BUFFER_LIST@@KKKPAX1P6GX10KKK@Z@Z
??$ndisExpandDataPathStack@$02$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGJPAU_NET_BUFFER_LIST@@KKKPAX1P6GX10K@Z@Z
??$ndisExpandDataPathStack@$0A@$$A6GXPAXPAU_NET_BUFFER_LIST@@KK@Z@@YGJPAU_NET_BUFFER_LIST@@KKKPAX1P6GX10KK@Z@Z
??$ndisInvokeIterativeDatapath@$00$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGXPAU_NET_BUFFER_LIST@@KKKPAU_NDIS_OBJECT_HEADER@@PAXP6GX20K@Z@Z
??$ndisInvokeIterativeDatapath@$01$$A6GXPAXPAU_NET_BUFFER_LIST@@KKK@Z@@YGXPAU_NET_BUFFER_LIST@@KKKPAU_NDIS_OBJECT_HEADER@@PAXP6GX20KKK@Z@Z
??$ndisInvokeIterativeDatapath@$02$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGXPAU_NET_BUFFER_LIST@@KKKPAU_NDIS_OBJECT_HEADER@@PAXP6GX20K@Z@Z
??$ndisInvokeIterativeDatapath@$0A@$$A6GXPAXPAU_NET_BUFFER_LIST@@KK@Z@@YGXPAU_NET_BUFFER_LIST@@KKKPAU_NDIS_OBJECT_HEADER@@PAXP6GX20KK@Z@Z
??$ndisIterativeDPAddNblsToTracker@$00@@YGXPAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@PAU_NET_BUFFER_LIST@@KKK@Z
??$ndisIterativeDPAddNblsToTracker@$01@@YGXPAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@PAU_NET_BUFFER_LIST@@KKK@Z
??$ndisIterativeDPAddNblsToTracker@$02@@YGXPAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@PAU_NET_BUFFER_LIST@@KKK@Z
??$ndisIterativeDPAddNblsToTracker@$0A@@@YGXPAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@PAU_NET_BUFFER_LIST@@KKK@Z
??$ndisIterativeDPGetNumNbls@$01@@YGKPAU_NET_BUFFER_LIST@@@Z
??$ndisIterativeDPInvokeHandlerOnTracker@$00$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGXPAXP6GX0PAU_NET_BUFFER_LIST@@K@Z0PAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@@Z
??$ndisIterativeDPInvokeHandlerOnTracker@$01$$A6GXPAXPAU_NET_BUFFER_LIST@@KKK@Z@@YGXPAXP6GX0PAU_NET_BUFFER_LIST@@KKK@Z0PAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@@Z
??$ndisIterativeDPInvokeHandlerOnTracker@$02$$A6GXPAXPAU_NET_BUFFER_LIST@@K@Z@@YGXPAXP6GX0PAU_NET_BUFFER_LIST@@K@Z0PAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@@Z
??$ndisIterativeDPInvokeHandlerOnTracker@$0A@$$A6GXPAXPAU_NET_BUFFER_LIST@@KK@Z@@YGXPAXP6GX0PAU_NET_BUFFER_LIST@@KK@Z0PAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@@Z
??$ndisRegisterKnobs@$04@@YGJAAY04$$CBUKnobDescriptor@@P6GEPAXPBU0@AA_K@ZP6GJ12_K@Z1@Z
??$ndisRegisterKnobs@$0CB@@@YGJAAY0CB@$$CBUKnobDescriptor@@P6GEPAXPBU0@AA_K@ZP6GJ12_K@Z1@Z
...
??0?$EcDpc@VExecutionContext@@@@QAE@P6GXPAVExecutionContext@@@Z0@Z
...
??0?$Timer@UFastStopwatch@Statistics@@@Statistics@@QAE@PAVHistogram@1@_N@Z
??0BindEngine@Ndis@@QAE@XZ
??0BindStack@Ndis@@QAE@XZ
??0BindState@Ndis@@QAE@XZ
??0DpcBudget@@QAE@K_N@Z
??0ExecutionContext@@QAE@KW4_EXECUTION_CONTEXT_FLAGS@@@Z
??0ExecutionContextTask@@QAE@PAXP6GX0@Z_N@Z
??0Histogram@Statistics@@QAE@_K0K@Z
??0Hub@Statistics@@QAE@XZ
??0KAcquireSpinLock@@QAE@AAVKSpinLockBase@@@Z
??0KLockThisExclusive@@QAE@AAVKPushLockBase@@@Z
??0KLockThisShared@@QAE@AAVKPushLockBase@@@Z
??0KPushLock@@QAE@XZ
??0KSpinLock@@QAE@XZ
??0KnobCollection@@QAE@XZ
??0KnobNamespace@@QAE@PAU_DRIVER_OBJECT@@PBU_CONFIG_KNOB_NAMESPACE@@@Z
...
??0NdisDmaAllocationHistogramStopwatch@@QAE@XZ
??0NdisHistogramGlobal@@QAE@XZ
??0NdisNetworkInterfacePersistedState@@QAE@XZ
??0NdisPoll@@QAE@PAX0P6GX0PAU_NDIS_POLL_NOTIFICATION@@@ZP6GX0PAU_NDIS_POLL_DATA@@@ZI@Z
??0NdisStatisticalStopwatch@@QAE@W4NDIS_GLOBAL_STATISTIC@@@Z
...
??0const_iterator@?$KArray@PAU_KStringAtom@Rtl@@$00@Rtl@@IAE@PBV12@I@Z
??0const_iterator@?$KArray@PAX$00@Rtl@@IAE@PBV12@I@Z
??0const_iterator@?$KArray@ULwfBindProperties@@$00@Rtl@@IAE@PBV12@I@Z
??0const_iterator@?$KArray@UProtocolBindProperties@@$00@Rtl@@IAE@PBV12@I@Z
??0const_iterator@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@IAE@PBV12@I@Z
??0const_iterator@?$KArray@V?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@$00@Rtl@@IAE@PBV12@I@Z
??0const_iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@IAE@PBV12@I@Z
??0const_iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@IAE@PBV12@I@Z
??0iterator@?$KArray@PAU_KStringAtom@Rtl@@$00@Rtl@@IAE@PAV12@I@Z
??0iterator@?$KArray@PAX$00@Rtl@@IAE@PAV12@I@Z
??0iterator@?$KArray@ULwfBindProperties@@$00@Rtl@@IAE@PAV12@I@Z
??0iterator@?$KArray@UProtocolBindProperties@@$00@Rtl@@IAE@PAV12@I@Z
??0iterator@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@IAE@PAV12@I@Z
??0iterator@?$KArray@V?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@$00@Rtl@@IAE@PAV12@I@Z
??0iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@IAE@PAV12@I@Z
??0iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@IAE@PAV12@I@Z
??1?$KStringAtomTableBase@$00@Rtl@@QAE@XZ
??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PAXP6GJPAX@Z$1?ZwClose@@YGJ0@ZU?$integral_constant@I$0A@@wistd@@PAXPAX$0A@$$T@details@wil@@@details@wil@@@wil@@QAE@XZ
??1?$unique_call@P6GXXZ$1?KeLeaveCriticalRegion@@YGXXZ$00@wil@@QAE@XZ
...
??1?$unique_ptr@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@U?$KFreePoolNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@@wistd@@QAE@XZ
??1?$unique_ptr@_WU?$KFreePool@_W@@@wistd@@QAE@XZ
??1?$unique_storage@U?$resource_policy@PAU_DMA_ADAPTER@@$$A6GXPAU1@@Z$1?CloseDmaAdapter@@YGX0@ZU?$integral_constant@I$0A@@wistd@@PAU1@PAU1@$0A@$$T@details@wil@@@details@wil@@IAE@XZ
??1?$unique_storage@U?$resource_policy@PAU_KTHREAD@@P6IJPAX@Z$1?ObfDereferenceObject@@YIJ0@ZU?$integral_constant@I$0A@@wistd@@PAU1@PAU1@$0A@$$T@details@wil@@@details@wil@@IAE@XZ
??1BindEngine@Ndis@@QAE@XZ
??1BindState@Ndis@@QAE@XZ
??1ExecutionContext@@UAE@XZ
??1KAcquireSpinLock@@QAE@XZ
??1KLockHolder@@QAE@XZ
??1KLockThisExclusive@@QAE@XZ
??1KRegKey@@QAE@XZ
??1KRundownHolder@@QAE@XZ
??1KnobTransaction@@QAE@XZ
??1LwfBindProperties@@QAE@XZ
...
??1NdisDmaAllocationHistogramStopwatch@@QAE@XZ
??1NdisPoll@@QAE@XZ
??1NdisStatisticalStopwatch@@QAE@XZ
??1NdisWatchdogState@@QAE@XZ
??1ProtocolBindProperties@@QAE@XZ
??1_NDIS_MINIPORT_BLOCK@@QAE@XZ
??1unique_thread@@QAE@XZ
??3?$KALLOCATOR@$0GHGIEEEO@$00@@SGXPAX@Z
??3?$KALLOCATOR@$0HIHEEDEF@$0CAA@@@SGXPAX@Z
??3@YAXPAX@Z
??4?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@QAEAAV0@$$QAV0@@Z
??4?$unique_ptr@U_UNICODE_STRING@@U?$KFreePool@U_UNICODE_STRING@@@@@wistd@@QAEAAV01@$$QAV01@@Z
??4NBL_QUEUE_t@@QAEAAU0@$$QAU0@@Z
??A?$KArray@PBVHistogram@Statistics@@$00@Rtl@@QAEAAPBVHistogram@Statistics@@I@Z
??A?$KArray@PBVHistogram@Statistics@@$00@Rtl@@QBEABQBVHistogram@Statistics@@I@Z
...
??B?$unique_ptr@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@U?$KFreePoolNP@U_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@@@@wistd@@QBE_NXZ
??Bunique_thread@@QBE_NXZ
...
??_EExecutionContext@@UAEPAXI@Z
??_EExecutionContextTask@@UAEPAXI@Z
??_EMINIPORT_HOOK_DRIVER@@QAEPAXI@Z
??_GExecutionContext@@UAEPAXI@Z
??_GExecutionContextTask@@UAEPAXI@Z
??_GNdisHistogramEntry@@QAEPAXI@Z
??_I@YGXPAXIIP6EX0@Z@Z
??_V@YAXPAX@Z
?Acquire@?$KNeutralLock@W4NDIS_MINIPORT_POLICY_OWNER@@@Rtl@@QAEXW4NDIS_MINIPORT_POLICY_OWNER@@@Z
?Acquire@KSpinLockBase@@QAEEXZ
?AcquireExclusive@KPushLockBase@@QAEXXZ
?AddAces@@YGJPAU_ACL@@EEPAPAU1@@Z
?AddBindContext@BindState@Ndis@@QAE_NPAX@Z
?AddHistogramReference@Hub@Statistics@@QAE_NABVHistogram@2@@Z
?AddValue@KHistogram@@QAEX_K@Z
...
?BuildCollection@KnobNamespace@@AAEJPBUKnobDescriptor@@I_NP6GEPAX0AA_K@ZP6GJ20_K@Z2@Z
...
?ChangePollFunction@ExecutionContext@@QAEXPAU_EXECUTION_CONTEXT_POLL@@P6GXPAXPAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z@Z
?ChangeState@ExecutionContext@@AAEXW4State@1@@Z
?ChangeStateIf@ExecutionContext@@AAE_NW4State@1@0@Z
?ChangeStateNoLock@ExecutionContext@@AAEXW4State@1@@Z
...
?ClearKnobEphemeralValue@KnobNamespace@@AAEJPB_W@Z
?ClearKnobInStore@NetSetupKnobCollection@@UAEJABUKnobDescriptor@@@Z
?ClearKnobInStore@RegistryKnobCollection@@UAEJABUKnobDescriptor@@@Z
?ClearKnobRegistryValue@KnobNamespace@@AAEJPB_W_N@Z
?CloseDmaAdapter@@YGXPAU_DMA_ADAPTER@@@Z
?CoalesceFilterAttachDuringBoot@BindRules@Ndis@@YGXPAU_NDIS_MINIPORT_BLOCK@@PAUBindStack@2@@Z
?CollectHistogramsForIoctl@@YGJABVHub@Statistics@@PAUNDIS_COLLECT_HISTOGRAM_OUT@@KAAK@Z
?CommitSingleKnob@KnobCollection@@QAEXABUKnobDescriptor@@AAUKnobState@@_K_N@Z
?CommitUpdatedKnobValues@KnobCollection@@QAEX_N@Z
?CompleteTransmittedNbls@NdisPoll@@AAEXPAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z
?ComputeRoundedAverage@@YG_K_K0@Z
?ContextFromPoll@@YGAAUPollReserved@@PAU_EXECUTION_CONTEXT_POLL@@@Z
?Create@KHistogram@@SGPAV1@_K0K@Z
?Create@KnobCollection@@SGPAV1@PAVKnobNamespace@@PBUKnobDescriptor@@IP6GEPAX1AA_K@ZP6GJ21_K@Z2@Z
...
?DisableNotifications@ExecutionContext@@AAEXXZ
?Disarm@NdisWatchdogState@@QAEXXZ
?DispatchPendingWork@BindEngine@Ndis@@AAEXW4CallRunMode@@AAVKLockThisExclusive@@@Z
?DpcWatchdogStarving@DpcBudget@@ABE_NXZ
?DuplicateUnicodeString@Rtl@@YG?AV?$unique_ptr@U_UNICODE_STRING@@U?$KFreePool@U_UNICODE_STRING@@@@@wistd@@ABU_UNICODE_STRING@@K@Z
?EcEventInitialize@@YGXAAU_KEVENT@@W4EventType@@@Z
?EcEventSignal@@YGXAAU_KEVENT@@@Z
?EcEventTest@@YG_NAAU_KEVENT@@@Z
?EcEventWait@@YGXAAU_KEVENT@@@Z
?EcThreadCreate@@YGJP6GXPAX@Z0AAUunique_thread@@@Z
?EcThreadWaitForTermination@@YGXAAUunique_thread@@@Z
?EndBindOperation@BindEngine@Ndis@@SGXXZ
?EndPolicyUpdates@BindEngine@Ndis@@QAEXXZ
?EnumerateKnobs@KnobNamespace@@AAEXP6GXPAXPB_W@Z0@Z
...
?EvtCompleteTransmittedNbls@NdisPoll@@CGXPAXPAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z
?EvtIndicateReceivedNbls@NdisPoll@@CGXPAXPAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z
?EvtPollDriver@NdisPoll@@CGXPAXPAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z
?EvtSetMiniportNotificationEnabled@NdisPoll@@CGXPAXE@Z
?Feature_ScreenON_NAPS__private_IsEnabledPreCheck@@YGHXZ
?FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QAEXXZ
?FindById@KnobNamespace@@CGPAV1@PBU_CONFIG_KNOB_NAMESPACE@@@Z
?FindKnobByName@KnobCollection@@QAE_NPB_WPAPBUKnobDescriptor@@PAPAUKnobState@@@Z
?FindKnobByName@KnobNamespace@@AAE_NPB_WPAPAVKnobCollection@@PAPBUKnobDescriptor@@PAPAUKnobState@@@Z
...
?FromNotificationEntry@NotificationReserved@@SGPAU1@PAU_LIST_ENTRY@@@Z
...
?GetCurrentValue@KnobDescriptor@@QBE_KXZ
?GetElapsedTimeInMilliseconds@KStopwatch@@QBE_KXZ
?GetElapsedTimeInMilliseconds@KTickCounterStopwatch@@QBE_KXZ
?GetGlobalEcStatistics@@YGAAVHub@Statistics@@XZ
...
?IncrementBucket@KHistogram@@AAEX_K@Z
?IncrementReadConcurrency@@YGXPAUNDIS_VERIFY_RW_LOCK_EX@@@Z
?IndicateReceivedNbls@NdisPoll@@AAEXPAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z
?Initialize@BindEngine@Ndis@@QAEXPAU_NDIS_MINIPORT_BLOCK@@@Z
?Initialize@ExecutionContext@@QAEJPBU_UNICODE_STRING@@@Z
?Initialize@KPushLockManualConstruct@@QAEXXZ
?Initialize@KSpinLockManualConstruct@@QAEXXZ
?Initialize@KString@Rtl@@SGPAU12@PBU_UNICODE_STRING@@@Z
?Initialize@KString@Rtl@@SGPAU12@PB_W@Z
?Initialize@NdisPoll@@QAEJKW4_EXECUTION_CONTEXT_FLAGS@@@Z
?InitializeFriendlyName@ExecutionContext@@AAEJPBU_UNICODE_STRING@@@Z
?InitializeNetBuffer@@YGXPAU_NET_BUFFER@@PAXPAU_MDL@@K@Z
?InsertQueueDpc@?$EcDpc@VExecutionContext@@@@QAE_NXZ
?InternalDpcRoutine@?$EcDpc@VExecutionContext@@@@CGXPAU_KDPC@@PAX11@Z
?Ioctl@KnobNamespace@@SGJ_NKKKPAXPAK@Z
...
?IsOutOfBudget@DpcBudget@@QBE_NXZ
...
?LookupNetSetupPropertyKey@@YG?AU_NETSETUPPROPKEY@@PB_W@Z
...
?NDIS_ACQUIRE_MINIPORT_SPIN_LOCK_DPC@@YGXPAU_NDIS_MINIPORT_BLOCK@@@Z
...
?NdisClassifyNblChain2@@YGXPAU_NET_BUFFER_LIST@@P6GKPAX0@Z1PAUNBL_QUEUE_t@@3@Z
?NdisClassifyNblChainByCancelId@@YGXPAU_NET_BUFFER_LIST@@PAXPAUNBL_QUEUE_t@@2@Z
...
?NdisNblClassifierForCancelId@@YGKPAXPAU_NET_BUFFER_LIST@@@Z
?NdisNumNblsInNblChain@@YGKPBU_NET_BUFFER_LIST@@@Z
?NdisNumNbsInNblChain@@YGKPBU_NET_BUFFER_LIST@@@Z
?NdisReadConfigShimHook@@YGXPAHPAPAU_NDIS_CONFIGURATION_PARAMETER@@PAXPAU_UNICODE_STRING@@W4_NDIS_PARAMETER_TYPE@@@Z
?NdisSetJobObjectCompartmentId@@YGJPAU_EJOB@@I@Z
?NdisSetStatusInNblChain@@YGXPAU_NET_BUFFER_LIST@@H@Z
...
?Notify@ExecutionContext@@QAEXXZ
?NotifyBindComplete@_NDIS_PROTOCOL_BLOCK@@QAEXXZ
?NotifyDpcRoutine@ExecutionContext@@CGXPAV1@@Z
?Open@KRegKey@@QAEJKPBU_UNICODE_STRING@@PAX@Z
?Open@KRegKey@@QAEJKPB_WPAX@Z
?Open@NetSetupKnobCollection@@UBEJKAAUKnobTransaction@@@Z
?Open@RegistryKnobCollection@@UBEJKAAUKnobTransaction@@@Z
...
?Poll@ExecutionContext@@AAEXE@Z
?PollClients@ExecutionContext@@AAE_NE@Z
?PollDpcRoutine@ExecutionContext@@CGXPAV1@@Z
?PollDriver@NdisPoll@@AAEXPAU_EXECUTION_CONTEXT_POLL_PARAMETERS@@@Z
?PrepareUpdatedKnobValues@KnobCollection@@QAEXAAUKnobTransaction@@@Z
?ProcessTaskQueue@ExecutionContext@@AAEXXZ
?QueryKnobInformation@KnobNamespace@@AAE_NPB_WPAUNDIS_KNOB_INFORMATION@@@Z
...
?QueryValueUlong64@KRegKey@@QAEJPBU_UNICODE_STRING@@PA_K@Z
...
?QueueTask@ExecutionContext@@QAEXAAVExecutionContextTask@@@Z
...
?ReadKnobFromKey@NetSetupKnobCollection@@EAEJAAVKRegKey@@ABUKnobDescriptor@@AAUKnobState@@@Z
?ReadKnobFromKey@RegistryKnobCollection@@EAEJAAVKRegKey@@ABUKnobDescriptor@@AAUKnobState@@@Z
?ReadKnobFromStore@KnobCollection@@QAEJAAUKnobTransaction@@ABUKnobDescriptor@@AAUKnobState@@@Z
...
?RegisterNotification@ExecutionContext@@QAEXPAU_EXECUTION_CONTEXT_NOTIFICATION@@@Z
?RegisterPoll@ExecutionContext@@QAEXPAU_EXECUTION_CONTEXT_POLL@@@Z
?Release@?$KNeutralLock@W4NDIS_MINIPORT_POLICY_OWNER@@@Rtl@@QAEXW4NDIS_MINIPORT_POLICY_OWNER@@@Z
?Release@KAcquireSpinLock@@QAEXXZ
?Release@KSpinLockBase@@QAEXE@Z
...
?RemoveHistogramReference@Hub@Statistics@@QAEXABVHistogram@2@@Z
...
?RtlULongLongAdd@@YGJ_K0PA_K@Z
?RtlULongLongMult@@YGJ_K0PA_K@Z
...
?SetAffinity@NdisPoll@@QAEXPBU_PROCESSOR_NUMBER@@@Z
?SetBinding@BindState@Ndis@@QAE_NW4BINDING_ENABLED_OR_DISABLED@@W4NDIS_DO_NOT_BIND_REASON@@@Z
?SetCurrentValue@KnobDescriptor@@QBEX_K@Z
?SetDirty@BindEngine@Ndis@@QAEXXZ
?SetKnobEphemeralValue@KnobNamespace@@AAEJPB_W_K@Z
?SetKnobInStore@NetSetupKnobCollection@@UAEJABUKnobDescriptor@@_K@Z
?SetKnobInStore@RegistryKnobCollection@@UAEJABUKnobDescriptor@@_K@Z
?SetKnobRegistryValue@KnobNamespace@@AAEJPB_W_K_N@Z
?SetMacAddress@NdisDmaAllocationHistogramStopwatch@@QAEXQBE@Z
?SetName@Histogram@Statistics@@QAEXABU_UNICODE_STRING@@@Z
...
?SetValueUlong64@KRegKey@@QAEJPB_W_K@Z
?SetValueUlong@KRegKey@@QAEJPB_WK@Z
?SetWorkerThreadAffinity@ExecutionContext@@QAEXABU_GROUP_AFFINITY@@@Z
?Stop@KTickCounterStopwatch@@QAE_KXZ
?Stop@NdisStatisticalStopwatch@@QAE_KXZ
?Thread@ExecutionContext@@SGXPAX@Z
...
?UnregisterNotification@ExecutionContext@@QAEXPAU_EXECUTION_CONTEXT_NOTIFICATION@@@Z
?UnregisterPoll@ExecutionContext@@QAEXPAU_EXECUTION_CONTEXT_POLL@@@Z
...
?UpdateKnobs@KnobNamespace@@AAEJPA_N@Z
...
?UpdateSingleKnob@KnobNamespace@@AAEXPAVKnobCollection@@PBUKnobDescriptor@@PAUKnobState@@@Z
?ValidateKnobValue@KnobCollection@@QAEJAA_KABUKnobDescriptor@@@Z
...
?begin@?$KArray@PAU_KStringAtom@Rtl@@$00@Rtl@@QAE?AViterator@12@XZ
?begin@?$KArray@PAU_KStringAtom@Rtl@@$00@Rtl@@QBE?AVconst_iterator@12@XZ
?begin@?$KArray@ULwfBindProperties@@$00@Rtl@@QAE?AViterator@12@XZ
?begin@?$KArray@V?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@$00@Rtl@@QAE?AViterator@12@XZ
?begin@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QAE?AViterator@12@XZ
?begin@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@PAU_KStringAtom@Rtl@@$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@PAU_KStringAtom@Rtl@@$00@Rtl@@QBE?AVconst_iterator@12@XZ
?end@?$KArray@PAX$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@ULwfBindProperties@@$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@UProtocolBindProperties@@$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@V?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QAE?AViterator@12@XZ
?end@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@QAE?AViterator@12@XZ
?ensure_valid@const_iterator@?$KArray@PAU_KStringAtom@Rtl@@$00@Rtl@@IBEXXZ
?ensure_valid@const_iterator@?$KArray@PAX$00@Rtl@@IBEXXZ
?ensure_valid@const_iterator@?$KArray@ULwfBindProperties@@$00@Rtl@@IBEXXZ
?ensure_valid@const_iterator@?$KArray@UProtocolBindProperties@@$00@Rtl@@IBEXXZ
?ensure_valid@const_iterator@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@IBEXXZ
?ensure_valid@const_iterator@?$KArray@V?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@$00@Rtl@@IBEXXZ
?ensure_valid@const_iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@IBEXXZ
?ensure_valid@const_iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@IBEXXZ
?enter_critical_region@wil@@YG?AV?$unique_call@P6GXXZ$1?KeLeaveCriticalRegion@@YGXXZ$00@1@XZ
...
?grow@?$KArray@PBVHistogram@Statistics@@$00@Rtl@@AAE_NI@Z
...
?is_valid@?$unique_storage@U?$resource_policy@PAXP6GJPAX@Z$1?ZwClose@@YGJ0@ZU?$integral_constant@I$0A@@wistd@@PAXPAX$0A@$$T@details@wil@@@details@wil@@QBE_NXZ
...
?ndisAzDmaInterceptFree@@YG_NPAX@Z
...
?ndisCollectAllStatisticsForIoctl@@YGJPBUNDIS_COLLECT_ALL_STATISTICS_IN@@PAUNDIS_COLLECT_ALL_STATISTICS_OUT@@KAAK@Z
?ndisCollectHistogramsForIoctl@@YGJW4NDIS_HISTOGRAM_TYPE@@_NPAEKAAK@Z
?ndisCollectSingleStatisticForIoctl@@YGJPBUNDIS_COLLECT_SINGLE_STATISTIC_IN@@PAUNDIS_COLLECT_SINGLE_STATISTIC_OUT@@AAK@Z
...
?ndisConvertNdisStatusToNtStatusForIoctl@@YGJJHE@Z
...
?ndisDriverVerifierNdisFlagEnabled@@YG_NXZ
...
?ndisExpandStackAllocationLikely@@YGJP6GXPAX@Z0@Z
...
?ndisGetGlobalStatisticName@@YGPB_WW4NDIS_GLOBAL_STATISTIC@@@Z
...
?ndisGetPMProtocolOffloadSize@@YGIPAU_NDIS_PM_PROTOCOL_OFFLOAD@@@Z
...
?ndisIMVBusIsValidInput@@YGEPAXPBU_NDIS_VBUS_DEVICE_CHARACTERISTICS@@@Z
...
?ndisIncrementGlobalStatistic@@YGXW4NDIS_GLOBAL_STATISTIC@@@Z
?ndisIncrementGlobalStatisticBy@@YGXW4NDIS_GLOBAL_STATISTIC@@_K@Z
...
?ndisIsLwfGuaranteedStackSpaceAvailable@@YG_NXZ
...
?ndisIsNetTrcCorrelationEnabled@@YG_NXZ
...
?ndisIsStackSpaceAvailable@@YG_NI@Z
...
?ndisKnobInitializeSubsystem@@YGXPAU_DRIVER_OBJECT@@@Z
?ndisKnobIoctl@@YGJ_NKKKPAXPAK@Z
...
?ndisLWMOpenConfigurationKey@@YGJABU_GUID@@AAVKRegKey@@@Z
...
?ndisLwmDispatchIrp@@YGJPAU_DEVICE_OBJECT@@PAU_IRP@@@Z
?ndisLwmInitializeSubsystem@@YGJXZ
...
?ndisMInitializeScatterGatherDmaInternal@@YGHPAU_NDIS_MINIPORT_BLOCK@@PAU_DEVICE_OBJECT@@EEKK@Z
...
?ndisMiniportFdoInitializeSubsystem@@YGJXZ
?ndisMiniportOidIoctl@@YGJPAU_NDIS_MINIPORT_BLOCK@@PAU_NDIS_USER_OPEN_CONTEXT@@KKKPAEPAU_MDL@@AAK@Z
...
?ndisNotifyDevicePowerStateChange@@YGXPAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_DEVICE_POWER_STATE@@@Z
?ndisNotifyMiniports@@YGXPAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_DEVICE_PNP_EVENT@@PAXK@Z
?ndisNotifyWmiAdapterArrival@@YGXPAU_NDIS_MINIPORT_BLOCK@@@Z
...
?ndisOidNeedArmWatchDog@@YGEPAU_NDIS_OID_REQUEST@@PAU_NDIS_MINIPORT_BLOCK@@@Z
...
?ndisPnPAddDevice@@YGJPAU_DRIVER_OBJECT@@PAU_DEVICE_OBJECT@@PAXPAPAXE@Z
...
?ndisQueryDeviceReset@@YGJPAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@KKPAIPAU_NDIS_QUERY_DEVICE_RESET@@@Z
...
?ndisReadLwfById@@YGJW4NetSetupStoreType@@ABU_GUID@@@Z
...
?ndisReadProtocolById@@YGJW4NetSetupStoreType@@ABU_GUID@@@Z
...
?ndisRegisterKnobs@@YGJPBUKnobDescriptor@@IP6GEPAX0AA_K@ZP6GJ10_K@Z1@Z
...
?ndisReinitializeHistograms@@YGJXZ
...
?ndisStackExpansionAddProcessor@@YGXK@Z
?ndisStackExpansionFallbackWorker@@YGXPAX@Z
?ndisStackExpansionInitializeSubsystem@@YGJXZ
...
?ndisWaitForEvent@@YG_NPAU_KEVENT@@_J@Z
...
?ndisWdfCsResiliencyChange@@YGXPAU_NDIS_MINIPORT_BLOCK@@E@Z
?ndisWdfCsStateChange@@YGXPAU_NDIS_MINIPORT_BLOCK@@E_K@Z
?ndisWdfDeviceObjectCleanup@@YGJPAU_NDIS_MINIPORT_BLOCK@@@Z
?ndisWdfGetGuidToOidList@@YGXPBKGPAU_NDIS_GUID@@PAG@Z
?ndisWdfNicActiveAcquireSleepStudy@@YGXPAU_NDIS_MINIPORT_BLOCK@@PAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@PAU_NDIS_PM_NIC_ACTIVE@@@Z
?ndisWdfNicActiveReleaseSleepStudy@@YGXPAU_NDIS_MINIPORT_BLOCK@@PAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@PAU_NDIS_PM_NIC_ACTIVE@@@Z
...
?ndisWdfSendPmParametersForS0Idle@@YGXPAU_NDIS_MINIPORT_BLOCK@@@Z
?ndisWdfSendPmParametersForSx@@YGXPAU_NDIS_MINIPORT_BLOCK@@@Z
...
?reserve@?$KArray@PBVHistogram@Statistics@@$00@Rtl@@QAE_NI@Z
...
?reset@?$unique_ptr@U_UNICODE_STRING@@U?$KFreePool@U_UNICODE_STRING@@@@@wistd@@QAEXPAU_UNICODE_STRING@@@Z
?reset@?$unique_ptr@VHistogram@Statistics@@U?$KFreePool@VHistogram@Statistics@@@@@wistd@@QAEXPAVHistogram@Statistics@@@Z
?reset@?$unique_ptr@VKHistogram@@U?$default_delete@VKHistogram@@@wistd@@@wistd@@QAEXPAVKHistogram@@@Z
?reset@?$unique_ptr@VKnobCollection@@U?$KFreePool@VKnobCollection@@@@@wistd@@QAEXPAVKnobCollection@@@Z
...
?reset@?$unique_storage@U?$resource_policy@PAU_KTHREAD@@P6IJPAX@Z$1?ObfDereferenceObject@@YIJ0@ZU?$integral_constant@I$0A@@wistd@@PAU1@PAU1@$0A@$$T@details@wil@@@details@wil@@QAEXPAU_KTHREAD@@@Z
...
_McTemplateK0jqqqqqqqqqq_EtwWriteTransfer@56
...
_NdisWaitEvent@8
_NdisWdfAsyncPowerReferenceCompleteNotification@8
...
_NdisWdfNotifyWmiAdapterArrival@4
_NdisWdfPnPAddDevice@8
...
_PktMonClientNblDrop@32
_PktMonClientNblDropNdis@24
_PktMonClientNblLog@24
...
_PplAllocateFromLookasideListProcessor@8
_PplDestroyLookasideList@8
_PplFreeToLookasideListProcessor@12
_PplpCreateLookasideListEx@36
_PplpGenericAllocateFunction@16
_PplpGenericFreeFunction@8
_PplpLazyInitializeLookasideList@8
_PplpRetrieveListIndex@8
...
_WPP_RECORDER_SF_Sii@40
_WPP_RECORDER_SF_SiiD@44
_WPP_RECORDER_SF_Siid@44
_WPP_RECORDER_SF_Siii@48
...
_WdmlibIoValidateDeviceIoControlAccess@8
