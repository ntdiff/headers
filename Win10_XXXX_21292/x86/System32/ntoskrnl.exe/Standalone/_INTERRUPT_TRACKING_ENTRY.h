...
typedef struct _INTERRUPT_TRACKING_ENTRY
{
  ...
  /* 0x0008 */ struct _INTERRUPT_TRACKING_ROOT* IntTrackRoot;
  /* 0x000c */ unsigned long InterruptObjectCount;
  /* 0x0010 */ struct _KINTERRUPT** InterruptObjectArray;
  /* 0x0018 */ unsigned __int64 IsrTime;
  /* 0x0020 */ unsigned __int64 DpcTime;
  /* 0x0028 */ unsigned char IsPrimaryInterrupt;
  /* 0x0030 */ struct _INTERRUPT_VECTOR_DATA VectorData;
} INTERRUPT_TRACKING_ENTRY, *PINTERRUPT_TRACKING_ENTRY; /* size: 0x0080 */
