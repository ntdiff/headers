...
typedef struct _ETW_STACK_TRACE_BLOCK
{
  ...
  /* 0x002c */ unsigned long ApcSpinLock;
  /* 0x0030 */ union _SLIST_HEADER ApcFreeListHead;
  /* 0x0038 */ union _SLIST_HEADER ApcGlobalListHead;
  /* 0x0040 */ long ApcCount;
  /* 0x0044 */ unsigned long MaxApcCount;
  /* 0x0048 */ long Flags;
  /* 0x004c */ long OutstandingApcCount;
  /* 0x0050 */ long MaxOutstandingApcCount;
  /* 0x0054 */ long __PADDING__[1];
} ETW_STACK_TRACE_BLOCK, *PETW_STACK_TRACE_BLOCK; /* size: 0x0058 */
...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  union
  {
    /* 0x025c */ unsigned long Flags2;
    /* 0x025c */ unsigned long UnifiedStackCaching : 1; /* bit position: 0 */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0260 */ volatile unsigned long RequestFlag;
    struct /* bitfield */
    {
      /* 0x0260 */ unsigned long DbgRequestNewFile : 1; /* bit position: 0 */
      /* 0x0260 */ unsigned long DbgRequestUpdateFile : 1; /* bit position: 1 */
      /* 0x0260 */ unsigned long DbgRequestFlush : 1; /* bit position: 2 */
      /* 0x0260 */ unsigned long DbgRequestDisableRealtime : 1; /* bit position: 3 */
      /* 0x0260 */ unsigned long DbgRequestDisconnectConsumer : 1; /* bit position: 4 */
      /* 0x0260 */ unsigned long DbgRequestConnectConsumer : 1; /* bit position: 5 */
      /* 0x0260 */ unsigned long DbgRequestNotifyConsumer : 1; /* bit position: 6 */
      /* 0x0260 */ unsigned long DbgRequestUpdateHeader : 1; /* bit position: 7 */
      /* 0x0260 */ unsigned long DbgRequestDeferredFlush : 1; /* bit position: 8 */
      /* 0x0260 */ unsigned long DbgRequestDeferredFlushTimer : 1; /* bit position: 9 */
      /* 0x0260 */ unsigned long DbgRequestFlushTimer : 1; /* bit position: 10 */
      /* 0x0260 */ unsigned long DbgRequestUpdateDebugger : 1; /* bit position: 11 */
      /* 0x0260 */ unsigned long DbgSpareRequestFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0268 */ struct _ETW_STACK_TRACE_BLOCK StackTraceBlock;
  /* 0x02c0 */ struct _RTL_BITMAP HookIdMap;
  /* 0x02c8 */ struct _ETW_STACK_CACHE* StackCache;
  /* 0x02cc */ struct _ETW_PMC_SUPPORT* PmcData;
  /* 0x02d0 */ struct _ETW_LBR_SUPPORT* LbrData;
  /* 0x02d4 */ struct _ETW_IPT_SUPPORT* IptData;
  /* 0x02d8 */ struct _LIST_ENTRY BinaryTrackingList;
  /* 0x02e0 */ struct _WMI_BUFFER_HEADER** ScratchArray;
  /* 0x02e4 */ struct _DISALLOWED_GUIDS DisallowedGuids;
  /* 0x02f0 */ __int64 RelativeTimerDueTime;
  /* 0x02f8 */ struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;
  /* 0x0300 */ struct _EX_TIMER* PeriodicCaptureStateTimer;
  /* 0x0304 */ enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;
  /* 0x0308 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x030c */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x0310 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x0320 */ long CompressionWorkItemState;
  /* 0x0324 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x0328 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x032c */ void* CompressionWorkspace;
  /* 0x0330 */ long CompressionOn;
  /* 0x0334 */ unsigned long CompressionRatioGuess;
  /* 0x0338 */ unsigned long PartialBufferCompressionLevel;
  /* 0x033c */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x0340 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x0344 */ struct _KDPC CompressionDpc;
  /* 0x0368 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0370 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0378 */ union _LARGE_INTEGER BufferCompressDuration;
  /* 0x0380 */ __int64 ReferenceQpcDelta;
  /* 0x0388 */ struct _ETW_EVENT_CALLBACK_CONTEXT* CallbackContext;
  /* 0x038c */ union _LARGE_INTEGER* LastDroppedTime;
  /* 0x0390 */ union _LARGE_INTEGER* FlushingLastDroppedTime;
  /* 0x0398 */ __int64 FlushingSequenceNumber;
  /* 0x03a0 */ struct _ETW_PARTITION_CONTEXT PartitionContext;
  /* 0x03a4 */ struct _MDL* BufferMdl;
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x03a8 */
