...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x0138 */ volatile unsigned long HotAddSequenceNumber;
...
typedef struct _MI_SYSTEM_VA_STATE
{
  ...
  /* 0x0014 */ void* SystemCacheReverseMaps[1024];
  /* 0x1014 */ struct _MI_SYSTEM_REGION_REFERENCE VaRegion[1024];
  /* 0x2014 */ unsigned long TopLevelPteLockBits[128];
  /* 0x2214 */ unsigned long TopLevelPteAlternateLockBits[4];
  /* 0x2224 */ volatile long DeleteKvaLock;
  /* 0x2228 */ struct _MI_WSLE* WsleArrays[8];
  /* 0x2248 */ void* PagableHyperSpace;
  /* 0x224c */ void* HyperSpaceEnd;
  /* 0x2250 */ unsigned long PagableHyperSpaceBytes;
  /* 0x2254 */ struct _KEVENT FreeSystemCacheVa;
  /* 0x2264 */ unsigned long SystemVaLock;
  /* 0x2268 */ unsigned long SystemCacheViewLock;
  /* 0x226c */ struct _MMWSL_INSTANCE SystemWorkingSetList[8];
  /* 0x232c */ long __PADDING__[5];
} MI_SYSTEM_VA_STATE, *PMI_SYSTEM_VA_STATE; /* size: 0x2340 */
...
typedef struct _MI_PARTITION_STATE
{
  ...
  /* 0x002c */ unsigned long TotalNodePagesInChildPartitions[16];
  /* 0x006c */ unsigned long TotalSpecialPurposeMemoryInChildPartitions[1][16];
  /* 0x00ac */ unsigned long CrossPartitionDenials;
  /* 0x00b0 */ unsigned char MultiplePartitionsExist;
  /* 0x00b1 */ char __PADDING__[7];
} MI_PARTITION_STATE, *PMI_PARTITION_STATE; /* size: 0x00b8 */
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x00dc */ volatile struct _MI_CACHED_PTES* CachedKernelShadowStackPteHeads;
  /* 0x00e0 */ struct _MI_SYSTEM_PTE_TYPE SystemViewPteInfo;
  /* 0x0114 */ struct _MI_SYSTEM_PTE_TYPE KernelStackPteInfo;
  /* 0x0148 */ struct _MI_SYSTEM_PTE_TYPE KernelShadowStackPteInfo;
  /* 0x017c */ unsigned long StackGrowthFailures;
  /* 0x0180 */ unsigned char KernelStackPages;
  /* 0x0181 */ unsigned char TrackPtesAborted;
  /* 0x0182 */ unsigned char AdjustCounter;
  /* 0x0184 */ volatile long ReservedMappingLock;
  /* 0x0188 */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x018c */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x0190 */ struct _RTL_AVL_TREE OutswappedKernelStackRoot;
  /* 0x0194 */ volatile long OutswappedKernelStackLock;
  /* 0x0198 */ struct _MMPTE* BreakMakePte;
  /* 0x019c */ long __PADDING__[9];
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0064 */ volatile unsigned long ContiguousPagesAllocated;
  /* 0x0068 */ volatile unsigned long SystemPageTableCommit;
  /* 0x006c */ volatile unsigned long ProcessCommit;
  /* 0x0070 */ volatile long DriverCommit;
  /* 0x0074 */ unsigned char PagingLevels;
  /* 0x0078 */ volatile unsigned long PfnDatabaseCommit;
  ...
  /* 0x0794 */ unsigned long SystemVaTypeCount[17];
  /* 0x07d8 */ unsigned char SystemVaType[1024];
  /* 0x0bd8 */ unsigned long SystemVaTypeCountFailures[17];
  /* 0x0c1c */ unsigned long SystemVaTypeCountLimit[17];
  /* 0x0c60 */ unsigned long SystemVaTypeCountPeak[17];
  /* 0x0ca4 */ unsigned long SystemAvailableVa;
  /* 0x0ca8 */ long __PADDING__[6];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0240 */ struct _MI_SYSTEM_IMAGE_STATE SystemImages;
  /* 0x02a4 */ struct _MI_SESSION_STATE Sessions;
  /* 0x12e0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1380 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x14c0 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x3800 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x3820 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x3870 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x3928 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x3970 */ struct _MI_ERROR_STATE Errors;
  /* 0x3a40 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x3ac0 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x3b50 */ struct _MI_STANDBY_STATE Standby;
  /* 0x3cc0 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x3e80 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x3f00 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x3f60 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x3fc0 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x4000 */ struct _MI_SYSTEM_ZEROING Zeroing;
  /* 0x4018 */ struct _MI_ENCLAVE_STATE Enclaves;
  /* 0x403c */ unsigned long Cookie;
  /* 0x4040 */ void* volatile* BootRegistryRuns;
  /* 0x4044 */ volatile long ZeroingDisabled;
  /* 0x4048 */ unsigned char FullyInitialized;
  /* 0x4049 */ unsigned char SafeBooted;
  /* 0x404c */ struct _RTL_BITMAP PfnBitMap;
  /* 0x4054 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x4080 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x4d40 */
