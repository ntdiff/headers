...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x0078 */ volatile long CommonReferenceFlags;
  /* 0x007c */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x0094 */ struct _IO_REMOVE_LOCK AcpiRemoveLock;
  /* 0x00ac */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x00c8 */ unsigned long IdleLock;
  /* 0x00d0 */ struct _KTIMER IdleTimer;
  /* 0x00f8 */ struct _KDPC IdleDpc;
  /* 0x0118 */ unsigned __int64 IdleTimeout;
  /* 0x0120 */ unsigned __int64 IdleStamp;
  /* 0x0128 */ struct _DEVICE_OBJECT* NextIrpDeviceObject[2];
  /* 0x0130 */ union _POWER_STATE NextIrpPowerState[2];
  /* 0x0138 */ void* NextIrpCallerCompletion[2] /* function */;
  /* 0x0140 */ void* NextIrpCallerContext[2];
  /* 0x0148 */ struct _KEVENT IrpCompleteEvent;
  /* 0x0158 */ void* PowerOnDumpDeviceCallback /* function */;
  /* 0x0160 */ struct _POP_FX_ACCOUNTING Accounting;
  /* 0x0238 */ volatile unsigned long Flags;
  /* 0x023c */ unsigned long ComponentCount;
  /* 0x0240 */ struct _POP_FX_COMPONENT** Components;
  /* 0x0244 */ unsigned long LogEntries;
  /* 0x0248 */ struct _POP_FX_LOG_ENTRY* Log;
  /* 0x024c */ volatile long LogIndex;
  /* 0x0250 */ struct _DRIVER_OBJECT* DripsWatchdogDriverObject;
  /* 0x0254 */ struct _POP_FX_DRIPS_WATCHDOG_CONTEXT DripsWatchdogContext;
  /* 0x0268 */ unsigned long DirectedTimeout;
  /* 0x026c */ struct _POP_FX_WORK_ORDER DirectedWorkOrder;
  /* 0x0288 */ struct _POP_FX_WORK_ORDER_WATCHDOG_INFO DirectedWorkWatchdogInfo;
  /* 0x02f0 */ unsigned long DirectedLock;
  /* 0x02f4 */ volatile long DirectedTransitionCallCount;
  /* 0x02f8 */ struct _POP_FX_DEVICE_DIRECTED_TRANSITION_STATE DirectedTransitionState;
  /* 0x0304 */ struct _POP_DEVICE_POWER_PROFILE* PowerProfile;
  /* 0x0308 */ struct _UNICODE_STRING FriendlyName;
  /* 0x0310 */ struct _WORK_QUEUE_ITEM ReportDevicePoweredOnPassiveWorkItem;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x0320 */
