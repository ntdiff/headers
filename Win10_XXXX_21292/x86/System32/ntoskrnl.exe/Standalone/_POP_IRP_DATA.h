...
typedef struct _POP_IRP_DATA
{
  ...
  union
  {
    struct
    {
      ...
      /* 0x0094 */ struct _WORK_QUEUE_ITEM PassiveCompletionWorkItem;
    } /* size: 0x0020 */ Device;
    struct
    {
  ...
  /* 0x00a4 */ enum _POP_PEP_NOTIFY_DEVICE_DSTATE_REASON DStateReason;
} POP_IRP_DATA, *PPOP_IRP_DATA; /* size: 0x00a8 */
