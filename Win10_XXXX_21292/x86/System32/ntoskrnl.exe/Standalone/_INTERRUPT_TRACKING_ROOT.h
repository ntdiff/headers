...
typedef struct _INTERRUPT_TRACKING_ROOT
{
  ...
  /* 0x0008 */ struct _LIST_ENTRY TrackingEntryList;
  /* 0x0010 */ unsigned long Gsiv;
  /* 0x0018 */ struct _INTERRUPT_VECTOR_DATA VectorData;
  /* 0x0068 */ enum _INTERRUPT_STEERING_MODE SteeringMode;
  /* 0x006c */ unsigned char EnableSteering;
  /* 0x0070 */ struct _GROUP_AFFINITY CpuSetMask;
  /* 0x007c */ unsigned long AffinityEpoch;
  /* 0x0080 */ struct _GROUP_AFFINITY CurrentTarget;
  /* 0x008c */ struct _GROUP_AFFINITY NextTarget;
  /* 0x0098 */ unsigned __int64 TimeDelta;
  /* 0x00a0 */ void* RedirectHandle;
  /* 0x00a4 */ long __PADDING__[1];
} INTERRUPT_TRACKING_ROOT, *PINTERRUPT_TRACKING_ROOT; /* size: 0x00a8 */
