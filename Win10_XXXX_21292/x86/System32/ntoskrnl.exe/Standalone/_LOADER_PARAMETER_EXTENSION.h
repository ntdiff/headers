...
typedef struct _LOADER_FEATURE_CONFIGURATION_INFORMATION
{
  ...
  /* 0x0018 */ struct _LOADER_FEATURE_CONFIGURATION_DIAGNOSTIC_INFORMATION DiagnosticInformation;
...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0054 */ unsigned long PointerAuthKernelIpEnabled : 1; /* bit position: 16 */
    /* 0x0054 */ unsigned long SplitLargeNumaNodes : 1; /* bit position: 17 */
    /* 0x0054 */ unsigned long Unused : 3; /* bit position: 18 */
  ...
  /* 0x09c0 */ struct _LIST_ENTRY PrmUpdateModuleList;
  /* 0x09c8 */ struct _LIST_ENTRY PrmFirmwareModuleList;
  /* 0x09d0 */ union _LARGE_INTEGER SystemTime;
  /* 0x09d8 */ unsigned __int64 TimeStampAtSystemTimeRead;
  union
  {
    /* 0x09e0 */ unsigned __int64 BootFlags;
    struct /* bitfield */
    {
      /* 0x09e0 */ unsigned __int64 DbgMenuOsSelection : 1; /* bit position: 0 */
      /* 0x09e0 */ unsigned __int64 DbgHiberBoot : 1; /* bit position: 1 */
      /* 0x09e0 */ unsigned __int64 DbgSoftRestart : 1; /* bit position: 2 */
      /* 0x09e0 */ unsigned __int64 DbgMeasuredLaunch : 1; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0008 */
  union
  {
    /* 0x09e8 */ unsigned __int64 InternalBootFlags;
    struct /* bitfield */
    {
      /* 0x09e8 */ unsigned __int64 DbgUtcBootTime : 1; /* bit position: 0 */
      /* 0x09e8 */ unsigned __int64 DbgRtcBootTime : 1; /* bit position: 1 */
      /* 0x09e8 */ unsigned __int64 DbgNoLegacyServices : 1; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0008 */
  /* 0x09f0 */ void* WfsFPData;
  /* 0x09f4 */ unsigned long WfsFPDataSize;
  /* 0x09f8 */ struct _LOADER_BUGCHECK_PARAMETERS BugcheckParameters;
  /* 0x0a0c */ void* ApiSetSchema;
  /* 0x0a10 */ unsigned long ApiSetSchemaSize;
  /* 0x0a14 */ struct _LIST_ENTRY ApiSetSchemaExtensions;
  /* 0x0a1c */ struct _UNICODE_STRING AcpiBiosVersion;
  /* 0x0a24 */ struct _UNICODE_STRING SmbiosVersion;
  /* 0x0a2c */ struct _UNICODE_STRING EfiVersion;
  /* 0x0a34 */ struct _DEBUG_DEVICE_DESCRIPTOR* KdDebugDevice;
  /* 0x0a38 */ struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2 OfflineCrashdumpConfigurationTable;
  /* 0x0a58 */ struct _UNICODE_STRING ManufacturingProfile;
  /* 0x0a60 */ void* BbtBuffer;
  /* 0x0a68 */ unsigned __int64 XsaveAllowedFeatures;
  /* 0x0a70 */ unsigned long XsaveFlags;
  /* 0x0a74 */ void* BootOptions;
  /* 0x0a78 */ unsigned long IumEnablement;
  /* 0x0a7c */ unsigned long IumPolicy;
  /* 0x0a80 */ long IumStatus;
  /* 0x0a84 */ unsigned long BootId;
  /* 0x0a88 */ struct _LOADER_PARAMETER_CI_EXTENSION* CodeIntegrityData;
  /* 0x0a8c */ unsigned long CodeIntegrityDataSize;
  /* 0x0a90 */ struct _LOADER_HIVE_RECOVERY_INFO SystemHiveRecoveryInfo;
  /* 0x0aa4 */ unsigned long SoftRestartCount;
  /* 0x0aa8 */ __int64 SoftRestartTime;
  /* 0x0ab0 */ struct _LEAP_SECOND_DATA* LeapSecondData;
  /* 0x0ab4 */ unsigned long MajorRelease;
  /* 0x0ab8 */ unsigned long Reserved1;
  /* 0x0abc */ char NtBuildLab[224];
  /* 0x0b9c */ char NtBuildLabEx[224];
  /* 0x0c80 */ struct _LOADER_RESET_REASON ResetReason;
  /* 0x0cb0 */ unsigned long MaxPciBusNumber;
  /* 0x0cb4 */ unsigned long FeatureSettings;
  /* 0x0cb8 */ unsigned long HotPatchReserveSize;
  /* 0x0cbc */ unsigned long RetpolineReserveSize;
  /* 0x0cc0 */ struct _VSM_PERFORMANCE_DATA VsmPerformanceData;
  /* 0x0d00 */ struct _NUMA_MEMORY_RANGE* NumaMemoryRanges;
  /* 0x0d04 */ unsigned long NumaMemoryRangeCount;
  /* 0x0d08 */ unsigned long IommuFaultPolicy;
  /* 0x0d0c */ struct _LOADER_FEATURE_CONFIGURATION_INFORMATION FeatureConfigurationInformation;
  /* 0x0d3c */ struct _ETW_BOOT_CONFIG EtwBootConfig;
  /* 0x0d48 */ struct _BOOT_FIRMWARE_RAMDISK_INFO* FwRamdiskInfo;
  /* 0x0d4c */ void* IpmiHwContext;
  /* 0x0d50 */ union _LARGE_INTEGER Luid;
  struct
  {
    /* 0x0d58 */ struct _INSTALLED_MEMORY_RANGE* Ranges;
    /* 0x0d5c */ unsigned long RangeCount;
  } /* size: 0x0008 */ InstalledMemory;
