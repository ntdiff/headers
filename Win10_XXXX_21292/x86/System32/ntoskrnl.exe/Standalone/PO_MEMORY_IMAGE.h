...
struct PO_MEMORY_IMAGE
{
  ...
  /* 0x02c8 */ unsigned long FirmwareRuntimeInformationPages;
  /* 0x02cc */ unsigned long FirmwareRuntimeInformation[1];
  /* 0x02d0 */ unsigned long SpareUlong;
  /* 0x02d4 */ unsigned long NoBootLoaderLogPages;
  /* 0x02d8 */ unsigned long BootLoaderLogPages[24];
  /* 0x0338 */ unsigned long NotUsed;
  /* 0x033c */ unsigned long ResumeContextCheck;
  /* 0x0340 */ unsigned long ResumeContextPages;
  /* 0x0344 */ unsigned char Hiberboot;
  /* 0x0345 */ unsigned char SecureLaunched;
  /* 0x0346 */ unsigned char SecureBoot;
  /* 0x0348 */ unsigned __int64 HvPageTableRoot;
  /* 0x0350 */ unsigned __int64 HvEntryPoint;
  /* 0x0358 */ unsigned __int64 HvReservedTransitionAddress;
  /* 0x0360 */ unsigned __int64 HvReservedTransitionAddressSize;
  /* 0x0368 */ unsigned __int64 BootFlags;
  /* 0x0370 */ unsigned __int64 RestoreProcessorStateRoutine;
  /* 0x0378 */ unsigned long HighestPhysicalPage;
  /* 0x037c */ unsigned long BitlockerKeyPfns[4];
  /* 0x038c */ unsigned long HardwareSignature;
  /* 0x0390 */ union _LARGE_INTEGER SMBiosTablePhysicalAddress;
  /* 0x0398 */ unsigned long SMBiosTableLength;
  /* 0x039c */ unsigned char SMBiosMajorVersion;
  /* 0x039d */ unsigned char SMBiosMinorVersion;
  /* 0x039e */ unsigned char HiberResumeXhciHandoffSkip;
  /* 0x039f */ unsigned char InitializeUSBCore;
  /* 0x03a0 */ unsigned char ValidUSBCoreId;
  /* 0x03a1 */ unsigned char USBCoreId;
  /* 0x03a2 */ unsigned char SkipMemoryMapValidation;
  /* 0x03a3 */ unsigned char SuppressResumePrompt;
