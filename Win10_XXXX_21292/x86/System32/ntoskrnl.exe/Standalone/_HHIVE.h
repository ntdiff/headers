...
typedef struct _HHIVE
{
  ...
  /* 0x0068 */ unsigned long FlusherFlags;
  /* 0x006c */ unsigned long CurrentLog;
  /* 0x0070 */ unsigned long CurrentLogSequence;
  /* 0x0074 */ unsigned long CurrentLogMinimumSequence;
  /* 0x0078 */ unsigned long CurrentLogOffset;
  /* 0x007c */ unsigned long MinimumLogSequence;
  /* 0x0080 */ unsigned long LogFileSizeCap;
  /* 0x0084 */ unsigned char LogDataPresent[2];
  /* 0x0086 */ unsigned char PrimaryFileValid;
  /* 0x0087 */ unsigned char BaseBlockDirty;
