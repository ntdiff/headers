...
typedef struct _IOMMU_DEVICE_CREATION_CONFIGURATION
{
  ...
  /* 0x0008 */ enum _IOMMU_DEVICE_CREATION_CONFIGURATION_TYPE ConfigType;
  /* 0x000c */ struct _IOMMU_DEVICE_CREATION_CONFIGURATION_ACPI Acpi;
} IOMMU_DEVICE_CREATION_CONFIGURATION, *PIOMMU_DEVICE_CREATION_CONFIGURATION; /* size: 0x0014 */
