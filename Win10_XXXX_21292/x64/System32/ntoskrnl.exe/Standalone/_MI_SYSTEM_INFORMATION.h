...
typedef struct _MI_ERROR_STATE
{
  ...
  /* 0x008c */ unsigned long PrePhase0BugCheckParameter;
  /* 0x0090 */ unsigned long WsleFailures;
  /* 0x0094 */ unsigned long PageHashErrors;
  /* 0x0098 */ unsigned long CheckZeroCount;
  /* 0x009c */ volatile long ZeroedPageSingleBitErrorsDetected;
  /* 0x00a0 */ volatile long BadPagesDetected;
  /* 0x00a4 */ unsigned long BadPagesInserted;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x04e8 */ struct _MI_SESSION_STATE Sessions;
  /* 0x1570 */ struct _MI_PROCESS_STATE Processes;
  /* 0x15c0 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x2780 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x2c80 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x2ca0 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x2d40 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x3800 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x3878 */ struct _MI_ERROR_STATE Errors;
  /* 0x3980 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x3a00 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x3b20 */ struct _MI_STANDBY_STATE Standby;
  /* 0x3cc0 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x3f40 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x4000 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x40b0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x4180 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x41c0 */ struct _MI_SYSTEM_ZEROING Zeroing;
  /* 0x41e0 */ struct _MI_HOT_PATCH_STATE HotPatch;
  /* 0x4220 */ struct _MI_ENCLAVE_STATE Enclaves;
  /* 0x4268 */ unsigned __int64 Cookie;
  /* 0x4270 */ void* volatile* BootRegistryRuns;
  /* 0x4278 */ volatile long ZeroingDisabled;
  /* 0x427c */ unsigned char FullyInitialized;
  /* 0x427d */ unsigned char SafeBooted;
  /* 0x4280 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x42c0 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x4f80 */
