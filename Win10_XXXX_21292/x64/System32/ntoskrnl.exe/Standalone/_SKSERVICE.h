typedef enum _SKSERVICE
{
  ...
  SECURESERVICE_LIVEDUMP_QUERY_SECONDARYDATA_SIZE = 54,
  SECURESERVICE_LIVEDUMP_START = 55,
  SECURESERVICE_LIVEDUMP_ADD_BUFFER = 56,
  SECURESERVICE_LIVEDUMP_SETUP_BUFFER = 57,
  SECURESERVICE_LIVEDUMP_FINALIZE = 58,
  SECURESERVICE_LIVEDUMP_ABORT = 59,
  SECURESERVICE_LIVEDUMP_CAPTURE_PROCESS = 60,
  SECURESERVICE_NOTIFY_POWER_STATE = 61,
  SECURESERVICE_QUERY_PROFILE_INFORMATION = 62,
  SECURESERVICE_UPDATE_FREEZE_BIAS = 63,
  SECURESERVICE_CREATE_SECURE_SECTION = 64,
  SECURESERVICE_DELETE_SECURE_SECTION = 65,
  SECURESERVICE_QUERY_SECURE_DEVICE = 66,
  SECURESERVICE_UNPROTECT_SECURE_DEVICE = 67,
  SECURESERVICE_DETERMINE_HOT_PATCH_TYPE = 68,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE_SIZE = 69,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE = 70,
  SECURESERVICE_APPLY_HOT_PATCH = 71,
  SECURESERVICE_REVERT_HOT_PATCH = 72,
  SECURESERVICE_PREPARE_DRIVER_FOR_PATCH = 73,
  SECURESERVICE_PROVISION_DUMP_KEYS = 74,
  SECURESERVICE_CAPTURE_PGO_DATA = 75,
  SECURESERVICE_START_PROFILE = 76,
  SECURESERVICE_STOP_PROFILE = 77,
  SECURESERVICE_SECURE_POOL_CREATE = 78,
  SECURESERVICE_SECURE_POOL_DESTROY = 79,
  SECURESERVICE_SECURE_POOL_ALLOCATE = 80,
  SECURESERVICE_SECURE_POOL_FREE = 81,
  SECURESERVICE_SECURE_POOL_UPDATE = 82,
  SECURESERVICE_SET_TRACEPOINT = 83,
  SECURESERVICE_TRANSFORM_DUMP_KEY = 84,
