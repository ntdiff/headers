...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x3498 */ struct _KEVENT LargePageCandidatesExistEvent;
  /* 0x34b0 */ unsigned __int64 LowMemoryThreshold;
  /* 0x34b8 */ unsigned __int64 HighMemoryThreshold;
  /* 0x34c0 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x34d0 */ unsigned char SlabPagesNotAvailable[7];
  /* 0x34d8 */ void* HugePfnLists;
  /* 0x34e0 */ unsigned __int64 AvailableHugeIoRanges;
  /* 0x34e8 */ long __PADDING__[6];
