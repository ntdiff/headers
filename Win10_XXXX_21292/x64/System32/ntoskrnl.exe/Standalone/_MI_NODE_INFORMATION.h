...
typedef struct _MI_NODE_INFORMATION
{
  ...
  /* 0x5930 */ volatile long LargePageLock;
  /* 0x5934 */ struct _MI_PAGE_COLORS PageColorTable;
  /* 0x5948 */ unsigned __int64 NumberOfPagesGoingBad;
  /* 0x5950 */ void* BootZeroContext;
  /* 0x5958 */ void* ZeroingVaBase;
  /* 0x5960 */ unsigned __int64 TotalBytesToZero;
  /* 0x5968 */ unsigned __int64 PerProcessorNumberOfBytesToZero;
  /* 0x5970 */ void* ZeroingContext;
  /* 0x5978 */ volatile unsigned long ZeroingProcessorCount;
  /* 0x597c */ volatile long ZeroHand;
  /* 0x5980 */ volatile long FinishedProcessors;
  /* 0x5984 */ unsigned char BackgroundZeroingActive;
  /* 0x5985 */ unsigned char ZeroThreadsReady;
  /* 0x5988 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* ZeroingPhysicalMemoryBlock;
  /* 0x5990 */ struct _CACHED_KSTACK_LIST CachedKernelStacks[3];
  /* 0x59f0 */ struct _CACHED_KSTACK_LIST CachedKernelShadowStackLists[3];
  /* 0x5a50 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[7];
  /* 0x5f00 */ struct _MMPFNLIST EnclavePageListHead;
  /* 0x5f58 */ long __PADDING__[10];
} MI_NODE_INFORMATION, *PMI_NODE_INFORMATION; /* size: 0x5f80 */
