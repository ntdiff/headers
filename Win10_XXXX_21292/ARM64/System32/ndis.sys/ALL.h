...
typedef struct _PPL_LOOKASIDE_LIST_ARRAY
{
  ...
  /* 0x001e */ char Padding_34[98];
  /* 0x0080 */ struct _PPL_LOOKASIDE_LIST* LookasideLists /* zero-length array */;
...
typedef struct _KPRCB
{
  ...
  /* 0x0030 */ struct _KPRIORITY_STATE* PriorityState;
  /* 0x0038 */ long Padding_121[2];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_181;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_182[2];
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x107e */ char Padding_259[2];
  /* 0x1080 */ unsigned long DirectOidRequestCount;
  /* 0x1084 */ long Padding_260;
  ...
  /* 0x132c */ long Padding_270;
  /* 0x1330 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x1338 */ unsigned long QosRemoteParametersBufferSize;
  /* 0x133c */ long Padding_271;
  /* 0x1340 */ unsigned __int64 DeviceFlags;
  /* 0x1348 */ void* VerifierContext;
  /* 0x1350 */ struct WORKITEM_WITH_IRP SurpriseRemovalWorkItem;
  /* 0x1378 */ struct Ndis::BindStack Bindings;
  /* 0x13e0 */ struct Ndis::BindEngine BindEngine;
  /* 0x1458 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x1480 */ BOOL PmInterruptedByPnp;
  /* 0x1481 */ BOOL DoNotBlockOnMiniportLock;
  /* 0x1482 */ BOOL PoFxDStateReportingEnabled;
  /* 0x1483 */ char Padding_272[5];
  /* 0x1488 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x1490 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x14b0 */ BOOL InterfaceUpdateInProgress;
  /* 0x14b1 */ BOOL MacAddressUpdateQueued;
  /* 0x14b2 */ BOOL MtuUpdateQueued;
  /* 0x14b3 */ char Padding_273;
  /* 0x14b4 */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x14d6 */ char Padding_274[2];
  /* 0x14d8 */ unsigned long PendingMtuSize;
  /* 0x14dc */ long Padding_275;
  /* 0x14e0 */ wchar_t* PnPInstanceId;
  /* 0x14e8 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x1510 */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x1538 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x1540 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x1548 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > ReenumerateWatchdog;
  /* 0x1550 */ struct _NDIS_PD_BLOCK* PDBlock;
  /* 0x1558 */ void* PdcHandle;
  /* 0x1560 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x15e0 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x1630 */ volatile long PdcTaskClientMode;
  /* 0x1634 */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x1638 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x1640 */ volatile long RssV2CompletionCount;
  /* 0x1644 */ long Padding_276;
  /* 0x1648 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x1660 */ unsigned char RssV2Initialized;
  /* 0x1661 */ char Padding_277[7];
  ...
  /* 0x16c0 */ unsigned char WdfCxPowerManagement;
  /* 0x16c1 */ char __PADDING__[7];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_392;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_393[2];
...
{
  /* 0x0000 */ long Padding_399[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_400;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_401;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
...
struct DOT11_EXTSTA_ATTRIBUTES
{
  ...
  /* 0x002f */ char Padding_444;
  /* 0x0030 */ unsigned long uNumSupportedCountryOrRegionStrings;
  /* 0x0034 */ long Padding_445;
  /* 0x0038 */ unsigned char* pSupportedCountryOrRegionStrings[3];
  /* 0x0040 */ unsigned long uInfraNumSupportedUcastAlgoPairs;
  /* 0x0044 */ long Padding_446;
...
??$invoke@P6AXPEAU_DMA_ADAPTER@@@ZAEAPEAU1@@wistd@@YAX$$QEAP6AXPEAU_DMA_ADAPTER@@@ZAEAPEAU1@@Z
...
??0KAcquireSpinLock@@QEAA@AEAVKSpinLockBase@@@Z
...
??1?$unique_ptr@UNdisHistogramGlobal@@U?$default_delete@UNdisHistogramGlobal@@@wistd@@@wistd@@QEAA@XZ
...
??1?$unique_ptr@VNdisPoll@@U?$default_delete@VNdisPoll@@@wistd@@@wistd@@QEAA@XZ
...
??3?$KALLOCATOR@$0HEHDEIEL@$0CAA@@@SAXPEAX@Z
??3@YAXPEAX@Z
...
?ChangeStateNoLock@ExecutionContext@@AEAAXW4State@1@@Z
...
?IsAddressContained@STACK_SEGMENT@@QEBA_N_K@Z
...
?LoadCurrentStack@STACK_SEGMENT@@QEAAXXZ
...
?Release@KAcquireSpinLock@@QEAAXXZ
...
?SetMiniportNotificationEnabled@NdisPoll@@AEAAX_N@Z
...
?SetTargetProcessorDpcEx@?$EcDpc@VExecutionContext@@@@QEAAJQEAU_PROCESSOR_NUMBER@@@Z
...
?ShouldRunInDpc@ExecutionContext@@AEBA_NXZ
?Stop@KTickCounterStopwatch@@QEAA_KXZ
...
?ndisInitializePerProcRcvTracker@@YAXXZ
...
?ndisLoadKnobsOnce@@YAJPEBUKnobDescriptor@@_K@Z
...
?ndisPplFree@@YAXPEAUPPL_POOL_HANDLE__@@KPEAX@Z
?ndisPreOffloadAdminSettings@@YAEPEAU_NDIS_REQ_TRACKER@@@Z
?ndisPreProcessOid@@YAEPEAXPEAU_NDIS_OID_REQUEST@@IPEAH@Z
