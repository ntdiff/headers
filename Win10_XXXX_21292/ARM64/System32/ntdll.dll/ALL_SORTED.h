...
typedef struct _EJOB
{
  ...
  /* 0x02a0 */ unsigned __int64 ProcessMemoryLimit;
  /* 0x02a8 */ unsigned __int64 JobMemoryLimit;
  /* 0x02b0 */ unsigned __int64 JobTotalMemoryLimit;
  /* 0x02b8 */ unsigned __int64 PeakProcessMemoryUsed;
  /* 0x02c0 */ unsigned __int64 PeakJobMemoryUsed;
  /* 0x02c8 */ struct _KAFFINITY_EX EffectiveAffinity;
  /* 0x03d0 */ union _LARGE_INTEGER EffectivePerProcessUserTimeLimit;
  /* 0x03d8 */ unsigned __int64 EffectiveMinimumWorkingSetSize;
  /* 0x03e0 */ unsigned __int64 EffectiveMaximumWorkingSetSize;
  /* 0x03e8 */ unsigned __int64 EffectiveProcessMemoryLimit;
  /* 0x03f0 */ struct _EJOB* EffectiveProcessMemoryLimitJob;
  /* 0x03f8 */ struct _EJOB* EffectivePerProcessUserTimeLimitJob;
  /* 0x0400 */ struct _EJOB* EffectiveNetIoRateLimitJob;
  /* 0x0408 */ struct _EJOB* EffectiveHeapAttributionJob;
  /* 0x0410 */ unsigned long EffectiveLimitFlags;
  /* 0x0414 */ unsigned long EffectiveSchedulingClass;
  /* 0x0418 */ unsigned long EffectiveFreezeCount;
  /* 0x041c */ unsigned long EffectiveBackgroundCount;
  /* 0x0420 */ unsigned long EffectiveSwapCount;
  /* 0x0424 */ unsigned long EffectiveNotificationLimitCount;
  /* 0x0428 */ unsigned char EffectivePriorityClass;
  /* 0x0429 */ unsigned char PriorityClass;
  /* 0x042a */ unsigned char NestingDepth;
  /* 0x042b */ unsigned char Reserved1[1];
  /* 0x042c */ unsigned long CompletionFilter;
  union
  {
    /* 0x0430 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x0430 */ struct _PS_JOB_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0048 */
  /* 0x0478 */ struct _JOBOBJECT_WAKE_FILTER WakeFilter;
  /* 0x0480 */ unsigned long LowEdgeLatchFilter;
  /* 0x0488 */ struct _EJOB* NotificationLink;
  /* 0x0490 */ unsigned __int64 CurrentJobMemoryUsed;
  /* 0x0498 */ struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
  /* 0x04a0 */ void* NotificationInfoQuotaReference;
  /* 0x04a8 */ struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
  /* 0x04b0 */ struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
  /* 0x04b8 */ void* EffectiveSchedulingGroup;
  /* 0x04c0 */ unsigned __int64 ReadyTime;
  /* 0x04c8 */ struct _EX_PUSH_LOCK MemoryLimitsLock;
  /* 0x04d0 */ struct _LIST_ENTRY SiblingJobLinks;
  /* 0x04e0 */ struct _LIST_ENTRY ChildJobListHead;
  /* 0x04f0 */ struct _EJOB* ParentJob;
  /* 0x04f8 */ struct _EJOB* volatile RootJob;
  /* 0x0500 */ struct _LIST_ENTRY IteratorListHead;
  /* 0x0510 */ unsigned __int64 AncestorCount;
  union
  {
    /* 0x0518 */ struct _EJOB** Ancestors;
    /* 0x0518 */ void* SessionObject;
  }; /* size: 0x0008 */
  /* 0x0520 */ struct _EPROCESS_VALUES Accounting;
  /* 0x0588 */ unsigned long ShadowActiveProcessCount;
  /* 0x058c */ unsigned long ActiveAuxiliaryProcessCount;
  /* 0x0590 */ unsigned long SequenceNumber;
  /* 0x0594 */ unsigned long JobId;
  /* 0x0598 */ struct _GUID ContainerId;
  /* 0x05a8 */ struct _GUID ContainerTelemetryId;
  /* 0x05b8 */ struct _ESERVERSILO_GLOBALS* ServerSiloGlobals;
  /* 0x05c0 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x05d8 */ struct _PSP_STORAGE* Storage;
  /* 0x05e0 */ struct _JOB_NET_RATE_CONTROL* NetRateControl;
  union
  {
    /* 0x05e8 */ unsigned long JobFlags;
    struct /* bitfield */
    {
      /* 0x05e8 */ unsigned long CloseDone : 1; /* bit position: 0 */
      /* 0x05e8 */ unsigned long MultiGroup : 1; /* bit position: 1 */
      /* 0x05e8 */ unsigned long OutstandingNotification : 1; /* bit position: 2 */
      /* 0x05e8 */ unsigned long NotificationInProgress : 1; /* bit position: 3 */
      /* 0x05e8 */ unsigned long UILimits : 1; /* bit position: 4 */
      /* 0x05e8 */ unsigned long CpuRateControlActive : 1; /* bit position: 5 */
      /* 0x05e8 */ unsigned long OwnCpuRateControl : 1; /* bit position: 6 */
      /* 0x05e8 */ unsigned long Terminating : 1; /* bit position: 7 */
      /* 0x05e8 */ unsigned long WorkingSetLock : 1; /* bit position: 8 */
      /* 0x05e8 */ unsigned long JobFrozen : 1; /* bit position: 9 */
      /* 0x05e8 */ unsigned long Background : 1; /* bit position: 10 */
      /* 0x05e8 */ unsigned long WakeNotificationAllocated : 1; /* bit position: 11 */
      /* 0x05e8 */ unsigned long WakeNotificationEnabled : 1; /* bit position: 12 */
      /* 0x05e8 */ unsigned long WakeNotificationPending : 1; /* bit position: 13 */
      /* 0x05e8 */ unsigned long LimitNotificationRequired : 1; /* bit position: 14 */
      /* 0x05e8 */ unsigned long ZeroCountNotificationRequired : 1; /* bit position: 15 */
      /* 0x05e8 */ unsigned long CycleTimeNotificationRequired : 1; /* bit position: 16 */
      /* 0x05e8 */ unsigned long CycleTimeNotificationPending : 1; /* bit position: 17 */
      /* 0x05e8 */ unsigned long TimersVirtualized : 1; /* bit position: 18 */
      /* 0x05e8 */ unsigned long JobSwapped : 1; /* bit position: 19 */
      /* 0x05e8 */ unsigned long ViolationDetected : 1; /* bit position: 20 */
      /* 0x05e8 */ unsigned long EmptyJobNotified : 1; /* bit position: 21 */
      /* 0x05e8 */ unsigned long NoSystemCharge : 1; /* bit position: 22 */
      /* 0x05e8 */ unsigned long DropNoWakeCharges : 1; /* bit position: 23 */
      /* 0x05e8 */ unsigned long NoWakeChargePolicyDecided : 1; /* bit position: 24 */
      /* 0x05e8 */ unsigned long NetRateControlActive : 1; /* bit position: 25 */
      /* 0x05e8 */ unsigned long OwnNetRateControl : 1; /* bit position: 26 */
      /* 0x05e8 */ unsigned long IoRateControlActive : 1; /* bit position: 27 */
      /* 0x05e8 */ unsigned long OwnIoRateControl : 1; /* bit position: 28 */
      /* 0x05e8 */ unsigned long DisallowNewProcesses : 1; /* bit position: 29 */
      /* 0x05e8 */ unsigned long Silo : 1; /* bit position: 30 */
      /* 0x05e8 */ unsigned long ContainerTelemetryIdSet : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x05ec */ unsigned long JobFlags2;
    struct /* bitfield */
    {
      /* 0x05ec */ unsigned long ParentLocked : 1; /* bit position: 0 */
      /* 0x05ec */ unsigned long EnableUsermodeSiloThreadImpersonation : 1; /* bit position: 1 */
      /* 0x05ec */ unsigned long DisallowUsermodeSiloThreadImpersonation : 1; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x05f0 */ struct _PROCESS_EXTENDED_ENERGY_VALUES* EnergyValues;
  /* 0x05f8 */ volatile unsigned __int64 SharedCommitCharge;
  /* 0x0600 */ unsigned long DiskIoAttributionUserRefCount;
  /* 0x0604 */ unsigned long DiskIoAttributionRefCount;
  union
  {
    /* 0x0608 */ void* DiskIoAttributionContext;
    /* 0x0608 */ struct _EJOB* DiskIoAttributionOwnerJob;
  }; /* size: 0x0008 */
  /* 0x0610 */ struct _JOB_RATE_CONTROL_HEADER IoRateControlHeader;
  /* 0x0638 */ struct _PS_IO_CONTROL_ENTRY GlobalIoControl;
  /* 0x0670 */ volatile long IoControlStateLock;
  /* 0x0678 */ struct _RTL_RB_TREE VolumeIoControlTree;
  /* 0x0688 */ unsigned __int64 IoRateOverQuotaHistory;
  /* 0x0690 */ unsigned long IoRateCurrentGeneration;
  /* 0x0694 */ unsigned long IoRateLastQueryGeneration;
  /* 0x0698 */ unsigned long IoRateGenerationLength;
  /* 0x069c */ unsigned long IoRateOverQuotaNotifySequenceId;
  /* 0x06a0 */ unsigned __int64 LastThrottledIoTime;
  /* 0x06a8 */ struct _EX_PUSH_LOCK IoControlLock;
  /* 0x06b0 */ __int64 SiloHardReferenceCount;
  /* 0x06b8 */ struct _WORK_QUEUE_ITEM RundownWorkItem;
  /* 0x06d8 */ void* PartitionObject;
  /* 0x06e0 */ struct _EJOB* PartitionOwnerJob;
  /* 0x06e8 */ union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;
  /* 0x06f0 */ unsigned __int64 KernelWaitTime;
  /* 0x06f8 */ unsigned __int64 UserWaitTime;
} EJOB, *PEJOB; /* size: 0x0700 */
...
typedef struct _ENODE
{
  ...
  /* 0x0110 */ struct _WORK_QUEUE_ITEM HotAddProcessorWorkItem;
  /* 0x0130 */ long __PADDING__[20];
...
typedef struct _EPROCESS
{
  ...
  /* 0x0540 */ struct _EX_FAST_REF DeviceMap;
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x093c */ unsigned long DisallowUserTerminate : 1; /* bit position: 27 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  ...
  /* 0x0a2c */ unsigned short Machine;
  /* 0x0a2e */ unsigned short Spare0;
  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0a94 */ unsigned long CetUserShadowStacksStrictMode : 1; /* bit position: 20 */
        /* 0x0a94 */ unsigned long BlockNonCetBinaries : 1; /* bit position: 21 */
        /* 0x0a94 */ unsigned long BlockNonCetBinariesNonEhcont : 1; /* bit position: 22 */
        /* 0x0a94 */ unsigned long AuditBlockNonCetBinaries : 1; /* bit position: 23 */
        /* 0x0a94 */ unsigned long AuditBlockNonCetBinariesLogged : 1; /* bit position: 24 */
        /* 0x0a94 */ unsigned long XtendedControlFlowGuard : 1; /* bit position: 25 */
        /* 0x0a94 */ unsigned long AuditXtendedControlFlowGuard : 1; /* bit position: 26 */
        /* 0x0a94 */ unsigned long PointerAuthUserIp : 1; /* bit position: 27 */
        /* 0x0a94 */ unsigned long AuditPointerAuthUserIp : 1; /* bit position: 28 */
        /* 0x0a94 */ unsigned long AuditPointerAuthUserIpLogged : 1; /* bit position: 29 */
        /* 0x0a94 */ unsigned long CetDynamicApisOutOfProcOnly : 1; /* bit position: 30 */
        /* 0x0a94 */ unsigned long UserCetSetContextIpValidationRelaxedMode : 1; /* bit position: 31 */
      }; /* bitfield */
  ...
  /* 0x0bd8 */ struct _RTL_AVL_TREE DynamicEHContinuationTargetsTree;
  /* 0x0be0 */ struct _EX_PUSH_LOCK DynamicEHContinuationTargetsLock;
  /* 0x0be8 */ unsigned __int64 PointerAuthUserIpKey[2];
  /* 0x0bf8 */ struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES DynamicEnforcedCetCompatibleRanges;
  /* 0x0c08 */ unsigned long DisabledComponentFlags;
  /* 0x0c0c */ long __PADDING__[29];
} EPROCESS, *PEPROCESS; /* size: 0x0c80 */
...
typedef struct _ETHREAD
{
  ...
  /* 0x057c */ volatile long MmLockOrdering;
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0580 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0584 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x0589 */ unsigned char SessionAttachActive : 1; /* bit position: 7 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  ...
  /* 0x0590 */ unsigned long PerformanceCountLowReserved;
  /* 0x0594 */ long PerformanceCountHighReserved;
  ...
  /* 0x0690 */ unsigned long LastExpectedRunTime;
  /* 0x0694 */ unsigned long HeapData;
  ...
  /* 0x06c0 */ struct _KLOCK_ENTRY LockEntries[6];
  /* 0x0900 */ void* CmThreadInfo;
  /* 0x0908 */ void* FlsData;
} ETHREAD, *PETHREAD; /* size: 0x0910 */
  ...
  union
  {
    union
    {
      struct /* bitfield */
      {
        ...
        /* 0x000d */ unsigned char LargeHeapFirstSegment : 1; /* bit position: 5 */
      }; /* bitfield */
...
} KE_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK, *PKE_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK; /* size: 0x0118 */
...
typedef struct _KNODE
{
  ...
  /* 0x0010 */ struct _KSCHEDULER_SUBNODE* SchedulerSubNodes[32];
} KNODE, *PKNODE; /* size: 0x0110 */
...
typedef struct _KPRCB
{
  ...
  /* 0x0892 */ unsigned char PrcbPad5[1];
  ...
  /* 0x08c8 */ unsigned __int64 EmulatedMisalignedAtomics;
  /* 0x08d0 */ volatile long EmulatedCoalesceCount;
  ...
  /* 0x0b30 */ unsigned long InterruptLastCount;
  /* 0x0b34 */ unsigned long InterruptRate;
  /* 0x0b38 */ unsigned long SingleDpcSoftTimeLimitTicks;
  /* 0x0b3c */ unsigned long CumulativeDpcSoftTimeLimitTicks;
  /* 0x0b40 */ struct _KSINGLE_DPC_SOFT_TIMEOUT_EVENT_INFO* SingleDpcSoftTimeoutEventInfo;
  ...
  /* 0x0f20 */ unsigned long DpcTimeLimitTicks;
  ...
  /* 0x13f0 */ struct _KDPC ForceIdleDpc;
  /* 0x1430 */ struct _RTL_HASH_TABLE* DpcRuntimeHistoryHashTable;
  /* 0x1438 */ struct _KDPC* DpcRuntimeHistoryHashTableCleanupDpc;
  /* 0x1440 */ void* CurrentDpcRoutine /* function */;
  /* 0x1448 */ unsigned __int64 CurrentDpcRuntimeHistoryCached;
  /* 0x1450 */ unsigned __int64 CurrentDpcStartTime;
  /* 0x1458 */ struct _KTHREAD* DpcDelegateThread;
  /* 0x1460 */ unsigned long DeviceInterrupts;
  /* 0x1468 */ void* IsrDpcStats;
  /* 0x1470 */ unsigned long KeAlignmentFixupCount;
  /* 0x1478 */ struct _KDPC DpcWatchdogDpc;
  /* 0x14b8 */ struct _KTIMER DpcWatchdogTimer;
  /* 0x1500 */ union _SLIST_HEADER InterruptObjectPool;
  /* 0x1510 */ struct _KAFFINITY_EX PackageProcessorSet;
  /* 0x1618 */ unsigned long PackageId;
  /* 0x1680 */ unsigned __int64 SharedReadyQueueMask;
  /* 0x1688 */ struct _KSHARED_READY_QUEUE* SharedReadyQueue;
  /* 0x1690 */ unsigned long SharedQueueScanOwner;
  /* 0x1694 */ unsigned long ScanSiblingIndex;
  /* 0x1698 */ unsigned __int64 CoreProcessorSet;
  /* 0x16a0 */ unsigned __int64 ScanSiblingMask;
  /* 0x16a8 */ unsigned __int64 LLCMask;
  /* 0x16b0 */ unsigned __int64 CacheProcessorMask[5];
  /* 0x16d8 */ struct _CACHE_DESCRIPTOR Cache[6];
  /* 0x1720 */ unsigned char CacheCount;
  /* 0x1721 */ unsigned char PrcbPad20[2];
  /* 0x1723 */ unsigned char ExceptionStackActive;
  /* 0x1724 */ volatile unsigned long CachedCommit;
  /* 0x1728 */ volatile unsigned long CachedResidentAvailable;
  /* 0x1730 */ void* HyperPte;
  /* 0x1738 */ void* MmInternal;
  /* 0x1740 */ unsigned __int64 GenerationTarget;
  /* 0x1748 */ unsigned __int64 PcbPad21[4];
  /* 0x1768 */ void* ExceptionStack;
  /* 0x1770 */ void* WheaInfo;
  /* 0x1778 */ void* EtwSupport;
  /* 0x1780 */ union _SLIST_HEADER HypercallPageList;
  /* 0x1790 */ void* HypercallCachedPages;
  /* 0x1798 */ void* VirtualApicAssist;
  /* 0x17a0 */ unsigned __int64* StatisticsPage;
  /* 0x1800 */ struct _SYNCH_COUNTERS SynchCounters;
  /* 0x18b8 */ unsigned __int64 PteBitCache;
  /* 0x18c0 */ unsigned long PteBitOffset;
  /* 0x18c8 */ struct _FILESYSTEM_DISK_COUNTERS FsCounters;
  /* 0x18d8 */ unsigned __int64 PanicStackBase;
  /* 0x18e0 */ void* IsrStack;
  /* 0x1900 */ struct _KTIMER_TABLE TimerTable;
  /* 0x5b80 */ struct _GENERAL_LOOKASIDE_POOL PPNxPagedLookasideList[32];
  /* 0x6780 */ struct _GENERAL_LOOKASIDE_POOL PPNPagedLookasideList[32];
  /* 0x7380 */ struct _GENERAL_LOOKASIDE_POOL PPPagedLookasideList[32];
  /* 0x7f80 */ struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;
  /* 0x7f88 */ struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;
  /* 0x7f90 */ struct _KDPC AbDpc;
  /* 0x7fd0 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x8024 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x8080 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x82f0 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x83f0 */ unsigned long TimerExpirationTraceCount;
  /* 0x8400 */ struct _KCLOCK_TIMER_STATE ClockTimerState;
  /* 0x8918 */ void* ExSaPageArray;
  /* 0x8920 */ volatile long FreezePowerOff;
  /* 0x8928 */ struct _KSTATIC_AFFINITY_BLOCK StaticAffinity;
  /* 0x8d48 */ struct _KSOFTWARE_INTERRUPT_BATCH DeferredDispatchInterrupts;
  /* 0x8e58 */ struct _KSECURE_FAULT_INFORMATION SecureFault;
  /* 0x8e68 */ unsigned __int64 CyclesByThreadType[2][5];
  /* 0x8eb8 */ unsigned long ReadyThreadCount;
  /* 0x8ec0 */ unsigned __int64 ReadyQueueExpectedRunTime;
  /* 0x8ec8 */ unsigned long DpcWatchdogProfileCumulativeDpcThresholdTicks;
  /* 0x8ecc */ unsigned long DpcWatchdogProfileSingleDpcThresholdTicks;
  /* 0x8ed0 */ void** DpcWatchdogProfile;
  /* 0x8ed8 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x8ee0 */ void* SchedulerAssist;
  /* 0x8ee8 */ struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
  /* 0x8f80 */ struct _REQUEST_MAILBOX RequestMailbox[1];
  /* 0x8fc0 */ long __PADDING__[16];
} KPRCB, *PKPRCB; /* size: 0x9000 */
...
typedef struct _KPRIORITY_STATE
{
  /* 0x0000 */ unsigned char Priority;
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0280 */ unsigned long MultiGroup : 1; /* bit position: 11 */
      /* 0x0280 */ unsigned long ReservedFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  ...
  /* 0x028c */ unsigned short ThreadSeed[32];
  /* 0x02cc */ unsigned short IdealProcessor[32];
  /* 0x030c */ unsigned short IdealNode[32];
  ...
  /* 0x03c0 */ unsigned short PrimaryGroup;
  /* 0x03c2 */ unsigned short Spare3[3];
  /* 0x03c8 */ unsigned __int64 EndPadding[5];
...
typedef struct _KSHARED_READY_QUEUE
{
  ...
  /* 0x0210 */ struct _KPRIORITY_STATE RunningSummary[64];
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x006c */ unsigned long Spare1 : 1; /* bit position: 8 */
      ...
      /* 0x006c */ unsigned long Spare2 : 1; /* bit position: 16 */
  ...
  /* 0x0428 */ unsigned __int64 Spare28[5];
  /* 0x0450 */ struct _SINGLE_LIST_ENTRY SystemAffinityTokenListHead;
  /* 0x0458 */ unsigned __int64 Spare30;
  /* 0x0460 */ unsigned __int64 EndPadding[8];
...
{
  /* 0x0000 */ unsigned long Dummy;
} MCA_EXCEPTION, *PMCA_EXCEPTION; /* size: 0x0004 */
...
} MM_DRIVER_VERIFIER_DATA, *PMM_DRIVER_VERIFIER_DATA; /* size: 0x00b0 */
...
typedef struct _PEB32
{
  ...
  /* 0x021c */ unsigned long SpareUlongs[3];
...
typedef struct _PPM_IDLE_STATES
{
  ...
  /* 0x0258 */ void* IdlePrepare /* function */;
  /* 0x0260 */ void* IdlePreExecute /* function */;
  /* 0x0268 */ void* IdleExecute /* function */;
  /* 0x0270 */ void* IdlePreselect /* function */;
  /* 0x0278 */ void* IdleTest /* function */;
  /* 0x0280 */ void* IdleAvailabilityCheck /* function */;
  /* 0x0288 */ void* IdleComplete /* function */;
  /* 0x0290 */ void* IdleCancel /* function */;
  /* 0x0298 */ void* IdleIsHalted /* function */;
  /* 0x02a0 */ void* IdleInitiateWake /* function */;
  /* 0x02a8 */ struct _PROCESSOR_IDLE_PREPARE_INFO PrepareInfo;
  /* 0x0300 */ struct _KAFFINITY_EX DeepIdleSnapshot;
  /* 0x0408 */ struct _PERFINFO_PPM_STATE_SELECTION* Tracing;
  /* 0x0410 */ struct _PERFINFO_PPM_STATE_SELECTION* CoordinatedTracing;
  /* 0x0418 */ struct _PPM_SELECTION_MENU ProcessorMenu;
  /* 0x0428 */ struct _PPM_SELECTION_MENU CoordinatedMenu;
  /* 0x0438 */ struct _PPM_COORDINATED_SELECTION CoordinatedSelection;
  /* 0x0450 */ struct _PPM_IDLE_STATE State[1];
} PPM_IDLE_STATES, *PPPM_IDLE_STATES; /* size: 0x05a8 */
...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x01a9 */ unsigned char PerformanceSchedulingClass;
  /* 0x01aa */ unsigned char EfficiencySchedulingClass;
  /* 0x01ab */ unsigned char Unused;
  /* 0x01ac */ unsigned char Parked;
  /* 0x01ad */ unsigned char LongPriorQosPeriod;
  union
  {
  ...
  /* 0x01d0 */ unsigned __int64 LastQosTranstionTsc;
...
} PROCESSOR_POWER_STATE, *PPROCESSOR_POWER_STATE; /* size: 0x01f0 */
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x0100 */ unsigned char* ReservedRegionEnd;
...
} SEGMENT_HEAP, *PSEGMENT_HEAP; /* size: 0x0840 */
...
typedef struct _TEB32
{
  ...
  /* 0x1008 */ unsigned long DelayBackoff;
