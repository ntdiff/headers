...
typedef struct _MI_NODE_INFORMATION
{
  ...
  /* 0x1800 */ struct _MI_STANDBY_LOOKASIDE StandbyPageCachePerChannel[8][4];
  /* 0x5800 */ struct _RTL_BITMAP FreePageListHeadsBitmap[2];
  /* 0x5820 */ unsigned long FreePageListHeadsBitmapBuffer[16];
  /* 0x5860 */ volatile unsigned __int64 FreeCount[2];
  /* 0x5870 */ unsigned __int64 TotalPages[4];
  /* 0x5890 */ unsigned __int64 TotalPagesEntireNode;
  /* 0x5898 */ struct _MI_PARTITION* Partition;
  /* 0x58a0 */ unsigned long CurrentHugeRangeColor;
  /* 0x58a8 */ unsigned __int64 TotalHugeIoPages;
  /* 0x58b0 */ struct _RTL_AVL_TREE HugePfnBadPages;
  /* 0x58b8 */ unsigned __int64 HugeIoRangeFreeCount[4][2];
  /* 0x58f8 */ unsigned long MmShiftedColor;
  /* 0x58fc */ unsigned long Color;
  /* 0x5900 */ volatile unsigned __int64 ChannelFreeCount[2][4];
  struct
  {
    struct /* bitfield */
    {
      /* 0x5940 */ unsigned long ChannelsHotCold : 1; /* bit position: 0 */
      /* 0x5940 */ unsigned long Spare : 31; /* bit position: 1 */
    }; /* bitfield */
  } /* size: 0x0004 */ Flags;
  /* 0x5944 */ unsigned long LargeListMoveInProgress;
  /* 0x5948 */ struct _MI_LARGE_PAGE_LISTS_CHANGING* LargeListWaiters;
  /* 0x5950 */ struct _EX_PUSH_LOCK NodeLock;
  /* 0x5958 */ unsigned __int64 ZeroThreadHugeMapLock;
  /* 0x5960 */ unsigned char ChannelStatus;
  /* 0x5961 */ unsigned char ChannelOrdering[4];
  /* 0x5965 */ unsigned char LockedChannelOrdering[4];
  /* 0x5969 */ unsigned char PowerAttribute[4];
  /* 0x5970 */ volatile long LargePageLock;
  /* 0x5974 */ struct _MI_PAGE_COLORS PageColorTable;
  /* 0x5988 */ unsigned __int64 NumberOfPagesGoingBad;
  /* 0x5990 */ void* BootZeroContext;
  /* 0x5998 */ void* ZeroingVaBase;
  /* 0x59a0 */ unsigned __int64 TotalBytesToZero;
  /* 0x59a8 */ unsigned __int64 PerProcessorNumberOfBytesToZero;
  /* 0x59b0 */ void* ZeroingContext;
  /* 0x59b8 */ volatile unsigned long ZeroingProcessorCount;
  /* 0x59bc */ volatile long ZeroHand;
  /* 0x59c0 */ volatile long FinishedProcessors;
  /* 0x59c4 */ unsigned char BackgroundZeroingActive;
  /* 0x59c5 */ unsigned char ZeroThreadsReady;
  /* 0x59c8 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* ZeroingPhysicalMemoryBlock;
  /* 0x59d0 */ struct _CACHED_KSTACK_LIST CachedKernelStacks[3];
  /* 0x5a30 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[7];
  /* 0x5ec8 */ long __PADDING__[14];
} MI_NODE_INFORMATION, *PMI_NODE_INFORMATION; /* size: 0x5f00 */
