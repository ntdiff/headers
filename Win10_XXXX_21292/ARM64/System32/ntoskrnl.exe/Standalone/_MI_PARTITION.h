...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0500 */ struct _MMPFNLIST ModifiedPageListNoReservation;
  ...
  /* 0x3480 */ unsigned __int64 AvailableEventsLock;
  ...
  /* 0x3528 */ struct _MI_FREE_LARGE_PAGE_LIST* LargePageListHeads;
  /* 0x3530 */ volatile char* MediumPagesOnFreeZeroList;
  /* 0x3538 */ struct _RTL_BITMAP_EX LargePageRebuildCandidates;
  /* 0x3548 */ volatile short* LargePagesOnFreeZeroList;
  /* 0x3550 */ volatile long HugePageRebuildCandidatesExist;
  /* 0x3558 */ struct _KEVENT LargePageCandidatesExistEvent;
  /* 0x3570 */ unsigned __int64 LowMemoryThreshold;
  /* 0x3578 */ unsigned __int64 HighMemoryThreshold;
  /* 0x3580 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x3590 */ unsigned char SlabPagesNotAvailable[7];
  /* 0x3598 */ void* HugePfnLists;
  /* 0x35a0 */ unsigned __int64 AvailableHugeIoRanges;
  /* 0x35a8 */ long __PADDING__[22];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x3600 */
...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x03d8 */ unsigned __int64 TotalCommitLimit;
  /* 0x03e0 */ unsigned __int64 TotalPagesForPagingFile;
  /* 0x03e8 */ unsigned __int64 VadPhysicalPages;
  /* 0x03f0 */ unsigned __int64 ProcessLockedFilePages;
  /* 0x03f8 */ volatile unsigned __int64 SharedCommit;
  /* 0x0400 */ unsigned __int64 SlabAllocatorPages;
  /* 0x0408 */ unsigned __int64 BootSlabPages;
  /* 0x0410 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x0420 */ volatile long PageFileTraceIndex;
  /* 0x0428 */ struct _MI_PAGEFILE_TRACES PageFileTraces[32];
  /* 0x1328 */ long __PADDING__[22];
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0a00 */ struct _MI_PARTITION_PAGE_LISTS PageLists;
  /* 0x4000 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x4040 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x40c8 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x4258 */ void* WorkingSetControl;
  /* 0x4260 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x4270 */ struct _MI_SPECIAL_PURPOSE_MEMORY_STATE SpecialPurposeMemory;
  /* 0x42a8 */ unsigned long SessionDetachTimeStamp;
  /* 0x4300 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x5680 */
