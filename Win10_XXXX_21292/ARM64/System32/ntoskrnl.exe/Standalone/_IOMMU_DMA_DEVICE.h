...
typedef struct _IOMMU_DMA_DEVICE
{
  ...
  /* 0x0030 */ struct _IOMMU_INTERFACE_CALLBACK_RECORD* InterfaceCallbackRecord;
  /* 0x0038 */ unsigned char DpptException;
  /* 0x0040 */ void* FaultHandler /* function */;
  /* 0x0048 */ void* FaultContext;
  /* 0x0050 */ struct _FAULT_INFORMATION FaultInfo;
  /* 0x0088 */ struct _KDPC FaultDpc;
  /* 0x00c8 */ struct _WORK_QUEUE_ITEM FaultWorkItem;
} IOMMU_DMA_DEVICE, *PIOMMU_DMA_DEVICE; /* size: 0x00e8 */
