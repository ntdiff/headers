...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0240 */ struct _MI_SECTION_WOW_STATE Wow[2];
  /* 0x02c0 */ unsigned __int64 ImageBiasWow;
  /* 0x02c8 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  /* 0x02d8 */ void* ApiSetSection;
  /* 0x02e0 */ void* ApiSetSchema;
  /* 0x02e8 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x02f0 */ unsigned long LostDataFiles;
  /* 0x02f4 */ unsigned long LostDataPages;
  /* 0x02f8 */ unsigned long ImageFailureReason;
  /* 0x0300 */ struct _SECTION* CfgBitMapSection;
  /* 0x0308 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0310 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x0320 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x0328 */ unsigned long ImageCfgFailure;
  /* 0x0330 */ struct _SECTION* EcBitMapSection;
  /* 0x0338 */ struct _CONTROL_AREA* EcBitMapControlArea;
  /* 0x0340 */ unsigned long ImageBreakpointEnabled;
  /* 0x0344 */ unsigned long ImageBreakpointChecksum;
  /* 0x0348 */ unsigned long ImageBreakpointSize;
  /* 0x034c */ volatile long ImageValidationFailed;
  /* 0x0350 */ struct _RTL_AVL_TREE ExtentTree[2];
  /* 0x0360 */ struct _EX_PUSH_LOCK ExtentTreeLock;
  /* 0x0368 */ struct _EX_PUSH_LOCK ExtentForwardProgressMappingLock;
  /* 0x0370 */ unsigned long HotPatchReserveSize;
...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x11a4 */ unsigned char GlobalBitPolarity[2];
  /* 0x11a6 */ char __PADDING__[90];
} MI_HARDWARE_STATE, *PMI_HARDWARE_STATE; /* size: 0x1200 */
...
typedef struct _MI_PARTITION_STATE
{
  ...
  /* 0x0a88 */ long __PADDING__[30];
} MI_PARTITION_STATE, *PMI_PARTITION_STATE; /* size: 0x0b00 */
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x0120 */ struct _MI_SYSTEM_PTE_TYPE KernelStackPteInfo;
  /* 0x0180 */ struct _MI_SYSTEM_PTE_TYPE KernelShadowStackPteInfo;
  /* 0x01e0 */ unsigned long StackGrowthFailures;
  /* 0x01e4 */ unsigned char KernelStackPages;
  /* 0x01e5 */ unsigned char TrackPtesAborted;
  /* 0x01e6 */ unsigned char AdjustCounter;
  /* 0x01e8 */ volatile long ReservedMappingLock;
  /* 0x01f0 */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x01f8 */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x0200 */ struct _RTL_AVL_TREE OutswappedKernelStackRoot;
  /* 0x0208 */ volatile long OutswappedKernelStackLock;
  /* 0x0210 */ struct _MMPTE* BreakMakePte;
  /* 0x0218 */ struct _MI_ULTRA_VA_CONTEXT UltraSpaceContext;
  /* 0x0258 */ unsigned long NumberOfUltraMdlMaps;
  /* 0x0260 */ struct _MI_ULTRA_MDL_NODE* UltraMdlNodeMappings;
...
} MI_HOT_PATCH_STATE, *PMI_HOT_PATCH_STATE; /* size: 0x0040 */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x00c0 */ volatile unsigned __int64 ContiguousPagesAllocated;
  /* 0x00c8 */ volatile unsigned __int64 SystemPageTableCommit;
  /* 0x00d0 */ volatile unsigned __int64 ProcessCommit;
  /* 0x00d8 */ volatile long DriverCommit;
  /* 0x00dc */ unsigned char PagingLevels;
  /* 0x00e0 */ volatile unsigned __int64 PfnDatabaseCommit;
  ...
  /* 0x0f48 */ unsigned __int64 SystemVaTypeCount[17];
  /* 0x0fd0 */ unsigned char SystemVaType[256];
  /* 0x10d0 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[14];
  /* 0x11b0 */ long __PADDING__[20];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x2800 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x2d00 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x2d20 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x2e00 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x3900 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x3978 */ struct _MI_ERROR_STATE Errors;
  /* 0x3a80 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x3b80 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x3ca0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x3e80 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x4100 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x4200 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x42b0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x4380 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x4400 */ struct _MI_SYSTEM_ZEROING Zeroing;
  /* 0x4420 */ struct _MI_HOT_PATCH_STATE HotPatch;
  /* 0x4460 */ unsigned __int64 Cookie;
  /* 0x4468 */ void* volatile* BootRegistryRuns;
  /* 0x4470 */ volatile long ZeroingDisabled;
  /* 0x4474 */ unsigned char FullyInitialized;
  /* 0x4475 */ unsigned char SafeBooted;
  /* 0x4478 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x4480 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x5680 */
