...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x0200 */ enum _HALP_DMA_TRANSLATION_TYPE TranslationType;
  /* 0x0204 */ unsigned char AdapterInUse;
  /* 0x0208 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0210 */ struct _EXT_IOMMU_DEVICE_ID* DeviceId;
  /* 0x0218 */ struct _IOMMU_DMA_DEVICE* IommuDevice;
  /* 0x0220 */ struct _MDL* ScatterGatherMdl;
  /* 0x0228 */ struct _IOMMU_DMA_LOGICAL_ADDRESS_TOKEN* LowMemoryLogicalAddressToken;
