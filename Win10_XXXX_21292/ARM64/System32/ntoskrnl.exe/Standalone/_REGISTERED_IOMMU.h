...
typedef struct _REGISTERED_IOMMU
{
  ...
  /* 0x0188 */ struct _LIST_ENTRY PasidTableListHead;
  /* 0x0198 */ struct _IOMMU_PAGE_HANDLING_DATA PageHandling;
  /* 0x01c0 */ unsigned long MaximumDomainIds;
  /* 0x01c8 */ unsigned __int64 DomainIdBitmapLock;
  /* 0x01d0 */ struct _RTL_BITMAP DomainIdBitmap;
  /* 0x01e0 */ unsigned long Capabilities;
  /* 0x01e4 */ enum _EXT_IOMMU_KNOWN_IOMMU_TYPE KnownType;
  /* 0x01e8 */ unsigned long PciSegment;
  /* 0x01ec */ unsigned long PciBus;
  /* 0x01f0 */ struct _PCI_SLOT_NUMBER PciSlot;
  /* 0x01f8 */ union _LARGE_INTEGER MsiAddress;
  /* 0x0200 */ unsigned __int64 MsiData;
  /* 0x0208 */ unsigned long MaximumAsids;
  /* 0x020c */ unsigned long FaultPacketBytes;
  /* 0x0210 */ unsigned long Identifier;
