...
typedef struct _CMHIVE
{
  ...
  /* 0x0b88 */ struct _CM_WORKITEM* UnloadWorkItem;
  /* 0x0b90 */ struct _CM_WORKITEM UnloadWorkItemHolder;
  /* 0x0bb8 */ struct _CM_DIRTY_VECTOR_LOG DirtyVectorLog;
  /* 0x1040 */ unsigned long Flags;
  /* 0x1048 */ struct _LIST_ENTRY TrustClassEntry;
  /* 0x1058 */ unsigned __int64 DirtyTime;
  /* 0x1060 */ unsigned __int64 UnreconciledTime;
  /* 0x1068 */ struct _CM_RM* CmRm;
  /* 0x1070 */ unsigned long CmRmInitFailPoint;
  /* 0x1074 */ long CmRmInitFailStatus;
  /* 0x1078 */ struct _KTHREAD* CreatorOwner;
  /* 0x1080 */ struct _KTHREAD* RundownThread;
  /* 0x1088 */ union _LARGE_INTEGER LastWriteTime;
  /* 0x1090 */ struct _HIVE_WRITE_WAIT_QUEUE FlushQueue;
  /* 0x10a0 */ struct _HIVE_WRITE_WAIT_QUEUE ReconcileQueue;
  union
  {
    /* 0x10b0 */ unsigned long FlushFlags;
    struct /* bitfield */
    {
      /* 0x10b0 */ unsigned long PrimaryFilePurged : 1; /* bit position: 0 */
      /* 0x10b0 */ unsigned long DiskFileBad : 1; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x10b4 */ unsigned long PrimaryFileSizeBeforeLastFlush;
  /* 0x10b8 */ volatile long ReferenceCount;
  /* 0x10bc */ long UnloadHistoryIndex;
  /* 0x10c0 */ unsigned long UnloadHistory[128];
  /* 0x12c0 */ unsigned long BootStart;
  /* 0x12c4 */ unsigned long UnaccessedStart;
  /* 0x12c8 */ unsigned long UnaccessedEnd;
  /* 0x12cc */ unsigned long LoadedKeyCount;
  /* 0x12d0 */ volatile unsigned long HandleClosePending;
  /* 0x12d8 */ struct _EX_PUSH_LOCK HandleClosePendingEvent;
  /* 0x12e0 */ unsigned char FinalFlushSucceeded;
  /* 0x12e8 */ struct _CMP_VOLUME_CONTEXT* VolumeContext;
} CMHIVE, *PCMHIVE; /* size: 0x12f0 */
