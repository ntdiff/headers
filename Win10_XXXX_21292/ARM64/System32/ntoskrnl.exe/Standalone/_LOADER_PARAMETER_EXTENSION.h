...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0084 */ unsigned long Unused : 3; /* bit position: 18 */
  ...
  /* 0x0b30 */ void* BootOptions;
  /* 0x0b38 */ unsigned long IumEnablement;
  /* 0x0b3c */ unsigned long IumPolicy;
  /* 0x0b40 */ long IumStatus;
  /* 0x0b44 */ unsigned long BootId;
  /* 0x0b48 */ struct _LOADER_PARAMETER_CI_EXTENSION* CodeIntegrityData;
  /* 0x0b50 */ unsigned long CodeIntegrityDataSize;
  /* 0x0b54 */ struct _LOADER_HIVE_RECOVERY_INFO SystemHiveRecoveryInfo;
  /* 0x0b68 */ unsigned long SoftRestartCount;
  /* 0x0b70 */ __int64 SoftRestartTime;
  /* 0x0b78 */ void* HalVirtualAddress;
  /* 0x0b80 */ unsigned __int64 HalNumberOfBytes;
  /* 0x0b88 */ struct _LEAP_SECOND_DATA* LeapSecondData;
  /* 0x0b90 */ unsigned long MajorRelease;
  /* 0x0b94 */ unsigned long Reserved1;
  /* 0x0b98 */ char NtBuildLab[224];
  /* 0x0c78 */ char NtBuildLabEx[224];
  /* 0x0d58 */ struct _LOADER_RESET_REASON ResetReason;
  /* 0x0d88 */ unsigned long MaxPciBusNumber;
  /* 0x0d8c */ unsigned long FeatureSettings;
  /* 0x0d90 */ unsigned long HotPatchReserveSize;
  /* 0x0d94 */ unsigned long RetpolineReserveSize;
  /* 0x0d98 */ struct _VSM_PERFORMANCE_DATA VsmPerformanceData;
  /* 0x0dd8 */ struct _NUMA_MEMORY_RANGE* NumaMemoryRanges;
  /* 0x0de0 */ unsigned long NumaMemoryRangeCount;
  /* 0x0de4 */ unsigned long IommuFaultPolicy;
  /* 0x0de8 */ struct _LOADER_FEATURE_CONFIGURATION_INFORMATION FeatureConfigurationInformation;
  /* 0x0e30 */ struct _ETW_BOOT_CONFIG EtwBootConfig;
  /* 0x0e48 */ struct _BOOT_FIRMWARE_RAMDISK_INFO* FwRamdiskInfo;
  /* 0x0e50 */ void* IpmiHwContext;
  /* 0x0e58 */ unsigned __int64 PointerAuthKernelIpKey[2];
  /* 0x0e68 */ union _LARGE_INTEGER Luid;
  struct
  {
    /* 0x0e70 */ struct _INSTALLED_MEMORY_RANGE* Ranges;
    /* 0x0e78 */ unsigned long RangeCount;
    /* 0x0e7c */ long __PADDING__[1];
  } /* size: 0x0010 */ InstalledMemory;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0e80 */
