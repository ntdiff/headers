...
typedef struct _ETW_STACK_TRACE_BLOCK
{
  ...
  /* 0x0050 */ unsigned __int64 ApcSpinLock;
  /* 0x0060 */ union _SLIST_HEADER ApcFreeListHead;
  /* 0x0070 */ union _SLIST_HEADER ApcGlobalListHead;
  /* 0x0080 */ long ApcCount;
  /* 0x0084 */ unsigned long MaxApcCount;
  /* 0x0088 */ long Flags;
  /* 0x008c */ long OutstandingApcCount;
  /* 0x0090 */ long MaxOutstandingApcCount;
  /* 0x0094 */ long __PADDING__[3];
} ETW_STACK_TRACE_BLOCK, *PETW_STACK_TRACE_BLOCK; /* size: 0x00a0 */
...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  union
  {
    /* 0x0344 */ unsigned long Flags2;
    /* 0x0344 */ unsigned long UnifiedStackCaching : 1; /* bit position: 0 */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0348 */ volatile unsigned long RequestFlag;
    struct /* bitfield */
    {
      /* 0x0348 */ unsigned long DbgRequestNewFile : 1; /* bit position: 0 */
      /* 0x0348 */ unsigned long DbgRequestUpdateFile : 1; /* bit position: 1 */
      /* 0x0348 */ unsigned long DbgRequestFlush : 1; /* bit position: 2 */
      /* 0x0348 */ unsigned long DbgRequestDisableRealtime : 1; /* bit position: 3 */
      /* 0x0348 */ unsigned long DbgRequestDisconnectConsumer : 1; /* bit position: 4 */
      /* 0x0348 */ unsigned long DbgRequestConnectConsumer : 1; /* bit position: 5 */
      /* 0x0348 */ unsigned long DbgRequestNotifyConsumer : 1; /* bit position: 6 */
      /* 0x0348 */ unsigned long DbgRequestUpdateHeader : 1; /* bit position: 7 */
      /* 0x0348 */ unsigned long DbgRequestDeferredFlush : 1; /* bit position: 8 */
      /* 0x0348 */ unsigned long DbgRequestDeferredFlushTimer : 1; /* bit position: 9 */
      /* 0x0348 */ unsigned long DbgRequestFlushTimer : 1; /* bit position: 10 */
      /* 0x0348 */ unsigned long DbgRequestUpdateDebugger : 1; /* bit position: 11 */
      /* 0x0348 */ unsigned long DbgSpareRequestFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0350 */ struct _ETW_STACK_TRACE_BLOCK StackTraceBlock;
  /* 0x03f0 */ struct _RTL_BITMAP HookIdMap;
  /* 0x0400 */ struct _ETW_STACK_CACHE* StackCache;
  /* 0x0408 */ struct _ETW_PMC_SUPPORT* PmcData;
  /* 0x0410 */ struct _ETW_LBR_SUPPORT* LbrData;
  /* 0x0418 */ struct _ETW_IPT_SUPPORT* IptData;
  /* 0x0420 */ struct _LIST_ENTRY BinaryTrackingList;
  /* 0x0430 */ struct _WMI_BUFFER_HEADER** ScratchArray;
  /* 0x0438 */ struct _DISALLOWED_GUIDS DisallowedGuids;
  /* 0x0448 */ __int64 RelativeTimerDueTime;
  /* 0x0450 */ struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;
  /* 0x0460 */ struct _EX_TIMER* PeriodicCaptureStateTimer;
  /* 0x0468 */ enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;
  /* 0x0470 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x0478 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x0480 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x04a0 */ long CompressionWorkItemState;
  /* 0x04a8 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x04b0 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x04b8 */ void* CompressionWorkspace;
  /* 0x04c0 */ long CompressionOn;
  /* 0x04c4 */ unsigned long CompressionRatioGuess;
  /* 0x04c8 */ unsigned long PartialBufferCompressionLevel;
  /* 0x04cc */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x04d0 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x04d8 */ struct _KDPC CompressionDpc;
  /* 0x0518 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0520 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0528 */ union _LARGE_INTEGER BufferCompressDuration;
  /* 0x0530 */ __int64 ReferenceQpcDelta;
  /* 0x0538 */ struct _ETW_EVENT_CALLBACK_CONTEXT* CallbackContext;
  /* 0x0540 */ union _LARGE_INTEGER* LastDroppedTime;
  /* 0x0548 */ union _LARGE_INTEGER* FlushingLastDroppedTime;
  /* 0x0550 */ __int64 FlushingSequenceNumber;
  /* 0x0558 */ struct _ETW_PARTITION_CONTEXT PartitionContext;
  /* 0x0560 */ struct _MDL* BufferMdl;
  /* 0x0568 */ long __PADDING__[2];
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0570 */
