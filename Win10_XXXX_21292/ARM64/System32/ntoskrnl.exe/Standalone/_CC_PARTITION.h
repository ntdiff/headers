...
typedef struct _CC_PARTITION
{
  ...
  /* 0x0360 */ struct _KEVENT PeriodicEvent;
  /* 0x0378 */ struct _KEVENT WaitingForTeardownEvent;
  /* 0x0390 */ struct _KEVENT CoalescingFlushEvent;
  /* 0x03a8 */ unsigned long PagesYetToWrite;
  /* 0x03b0 */ struct _LAZY_WRITER LazyWriter;
  /* 0x0438 */ struct _DIRTY_PAGE_STATISTICS DirtyPageStatistics;
  /* 0x0450 */ struct _DIRTY_PAGE_THRESHOLDS DirtyPageThresholds;
  /* 0x0488 */ struct _WRITE_BEHIND_THROUGHPUT* ThroughputStats;
  /* 0x0490 */ unsigned __int64 AverageAvailablePages;
  /* 0x0498 */ unsigned __int64 AverageDirtyPages;
  /* 0x04a0 */ unsigned __int64 PagesSkippedDueToHotSpot;
  /* 0x04a8 */ struct _LIST_ENTRY DeferredWrites;
  ...
  /* 0x0590 */ long __PADDING__[28];
} CC_PARTITION, *PCC_PARTITION; /* size: 0x0600 */
