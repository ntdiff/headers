...
typedef struct _NDIS_MINIPORT_OFFLOAD
{
  ...
  /* 0x0498 */ void* MiniportRequestBuffer;
  /* 0x04a0 */ unsigned long MiniportRequestOid;
  /* 0x04a4 */ unsigned long MiniportRequestBufferLength;
} NDIS_MINIPORT_OFFLOAD, *PNDIS_MINIPORT_OFFLOAD; /* size: 0x04a8 */
