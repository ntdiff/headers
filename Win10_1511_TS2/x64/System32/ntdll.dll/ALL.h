...
typedef struct _KPRCB
{
  ...
  /* 0x6864 */ long Padding_76;
  /* 0x6868 */ void* ExSaPageArray;
  /* 0x6870 */ long Padding_77[4];
  /* 0x6880 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x6888 */ long Padding_78[14];
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x06c0 */ unsigned long StoreLockThread : 1; /* bit position: 2 */
      /* 0x06c0 */ unsigned long ClonedThread : 1; /* bit position: 3 */
      /* 0x06c0 */ unsigned long KeyedEventInUse : 1; /* bit position: 4 */
      /* 0x06c0 */ unsigned long SelfTerminate : 1; /* bit position: 5 */
      /* 0x06c0 */ unsigned long RespectIoPriority : 1; /* bit position: 6 */
      /* 0x06c0 */ unsigned long ReservedSameThreadPassiveFlags : 25; /* bit position: 7 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
...
typedef struct _EJOB
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0510 */ unsigned long DisallowNewProcesses : 1; /* bit position: 29 */
...
typedef struct _HEAP_LFH_CONTEXT
{
  ...
  /* 0x0039 */ char Padding_201[7];
  /* 0x0040 */ const unsigned char* AffinityModArray;
  /* 0x0048 */ long Padding_202[2];
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x016a */ char Padding_205[6];
  /* 0x0170 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x0208 */ long Padding_206[2];
