...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x0068 */ unsigned char HeteroDecreaseThreshold[640];
  /* 0x02e8 */ unsigned char HeteroIncreaseThreshold[640];
  /* 0x0568 */ unsigned char Class0FloorPerformance;
  /* 0x0569 */ unsigned char Class1InitialPerformance;
  /* 0x056a */ char __PADDING__[6];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x0570 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x0b08 */ unsigned __int64 StartTime;
  /* 0x0b10 */ unsigned __int64 Count;
  /* 0x0b18 */ unsigned __int64 MaxDuration;
  /* 0x0b20 */ unsigned __int64 MinDuration;
  /* 0x0b28 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x0b30 */
