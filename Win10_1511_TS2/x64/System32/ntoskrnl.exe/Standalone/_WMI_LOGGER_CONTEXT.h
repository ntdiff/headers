...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0340 */ unsigned long SpareFlags1 : 1; /* bit position: 15 */
  ...
  /* 0x0348 */ struct _RTL_BITMAP HookIdMap;
  /* 0x0358 */ struct _ETW_STACK_CACHE* StackCache;
  /* 0x0360 */ struct _ETW_PMC_SUPPORT* PmcData;
  /* 0x0368 */ struct _LIST_ENTRY WinRtProviderBinaryList;
  /* 0x0378 */ struct _WMI_BUFFER_HEADER** ScratchArray;
  /* 0x0380 */ struct _DISALLOWED_GUIDS DisallowedGuids;
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0390 */
