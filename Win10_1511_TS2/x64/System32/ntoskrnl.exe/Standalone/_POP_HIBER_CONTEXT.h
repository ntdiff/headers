...
typedef struct _POP_HIBER_CONTEXT
{
  ...
  /* 0x00e0 */ unsigned long SiLogOffset;
  /* 0x00e8 */ struct _MDL* FirmwareRuntimeInformationMdl;
  /* 0x00f0 */ void* FirmwareRuntimeInformationVa;
  /* 0x00f8 */ void* ResumeContext;
  /* 0x0100 */ unsigned long ResumeContextPages;
  /* 0x0104 */ unsigned long SecurePages;
  /* 0x0108 */ unsigned long ProcessorCount;
  /* 0x0110 */ struct _POP_PER_PROCESSOR_CONTEXT* ProcessorContext;
  /* 0x0118 */ char* ProdConsBuffer;
  /* 0x0120 */ unsigned long ProdConsSize;
  /* 0x0124 */ unsigned long MaxDataPages;
  /* 0x0128 */ void* ExtraBuffer;
  /* 0x0130 */ unsigned __int64 ExtraBufferSize;
  /* 0x0138 */ void* ExtraMapVa;
  /* 0x0140 */ unsigned __int64 BitlockerKeyPFN;
  /* 0x0148 */ struct _POP_IO_INFO IoInfo;
  /* 0x01b8 */ unsigned short* IoChecksums;
  /* 0x01c0 */ unsigned __int64 IoChecksumsSize;
  /* 0x01c8 */ unsigned long HardwareConfigurationSignature;
  /* 0x01cc */ unsigned char IumEnabled;
  /* 0x01cd */ char __PADDING__[3];
} POP_HIBER_CONTEXT, *PPOP_HIBER_CONTEXT; /* size: 0x01d0 */
