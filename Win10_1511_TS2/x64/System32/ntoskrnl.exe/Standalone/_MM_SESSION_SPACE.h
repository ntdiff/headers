...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0b98 */ struct _MMSUPPORT Vm;
  /* 0x0c90 */ struct _MMWSLE* Wsle;
  /* 0x0c98 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0cc0 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x1e00 */ struct _MMPTE PageDirectory;
  /* 0x1e08 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x1e10 */ struct _RTL_BITMAP DynamicVaBitMap;
  /* 0x1e20 */ unsigned long DynamicVaHint;
  /* 0x1e28 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x1e78 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x1e80 */ long PoolBigEntriesInUse;
  /* 0x1e84 */ unsigned long PagedPoolPdeCount;
  /* 0x1e88 */ unsigned long SpecialPoolPdeCount;
  /* 0x1e8c */ unsigned long DynamicSessionPdeCount;
  /* 0x1e90 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1ef0 */ void* PoolTrackTableExpansion;
  /* 0x1ef8 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x1f00 */ void* PoolTrackBigPages;
  /* 0x1f08 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x1f10 */ enum _IO_SESSION_STATE IoState;
  /* 0x1f14 */ unsigned long IoStateSequence;
  /* 0x1f18 */ struct _KEVENT IoNotificationEvent;
  /* 0x1f30 */ struct _EJOB* ServerSilo;
  /* 0x1f38 */ unsigned __int64 CreateTime;
} MM_SESSION_SPACE, *PMM_SESSION_SPACE; /* size: 0x1f40 */
