...
typedef struct _ETW_SILODRIVERSTATE
{
  ...
  /* 0x0190 */ struct _EX_RUNDOWN_REF_CACHE_AWARE* EtwpLoggerRundown[64];
  /* 0x0390 */ struct _WMI_LOGGER_CONTEXT* WmipLoggerContext[64];
  /* 0x0590 */ struct _ETW_HASH_BUCKET EtwpGuidHashTable[64];
  /* 0x1390 */ unsigned short EtwpSecurityLoggers[8];
  /* 0x13a0 */ unsigned char EtwpSecurityProviderEnableMask;
  /* 0x13a1 */ unsigned char EtwpShutdownInProgress;
  /* 0x13a4 */ unsigned long EtwpSecurityProviderPID;
} ETW_SILODRIVERSTATE, *PETW_SILODRIVERSTATE; /* size: 0x13a8 */
