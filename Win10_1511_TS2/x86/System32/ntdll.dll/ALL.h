...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x03cc */ unsigned long StoreLockThread : 1; /* bit position: 2 */
      /* 0x03cc */ unsigned long ClonedThread : 1; /* bit position: 3 */
      /* 0x03cc */ unsigned long KeyedEventInUse : 1; /* bit position: 4 */
      /* 0x03cc */ unsigned long SelfTerminate : 1; /* bit position: 5 */
      /* 0x03cc */ unsigned long RespectIoPriority : 1; /* bit position: 6 */
      /* 0x03cc */ unsigned long ReservedSameThreadPassiveFlags : 25; /* bit position: 7 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
...
typedef struct _MMSUPPORT
{
  ...
  /* 0x006c */ unsigned long Reserved0;
...
typedef struct _EPROCESS
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x02e0 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 11 */
      /* 0x02e0 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 12 */
      /* 0x02e0 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 13 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  ...
  /* 0x0328 */ unsigned __int64 SequenceNumber;
  /* 0x0330 */ unsigned __int64 CreateInterruptTime;
  /* 0x0338 */ unsigned __int64 CreateUnbiasedInterruptTime;
  /* 0x0340 */ unsigned __int64 TotalUnbiasedFrozenTime;
  /* 0x0348 */ unsigned __int64 LastAppStateUpdateTime;
  struct /* bitfield */
  {
    /* 0x0350 */ unsigned __int64 LastAppStateUptime : 61; /* bit position: 0 */
    /* 0x0350 */ unsigned __int64 LastAppState : 3; /* bit position: 61 */
  }; /* bitfield */
  /* 0x0358 */ volatile unsigned long SharedCommitCharge;
  /* 0x035c */ struct _EX_PUSH_LOCK SharedCommitLock;
  /* 0x0360 */ struct _LIST_ENTRY SharedCommitLinks;
  union
  {
    struct
    {
      /* 0x0368 */ unsigned long AllowedCpuSets;
      /* 0x036c */ unsigned long DefaultCpuSets;
    }; /* size: 0x0008 */
    struct
    {
      /* 0x0368 */ unsigned long* AllowedCpuSetsIndirect;
      /* 0x036c */ unsigned long* DefaultCpuSetsIndirect;
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
} EPROCESS, *PEPROCESS; /* size: 0x0370 */
...
typedef struct _EJOB
{
  ...
  /* 0x02d0 */ struct _SILO_CONTEXT* Container;
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x02e8 */ unsigned long DisallowNewProcesses : 1; /* bit position: 29 */
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x004c */ struct _RTL_SRWLOCK ContextExtendLock;
  /* 0x0050 */ unsigned char* AllocatedBase;
  /* 0x0054 */ unsigned char* UncommittedBase;
  /* 0x0058 */ unsigned char* ReservedLimit;
  /* 0x005c */ struct _HEAP_VS_CONTEXT VsContext;
  /* 0x0090 */ struct _HEAP_LFH_CONTEXT LfhContext;
} SEGMENT_HEAP, *PSEGMENT_HEAP; /* size: 0x02f8 */
...
_LdrpHandleProtectedDelayload@20
_LdrpHandleReplacedModule@4
_LdrpHandleTlsData@4
_LdrpHandleUnprotectedDelayLoad@20
...
_LdrpWriteBackProtectedDelayLoad@16
...
_RtlpHpLfhBucketComputeNewSubsegmentBlockCount@4
