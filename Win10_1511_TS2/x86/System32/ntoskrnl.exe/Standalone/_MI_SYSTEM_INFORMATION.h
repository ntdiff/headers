...
typedef struct _SUBSECTION
{
  ...
  union
  {
    ...
    /* 0x000c */ struct _MI_SUBSECTION_WAIT_BLOCK* CreationWaitList;
...
typedef struct _MI_SYSTEM_IMAGE_STATE
{
  ...
  /* 0x0064 */ struct _MMPTE* ErrataPte;
  /* 0x0068 */ unsigned long ErrataPteMapped;
...
typedef struct _MI_RESAVAIL_TRACKER
{
  ...
  /* 0x010c */ unsigned long AllocateHotRemove;
  /* 0x0110 */ unsigned long FreeHotAdd;
  /* 0x0114 */ unsigned long AllocateBoot;
  /* 0x0118 */ unsigned long FreeLoaderBlock;
  /* 0x011c */ unsigned long AllocateNonPagedSpecialPool;
  /* 0x0120 */ unsigned long FreeNonPagedSpecialPoolError;
  /* 0x0124 */ unsigned long FreeNonPagedSpecialPool;
  /* 0x0128 */ unsigned long AllocateSharedSegmentPage;
  /* 0x012c */ unsigned long FreeSharedSegmentPage;
  /* 0x0130 */ unsigned long AllocateZeroPage;
  /* 0x0134 */ unsigned long FreeZeroPage;
  /* 0x0138 */ unsigned long AllocateForPo;
  /* 0x013c */ unsigned long AllocateForPoForce;
  /* 0x0140 */ unsigned long FreeForPo;
  /* 0x0144 */ unsigned long AllocateThreadHardFaultBehavior;
  /* 0x0148 */ unsigned long FreeThreadHardFaultBehavior;
  /* 0x014c */ unsigned long ObtainFaultCharges;
  /* 0x0150 */ unsigned long FreeFaultCharges;
  /* 0x0154 */ unsigned long AllocateStoreCharges;
  /* 0x0158 */ unsigned long FreeStoreCharges;
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0284 */ unsigned long PagefileHashPages;
  /* 0x0288 */ struct _SYSPTES_HEADER PteHeader;
  /* 0x0314 */ struct _MI_SPECIAL_POOL* SessionSpecialPool;
  /* 0x0318 */ unsigned long SystemVaTypeCount[15];
  /* 0x0354 */ unsigned char SystemVaType[1024];
  /* 0x0754 */ unsigned long SystemVaTypeCountFailures[15];
  /* 0x0790 */ unsigned long SystemVaTypeCountLimit[15];
  /* 0x07cc */ unsigned long SystemVaTypeCountPeak[15];
  /* 0x0808 */ unsigned long SystemAvailableVa;
  /* 0x080c */ long __PADDING__[13];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x2d10 */ struct _MI_SHUTDOWN_STATE Shutdowns;
