...
{
  /* 0x0000 */ struct _ETW_GUID_ENTRY EtwpSecurityProviderGuidEntry;
  /* 0x0168 */ struct _EX_RUNDOWN_REF_CACHE_AWARE* EtwpLoggerRundown[64];
  /* 0x0268 */ struct _WMI_LOGGER_CONTEXT* WmipLoggerContext[64];
  /* 0x0368 */ struct _ETW_HASH_BUCKET EtwpGuidHashTable[64];
  /* 0x0a68 */ unsigned short EtwpSecurityLoggers[8];
  /* 0x0a78 */ unsigned char EtwpSecurityProviderEnableMask;
  /* 0x0a79 */ unsigned char EtwpShutdownInProgress;
  /* 0x0a7c */ unsigned long EtwpSecurityProviderPID;
} ETW_SILODRIVERSTATE, *PETW_SILODRIVERSTATE; /* size: 0x0a80 */
