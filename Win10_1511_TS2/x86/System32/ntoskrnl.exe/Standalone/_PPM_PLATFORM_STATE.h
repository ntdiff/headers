...
typedef struct _PPM_PLATFORM_STATE
{
  ...
  /* 0x0020 */ unsigned char TransitionDebugger;
  /* 0x0021 */ unsigned char Platform;
  /* 0x0024 */ unsigned long DependencyListCount;
  /* 0x0028 */ struct _KAFFINITY_EX Processors;
  /* 0x0034 */ struct _UNICODE_STRING Name;
  /* 0x003c */ struct _PPM_SELECTION_DEPENDENCY* DependencyLists;
  /* 0x0040 */ volatile union _PPM_COORDINATED_SYNCHRONIZATION Synchronization;
  /* 0x0048 */ volatile unsigned __int64 EnterTime;
  union
  {
