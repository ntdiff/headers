...
typedef struct _MI_PARTITION_CORE
{
  ...
  /* 0x0024 */ unsigned long MemoryBlockReferences;
  /* 0x0028 */ struct _WORK_QUEUE_ITEM PfnUnmapWorkItem;
  /* 0x0038 */ unsigned char PfnUnmapActive;
  /* 0x003c */ unsigned long PfnUnmapCount;
  /* 0x0040 */ void* PfnUnmapWaitList;
  /* 0x0044 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* MemoryRuns;
  /* 0x0048 */ struct _KEVENT ExitEvent;
  /* 0x0058 */ void* SystemThreadHandles[5];
  /* 0x006c */ void* PartitionObject;
  /* 0x0070 */ void* PartitionObjectHandle;
  /* 0x0074 */ struct _EX_PUSH_LOCK DynamicMemoryPushLock;
  /* 0x0078 */ volatile long DynamicMemoryLock;
  /* 0x007c */ struct _KEVENT TemporaryMemoryEvent;
  /* 0x008c */ struct _KEVENT* MemoryEvents[11];
} MI_PARTITION_CORE, *PMI_PARTITION_CORE; /* size: 0x00b8 */
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0709 */ unsigned char RebuildLargePagesInitialized;
  /* 0x070c */ struct _MI_REBUILD_LARGE_PAGES RebuildLargePagesItem;
  /* 0x0740 */ void* MirrorListLocks;
...
typedef struct _MI_PARTITION_ZEROING
{
  ...
  /* 0x002c */ volatile long ThreadCount;
  /* 0x0030 */ struct _KGATE Gate;
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x00b8 */ struct _MI_PARTITION_MODWRITES Modwriter;
  /* 0x0288 */ struct _MI_PARTITION_STORES Store;
...
} MI_PARTITION, *PMI_PARTITION; /* size: 0x18c0 */
