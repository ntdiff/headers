...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0908 */ struct _RTL_BITMAP SlabPfnBitMap;
  /* 0x0910 */ long __PADDING__[12];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x0940 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0e80 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x0f00 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x0f40 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1018 */ void* WorkingSetControl;
  /* 0x101c */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1024 */ unsigned long SessionDetachTimeStamp;
  /* 0x1040 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x1c40 */
