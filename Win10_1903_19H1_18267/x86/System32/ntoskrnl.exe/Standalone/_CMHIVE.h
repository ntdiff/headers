...
typedef struct _CMHIVE
{
  ...
  /* 0x0458 */ unsigned char* FlushLogEntry;
  /* 0x045c */ unsigned long FlushLogEntrySize;
  /* 0x0460 */ unsigned long FlushHiveTruncated;
  /* 0x0464 */ unsigned char FlushBaseBlockDirty;
  /* 0x0468 */ struct _RTL_BITMAP CapturedUnreconciledVector;
  /* 0x0470 */ unsigned long CapturedUnreconciledVectorSize;
  /* 0x0474 */ struct CMP_OFFSET_ARRAY* UnreconciledOffsetArray;
  /* 0x0478 */ unsigned long UnreconciledOffsetArrayCount;
  /* 0x047c */ struct _HBASE_BLOCK* UnreconciledBaseBlock;
  /* 0x0480 */ struct _EX_PUSH_LOCK SecurityLock;
  /* 0x0484 */ unsigned long LastShrinkHiveSize;
  /* 0x0488 */ union _LARGE_INTEGER ActualFileSize;
  /* 0x0490 */ union _LARGE_INTEGER LogFileSizes[2];
  /* 0x04a0 */ struct _UNICODE_STRING FileFullPath;
  /* 0x04a8 */ struct _UNICODE_STRING FileUserName;
  /* 0x04b0 */ struct _UNICODE_STRING HiveRootPath;
  /* 0x04b8 */ unsigned long SecurityCount;
  /* 0x04bc */ unsigned long SecurityCacheSize;
  /* 0x04c0 */ long SecurityHitHint;
  /* 0x04c4 */ struct _CM_KEY_SECURITY_CACHE_ENTRY* SecurityCache;
  /* 0x04c8 */ struct _LIST_ENTRY SecurityHash[64];
  /* 0x06c8 */ unsigned long UnloadEventCount;
  /* 0x06cc */ struct _KEVENT** UnloadEventArray;
  /* 0x06d0 */ struct _CM_KEY_CONTROL_BLOCK* RootKcb;
  /* 0x06d4 */ unsigned char Frozen;
  /* 0x06d8 */ struct _CM_WORKITEM* UnloadWorkItem;
  /* 0x06dc */ struct _CM_WORKITEM UnloadWorkItemHolder;
  /* 0x06f0 */ struct _CM_DIRTY_VECTOR_LOG DirtyVectorLog;
  /* 0x0978 */ unsigned long Flags;
  /* 0x097c */ struct _LIST_ENTRY TrustClassEntry;
  /* 0x0988 */ unsigned __int64 DirtyTime;
  /* 0x0990 */ unsigned __int64 UnreconciledTime;
  /* 0x0998 */ struct _CM_RM* CmRm;
  /* 0x099c */ unsigned long CmRmInitFailPoint;
  /* 0x09a0 */ long CmRmInitFailStatus;
  /* 0x09a4 */ struct _KTHREAD* CreatorOwner;
  /* 0x09a8 */ struct _KTHREAD* RundownThread;
  /* 0x09b0 */ union _LARGE_INTEGER LastWriteTime;
  /* 0x09b8 */ struct _HIVE_WRITE_WAIT_QUEUE FlushQueue;
  /* 0x09c0 */ struct _HIVE_WRITE_WAIT_QUEUE ReconcileQueue;
  union
  {
    /* 0x09c8 */ unsigned long FlushFlags;
    struct /* bitfield */
    {
      /* 0x09c8 */ unsigned long PrimaryFilePurged : 1; /* bit position: 0 */
      /* 0x09c8 */ unsigned long DiskFileBad : 1; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x09cc */ unsigned long PrimaryFileSizeBeforeLastFlush;
  /* 0x09d0 */ volatile long ReferenceCount;
  /* 0x09d4 */ long UnloadHistoryIndex;
  /* 0x09d8 */ unsigned long UnloadHistory[128];
  /* 0x0bd8 */ unsigned long BootStart;
  /* 0x0bdc */ unsigned long UnaccessedStart;
  /* 0x0be0 */ unsigned long UnaccessedEnd;
  /* 0x0be4 */ unsigned long LoadedKeyCount;
  /* 0x0be8 */ volatile unsigned long HandleClosePending;
  /* 0x0bec */ struct _EX_PUSH_LOCK HandleClosePendingEvent;
  /* 0x0bf0 */ unsigned char FinalFlushSucceeded;
  /* 0x0bf4 */ struct _CMP_VOLUME_CONTEXT* VolumeContext;
} CMHIVE, *PCMHIVE; /* size: 0x0bf8 */
