...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x03c8 */ volatile long DirectedTransitionCallCount;
  /* 0x03d0 */ void* DirectedTransitionCompletionContext;
  /* 0x03d8 */ struct _UNICODE_STRING FriendlyName;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x03e8 */
