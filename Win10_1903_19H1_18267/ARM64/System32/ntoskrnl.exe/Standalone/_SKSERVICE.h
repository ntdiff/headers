typedef enum _SKSERVICE
{
  ...
  SECURESERVICE_CREATE_ENCLAVE = 42,
  SECURESERVICE_LOAD_ENCLAVE_MODULE = 43,
  SECURESERVICE_INITIALIZE_ENCLAVE = 44,
  SECURESERVICE_TERMINATE_ENCLAVE = 45,
  SECURESERVICE_DELETE_ENCLAVE = 46,
  SECURESERVICE_CONNECT_SW_INTERRUPT = 47,
  SECURESERVICE_RELAX_HYPERGUARD_QUOTA = 48,
  SECURESERVICE_LIVEDUMP_QUERY_SECONDARYDATA_SIZE = 49,
  SECURESERVICE_LIVEDUMP_START = 50,
  SECURESERVICE_LIVEDUMP_ADD_BUFFER = 51,
  SECURESERVICE_LIVEDUMP_SETUP_BUFFER = 52,
  SECURESERVICE_LIVEDUMP_FINALIZE = 53,
  SECURESERVICE_LIVEDUMP_ABORT = 54,
  SECURESERVICE_LIVEDUMP_CAPTURE_PROCESS = 55,
  SECURESERVICE_NOTIFY_POWER_STATE = 56,
  SECURESERVICE_QUERY_PROFILE_INFORMATION = 57,
  SECURESERVICE_UPDATE_FREEZE_BIAS = 58,
  SECURESERVICE_CREATE_SECURE_SECTION = 59,
  SECURESERVICE_DELETE_SECURE_SECTION = 60,
  SECURESERVICE_QUERY_SECURE_DEVICE = 61,
  SECURESERVICE_UNPROTECT_SECURE_DEVICE = 62,
  SECURESERVICE_DETERMINE_HOT_PATCH_TYPE = 63,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE_SIZE = 64,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE = 65,
  SECURESERVICE_APPLY_HOT_PATCH = 66,
  SECURESERVICE_REVERT_HOT_PATCH = 67,
  SECURESERVICE_PROVISION_DUMP_KEYS = 68,
  SECURESERVICE_DEBUG_SWEEP_ICACHE_RANGE = 69,
  SECURESERVICE_SET_BREAKPOINT = 70,
