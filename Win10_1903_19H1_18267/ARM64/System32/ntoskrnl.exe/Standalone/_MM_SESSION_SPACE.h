typedef struct _MM_SESSION_SPACE_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long SessionHeapInitialized : 1; /* bit position: 8 */
    /* 0x0000 */ unsigned long SessionHeapDestroyed : 1; /* bit position: 9 */
...
typedef struct _POOL_DESCRIPTOR
{
  ...
  /* 0x0184 */ enum _POOL_TYPE PoolTypeCopy;
  /* 0x0200 */ struct _SINGLE_LIST_ENTRY PendingFrees;
  /* 0x0208 */ volatile long ThreadsProcessingDeferrals;
  /* 0x020c */ volatile long PendingFreeDepth;
  /* 0x0280 */ struct _LIST_ENTRY ListHeads[256];
} POOL_DESCRIPTOR, *PPOOL_DESCRIPTOR; /* size: 0x1280 */
...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x00a0 */ struct _MM_PAGED_POOL_INFO PagedPoolInfo;
  /* 0x0100 */ struct _GENERAL_LOOKASIDE Lookaside[21];
  /* 0x0b80 */ struct _MMSESSION Session;
  /* 0x0c00 */ struct _MMSUPPORT_FULL Vm;
  /* 0x0d80 */ struct _MMWSL_INSTANCE WorkingSetList;
  /* 0x0e00 */ struct _MMSUPPORT_AGGREGATION AggregateSessionWs;
  /* 0x0e20 */ void* HeapState;
  /* 0x0e80 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x2100 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x2108 */ unsigned long TopLevelPteLockBits[32];
  /* 0x2188 */ struct _MMPTE PageDirectory;
  /* 0x2190 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x2198 */ struct _RTL_BITMAP_EX DynamicVaBitMap;
  /* 0x21a8 */ unsigned __int64 DynamicVaHint;
  /* 0x21b0 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x21f0 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x21f8 */ long PoolBigEntriesInUse;
  /* 0x21fc */ unsigned long PagedPoolPdeCount;
  /* 0x2200 */ unsigned long SpecialPoolPdeCount;
  /* 0x2204 */ unsigned long DynamicSessionPdeCount;
  /* 0x2208 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x2268 */ void* PoolTrackTableExpansion;
  /* 0x2270 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x2278 */ void* PoolTrackBigPages;
  /* 0x2280 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x2288 */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x2290 */ enum _IO_SESSION_STATE IoState;
  /* 0x2294 */ unsigned long IoStateSequence;
  /* 0x2298 */ struct _KEVENT IoNotificationEvent;
  /* 0x22b0 */ struct _EJOB* ServerSilo;
  /* 0x22b8 */ unsigned __int64 CreateTime;
  /* 0x3000 */ unsigned char PoolTags[8192];
