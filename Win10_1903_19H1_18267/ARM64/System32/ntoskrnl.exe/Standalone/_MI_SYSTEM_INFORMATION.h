...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0284 */ unsigned long ImageChecksumBreakpoint;
  /* 0x0288 */ unsigned long ImageSizeBreakpoint;
  /* 0x028c */ volatile long ImageValidationFailed;
  /* 0x0290 */ unsigned long HotPatchReserveSize;
  /* 0x0294 */ long __PADDING__[27];
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x013c */ unsigned char PagingLevels;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1d80 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x1d98 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x1dc0 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1e20 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1e98 */ struct _MI_ERROR_STATE Errors;
...
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3380 */
