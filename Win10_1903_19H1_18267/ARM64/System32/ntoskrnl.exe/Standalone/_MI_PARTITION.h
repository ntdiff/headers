...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x1250 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x1260 */ long __PADDING__[8];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x1280 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1b00 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1c00 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1c68 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1df0 */ void* WorkingSetControl;
  /* 0x1df8 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1e08 */ unsigned long SessionDetachTimeStamp;
  /* 0x1e80 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x3180 */
