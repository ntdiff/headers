...
typedef struct _MEMORY_PARTITION_INITIAL_ADD_INFORMATION
{
  ...
  /* 0x0010 */ struct _MEMORY_PARTITION_PAGE_RANGE PartitionRanges[1];
} MEMORY_PARTITION_INITIAL_ADD_INFORMATION, *PMEMORY_PARTITION_INITIAL_ADD_INFORMATION; /* size: 0x0020 */
