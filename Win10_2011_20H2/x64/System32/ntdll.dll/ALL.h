...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_155[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_156[2];
...
Feature_Servicing_EHCONT_Checks_28208890__private_IsEnabled
FindDirectoryEntry
FindEmailAt
FindLabelEnd
FindNodeOrParent
