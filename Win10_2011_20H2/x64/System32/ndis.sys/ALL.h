/*
 * PDB file: PDB\Win10_2011_20H2\x64\System32\drivers\ndis.sys.pdb
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1096 */ char Padding_91[2];
  /* 0x1098 */ unsigned long DirectOidRequestCount;
  /* 0x109c */ long Padding_92;
...
typedef struct _TCP_OFFLOAD_STATE_DELEGATED
{
  ...
  /* 0x004e */ char Padding_347[2];
  struct
  {
    /* 0x0050 */ unsigned char ProbeCount;
    /* 0x0001 */ char Padding_348[3];
...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0060 */ long Padding_351[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_352[12];
...
{
  /* 0x0000 */ long Padding_482[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_483;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_484;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
