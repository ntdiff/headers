...
typedef struct _MI_SESSION_STATE
{
  ...
  /* 0x1038 */ struct _KEVENT DeleteInProgressEvent;
  /* 0x1048 */ unsigned long DeleteInProgressCount;
} MI_SESSION_STATE, *PMI_SESSION_STATE; /* size: 0x104c */
...
typedef struct _MIPFNBLINK
{
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0000 */ unsigned long TbFlushStamp : 4; /* bit position: 23 */
      /* 0x0000 */ unsigned long Unused : 1; /* bit position: 27 */
      /* 0x0000 */ unsigned long PageBlinkDeleteBit : 1; /* bit position: 28 */
      /* 0x0000 */ unsigned long PageBlinkLockBit : 1; /* bit position: 29 */
    }; /* bitfield */
    struct /* bitfield */
    {
...
typedef struct _MI_ERROR_STATE
{
  ...
  /* 0x00ad */ unsigned char FatalGraphicsFailures;
  /* 0x00ae */ unsigned char InitFailure;
  /* 0x00af */ unsigned char StopBadMaps;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x12b0 */ struct _MI_PROCESS_STATE Processes;
  ...
  /* 0x4120 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x4180 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x41c0 */ struct _MI_ENCLAVE_STATE Enclaves;
  /* 0x41e4 */ unsigned long Cookie;
  /* 0x41e8 */ void* volatile* BootRegistryRuns;
  /* 0x41ec */ volatile long ZeroingDisabled;
  /* 0x41f0 */ unsigned char FullyInitialized;
  /* 0x41f1 */ unsigned char SafeBooted;
  /* 0x41f4 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x41fc */ const struct _tlgProvider_t* TraceLogging;
  /* 0x4200 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x4ec0 */
