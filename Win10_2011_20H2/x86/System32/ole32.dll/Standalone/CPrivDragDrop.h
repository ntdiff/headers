...
class CPrivDragDrop
{
  ...
  /* 0x0010 */ class Microsoft::WRL::ComPtr<IEnterpriseDropTarget> _pEnterpriseDropTarget;
  /* 0x0014 */ struct HWND__* _hwnd;
  /* 0x0018 */ BOOL _fBrokerInstance;
  /* 0x0019 */ BOOL m_dropTargetIsRPCSSRegistered;
  /* 0x001c */ struct CO_MTA_USAGE_COOKIE__* _mtaCookie;
}; /* size: 0x0020 */
