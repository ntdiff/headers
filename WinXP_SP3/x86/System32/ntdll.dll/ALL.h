...
} NPAGED_LOOKASIDE_LIST, *PNPAGED_LOOKASIDE_LIST; /* size: 0x0100 */
...
} RTL_USER_PROCESS_PARAMETERS, *PRTL_USER_PROCESS_PARAMETERS; /* size: 0x0290 */
...
typedef struct _VPB
{
  ...
  /* 0x0018 */ unsigned short VolumeLabel[32];
...
typedef struct _PEB
{
  ...
  /* 0x0020 */ void* FastPebLockRoutine;
  /* 0x0024 */ void* FastPebUnlockRoutine;
  ...
  /* 0x01f8 */ void* ActivationContextData;
  /* 0x01fc */ void* ProcessAssemblyStorageMap;
  /* 0x0200 */ void* SystemDefaultActivationContextData;
  /* 0x0204 */ void* SystemAssemblyStorageMap;
  /* 0x0208 */ unsigned long MinimumStackCommit;
  /* 0x020c */ long __PADDING__[1];
} PEB, *PPEB; /* size: 0x0210 */
...
typedef struct _STACK_TRACE_DATABASE
{
  ...
  /* 0x0038 */ void* AcquireLockRoutine /* function */;
  /* 0x003c */ void* ReleaseLockRoutine /* function */;
  /* 0x0040 */ void* OkayToLockRoutine /* function */;
  /* 0x0044 */ unsigned char PreCommitted;
  /* 0x0045 */ unsigned char DumpInProgress;
  /* 0x0046 */ char Padding_14[2];
  ...
  /* 0x0068 */ unsigned long NumberOfBuckets;
  /* 0x006c */ struct _RTL_STACK_TRACE_ENTRY* Buckets[1];
} STACK_TRACE_DATABASE, *PSTACK_TRACE_DATABASE; /* size: 0x0070 */
...
typedef struct _IO_STACK_LOCATION
{
  ...
  union // _TAG_UNNAMED_31
  {
    union
    {
      ...
      {
        /* 0x0004 */ unsigned long Length;
        /* 0x0008 */ struct _STRING* FileName;
...
typedef struct _HEAP_TAG_ENTRY
{
  ...
  /* 0x0010 */ unsigned short TagName[24];
...
typedef struct _KUSER_SHARED_DATA
{
  ...
  /* 0x02ed */ char Padding_20[3];
  /* 0x02f0 */ unsigned long TraceLogging;
  /* 0x02f4 */ long Padding_21;
