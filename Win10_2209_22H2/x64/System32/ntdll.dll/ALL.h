...
typedef struct _KNODE
{
  ...
  /* 0x0070 */ long Padding_43[4];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_44;
  union
  {
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x00cf */ char Padding_77;
  /* 0x00d0 */ enum _PROCESSOR_PRESENCE Presence;
  /* 0x00d4 */ long Padding_78;
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_188[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_189[2];
...
Feature_Servicing_2206c_38427506__private_IsEnabled
Feature_Servicing_AppServerAI__private_IsEnabled
FindDirectoryEntry
FindEmailAt
FindLabelEnd
FindNodeOrParent
...
RtlpProtectHeap
RtlpProtectInvertedFunctionTable
