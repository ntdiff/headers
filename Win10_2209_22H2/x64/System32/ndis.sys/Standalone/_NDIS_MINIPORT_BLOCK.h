...
typedef struct _PKTMON_COMPONENT_CONTEXT
{
  ...
  /* 0x0030 */ enum _PKTMON_PACKET_TYPE PacketType;
  struct /* bitfield */
  {
    /* 0x0034 */ int FlowEnabled : 1; /* bit position: 0 */
    /* 0x0034 */ int DropEnabled : 1; /* bit position: 1 */
  }; /* bitfield */
} PKTMON_COMPONENT_CONTEXT, *PPKTMON_COMPONENT_CONTEXT; /* size: 0x0038 */
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1648 */ BOOL ModernStandbySystemWakeEnabled;
  ...
  /* 0x16e8 */ struct _PKTMON_EDGE_CONTEXT PktMonEdge;
  /* 0x1710 */ enum NetSetupStoreType LWMConfigurationStore;
  /* 0x1714 */ long __PADDING__[1];
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x1718 */
