...
typedef struct _PROC_PERF_CHECK_CONTEXT
{
  ...
  /* 0x0020 */ unsigned short LatestAffinitizedPercent;
  /* 0x0022 */ unsigned short AveragePerformancePercent;
  /* 0x0024 */ unsigned long RelativePerformance;
} PROC_PERF_CHECK_CONTEXT, *PPROC_PERF_CHECK_CONTEXT; /* size: 0x0028 */
...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x015c */ struct _PPM_CONCURRENCY_ACCOUNTING* ClassConcurrency;
  /* 0x0160 */ unsigned char ArchitecturalEfficiencyClass;
  /* 0x0161 */ unsigned char PerformanceSchedulingClass;
  /* 0x0162 */ unsigned char EfficiencySchedulingClass;
  /* 0x0163 */ unsigned char Unused;
  /* 0x0164 */ unsigned char Parked;
  /* 0x0165 */ unsigned char LongPriorQosPeriod;
  /* 0x0166 */ char Padding_11[2];
  union
  {
...
typedef struct _KPRCB
{
  ...
  /* 0x3f18 */ struct _KDPC ForceIdleDpc;
  /* 0x3f38 */ unsigned long PrcbPad91[8];
  /* 0x3f58 */ struct _RTL_HASH_TABLE* DpcRuntimeHistoryHashTable;
  /* 0x3f5c */ struct _KDPC* DpcRuntimeHistoryHashTableCleanupDpc;
  /* 0x3f60 */ unsigned __int64 CurrentDpcRuntimeHistoryCached;
  /* 0x3f68 */ unsigned __int64 CurrentDpcStartTime;
  /* 0x3f70 */ void* CurrentDpcRoutine /* function */;
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      /* 0x005c */ unsigned long ThreadFlagsSpare : 2; /* bit position: 0 */
...
} TIMEZONE_CHANGE_EVENT, *PTIMEZONE_CHANGE_EVENT; /* size: 0x0058 */
...
typedef struct _EPROCESS
{
  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0494 */ unsigned long Reserved1 : 1; /* bit position: 25 */
        /* 0x0494 */ unsigned long Reserved2 : 1; /* bit position: 26 */
        /* 0x0494 */ unsigned long Reserved3 : 1; /* bit position: 27 */
        /* 0x0494 */ unsigned long Reserved4 : 1; /* bit position: 28 */
        /* 0x0494 */ unsigned long Reserved5 : 1; /* bit position: 29 */
  ...
  /* 0x04c0 */ struct _PS_DYNAMIC_ENFORCED_ADDRESS_RANGES DynamicEnforcedCetCompatibleRanges;
  /* 0x04c8 */ unsigned long DisabledComponentFlags;
  /* 0x04cc */ unsigned long* volatile PathRedirectionHashes;
  /* 0x04d0 */ long __PADDING__[12];
...
typedef struct _EX_TIMEZONE_STATE
{
  ...
  /* 0x0218 */ struct _TIMEZONE_CHANGE_EVENT Century;
  /* 0x0270 */ struct _TIMEZONE_CHANGE_EVENT NextYear;
  /* 0x02c8 */ long OkToTimeZoneRefresh;
  /* 0x02cc */ long Padding_67;
  /* 0x02d0 */ union _LARGE_INTEGER NextCenturyTimeInUTC;
  /* 0x02d8 */ struct _TIME_FIELDS NextCenturyTimeFieldsInLocalTime;
  /* 0x02e8 */ union _LARGE_INTEGER NextYearTimeInUTC;
  /* 0x02f0 */ struct _TIME_FIELDS NextYearTimeFieldsInLocalTime;
  /* 0x0300 */ short LastDynamicTimeZoneYear;
  /* 0x0302 */ char Padding_68[6];
  /* 0x0308 */ union _LARGE_INTEGER NextSystemCutoverInUTC;
  /* 0x0310 */ unsigned long RefreshFailures;
  /* 0x0314 */ long __PADDING__[1];
} EX_TIMEZONE_STATE, *PEX_TIMEZONE_STATE; /* size: 0x0318 */
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0261 */ unsigned char TzVirtualizationSupported;
  /* 0x0262 */ char Padding_76[2];
  /* 0x0264 */ void* ImgFileExecOptions;
  /* 0x0268 */ struct _EX_TIMEZONE_STATE* ExTimeZoneState;
  /* 0x026c */ struct _UNICODE_STRING NtSystemRoot;
  /* 0x0274 */ struct _UNICODE_STRING SiloRootDirectoryName;
  /* 0x027c */ struct _PSP_STORAGE* Storage;
  /* 0x0280 */ enum _SERVERSILO_STATE State;
  /* 0x0284 */ long ExitStatus;
  /* 0x0288 */ struct _KEVENT* DeleteEvent;
  /* 0x028c */ struct _SILO_USER_SHARED_DATA* UserSharedData;
  /* 0x0290 */ void* UserSharedSection;
  /* 0x0294 */ struct _WORK_QUEUE_ITEM TerminateWorkItem;
  /* 0x02a4 */ unsigned char IsDownlevelContainer;
  /* 0x02a5 */ char __PADDING__[3];
...
_Feature_SearchPackagePaths__private_IsEnabled@0
_Feature_Servicing_2206c_38427506__private_IsEnabled@0
_Feature_Servicing_AppServerAI__private_IsEnabled@0
...
_LdrpCompareResourceNamesWithValidation@24
...
_wil_StagingConfig_QueryFeatureState@20
...
_wil_details_StagingConfigFeature_HasUniqueState@4
_wil_details_StagingConfig_Free@4
_wil_details_StagingConfig_Load@20
_wil_details_StagingConfig_QueryFeatureState@16
*/
