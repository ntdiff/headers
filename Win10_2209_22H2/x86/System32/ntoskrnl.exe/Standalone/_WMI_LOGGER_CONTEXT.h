...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0258 */ unsigned long SpareFlags2 : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
  ...
  /* 0x02dc */ struct PERIODIC_CAPTURE_STATE_CONTEXT* PeriodicCaptureStateContext;
  /* 0x02e0 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x02e4 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x02e8 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x02f8 */ long CompressionWorkItemState;
  /* 0x02fc */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x0300 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x0304 */ void* CompressionWorkspace;
  /* 0x0308 */ long CompressionOn;
  /* 0x030c */ unsigned long CompressionRatioGuess;
  /* 0x0310 */ unsigned long PartialBufferCompressionLevel;
  /* 0x0314 */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x0318 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x031c */ struct _KDPC CompressionDpc;
  /* 0x0340 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0348 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0350 */ union _LARGE_INTEGER BufferCompressDuration;
  /* 0x0358 */ __int64 ReferenceQpcDelta;
  /* 0x0360 */ struct _ETW_EVENT_CALLBACK_CONTEXT* CallbackContext;
  /* 0x0364 */ union _LARGE_INTEGER* LastDroppedTime;
  /* 0x0368 */ union _LARGE_INTEGER* FlushingLastDroppedTime;
  /* 0x0370 */ __int64 FlushingSequenceNumber;
  /* 0x0378 */ struct _ETW_PARTITION_CONTEXT PartitionContext;
  /* 0x037c */ struct _MDL* BufferMdl;
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0380 */
