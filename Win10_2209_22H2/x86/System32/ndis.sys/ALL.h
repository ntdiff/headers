...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0048 */ long Padding_15[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_16[14];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_60;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_61[2];
...
?ndisPktMonRegisterAllFilters@@YGXXZ
?ndisPktMonRegisterAllMiniports@@YGXXZ
?ndisPktMonRegisterAllOpens@@YGXXZ
