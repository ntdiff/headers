...
typedef struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
  ...
  /* 0x00fc */ void* RestoreTime /* function */;
} HAL_INTEL_ENLIGHTENMENT_INFORMATION, *PHAL_INTEL_ENLIGHTENMENT_INFORMATION; /* size: 0x0100 */
...
_memcpy
_memset
_wil_InitializeFeatureStaging@0
_wil_details_BuildFeatureStateCacheFromQueryResults@12
_wil_details_EvaluateFeatureDependencies@0
...
_wil_details_PopulateInitialConfiguredFeatureStates@0
