...
class CFont
{
  /* 0x0018 */ class CNotifyCP m_cpNotify;
  /* 0x0030 */ class CFontEventsCP m_cpEvents;
  /* 0x0044 */ struct FR m_fr;
  /* 0x009c */ struct HDC__* m_hdc;
  /* 0x00a0 */ struct HFONT__* m_hfont;
  /* 0x00a4 */ int m_nFcr;
  /* 0x00a8 */ long m_cRefs;
  struct /* bitfield */
  {
    /* 0x00ac */ unsigned char m_fNameDirty : 1; /* bit position: 0 */
    /* 0x00ac */ unsigned char m_fCharSetDirty : 1; /* bit position: 1 */
    /* 0x00ac */ unsigned char m_fNotifyOff : 1; /* bit position: 2 */
  }; /* bitfield */
  union
  {
    /* 0x0000 */ int s_cFcr;
