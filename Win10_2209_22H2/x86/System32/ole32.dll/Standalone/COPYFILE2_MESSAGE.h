  ...
  union
  {
    union
    {
      struct
      {
        ...
        /* 0x0014 */ void* hDestinationFile;
        /* 0x0018 */ union _ULARGE_INTEGER uliChunkNumber;
        /* 0x0020 */ union _ULARGE_INTEGER uliChunkSize;
        /* 0x0028 */ union _ULARGE_INTEGER uliStreamSize;
        /* 0x0030 */ union _ULARGE_INTEGER uliTotalFileSize;
      } /* size: 0x0030 */ ChunkStarted;
      struct
      {
        /* 0x0008 */ unsigned long dwStreamNumber;
        ...
        /* 0x0020 */ union _ULARGE_INTEGER uliChunkSize;
        /* 0x0028 */ union _ULARGE_INTEGER uliStreamSize;
        /* 0x0030 */ union _ULARGE_INTEGER uliStreamBytesTransferred;
        /* 0x0038 */ union _ULARGE_INTEGER uliTotalFileSize;
        /* 0x0040 */ union _ULARGE_INTEGER uliTotalBytesTransferred;
      } /* size: 0x0040 */ ChunkFinished;
      struct
      {
        /* 0x0008 */ unsigned long dwStreamNumber;
        /* 0x000c */ unsigned long dwReserved;
        /* 0x0010 */ void* hSourceFile;
        /* 0x0014 */ void* hDestinationFile;
        /* 0x0018 */ union _ULARGE_INTEGER uliStreamSize;
        /* 0x0020 */ union _ULARGE_INTEGER uliTotalFileSize;
      } /* size: 0x0020 */ StreamStarted;
      struct
      {
        /* 0x0008 */ unsigned long dwStreamNumber;
        /* 0x000c */ unsigned long dwReserved;
        ...
        /* 0x0014 */ void* hDestinationFile;
        /* 0x0018 */ union _ULARGE_INTEGER uliStreamSize;
        /* 0x0020 */ union _ULARGE_INTEGER uliStreamBytesTransferred;
        /* 0x0028 */ union _ULARGE_INTEGER uliTotalFileSize;
        /* 0x0030 */ union _ULARGE_INTEGER uliTotalBytesTransferred;
      } /* size: 0x0030 */ StreamFinished;
      struct
      {
