typedef struct _MEMORY_WORKING_SET_EX_BLOCK
{
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0000 */ unsigned long Reserved : 3; /* bit position: 27 */
      /* 0x0000 */ unsigned long SharedOriginal : 1; /* bit position: 30 */
      /* 0x0000 */ unsigned long Bad : 1; /* bit position: 31 */
    }; /* bitfield */
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0000 */ unsigned long Shared : 1; /* bit position: 15 */
        /* 0x0000 */ unsigned long Reserved1 : 5; /* bit position: 16 */
        /* 0x0000 */ unsigned long PageTable : 1; /* bit position: 21 */
        /* 0x0000 */ unsigned long Location : 2; /* bit position: 22 */
        /* 0x0000 */ unsigned long Priority : 3; /* bit position: 24 */
        /* 0x0000 */ unsigned long ModifiedList : 1; /* bit position: 27 */
        /* 0x0000 */ unsigned long Reserved2 : 2; /* bit position: 28 */
        /* 0x0000 */ unsigned long SharedOriginal : 1; /* bit position: 30 */
        /* 0x0000 */ unsigned long Bad : 1; /* bit position: 31 */
      }; /* bitfield */
    } /* size: 0x0004 */ Invalid;
