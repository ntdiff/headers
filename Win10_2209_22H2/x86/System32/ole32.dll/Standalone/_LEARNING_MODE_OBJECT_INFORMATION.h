...
typedef struct _LEARNING_MODE_OBJECT_INFORMATION
{
  ...
  /* 0x0004 */ enum _LEARNING_MODE_LOG_LEVEL LogLevel;
  /* 0x0008 */ struct _UNICODE_STRING* ObjectType;
  /* 0x000c */ struct _UNICODE_STRING* ObjectName;
  /* 0x0010 */ void* RootDirectory;
  /* 0x0014 */ struct _UNICODE_STRING FullObjectName;
} LEARNING_MODE_OBJECT_INFORMATION, *PLEARNING_MODE_OBJECT_INFORMATION; /* size: 0x001c */
