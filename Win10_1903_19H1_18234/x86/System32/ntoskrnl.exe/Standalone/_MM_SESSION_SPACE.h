...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0dd8 */ void* HeapState;
  /* 0x0e00 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x1f40 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x1f44 */ unsigned long TopLevelPteLockBits[128];
  /* 0x2148 */ struct _MMPTE PageTables[1024];
  /* 0x4148 */ unsigned long PagedPoolBitBuffer[32];
  /* 0x41c8 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x4208 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x420c */ long PoolBigEntriesInUse;
  /* 0x4210 */ unsigned long PagedPoolPdeCount;
  /* 0x4214 */ unsigned long SpecialPoolPdeCount;
  /* 0x4218 */ unsigned long DynamicSessionPdeCount;
  /* 0x421c */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x4250 */ void* PoolTrackTableExpansion;
  /* 0x4254 */ unsigned long PoolTrackTableExpansionSize;
  /* 0x4258 */ void* PoolTrackBigPages;
  /* 0x425c */ unsigned long PoolTrackBigPagesSize;
  /* 0x4260 */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x4264 */ enum _IO_SESSION_STATE IoState;
  /* 0x4268 */ unsigned long IoStateSequence;
  /* 0x426c */ struct _KEVENT IoNotificationEvent;
  /* 0x427c */ struct _EJOB* ServerSilo;
  /* 0x4280 */ unsigned __int64 CreateTime;
