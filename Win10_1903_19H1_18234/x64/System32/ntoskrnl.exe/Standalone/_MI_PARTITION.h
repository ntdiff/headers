...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x1090 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x10a0 */ long __PADDING__[8];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x10c0 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1900 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1980 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x19e8 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1b70 */ void* WorkingSetControl;
  /* 0x1b78 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1bc0 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x2dc0 */
