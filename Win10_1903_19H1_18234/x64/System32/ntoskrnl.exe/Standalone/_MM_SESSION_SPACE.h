...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0d60 */ void* HeapState;
  /* 0x0d80 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x1ec0 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x1ec8 */ unsigned long TopLevelPteLockBits[32];
  /* 0x1f48 */ struct _MMPTE PageDirectory;
  /* 0x1f50 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x1f58 */ struct _RTL_BITMAP_EX DynamicVaBitMap;
  /* 0x1f68 */ unsigned __int64 DynamicVaHint;
  /* 0x1f70 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x1fb0 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x1fb8 */ long PoolBigEntriesInUse;
  /* 0x1fbc */ unsigned long PagedPoolPdeCount;
  /* 0x1fc0 */ unsigned long SpecialPoolPdeCount;
  /* 0x1fc4 */ unsigned long DynamicSessionPdeCount;
  /* 0x1fc8 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x2028 */ void* PoolTrackTableExpansion;
  /* 0x2030 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x2038 */ void* PoolTrackBigPages;
  /* 0x2040 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x2048 */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x2050 */ enum _IO_SESSION_STATE IoState;
  /* 0x2054 */ unsigned long IoStateSequence;
  /* 0x2058 */ struct _KEVENT IoNotificationEvent;
  /* 0x2070 */ struct _EJOB* ServerSilo;
  /* 0x2078 */ unsigned __int64 CreateTime;
