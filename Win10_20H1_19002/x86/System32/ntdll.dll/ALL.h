...
typedef struct _KPRCB
{
  ...
  /* 0x3f40 */ unsigned long PrcbPad91[6];
...
} PROC_PERF_HISTORY, *PPROC_PERF_HISTORY; /* size: 0x0028 */
...
_TpIsTimerSet@4
_TpOverrideDefaultPoolMaxThreads@4
