...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1c80 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1d40 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1db8 */ struct _MI_ERROR_STATE Errors;
  ...
  /* 0x20c0 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x22c0 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x2330 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x23e0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
...
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x31c0 */
