...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x107e */ char Padding_275[2];
  /* 0x1080 */ unsigned long DirectOidRequestCount;
  /* 0x1084 */ long Padding_276;
...
typedef struct _TCP_OFFLOAD_STATE_DELEGATED
{
  ...
  /* 0x004e */ char Padding_341[2];
  struct
  {
    /* 0x0050 */ unsigned char ProbeCount;
    /* 0x0001 */ char Padding_342[3];
...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0060 */ long Padding_403[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_404[28];
...
{
  /* 0x0000 */ long Padding_405[8];
  /* 0x0020 */ unsigned long ItemLength;
  /* 0x0024 */ long Padding_406;
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_450;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_451[2];
