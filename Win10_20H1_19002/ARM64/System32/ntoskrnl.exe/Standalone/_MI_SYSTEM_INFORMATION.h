...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x15d0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1680 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1880 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x1d00 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x1d20 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x1d80 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1e80 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1ef8 */ struct _MI_ERROR_STATE Errors;
  /* 0x2000 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x2100 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x2220 */ struct _MI_STANDBY_STATE Standby;
  /* 0x2300 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x2500 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x2570 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x2620 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2700 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2780 */ unsigned __int64 Cookie;
  /* 0x2788 */ void* volatile* BootRegistryRuns;
  /* 0x2790 */ volatile long ZeroingDisabled;
  /* 0x2794 */ unsigned char FullyInitialized;
  /* 0x2795 */ unsigned char SafeBooted;
  /* 0x2798 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x2800 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3980 */
