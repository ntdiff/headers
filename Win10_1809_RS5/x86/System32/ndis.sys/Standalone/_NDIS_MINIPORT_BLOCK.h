...
class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > >
{
}; /* size: 0x0004 */
...
typedef struct _PKTMON_COMPONENT_CONTEXT
{
  ...
  struct /* bitfield */
  {
    /* 0x0008 */ unsigned long FlowEnabled : 1; /* bit position: 0 */
    /* 0x0008 */ unsigned long DropEnabled : 1; /* bit position: 1 */
  }; /* bitfield */
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x04a4 */ void* FakeMac;
  /* 0x04a8 */ unsigned long LockDbg;
  /* 0x04ac */ unsigned long LockDbgX;
  /* 0x04b0 */ void* LockThread;
  /* 0x04b4 */ unsigned long InfoFlags;
  /* 0x04b8 */ unsigned long TimerQueueLock;
  /* 0x04bc */ struct _KEVENT* ResetCompletedEvent;
  /* 0x04c0 */ void* SavedPacketIndicateHandler /* function */;
  /* 0x04c4 */ long RegisteredInterrupts;
  /* 0x04c8 */ unsigned long SetOid;
  /* 0x04cc */ struct _KEVENT CFHCompletedEvent;
  /* 0x04dc */ struct _WORK_QUEUE_ITEM CFHWorkItem;
  /* 0x04ec */ volatile long CFHWorkItemQueued;
  /* 0x04f0 */ void* DeviceContext;
  /* 0x04f4 */ struct _NDIS_MINIPORT_RSS_PARAMETERS_CACHE* RssParametersBuffer;
  /* 0x04f8 */ unsigned char UsingMSIX;
  /* 0x04f9 */ unsigned char Miniport5InNdis6Mode;
  /* 0x04fa */ unsigned char Miniport5HasNdis6Component;
  /* 0x04fb */ unsigned char InitMode;
  /* 0x04fc */ unsigned char InitModeNotNeededAnymore;
  /* 0x04fd */ char MediaChangeFilters;
  /* 0x04fe */ unsigned char CheckPacketFilters;
  /* 0x04ff */ unsigned char ReceiveFilters;
  /* 0x0500 */ unsigned long RecvLock;
  /* 0x0504 */ enum _NDIS_MINIPORT_STATE RecvState;
  /* 0x0508 */ unsigned long OutstandingReceives;
  /* 0x050c */ void* MiniportRecvLockThread;
  /* 0x0510 */ unsigned long RecvLockDbg;
  /* 0x0514 */ void* NextSendPacketsHandler /* function */;
  /* 0x0518 */ void* FinalSendPacketsHandler /* function */;
  /* 0x051c */ struct _NDIS_FILTER_BLOCK* LowestFilter;
  /* 0x0520 */ struct _NDIS_FILTER_BLOCK* HighestFilter;
  /* 0x0524 */ void* ShutdownContext;
  /* 0x0528 */ void* ShutdownHandler /* function */;
  /* 0x052c */ struct _KBUGCHECK_CALLBACK_RECORD BugcheckCallbackRecord;
  /* 0x054c */ void* TopIndicateNetBufferListsHandler /* function */;
  /* 0x0550 */ void* TopIndicateLoopbackNetBufferListsHandler /* function */;
  /* 0x0554 */ void* Ndis5PacketIndicateHandler /* function */;
  /* 0x0558 */ void* MiniportReturnPacketHandler /* function */;
  /* 0x055c */ void* MiniportReturnPacketContext;
  /* 0x0560 */ void* SynchronousReturnPacketHandler /* function */;
  /* 0x0564 */ void* SynchronousReturnPacketContext;
  /* 0x0568 */ struct _LIST_ENTRY OidRequestList;
  /* 0x0570 */ struct _NDIS_OID_REQUEST* PendingOidRequest;
  /* 0x0574 */ struct _NDIS_OID_REQUEST* ProcessedOidRequest;
  /* 0x0578 */ struct _NDIS_OID_REQUEST* HookedOidRequest;
  /* 0x057c */ void* NextCoOidRequestHandle;
  /* 0x0580 */ unsigned long Ndis6ProtocolsBound;
  /* 0x0584 */ unsigned long PmodeOpen6;
  /* 0x0588 */ enum _NDIS_MINIPORT_STATE State;
  /* 0x058c */ struct _KEVENT* AsyncOpCompletionEvent;
  /* 0x0590 */ int AsyncOpCompletionStatus;
  /* 0x0598 */ unsigned __int64 MaxXmitLinkSpeed;
  /* 0x05a0 */ unsigned __int64 MaxRcvLinkSpeed;
  /* 0x05a8 */ unsigned long SupportedPacketFilters;
  /* 0x05ac */ struct _NDIS_MINIPORT_HANDLERS NoFilter;
  /* 0x0608 */ struct _NDIS_MINIPORT_HANDLERS Next;
  /* 0x0664 */ unsigned char ReceivePathEnabled;
  /* 0x0665 */ unsigned char NormalTopReceive;
  /* 0x0668 */ enum _NDIS_SEND_PATH_TYPE SendPathType;
  /* 0x066c */ enum _NDIS_SEND_PATH_TYPE SavedSendPathType;
  /* 0x0670 */ unsigned char SavedReceivePathEnabled;
  /* 0x0674 */ unsigned long TimestampFlags;
  /* 0x0678 */ unsigned long FilterPnPFlags;
  /* 0x067c */ unsigned long SupportedStatistics;
  /* 0x0680 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x0694 */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x0698 */ struct _LIST_ENTRY PortList;
  /* 0x06a0 */ unsigned char* AllocatedPortIndices;
  /* 0x06a4 */ unsigned long AllocatedPortIndicesLength;
  /* 0x06a8 */ unsigned long NumberOfPorts;
  /* 0x06ac */ unsigned long NumberOfActivePorts;
  /* 0x06b0 */ unsigned __int64 MiniportXmitLinkSpeed;
  /* 0x06b8 */ unsigned __int64 MiniportRcvLinkSpeed;
  /* 0x06c0 */ struct _NDIS_TIMER InitModeTimeoutTimer;
  /* 0x0708 */ struct _NDIS_WORK_ITEM InitModeTimeoutWorkItem;
  /* 0x0730 */ struct _KEVENT InitModeTimeoutTimerQueuedEvent;
  /* 0x0740 */ unsigned long DataBackFillSize;
  /* 0x0744 */ unsigned long ContextBackFillSize;
  /* 0x0748 */ struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;
  /* 0x0798 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;
  /* 0x07ac */ unsigned long NsiOpenReferences;
  /* 0x07b0 */ void* ProcessingOpen;
  /* 0x07b4 */ struct _KEVENT* NsiRequestsCompletedEvent;
  /* 0x07b8 */ enum _DEVICE_POWER_STATE QueryPowerDeviceState;
  /* 0x07bc */ unsigned char MinimumNdisMajorVersion;
  /* 0x07bd */ unsigned char MinimumNdisMinorVersion;
  /* 0x07c0 */ struct _NDIS_MINIPORT_STATS* BottomIfStats;
  /* 0x07c4 */ struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;
  /* 0x0820 */ struct PNDIS_PER_PROCESSOR_SLOT__* PeriodicReceivesNblCountIndex;
  /* 0x0824 */ enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;
  /* 0x0828 */ enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;
  /* 0x082c */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;
  /* 0x0830 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;
  /* 0x0834 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;
  /* 0x0838 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;
  /* 0x083c */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;
  /* 0x0840 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;
  /* 0x0844 */ struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;
  /* 0x0878 */ void* TopNdis5PacketIndicateHandler /* function */;
  /* 0x087c */ unsigned long* ndisSupportedOidList;
  /* 0x0880 */ unsigned long ndisSupportedOidListLength;
  /* 0x0884 */ unsigned long MsiIntCount;
  /* 0x0888 */ struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;
  /* 0x0898 */ unsigned __int64 InvalidFrames;
  /* 0x08a0 */ long PagingPathCount;
  /* 0x08a4 */ struct _LIST_ENTRY ReceiveQueueList;
  /* 0x08ac */ unsigned char* AllocatedQueueIndices;
  /* 0x08b0 */ unsigned long AllocatedQueueIndicesLength;
  /* 0x08b4 */ unsigned long NumReceiveQueues;
  /* 0x08b8 */ struct _LIST_ENTRY ReceiveFilterList;
  /* 0x08c0 */ unsigned char* AllocatedReceiveFilterIndices;
  /* 0x08c4 */ unsigned long AllocatedReceiveFilterIndicesLength;
  /* 0x08c8 */ unsigned long NumReceiveFilters;
  /* 0x08cc */ unsigned long EnabledReceiveFilterTypes;
  /* 0x08d0 */ unsigned long EnabledReceiveQueueTypes;
  /* 0x08d4 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterHwCapabilities;
  /* 0x08d8 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterCurrentCapabilities;
  /* 0x08dc */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* TopReceiveFilterCurrentCapabilities;
  /* 0x08e0 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchHwCapabilities;
  /* 0x08e4 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchCurrentCapabilities;
  /* 0x08e8 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* TopNicSwitchCurrentCapabilities;
  /* 0x08ec */ struct _LIST_ENTRY SharedMemoryBlockList;
  /* 0x08f4 */ void* AllocateSharedMemoryHandler /* function */;
  /* 0x08f8 */ void* FreeSharedMemoryHandler /* function */;
  /* 0x08fc */ void* AllocateSharedMemoryContext;
  /* 0x0900 */ struct PCI_MSI_CAPABILITY MsiCaps;
  /* 0x0918 */ struct PCI_MSIX_CAPABILITY MsiXCaps;
  /* 0x0928 */ unsigned __int64 NumberOfIndirectionTableChanges;
  /* 0x0930 */ unsigned int PciDeviceSriovSupport;
  union
  {
    /* 0x0934 */ unsigned char BeginSavedFields;
    /* 0x0934 */ unsigned long NumUserOpens;
  }; /* size: 0x0004 */
  /* 0x0938 */ struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;
  /* 0x093c */ unsigned short MediaDisconnectTimeOut;
  /* 0x093e */ unsigned short SGMapRegistersNeeded;
  /* 0x0940 */ unsigned long DriverVerifyFlags;
  /* 0x0944 */ void* SetBusData /* function */;
  /* 0x0948 */ void* GetBusData /* function */;
  /* 0x094c */ void* BusDataContext;
  /* 0x0950 */ enum _INTERFACE_TYPE BusType;
  /* 0x0954 */ unsigned long BusNumber;
  /* 0x0958 */ unsigned long SlotNumber;
  /* 0x095c */ struct _NDIS_EVENT OpenReadyEvent;
  /* 0x096c */ unsigned long NumAdminOpens;
  /* 0x0970 */ struct _NDIS_M_DRIVER_BLOCK* DriverHandle;
  /* 0x0974 */ struct _NDIS_BIND_PATHS* BindPaths;
  /* 0x0978 */ enum _NDIS_PHYSICAL_MEDIUM MiniportPhysicalMediumType;
  /* 0x097c */ void* SecurityDescriptor;
  /* 0x0980 */ struct _UNICODE_STRING BaseName;
  /* 0x0988 */ struct _UNICODE_STRING MiniportName;
  /* 0x0990 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0994 */ struct _DEVICE_OBJECT* PhysicalDeviceObject;
  /* 0x0998 */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x099c */ struct _NDIS_MINIPORT_BLOCK* NextGlobalMiniport;
  /* 0x09a0 */ struct _UNICODE_STRING* pAdapterInstanceName;
  /* 0x09a4 */ unsigned long PnPCapabilities;
  /* 0x09a8 */ enum _DEVICE_POWER_STATE CurrentDevicePowerState;
  /* 0x09ac */ unsigned long PowerStateLock;
  /* 0x09b0 */ enum _DEVICE_POWER_STATE DriverPowerState;
  /* 0x09b4 */ enum _DEVICE_POWER_STATE PrevDriverPowerState;
  /* 0x09b8 */ struct _NET_BUFFER_LIST* LowPowerRcvReturnNbls;
  /* 0x09bc */ unsigned long PendingReturnNBLCount;
  /* 0x09c0 */ unsigned char SurpriseRemoveFlushedRcvReturnQueue;
  /* 0x09c4 */ struct NDIS_NBL_TRACKER_HANDLE__* LowPowerRcvReturnNblTracker;
  /* 0x09c8 */ struct _NDIS_PM_ADMIN_CONFIG PMAdminConfig;
  /* 0x09cc */ struct _KSEMAPHORE PMPatternSemaphore;
  /* 0x09e0 */ struct _KSEMAPHORE PMOffloadSemaphore;
  /* 0x09f4 */ void* BusInterface;
  /* 0x09f8 */ unsigned short InstanceNumber;
  /* 0x09fc */ void* ConfigurationHandle;
  /* 0x0a00 */ struct _GUID InterfaceGuid;
  /* 0x0a10 */ union _NET_LUID_LH NetLuid;
  /* 0x0a18 */ unsigned char IfBlockAvailable;
  /* 0x0a1c */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x0a20 */ struct _KEVENT* IfBlockPointerRefZeroEvent;
  /* 0x0a24 */ unsigned int IfIndex;
  /* 0x0a28 */ enum _NET_IF_ADMIN_STATUS AdminStatus;
  /* 0x0a2c */ enum _NET_IF_OPER_STATUS OperStatus;
  /* 0x0a30 */ unsigned long OperStatusFlags;
  union
  {
    /* 0x0a34 */ void* SendHandler /* function */;
    /* 0x0a34 */ void* WanSendHandler /* function */;
  }; /* size: 0x0004 */
  /* 0x0a38 */ struct NDIS_NBL_TRACKER_HANDLE__* NblTracker;
  /* 0x0a3c */ struct _DEVICE_RESET_INTERFACE_STANDARD* ReenumerateSelfInterface;
  /* 0x0a40 */ struct _NDIS_MINIPORT_OFFLOAD* Offload;
  /* 0x0a44 */ void* NDKBlock;
  /* 0x0a48 */ void* AddDeviceContext;
  /* 0x0a4c */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x0a64 */ struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;
  /* 0x0a6c */ unsigned long PhysicalMediumInInf;
  /* 0x0a70 */ class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > ExportName;
  /* 0x0a74 */ class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > FilterClass;
  /* 0x0a78 */ void* StatusProcessingThread;
  /* 0x0a7c */ unsigned long StatusProcessingDbgX;
  /* 0x0a80 */ struct _UNICODE_STRING FdoName;
  /* 0x0a88 */ struct _KEVENT PowerD0CompleteEvent;
  /* 0x0a98 */ long LastD0CompleteStatus;
  /* 0x0a9c */ enum _NDIS_MINIPORT_EVENT LastD0Reason;
  /* 0x0aa0 */ unsigned long DirectOidRequestCount;
  /* 0x0aa4 */ struct _KEVENT* AllDirectRequestsCompletedEvent;
  /* 0x0aa8 */ struct _NDIS_HD_SPLIT_CURRENT_CONFIG* HDSplitCurrentConfig;
  /* 0x0aac */ void* MSIXConfigContext;
  /* 0x0ab0 */ void* SetMSIXTableEntry /* function */;
  /* 0x0ab4 */ void* MaskMSIXTableEntry /* function */;
  /* 0x0ab8 */ void* UnmaskMSIXTableEntry /* function */;
  /* 0x0abc */ struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;
  /* 0x0acc */ struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;
  /* 0x0adc */ struct _NDIS_RECEIVE_QUEUE_BLOCK* DefaultReceiveQueue;
  /* 0x0ae0 */ unsigned long MaxNumRssProcessors;
  /* 0x0ae4 */ struct _PROCESSOR_NUMBER RssBaseProcessor;
  /* 0x0ae8 */ struct _PROCESSOR_NUMBER RssMaxProcessor;
  /* 0x0aec */ enum _NDIS_RSS_PROFILE RssProfile;
  /* 0x0af0 */ unsigned short NumaNodeId;
  /* 0x0af4 */ unsigned short* NumaDistances;
  /* 0x0af8 */ struct _UNICODE_STRING* pModifiedInstanceName;
  /* 0x0afc */ unsigned long SyncFlags;
  /* 0x0b00 */ unsigned long WSyncFlags;
  /* 0x0b04 */ unsigned long InterlockedFlags;
  /* 0x0b08 */ struct _ULONG_REFERENCE Ref;
  /* 0x0b14 */ struct _NDIS_SELECTIVE_SUSPEND* SelectiveSuspend;
  /* 0x0b18 */ struct _NDIS_MINIPORT_AOAC* AoAc;
  /* 0x0b1c */ enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;
  /* 0x0b20 */ struct NDIS_EVENT_LOG_HANDLE__* PnpEventLog;
  /* 0x0b24 */ struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;
  /* 0x0b54 */ struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS* PhysicalPerformanceCounters;
  /* 0x0b58 */ union _LARGE_INTEGER TimeOfInitialization;
  /* 0x0b60 */ union _LARGE_INTEGER LastSystemSleepTime;
  /* 0x0b68 */ unsigned __int64 TotalSystemSleepTimeMs;
  /* 0x0b70 */ struct _NDIS_SRIOV_CAPABILITIES* SriovHwCapabilities;
  /* 0x0b74 */ struct _NDIS_SRIOV_CAPABILITIES* SriovCurrentCapabilities;
  /* 0x0b78 */ unsigned __int64 InvalidateBlockMask;
  /* 0x0b80 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x0b84 */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x0b88 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x0b90 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x0ba0 */ unsigned short InvalidateVfId;
  /* 0x0ba2 */ unsigned char InvalidateBlockCancelling;
  /* 0x0ba4 */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x0ba8 */ unsigned long NumSwitches;
  /* 0x0bac */ struct _LIST_ENTRY NicSwitchList;
  /* 0x0bb4 */ unsigned long NumAllocatedVFs;
  /* 0x0bb8 */ struct _LIST_ENTRY VFList;
  /* 0x0bc0 */ unsigned long NumActiveVPorts;
  /* 0x0bc4 */ struct _LIST_ENTRY VPortList;
  /* 0x0bcc */ unsigned char* AllocatedVPortIndices;
  /* 0x0bd0 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x0bd4 */ void* SetVirtualFunctionData /* function */;
  /* 0x0bd8 */ void* GetVirtualFunctionData /* function */;
  /* 0x0bdc */ void* EnableVirtualization /* function */;
  /* 0x0be0 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x0be4 */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x0be8 */ void* VirtInterfaceContext;
  /* 0x0bec */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x0bf4 */ void* VpciInterfaceDereference /* function */;
  /* 0x0bf8 */ void* WriteVfConfigBlock /* function */;
  /* 0x0bfc */ void* ReadVfConfigBlock /* function */;
  /* 0x0c00 */ void* VpciInterfaceContext;
  /* 0x0c04 */ unsigned int VfSerialNumber;
  /* 0x0c08 */ struct _LUID SriovLuid;
  /* 0x0c10 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x0c14 */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x0c18 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x0c1c */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x0c20 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x0c24 */ unsigned long QosOperationalParametersBufferSize;
  /* 0x0c28 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x0c2c */ unsigned long QosRemoteParametersBufferSize;
  /* 0x0c30 */ unsigned __int64 DeviceFlags;
  /* 0x0c38 */ void* VerifierContext;
  /* 0x0c3c */ struct _WORK_QUEUE_ITEM SurpriseRemovalWorkItem;
  /* 0x0c4c */ struct Ndis::BindStack Bindings;
  /* 0x0c94 */ struct Ndis::BindEngine BindEngine;
  /* 0x0cd4 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x0cec */ BOOL PmInterruptedByPnp;
  /* 0x0ced */ BOOL DoNotBlockOnMiniportLock;
  /* 0x0cee */ BOOL PoFxDStateReportingEnabled;
  /* 0x0cf0 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x0cf4 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x0d04 */ BOOL InterfaceUpdateInProgress;
  /* 0x0d05 */ BOOL MacAddressUpdateQueued;
  /* 0x0d06 */ BOOL MtuUpdateQueued;
  /* 0x0d08 */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x0d2c */ unsigned long PendingMtuSize;
  /* 0x0d30 */ wchar_t* PnPInstanceId;
  /* 0x0d34 */ struct RECORDER_LOG__* BlackBoxHandle;
  /* 0x0d38 */ struct _KEVENT* PowerCompleteEvent;
  /* 0x0d3c */ long PowerCompleteStatus;
  /* 0x0d40 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x0d54 */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x0d68 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x0d6c */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x0d70 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > ReenumerateWatchdog;
  /* 0x0d74 */ void* PdcHandle;
  /* 0x0d78 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x0dc0 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x0de8 */ volatile long PdcTaskClientMode;
  /* 0x0dec */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x0df0 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x0df4 */ volatile long RssV2CompletionCount;
  /* 0x0df8 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x0e08 */ unsigned char RssV2Initialized;
  /* 0x0e0c */ struct _LIST_ENTRY SynchronousOidCalls;
  /* 0x0e14 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCapabilities;
  /* 0x0e18 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCurrentConfig;
  /* 0x0e1c */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopTimestampConfig;
  /* 0x0e20 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopHwTimestampCapabilities;
  /* 0x0e24 */ struct _PKTMON_COMPONENT_CONTEXT PktMonComp;
  /* 0x0e30 */ struct _PKTMON_EDGE_CONTEXT PktMonEdge;
  /* 0x0e3c */ long __PADDING__[1];
