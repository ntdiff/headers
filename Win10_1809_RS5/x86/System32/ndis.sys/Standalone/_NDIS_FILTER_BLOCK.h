...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0064 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > PendingOidWatchdog;
  struct
  {
    /* 0x0068 */ struct _WORK_QUEUE_ITEM WorkItem;
    /* 0x0078 */ unsigned char WorkItemQueued;
    /* 0x007c */ struct _PENDING_STACK_EXPANSION_FALLBACK_WORK PendingWork;
  } /* size: 0x0030 */ StackExpansionFallback;
  /* 0x0098 */ volatile unsigned char StatusIndicationsQueued;
  /* 0x009c */ volatile long DroppedReceiveNbls;
  /* 0x00a0 */ volatile long DroppedSendNbls;
  /* 0x00a4 */ unsigned long DroppedStatusIndications;
  /* 0x00a8 */ unsigned long DroppedUncloneableStatusIndications;
  /* 0x00ac */ struct _REFERENCE_EX PnPRef;
  /* 0x00b8 */ enum _NDIS_MEDIUM MediaType;
  /* 0x00bc */ enum _NDIS_PHYSICAL_MEDIUM PhysicalMediaType;
  /* 0x00c0 */ enum _NET_IF_MEDIA_CONNECT_STATE MediaConnectState;
  /* 0x00c4 */ enum _NET_IF_MEDIA_DUPLEX_STATE MediaDuplexState;
