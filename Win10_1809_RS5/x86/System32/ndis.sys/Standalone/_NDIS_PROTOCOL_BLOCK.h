...
typedef struct _NDIS_PROTOCOL_BLOCK
{
  ...
  /* 0x0198 */ void* DirectOidRequestCompleteHandler /* function */;
  /* 0x019c */ void* AllocateSharedMemoryHandler /* function */;
  /* 0x01a0 */ void* FreeSharedMemoryHandler /* function */;
  /* 0x01a4 */ void* AllocateSharedMemoryContext;
  /* 0x01a8 */ struct _UNICODE_STRING ImageName;
  /* 0x01b0 */ class KRef<NDIS_BIND_PROTOCOL_DRIVER> Bind;
  /* 0x01b4 */ class KCoalescingWorkItem<_NDIS_PROTOCOL_BLOCK> NotifyBindCompleteWorkItem;
} NDIS_PROTOCOL_BLOCK, *PNDIS_PROTOCOL_BLOCK; /* size: 0x01d0 */
