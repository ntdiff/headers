...
typedef struct _NDIS_SELECTIVE_SUSPEND
{
  ...
  /* 0x0008 */ unsigned long IdleTimeoutScreenOff;
  /* 0x0010 */ struct _NDIS_TIMER IdleTimer;
  /* 0x0058 */ unsigned long IdleTickCount;
  /* 0x005c */ struct _KEVENT IdleWorkItemCompleteEvent;
  /* 0x006c */ struct _KEVENT PowerSuspendCompleteEvent;
  /* 0x007c */ struct _KEVENT IdleNotificationCompleteEvent;
  /* 0x008c */ struct _KEVENT IdleNotificationDoneEvent;
  /* 0x009c */ struct _KEVENT DevicePowerReadyEvent;
  /* 0x00ac */ struct _KEVENT WdfD0LockedForSSEvent;
  /* 0x00bc */ struct _NDIS_WORK_ITEM IdleTimerWorkItem;
  /* 0x00e4 */ struct _NDIS_WORK_ITEM IdleCancelWorkItem;
  /* 0x010c */ struct _NDIS_IRP_WORK_ITEM ResumeWorkItem;
  /* 0x0124 */ struct _NDIS_SS_IDLE_FLAGS Flags;
  /* 0x0128 */ struct _NDIS_SS_STOP_FLAGS StopFlags;
  /* 0x012c */ struct _NDIS_SS_CONTROL_OPS PendingControlOps;
  /* 0x0130 */ long PendingPnPEventCount;
  /* 0x0134 */ long PendingSendNblCount;
  /* 0x0138 */ long PendingCancelSendCount;
  /* 0x013c */ long PendingDirectOidCount;
  /* 0x0140 */ long PendingCancelDirectOidCount;
  /* 0x0144 */ long PendingPnPOpCount;
  /* 0x0148 */ struct _NBL_QUEUE PendingSendNblQueue;
  /* 0x0150 */ struct _NBL_QUEUE PendingReceiveNblQueue;
  /* 0x0158 */ long PendingReceiveReturnCount;
  /* 0x015c */ struct _LIST_ENTRY PendingDirectOidQueue;
  /* 0x0164 */ struct _NDIS_OID_CACHE_ENTRY* OidCacheArray;
  /* 0x0168 */ struct NDIS_NBL_TRACKER_HANDLE__* QueuedSendNblTracker;
  /* 0x016c */ struct NDIS_NBL_TRACKER_HANDLE__* QueuedReceiveReturnNblTracker;
  /* 0x0170 */ unsigned short LastUnexpectedFailureLine[2];
  /* 0x0174 */ union _NDIS_SS_RESUME_REASON LastResumeReason;
  /* 0x0178 */ unsigned long LastResumeContext;
  /* 0x017c */ union _NDIS_SS_RESUME_REASON LastBusyEvent;
  /* 0x0180 */ unsigned long LastBusyContext;
  /* 0x0184 */ unsigned long SuspendCount;
  /* 0x0188 */ union _LARGE_INTEGER LastSuspendTime;
  /* 0x0190 */ union _LARGE_INTEGER LastCancelTime;
  /* 0x0198 */ unsigned __int64 LastResumeLatencyMs;
  /* 0x01a0 */ unsigned __int64 TotalResumeLatencyMs;
  /* 0x01a8 */ unsigned __int64 LastSuspendIntervalMs;
  /* 0x01b0 */ unsigned __int64 TotalSuspendedTimeMs;
  /* 0x01b8 */ enum _NDIS_DEVICE_POWER_STATE LastRequestedIdlePowerState;
  /* 0x01c0 */ struct _NDIS_NAPS_TELEMETRY_DATA TelemetryData;
} NDIS_SELECTIVE_SUSPEND, *PNDIS_SELECTIVE_SUSPEND; /* size: 0x0550 */
