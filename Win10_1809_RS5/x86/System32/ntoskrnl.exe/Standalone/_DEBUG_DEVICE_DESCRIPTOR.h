...
typedef struct _DEBUG_DEVICE_DESCRIPTOR
{
  ...
  /* 0x0080 */ unsigned short PortType;
  /* 0x0082 */ unsigned short PortSubtype;
  /* 0x0084 */ void* OemData;
  /* 0x0088 */ unsigned long OemDataLength;
  /* 0x008c */ enum KD_NAMESPACE_ENUM NameSpace;
  /* 0x0090 */ wchar_t* NameSpacePath;
  /* 0x0094 */ unsigned long NameSpacePathLength;
  /* 0x0098 */ unsigned long TransportType;
  /* 0x009c */ struct _DEBUG_TRANSPORT_DATA TransportData;
