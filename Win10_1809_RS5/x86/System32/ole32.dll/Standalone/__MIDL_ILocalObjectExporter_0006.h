...
typedef struct __MIDL_ILocalObjectExporter_0006
{
  ...
  /* 0x0040 */ enum __MIDL_ILocalObjectExporter_0005 clientDependencyBehavior;
  /* 0x0044 */ struct HSTRING__* packageFullName;
  /* 0x0048 */ struct HSTRING__* userSid;
  /* 0x004c */ struct HSTRING__* appcontainerSid;
} _MIDL_ILocalObjectExporter_0006, *P_MIDL_ILocalObjectExporter_0006; /* size: 0x0050 */
