typedef struct _CERT_CHAIN_ENGINE_CONFIG
{
  ...
  /* 0x0028 */ void* hExclusiveRoot;
  /* 0x002c */ void* hExclusiveTrustedPeople;
  /* 0x0030 */ unsigned long dwExclusiveFlags;
} CERT_CHAIN_ENGINE_CONFIG, *PCERT_CHAIN_ENGINE_CONFIG; /* size: 0x0034 */
