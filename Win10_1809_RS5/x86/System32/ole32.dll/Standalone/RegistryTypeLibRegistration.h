...
{
  /* 0x001c */ struct _GUID _typeLibId;
  /* 0x002c */ wchar_t _version[256];
  /* 0x022c */ unsigned long _localeId;
  /* 0x0230 */ class Microsoft::WRL::ComPtr<ReferencedRegistryKey> _versionKey;
  /* 0x0234 */ class RegistryKey _localeKey;
}; /* size: 0x0238 */
