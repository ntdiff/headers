...
{
  /* 0x001c */ class Microsoft::WRL::Wrappers::CriticalSection m_CallCS;
  /* 0x0034 */ class CancellableCall* m_pOutstandingCalls;
  /* 0x0038 */ struct _TP_TIMER* m_pCancellationTimer;
  /* 0x003c */ volatile BOOL m_fTaskActive;
  /* 0x0040 */ volatile unsigned long m_dwCancellationThreadId;
  /* 0x0044 */ BOOL m_fReleaseOnTimeout;
  /* 0x0048 */ class Microsoft::WRL::ComPtr<IOSTaskCompletion> m_spTaskCompletion;
}; /* size: 0x004c */
