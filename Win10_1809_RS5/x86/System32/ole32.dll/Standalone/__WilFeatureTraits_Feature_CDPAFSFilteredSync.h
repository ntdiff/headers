...
typedef struct __WilFeatureTraits_Feature_CDPAFSFilteredSync
{
  union
  {
...
} _WilFeatureTraits_Feature_CDPAFSFilteredSync, *P_WilFeatureTraits_Feature_CDPAFSFilteredSync; /* size: 0x0001 */
