...
typedef struct _POP_FX_DRIVER_CALLBACKS
{
  ...
  /* 0x0040 */ void* DirectedPowerTransitionCallback /* function */;
} POP_FX_DRIVER_CALLBACKS, *PPOP_FX_DRIVER_CALLBACKS; /* size: 0x0048 */
...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x00b8 */ void* DriverContext;
  /* 0x00c0 */ struct _LIST_ENTRY AcpiLink;
  /* 0x00d0 */ struct _UNICODE_STRING DeviceId;
  /* 0x00e0 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x0100 */ struct _IO_REMOVE_LOCK AcpiRemoveLock;
  /* 0x0120 */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x0158 */ unsigned __int64 IdleLock;
  /* 0x0160 */ struct _KTIMER IdleTimer;
  /* 0x01a0 */ struct _KDPC IdleDpc;
  /* 0x01e0 */ unsigned __int64 IdleTimeout;
  /* 0x01e8 */ unsigned __int64 IdleStamp;
  /* 0x01f0 */ struct _DEVICE_OBJECT* NextIrpDeviceObject[2];
  /* 0x0200 */ union _POWER_STATE NextIrpPowerState[2];
  /* 0x0208 */ void* NextIrpCallerCompletion[2] /* function */;
  /* 0x0218 */ void* NextIrpCallerContext[2];
  /* 0x0228 */ struct _KEVENT IrpCompleteEvent;
  /* 0x0240 */ void* PowerOnDumpDeviceCallback /* function */;
  /* 0x0248 */ struct _POP_FX_ACCOUNTING Accounting;
  /* 0x0328 */ volatile unsigned long Flags;
  /* 0x032c */ unsigned long ComponentCount;
  /* 0x0330 */ struct _POP_FX_COMPONENT** Components;
  /* 0x0338 */ unsigned long LogEntries;
  /* 0x0340 */ struct _POP_FX_LOG_ENTRY* Log;
  /* 0x0348 */ volatile long LogIndex;
  /* 0x0350 */ struct _DRIVER_OBJECT* DripsWatchdogDriverObject;
  /* 0x0358 */ struct _POP_FX_DRIPS_WATCHDOG_CONTEXT DripsWatchdogContext;
  /* 0x0380 */ unsigned long DirectedTimeout;
  /* 0x0388 */ struct _POP_FX_WORK_ORDER DirectedWorkOrder;
  /* 0x03c0 */ volatile long DirectedTransitionCallCount;
  /* 0x03c8 */ void* DirectedTransitionCompletionContext;
  /* 0x03d0 */ struct _UNICODE_STRING FriendlyName;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x03e0 */
