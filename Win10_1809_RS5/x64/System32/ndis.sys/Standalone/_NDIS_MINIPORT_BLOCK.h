...
typedef struct _PKTMON_COMPONENT_CONTEXT
{
  ...
  struct /* bitfield */
  {
    /* 0x000c */ unsigned long FlowEnabled : 1; /* bit position: 0 */
    /* 0x000c */ unsigned long DropEnabled : 1; /* bit position: 1 */
  }; /* bitfield */
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x0740 */ void* FakeMac;
  /* 0x0748 */ unsigned long LockDbg;
  /* 0x074c */ unsigned long LockDbgX;
  /* 0x0750 */ void* LockThread;
  /* 0x0758 */ unsigned long InfoFlags;
  /* 0x0760 */ unsigned __int64 TimerQueueLock;
  /* 0x0768 */ struct _KEVENT* ResetCompletedEvent;
  /* 0x0770 */ void* SavedPacketIndicateHandler /* function */;
  /* 0x0778 */ long RegisteredInterrupts;
  /* 0x077c */ unsigned long SetOid;
  /* 0x0780 */ struct _KEVENT CFHCompletedEvent;
  /* 0x0798 */ struct _WORK_QUEUE_ITEM CFHWorkItem;
  /* 0x07b8 */ volatile long CFHWorkItemQueued;
  /* 0x07c0 */ void* DeviceContext;
  /* 0x07c8 */ struct _NDIS_MINIPORT_RSS_PARAMETERS_CACHE* RssParametersBuffer;
  /* 0x07d0 */ unsigned char UsingMSIX;
  /* 0x07d1 */ unsigned char Miniport5InNdis6Mode;
  /* 0x07d2 */ unsigned char Miniport5HasNdis6Component;
  /* 0x07d3 */ unsigned char InitMode;
  /* 0x07d4 */ unsigned char InitModeNotNeededAnymore;
  /* 0x07d5 */ char MediaChangeFilters;
  /* 0x07d6 */ unsigned char CheckPacketFilters;
  /* 0x07d7 */ unsigned char ReceiveFilters;
  ...
  /* 0x08c0 */ struct _NDIS_OID_REQUEST* HookedOidRequest;
  /* 0x08c8 */ void* NextCoOidRequestHandle;
  /* 0x08d0 */ unsigned long Ndis6ProtocolsBound;
  /* 0x08d4 */ unsigned long PmodeOpen6;
  /* 0x08d8 */ enum _NDIS_MINIPORT_STATE State;
  /* 0x08e0 */ struct _KEVENT* AsyncOpCompletionEvent;
  /* 0x08e8 */ int AsyncOpCompletionStatus;
  /* 0x08f0 */ unsigned __int64 MaxXmitLinkSpeed;
  /* 0x08f8 */ unsigned __int64 MaxRcvLinkSpeed;
  /* 0x0900 */ unsigned long SupportedPacketFilters;
  /* 0x0908 */ struct _NDIS_MINIPORT_HANDLERS NoFilter;
  /* 0x09c0 */ struct _NDIS_MINIPORT_HANDLERS Next;
  /* 0x0a78 */ unsigned char ReceivePathEnabled;
  /* 0x0a79 */ unsigned char NormalTopReceive;
  /* 0x0a7c */ enum _NDIS_SEND_PATH_TYPE SendPathType;
  /* 0x0a80 */ enum _NDIS_SEND_PATH_TYPE SavedSendPathType;
  /* 0x0a84 */ unsigned char SavedReceivePathEnabled;
  /* 0x0a88 */ unsigned long TimestampFlags;
  /* 0x0a8c */ unsigned long FilterPnPFlags;
  /* 0x0a90 */ unsigned long SupportedStatistics;
  /* 0x0a94 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x0aa8 */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x0ab0 */ struct _LIST_ENTRY PortList;
  /* 0x0ac0 */ unsigned char* AllocatedPortIndices;
  /* 0x0ac8 */ unsigned long AllocatedPortIndicesLength;
  /* 0x0acc */ unsigned long NumberOfPorts;
  /* 0x0ad0 */ unsigned long NumberOfActivePorts;
  /* 0x0ad8 */ unsigned __int64 MiniportXmitLinkSpeed;
  /* 0x0ae0 */ unsigned __int64 MiniportRcvLinkSpeed;
  /* 0x0ae8 */ struct _NDIS_TIMER InitModeTimeoutTimer;
  /* 0x0b68 */ struct _NDIS_WORK_ITEM InitModeTimeoutWorkItem;
  /* 0x0bb8 */ struct _KEVENT InitModeTimeoutTimerQueuedEvent;
  /* 0x0bd0 */ unsigned long DataBackFillSize;
  /* 0x0bd4 */ unsigned long ContextBackFillSize;
  /* 0x0bd8 */ struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;
  /* 0x0c30 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;
  /* 0x0c44 */ unsigned long NsiOpenReferences;
  /* 0x0c48 */ void* ProcessingOpen;
  /* 0x0c50 */ struct _KEVENT* NsiRequestsCompletedEvent;
  ...
  /* 0x0c68 */ struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;
  /* 0x0cf8 */ struct PNDIS_PER_PROCESSOR_SLOT__* PeriodicReceivesNblCountIndex;
  /* 0x0d00 */ enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;
  /* 0x0d04 */ enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;
  /* 0x0d08 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;
  /* 0x0d0c */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;
  /* 0x0d10 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;
  /* 0x0d14 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;
  /* 0x0d18 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;
  /* 0x0d1c */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;
  /* 0x0d20 */ struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;
  /* 0x0d58 */ void* TopNdis5PacketIndicateHandler /* function */;
  /* 0x0d60 */ unsigned long* ndisSupportedOidList;
  /* 0x0d68 */ unsigned long ndisSupportedOidListLength;
  /* 0x0d6c */ unsigned long MsiIntCount;
  /* 0x0d70 */ struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;
  /* 0x0d90 */ unsigned __int64 InvalidFrames;
  /* 0x0d98 */ long PagingPathCount;
  /* 0x0da0 */ struct _LIST_ENTRY ReceiveQueueList;
  /* 0x0db0 */ unsigned char* AllocatedQueueIndices;
  /* 0x0db8 */ unsigned long AllocatedQueueIndicesLength;
  /* 0x0dbc */ unsigned long NumReceiveQueues;
  /* 0x0dc0 */ struct _LIST_ENTRY ReceiveFilterList;
  /* 0x0dd0 */ unsigned char* AllocatedReceiveFilterIndices;
  /* 0x0dd8 */ unsigned long AllocatedReceiveFilterIndicesLength;
  /* 0x0ddc */ unsigned long NumReceiveFilters;
  /* 0x0de0 */ unsigned long EnabledReceiveFilterTypes;
  /* 0x0de4 */ unsigned long EnabledReceiveQueueTypes;
  /* 0x0de8 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterHwCapabilities;
  /* 0x0df0 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterCurrentCapabilities;
  /* 0x0df8 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* TopReceiveFilterCurrentCapabilities;
  /* 0x0e00 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchHwCapabilities;
  /* 0x0e08 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchCurrentCapabilities;
  /* 0x0e10 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* TopNicSwitchCurrentCapabilities;
  /* 0x0e18 */ struct _LIST_ENTRY SharedMemoryBlockList;
  /* 0x0e28 */ void* AllocateSharedMemoryHandler /* function */;
  /* 0x0e30 */ void* FreeSharedMemoryHandler /* function */;
  /* 0x0e38 */ void* AllocateSharedMemoryContext;
  /* 0x0e40 */ struct PCI_MSI_CAPABILITY MsiCaps;
  /* 0x0e58 */ struct PCI_MSIX_CAPABILITY MsiXCaps;
  /* 0x0e68 */ unsigned __int64 NumberOfIndirectionTableChanges;
  /* 0x0e70 */ unsigned int PciDeviceSriovSupport;
  union
  {
    /* 0x0e74 */ unsigned char BeginSavedFields;
    /* 0x0e74 */ unsigned long NumUserOpens;
  }; /* size: 0x0004 */
  /* 0x0e78 */ struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;
  /* 0x0e7c */ unsigned short MediaDisconnectTimeOut;
  /* 0x0e7e */ unsigned short SGMapRegistersNeeded;
  /* 0x0e80 */ unsigned long DriverVerifyFlags;
  /* 0x0e88 */ void* SetBusData /* function */;
  /* 0x0e90 */ void* GetBusData /* function */;
  /* 0x0e98 */ void* BusDataContext;
  /* 0x0ea0 */ enum _INTERFACE_TYPE BusType;
  /* 0x0ea4 */ unsigned long BusNumber;
  /* 0x0ea8 */ unsigned long SlotNumber;
  /* 0x0eb0 */ struct _NDIS_EVENT OpenReadyEvent;
  /* 0x0ec8 */ unsigned long NumAdminOpens;
  /* 0x0ed0 */ struct _NDIS_M_DRIVER_BLOCK* DriverHandle;
  /* 0x0ed8 */ struct _NDIS_BIND_PATHS* BindPaths;
  /* 0x0ee0 */ enum _NDIS_PHYSICAL_MEDIUM MiniportPhysicalMediumType;
  /* 0x0ee8 */ void* SecurityDescriptor;
  /* 0x0ef0 */ struct _UNICODE_STRING BaseName;
  /* 0x0f00 */ struct _UNICODE_STRING MiniportName;
  /* 0x0f10 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0f18 */ struct _DEVICE_OBJECT* PhysicalDeviceObject;
  /* 0x0f20 */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x0f28 */ struct _NDIS_MINIPORT_BLOCK* NextGlobalMiniport;
  /* 0x0f30 */ struct _UNICODE_STRING* pAdapterInstanceName;
  /* 0x0f38 */ unsigned long PnPCapabilities;
  /* 0x0f3c */ enum _DEVICE_POWER_STATE CurrentDevicePowerState;
  /* 0x0f40 */ unsigned __int64 PowerStateLock;
  /* 0x0f48 */ enum _DEVICE_POWER_STATE DriverPowerState;
  /* 0x0f4c */ enum _DEVICE_POWER_STATE PrevDriverPowerState;
  /* 0x0f50 */ struct _NET_BUFFER_LIST* LowPowerRcvReturnNbls;
  /* 0x0f58 */ unsigned long PendingReturnNBLCount;
  /* 0x0f5c */ unsigned char SurpriseRemoveFlushedRcvReturnQueue;
  /* 0x0f60 */ struct NDIS_NBL_TRACKER_HANDLE__* LowPowerRcvReturnNblTracker;
  /* 0x0f68 */ struct _NDIS_PM_ADMIN_CONFIG PMAdminConfig;
  /* 0x0f70 */ struct _KSEMAPHORE PMPatternSemaphore;
  /* 0x0f90 */ struct _KSEMAPHORE PMOffloadSemaphore;
  /* 0x0fb0 */ void* BusInterface;
  /* 0x0fb8 */ unsigned short InstanceNumber;
  /* 0x0fc0 */ void* ConfigurationHandle;
  /* 0x0fc8 */ struct _GUID InterfaceGuid;
  /* 0x0fd8 */ union _NET_LUID_LH NetLuid;
  /* 0x0fe0 */ unsigned char IfBlockAvailable;
  /* 0x0fe8 */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x0ff0 */ struct _KEVENT* IfBlockPointerRefZeroEvent;
  /* 0x0ff8 */ unsigned int IfIndex;
  /* 0x0ffc */ enum _NET_IF_ADMIN_STATUS AdminStatus;
  /* 0x1000 */ enum _NET_IF_OPER_STATUS OperStatus;
  /* 0x1004 */ unsigned long OperStatusFlags;
  union
  {
    /* 0x1008 */ void* SendHandler /* function */;
    /* 0x1008 */ void* WanSendHandler /* function */;
  }; /* size: 0x0008 */
  /* 0x1010 */ struct NDIS_NBL_TRACKER_HANDLE__* NblTracker;
  /* 0x1018 */ struct _DEVICE_RESET_INTERFACE_STANDARD* ReenumerateSelfInterface;
  /* 0x1020 */ struct _NDIS_MINIPORT_OFFLOAD* Offload;
  /* 0x1028 */ void* NDKBlock;
  /* 0x1030 */ void* AddDeviceContext;
  /* 0x1038 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x1058 */ struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;
  /* 0x1068 */ unsigned long PhysicalMediumInInf;
  /* 0x1070 */ class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > ExportName;
  /* 0x1078 */ class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > FilterClass;
  /* 0x1080 */ void* StatusProcessingThread;
  /* 0x1088 */ unsigned long StatusProcessingDbgX;
  /* 0x1090 */ struct _UNICODE_STRING FdoName;
  /* 0x10a0 */ struct _KEVENT PowerD0CompleteEvent;
  /* 0x10b8 */ long LastD0CompleteStatus;
  /* 0x10bc */ enum _NDIS_MINIPORT_EVENT LastD0Reason;
  /* 0x10c0 */ unsigned long DirectOidRequestCount;
  /* 0x10c8 */ struct _KEVENT* AllDirectRequestsCompletedEvent;
  /* 0x10d0 */ struct _NDIS_HD_SPLIT_CURRENT_CONFIG* HDSplitCurrentConfig;
  /* 0x10d8 */ void* MSIXConfigContext;
  /* 0x10e0 */ void* SetMSIXTableEntry /* function */;
  /* 0x10e8 */ void* MaskMSIXTableEntry /* function */;
  /* 0x10f0 */ void* UnmaskMSIXTableEntry /* function */;
  /* 0x10f8 */ struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;
  /* 0x1118 */ struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;
  /* 0x1138 */ struct _NDIS_RECEIVE_QUEUE_BLOCK* DefaultReceiveQueue;
  /* 0x1140 */ unsigned long MaxNumRssProcessors;
  /* 0x1144 */ struct _PROCESSOR_NUMBER RssBaseProcessor;
  /* 0x1148 */ struct _PROCESSOR_NUMBER RssMaxProcessor;
  /* 0x114c */ enum _NDIS_RSS_PROFILE RssProfile;
  /* 0x1150 */ unsigned short NumaNodeId;
  /* 0x1158 */ unsigned short* NumaDistances;
  /* 0x1160 */ struct _UNICODE_STRING* pModifiedInstanceName;
  /* 0x1168 */ unsigned long SyncFlags;
  /* 0x116c */ unsigned long WSyncFlags;
  /* 0x1170 */ unsigned long InterlockedFlags;
  /* 0x1178 */ struct _ULONG_REFERENCE Ref;
  /* 0x1188 */ struct _NDIS_SELECTIVE_SUSPEND* SelectiveSuspend;
  /* 0x1190 */ struct _NDIS_MINIPORT_AOAC* AoAc;
  /* 0x1198 */ enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;
  /* 0x11a0 */ struct NDIS_EVENT_LOG_HANDLE__* PnpEventLog;
  /* 0x11a8 */ struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;
  /* 0x1200 */ struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS* PhysicalPerformanceCounters;
  /* 0x1208 */ union _LARGE_INTEGER TimeOfInitialization;
  /* 0x1210 */ union _LARGE_INTEGER LastSystemSleepTime;
  /* 0x1218 */ unsigned __int64 TotalSystemSleepTimeMs;
  /* 0x1220 */ struct _NDIS_SRIOV_CAPABILITIES* SriovHwCapabilities;
  /* 0x1228 */ struct _NDIS_SRIOV_CAPABILITIES* SriovCurrentCapabilities;
  /* 0x1230 */ unsigned __int64 InvalidateBlockMask;
  /* 0x1238 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x1240 */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x1248 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x1250 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x1268 */ unsigned short InvalidateVfId;
  /* 0x126a */ unsigned char InvalidateBlockCancelling;
  /* 0x1270 */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x1278 */ unsigned long NumSwitches;
  /* 0x1280 */ struct _LIST_ENTRY NicSwitchList;
  /* 0x1290 */ unsigned long NumAllocatedVFs;
  /* 0x1298 */ struct _LIST_ENTRY VFList;
  /* 0x12a8 */ unsigned long NumActiveVPorts;
  /* 0x12b0 */ struct _LIST_ENTRY VPortList;
  /* 0x12c0 */ unsigned char* AllocatedVPortIndices;
  /* 0x12c8 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x12d0 */ void* SetVirtualFunctionData /* function */;
  /* 0x12d8 */ void* GetVirtualFunctionData /* function */;
  /* 0x12e0 */ void* EnableVirtualization /* function */;
  /* 0x12e8 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x12f0 */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x12f8 */ void* VirtInterfaceContext;
  /* 0x1300 */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x1310 */ void* VpciInterfaceDereference /* function */;
  /* 0x1318 */ void* WriteVfConfigBlock /* function */;
  /* 0x1320 */ void* ReadVfConfigBlock /* function */;
  /* 0x1328 */ void* VpciInterfaceContext;
  /* 0x1330 */ unsigned int VfSerialNumber;
  /* 0x1334 */ struct _LUID SriovLuid;
  /* 0x1340 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x1348 */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x1350 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x1358 */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x1360 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x1368 */ unsigned long QosOperationalParametersBufferSize;
  /* 0x1370 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x1378 */ unsigned long QosRemoteParametersBufferSize;
  /* 0x1380 */ unsigned __int64 DeviceFlags;
  /* 0x1388 */ void* VerifierContext;
  /* 0x1390 */ struct _WORK_QUEUE_ITEM SurpriseRemovalWorkItem;
  /* 0x13b0 */ struct Ndis::BindStack Bindings;
  /* 0x1418 */ struct Ndis::BindEngine BindEngine;
  /* 0x1490 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x14b8 */ BOOL PmInterruptedByPnp;
  /* 0x14b9 */ BOOL DoNotBlockOnMiniportLock;
  /* 0x14ba */ BOOL PoFxDStateReportingEnabled;
  /* 0x14c0 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x14c8 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x14e8 */ BOOL InterfaceUpdateInProgress;
  /* 0x14e9 */ BOOL MacAddressUpdateQueued;
  /* 0x14ea */ BOOL MtuUpdateQueued;
  /* 0x14ec */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x1510 */ unsigned long PendingMtuSize;
  /* 0x1518 */ wchar_t* PnPInstanceId;
  /* 0x1520 */ struct RECORDER_LOG__* BlackBoxHandle;
  /* 0x1528 */ struct _KEVENT* PowerCompleteEvent;
  /* 0x1530 */ long PowerCompleteStatus;
  /* 0x1538 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x1560 */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x1588 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x1590 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x1598 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > ReenumerateWatchdog;
  /* 0x15a0 */ struct _NDIS_PD_BLOCK* PDBlock;
  /* 0x15a8 */ void* PdcHandle;
  /* 0x15b0 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x1630 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x1680 */ volatile long PdcTaskClientMode;
  /* 0x1684 */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x1688 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x1690 */ volatile long RssV2CompletionCount;
  /* 0x1698 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x16b0 */ unsigned char RssV2Initialized;
  /* 0x16b8 */ struct _LIST_ENTRY SynchronousOidCalls;
  /* 0x16c8 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCapabilities;
  /* 0x16d0 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCurrentConfig;
  /* 0x16d8 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopTimestampConfig;
  /* 0x16e0 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopHwTimestampCapabilities;
  /* 0x16e8 */ struct _PKTMON_COMPONENT_CONTEXT PktMonComp;
  /* 0x16f8 */ struct _PKTMON_EDGE_CONTEXT PktMonEdge;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x1710 */
