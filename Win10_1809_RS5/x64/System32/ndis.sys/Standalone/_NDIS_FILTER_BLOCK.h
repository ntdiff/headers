...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0290 */ void* TcpOffloadReceiveReturnHandler /* function */;
  /* 0x0298 */ struct NDIS_NBL_TRACKER_HANDLE__* NblTracker;
  /* 0x02a0 */ struct _NDIS_FILTER_TASK_OFFLOAD* Offload;
  /* 0x02a8 */ struct _GUID InterfaceGuid;
  /* 0x02b8 */ unsigned long IfIndex;
  /* 0x02c0 */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x02c8 */ void* NextDirectRequestHandle;
  /* 0x02d0 */ unsigned long DirectOidRequestCount;
  /* 0x02d8 */ struct _SINGLE_LIST_ENTRY WOLPatternList;
  /* 0x02e0 */ struct _SINGLE_LIST_ENTRY PMProtocolOffloadList;
  /* 0x02e8 */ struct _NDIS_PM_PARAMETERS PMCurrentParameters;
  /* 0x0300 */ struct NDIS_BIND_FILTER_LINK* Bind;
  /* 0x0308 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCapabilities;
  /* 0x0310 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCurrentConfig;
  /* 0x0318 */ void* VerifierContext;
  /* 0x0320 */ struct _PKTMON_COMPONENT_CONTEXT PktMonComp;
  /* 0x0330 */ struct _PKTMON_EDGE_CONTEXT PktMonEdgeLower;
  /* 0x0348 */ struct _PKTMON_EDGE_CONTEXT PktMonEdgeUpper;
} NDIS_FILTER_BLOCK, *PNDIS_FILTER_BLOCK; /* size: 0x0360 */
