...
class wil::details::unique_storage<wil::details::resource_policy<unsigned __int64 *,void __cdecl(unsigned __int64 *) noexcept,&wil::details::ReleaseSpinLockFromDpcLevel,wistd::integral_constant<unsigned __int64,2>,unsigned __int64 *,0,std::nullptr_t> >;
enum SCOPE_LEVEL;
...
class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned __int64 *,void __cdecl(unsigned __int64 *) noexcept,&wil::details::ReleaseSpinLockFromDpcLevel,wistd::integral_constant<unsigned __int64,2>,unsigned __int64 *,0,std::nullptr_t> > >;
...
class wil::details::unique_storage<wil::details::resource_policy<unsigned __int64 *,void __cdecl(wil::details::kspin_lock_saved_irql const &),&wil::details::kspin_lock_saved_irql::Release,wistd::integral_constant<unsigned __int64,2>,wil::details::kspin_lock_saved_irql,0,std::nullptr_t> >;
class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned __int64 *,void __cdecl(wil::details::kspin_lock_saved_irql const &),&wil::details::kspin_lock_saved_irql::Release,wistd::integral_constant<unsigned __int64,2>,wil::details::kspin_lock_saved_irql,0,std::nullptr_t> > >;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x10be */ char Padding_50[2];
  /* 0x10c0 */ unsigned long DirectOidRequestCount;
  /* 0x10c4 */ long Padding_51;
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_174[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_175[12];
...
typedef struct _NDIS_IF_COMPARTMENT_BLOCK
{
  ...
  /* 0x0014 */ long Padding_307;
  /* 0x0018 */ struct _LIST_ENTRY NetworkLink;
  /* 0x0028 */ unsigned long Flags;
  /* 0x002c */ long Ref;
  /* 0x0030 */ long UserRef;
  /* 0x0034 */ long Padding_308;
...
{
  /* 0x0000 */ long Padding_413[8];
  /* 0x0020 */ unsigned long ItemLength;
  /* 0x0024 */ long Padding_414;
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_426;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_427[2];
...
{
  /* 0x0000 */ long Padding_556[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_557;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_558;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
