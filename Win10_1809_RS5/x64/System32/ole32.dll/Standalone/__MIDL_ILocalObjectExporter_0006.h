...
typedef struct __MIDL_ILocalObjectExporter_0006
{
  ...
  /* 0x0048 */ enum __MIDL_ILocalObjectExporter_0005 clientDependencyBehavior;
  /* 0x0050 */ struct HSTRING__* packageFullName;
  /* 0x0058 */ struct HSTRING__* userSid;
  /* 0x0060 */ struct HSTRING__* appcontainerSid;
} _MIDL_ILocalObjectExporter_0006, *P_MIDL_ILocalObjectExporter_0006; /* size: 0x0068 */
