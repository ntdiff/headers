...
typedef struct __WilFeatureTraits_Feature_SuspendPerAppBroker
{
  union
  {
...
} _WilFeatureTraits_Feature_SuspendPerAppBroker, *P_WilFeatureTraits_Feature_SuspendPerAppBroker; /* size: 0x0001 */
