...
typedef struct _SECTION_INTERNAL_IMAGE_INFORMATION
{
  ...
  union
  {
    /* 0x0030 */ unsigned long ExtendedFlags;
    struct /* bitfield */
    {
      /* 0x0030 */ unsigned long ImageExportSuppressionEnabled : 1; /* bit position: 0 */
      /* 0x0030 */ unsigned long ImageCetShadowStacksReady : 1; /* bit position: 1 */
      /* 0x0030 */ unsigned long ImageXfgEnabled : 1; /* bit position: 2 */
      /* 0x0030 */ unsigned long ImageCetShadowStacksStrictMode : 1; /* bit position: 3 */
      /* 0x0030 */ unsigned long ImageCetSetContextIpValidationRelaxedMode : 1; /* bit position: 4 */
      /* 0x0030 */ unsigned long ImageCetDynamicApisAllowInProc : 1; /* bit position: 5 */
      /* 0x0030 */ unsigned long ImageCetDowngradeReserved1 : 1; /* bit position: 6 */
      /* 0x0030 */ unsigned long ImageCetDowngradeReserved2 : 1; /* bit position: 7 */
      /* 0x0030 */ unsigned long Reserved : 24; /* bit position: 8 */
    }; /* bitfield */
  }; /* size: 0x0004 */
} SECTION_INTERNAL_IMAGE_INFORMATION, *PSECTION_INTERNAL_IMAGE_INFORMATION; /* size: 0x0034 */
