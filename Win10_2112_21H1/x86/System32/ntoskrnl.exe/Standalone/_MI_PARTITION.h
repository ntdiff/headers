...
typedef struct _MI_PARTITION_ZEROING
{
  ...
  /* 0x0010 */ unsigned char ThreadPriorityStatic;
  /* 0x0011 */ unsigned char AdaptiveZeroingEnabled;
  /* 0x0014 */ long ZeroFreePageSlistMinimum;
  /* 0x0018 */ struct _WORK_QUEUE_ITEM RebalanceZeroFreeWorkItem;
  /* 0x0028 */ volatile long NodeCount;
  /* 0x002c */ volatile long BackgroundZeroingDisabled;
  /* 0x0030 */ struct _KGATE LargeBootZeroingComplete;
  /* 0x0040 */ struct _MI_WRITE_CALIBRATION WriteCalibration;
  /* 0x0058 */ unsigned char IpiCalibrationFailed;
  /* 0x005c */ volatile long ActiveProcessorsForIpiCalibration;
  /* 0x0060 */ volatile long NodesReadyForIpiCalibration;
  /* 0x0064 */ struct _KEVENT ReleaseNodeZeroingThreads;
  /* 0x0074 */ struct _MI_ZERO_THREAD_CONTEXT* ThreadContext;
} MI_PARTITION_ZEROING, *PMI_PARTITION_ZEROING; /* size: 0x0078 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0e20 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x0f00 */ void* WorkingSetControl;
  /* 0x0f04 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x0f0c */ unsigned long SessionDetachTimeStamp;
  /* 0x0f40 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x1b40 */
