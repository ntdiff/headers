...
typedef struct _MI_SLAB_ALLOCATOR_CONTEXT
{
  ...
  /* 0x0034 */ unsigned long NumaNodeIndex;
  union
  {
    union
    {
  ...
  /* 0x0098 */ unsigned __int64 LastReplenishTime;
  /* 0x00a0 */ unsigned __int64 LastFailureTime;
} MI_SLAB_ALLOCATOR_CONTEXT, *PMI_SLAB_ALLOCATOR_CONTEXT; /* size: 0x00a8 */
...
typedef struct _MI_NODE_INFORMATION
{
  ...
  /* 0x57c0 */ struct _RTL_BITMAP FreePageListHeadsBitmap[2];
  /* 0x57e0 */ unsigned long FreePageListHeadsBitmapBuffer[16];
  /* 0x5820 */ volatile unsigned __int64 FreeCount[2];
  /* 0x5830 */ unsigned __int64 TotalPages[4];
  /* 0x5850 */ unsigned __int64 TotalPagesEntireNode;
  /* 0x5858 */ struct _MI_PARTITION* Partition;
  /* 0x5860 */ unsigned long CurrentHugeRangeColor;
  /* 0x5868 */ unsigned __int64 TotalHugeIoPages;
  /* 0x5870 */ struct _RTL_AVL_TREE HugePfnBadPages;
  /* 0x5878 */ unsigned __int64 HugeIoRangeFreeCount[4][2];
  /* 0x58b8 */ unsigned long MmShiftedColor;
  /* 0x58bc */ unsigned long Color;
  /* 0x58c0 */ volatile unsigned __int64 ChannelFreeCount[2][4];
  struct
  {
    struct /* bitfield */
    {
      /* 0x5900 */ unsigned long ChannelsHotCold : 1; /* bit position: 0 */
      /* 0x5900 */ unsigned long Spare : 31; /* bit position: 1 */
    }; /* bitfield */
  } /* size: 0x0004 */ Flags;
  /* 0x5904 */ unsigned long LargeListMoveInProgress;
  /* 0x5908 */ struct _MI_LARGE_PAGE_LISTS_CHANGING* LargeListWaiters;
  /* 0x5910 */ struct _EX_PUSH_LOCK NodeLock;
  /* 0x5918 */ unsigned __int64 ZeroThreadHugeMapLock;
  /* 0x5920 */ unsigned char ChannelStatus;
  /* 0x5921 */ unsigned char ChannelOrdering[4];
  /* 0x5925 */ unsigned char LockedChannelOrdering[4];
  /* 0x5929 */ unsigned char PowerAttribute[4];
  /* 0x5940 */ volatile long LargePageLock;
  /* 0x5944 */ struct _MI_PAGE_COLORS PageColorTable[3];
  /* 0x5978 */ unsigned __int64 NumberOfPagesGoingBad;
  /* 0x5980 */ void* BootZeroContext;
  /* 0x5988 */ void* ZeroingVaBase;
  /* 0x5990 */ unsigned __int64 TotalBytesToZero;
  /* 0x5998 */ unsigned __int64 PerProcessorNumberOfBytesToZero;
  /* 0x59a0 */ void* ZeroingContext;
  /* 0x59a8 */ volatile unsigned long ZeroingProcessorCount;
  /* 0x59ac */ volatile long ZeroHand;
  /* 0x59b0 */ volatile long FinishedProcessors;
  /* 0x59b4 */ unsigned char BackgroundZeroingActive;
  /* 0x59b5 */ unsigned char ZeroThreadsReady;
  /* 0x59b8 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* ZeroingPhysicalMemoryBlock;
  /* 0x59c0 */ struct _CACHED_KSTACK_LIST CachedKernelStacks[3];
  /* 0x5a20 */ struct _CACHED_KSTACK_LIST CachedKernelShadowStackLists[3];
  /* 0x5a80 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[7];
  /* 0x5f40 */ struct _MMPFNLIST EnclavePageListHead;
  /* 0x5f98 */ long __PADDING__[10];
} MI_NODE_INFORMATION, *PMI_NODE_INFORMATION; /* size: 0x5fc0 */
