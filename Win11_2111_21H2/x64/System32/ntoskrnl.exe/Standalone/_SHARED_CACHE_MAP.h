...
typedef struct _SHARED_CACHE_MAP
{
  ...
  /* 0x0224 */ unsigned long IdealNodeForWriteBehind;
  /* 0x0228 */ unsigned long IdealNodeNumber;
  /* 0x0230 */ struct _LIST_ENTRY VolSharedCacheMapLinks;
  /* 0x0240 */ struct _LIST_ENTRY VolLoggedStreamLinks;
  /* 0x0250 */ struct _PRIVATE_VOLUME_CACHEMAP* PrivateVolumeCacheMap;
} SHARED_CACHE_MAP, *PSHARED_CACHE_MAP; /* size: 0x0258 */
