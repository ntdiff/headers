...
typedef struct _CC_PARTITION
{
  ...
  /* 0x0050 */ struct _CC_NUMA_NODE* NumaNodeBlock[64];
  /* 0x0250 */ struct _LIST_ENTRY CleanSharedCacheMapList;
  /* 0x0260 */ struct _LIST_ENTRY CleanSharedCacheMapWithLogHandleList;
  /* 0x0270 */ struct _SHARED_CACHE_MAP_LIST_CURSOR DirtySharedCacheMapList;
  /* 0x0288 */ struct _SHARED_CACHE_MAP_LIST_CURSOR LazyWriteCursor;
  /* 0x02a0 */ struct _LIST_ENTRY DirtySharedCacheMapWithLogHandleList;
  /* 0x02c0 */ unsigned __int64 PrivateLock;
  /* 0x02c8 */ unsigned long ConsecutiveWorklessLazyScanCount;
  /* 0x02cc */ unsigned char ForcedDisableLazywriteScan;
  ...
  /* 0x0510 */ struct _CC_LWS_PACKET LWSPacket;
