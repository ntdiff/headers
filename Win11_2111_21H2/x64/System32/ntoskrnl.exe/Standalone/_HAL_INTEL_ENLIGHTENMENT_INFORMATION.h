typedef struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
  ...
  /* 0x01e8 */ void* SetRootFaultReportingReady /* function */;
  /* 0x01f0 */ void* ConfigureDeviceDomain /* function */;
  /* 0x01f8 */ void* UnblockDefaultDma /* function */;
  /* 0x0200 */ void* FlushDeviceDomain /* function */;
  /* 0x0208 */ void* FlushDeviceDomainVaList /* function */;
} HAL_INTEL_ENLIGHTENMENT_INFORMATION, *PHAL_INTEL_ENLIGHTENMENT_INFORMATION; /* size: 0x0210 */
