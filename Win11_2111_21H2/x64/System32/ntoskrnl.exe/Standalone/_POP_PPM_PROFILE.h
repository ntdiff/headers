  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x0004 */ unsigned long Spare : 10; /* bit position: 22 */
      }; /* bitfield */
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x00a1 */ unsigned char HeteroDecreaseThreshold[2048];
  /* 0x08a1 */ unsigned char HeteroIncreaseThreshold[2048];
  /* 0x10a1 */ unsigned char Class0FloorPerformance;
  /* 0x10a2 */ unsigned char Class1InitialPerformance;
  /* 0x10a4 */ unsigned long ShortThreadRuntimeThreshold;
  /* 0x10a8 */ enum _KHETERO_CPU_POLICY ThreadPolicies[2];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x10b0 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x2188 */ unsigned __int64 StartTime;
  /* 0x2190 */ unsigned __int64 Count;
  /* 0x2198 */ unsigned __int64 MaxDuration;
  /* 0x21a0 */ unsigned __int64 MinDuration;
  /* 0x21a8 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x21b0 */
