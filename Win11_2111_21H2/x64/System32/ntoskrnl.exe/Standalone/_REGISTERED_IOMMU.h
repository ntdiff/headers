...
} EXT_IOMMU_FUNCTION_TABLE, *PEXT_IOMMU_FUNCTION_TABLE; /* size: 0x0088 */
...
typedef struct _IOMMU_PAGE_HANDLING_DATA
{
  ...
  /* 0x0014 */ unsigned long FaultPacketBytes;
...
typedef struct _REGISTERED_IOMMU
{
  ...
  /* 0x00c0 */ struct _EXT_IOMMU_FUNCTION_TABLE_EXTENDED FunctionTableExtended;
  /* 0x0178 */ unsigned long Flags;
  /* 0x0180 */ struct _LIST_ENTRY PasidTableListHead;
  /* 0x0190 */ struct _IOMMU_PAGE_HANDLING_DATA PageHandling;
  /* 0x01b8 */ unsigned long MaximumDomainIds;
  /* 0x01c0 */ unsigned __int64 DomainIdBitmapLock;
  /* 0x01c8 */ struct _RTL_BITMAP DomainIdBitmap;
  /* 0x01d8 */ unsigned long Capabilities;
  /* 0x01dc */ enum _EXT_IOMMU_KNOWN_IOMMU_TYPE KnownType;
  /* 0x01e0 */ unsigned long PciSegment;
  /* 0x01e4 */ unsigned long PciBus;
  /* 0x01e8 */ struct _PCI_SLOT_NUMBER PciSlot;
  /* 0x01f0 */ union _LARGE_INTEGER MsiAddress;
  /* 0x01f8 */ unsigned __int64 MsiData;
  /* 0x0200 */ unsigned long MaximumAsids;
  /* 0x0204 */ unsigned long FaultPacketBytes;
  /* 0x0208 */ unsigned long Identifier;
  /* 0x0210 */ struct _UNICODE_STRING ResourceId;
  /* 0x0220 */ struct _IOMMU_RESERVED_DEVICE_LIST* ReservedDevices;
} REGISTERED_IOMMU, *PREGISTERED_IOMMU; /* size: 0x0228 */
