...
typedef struct _VOLUME_CACHE_MAP
{
  ...
  /* 0x00cc */ unsigned long VolumeId;
  /* 0x00d0 */ struct _LIST_ENTRY PrivateVolumeList;
  /* 0x00e0 */ struct _CC_VOLUME_TELEMETRY VolumeTelemetry;
} VOLUME_CACHE_MAP, *PVOLUME_CACHE_MAP; /* size: 0x0a20 */
