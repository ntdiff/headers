typedef struct _MM_SESSION_SPACE_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long Filler : 23; /* bit position: 9 */
  }; /* bitfield */
...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0020 */ volatile unsigned __int64 NonPagablePages;
  /* 0x0028 */ volatile unsigned __int64 CommittedPages;
  /* 0x0030 */ void* PagedPoolStart;
  /* 0x0038 */ void* PagedPoolEnd;
  /* 0x0040 */ void* SessionObject;
  /* 0x0048 */ void* SessionObjectHandle;
  /* 0x0050 */ struct _RTL_AVL_TREE ImageTree;
  /* 0x0058 */ unsigned long LocaleId;
  /* 0x005c */ unsigned long AttachCount;
  /* 0x0060 */ struct _KGATE AttachGate;
  /* 0x0078 */ struct _LIST_ENTRY WsListEntry;
  /* 0x0088 */ struct _RTL_BALANCED_NODE WsTreeEntry;
  /* 0x00a0 */ struct _MM_PAGED_POOL_INFO PagedPoolInfo;
  /* 0x00b8 */ unsigned __int64 CombineDomain;
  /* 0x00c0 */ struct _MMSUPPORT_FULL Vm;
  /* 0x0200 */ struct _MMWSL_INSTANCE WorkingSetList;
  /* 0x0240 */ struct _MMSUPPORT_AGGREGATION AggregateSessionWs;
  /* 0x0260 */ void* HeapState;
  /* 0x0268 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0270 */ unsigned long TopLevelPteLockBits[32];
  /* 0x02f0 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x02f8 */ struct _RTL_BITMAP_EX DynamicVaBitMap;
  /* 0x0308 */ unsigned __int64 DynamicVaHint;
  /* 0x0310 */ struct _MMPTE PageTables[1];
  /* 0x0318 */ long PoolBigEntriesInUse;
  /* 0x031c */ volatile long PagedPoolPdeCount;
  /* 0x0320 */ unsigned long DynamicSessionPdeCount;
  /* 0x0328 */ void* PoolTrackTableExpansion;
  /* 0x0330 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x0338 */ void* PoolTrackBigPages;
  /* 0x0340 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x0348 */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x0350 */ enum _IO_SESSION_STATE IoState;
  /* 0x0354 */ unsigned long IoStateSequence;
  /* 0x0358 */ struct _KEVENT IoNotificationEvent;
  /* 0x0370 */ struct _EJOB* ServerSilo;
  /* 0x0378 */ unsigned __int64 CreateTime;
  /* 0x0380 */ void* PoolTags;
  /* 0x0388 */ long __PADDING__[14];
} MM_SESSION_SPACE, *PMM_SESSION_SPACE; /* size: 0x03c0 */
