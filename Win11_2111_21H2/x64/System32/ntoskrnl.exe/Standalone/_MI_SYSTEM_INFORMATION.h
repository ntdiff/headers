...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0378 */ unsigned long HotPatchReserveSize;
...
typedef struct _MI_DRIVER_PAGES_ALLOCATE_STATE
{
  /* 0x0000 */ volatile long Lock;
  /* 0x0004 */ unsigned long RangeBasedAllocationActive;
  /* 0x0008 */ struct _RTL_RB_TREE RangesTree;
  /* 0x0018 */ unsigned __int64 CurrentRangePage;
  /* 0x0020 */ unsigned __int64 RangeRemainingPageCount;
  /* 0x0028 */ struct _RTL_BALANCED_NODE* RangeEntryNodeCache;
  /* 0x0030 */ unsigned __int64 NegativeCacheBasePage;
  /* 0x0038 */ struct _KTIMER FinishTimer;
  /* 0x0078 */ struct _KDPC FinishTimerDpc;
  /* 0x00b8 */ unsigned __int64 PageCount;
  /* 0x00c0 */ unsigned __int64 LastPage;
} MI_DRIVER_PAGES_ALLOCATE_STATE, *PMI_DRIVER_PAGES_ALLOCATE_STATE; /* size: 0x00c8 */
...
typedef struct _MI_SYSTEM_IMAGE_STATE
{
  ...
  /* 0x0030 */ struct _LIST_ENTRY LargePageList;
  /* 0x0040 */ struct _LIST_ENTRY StrongCodeLoadFailureList;
  /* 0x0050 */ struct _KLDR_DATA_TABLE_ENTRY* SystemBase[1];
  ...
  /* 0x0078 */ struct _MM_SYSTEM_PAGE_COUNTS PageCounts;
  /* 0x0088 */ struct _EX_PUSH_LOCK CollidedLock;
  /* 0x0090 */ struct _MI_DRIVER_PAGES_ALLOCATE_STATE PagesAllocateState;
  /* 0x0158 */ struct _RTL_AVL_TREE ImageTree;
  /* 0x0160 */ struct _KLDR_DATA_TABLE_ENTRY* LoadInProgress;
} MI_SYSTEM_IMAGE_STATE, *PMI_SYSTEM_IMAGE_STATE; /* size: 0x0168 */
...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x0190 */ unsigned __int64 HugePageRemoveTracker[512];
  /* 0x1190 */ volatile unsigned __int64 HotAddSequenceNumber;
  /* 0x1198 */ volatile unsigned __int64 SpecialPurposeMemoryTypeId;
  /* 0x11a0 */ unsigned long SpecialPurposeMemoryQueryTypeExtraSpace;
  /* 0x11a4 */ long __PADDING__[7];
} MI_HARDWARE_STATE, *PMI_HARDWARE_STATE; /* size: 0x11c0 */
...
} MI_PAGELIST_STATE, *PMI_PAGELIST_STATE; /* size: 0x0100 */
...
typedef struct _MI_PARTITION_STATE
{
  ...
  /* 0x0a58 */ struct _RTL_BITMAP_EX HugeIoPfnBitMap;
  /* 0x0a68 */ struct _MI_HUGE_PFN* HugePfnDatabase;
...
typedef struct _MI_ERROR_STATE
{
  ...
  /* 0x0088 */ enum _MI_PAGE_HASH_ERROR_BEHAVIOR PageHashErrorBehavior;
  /* 0x008c */ unsigned long PageHashReadErrors;
  /* 0x0090 */ unsigned long PageHashStandbyErrors;
  /* 0x0094 */ unsigned long PageHashTransferErrors;
  /* 0x0098 */ unsigned long PageHashAllocationErrors;
  ...
  /* 0x00f8 */ unsigned char PendingBadPages;
  /* 0x00f9 */ unsigned char FatalGraphicsFailures;
  /* 0x00fa */ unsigned char InitFailure;
  /* 0x00fb */ unsigned char BadPagesInsertSignalState;
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x00b8 */ volatile struct _MI_CACHED_PTES* CachedKernelShadowStackPteHeads;
  /* 0x00c0 */ struct _MI_SYSTEM_PTE_TYPE SystemViewPteInfo;
  /* 0x0118 */ struct _MI_SYSTEM_PTE_TYPE KernelStackPteInfo;
  /* 0x0170 */ struct _MI_SYSTEM_PTE_TYPE KernelShadowStackPteInfo;
  /* 0x01c8 */ unsigned long StackGrowthFailures;
  /* 0x01cc */ unsigned char KernelStackPages;
  /* 0x01cd */ unsigned char TrackPtesAborted;
  /* 0x01ce */ unsigned char AdjustCounter;
  /* 0x01d0 */ volatile long ReservedMappingLock;
  /* 0x01d8 */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x01e0 */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x01e8 */ struct _RTL_AVL_TREE OutswappedKernelStackRoot;
  /* 0x01f0 */ volatile long OutswappedKernelStackLock;
  /* 0x01f8 */ struct _MMPTE* BreakMakePte;
  /* 0x0200 */ struct _MI_ULTRA_VA_CONTEXT UltraSpaceContext;
  /* 0x0240 */ unsigned long NumberOfUltraMdlMaps;
  /* 0x0248 */ struct _MI_ULTRA_MDL_NODE* UltraMdlNodeMappings;
  /* 0x0250 */ long __PADDING__[12];
} MI_SYSTEM_PTE_STATE, *PMI_SYSTEM_PTE_STATE; /* size: 0x0280 */
...
{
  /* 0x0000 */ unsigned long UserHotPatchReserveSize;
  /* 0x0008 */ struct _RTL_AVL_TREE UserSidPatchLists;
  /* 0x0010 */ struct _RTL_AVL_TREE GlobalHotPatchList;
  ...
  /* 0x0040 */ volatile char ReadyForPatchOperations;
  struct /* bitfield */
  {
    /* 0x0044 */ unsigned long HotPatchingEnabled : 1; /* bit position: 0 */
    /* 0x0044 */ unsigned long EnforcePatchSequenceNumbers : 1; /* bit position: 1 */
    /* 0x0044 */ unsigned long Spare : 30; /* bit position: 2 */
  }; /* bitfield */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0a48 */ unsigned __int64 SystemVaTypeCount[17];
  /* 0x0ad0 */ unsigned char SystemVaType[256];
  /* 0x0bd0 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[14];
  /* 0x0cb0 */ long __PADDING__[4];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x05a8 */ struct _MI_SESSION_STATE Sessions;
  /* 0x1600 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1680 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x2840 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x2d40 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x2d60 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x2e80 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x3940 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x39b8 */ struct _MI_ERROR_STATE Errors;
  /* 0x3ac0 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x3b40 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x3c60 */ struct _MI_STANDBY_STATE Standby;
  /* 0x3e00 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x4080 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x4140 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x41f0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x42c0 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x4300 */ struct _MI_SYSTEM_ZEROING Zeroing;
  /* 0x4320 */ struct _MI_HOT_PATCH_STATE HotPatch;
  /* 0x4368 */ struct _MI_ENCLAVE_STATE Enclaves;
  /* 0x43b0 */ unsigned __int64 Cookie;
  /* 0x43b8 */ void* volatile* BootRegistryRuns;
  /* 0x43c0 */ volatile long ZeroingDisabled;
  /* 0x43c4 */ unsigned char FullyInitialized;
  /* 0x43c5 */ unsigned char SafeBooted;
  /* 0x43c8 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x4400 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x50c0 */
