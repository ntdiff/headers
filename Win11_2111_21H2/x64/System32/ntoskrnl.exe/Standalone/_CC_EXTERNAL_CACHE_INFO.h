...
typedef struct _CC_EXTERNAL_CACHE_INFO
{
  ...
  /* 0x0030 */ struct _CC_PARTITION* Partition;
  /* 0x0038 */ struct _PRIVATE_VOLUME_CACHEMAP* PrivateVolumeCacheMap;
} CC_EXTERNAL_CACHE_INFO, *PCC_EXTERNAL_CACHE_INFO; /* size: 0x0040 */
