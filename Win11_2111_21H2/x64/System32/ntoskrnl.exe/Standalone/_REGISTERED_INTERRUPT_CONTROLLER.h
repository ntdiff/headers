...
} INTERRUPT_FUNCTION_TABLE, *PINTERRUPT_FUNCTION_TABLE; /* size: 0x00c0 */
...
typedef struct _REGISTERED_INTERRUPT_CONTROLLER
{
  ...
  /* 0x00e0 */ enum _KNOWN_CONTROLLER_TYPE KnownType;
  /* 0x00e4 */ unsigned long Capabilities;
  /* 0x00e8 */ unsigned long Flags;
  /* 0x00ec */ unsigned long MaxPriority;
  /* 0x00f0 */ unsigned long UnitId;
  /* 0x00f8 */ struct _LIST_ENTRY LinesHead;
  /* 0x0108 */ struct _LIST_ENTRY OutputLinesHead;
  /* 0x0118 */ long MinLine;
  /* 0x011c */ long MaxLine;
  /* 0x0120 */ unsigned long MaxClusterSize;
  /* 0x0124 */ unsigned long MaxClusters;
  /* 0x0128 */ unsigned long InterruptReplayDataSize;
  /* 0x012c */ enum _INTERRUPT_PROBLEM Problem;
  /* 0x0130 */ long ProblemStatus;
  /* 0x0138 */ const char* ProblemSourceFile;
  /* 0x0140 */ unsigned long ProblemSourceLine;
  /* 0x0144 */ unsigned long CustomProblem;
  /* 0x0148 */ long CustomProblemStatus;
  /* 0x0150 */ struct _UNICODE_STRING ResourceId;
  /* 0x0160 */ struct POHANDLE__* PowerHandle;
} REGISTERED_INTERRUPT_CONTROLLER, *PREGISTERED_INTERRUPT_CONTROLLER; /* size: 0x0168 */
