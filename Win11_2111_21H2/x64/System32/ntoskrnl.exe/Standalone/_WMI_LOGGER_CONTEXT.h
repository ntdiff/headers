...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  /* 0x03e0 */ struct _RTL_BITMAP HookIdMap;
  /* 0x03f0 */ struct _ETW_STACK_CACHE* StackCache;
  /* 0x03f8 */ struct _ETW_PMC_SUPPORT* PmcData;
  /* 0x0400 */ struct _ETW_LBR_SUPPORT* LbrData;
  /* 0x0408 */ struct _ETW_IPT_SUPPORT* IptData;
  /* 0x0410 */ struct _LIST_ENTRY BinaryTrackingList;
  /* 0x0420 */ struct _WMI_BUFFER_HEADER** ScratchArray;
  /* 0x0428 */ struct _DISALLOWED_GUIDS DisallowedGuids;
  /* 0x0438 */ __int64 RelativeTimerDueTime;
  /* 0x0440 */ struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;
  /* 0x0450 */ struct _EX_TIMER* PeriodicCaptureStateTimer;
  /* 0x0458 */ enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;
  /* 0x0460 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x0468 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x0470 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x0490 */ long CompressionWorkItemState;
  /* 0x0498 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x04a0 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x04a8 */ void* CompressionWorkspace;
  /* 0x04b0 */ long CompressionOn;
  /* 0x04b4 */ unsigned long CompressionRatioGuess;
  /* 0x04b8 */ unsigned long PartialBufferCompressionLevel;
  /* 0x04bc */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x04c0 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x04c8 */ struct _KDPC CompressionDpc;
  /* 0x0508 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0510 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0518 */ union _LARGE_INTEGER BufferCompressDuration;
  /* 0x0520 */ __int64 ReferenceQpcDelta;
  /* 0x0528 */ struct _ETW_EVENT_CALLBACK_CONTEXT* CallbackContext;
  /* 0x0530 */ union _LARGE_INTEGER* LastDroppedTime;
  /* 0x0538 */ union _LARGE_INTEGER* FlushingLastDroppedTime;
  /* 0x0540 */ __int64 FlushingSequenceNumber;
  /* 0x0548 */ struct _ETW_PARTITION_CONTEXT PartitionContext;
  /* 0x0550 */ struct _MDL* BufferMdl;
  /* 0x0558 */ long __PADDING__[2];
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0560 */
