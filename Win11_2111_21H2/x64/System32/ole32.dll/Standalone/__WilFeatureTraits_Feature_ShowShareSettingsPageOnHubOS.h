...
typedef struct __WilFeatureTraits_Feature_ShowShareSettingsPageOnHubOS
{
  union
  {
...
} _WilFeatureTraits_Feature_ShowShareSettingsPageOnHubOS, *P_WilFeatureTraits_Feature_ShowShareSettingsPageOnHubOS; /* size: 0x0001 */
