...
typedef struct __WilFeatureTraits_Feature_FailfastOnHstringOverrelease
{
  union
  {
...
} _WilFeatureTraits_Feature_FailfastOnHstringOverrelease, *P_WilFeatureTraits_Feature_FailfastOnHstringOverrelease; /* size: 0x0001 */
