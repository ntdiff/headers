...
typedef struct __WilFeatureTraits_Feature_ClipboardUserAttribution
{
  union
  {
...
} _WilFeatureTraits_Feature_ClipboardUserAttribution, *P_WilFeatureTraits_Feature_ClipboardUserAttribution; /* size: 0x0001 */
