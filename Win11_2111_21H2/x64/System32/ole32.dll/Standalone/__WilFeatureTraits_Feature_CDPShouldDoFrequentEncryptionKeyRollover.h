...
typedef struct __WilFeatureTraits_Feature_CDPShouldDoFrequentEncryptionKeyRollover
{
  union
  {
...
} _WilFeatureTraits_Feature_CDPShouldDoFrequentEncryptionKeyRollover, *P_WilFeatureTraits_Feature_CDPShouldDoFrequentEncryptionKeyRollover; /* size: 0x0001 */
