...
typedef struct _ENODE
{
  ...
  /* 0x0118 */ struct _WORK_QUEUE_ITEM HotAddProcessorWorkItem;
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0074 */ unsigned long IsolationWidth : 1; /* bit position: 24 */
      /* 0x0074 */ unsigned long Reserved : 7; /* bit position: 25 */
    }; /* bitfield */
  ...
  /* 0x0205 */ unsigned char Spare21[3];
  ...
  /* 0x0460 */ unsigned __int64 EndPadding[4];
...
typedef struct _KSCHEDULER_SUBNODE
{
  ...
  /* 0x0010 */ unsigned __int64 IdleSmtSet;
  /* 0x0018 */ unsigned __int64 NonPairedSmtSet;
  /* 0x0020 */ unsigned __int64 IdleModuleSet;
  /* 0x0028 */ unsigned __int64 IdleCpuSet;
  /* 0x0030 */ long Padding_63[4];
  ...
  /* 0x00ba */ char Padding_65[6];
  /* 0x00c0 */ struct _KHETERO_PROCESSOR_SET* HeteroSets;
  /* 0x00c8 */ unsigned __int64 PpmConfiguredQosSets[6];
  /* 0x00f8 */ unsigned __int64 Pad;
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x012f */ char Padding_66;
  /* 0x0130 */ enum _PROCESSOR_PRESENCE Presence;
  /* 0x0134 */ long Padding_67;
  ...
  /* 0x01f9 */ unsigned char ProvideGuidance;
  /* 0x01fa */ char Padding_69[2];
  ...
  /* 0x0205 */ char Padding_70[3];
  /* 0x0208 */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[6];
  /* 0x02b0 */ unsigned long QosDisableReasons[6];
  /* 0x02c8 */ unsigned short QosEquivalencyMasks[6];
  /* 0x02d4 */ unsigned char QosSupported;
  /* 0x02d5 */ char Padding_71[3];
  /* 0x02d8 */ volatile unsigned long SelectionGeneration;
  /* 0x02dc */ long Padding_72;
  /* 0x02e0 */ struct _PERF_CONTROL_STATE_SELECTION QosSelection[6];
  /* 0x03d0 */ unsigned __int64 PerfChangeTime;
  /* 0x03d8 */ unsigned long PerfChangeIntervalCount;
  /* 0x03dc */ unsigned char Force;
  /* 0x03dd */ unsigned char Update;
  /* 0x03de */ unsigned char Apply;
  /* 0x03df */ char __PADDING__[1];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x03e0 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_80[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_81[2];
...
typedef struct _PROC_PERF_CHECK
{
  ...
  /* 0x00ed */ unsigned char Class0FloorPerfSelection;
  /* 0x00ee */ unsigned char Class1MinimumPerfSelection;
  /* 0x00ef */ char Padding_103;
  /* 0x00f0 */ unsigned long CurrentResponsivenessEvents;
  /* 0x00f4 */ long Padding_104;
...
typedef struct _LDR_DATA_TABLE_ENTRY
{
  ...
  /* 0x011d */ char Padding_119[3];
  /* 0x0120 */ unsigned long CheckSum;
  /* 0x0124 */ long Padding_120;
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0419 */ char Padding_188[7];
  /* 0x0420 */ struct _NLS_STATE* NlsState;
  /* 0x0428 */ struct _RTL_NLS_STATE RtlNlsState;
  /* 0x04e0 */ struct _EX_TIMEZONE_STATE* ExTimeZoneState;
  /* 0x04e8 */ struct _UNICODE_STRING NtSystemRoot;
  /* 0x04f8 */ struct _UNICODE_STRING SiloRootDirectoryName;
  /* 0x0508 */ struct _PSP_STORAGE* Storage;
  /* 0x0510 */ enum _SERVERSILO_STATE State;
  /* 0x0514 */ long ExitStatus;
  /* 0x0518 */ struct _KEVENT* DeleteEvent;
  /* 0x0520 */ struct _SILO_USER_SHARED_DATA* UserSharedData;
  /* 0x0528 */ void* UserSharedSection;
  /* 0x0530 */ struct _WORK_QUEUE_ITEM TerminateWorkItem;
  /* 0x0550 */ unsigned char IsDownlevelContainer;
  /* 0x0551 */ char __PADDING__[7];
} ESERVERSILO_GLOBALS, *PESERVERSILO_GLOBALS; /* size: 0x0558 */
