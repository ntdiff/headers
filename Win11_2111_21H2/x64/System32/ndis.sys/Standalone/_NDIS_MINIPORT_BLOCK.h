...
class KnobNamespace
{
  /* 0x0000 */ const struct _DRIVER_OBJECT* m_driverObject;
  /* 0x0008 */ const struct _CONFIG_KNOB_NAMESPACE m_id;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x16d8 */ class KnobNamespace PollModeConfigKnobsNamespace;
  /* 0x1720 */ class Rtl::KArray<KnobDescriptor,1> PollModeConfigKnobDescriptors;
  /* 0x1730 */ struct _EXECUTION_CONTEXT_RUNTIME_KNOBS PollModeConfigKnobs;
  /* 0x176c */ unsigned char WdfCxPowerManagement;
  /* 0x176d */ char __PADDING__[3];
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x1770 */
