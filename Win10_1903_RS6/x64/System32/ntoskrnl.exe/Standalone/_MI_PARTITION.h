...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0fa0 */ unsigned char RebuildLargePageCandidates;
  /* 0x0fa1 */ unsigned char RebuildLargePageActive;
  ...
  /* 0x0fb8 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[4][2];
  /* 0x1378 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x1388 */ void* HugePfnLists;
  /* 0x1390 */ unsigned __int64 AvailableHugeIoRanges;
  /* 0x1398 */ long __PADDING__[10];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x13c0 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1c00 */ struct _MI_PARTITION_COMMIT Commit;
  ...
  /* 0x1ec0 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x30c0 */
