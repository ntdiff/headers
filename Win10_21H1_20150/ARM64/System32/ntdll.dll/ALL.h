...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x01a3 */ unsigned char Unused;
  /* 0x01a4 */ unsigned char Parked;
  /* 0x01a5 */ unsigned char LongPriorQosPeriod;
  /* 0x01a6 */ char Padding_15[2];
  union
  {
    /* 0x01a8 */ unsigned __int64 SnapTimeLast;
    /* 0x01a8 */ unsigned __int64 EnergyConsumed;
  }; /* size: 0x0008 */
  /* 0x01b0 */ unsigned __int64 ActiveTime;
  /* 0x01b8 */ unsigned __int64 TotalTime;
  /* 0x01c0 */ struct _POP_FX_DEVICE* FxDevice;
  /* 0x01c8 */ unsigned __int64 LastQosTranstionTsc;
  /* 0x01d0 */ unsigned __int64 QosTransitionHysteresis;
  /* 0x01d8 */ enum _KHETERO_CPU_QOS RequestedQosClass;
  /* 0x01dc */ enum _KHETERO_CPU_QOS ResolvedQosClass;
  /* 0x01e0 */ unsigned short QosEquivalencyMask;
  /* 0x01e2 */ char __PADDING__[6];
} PROCESSOR_POWER_STATE, *PPROCESSOR_POWER_STATE; /* size: 0x01e8 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x0b88 */ unsigned __int64 PointerAuthUserIpKey[2];
  /* 0x0b98 */ long __PADDING__[26];
...
typedef struct _KPRCB
{
  ...
  /* 0x11f4 */ long Padding_92[3];
  /* 0x1200 */ struct _PROCESSOR_POWER_STATE PowerState;
  /* 0x13e8 */ struct _KDPC ForceIdleDpc;
  /* 0x1428 */ struct _RTL_HASH_TABLE* DpcRuntimeHistoryHashTable;
  /* 0x1430 */ struct _KDPC* DpcRuntimeHistoryHashTableCleanupDpc;
  /* 0x1438 */ void* CurrentDpcRoutine /* function */;
  /* 0x1440 */ unsigned __int64 CurrentDpcRuntimeHistoryCached;
  /* 0x1448 */ unsigned __int64 CurrentDpcStartTime;
  /* 0x1450 */ struct _KTHREAD* DpcDelegateThread;
  /* 0x1458 */ unsigned long DeviceInterrupts;
  /* 0x145c */ long Padding_93;
  /* 0x1460 */ void* IsrDpcStats;
  /* 0x1468 */ unsigned long KeAlignmentFixupCount;
  /* 0x146c */ long Padding_94;
  /* 0x1470 */ struct _KDPC DpcWatchdogDpc;
  /* 0x14b0 */ struct _KTIMER DpcWatchdogTimer;
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x006c */ unsigned long Reserved : 9; /* bit position: 23 */
    }; /* bitfield */
  ...
  /* 0x0428 */ unsigned __int64 Spare28[4];
  /* 0x0448 */ unsigned __int64 EndPadding[1];
...
typedef struct _PROC_PERF_CHECK
{
  ...
  /* 0x023e */ char Padding_134[2];
  /* 0x0240 */ unsigned long CurrentResponsivenessEvents;
  /* 0x0244 */ long Padding_135;
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_225[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_226[2];
