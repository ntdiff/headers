typedef enum _SKSERVICE
{
  ...
  SECURESERVICE_SECURE_POOL_CREATE = 77,
  SECURESERVICE_SECURE_POOL_DESTROY = 78,
  SECURESERVICE_SECURE_POOL_ALLOCATE = 79,
  SECURESERVICE_SECURE_POOL_FREE = 80,
  SECURESERVICE_SECURE_POOL_UPDATE = 81,
  SECURESERVICE_DEBUG_SWEEP_ICACHE_RANGE = 82,
