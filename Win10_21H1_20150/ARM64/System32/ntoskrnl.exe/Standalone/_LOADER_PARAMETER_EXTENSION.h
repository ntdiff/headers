...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  /* 0x0e10 */ struct _ETW_BOOT_CONFIG EtwBootConfig;
  /* 0x0e28 */ struct _BOOT_FIRMWARE_RAMDISK_INFO* FwRamdiskInfo;
  /* 0x0e30 */ void* IpmiHwContext;
  /* 0x0e38 */ unsigned __int64 PointerAuthKernelIpKey[2];
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0e48 */
