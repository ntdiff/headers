...
typedef struct _KPRCB
{
  ...
  /* 0x90e0 */ unsigned __int64 TransitionShadowStack;
  /* 0x90e8 */ unsigned __int64 KernelShadowStackInitial;
  /* 0x90f0 */ unsigned __int64* IstShadowStacksTable;
  /* 0x90f8 */ unsigned __int64 PrcbPad134;
  ...
  /* 0x9290 */ unsigned char PrcbPad137[64];
  /* 0x92d0 */ unsigned char PrcbPad138[2928];
...
typedef struct _KTHREAD
{
  ...
  /* 0x0420 */ void* KernelShadowStackLimit;
  /* 0x0428 */ unsigned __int64 EndPadding[1];
...
typedef struct _KPROCESS
{
  ...
  /* 0x0408 */ unsigned __int64 EndPadding[6];
...
typedef struct _KNODE
{
  ...
  /* 0x0070 */ long Padding_128[4];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_129;
  union
  {
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x00cf */ char Padding_131;
  /* 0x00d0 */ enum _PROCESSOR_PRESENCE Presence;
  /* 0x00d4 */ long Padding_132;
  ...
  /* 0x0138 */ void* PerfUpdateHwDebugData /* function */;
  /* 0x0140 */ unsigned long MaxFrequency;
  /* 0x0144 */ unsigned long NominalFrequency;
  /* 0x0148 */ unsigned long MaxPercent;
  /* 0x014c */ unsigned long MinPerfPercent;
  /* 0x0150 */ unsigned long MinThrottlePercent;
  /* 0x0154 */ unsigned long AdvertizedMaximumFrequency;
  /* 0x0158 */ unsigned __int64 MinimumRelativePerformance;
  /* 0x0160 */ unsigned __int64 NominalRelativePerformance;
  /* 0x0168 */ unsigned char NominalRelativePerformancePercent;
  /* 0x0169 */ unsigned char Coordination;
  /* 0x016a */ unsigned char HardPlatformCap;
  /* 0x016b */ unsigned char AffinitizeControl;
  /* 0x016c */ unsigned char EfficientThrottle;
  /* 0x016d */ unsigned char AllowSchedulerDirectedPerfStates;
  /* 0x016e */ unsigned char InitiateAllProcessors;
  /* 0x016f */ unsigned char AllowVmPerfSelection;
  /* 0x0170 */ unsigned long VmFrequencyStepMhz;
  /* 0x0174 */ unsigned long VmHighestFrequencyMhz;
  /* 0x0178 */ unsigned long VmNominalFrequencyMhz;
  /* 0x017c */ unsigned long VmLowestFrequencyMhz;
  /* 0x0180 */ unsigned char AutonomousMode;
  /* 0x0181 */ unsigned char ProvideGuidance;
  /* 0x0182 */ char Padding_133[2];
  /* 0x0184 */ unsigned long DesiredPercent;
  /* 0x0188 */ unsigned long GuaranteedPercent;
  /* 0x018c */ unsigned char EngageResponsivenessOverrides;
  /* 0x018d */ char Padding_134[3];
  /* 0x0190 */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[5];
  /* 0x021c */ unsigned long QosDisableReasons[5];
  /* 0x0230 */ unsigned short QosEquivalencyMasks[5];
  /* 0x023a */ unsigned char QosSupported;
  /* 0x023b */ char Padding_135;
  /* 0x023c */ volatile unsigned long SelectionGeneration;
  /* 0x0240 */ struct _PERF_CONTROL_STATE_SELECTION QosSelection[5];
  /* 0x0308 */ unsigned __int64 PerfChangeTime;
  /* 0x0310 */ unsigned long PerfChangeIntervalCount;
  /* 0x0314 */ unsigned char Force;
  /* 0x0315 */ unsigned char Update;
  /* 0x0316 */ unsigned char Apply;
  /* 0x0317 */ char __PADDING__[1];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x0318 */
...
typedef struct _PROC_PERF_CHECK
{
  ...
  /* 0x023e */ char Padding_146[2];
  /* 0x0240 */ unsigned long CurrentResponsivenessEvents;
  /* 0x0244 */ long Padding_147;
...
typedef struct _EPROCESS
{
  ...
  /* 0x0ab8 */ struct _RTL_AVL_TREE DynamicEHContinuationTargetsTree;
  /* 0x0ac0 */ struct _EX_PUSH_LOCK DynamicEHContinuationTargetsLock;
  /* 0x0ac8 */ long __PADDING__[14];
  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x0519 */ unsigned char SessionAttachActive : 1; /* bit position: 7 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_187[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_188[2];
