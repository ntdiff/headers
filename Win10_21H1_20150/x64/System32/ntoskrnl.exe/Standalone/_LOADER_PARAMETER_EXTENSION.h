...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  /* 0x0e38 */ struct _ETW_BOOT_CONFIG EtwBootConfig;
  /* 0x0e50 */ struct _BOOT_FIRMWARE_RAMDISK_INFO* FwRamdiskInfo;
  /* 0x0e58 */ void* IpmiHwContext;
  /* 0x0e60 */ unsigned __int64 IdleThreadShadowStack;
  /* 0x0e68 */ unsigned __int64 TransitionShadowStack;
  /* 0x0e70 */ unsigned __int64* IstShadowStacksTable;
  /* 0x0e78 */ unsigned __int64 ReservedForKernelCet[2];
  /* 0x0e88 */ struct _MEMORY_MIRRORING_DATA* MirroringData;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0e90 */
