...
typedef struct _ETW_SILODRIVERSTATE
{
  ...
  /* 0x1038 */ struct _EX_WNF_SUBSCRIPTION* ContainerRestoreWnfSubscription;
  /* 0x1040 */ struct _GUID PartitionId;
  /* 0x1050 */ struct _GUID ParentId;
  /* 0x1060 */ union _LARGE_INTEGER QpcOffsetFromRoot;
  /* 0x1068 */ char* PartitionName;
  /* 0x1070 */ unsigned short PartitionNameSize;
  /* 0x1072 */ unsigned short UnusedPadding;
  /* 0x1074 */ unsigned long PartitionType;
  /* 0x1078 */ struct _ETW_SYSTEM_LOGGER_SETTINGS SystemLoggerSettings;
  /* 0x11f0 */ struct _KMUTANT EtwpStartTraceMutex;
} ETW_SILODRIVERSTATE, *PETW_SILODRIVERSTATE; /* size: 0x1228 */
