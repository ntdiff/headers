...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0058 */ unsigned long Reserved : 9; /* bit position: 23 */
    }; /* bitfield */
  ...
  /* 0x0264 */ unsigned long Spare28[4];
  /* 0x0274 */ unsigned long Spare29[2];
  /* 0x027c */ unsigned long EndPadding[1];
...
typedef struct _ETHREAD
{
  ...
  /* 0x0508 */ void* CmDbgInfo;
  /* 0x050c */ long __PADDING__[1];
} ETHREAD, *PETHREAD; /* size: 0x0510 */
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x0068 */ unsigned long AdvertizedMaximumFrequency;
  /* 0x006c */ long Padding_56;
...
typedef struct _PROC_PERF_CHECK
{
  ...
  /* 0x023e */ char Padding_65[2];
  /* 0x0240 */ unsigned long CurrentResponsivenessEvents;
  /* 0x0244 */ long Padding_66;
  /* 0x0248 */ unsigned __int64 CyclesByFreqBand[48][3];
} PROC_PERF_CHECK, *PPROC_PERF_CHECK; /* size: 0x06c8 */
