...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0048 */ long Padding_62[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_63[14];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_139;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_140[2];
...
?ndisMAdjustFilters@@YGXPAU_NDIS_MINIPORT_BLOCK@@PAUFILTERDBS@@@Z
