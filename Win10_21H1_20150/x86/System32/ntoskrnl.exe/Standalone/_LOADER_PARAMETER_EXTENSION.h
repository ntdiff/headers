...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  /* 0x0d2c */ struct _ETW_BOOT_CONFIG EtwBootConfig;
  /* 0x0d38 */ struct _BOOT_FIRMWARE_RAMDISK_INFO* FwRamdiskInfo;
  /* 0x0d3c */ void* IpmiHwContext;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0d40 */
