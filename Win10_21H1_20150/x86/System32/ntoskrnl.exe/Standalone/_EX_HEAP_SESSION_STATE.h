...
typedef struct _EX_HEAP_SESSION_STATE
{
  ...
  /* 0x1c78 */ struct RTL_HP_ENV_HANDLE PagedEnv;
  /* 0x1c80 */ struct _SEGMENT_HEAP* PagedHeap;
  /* 0x1c84 */ struct _SEGMENT_HEAP* SpecialPoolHeap;
} EX_HEAP_SESSION_STATE, *PEX_HEAP_SESSION_STATE; /* size: 0x1c88 */
