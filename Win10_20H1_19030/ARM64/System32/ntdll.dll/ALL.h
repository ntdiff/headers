...
typedef struct _KNODE
{
  ...
  /* 0x00b0 */ long Padding_122[20];
  /* 0x0100 */ unsigned long SiblingMask;
  /* 0x0104 */ long Padding_123;
  union
  {
...
typedef struct _EPROCESS
{
  ...
  /* 0x0ac0 */ struct _RTL_AVL_TREE DynamicEHContinuationTargetsTree;
  /* 0x0ac8 */ struct _EX_PUSH_LOCK DynamicEHContinuationTargetsLock;
  /* 0x0ad0 */ long __PADDING__[12];
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_229[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_230[2];
