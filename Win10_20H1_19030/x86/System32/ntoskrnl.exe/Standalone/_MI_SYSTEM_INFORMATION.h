...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x4180 */ struct _MI_ENCLAVE_STATE Enclaves;
  /* 0x41a4 */ unsigned long Cookie;
  /* 0x41a8 */ void* volatile* BootRegistryRuns;
  /* 0x41ac */ volatile long ZeroingDisabled;
  /* 0x41b0 */ unsigned char FullyInitialized;
  /* 0x41b1 */ unsigned char SafeBooted;
  /* 0x41b4 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x41bc */ const struct _tlgProvider_t* TraceLogging;
