...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0e18 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x0ef8 */ void* WorkingSetControl;
  /* 0x0efc */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x0f04 */ unsigned long SessionDetachTimeStamp;
