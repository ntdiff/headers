...
typedef struct _MI_NODE_INFORMATION
{
  ...
  /* 0x0878 */ struct _GROUP_AFFINITY GroupAffinity;
  /* 0x0888 */ unsigned short ProcessorCount;
  /* 0x088a */ unsigned char BackgroundZeroingActive;
  /* 0x0890 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* ZeroingPhysicalMemoryBlock;
  /* 0x0898 */ long __PADDING__[10];
} MI_NODE_INFORMATION, *PMI_NODE_INFORMATION; /* size: 0x08c0 */
