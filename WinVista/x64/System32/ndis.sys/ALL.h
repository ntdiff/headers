...
} NDIS_MINIPORT_DRIVER_CHARACTERISTICS, *PNDIS_MINIPORT_DRIVER_CHARACTERISTICS; /* size: 0x0088 */
...
} NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES, *PNDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES; /* size: 0x00d8 */
...
} NDIS_FILTER_DRIVER_CHARACTERISTICS, *PNDIS_FILTER_DRIVER_CHARACTERISTICS; /* size: 0x00c8 */
...
} NDIS_BIND_PARAMETERS, *PNDIS_BIND_PARAMETERS; /* size: 0x00f8 */
...
typedef struct _NDIS_COMMON_OPEN_BLOCK
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x053c */ long __PADDING__[1];
    }; /* size: 0x0378 */
  }; /* size: 0x0378 */
} NDIS_COMMON_OPEN_BLOCK, *PNDIS_COMMON_OPEN_BLOCK; /* size: 0x0540 */
...
typedef struct _NET_BUFFER_LIST
{
  ...
  /* 0x008c */ int Status;
  /* 0x0090 */ void* NetBufferListInfo[11];
  /* 0x00e8 */ long __PADDING__[2];
} NET_BUFFER_LIST, *PNET_BUFFER_LIST; /* size: 0x00f0 */
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x08a8 */ long Padding_188[2];
  /* 0x08b0 */ unsigned char CombinedRSSParametersBuf[196];
  /* 0x0974 */ long Padding_189[3];
  ...
  /* 0x0bac */ long Padding_195;
  /* 0x0bb0 */ struct _NDIS_MINIPORT_HANDLERS NoFilter;
  /* 0x0c40 */ struct _NDIS_MINIPORT_HANDLERS Next;
  /* 0x0cd0 */ long NumOfPauseRestartRequests;
  /* 0x0cd4 */ unsigned long FilterPnPFlags;
  /* 0x0cd8 */ unsigned long SupportedStatistics;
  /* 0x0cdc */ unsigned long cDpcSendCompletes;
  /* 0x0ce0 */ unsigned long cDpcRcvIndications;
  /* 0x0ce4 */ unsigned long cDpcRcvIndicationCalls;
  /* 0x0ce8 */ unsigned long cDpcNbSendCompletes;
  /* 0x0cec */ unsigned long cDpcNblSendCompletes;
  /* 0x0cf0 */ unsigned long cDpcNblIndications;
  /* 0x0cf4 */ unsigned long cDpcMaxPacketsIndicated;
  /* 0x0cf8 */ unsigned long cDpcTotalDpcCount;
  /* 0x0cfc */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x0d0c */ long Padding_196;
  /* 0x0d10 */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x0d18 */ struct _LIST_ENTRY PortList;
  /* 0x0d28 */ unsigned char* AllocatedPortIndices;
  /* 0x0d30 */ unsigned long AllocatedPortIndicesLength;
  /* 0x0d34 */ unsigned long NumberOfPorts;
  /* 0x0d38 */ unsigned long NumberOfActivePorts;
  /* 0x0d3c */ long Padding_197;
  /* 0x0d40 */ unsigned __int64 MiniportXmitLinkSpeed;
  /* 0x0d48 */ unsigned __int64 MiniportRcvLinkSpeed;
  /* 0x0d50 */ struct _KEVENT RestoreStackTimerEvent;
  /* 0x0d68 */ struct _NDIS_TIMER RestoreStackTimer;
  /* 0x0de8 */ struct _NDIS_WORK_ITEM RestoreStackWorkItem;
  /* 0x0e38 */ unsigned long RestoreStackBindRefCount;
  /* 0x0e3c */ unsigned long ProtocolsToBind;
  /* 0x0e40 */ struct _NDIS_DPC_TRACKER* DpcTrackers;
  /* 0x0e48 */ struct _NDIS_DPC_TRACKER* CurrentDpcTracker;
  /* 0x0e50 */ unsigned char DpcTrackerIndex;
  /* 0x0e51 */ unsigned char SupportedRss;
  /* 0x0e52 */ char Padding_198[6];
  /* 0x0e58 */ unsigned __int64 DpcWatchDogCycleCount;
  /* 0x0e60 */ unsigned long DataBackFillSize;
  /* 0x0e64 */ unsigned long ContextBackFillSize;
  /* 0x0e68 */ unsigned long SupportedPauseFunctions;
  /* 0x0e6c */ long Padding_199;
  /* 0x0e70 */ struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;
  /* 0x0ec8 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;
  /* 0x0ed8 */ long NumOfOpenPauseRestartRequests;
  /* 0x0edc */ long MiniportStackPauseCount;
  /* 0x0ee0 */ unsigned long NsiOpenReferences;
  /* 0x0ee4 */ long Padding_200;
  /* 0x0ee8 */ struct _KEVENT* NsiRequestsCompletedEvent;
  /* 0x0ef0 */ enum _DEVICE_POWER_STATE QueryPowerDeviceState;
  /* 0x0ef4 */ unsigned char MinimumNdisMajorVersion;
  /* 0x0ef5 */ unsigned char MinimumNdisMinorVersion;
  /* 0x0ef6 */ unsigned short NumOfMinimumVersionDrivers;
  /* 0x0ef8 */ struct _NDIS_MINIPORT_STATS* BottomIfStats;
  /* 0x0f00 */ struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;
  /* 0x0f78 */ enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;
  /* 0x0f7c */ enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;
  /* 0x0f80 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;
  /* 0x0f84 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;
  /* 0x0f88 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;
  /* 0x0f8c */ enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;
  /* 0x0f90 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;
  /* 0x0f94 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;
  /* 0x0f98 */ struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;
  /* 0x0fc0 */ void* TopNdis5PacketIndicateHandler /* function */;
  /* 0x0fc8 */ unsigned long* ndisSupportedOidList;
  /* 0x0fd0 */ unsigned long ndisSupportedOidListLength;
  /* 0x0fd4 */ long Padding_201;
  /* 0x0fd8 */ struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;
  /* 0x0ff8 */ unsigned __int64 InvalidFrames;
  union
  {
    /* 0x1000 */ unsigned char BeginSavedFields;
    /* 0x1000 */ unsigned long NumUserOpens;
  }; /* size: 0x0004 */
  /* 0x1004 */ struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;
  /* 0x1008 */ unsigned short MediaDisconnectTimeOut;
  /* 0x100a */ unsigned short SGMapRegistersNeeded;
  /* 0x100c */ unsigned long DriverVerifyFlags;
  /* 0x1010 */ void* SetBusData /* function */;
  /* 0x1018 */ void* GetBusData /* function */;
  /* 0x1020 */ void* BusDataContext;
  /* 0x1028 */ enum _NDIS_INTERFACE_TYPE BusType;
  /* 0x102c */ unsigned long BusNumber;
  /* 0x1030 */ unsigned long SlotNumber;
  /* 0x1034 */ long Padding_202;
  /* 0x1038 */ struct _NDIS_EVENT OpenReadyEvent;
  /* 0x1050 */ unsigned long NumAdminOpens;
  /* 0x1054 */ long Padding_203;
  /* 0x1058 */ struct _NDIS_M_DRIVER_BLOCK* DriverHandle;
  /* 0x1060 */ struct _NDIS_BIND_PATHS* BindPaths;
  /* 0x1068 */ struct _NDIS_BIND_PATHS* LWFilterList;
  /* 0x1070 */ struct _NDIS_PROTOCOL_BLOCK** ProtocolsFailToBind;
  /* 0x1078 */ unsigned long MiniportPhysicalMediumType;
  /* 0x107c */ long Padding_204;
  /* 0x1080 */ struct _NDIS_FILTER_ATTACH_LIST* LWFilterAttachList;
  /* 0x1088 */ unsigned long NumFilters;
  /* 0x108c */ unsigned int NetLuidIndex;
  /* 0x1090 */ struct _KMUTANT LWFilterMutex;
  /* 0x10c8 */ void* SecurityDescriptor;
  /* 0x10d0 */ struct _UNICODE_STRING BaseName;
  /* 0x10e0 */ struct _UNICODE_STRING MiniportName;
  /* 0x10f0 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x10f8 */ struct _DEVICE_OBJECT* PhysicalDeviceObject;
  /* 0x1100 */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x1108 */ struct _NDIS_MINIPORT_BLOCK* NextGlobalMiniport;
  /* 0x1110 */ struct _UNICODE_STRING* pAdapterInstanceName;
  /* 0x1118 */ unsigned long PnPCapabilities;
  /* 0x111c */ enum _DEVICE_POWER_STATE CurrentDevicePowerState;
  /* 0x1120 */ void* BusInterface;
  /* 0x1128 */ unsigned short InstanceNumber;
  /* 0x112a */ char Padding_205[6];
  /* 0x1130 */ void* ConfigurationHandle;
  /* 0x1138 */ struct _GUID InterfaceGuid;
  /* 0x1148 */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x1150 */ unsigned int IfIndex;
  /* 0x1154 */ enum _NET_IF_ADMIN_STATUS AdminStatus;
  /* 0x1158 */ enum _NET_IF_OPER_STATUS OperStatus;
  /* 0x115c */ unsigned long OperStatusFlags;
  union
  {
    /* 0x1160 */ void* SendHandler /* function */;
    /* 0x1160 */ void* WanSendHandler /* function */;
  }; /* size: 0x0008 */
  /* 0x1168 */ struct _NDIS_MINIPORT_OFFLOAD* Offload;
  /* 0x1170 */ void* AddDeviceContext;
  /* 0x1178 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x1198 */ struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;
  /* 0x11a8 */ unsigned char RssEnable;
  /* 0x11a9 */ unsigned char ChimneyEnable;
  /* 0x11aa */ char Padding_206[2];
  /* 0x11ac */ unsigned long PhysicalMediumInInf;
  /* 0x11b0 */ struct _UNICODE_STRING ExportName;
  /* 0x11c0 */ struct _UNICODE_STRING FilterClass;
  /* 0x11d0 */ void* StatusProcessingThread;
  /* 0x11d8 */ unsigned long StatusProcessingDbgX;
  /* 0x11dc */ long Padding_207;
  /* 0x11e0 */ struct _UNICODE_STRING FdoName;
  /* 0x11f0 */ struct _NDIS_MINIPORT_BLOCK* NextOrphanedMiniport;
  /* 0x11f8 */ long __PADDING__[2];
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x1200 */
...
typedef struct _NDIS_IF_BLOCK
{
  ...
  /* 0x0044 */ unsigned long LowerLayerIfCount;
  /* 0x0048 */ unsigned long HigherLayerIfCount;
  /* 0x004c */ long Ref;
  /* 0x0050 */ long MiniportRef;
  /* 0x0054 */ long Padding_220;
  ...
  /* 0x0582 */ char Padding_226[2];
  /* 0x0584 */ unsigned long SupportedStatistics;
} NDIS_IF_BLOCK, *PNDIS_IF_BLOCK; /* size: 0x0588 */

typedef struct _IO_INTERRUPT_MESSAGE_INFO
{
  /* 0x0000 */ unsigned char UnifiedIrql;
  /* 0x0001 */ char Padding_227[3];
...
typedef struct _X_FILTER
{
  ...
  /* 0x0566 */ char Padding_230[2];
  union
  {
    struct
    {
      /* 0x0568 */ unsigned int MaxMulticastAddresses;
      /* 0x056c */ long Padding_231;
...
typedef struct _NDIS_OPEN_BLOCK
{
  ...
  /* 0x0104 */ unsigned long ProtocolOptions;
  /* 0x0108 */ unsigned long CurrentLookahead;
  /* 0x010c */ long Padding_234;
  /* 0x0110 */ void* WSendHandler /* function */;
  /* 0x0118 */ void* WTransferDataHandler /* function */;
  /* 0x0120 */ void* WSendPacketsHandler /* function */;
  /* 0x0128 */ void* CancelSendPacketsHandler /* function */;
  /* 0x0130 */ unsigned long WakeUpEnable;
  /* 0x0134 */ long Padding_235;
  /* 0x0138 */ struct _KEVENT* CloseCompleteEvent;
  /* 0x0140 */ struct _QUEUED_CLOSE QC;
  /* 0x0168 */ long AfReferences;
  /* 0x016c */ long Padding_236;
  /* 0x0170 */ struct _NDIS_OPEN_BLOCK* NextGlobalOpen;
  /* 0x0178 */ struct _NDIS_OPEN_BLOCK* MiniportNextOpen;
  /* 0x0180 */ struct _NDIS_OPEN_BLOCK* ProtocolNextOpen;
  /* 0x0188 */ struct _UNICODE_STRING* BindDeviceName;
  ...
  union
  {
    ...
    {
      /* 0x01a8 */ unsigned int MaxMulticastAddresses;
      /* 0x01ac */ long Padding_237;
      /* 0x01b0 */ struct _ETH_MULTICAST_WRAPPER* MCastAddressBuf;
      /* 0x01b8 */ unsigned int NumAddresses;
      /* 0x01bc */ long Padding_238;
      /* 0x01c0 */ struct _ETH_MULTICAST_WRAPPER* OldMCastAddressBuf;
      /* 0x01c8 */ unsigned int OldNumAddresses;
    }; /* size: 0x001c */
    struct
    {
      ...
      /* 0x01b0 */ unsigned char UsingGroupAddress;
      /* 0x01b1 */ unsigned char OldUsingGroupAddress;
      /* 0x01b2 */ char Padding_239[2];
      /* 0x01b4 */ unsigned long FARefCount[32];
      /* 0x0234 */ unsigned long OldFARefCount[32];
      /* 0x02b4 */ long Padding_240[3];
      /* 0x02c0 */ unsigned char RSSParametersBuf[196];
      /* 0x0384 */ long Padding_241;
      /* 0x0388 */ struct _NDIS_RECEIVE_SCALE_PARAMETERS* NdisRSSParameters;
      /* 0x0390 */ struct _SINGLE_LIST_ENTRY PatternList;
      /* 0x0398 */ void* ProtSendNetBufferListsComplete /* function */;
      /* 0x03a0 */ void* NextSendNetBufferListsComplete /* function */;
      ...
      /* 0x0448 */ void* TcpOffloadReceiveIndicateHandler /* function */;
      /* 0x0450 */ unsigned long ProtocolMajorVersion;
      /* 0x0454 */ long Padding_242;
      /* 0x0458 */ void** IfBlock;
      /* 0x0460 */ struct _NDIS_SPIN_LOCK PnPStateLock;
      /* 0x0470 */ enum _NDIS_NDIS5_DRIVER_STATE PnPState;
      /* 0x0474 */ enum _NDIS_OPEN_TRANSLATION_STATE TranslationState;
      /* 0x0478 */ int OutstandingSends;
      /* 0x047c */ long Padding_243;
      /* 0x0480 */ struct _NDIS_EVENT PauseEvent;
      /* 0x0498 */ void* Ndis5WanSendHandler /* function */;
      /* 0x04a0 */ void* ProtSendCompleteHandler /* function */;
      /* 0x04a8 */ void* OidRequestCompleteHandler /* function */;
      ...
      /* 0x04b8 */ void* SetInfoBuf;
      /* 0x04c0 */ unsigned short SetInfoBufLen;
      /* 0x04c2 */ char Padding_244[2];
      /* 0x04c4 */ unsigned long RequestBuffer;
      /* 0x04c8 */ unsigned long SetInfoOid;
      /* 0x04cc */ long Padding_245;
      /* 0x04d0 */ void* OidContext;
      /* 0x04d8 */ long NumOfPauseRestartRequests;
      /* 0x04dc */ enum _NDIS_OPEN_STATE State;
      /* 0x04e0 */ struct _NDIS_OPEN_OFFLOAD* Offload;
      ...
      /* 0x04f8 */ unsigned long NumberOfNetBufferLists;
      /* 0x04fc */ unsigned char ReceivedAPacket[64];
      /* 0x053c */ long Padding_246;
      /* 0x0540 */ struct _NDIS_CO_AF_BLOCK* NextAf;
      /* 0x0548 */ void* MiniportCoCreateVcHandler /* function */;
      /* 0x0550 */ void* MiniportCoRequestHandler /* function */;
      /* 0x0558 */ void* CoCreateVcHandler /* function */;
      /* 0x0560 */ void* CoDeleteVcHandler /* function */;
      /* 0x0568 */ void* CmActivateVcCompleteHandler /* function */;
      /* 0x0570 */ void* CmDeactivateVcCompleteHandler /* function */;
      /* 0x0578 */ void* CoRequestCompleteHandler /* function */;
      /* 0x0580 */ void* CoRequestHandler /* function */;
      /* 0x0588 */ struct _LIST_ENTRY ActiveVcHead;
      /* 0x0598 */ struct _LIST_ENTRY InactiveVcHead;
      /* 0x05a8 */ long PendingAfNotifications;
      /* 0x05ac */ long Padding_247;
      /* 0x05b0 */ struct _KEVENT* AfNotifyCompleteEvent;
      /* 0x05b8 */ void* MiniportCoOidRequestHandler /* function */;
      /* 0x05c0 */ void* CoOidRequestCompleteHandler /* function */;
      /* 0x05c8 */ void* CoOidRequestHandler /* function */;
    }; /* size: 0x0400 */
  }; /* size: 0x0400 */
} NDIS_OPEN_BLOCK, *PNDIS_OPEN_BLOCK; /* size: 0x05d0 */
...
} NDIS_PROTOCOL_BLOCK, *PNDIS_PROTOCOL_BLOCK; /* size: 0x02d0 */
...
typedef struct _NDIS_FILTER_DRIVER_BLOCK
{
  ...
  /* 0x0120 */ void* InitiateOffloadCompleteHandler /* function */;
  /* 0x0128 */ void* TerminateOffloadCompleteHandler /* function */;
  /* 0x0130 */ void* UpdateOffloadCompleteHandler /* function */;
  /* 0x0138 */ void* InvalidateOffloadCompleteHandler /* function */;
  /* 0x0140 */ void* QueryOffloadCompleteHandler /* function */;
  /* 0x0148 */ void* IndicateOffloadEventHandler /* function */;
  /* 0x0150 */ void* TcpOffloadSendCompleteHandler /* function */;
  /* 0x0158 */ void* TcpOffloadReceiveCompleteHandler /* function */;
  /* 0x0160 */ void* TcpOffloadDisconnectCompleteHandler /* function */;
  /* 0x0168 */ void* TcpOffloadForwardCompleteHandler /* function */;
  /* 0x0170 */ void* TcpOffloadEventHandler /* function */;
  /* 0x0178 */ void* TcpOffloadReceiveIndicateHandler /* function */;
  /* 0x0180 */ void* InitiateOffloadHandler /* function */;
  /* 0x0188 */ void* TerminateOffloadHandler /* function */;
  /* 0x0190 */ void* UpdateOffloadHandler /* function */;
  /* 0x0198 */ void* InvalidateOffloadHandler /* function */;
  /* 0x01a0 */ void* QueryOffloadHandler /* function */;
  /* 0x01a8 */ void* TcpOffloadSendHandler /* function */;
  /* 0x01b0 */ void* TcpOffloadReceiveHandler /* function */;
  /* 0x01b8 */ void* TcpOffloadDisconnectHandler /* function */;
  /* 0x01c0 */ void* TcpOffloadForwardHandler /* function */;
  /* 0x01c8 */ void* TcpOffloadReceiveReturnHandler /* function */;
  /* 0x01d0 */ void* SetInfoBuf;
  /* 0x01d8 */ unsigned long RequestBuffer;
  /* 0x01dc */ unsigned short SetInfoBufLen;
  /* 0x01de */ char Padding_275[2];
  /* 0x01e0 */ enum _NDIS_FILTER_TYPE FilterType;
  /* 0x01e4 */ enum _NDIS_FILTER_RUN_TYPE FilterRunType;
  /* 0x01e8 */ struct _UNICODE_STRING FilterClass;
