...
typedef struct _MMPTE_HARDWARE_LARGEPAGE
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned __int64 PageFrameNumber : 19; /* bit position: 21 */
    /* 0x0000 */ unsigned __int64 reserved2 : 24; /* bit position: 40 */
  }; /* bitfield */
...
typedef struct _MMPTE_TRANSITION
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned __int64 Transition : 1; /* bit position: 11 */
    /* 0x0000 */ unsigned __int64 PageFrameNumber : 28; /* bit position: 12 */
    /* 0x0000 */ unsigned __int64 Unused : 24; /* bit position: 40 */
  }; /* bitfield */
...
} MI_SECTION_CREATION_EVENT, *PMI_SECTION_CREATION_EVENT; /* size: 0x0020 */
...
} VI_DEADLOCK_ADDRESS_RANGE, *PVI_DEADLOCK_ADDRESS_RANGE; /* size: 0x0010 */
...
typedef struct _PNP_DEVICE_COMPLETION_QUEUE
{
  ...
  /* 0x0010 */ struct _LIST_ENTRY DispatchedList;
  /* 0x0020 */ struct _KSEMAPHORE CompletedSemaphore;
  /* 0x0040 */ struct _LIST_ENTRY CompletedList;
...
typedef struct _KTM
{
  ...
  /* 0x0298 */ void* TmRmHandle;
  /* 0x02a0 */ struct _KRESOURCEMANAGER* TmRm;
  /* 0x02a8 */ struct _KEVENT LogFullNotifyEvent;
  /* 0x02c0 */ struct _WORK_QUEUE_ITEM CheckpointWorkItem;
  /* 0x02e0 */ union _CLS_LSN CheckpointTargetLsn;
  /* 0x02e8 */ struct _WORK_QUEUE_ITEM LogFullCompletedWorkItem;
  /* 0x0308 */ struct _ERESOURCE LogWriteResource;
  /* 0x0370 */ unsigned long LogFlags;
  /* 0x0374 */ long LogFullStatus;
  /* 0x0378 */ long RecoveryStatus;
  /* 0x037c */ long __PADDING__[1];
} KTM, *PKTM; /* size: 0x0380 */
...
typedef struct _VACB
{
  ...
  /* 0x0018 */ struct _LIST_ENTRY LruList;
...
typedef struct _DEFERRED_WRITE
{
  ...
  /* 0x0048 */ unsigned char LimitModifiedPages;
  /* 0x0049 */ char __PADDING__[7];
...
typedef struct _MBCB
{
  ...
  /* 0x0058 */ struct _BITMAP_RANGE BitmapRange2;
  /* 0x0088 */ struct _BITMAP_RANGE BitmapRange3;
} MBCB, *PMBCB; /* size: 0x00b8 */
...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0040 */ struct _POP_DISPLAY_RESUME_CONTEXT* DisplayResumeContext;
  /* 0x0048 */ struct _POP_HIBER_CONTEXT* HiberContext;
  /* 0x0050 */ unsigned __int64 WakeTime;
  /* 0x0058 */ unsigned __int64 SleepTime;
  /* 0x0060 */ struct _SYSTEM_POWER_STATE_CONTEXT SystemContext;
  /* 0x0064 */ struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;
...
} VI_DEADLOCK_THREAD, *PVI_DEADLOCK_THREAD; /* size: 0x0030 */
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x0422 */ unsigned short PriorityRegionActive : 4; /* bit position: 0 */
    }; /* size: 0x0004 */
  }; /* size: 0x0004 */
...
typedef struct _PEB
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0050 */ unsigned long ReservedBits0 : 30; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0054 */ long Padding_169;
  union
  {
...
{
  /* 0x0000 */ void* Wow64;
} WOW64_PROCESS, *PWOW64_PROCESS; /* size: 0x0008 */

typedef struct _PEB_LDR_DATA
{
  /* 0x0000 */ unsigned long Length;
  /* 0x0004 */ unsigned char Initialized;
  /* 0x0005 */ char Padding_179[3];
...
typedef struct _TOKEN
{
  ...
  /* 0x00c5 */ char Padding_184[3];
  /* 0x00c8 */ unsigned long IntegrityLevelIndex;
  /* 0x00cc */ unsigned long MandatoryPolicy;
  /* 0x00d0 */ struct _SECURITY_TOKEN_PROXY_DATA* ProxyData;
  /* 0x00d8 */ struct _SECURITY_TOKEN_AUDIT_DATA* AuditData;
  /* 0x00e0 */ struct _SEP_LOGON_SESSION_REFERENCES* LogonSession;
  /* 0x00e8 */ struct _LUID OriginatingLogonSession;
  /* 0x00f0 */ struct _SID_AND_ATTRIBUTES_HASH SidHash;
  /* 0x0200 */ struct _SID_AND_ATTRIBUTES_HASH RestrictedSidHash;
  /* 0x0310 */ unsigned __int64 VariablePart;
} TOKEN, *PTOKEN; /* size: 0x0318 */
...
typedef struct _DEVOBJ_EXTENSION
{
  ...
  /* 0x0044 */ long Padding_206;
  /* 0x0048 */ struct _VPB* Vpb;
} DEVOBJ_EXTENSION, *PDEVOBJ_EXTENSION; /* size: 0x0050 */

typedef struct _PO_DEVICE_NOTIFY_ORDER
{
  /* 0x0000 */ unsigned char Locked;
  /* 0x0001 */ char Padding_207[7];
...
typedef struct _PEB64
{
  ...
  /* 0x0060 */ unsigned long SystemReserved[1];
  /* 0x0064 */ unsigned long SpareUlong;
  /* 0x0068 */ unsigned __int64 FreeList;
  /* 0x0070 */ unsigned long TlsExpansionCounter;
  /* 0x0074 */ long Padding_228;
...
typedef struct _MMMOD_WRITER_MDL_ENTRY
{
  ...
  union // _TAG_UNNAMED_127
  {
    union
    {
      /* 0x0028 */ unsigned __int64 LastPageToWrite;
...
typedef struct _OBJECT_CREATE_INFORMATION
{
  ...
  /* 0x0008 */ void* RootDirectory;
  /* 0x0010 */ void* ParseContext;
  /* 0x0018 */ char ProbeMode;
  /* 0x0019 */ char Padding_234[3];
  /* 0x001c */ unsigned long PagedPoolCharge;
  /* 0x0020 */ unsigned long NonPagedPoolCharge;
  /* 0x0024 */ unsigned long SecurityDescriptorCharge;
  /* 0x0028 */ void* SecurityDescriptor;
  /* 0x0030 */ struct _SECURITY_QUALITY_OF_SERVICE* SecurityQos;
  /* 0x0038 */ struct _SECURITY_QUALITY_OF_SERVICE SecurityQualityOfService;
  /* 0x0044 */ long __PADDING__[1];
} OBJECT_CREATE_INFORMATION, *POBJECT_CREATE_INFORMATION; /* size: 0x0048 */
...
typedef struct _OBJECT_HEADER_QUOTA_INFO
{
  ...
  /* 0x0010 */ struct _EPROCESS* ExclusiveProcess;
...
typedef struct _OBJECT_HEADER_NAME_INFO
{
  ...
  /* 0x0018 */ unsigned long QueryReferences;
  /* 0x001c */ long __PADDING__[1];
...
struct PO_MEMORY_IMAGE
{
  ...
  /* 0x005c */ long Padding_240;
  /* 0x0060 */ unsigned __int64 TotalPages;
  /* 0x0068 */ unsigned __int64 FirstTablePage;
  /* 0x0070 */ unsigned __int64 LastFilePage;
  /* 0x0078 */ struct _PO_HIBER_PERF PerfInfo;
  /* 0x00d8 */ unsigned long NoBootLoaderLogPages;
  /* 0x00dc */ long Padding_241;
  /* 0x00e0 */ unsigned __int64 BootLoaderLogPages[8];
  /* 0x0120 */ unsigned long TotalPhysicalMemoryCount;
...
typedef struct _POP_SHUTDOWN_BUG_CHECK
{
  ...
  /* 0x0008 */ unsigned __int64 Parameter1;
  /* 0x0010 */ unsigned __int64 Parameter2;
  /* 0x0018 */ unsigned __int64 Parameter3;
  /* 0x0020 */ unsigned __int64 Parameter4;
} POP_SHUTDOWN_BUG_CHECK, *PPOP_SHUTDOWN_BUG_CHECK; /* size: 0x0028 */
...
} VIRTUAL_EFI_RUNTIME_SERVICES, *PVIRTUAL_EFI_RUNTIME_SERVICES; /* size: 0x0058 */
...
typedef struct _MMPFN
{
  ...
  union // _TAG_UNNAMED_132
  {
    union
    {
      ...
      {
        /* 0x0018 */ unsigned short ReferenceCount;
        /* 0x001a */ unsigned char ByteFlags;
        /* 0x001b */ unsigned char InterlockedByteFlags;
      } /* size: 0x0004 */ e3;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u3;
...
typedef struct _CONTROL_AREA
{
  ...
  /* 0x0018 */ unsigned long NumberOfSectionReferences;
  /* 0x001c */ unsigned long NumberOfPfnReferences;
  /* 0x0020 */ unsigned long NumberOfMappedViews;
  /* 0x0024 */ unsigned long NumberOfUserReferences;
  union // _TAG_UNNAMED_136
  {
    union
    {
      /* 0x0028 */ unsigned long LongFlags;
      /* 0x0028 */ struct _MMSECTION_FLAGS Flags;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u;
  union // _TAG_UNNAMED_137
  {
    ...
    {
      /* 0x002c */ unsigned short ModifiedWriteCount;
      /* 0x002e */ unsigned short FlushInProgressCount;
    } /* size: 0x0004 */ e2;
  } /* size: 0x0004 */ u1;
  /* 0x0030 */ struct _EX_FAST_REF FilePointer;
  /* 0x0038 */ volatile long ControlAreaLock;
  /* 0x003c */ unsigned long StartingFrame;
  /* 0x0040 */ struct _MI_SECTION_CREATION_EVENT* WaitingForDeletion;
  union // _TAG_UNNAMED_139
  {
    struct // _TAG_UNNAMED_140
    {
      union
      {
        /* 0x0048 */ unsigned long NumberOfSystemCacheViews;
        /* 0x0048 */ unsigned long ImageRelocationStartBit;
      }; /* size: 0x0004 */
      union
      {
        /* 0x004c */ volatile long WritableUserReferences;
        struct /* bitfield */
        {
          /* 0x004c */ unsigned long ImageRelocationSizeIn64k : 16; /* bit position: 0 */
          /* 0x004c */ unsigned long Unused : 14; /* bit position: 16 */
          /* 0x004c */ unsigned long BitMap64 : 1; /* bit position: 30 */
          /* 0x004c */ unsigned long ImageActive : 1; /* bit position: 31 */
        }; /* bitfield */
      }; /* size: 0x0004 */
      union
      {
        /* 0x0050 */ struct _MM_SUBSECTION_AVL_TABLE* SubsectionRoot;
        /* 0x0050 */ struct _MI_IMAGE_SECURITY_REFERENCE* SeImageStub;
      }; /* size: 0x0008 */
    } /* size: 0x0010 */ e2;
  } /* size: 0x0010 */ u2;
  /* 0x0058 */ volatile __int64 LockedPages;
} CONTROL_AREA, *PCONTROL_AREA; /* size: 0x0060 */
...
typedef struct _SEGMENT
{
  ...
  union // _TAG_UNNAMED_141
  {
    union
    {
      /* 0x0038 */ unsigned __int64 ImageCommitment;
      /* 0x0038 */ struct _EPROCESS* CreatingProcess;
    }; /* size: 0x0008 */
  } /* size: 0x0008 */ u1;
  union // _TAG_UNNAMED_142
  {
    union
    {
      /* 0x0040 */ struct _MI_SECTION_IMAGE_INFORMATION* ImageInformation;
      /* 0x0040 */ void* FirstMappedVa;
    }; /* size: 0x0008 */
  } /* size: 0x0008 */ u2;
  /* 0x0048 */ struct _MMPTE* PrototypePte;
  /* 0x0050 */ struct _MMPTE ThePtes[1];
} SEGMENT, *PSEGMENT; /* size: 0x0058 */
...
typedef struct _MMPAGING_FILE
{
  ...
  /* 0x006c */ long Padding_260;
  /* 0x0070 */ void* FileHandle;
  /* 0x0078 */ long Padding_261[2];
...
typedef struct _VI_DEADLOCK_GLOBALS
{
  ...
  /* 0x0020 */ struct _VI_DEADLOCK_ADDRESS_RANGE ResourceAddressRange[1023];
  ...
  /* 0x805c */ long Padding_262;
  /* 0x8060 */ struct _VI_DEADLOCK_NODE* Participant[32];
  /* 0x8160 */ unsigned long CacheReductionInProgress;
...
typedef struct _CMHIVE
{
  ...
  /* 0x05e8 */ struct _FAST_MUTEX* ViewLock;
  /* 0x05f0 */ struct _FAST_MUTEX* WriterLock;
  /* 0x05f8 */ struct _EX_PUSH_LOCK FlusherLock;
  /* 0x0600 */ struct _EX_PUSH_LOCK SecurityLock;
  /* 0x0608 */ struct _LIST_ENTRY MappedViewList;
  /* 0x0618 */ struct _LIST_ENTRY PinnedViewList;
  /* 0x0628 */ struct _LIST_ENTRY FlushedViewList;
  /* 0x0638 */ unsigned short MappedViewCount;
  /* 0x063a */ unsigned short PinnedViewCount;
  /* 0x063c */ unsigned long UseCount;
  /* 0x0640 */ unsigned long ViewsPerHive;
  /* 0x0644 */ long Padding_263;
  /* 0x0648 */ struct _FILE_OBJECT* FileObject;
  /* 0x0650 */ unsigned long LastShrinkHiveSize;
  /* 0x0654 */ long Padding_264;
  /* 0x0658 */ union _LARGE_INTEGER ActualFileSize;
  /* 0x0660 */ struct _UNICODE_STRING FileFullPath;
  /* 0x0670 */ struct _UNICODE_STRING FileUserName;
  /* 0x0680 */ struct _UNICODE_STRING HiveRootPath;
  /* 0x0690 */ unsigned long SecurityCount;
  /* 0x0694 */ unsigned long SecurityCacheSize;
  /* 0x0698 */ long SecurityHitHint;
  /* 0x069c */ long Padding_265;
  /* 0x06a0 */ struct _CM_KEY_SECURITY_CACHE_ENTRY* SecurityCache;
  /* 0x06a8 */ struct _LIST_ENTRY SecurityHash[64];
  /* 0x0aa8 */ unsigned long UnloadEventCount;
  /* 0x0aac */ long Padding_266;
  /* 0x0ab0 */ struct _KEVENT** UnloadEventArray;
  /* 0x0ab8 */ struct _CM_KEY_CONTROL_BLOCK* RootKcb;
  /* 0x0ac0 */ unsigned char Frozen;
  /* 0x0ac1 */ char Padding_267[7];
  /* 0x0ac8 */ struct _CM_WORKITEM* UnloadWorkItem;
  /* 0x0ad0 */ unsigned char GrowOnlyMode;
  /* 0x0ad1 */ char Padding_268[3];
  /* 0x0ad4 */ unsigned long GrowOffset;
  /* 0x0ad8 */ struct _LIST_ENTRY KcbConvertListHead;
  /* 0x0ae8 */ struct _LIST_ENTRY KnodeConvertListHead;
  /* 0x0af8 */ struct _CM_CELL_REMAP_BLOCK* CellRemapArray;
  /* 0x0b00 */ unsigned long Flags;
  /* 0x0b04 */ long Padding_269;
  /* 0x0b08 */ struct _LIST_ENTRY TrustClassEntry;
  /* 0x0b18 */ unsigned long FlushCount;
  /* 0x0b1c */ long Padding_270;
  /* 0x0b20 */ struct _CM_RM* CmRm;
  /* 0x0b28 */ unsigned long CmRmInitFailPoint;
  /* 0x0b2c */ long CmRmInitFailStatus;
  /* 0x0b30 */ struct _KTHREAD* CreatorOwner;
} CMHIVE, *PCMHIVE; /* size: 0x0b38 */
...
typedef struct _CM_WORKITEM
{
  ...
  /* 0x0010 */ void* WorkerRoutine /* function */;
  /* 0x0018 */ void* Parameter;
} CM_WORKITEM, *PCM_WORKITEM; /* size: 0x0020 */
...
typedef struct _KUSER_SHARED_DATA
{
  ...
  /* 0x032c */ long Padding_315;
  /* 0x0330 */ unsigned long Cookie;
  /* 0x0334 */ long Padding_316;
...
typedef struct _ARBITER_INSTANCE
{
  ...
  /* 0x0121 */ char Padding_336[7];
  /* 0x0128 */ void* Extension;
  /* 0x0130 */ struct _DEVICE_OBJECT* BusDeviceObject;
  /* 0x0138 */ void* ConflictCallbackContext;
  /* 0x0140 */ void* ConflictCallback /* function */;
  /* 0x0148 */ wchar_t PdoDescriptionString[336];
  /* 0x03e8 */ char PdoSymbolicNameString[672];
  /* 0x0688 */ wchar_t PdoAddressString[1];
  /* 0x068a */ char __PADDING__[6];
} ARBITER_INSTANCE, *PARBITER_INSTANCE; /* size: 0x0690 */
...
typedef struct _POP_THERMAL_ZONE
{
  ...
  /* 0x0016 */ char Padding_342[2];
  /* 0x0018 */ long Throttle;
  /* 0x001c */ long Padding_343;
...
typedef struct _VI_TRACK_IRQL
{
  ...
  /* 0x000a */ unsigned char Processor;
  /* 0x000b */ char Padding_346;
...
typedef struct _MEMORY_ALLOCATION_DESCRIPTOR
{
  ...
  /* 0x0014 */ unsigned long BasePage;
  /* 0x0018 */ unsigned long PageCount;
  /* 0x001c */ long __PADDING__[1];
} MEMORY_ALLOCATION_DESCRIPTOR, *PMEMORY_ALLOCATION_DESCRIPTOR; /* size: 0x0020 */
...
typedef struct _ETIMER
{
  ...
  /* 0x00f5 */ unsigned char WakeTimer;
  /* 0x00f6 */ char Padding_348[2];
  /* 0x00f8 */ struct _LIST_ENTRY WakeTimerListEntry;
} ETIMER, *PETIMER; /* size: 0x0108 */
...
typedef struct _POP_HIBER_CONTEXT
{
  ...
  /* 0x0078 */ void* IoPages;
  /* 0x0080 */ void* CurrentMcb;
  /* 0x0088 */ struct _DUMP_STACK_CONTEXT* DumpStack;
  /* 0x0090 */ struct _KPROCESSOR_STATE* WakeState;
  /* 0x0098 */ unsigned __int64 HiberVa;
  /* 0x00a0 */ union _LARGE_INTEGER HiberPte;
  /* 0x00a8 */ long Status;
  /* 0x00ac */ long Padding_355;
  /* 0x00b0 */ struct PO_MEMORY_IMAGE* MemoryImage;
  /* 0x00b8 */ struct _PO_MEMORY_RANGE_ARRAY* TableHead;
  /* 0x00c0 */ unsigned char* CompressionWorkspace;
  /* 0x00c8 */ unsigned char* CompressedWriteBuffer;
  /* 0x00d0 */ unsigned long* PerformanceStats;
  /* 0x00d8 */ void* CompressionBlock;
  /* 0x00e0 */ void* DmaIO;
  /* 0x00e8 */ void* TemporaryHeap;
  /* 0x00f0 */ struct _PO_HIBER_PERF PerfInfo;
  /* 0x0150 */ struct _MDL* BootLoaderLogMdl;
} POP_HIBER_CONTEXT, *PPOP_HIBER_CONTEXT; /* size: 0x0158 */
...
typedef struct _MI_VERIFIER_DRIVER_ENTRY
{
  ...
  /* 0x0038 */ unsigned long Flags;
  /* 0x003c */ long Padding_357;
  /* 0x0040 */ unsigned __int64 Signature;
  /* 0x0048 */ long Padding_358[2];
...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0090 */ struct _KEVENT AttachEvent;
  /* 0x00a8 */ struct _LIST_ENTRY WsListEntry;
  /* 0x00b8 */ long Padding_360[2];
  ...
  /* 0x1d90 */ struct _MMPTE SessionPteFreeHead;
  /* 0x1d98 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1db8 */ void* PoolTrackTableExpansion;
  /* 0x1dc0 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x1dc8 */ void* PoolTrackBigPages;
  /* 0x1dd0 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x1dd8 */ long __PADDING__[10];
...
} MMPFNLIST, *PMMPFNLIST; /* size: 0x0020 */
...
} MM_DRIVER_VERIFIER_DATA, *PMM_DRIVER_VERIFIER_DATA; /* size: 0x0080 */
...
typedef struct _OBJECT_SYMBOLIC_LINK
{
  ...
  /* 0x0018 */ struct _UNICODE_STRING LinkTargetRemaining;
  /* 0x0028 */ void* LinkTargetObject;
  /* 0x0030 */ unsigned long DosDeviceDriveIndex;
  /* 0x0034 */ long __PADDING__[1];
} OBJECT_SYMBOLIC_LINK, *POBJECT_SYMBOLIC_LINK; /* size: 0x0038 */
