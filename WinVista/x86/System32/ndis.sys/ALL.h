...
typedef struct _NDIS_OPEN_BLOCK
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x03a4 */ long Padding_7;
      /* 0x03a8 */ struct _NDIS_CO_AF_BLOCK* NextAf;
      /* 0x03ac */ void* MiniportCoCreateVcHandler /* function */;
      /* 0x03b0 */ void* MiniportCoRequestHandler /* function */;
      /* 0x03b4 */ void* CoCreateVcHandler /* function */;
      /* 0x03b8 */ void* CoDeleteVcHandler /* function */;
      /* 0x03bc */ void* CmActivateVcCompleteHandler /* function */;
      /* 0x03c0 */ void* CmDeactivateVcCompleteHandler /* function */;
      /* 0x03c4 */ void* CoRequestCompleteHandler /* function */;
      /* 0x03c8 */ void* CoRequestHandler /* function */;
      /* 0x03cc */ struct _LIST_ENTRY ActiveVcHead;
      /* 0x03d4 */ struct _LIST_ENTRY InactiveVcHead;
      /* 0x03dc */ long PendingAfNotifications;
      /* 0x03e0 */ struct _KEVENT* AfNotifyCompleteEvent;
      /* 0x03e4 */ void* MiniportCoOidRequestHandler /* function */;
      /* 0x03e8 */ void* CoOidRequestCompleteHandler /* function */;
      /* 0x03ec */ void* CoOidRequestHandler /* function */;
    }; /* size: 0x0304 */
  }; /* size: 0x0304 */
} NDIS_OPEN_BLOCK, *PNDIS_OPEN_BLOCK; /* size: 0x03f0 */
...
} NDIS_MINIPORT_DRIVER_CHARACTERISTICS, *PNDIS_MINIPORT_DRIVER_CHARACTERISTICS; /* size: 0x0048 */
...
typedef struct _NET_BUFFER_LIST
{
  ...
  /* 0x0048 */ unsigned long Flags;
  /* 0x004c */ int Status;
  /* 0x0050 */ void* NetBufferListInfo[11];
  /* 0x007c */ long __PADDING__[1];
} NET_BUFFER_LIST, *PNET_BUFFER_LIST; /* size: 0x0080 */
...
} NDIS_FILTER_DRIVER_CHARACTERISTICS, *PNDIS_FILTER_DRIVER_CHARACTERISTICS; /* size: 0x0068 */
...
} NDIS_PROTOCOL_BLOCK, *PNDIS_PROTOCOL_BLOCK; /* size: 0x0178 */
...
} NDIS_FILTER_TASK_OFFLOAD, *PNDIS_FILTER_TASK_OFFLOAD; /* size: 0x0070 */
...
typedef struct _NDIS_FILTER_DRIVER_BLOCK
{
  ...
  /* 0x0094 */ void* InitiateOffloadCompleteHandler /* function */;
  /* 0x0098 */ void* TerminateOffloadCompleteHandler /* function */;
  /* 0x009c */ void* UpdateOffloadCompleteHandler /* function */;
  /* 0x00a0 */ void* InvalidateOffloadCompleteHandler /* function */;
  /* 0x00a4 */ void* QueryOffloadCompleteHandler /* function */;
  /* 0x00a8 */ void* IndicateOffloadEventHandler /* function */;
  /* 0x00ac */ void* TcpOffloadSendCompleteHandler /* function */;
  /* 0x00b0 */ void* TcpOffloadReceiveCompleteHandler /* function */;
  /* 0x00b4 */ void* TcpOffloadDisconnectCompleteHandler /* function */;
  /* 0x00b8 */ void* TcpOffloadForwardCompleteHandler /* function */;
  /* 0x00bc */ void* TcpOffloadEventHandler /* function */;
  /* 0x00c0 */ void* TcpOffloadReceiveIndicateHandler /* function */;
  /* 0x00c4 */ void* InitiateOffloadHandler /* function */;
  /* 0x00c8 */ void* TerminateOffloadHandler /* function */;
  /* 0x00cc */ void* UpdateOffloadHandler /* function */;
  /* 0x00d0 */ void* InvalidateOffloadHandler /* function */;
  /* 0x00d4 */ void* QueryOffloadHandler /* function */;
  /* 0x00d8 */ void* TcpOffloadSendHandler /* function */;
  /* 0x00dc */ void* TcpOffloadReceiveHandler /* function */;
  /* 0x00e0 */ void* TcpOffloadDisconnectHandler /* function */;
  /* 0x00e4 */ void* TcpOffloadForwardHandler /* function */;
  /* 0x00e8 */ void* TcpOffloadReceiveReturnHandler /* function */;
  /* 0x00ec */ void* SetInfoBuf;
  /* 0x00f0 */ unsigned long RequestBuffer;
  /* 0x00f4 */ unsigned short SetInfoBufLen;
  /* 0x00f6 */ char Padding_54[2];
...
} NDIS_FILTER_BLOCK, *PNDIS_FILTER_BLOCK; /* size: 0x03d8 */
...
typedef struct _NDIS_MINIPORT_OFFLOAD
{
  ...
  /* 0x037b */ char Padding_60;
  /* 0x037c */ void* MiniportRequestBuffer;
  /* 0x0380 */ unsigned long MiniportRequestOid;
  /* 0x0384 */ unsigned long MiniportRequestBufferLength;
} NDIS_MINIPORT_OFFLOAD, *PNDIS_MINIPORT_OFFLOAD; /* size: 0x0388 */
...
_ndisCreateAcl@28
_ndisCreateAdapterInstanceName@8
...
_ndisReadMiniportMediaSpecificPortAuthStates@8
