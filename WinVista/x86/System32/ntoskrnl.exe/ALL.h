...
typedef struct _OBJECT_TYPE
{
  ...
  /* 0x00b0 */ struct _EX_PUSH_LOCK ObjectLocks[32];
} OBJECT_TYPE, *POBJECT_TYPE; /* size: 0x0130 */
...
typedef struct _SECTION_IMAGE_INFORMATION
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0023 */ unsigned char Reserved : 5; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0001 */
...
} DEVOBJ_EXTENSION, *PDEVOBJ_EXTENSION; /* size: 0x002c */
...
struct PPM_PERF_STATES
{
  ...
  /* 0x002c */ void* PStateHandler /* function */;
  /* 0x0030 */ unsigned long PStateContext;
  /* 0x0034 */ void* TStateHandler /* function */;
  /* 0x0038 */ unsigned long TStateContext;
  /* 0x003c */ void* FeedbackHandler /* function */;
  /* 0x0040 */ struct PPM_PERF_STATE State[1];
}; /* size: 0x0068 */
...
typedef struct _POP_SHUTDOWN_BUG_CHECK
{
  ...
  /* 0x0004 */ unsigned long Parameter1;
  /* 0x0008 */ unsigned long Parameter2;
  /* 0x000c */ unsigned long Parameter3;
  /* 0x0010 */ unsigned long Parameter4;
} POP_SHUTDOWN_BUG_CHECK, *PPOP_SHUTDOWN_BUG_CHECK; /* size: 0x0014 */
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x026a */ unsigned short PriorityRegionActive : 4; /* bit position: 0 */
    }; /* size: 0x0004 */
  }; /* size: 0x0004 */
...
typedef struct _KUSER_SHARED_DATA
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x02f0 */ unsigned long SystemDllRelocated : 1; /* bit position: 4 */
      /* 0x02f0 */ unsigned long SpareBits : 27; /* bit position: 5 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02f4 */ long Padding_37;
  ...
  /* 0x032c */ long Padding_38;
  /* 0x0330 */ unsigned long Cookie;
  /* 0x0334 */ long Padding_39;
...
struct PO_MEMORY_IMAGE
{
  ...
  /* 0x00b8 */ unsigned long NoBootLoaderLogPages;
  /* 0x00bc */ unsigned long BootLoaderLogPages[8];
  /* 0x00dc */ unsigned long TotalPhysicalMemoryCount;
}; /* size: 0x00e0 */
...
typedef struct _VI_DEADLOCK_NODE
{
  ...
  /* 0x0028 */ void* StackTrace[8];
  /* 0x0048 */ void* ParentStackTrace[8];
} VI_DEADLOCK_NODE, *PVI_DEADLOCK_NODE; /* size: 0x0068 */
...
{
  /* 0x0000 */ struct _MI_SECTION_CREATION_EVENT* Next;
  /* 0x0004 */ struct _KEVENT Event;
} MI_SECTION_CREATION_EVENT, *PMI_SECTION_CREATION_EVENT; /* size: 0x0014 */
...
typedef struct _CONTROL_AREA
{
  ...
  /* 0x0030 */ struct _MI_SECTION_CREATION_EVENT* WaitingForDeletion;
...
typedef struct _POP_HIBER_CONTEXT
{
  ...
  /* 0x0048 */ void* IoPages;
  /* 0x004c */ void* CurrentMcb;
  /* 0x0050 */ struct _DUMP_STACK_CONTEXT* DumpStack;
  /* 0x0054 */ struct _KPROCESSOR_STATE* WakeState;
  /* 0x0058 */ unsigned long HiberVa;
...
} POP_HIBER_CONTEXT, *PPOP_HIBER_CONTEXT; /* size: 0x00f8 */
...
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x007c */
...
} MI_EXTRA_IMAGE_INFORMATION, *PMI_EXTRA_IMAGE_INFORMATION; /* size: 0x0004 */
...
} MI_SECTION_IMAGE_INFORMATION, *PMI_SECTION_IMAGE_INFORMATION; /* size: 0x0034 */
...
typedef struct _MMMOD_WRITER_MDL_ENTRY
{
  ...
  union // _TAG_UNNAMED_145
  {
    union
    {
      /* 0x0014 */ unsigned long LastPageToWrite;
...
typedef struct _CM_KEY_BODY
{
  ...
  /* 0x0024 */ struct _EX_PUSH_LOCK KeyBodyLock;
  /* 0x0028 */ struct _LIST_ENTRY ContextListHead;
...
typedef struct _KTM
{
  ...
  /* 0x0188 */ void* TmRmHandle;
  /* 0x018c */ struct _KRESOURCEMANAGER* TmRm;
  /* 0x0190 */ struct _KEVENT LogFullNotifyEvent;
  /* 0x01a0 */ struct _WORK_QUEUE_ITEM CheckpointWorkItem;
  /* 0x01b0 */ union _CLS_LSN CheckpointTargetLsn;
  /* 0x01b8 */ struct _WORK_QUEUE_ITEM LogFullCompletedWorkItem;
  /* 0x01c8 */ struct _ERESOURCE LogWriteResource;
  /* 0x0200 */ unsigned long LogFlags;
  /* 0x0204 */ long LogFullStatus;
  /* 0x0208 */ long RecoveryStatus;
  /* 0x020c */ long __PADDING__[1];
} KTM, *PKTM; /* size: 0x0210 */
...
typedef struct _KTRANSACTION
{
  ...
  /* 0x0104 */ long Padding_71;
  /* 0x0108 */ struct _KTIMER RollbackTimer;
  /* 0x0130 */ struct _LIST_ENTRY LsnOrderedEntry;
  /* 0x0138 */ enum _KTRANSACTION_OUTCOME Outcome;
  /* 0x013c */ unsigned long NextSavepoint;
  /* 0x0140 */ struct _KTM* Tm;
  /* 0x0144 */ long Padding_72;
  /* 0x0148 */ __int64 CommitReservation;
  /* 0x0150 */ struct _KTRANSACTION_HISTORY TransactionHistory[10];
  /* 0x01a0 */ unsigned long TransactionHistoryCount;
  /* 0x01a4 */ long __PADDING__[1];
} KTRANSACTION, *PKTRANSACTION; /* size: 0x01a8 */
...
typedef struct _TEB
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0fca */ unsigned short SpareSameTebBits : 8; /* bit position: 8 */
    }; /* bitfield */
  }; /* size: 0x0002 */
...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0050 */ struct _SYSTEM_POWER_STATE_CONTEXT SystemContext;
  /* 0x0054 */ struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;
...
typedef struct _ETW_GUID_ENTRY
{
  ...
  /* 0x0028 */ struct _TRACE_ENABLE_CONTEXT LegacyEnableContext;
  /* 0x0030 */ unsigned long LegacyProviderEnabled;
  /* 0x0034 */ long Padding_83;
...
typedef struct _ARBITER_INSTANCE
{
  ...
  /* 0x0091 */ char Padding_90[3];
  /* 0x0094 */ void* Extension;
  /* 0x0098 */ struct _DEVICE_OBJECT* BusDeviceObject;
  /* 0x009c */ void* ConflictCallbackContext;
  /* 0x00a0 */ void* ConflictCallback /* function */;
  /* 0x00a4 */ wchar_t PdoDescriptionString[336];
  /* 0x0344 */ char PdoSymbolicNameString[672];
  /* 0x05e4 */ wchar_t PdoAddressString[1];
  /* 0x05e6 */ char __PADDING__[2];
} ARBITER_INSTANCE, *PARBITER_INSTANCE; /* size: 0x05e8 */
...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0064 */ struct _KEVENT AttachEvent;
  /* 0x0074 */ struct _LIST_ENTRY WsListEntry;
  /* 0x007c */ long Padding_95;
  ...
  /* 0x1e40 */ struct _MMPTE SessionPteFreeHead;
  /* 0x1e44 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1e54 */ void* PoolTrackTableExpansion;
  /* 0x1e58 */ unsigned long PoolTrackTableExpansionSize;
  /* 0x1e5c */ void* PoolTrackBigPages;
  /* 0x1e60 */ unsigned long PoolTrackBigPagesSize;
  /* 0x1e64 */ struct _RTL_BITMAP SessionPoolPdes;
  /* 0x1e6c */ long __PADDING__[5];
} MM_SESSION_SPACE, *PMM_SESSION_SPACE; /* size: 0x1e80 */
...
typedef struct _VI_DEADLOCK_GLOBALS
{
  ...
  /* 0x40d8 */ unsigned long CacheReductionInProgress;
