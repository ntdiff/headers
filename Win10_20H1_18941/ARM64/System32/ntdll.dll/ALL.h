...
typedef struct _KNODE
{
  ...
  /* 0x00ac */ unsigned short ThreadSeed;
  /* 0x00ae */ unsigned short ProcessSeed;
  /* 0x00b0 */ long Padding_4[20];
  ...
  /* 0x01d0 */ union _KQOS_GROUPING_SETS QosGroupingSets;
  /* 0x01e0 */ unsigned __int64 LLCLeaders;
  /* 0x01e8 */ long __PADDING__[6];
...
typedef struct _KPRCB
{
  ...
  /* 0x1621 */ unsigned char PrcbPad20[2];
  /* 0x1623 */ unsigned char ExceptionStackActive;
  ...
  /* 0x1640 */ unsigned __int64 PcbPad21[5];
  /* 0x1668 */ void* ExceptionStack;
...
typedef struct _KTHREAD
{
  ...
  union
  {
    /* 0x03dc */ volatile long ThreadFlags2;
    struct /* bitfield */
    {
      /* 0x03dc */ unsigned long PpmPolicy : 2; /* bit position: 0 */
      /* 0x03dc */ unsigned long ThreadFlags2Reserved : 30; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
...
typedef struct _KPROCESS
{
  ...
  /* 0x034e */ char Padding_112[2];
  /* 0x0350 */ volatile union _KSTACK_COUNT StackCount;
  /* 0x0354 */ long Padding_113;
  ...
  /* 0x03b0 */ unsigned __int64 EndPadding[8];
...
typedef struct _EPROCESS
{
  ...
  /* 0x0ac0 */ long __PADDING__[16];
} EPROCESS, *PEPROCESS; /* size: 0x0b00 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_218[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_219[2];
