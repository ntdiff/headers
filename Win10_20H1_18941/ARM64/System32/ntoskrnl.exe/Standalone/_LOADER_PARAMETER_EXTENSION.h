...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  /* 0x0b00 */ void* BootOptions;
  /* 0x0b08 */ unsigned long IumEnablement;
  /* 0x0b0c */ unsigned long IumPolicy;
  /* 0x0b10 */ long IumStatus;
  /* 0x0b14 */ unsigned long BootId;
  /* 0x0b18 */ struct _LOADER_PARAMETER_CI_EXTENSION* CodeIntegrityData;
  /* 0x0b20 */ unsigned long CodeIntegrityDataSize;
  /* 0x0b24 */ struct _LOADER_HIVE_RECOVERY_INFO SystemHiveRecoveryInfo;
  /* 0x0b38 */ unsigned long SoftRestartCount;
  /* 0x0b40 */ __int64 SoftRestartTime;
  ...
  /* 0x0d68 */ struct _VSM_PERFORMANCE_DATA VsmPerformanceData;
  /* 0x0da8 */ struct _NUMA_MEMORY_RANGE* NumaMemoryRanges;
  /* 0x0db0 */ unsigned long NumaMemoryRangeCount;
  /* 0x0db4 */ long __PADDING__[1];
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0db8 */
