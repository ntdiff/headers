...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0074 */ unsigned long SuppressMonitorX : 1; /* bit position: 13 */
    /* 0x0074 */ unsigned long Unused : 7; /* bit position: 14 */
  ...
  /* 0x00d8 */ struct _LIST_ENTRY BootApplicationPersistentData;
  /* 0x00e8 */ void* WmdTestResult;
  /* 0x00f0 */ struct _GUID BootIdentifier;
  /* 0x0100 */ unsigned long ResumePages;
  /* 0x0108 */ void* DumpHeader;
  /* 0x0110 */ void* BgContext;
  /* 0x0118 */ void* NumaLocalityInfo;
  /* 0x0120 */ void* NumaGroupAssignment;
  /* 0x0128 */ struct _LIST_ENTRY AttachedHives;
  /* 0x0138 */ unsigned long MemoryCachingRequirementsCount;
  /* 0x0140 */ void* MemoryCachingRequirements;
  /* 0x0148 */ struct _BOOT_ENTROPY_LDR_RESULT BootEntropyResult;
  /* 0x09b0 */ unsigned __int64 ProcessorCounterFrequency;
  /* 0x09b8 */ struct _LOADER_PARAMETER_HYPERVISOR_EXTENSION HypervisorExtension;
  /* 0x09f8 */ struct _GUID HardwareConfigurationId;
  /* 0x0a08 */ struct _LIST_ENTRY HalExtensionModuleList;
  /* 0x0a18 */ union _LARGE_INTEGER SystemTime;
  /* 0x0a20 */ unsigned __int64 TimeStampAtSystemTimeRead;
  union
  {
    /* 0x0a28 */ unsigned __int64 BootFlags;
    struct /* bitfield */
    {
      /* 0x0a28 */ unsigned __int64 DbgMenuOsSelection : 1; /* bit position: 0 */
      /* 0x0a28 */ unsigned __int64 DbgHiberBoot : 1; /* bit position: 1 */
      /* 0x0a28 */ unsigned __int64 DbgSoftRestart : 1; /* bit position: 2 */
      /* 0x0a28 */ unsigned __int64 DbgMeasuredLaunch : 1; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0008 */
  union
  {
    /* 0x0a30 */ unsigned __int64 InternalBootFlags;
    struct /* bitfield */
    {
      /* 0x0a30 */ unsigned __int64 DbgUtcBootTime : 1; /* bit position: 0 */
      /* 0x0a30 */ unsigned __int64 DbgRtcBootTime : 1; /* bit position: 1 */
      /* 0x0a30 */ unsigned __int64 DbgNoLegacyServices : 1; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0008 */
  /* 0x0a38 */ void* WfsFPData;
  /* 0x0a40 */ unsigned long WfsFPDataSize;
  /* 0x0a48 */ struct _LOADER_BUGCHECK_PARAMETERS BugcheckParameters;
  /* 0x0a70 */ void* ApiSetSchema;
  /* 0x0a78 */ unsigned long ApiSetSchemaSize;
  /* 0x0a80 */ struct _LIST_ENTRY ApiSetSchemaExtensions;
  /* 0x0a90 */ struct _UNICODE_STRING AcpiBiosVersion;
  /* 0x0aa0 */ struct _UNICODE_STRING SmbiosVersion;
  /* 0x0ab0 */ struct _UNICODE_STRING EfiVersion;
  /* 0x0ac0 */ struct _DEBUG_DEVICE_DESCRIPTOR* KdDebugDevice;
  /* 0x0ac8 */ struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2 OfflineCrashdumpConfigurationTable;
  /* 0x0ae8 */ struct _UNICODE_STRING ManufacturingProfile;
  /* 0x0af8 */ void* BbtBuffer;
  /* 0x0b00 */ unsigned __int64 XsaveAllowedFeatures;
  /* 0x0b08 */ unsigned long XsaveFlags;
  ...
  /* 0x0b58 */ void* HypercallCodeVa;
  /* 0x0b60 */ void* HalVirtualAddress;
  /* 0x0b68 */ unsigned __int64 HalNumberOfBytes;
  /* 0x0b70 */ struct _LEAP_SECOND_DATA* LeapSecondData;
  /* 0x0b78 */ unsigned long MajorRelease;
  /* 0x0b7c */ unsigned long Reserved1;
  /* 0x0b80 */ char NtBuildLab[224];
  /* 0x0c60 */ char NtBuildLabEx[224];
  /* 0x0d40 */ struct _LOADER_RESET_REASON ResetReason;
  /* 0x0d70 */ unsigned long MaxPciBusNumber;
  /* 0x0d74 */ unsigned long FeatureSettings;
  /* 0x0d78 */ unsigned long HotPatchReserveSize;
  /* 0x0d7c */ unsigned long RetpolineReserveSize;
  struct
  {
    /* 0x0d80 */ void* CodeBase;
    /* 0x0d88 */ unsigned __int64 CodeSize;
  } /* size: 0x0010 */ MiniExecutive;
  /* 0x0d90 */ struct _VSM_PERFORMANCE_DATA VsmPerformanceData;
  /* 0x0dd0 */ struct _NUMA_MEMORY_RANGE* NumaMemoryRanges;
  /* 0x0dd8 */ unsigned long NumaMemoryRangeCount;
  /* 0x0ddc */ long __PADDING__[1];
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0de0 */
