...
typedef struct _KTHREAD
{
  ...
  union
  {
    /* 0x03bc */ volatile long ThreadFlags2;
    struct /* bitfield */
    {
      /* 0x03bc */ unsigned long PpmPolicy : 2; /* bit position: 0 */
      /* 0x03bc */ unsigned long ThreadFlags2Reserved : 30; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
...
typedef struct _KPRCB
{
  ...
  union
  {
    struct
    {
      /* 0x5ba6 */ unsigned char NmiActive;
      /* 0x5ba7 */ unsigned char MceActive;
    }; /* size: 0x0002 */
    /* 0x5ba6 */ unsigned short CombinedNmiMceActive;
  }; /* size: 0x0002 */
  ...
  /* 0x5be4 */ unsigned long PrcbPad75[2];
  /* 0x5bec */ unsigned long DpcWatchdogSequenceNumber;
...
} EPROCESS, *PEPROCESS; /* size: 0x0a00 */
...
typedef struct _KNODE
{
  ...
  /* 0x0070 */ long Padding_80[4];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_81;
  union
  {
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_186[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_187[2];
