...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x0040 */ unsigned long LogicalProcessorsPerCore;
  /* 0x0044 */ unsigned char ProcessorCachesFlushedOnPowerLoss;
  /* 0x0048 */ unsigned long TotalPagesAllowed;
  /* 0x004c */ unsigned long SecondaryColorMask;
  /* 0x0050 */ unsigned long SecondaryColors;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x40e0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
...
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x4e80 */
