...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x004c */ unsigned long SuppressMonitorX : 1; /* bit position: 13 */
    /* 0x004c */ unsigned long Unused : 7; /* bit position: 14 */
  ...
  /* 0x00b0 */ struct _LIST_ENTRY BootApplicationPersistentData;
  /* 0x00b8 */ void* WmdTestResult;
  /* 0x00bc */ struct _GUID BootIdentifier;
  /* 0x00cc */ unsigned long ResumePages;
  /* 0x00d0 */ void* DumpHeader;
  /* 0x00d4 */ void* BgContext;
  /* 0x00d8 */ void* NumaLocalityInfo;
  /* 0x00dc */ void* NumaGroupAssignment;
  /* 0x00e0 */ struct _LIST_ENTRY AttachedHives;
  /* 0x00e8 */ unsigned long MemoryCachingRequirementsCount;
  /* 0x00ec */ void* MemoryCachingRequirements;
  /* 0x00f0 */ struct _BOOT_ENTROPY_LDR_RESULT BootEntropyResult;
  /* 0x0958 */ unsigned __int64 ProcessorCounterFrequency;
  /* 0x0960 */ struct _LOADER_PARAMETER_HYPERVISOR_EXTENSION HypervisorExtension;
  /* 0x09a0 */ struct _GUID HardwareConfigurationId;
  /* 0x09b0 */ struct _LIST_ENTRY HalExtensionModuleList;
  /* 0x09b8 */ union _LARGE_INTEGER SystemTime;
  /* 0x09c0 */ unsigned __int64 TimeStampAtSystemTimeRead;
  union
  {
    /* 0x09c8 */ unsigned __int64 BootFlags;
    struct /* bitfield */
    {
      /* 0x09c8 */ unsigned __int64 DbgMenuOsSelection : 1; /* bit position: 0 */
      /* 0x09c8 */ unsigned __int64 DbgHiberBoot : 1; /* bit position: 1 */
      /* 0x09c8 */ unsigned __int64 DbgSoftRestart : 1; /* bit position: 2 */
      /* 0x09c8 */ unsigned __int64 DbgMeasuredLaunch : 1; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0008 */
  union
  {
    /* 0x09d0 */ unsigned __int64 InternalBootFlags;
    struct /* bitfield */
    {
      /* 0x09d0 */ unsigned __int64 DbgUtcBootTime : 1; /* bit position: 0 */
      /* 0x09d0 */ unsigned __int64 DbgRtcBootTime : 1; /* bit position: 1 */
      /* 0x09d0 */ unsigned __int64 DbgNoLegacyServices : 1; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0008 */
  /* 0x09d8 */ void* WfsFPData;
  /* 0x09dc */ unsigned long WfsFPDataSize;
  /* 0x09e0 */ struct _LOADER_BUGCHECK_PARAMETERS BugcheckParameters;
  /* 0x09f4 */ void* ApiSetSchema;
  /* 0x09f8 */ unsigned long ApiSetSchemaSize;
  /* 0x09fc */ struct _LIST_ENTRY ApiSetSchemaExtensions;
  /* 0x0a04 */ struct _UNICODE_STRING AcpiBiosVersion;
  /* 0x0a0c */ struct _UNICODE_STRING SmbiosVersion;
  /* 0x0a14 */ struct _UNICODE_STRING EfiVersion;
  /* 0x0a1c */ struct _DEBUG_DEVICE_DESCRIPTOR* KdDebugDevice;
  /* 0x0a20 */ struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2 OfflineCrashdumpConfigurationTable;
  /* 0x0a40 */ struct _UNICODE_STRING ManufacturingProfile;
  /* 0x0a48 */ void* BbtBuffer;
  /* 0x0a50 */ unsigned __int64 XsaveAllowedFeatures;
  /* 0x0a58 */ unsigned long XsaveFlags;
  /* 0x0a5c */ void* BootOptions;
  /* 0x0a60 */ unsigned long IumEnablement;
  /* 0x0a64 */ unsigned long IumPolicy;
  /* 0x0a68 */ long IumStatus;
  /* 0x0a6c */ unsigned long BootId;
  /* 0x0a70 */ struct _LOADER_PARAMETER_CI_EXTENSION* CodeIntegrityData;
  /* 0x0a74 */ unsigned long CodeIntegrityDataSize;
  /* 0x0a78 */ struct _LOADER_HIVE_RECOVERY_INFO SystemHiveRecoveryInfo;
  /* 0x0a8c */ unsigned long SoftRestartCount;
  /* 0x0a90 */ __int64 SoftRestartTime;
  /* 0x0a98 */ struct _LEAP_SECOND_DATA* LeapSecondData;
  /* 0x0a9c */ unsigned long MajorRelease;
  /* 0x0aa0 */ unsigned long Reserved1;
  /* 0x0aa4 */ char NtBuildLab[224];
  /* 0x0b84 */ char NtBuildLabEx[224];
  /* 0x0c68 */ struct _LOADER_RESET_REASON ResetReason;
  /* 0x0c98 */ unsigned long MaxPciBusNumber;
  /* 0x0c9c */ unsigned long FeatureSettings;
  /* 0x0ca0 */ unsigned long HotPatchReserveSize;
  /* 0x0ca4 */ unsigned long RetpolineReserveSize;
  /* 0x0ca8 */ struct _VSM_PERFORMANCE_DATA VsmPerformanceData;
  /* 0x0ce8 */ struct _NUMA_MEMORY_RANGE* NumaMemoryRanges;
  /* 0x0cec */ unsigned long NumaMemoryRangeCount;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x0cf0 */
