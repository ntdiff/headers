...
{
  /* 0x0038 */ struct _GUID _typeLibId;
  /* 0x0048 */ wchar_t _version[256];
  /* 0x0248 */ unsigned long _localeId;
  /* 0x0250 */ class Microsoft::WRL::ComPtr<ReferencedRegistryKey> _versionKey;
  /* 0x0258 */ class RegistryKey _localeKey;
}; /* size: 0x0260 */
