...
{
  /* 0x0038 */ class Microsoft::WRL::Wrappers::CriticalSection m_CallCS;
  /* 0x0060 */ class CancellableCall* m_pOutstandingCalls;
  /* 0x0068 */ struct _TP_TIMER* m_pCancellationTimer;
  /* 0x0070 */ volatile BOOL m_fTaskActive;
  /* 0x0074 */ volatile unsigned long m_dwCancellationThreadId;
  /* 0x0078 */ BOOL m_fReleaseOnTimeout;
  /* 0x0080 */ class Microsoft::WRL::ComPtr<IOSTaskCompletion> m_spTaskCompletion;
}; /* size: 0x0088 */
