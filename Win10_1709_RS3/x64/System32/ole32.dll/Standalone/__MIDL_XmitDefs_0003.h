...
typedef struct __MIDL_XmitDefs_0003
{
  ...
  /* 0x0008 */ struct _GUID passthroughTraceActivity;
  /* 0x0018 */ struct _GUID callTraceActivity;
  /* 0x0028 */ struct __MIDL_XmitDefs_0001 asyncRequestBlock;
  /* 0x0058 */ unsigned long reserved;
  /* 0x0060 */ struct __MIDL_XmitDefs_0002* pTouchedAstaArray;
} _MIDL_XmitDefs_0003, *P_MIDL_XmitDefs_0003; /* size: 0x0068 */
