typedef struct _MI_PARTITION_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long PureHoldingPartition : 1; /* bit position: 3 */
  }; /* bitfield */
...
typedef struct _MI_PARTITION_CORE
{
  ...
  /* 0x0080 */ void* SystemThreadHandles[5];
  /* 0x00a8 */ struct _EPARTITION* PartitionObject;
  /* 0x00b0 */ struct _EX_PUSH_LOCK PartitionSystemThreadsLock;
  /* 0x00b8 */ struct _EX_PUSH_LOCK DynamicMemoryPushLock;
  /* 0x00c0 */ volatile long DynamicMemoryLock;
  /* 0x00c4 */ unsigned char PfnUnmapActive;
  /* 0x00c8 */ struct _KEVENT TemporaryMemoryEvent;
  /* 0x00e0 */ void* RootDirectory;
  /* 0x00e8 */ void* KernelObjectsDirectory;
  /* 0x00f0 */ struct _KEVENT* MemoryEvents[11];
  /* 0x0148 */ void* MemoryEventHandles[11];
  /* 0x01a0 */ unsigned __int64 NonChargedSecurePages;
} MI_PARTITION_CORE, *PMI_PARTITION_CORE; /* size: 0x01a8 */
...
typedef struct _MMPAGE_FILE_EXPANSION_FLAGS
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0003 */ unsigned char Spare3 : 3; /* bit position: 5 */
  }; /* bitfield */
...
typedef struct _MI_PARTITION_MODWRITES
{
  ...
  /* 0x022c */ volatile long ClusterWritesDisabled[2];
...
typedef struct _MI_PARTITION_SEGMENTS
{
  ...
  /* 0x0048 */ unsigned __int64 SubsectionDeletePtes;
  /* 0x0050 */ struct _MMPAGE_FILE_EXPANSION AttemptForCantExtend;
  /* 0x00a8 */ struct _MMDEREFERENCE_SEGMENT_HEADER DereferenceSegmentHeader;
  /* 0x00f8 */ struct _LIST_ENTRY DeleteOnCloseList;
  /* 0x0108 */ struct _KTIMER DeleteOnCloseTimer;
  /* 0x0148 */ unsigned char DeleteOnCloseTimerActive;
  /* 0x0149 */ unsigned char SegmentDereferenceThreadExists;
  /* 0x0150 */ unsigned __int64 UnusedSegmentPagedPool;
  /* 0x0158 */ struct _LIST_ENTRY UnusedSegmentList;
  /* 0x0168 */ struct _LIST_ENTRY UnusedSubsectionList;
  /* 0x0178 */ struct _LIST_ENTRY DeleteSubsectionList;
  /* 0x0188 */ struct _KEVENT ControlAreaDeleteEvent;
  /* 0x01a0 */ struct _SINGLE_LIST_ENTRY ControlAreaDeleteList;
  /* 0x01a8 */ struct _MI_PTE_CHAIN_HEAD FreeSystemCache;
  /* 0x01c0 */ struct _KEVENT CloneDereferenceEvent;
  /* 0x01e0 */ union _SLIST_HEADER CloneProtosSListHead;
  /* 0x01f0 */ struct _EX_PUSH_LOCK SystemCacheInitLock;
  /* 0x01f8 */ unsigned long PagefileExtensionWaiters;
  /* 0x01fc */ unsigned long PagefileExtensionRequests;
  /* 0x0200 */ struct _KEVENT PagefileExtensionWaitEvent;
  /* 0x0218 */ struct _MI_CROSS_PARTITION_CHARGES SharedCharges[5];
  /* 0x02b8 */ struct _KEVENT* SharedChargesDrainEvent;
  /* 0x02c0 */ struct _KEVENT* PagefileControlAreasDrainEvent;
  /* 0x02c8 */ long __PADDING__[14];
} MI_PARTITION_SEGMENTS, *PMI_PARTITION_SEGMENTS; /* size: 0x0300 */
...
typedef struct _MI_PARTITION_ZEROING
{
  ...
  /* 0x0019 */ unsigned char ThreadPriorityStatic;
  /* 0x001c */ long ZeroFreePageSlistMinimum;
  /* 0x0020 */ struct _WORK_QUEUE_ITEM RebalanceZeroFreeWorkItem;
  /* 0x0040 */ volatile long ThreadCount;
  /* 0x0048 */ struct _KGATE Gate;
  /* 0x0060 */ struct _MI_ZERO_THREAD_CONTEXT* ThreadContext;
...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x0208 */ struct _MMWSL_INSTANCE PartitionWorkingSetLists[1];
  /* 0x0230 */ volatile unsigned __int64 TotalCommittedPages;
  ...
  /* 0x02d0 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x02e0 */ volatile long PageFileTraceIndex;
  /* 0x02e8 */ struct _MI_PAGEFILE_TRACES PageFileTraces[32];
  /* 0x11e8 */ long __PADDING__[6];
} MI_VISIBLE_PARTITION, *PMI_VISIBLE_PARTITION; /* size: 0x1200 */

typedef struct _MI_PARTITION
{
  /* 0x0000 */ struct _MI_PARTITION_CORE Core;
  /* 0x01a8 */ struct _MI_PARTITION_MODWRITES Modwriter;
  /* 0x0470 */ struct _MI_PARTITION_STORES Store;
  /* 0x0500 */ struct _MI_PARTITION_SEGMENTS Segments;
  /* 0x0800 */ struct _MI_PARTITION_PAGE_LISTS PageLists;
  /* 0x13c0 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1440 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x14a8 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1630 */ void* WorkingSetControl;
  /* 0x1638 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1680 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x2880 */
