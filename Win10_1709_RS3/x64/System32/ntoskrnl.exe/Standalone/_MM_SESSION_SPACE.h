...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0d00 */ struct _MMWSL_INSTANCE WorkingSetList;
  /* 0x0d40 */ struct _MMSUPPORT_AGGREGATION AggregateSessionWs;
  /* 0x0d80 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x1ec0 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x1ec8 */ struct _MMPTE PageDirectory;
  /* 0x1ed0 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x1ed8 */ struct _RTL_BITMAP_EX DynamicVaBitMap;
  /* 0x1ee8 */ unsigned __int64 DynamicVaHint;
  /* 0x1ef0 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x1f30 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x1f38 */ long PoolBigEntriesInUse;
  /* 0x1f3c */ unsigned long PagedPoolPdeCount;
  /* 0x1f40 */ unsigned long SpecialPoolPdeCount;
  /* 0x1f44 */ unsigned long DynamicSessionPdeCount;
  /* 0x1f48 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1fb0 */ void* PoolTrackTableExpansion;
  /* 0x1fb8 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x1fc0 */ void* PoolTrackBigPages;
  /* 0x1fc8 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x1fd0 */ enum _IO_SESSION_STATE IoState;
  /* 0x1fd4 */ unsigned long IoStateSequence;
  /* 0x1fd8 */ struct _KEVENT IoNotificationEvent;
  /* 0x1ff0 */ struct _EJOB* ServerSilo;
  /* 0x1ff8 */ unsigned __int64 CreateTime;
