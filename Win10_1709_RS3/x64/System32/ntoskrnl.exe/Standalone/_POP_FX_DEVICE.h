...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x0270 */ volatile unsigned long Flags;
  /* 0x0274 */ unsigned long ComponentCount;
  /* 0x0278 */ struct _POP_FX_COMPONENT** Components;
  /* 0x0280 */ unsigned long LogEntries;
  /* 0x0288 */ struct _POP_FX_LOG_ENTRY* Log;
  /* 0x0290 */ volatile long LogIndex;
  /* 0x0298 */ struct _DRIVER_OBJECT* DripsWatchdogDriverObject;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x02a0 */
