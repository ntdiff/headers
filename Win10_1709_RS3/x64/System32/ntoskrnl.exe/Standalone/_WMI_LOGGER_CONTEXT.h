...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0340 */ unsigned long SpareFlags2 : 7; /* bit position: 25 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
  ...
  /* 0x0850 */ struct _RTL_BITMAP HookIdMap;
  /* 0x0860 */ struct _ETW_STACK_CACHE* StackCache;
  /* 0x0868 */ struct _ETW_PMC_SUPPORT* PmcData;
  /* 0x0870 */ struct _ETW_LBR_SUPPORT* LbrData;
  /* 0x0878 */ struct _LIST_ENTRY BinaryTrackingList;
  /* 0x0888 */ struct _WMI_BUFFER_HEADER** ScratchArray;
  /* 0x0890 */ struct _DISALLOWED_GUIDS DisallowedGuids;
  /* 0x08a0 */ __int64 RelativeTimerDueTime;
  /* 0x08a8 */ struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;
  /* 0x08b8 */ struct _EX_TIMER* PeriodicCaptureStateTimer;
  /* 0x08c0 */ enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;
  /* 0x08c8 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x08d0 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x08d8 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x08f8 */ long CompressionWorkItemState;
  /* 0x0900 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x0908 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x0910 */ void* CompressionWorkspace;
  /* 0x0918 */ long CompressionOn;
  /* 0x091c */ unsigned long CompressionRatioGuess;
  /* 0x0920 */ unsigned long PartialBufferCompressionLevel;
  /* 0x0924 */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x0928 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x0930 */ struct _KDPC CompressionDpc;
  /* 0x0970 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0978 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0980 */ union _LARGE_INTEGER BufferCompressDuration;
  /* 0x0988 */ long __PADDING__[2];
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0990 */
