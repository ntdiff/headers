...
typedef struct _MI_PROCESS_STATE
{
  ...
  /* 0x0030 */ unsigned __int64 VadSecureCookie;
} MI_PROCESS_STATE, *PMI_PROCESS_STATE; /* size: 0x0038 */
...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x0050 */ unsigned long MediumPageColors;
  /* 0x0054 */ unsigned long FlushTbForAttributeChange;
  /* 0x0058 */ unsigned long FlushCacheForAttributeChange;
  /* 0x005c */ unsigned long FlushCacheForPageAttributeChange;
  /* 0x0060 */ unsigned long CacheFlushPromoteThreshold;
  /* 0x0068 */ unsigned __int64 FlushTbThreshold;
  /* 0x0070 */ enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4][4];
  /* 0x00b0 */ unsigned char AttributeChangeRequiresReZero;
  /* 0x00b8 */ struct _MI_ZERO_COST_COUNTS ZeroCostCounts[2];
  /* 0x00d8 */ unsigned __int64 PrimaryPfns;
  /* 0x00e0 */ unsigned __int64 HighestPossiblePhysicalPage;
  /* 0x00e8 */ struct _RTL_AVL_TREE EnclaveRegions;
  /* 0x00f0 */ unsigned __int64 VsmKernelPageCount;
} MI_HARDWARE_STATE, *PMI_HARDWARE_STATE; /* size: 0x00f8 */
...
typedef struct _MI_SYSTEM_VA_STATE
{
  ...
  /* 0x0284 */ volatile long DeleteKvaLock;
  /* 0x0288 */ struct _MI_WSLE* WsleArrays[5];
  /* 0x02b0 */ struct _MI_HYPER_SPACE* PagableHyperSpace;
  /* 0x02b8 */ void* HyperSpaceEnd;
  /* 0x02c0 */ struct _KEVENT FreeSystemCacheVa;
  /* 0x02d8 */ unsigned __int64 SystemVaLock;
  /* 0x02e0 */ unsigned __int64 SystemCacheViewLock;
  /* 0x02e8 */ struct _MMWSL_INSTANCE SystemWorkingSetList[5];
  /* 0x03b0 */ long __PADDING__[4];
} MI_SYSTEM_VA_STATE, *PMI_SYSTEM_VA_STATE; /* size: 0x03c0 */
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x0188 */ unsigned long StackGrowthFailures;
  /* 0x018c */ unsigned char KernelStackPages;
  /* 0x018d */ unsigned char TrackPtesAborted;
  /* 0x018e */ unsigned char AdjustCounter;
  /* 0x0190 */ volatile long ReservedMappingLock;
  /* 0x0198 */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x01a0 */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x01a8 */ struct _RTL_AVL_TREE OutswappedKernelStackRoot;
  /* 0x01b0 */ volatile long OutswappedKernelStackLock;
  /* 0x01b8 */ struct _MI_ULTRA_VA_CONTEXT UltraSpaceContext;
  /* 0x01f8 */ unsigned long NumberOfUltraMdlMaps;
  /* 0x0200 */ struct _MI_ULTRA_MDL_NODE* UltraMdlNodeMappings;
  /* 0x0208 */ long __PADDING__[14];
} MI_SYSTEM_PTE_STATE, *PMI_SYSTEM_PTE_STATE; /* size: 0x0240 */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0690 */ unsigned __int64 SystemVaTypeCount[16];
  /* 0x0710 */ unsigned char SystemVaType[256];
  /* 0x0810 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[14];
  /* 0x08f0 */ long __PADDING__[4];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0438 */ struct _MI_SESSION_STATE Sessions;
  /* 0x04c0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x04f8 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x0600 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x09c0 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x09d8 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x09e8 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x0a48 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x0ac0 */ struct _MI_ERROR_STATE Errors;
  /* 0x0b80 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x0c00 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x0d20 */ struct _MI_STANDBY_STATE Standby;
  /* 0x0dc0 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x1000 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x1070 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x10c0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x1180 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x11c0 */ unsigned __int64 Cookie;
  /* 0x11c8 */ void* volatile* BootRegistryRuns;
  /* 0x11d0 */ volatile long ZeroingDisabled;
  /* 0x11d4 */ unsigned char FullyInitialized;
  /* 0x11d5 */ unsigned char SafeBooted;
  /* 0x11d8 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x1200 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x1b00 */
