  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x0004 */ unsigned long Spare : 19; /* bit position: 13 */
      }; /* bitfield */
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x006e */ unsigned char HeteroDecreaseTime;
  /* 0x006f */ unsigned char HeteroIncreaseTime;
  /* 0x0070 */ unsigned char HeteroDecreaseThreshold[1280];
  /* 0x0570 */ unsigned char HeteroIncreaseThreshold[1280];
  /* 0x0a70 */ unsigned char Class0FloorPerformance;
  /* 0x0a71 */ unsigned char Class1InitialPerformance;
  /* 0x0a74 */ enum _KHETERO_CPU_POLICY ThreadPolicies[2];
  /* 0x0a7c */ long __PADDING__[1];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x0a80 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x1528 */ unsigned __int64 StartTime;
  /* 0x1530 */ unsigned __int64 Count;
  /* 0x1538 */ unsigned __int64 MaxDuration;
  /* 0x1540 */ unsigned __int64 MinDuration;
  /* 0x1548 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x1550 */
