...
typedef struct _ETW_SILODRIVERSTATE
{
  ...
  /* 0x01a0 */ struct _EX_RUNDOWN_REF_CACHE_AWARE** EtwpLoggerRundown;
  /* 0x01a8 */ struct _WMI_LOGGER_CONTEXT** EtwpLoggerContext;
  /* 0x01b0 */ struct _ETW_HASH_BUCKET EtwpGuidHashTable[64];
  /* 0x0fb0 */ unsigned short EtwpSecurityLoggers[8];
  /* 0x0fc0 */ unsigned char EtwpSecurityProviderEnableMask;
  /* 0x0fc4 */ long EtwpShutdownInProgress;
  /* 0x0fc8 */ unsigned long EtwpSecurityProviderPID;
  /* 0x0fd0 */ struct _ETW_PRIV_HANDLE_DEMUX_TABLE PrivHandleDemuxTable;
  /* 0x0ff0 */ struct _ETW_COUNTERS EtwpCounters;
  /* 0x1000 */ union _LARGE_INTEGER LogfileBytesWritten;
  /* 0x1008 */ struct _ETW_SILO_TRACING_BLOCK* ProcessorBlocks;
  /* 0x1010 */ struct _GUID PartitionId;
  /* 0x1020 */ struct _GUID ParentId;
  /* 0x1030 */ union _LARGE_INTEGER QpcOffsetFromRoot;
  /* 0x1038 */ unsigned long PartitionType;
  /* 0x103c */ struct _ETW_SYSTEM_LOGGER_SETTINGS SystemLoggerSettings;
} ETW_SILODRIVERSTATE, *PETW_SILODRIVERSTATE; /* size: 0x1190 */
