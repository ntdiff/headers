...
typedef struct _X_FILTER
{
  ...
  /* 0x0156 */ char Padding_68[2];
  /* 0x0158 */ unsigned int MaxMulticastAddresses;
  /* 0x015c */ long Padding_69;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x10b6 */ char Padding_170[2];
  /* 0x10b8 */ unsigned long DirectOidRequestCount;
  /* 0x10bc */ long Padding_171;
...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0041 */ char Padding_304[7];
  /* 0x0048 */ struct _REFERENCE_EX Ref;
  /* 0x0060 */ int FakeStatus;
  /* 0x0064 */ long Padding_305;
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_375[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_376[12];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_509;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_510[2];
...
{
  /* 0x0000 */ long Padding_546[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_547;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_548;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
...
??$IsBufferAligned@U_NET_PACKET@@@@YA_NPEAX@Z
...
??$OffsetPointerBy@U_NET_PACKET@@@@YAPEAU_NET_PACKET@@PEAU0@K@Z
...
??0?$KArray@PEAUNDIS_BIND_FILTER_LINK@@$00@Rtl@@QEAA@_K@Z
...
??0NDIS_SETUP_DEVICE_EXTENSION@@QEAA@PEAU_DEVICE_OBJECT@@@Z
...
??9const_iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QEBA_NAEBV012@@Z
??A?$KArray@PEAUNDIS_BIND_FILTER_LINK@@$00@Rtl@@QEAAAEAPEAUNDIS_BIND_FILTER_LINK@@_K@Z
...
??Diterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QEBAAEAV?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@XZ
...
?GetExtensionForClient@@YAPEAUNET_PACKET_EXTENSION@@PEAUHNETPACKETCLIENT__@@PEBG@Z
...
?InsertExtension@@YAXPEAUNET_PACKET_EXTENSION@@@Z
...
?NetPacketAssignLayout@@YAXPEAUNET_PACKET_EXTENSION@@PEAK@Z
?NetPacketClearVolatileFields@@YAXPEAU_NET_PACKET@@@Z
...
?QUEUE_WORK_ITEM_PRIORITY@@YAXPEAU_WORK_QUEUE_ITEM@@H@Z
...
?eraseAt@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QEAAX_K@Z
...
NdispRegisterShim
NetPacketClientPauseComplete
NetPacketDeepCopyOne
NetPacketDeregisterClient
NetPacketDestroyMany
NetPacketDestroyOne
NetPacketExtensionAllocate
NetPacketExtensionFree
NetPacketExtensionWaitForReady
NetPacketGetExtensionOffset
NetPacketGetExtensionSize
NetPacketGetSize
NetPacketInitializeMany
NetPacketInitializeOne
