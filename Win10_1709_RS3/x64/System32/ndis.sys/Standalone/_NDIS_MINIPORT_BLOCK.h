...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1528 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x1550 */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x1578 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x1580 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,-1,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x1588 */ struct _NDIS_PD_BLOCK* PDBlock;
  /* 0x1590 */ void* PdcHandle;
  /* 0x1598 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x1618 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x1668 */ volatile long PdcTaskClientMode;
  /* 0x166c */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x1670 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x1678 */ volatile long RssV2CompletionCount;
  /* 0x1680 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x1698 */ struct _LIST_ENTRY SynchronousOidCalls;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x16a8 */
