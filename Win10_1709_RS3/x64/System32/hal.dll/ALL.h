...
typedef struct _IOMMU_DEVICE_PATH
{
  ...
  /* 0x0010 */ void* UniqueId;
  /* 0x0018 */ void* Path;
} IOMMU_DEVICE_PATH, *PIOMMU_DEVICE_PATH; /* size: 0x0020 */
...
typedef struct _REGISTERED_INTERRUPT_CONTROLLER
{
  ...
  /* 0x00c8 */ enum _KNOWN_CONTROLLER_TYPE KnownType;
  /* 0x00cc */ unsigned long Capabilities;
  /* 0x00d0 */ unsigned long Flags;
  /* 0x00d4 */ unsigned long MaxPriority;
  /* 0x00d8 */ unsigned long UnitId;
  /* 0x00dc */ long Padding_89;
  /* 0x00e0 */ struct _LIST_ENTRY LinesHead;
  /* 0x00f0 */ struct _LIST_ENTRY OutputLinesHead;
  /* 0x0100 */ long MinLine;
  /* 0x0104 */ long MaxLine;
  /* 0x0108 */ unsigned long MaxClusterSize;
  /* 0x010c */ unsigned long MaxClusters;
  /* 0x0110 */ unsigned long InterruptReplayDataSize;
  /* 0x0114 */ enum _INTERRUPT_PROBLEM Problem;
  /* 0x0118 */ long ProblemStatus;
  /* 0x011c */ long Padding_90;
  /* 0x0120 */ const char* ProblemSourceFile;
  /* 0x0128 */ unsigned long ProblemSourceLine;
  /* 0x012c */ unsigned long CustomProblem;
  /* 0x0130 */ long CustomProblemStatus;
  /* 0x0134 */ long Padding_91;
  /* 0x0138 */ struct _UNICODE_STRING ResourceId;
  /* 0x0148 */ struct POHANDLE__* PowerHandle;
} REGISTERED_INTERRUPT_CONTROLLER, *PREGISTERED_INTERRUPT_CONTROLLER; /* size: 0x0150 */
...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x00d9 */ char Padding_99[7];
  /* 0x00e0 */ unsigned long MapRegistersPerChannel;
  /* 0x00e4 */ long Padding_100;
  ...
  /* 0x0205 */ char Padding_105[3];
  /* 0x0208 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0210 */ struct _IOMMU_DEVICE_PATH* DevicePath;
  /* 0x0218 */ struct _MDL* ScatterGatherMdl;
  /* 0x0220 */ unsigned long ScatterGatherBufferLength;
  /* 0x0224 */ long Padding_106;
  /* 0x0228 */ struct _SCATTER_GATHER_LIST ScatterGatherBuffer;
} ADAPTER_OBJECT, *PADAPTER_OBJECT; /* size: 0x0238 */
...
} DMA_OPERATIONS, *PDMA_OPERATIONS; /* size: 0x0110 */
...
typedef struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
  ...
  /* 0x0180 */ void* AllocateDeviceDomain /* function */;
  /* 0x0188 */ void* AttachDeviceDomain /* function */;
  /* 0x0190 */ void* DetachDeviceDomain /* function */;
  /* 0x0198 */ void* DeleteDeviceDomain /* function */;
  /* 0x01a0 */ void* MapDeviceLogicalRange /* function */;
  /* 0x01a8 */ void* UnmapDeviceLogicalRange /* function */;
} HAL_INTEL_ENLIGHTENMENT_INFORMATION, *PHAL_INTEL_ENLIGHTENMENT_INFORMATION; /* size: 0x01b0 */
...
HalpDmaGetNextTranslatedDevice
HalpDmaGetNextWcb
...
HalpHvInitSystem
HalpHvIommuDeviceDomainAvailable
...
HalpUsbLegacyStopXhciInterrupt
