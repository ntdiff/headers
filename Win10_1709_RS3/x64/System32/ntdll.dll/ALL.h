...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x01a3 */ unsigned char LongPriorQosPeriod;
  ...
  /* 0x01f8 */ unsigned long QosEquivalencyMask;
...
typedef struct _KPRCB
{
  ...
  union
  {
    /* 0x00ec */ volatile long BamFlags;
    struct /* bitfield */
    {
      /* 0x00ec */ unsigned long BamQosLevel : 2; /* bit position: 0 */
      /* 0x00ec */ unsigned long PendingQosUpdate : 2; /* bit position: 2 */
      /* 0x00ec */ unsigned long BamFlagsReserved : 28; /* bit position: 4 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  ...
  /* 0x2db0 */ unsigned __int64 PrcbPad35[2];
  ...
  /* 0x5c20 */ unsigned __int64 PrcbPad81[3];
  ...
  /* 0x6138 */ unsigned __int64 PrcbPad86;
  ...
  /* 0x6430 */ struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;
  /* 0x6438 */ struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;
  /* 0x6440 */ struct _KDPC AbDpc;
  /* 0x6480 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x64d4 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x6528 */ struct _KSECURE_FAULT_INFORMATION SecureFault;
  /* 0x6538 */ unsigned __int64 PrcbPad120;
  /* 0x6540 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x67b0 */ unsigned __int64 PrcbPad125[2];
  /* 0x67c0 */ unsigned long TimerExpirationTraceCount;
  /* 0x67c4 */ unsigned long PrcbPad127;
  /* 0x67c8 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x68c8 */ unsigned __int64 PrcbPad128[7];
  /* 0x6900 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x6908 */ unsigned __int64 PrcbPad130[7];
  /* 0x6940 */ struct _REQUEST_MAILBOX RequestMailbox[1];
} KPRCB, *PKPRCB; /* size: 0x6980 */
...
typedef struct _PEB
{
  ...
  /* 0x07ac */ long __PADDING__[1];
} PEB, *PPEB; /* size: 0x07b0 */
...
typedef struct _KNODE
{
  ...
  /* 0x0060 */ long Padding_62[8];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_63;
  union
  {
  ...
  /* 0x00af */ char Padding_64;
  /* 0x00b0 */ struct _KHETERO_PROCESSOR_SET HeteroSets[5];
  /* 0x0128 */ unsigned __int64 PpmConfiguredQosSets[3];
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x01b8 */ unsigned long PpmPolicy : 3; /* bit position: 6 */
      /* 0x01b8 */ unsigned long ActiveGroupsMask : 20; /* bit position: 9 */
      /* 0x01b8 */ long ReservedFlags : 3; /* bit position: 29 */
    }; /* bitfield */
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x0161 */ char Padding_126[3];
  /* 0x0164 */ unsigned long DesiredPercent;
  /* 0x0168 */ unsigned long GuaranteedPercent;
  /* 0x016c */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[3];
  /* 0x01b4 */ unsigned long QosDisableReasons[3];
  /* 0x01c0 */ unsigned long QosEquivalencyMasks[3];
  /* 0x01cc */ unsigned char QosSupported;
  /* 0x01cd */ char Padding_127[3];
  /* 0x01d0 */ unsigned long SelectionGeneration;
  /* 0x01d4 */ long Padding_128;
  /* 0x01d8 */ struct _PERF_CONTROL_STATE_SELECTION QosSelection[3];
  /* 0x0250 */ unsigned __int64 PerfChangeTime;
  /* 0x0258 */ unsigned long PerfChangeIntervalCount;
  /* 0x025c */ unsigned char Force;
  /* 0x025d */ char __PADDING__[3];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x0260 */
...
typedef union _HEAP_PAGE_SEGMENT
{
  union
  {
    struct
    {
      ...
      /* 0x0010 */ unsigned __int64 Signature;
      /* 0x0018 */ unsigned char UnusedWatermark;
    }; /* size: 0x0019 */
...
typedef struct _EPROCESS
{
  ...
  struct /* bitfield */
  {
    /* 0x06cb */ unsigned char HangCount : 4; /* bit position: 0 */
    /* 0x06cb */ unsigned char GhostCount : 4; /* bit position: 4 */
  }; /* bitfield */
  union
  {
...
} EPROCESS, *PEPROCESS; /* size: 0x0838 */
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x06d0 */ unsigned long ReservedCrossThreadFlags : 9; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x06d4 */ unsigned long ReservedSameThreadPassiveFlags : 21; /* bit position: 11 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
  ...
  /* 0x0770 */ unsigned long KernelStackReference;
  /* 0x0774 */ long Padding_142;
