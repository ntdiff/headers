  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x000c */ unsigned long Reserved : 29; /* bit position: 3 */
      }; /* bitfield */
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
...
typedef enum _RTLP_CSB_LOCKMODE
{
  BitmapLockNotHeld = 0,
  BitmapLockShared = 1,
  BitmapLockExclusive = 2,
} RTLP_CSB_LOCKMODE, *PRTLP_CSB_LOCKMODE;
...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x014c */ unsigned char GuaranteedPerformancePercent;
  /* 0x014d */ unsigned char HvTargetState;
  /* 0x014e */ unsigned char Parked;
  /* 0x014f */ unsigned char LongPriorQosPeriod;
  /* 0x0150 */ unsigned long LatestPerformancePercent;
  /* 0x0154 */ unsigned long AveragePerformancePercent;
  /* 0x0158 */ unsigned long LatestAffinitizedPercent;
  ...
  /* 0x01a0 */ unsigned long QosEquivalencyMask;
...
typedef struct _HEAP_LARGE_ALLOC_DATA
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0010 */ unsigned long Spare : 11; /* bit position: 1 */
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      /* 0x005c */ unsigned long BamQosLevel : 2; /* bit position: 0 */
      ...
      /* 0x005c */ unsigned long ThreadFlagsSpare : 1; /* bit position: 23 */
  ...
  /* 0x0328 */ volatile long AbCompletedIoQoSBoostCount;
  /* 0x032c */ volatile short KeReferenceCount;
  /* 0x032e */ unsigned char AbOrphanedEntrySummary;
  /* 0x032f */ unsigned char AbOwnedEntryCount;
  /* 0x0330 */ unsigned long ForegroundLossTime;
  union
  {
    /* 0x0334 */ struct _LIST_ENTRY GlobalForegroundListEntry;
    struct
    {
      /* 0x0334 */ struct _SINGLE_LIST_ENTRY ForegroundDpcStackListEntry;
      /* 0x0338 */ unsigned long InGlobalForegroundList;
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
  /* 0x033c */ struct _KSCB* QueuedScb;
  /* 0x0340 */ unsigned __int64 NpxState;
  /* 0x0348 */ volatile unsigned long ThreadTimerDelay;
  union
  {
    /* 0x034c */ volatile long ThreadFlags2;
    struct /* bitfield */
    {
      /* 0x034c */ unsigned long PpmPolicy : 2; /* bit position: 0 */
      /* 0x034c */ unsigned long ThreadFlags2Reserved : 30; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
} KTHREAD, *PKTHREAD; /* size: 0x0350 */
...
typedef struct _KPRCB
{
  ...
  /* 0x04c3 */ unsigned char PrcbPad20;
  ...
  /* 0x04d4 */ unsigned long PrcbPad21[2];
  ...
  /* 0x21a8 */ unsigned __int64 LastNonHrTimerExpiration;
  /* 0x21b0 */ unsigned char PrcbPad50[32];
  ...
  /* 0x3ad4 */ unsigned long DpcWatchdogProfileCumulativeDpcThreshold;
  ...
  /* 0x3af8 */ unsigned long ReadyThreadCount;
  /* 0x3afc */ long Padding_19;
  /* 0x3b00 */ unsigned __int64 StartCycles;
  /* 0x3b08 */ unsigned __int64 TaggedCyclesStart;
  /* 0x3b10 */ unsigned __int64 TaggedCycles[2];
  /* 0x3b20 */ unsigned __int64 GenerationTarget;
  /* 0x3b28 */ volatile unsigned __int64 CycleTime;
  /* 0x3b30 */ unsigned __int64 AffinitizedCycles;
  /* 0x3b38 */ unsigned __int64 ImportantCycles;
  /* 0x3b40 */ unsigned __int64 UnimportantCycles;
  /* 0x3b48 */ unsigned __int64 ReadyQueueExpectedRunTime;
  /* 0x3b50 */ volatile unsigned long HighCycleTime;
  /* 0x3b54 */ long Padding_20;
  /* 0x3b58 */ unsigned __int64 Cycles[2][4];
  /* 0x3b98 */ unsigned long PrcbPad71[2];
  ...
  /* 0x3ed8 */ struct _KDPC ForceIdleDpc;
  /* 0x3ef8 */ unsigned long PrcbPad91[14];
  /* 0x3f30 */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x3f34 */ struct _KDPC DpcWatchdogDpc;
  /* 0x3f54 */ long Padding_22;
  /* 0x3f58 */ struct _KTIMER DpcWatchdogTimer;
  /* 0x3f80 */ union _SLIST_HEADER HypercallPageList;
  /* 0x3f88 */ void* HypercallCachedPages;
  /* 0x3f8c */ void* VirtualApicAssist;
  /* 0x3f90 */ unsigned __int64* StatisticsPage;
  /* 0x3f94 */ struct _CACHE_DESCRIPTOR Cache[5];
  /* 0x3fd0 */ unsigned long CacheCount;
  /* 0x3fd4 */ struct _KAFFINITY_EX PackageProcessorSet;
  /* 0x3fe0 */ unsigned long SharedReadyQueueMask;
  /* 0x3fe4 */ struct _KSHARED_READY_QUEUE* SharedReadyQueue;
  /* 0x3fe8 */ unsigned long SharedQueueScanOwner;
  /* 0x3fec */ unsigned long CoreProcessorSet;
  /* 0x3ff0 */ unsigned long ScanSiblingMask;
  /* 0x3ff4 */ unsigned long LLCMask;
  /* 0x3ff8 */ unsigned long CacheProcessorMask[5];
  /* 0x400c */ unsigned long ScanSiblingIndex;
  /* 0x4010 */ void* WheaInfo;
  /* 0x4014 */ void* EtwSupport;
  /* 0x4018 */ union _SLIST_HEADER InterruptObjectPool;
  /* 0x4020 */ void** DpcWatchdogProfile;
  /* 0x4024 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x4028 */ unsigned long PrcbPad92[1];
  /* 0x402c */ unsigned long PteBitCache;
  /* 0x4030 */ unsigned long PteBitOffset;
  /* 0x4034 */ unsigned long PrcbPad93;
  /* 0x4038 */ struct _PROCESSOR_PROFILE_CONTROL_AREA* ProcessorProfileControlArea;
  /* 0x403c */ void* ProfileEventIndexAddress;
  /* 0x4040 */ struct _KDPC TimerExpirationDpc;
  /* 0x4060 */ struct _SYNCH_COUNTERS SynchCounters;
  /* 0x4118 */ struct _FILESYSTEM_DISK_COUNTERS FsCounters;
  /* 0x4128 */ struct _CONTEXT* Context;
  /* 0x412c */ unsigned long ContextFlagsInit;
  /* 0x4130 */ struct _XSAVE_AREA* ExtendedState;
  /* 0x4134 */ struct _KENTROPY_TIMING_STATE EntropyTimingState;
  /* 0x425c */ void* IsrStack;
  /* 0x4260 */ struct _KINTERRUPT* VectorToInterruptObject[208];
  /* 0x45a0 */ struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;
  /* 0x45a4 */ struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;
  /* 0x45a8 */ struct _KDPC AbDpc;
  /* 0x45c8 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x461c */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x4670 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x4770 */ unsigned long TimerExpirationTraceCount;
  /* 0x4774 */ void* ExSaPageArray;
  /* 0x4778 */ unsigned long PrcbPad100[10];
  /* 0x47a0 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x48e0 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x48e4 */ unsigned char PrcbPad[60];
  /* 0x4920 */ struct _REQUEST_MAILBOX RequestMailbox[1];
} KPRCB, *PKPRCB; /* size: 0x4940 */
...
typedef struct _TEB
{
  ...
  /* 0x0175 */ char PlaceholderReserved[11];
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0064 */ unsigned long PpmPolicy : 3; /* bit position: 6 */
      /* 0x0064 */ unsigned long ActiveGroupsMask : 1; /* bit position: 9 */
      /* 0x0064 */ long ReservedFlags : 22; /* bit position: 10 */
    }; /* bitfield */
...
typedef struct _PEB
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0028 */ unsigned long ReservedBits0 : 25; /* bit position: 7 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
  ...
  /* 0x0464 */ long __PADDING__[1];
} PEB, *PPEB; /* size: 0x0468 */
...
typedef struct _PROC_PERF_CHECK
{
  ...
  /* 0x0018 */ struct _PROC_PERF_CHECK_SNAP LastPerfCheckSnap;
  /* 0x0068 */ struct _PROC_PERF_CHECK_SNAP CurrentSnap;
  /* 0x00b8 */ struct _PROC_PERF_CHECK_SNAP LastDeliveredSnap;
  /* 0x0108 */ unsigned long LastDeliveredPerformance;
  /* 0x010c */ unsigned long LastDeliveredFrequency;
  /* 0x0110 */ unsigned char TaggedThreadPercent[2];
  /* 0x0112 */ char __PADDING__[6];
} PROC_PERF_CHECK, *PPROC_PERF_CHECK; /* size: 0x0118 */
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x00ed */ char Padding_50[3];
  /* 0x00f0 */ unsigned long SelectionGeneration;
  /* 0x00f4 */ long Padding_51;
...
typedef struct _PROC_PERF_CONSTRAINT
{
  ...
  /* 0x0068 */ unsigned char Force;
  /* 0x0069 */ char __PADDING__[7];
} PROC_PERF_CONSTRAINT, *PPROC_PERF_CONSTRAINT; /* size: 0x0070 */
...
typedef struct _RTLP_HEAP_FEATURES
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned char DisableDbgBreakOnCorruption : 1; /* bit position: 2 */
    /* 0x0000 */ unsigned char TraceLoggingEnabled : 1; /* bit position: 3 */
  }; /* bitfield */
...
typedef struct _EPROCESS
{
  ...
  /* 0x01fc */ struct _MMSUPPORT_FULL Vm;
  /* 0x0288 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0290 */ unsigned long ModifiedPageCount;
  /* 0x0294 */ long ExitStatus;
  /* 0x0298 */ struct _RTL_AVL_TREE VadRoot;
  /* 0x029c */ void* VadHint;
  /* 0x02a0 */ unsigned long VadCount;
  /* 0x02a4 */ volatile unsigned long VadPhysicalPages;
  /* 0x02a8 */ unsigned long VadPhysicalPagesLimit;
  /* 0x02ac */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x02bc */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x02c4 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x02c8 */ unsigned long RequestedTimerResolution;
  /* 0x02cc */ unsigned long SmallestTimerResolution;
  /* 0x02d0 */ union _LARGE_INTEGER ExitTime;
  /* 0x02d8 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x02dc */ unsigned long LargePrivateVadCount;
  /* 0x02e0 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x02e4 */ void* WnfContext;
  /* 0x02e8 */ struct _EJOB* ServerSilo;
  /* 0x02ec */ unsigned char SignatureLevel;
  /* 0x02ed */ unsigned char SectionSignatureLevel;
  /* 0x02ee */ struct _PS_PROTECTION Protection;
  struct /* bitfield */
  {
    /* 0x02ef */ unsigned char HangCount : 4; /* bit position: 0 */
    /* 0x02ef */ unsigned char GhostCount : 4; /* bit position: 4 */
  }; /* bitfield */
  union
  {
    /* 0x02f0 */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x02f0 */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x02f0 */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x02f0 */ unsigned long Crashed : 1; /* bit position: 2 */
      /* 0x02f0 */ unsigned long JobVadsAreTracked : 1; /* bit position: 3 */
      /* 0x02f0 */ unsigned long VadTrackingDisabled : 1; /* bit position: 4 */
      /* 0x02f0 */ unsigned long AuxiliaryProcess : 1; /* bit position: 5 */
      /* 0x02f0 */ unsigned long SubsystemProcess : 1; /* bit position: 6 */
      /* 0x02f0 */ unsigned long IndirectCpuSets : 1; /* bit position: 7 */
      /* 0x02f0 */ unsigned long RelinquishedCommit : 1; /* bit position: 8 */
      /* 0x02f0 */ unsigned long HighGraphicsPriority : 1; /* bit position: 9 */
      /* 0x02f0 */ unsigned long CommitFailLogged : 1; /* bit position: 10 */
      /* 0x02f0 */ unsigned long ReserveFailLogged : 1; /* bit position: 11 */
      /* 0x02f0 */ unsigned long SystemProcess : 1; /* bit position: 12 */
      /* 0x02f0 */ unsigned long HideImageBaseAddresses : 1; /* bit position: 13 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02f4 */ long DeviceAsid;
  /* 0x02f8 */ void* SvmData;
  /* 0x02fc */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x0300 */ unsigned long SvmLock;
  /* 0x0304 */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x030c */ long Padding_58;
  /* 0x0310 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x0318 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x031c */ void* PicoContext;
  /* 0x0320 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x0324 */ void* InstrumentationCallback;
  /* 0x0328 */ struct _PO_PROCESS_ENERGY_CONTEXT* EnergyContext;
  /* 0x032c */ void* VmContext;
  /* 0x0330 */ unsigned __int64 SequenceNumber;
  /* 0x0338 */ unsigned __int64 CreateInterruptTime;
  /* 0x0340 */ unsigned __int64 CreateUnbiasedInterruptTime;
  /* 0x0348 */ unsigned __int64 TotalUnbiasedFrozenTime;
  /* 0x0350 */ unsigned __int64 LastAppStateUpdateTime;
  struct /* bitfield */
  {
    /* 0x0358 */ unsigned __int64 LastAppStateUptime : 61; /* bit position: 0 */
    /* 0x0358 */ unsigned __int64 LastAppState : 3; /* bit position: 61 */
  }; /* bitfield */
  /* 0x0360 */ volatile unsigned long SharedCommitCharge;
  /* 0x0364 */ struct _EX_PUSH_LOCK SharedCommitLock;
  /* 0x0368 */ struct _LIST_ENTRY SharedCommitLinks;
  union
  {
    struct
    {
      /* 0x0370 */ unsigned long AllowedCpuSets;
      /* 0x0374 */ unsigned long DefaultCpuSets;
    }; /* size: 0x0008 */
    struct
    {
      /* 0x0370 */ unsigned long* AllowedCpuSetsIndirect;
      /* 0x0374 */ unsigned long* DefaultCpuSetsIndirect;
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
  /* 0x0378 */ void* DiskIoAttribution;
  /* 0x037c */ void* DxgProcess;
  /* 0x0380 */ unsigned long Win32KFilterSet;
  /* 0x0384 */ long Padding_59;
  /* 0x0388 */ volatile union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;
  /* 0x0390 */ volatile unsigned long KTimerSets;
  /* 0x0394 */ volatile unsigned long KTimer2Sets;
  /* 0x0398 */ volatile unsigned long ThreadTimerSets;
  /* 0x039c */ unsigned long VirtualTimerListLock;
  /* 0x03a0 */ struct _LIST_ENTRY VirtualTimerListHead;
  union
  {
    /* 0x03a8 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x03a8 */ struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0030 */
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        /* 0x03d8 */ unsigned long ControlFlowGuardEnabled : 1; /* bit position: 0 */
        /* 0x03d8 */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 1 */
        /* 0x03d8 */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 2 */
        /* 0x03d8 */ unsigned long DisallowStrippedImages : 1; /* bit position: 3 */
        /* 0x03d8 */ unsigned long ForceRelocateImages : 1; /* bit position: 4 */
        /* 0x03d8 */ unsigned long HighEntropyASLREnabled : 1; /* bit position: 5 */
        /* 0x03d8 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 6 */
        /* 0x03d8 */ unsigned long ExtensionPointDisable : 1; /* bit position: 7 */
        /* 0x03d8 */ unsigned long DisableDynamicCode : 1; /* bit position: 8 */
        /* 0x03d8 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 9 */
        /* 0x03d8 */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 10 */
        /* 0x03d8 */ unsigned long AuditDisableDynamicCode : 1; /* bit position: 11 */
        /* 0x03d8 */ unsigned long DisallowWin32kSystemCalls : 1; /* bit position: 12 */
        /* 0x03d8 */ unsigned long AuditDisallowWin32kSystemCalls : 1; /* bit position: 13 */
        /* 0x03d8 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 14 */
        /* 0x03d8 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 15 */
        /* 0x03d8 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 16 */
        /* 0x03d8 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 17 */
        /* 0x03d8 */ unsigned long PreferSystem32Images : 1; /* bit position: 18 */
        /* 0x03d8 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 19 */
        /* 0x03d8 */ unsigned long AuditProhibitRemoteImageMap : 1; /* bit position: 20 */
        /* 0x03d8 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 21 */
        /* 0x03d8 */ unsigned long AuditProhibitLowILImageMap : 1; /* bit position: 22 */
        /* 0x03d8 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 23 */
        /* 0x03d8 */ unsigned long AuditBlockNonMicrosoftBinaries : 1; /* bit position: 24 */
        /* 0x03d8 */ unsigned long AuditBlockNonMicrosoftBinariesAllowStore : 1; /* bit position: 25 */
        /* 0x03d8 */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 26 */
        /* 0x03d8 */ unsigned long AuditLoaderIntegrityContinuity : 1; /* bit position: 27 */
        /* 0x03d8 */ unsigned long EnableModuleTamperingProtection : 1; /* bit position: 28 */
        /* 0x03d8 */ unsigned long EnableModuleTamperingProtectionNoInherit : 1; /* bit position: 29 */
      }; /* bitfield */
  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        /* 0x03dc */ unsigned long EnableExportAddressFilter : 1; /* bit position: 0 */
        /* 0x03dc */ unsigned long AuditExportAddressFilter : 1; /* bit position: 1 */
        /* 0x03dc */ unsigned long EnableExportAddressFilterPlus : 1; /* bit position: 2 */
        /* 0x03dc */ unsigned long AuditExportAddressFilterPlus : 1; /* bit position: 3 */
        /* 0x03dc */ unsigned long EnableRopStackPivot : 1; /* bit position: 4 */
        /* 0x03dc */ unsigned long AuditRopStackPivot : 1; /* bit position: 5 */
        /* 0x03dc */ unsigned long EnableRopCallerCheck : 1; /* bit position: 6 */
        /* 0x03dc */ unsigned long AuditRopCallerCheck : 1; /* bit position: 7 */
        /* 0x03dc */ unsigned long EnableRopSimExec : 1; /* bit position: 8 */
        /* 0x03dc */ unsigned long AuditRopSimExec : 1; /* bit position: 9 */
        /* 0x03dc */ unsigned long EnableImportAddressFilter : 1; /* bit position: 10 */
        /* 0x03dc */ unsigned long AuditImportAddressFilter : 1; /* bit position: 11 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x03e0 */ void* PartitionObject;
...
typedef struct _ETHREAD
{
  ...
  /* 0x0350 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0358 */ union _LARGE_INTEGER ExitTime;
    /* 0x0358 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0008 */
  /* 0x0360 */ void* ChargeOnlySession;
  union
  {
    /* 0x0364 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0364 */ void* ForwardLinkShadow;
      /* 0x0368 */ void* StartAddress;
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
  union
  {
    /* 0x036c */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x036c */ struct _ETHREAD* ReaperLink;
    /* 0x036c */ void* KeyedWaitValue;
  }; /* size: 0x0004 */
  /* 0x0370 */ unsigned long ActiveTimerListLock;
  /* 0x0374 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x037c */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0384 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0384 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0014 */
  /* 0x0398 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x039c */ struct _LIST_ENTRY IrpList;
  /* 0x03a4 */ unsigned long TopLevelIrp;
  /* 0x03a8 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x03ac */ void* Win32StartAddress;
  /* 0x03b0 */ void* LegacyPowerObject;
  /* 0x03b4 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x03bc */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x03c0 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x03c4 */ unsigned long ReadClusterSize;
  /* 0x03c8 */ volatile long MmLockOrdering;
  union
  {
    /* 0x03cc */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x03cc */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x03cc */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x03cc */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x03cc */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x03cc */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x03cc */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x03cc */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x03cc */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x03cc */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x03cc */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x03cc */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x03cc */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x03cc */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x03cc */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x03cc */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x03cc */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x03cc */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x03cc */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x03cc */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x03cc */ unsigned long ReservedCrossThreadFlags : 9; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03d0 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x03d0 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x03d0 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x03d0 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x03d0 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x03d0 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x03d0 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x03d0 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x03d0 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x03d0 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x03d0 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x03d0 */ unsigned long ReservedSameThreadPassiveFlags : 21; /* bit position: 11 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03d4 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x03d4 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x03d4 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x03d4 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x03d4 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x03d4 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x03d4 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x03d4 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x03d4 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x03d5 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x03d5 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x03d5 */ unsigned char AllowWritesToExecutableMemory : 1; /* bit position: 4 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x03d8 */ unsigned char CacheManagerActive;
  /* 0x03d9 */ unsigned char DisablePageFaultClustering;
  /* 0x03da */ unsigned char ActiveFaultCount;
  /* 0x03db */ unsigned char LockOrderState;
  /* 0x03dc */ unsigned long AlpcMessageId;
  union
  {
    /* 0x03e0 */ void* AlpcMessage;
    /* 0x03e0 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0004 */
  /* 0x03e4 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x03ec */ long ExitStatus;
  /* 0x03f0 */ unsigned long CacheManagerCount;
  /* 0x03f4 */ unsigned long IoBoostCount;
  /* 0x03f8 */ unsigned long IoQoSBoostCount;
  /* 0x03fc */ unsigned long IoQoSThrottleCount;
  /* 0x0400 */ struct _LIST_ENTRY BoostList;
  /* 0x0408 */ struct _LIST_ENTRY DeboostList;
  /* 0x0410 */ unsigned long BoostListLock;
  /* 0x0414 */ unsigned long IrpListLock;
  /* 0x0418 */ void* ReservedForSynchTracking;
  /* 0x041c */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0420 */ const struct _GUID* ActivityId;
  /* 0x0424 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0428 */ void* VerifierContext;
  /* 0x042c */ unsigned long KernelStackReference;
  /* 0x0430 */ void* AdjustedClientToken;
  /* 0x0434 */ void* WorkOnBehalfThread;
  /* 0x0438 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x0444 */ void* PicoContext;
  /* 0x0448 */ unsigned long UserFsBase;
  /* 0x044c */ unsigned long UserGsBase;
  /* 0x0450 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x0454 */ void* CmDbgInfo;
  union
  {
    /* 0x0458 */ unsigned long SelectedCpuSets;
    /* 0x0458 */ unsigned long* SelectedCpuSetsIndirect;
  }; /* size: 0x0004 */
  /* 0x045c */ struct _EJOB* Silo;
  /* 0x0460 */ struct _UNICODE_STRING* ThreadName;
  /* 0x0464 */ unsigned long LastExpectedRunTime;
  /* 0x0468 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x0470 */ unsigned long DisownedOwnerEntryListLock;
  /* 0x0474 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
  /* 0x047c */ long __PADDING__[1];
} ETHREAD, *PETHREAD; /* size: 0x0480 */
...
typedef struct _HEAP
{
  ...
  /* 0x00d4 */ void* FrontEndHeap;
  /* 0x00d8 */ unsigned short FrontHeapLockCount;
  /* 0x00da */ unsigned char FrontEndHeapType;
  /* 0x00db */ unsigned char RequestedFrontEndHeapType;
  /* 0x00dc */ unsigned short* FrontEndHeapUsageData;
  /* 0x00e0 */ unsigned short FrontEndHeapMaximumIndex;
  /* 0x00e2 */ volatile unsigned char FrontEndHeapStatusBitmap[257];
  /* 0x01e3 */ char Padding_63;
  /* 0x01e4 */ struct _HEAP_COUNTERS Counters;
  /* 0x0240 */ struct _HEAP_TUNING_PARAMETERS TuningParameters;
...
typedef struct _DEVICE_CAPABILITIES
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0004 */ unsigned long Reserved : 11; /* bit position: 21 */
  }; /* bitfield */
...
typedef struct _EJOB
{
  ...
  /* 0x025c */ long Padding_68;
  /* 0x0260 */ struct _EPROCESS_VALUES Accounting;
  /* 0x02b8 */ unsigned long ShadowActiveProcessCount;
  /* 0x02bc */ unsigned long ActiveAuxiliaryProcessCount;
  /* 0x02c0 */ unsigned long SequenceNumber;
  /* 0x02c4 */ unsigned long JobId;
  /* 0x02c8 */ struct _GUID ContainerId;
  /* 0x02d8 */ struct _GUID ContainerTelemetryId;
  /* 0x02e8 */ struct _ESERVERSILO_GLOBALS* ServerSiloGlobals;
  /* 0x02ec */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x02f8 */ struct _PSP_STORAGE* Storage;
  /* 0x02fc */ struct _JOB_NET_RATE_CONTROL* NetRateControl;
  union
  {
    /* 0x0300 */ unsigned long JobFlags;
    struct /* bitfield */
    {
      /* 0x0300 */ unsigned long CloseDone : 1; /* bit position: 0 */
      /* 0x0300 */ unsigned long MultiGroup : 1; /* bit position: 1 */
      /* 0x0300 */ unsigned long OutstandingNotification : 1; /* bit position: 2 */
      /* 0x0300 */ unsigned long NotificationInProgress : 1; /* bit position: 3 */
      /* 0x0300 */ unsigned long UILimits : 1; /* bit position: 4 */
      /* 0x0300 */ unsigned long CpuRateControlActive : 1; /* bit position: 5 */
      /* 0x0300 */ unsigned long OwnCpuRateControl : 1; /* bit position: 6 */
      /* 0x0300 */ unsigned long Terminating : 1; /* bit position: 7 */
      /* 0x0300 */ unsigned long WorkingSetLock : 1; /* bit position: 8 */
      /* 0x0300 */ unsigned long JobFrozen : 1; /* bit position: 9 */
      /* 0x0300 */ unsigned long Background : 1; /* bit position: 10 */
      /* 0x0300 */ unsigned long WakeNotificationAllocated : 1; /* bit position: 11 */
      /* 0x0300 */ unsigned long WakeNotificationEnabled : 1; /* bit position: 12 */
      /* 0x0300 */ unsigned long WakeNotificationPending : 1; /* bit position: 13 */
      /* 0x0300 */ unsigned long LimitNotificationRequired : 1; /* bit position: 14 */
      /* 0x0300 */ unsigned long ZeroCountNotificationRequired : 1; /* bit position: 15 */
      /* 0x0300 */ unsigned long CycleTimeNotificationRequired : 1; /* bit position: 16 */
      /* 0x0300 */ unsigned long CycleTimeNotificationPending : 1; /* bit position: 17 */
      /* 0x0300 */ unsigned long TimersVirtualized : 1; /* bit position: 18 */
      /* 0x0300 */ unsigned long JobSwapped : 1; /* bit position: 19 */
      /* 0x0300 */ unsigned long ViolationDetected : 1; /* bit position: 20 */
      /* 0x0300 */ unsigned long EmptyJobNotified : 1; /* bit position: 21 */
      /* 0x0300 */ unsigned long NoSystemCharge : 1; /* bit position: 22 */
      /* 0x0300 */ unsigned long DropNoWakeCharges : 1; /* bit position: 23 */
      /* 0x0300 */ unsigned long NoWakeChargePolicyDecided : 1; /* bit position: 24 */
      /* 0x0300 */ unsigned long NetRateControlActive : 1; /* bit position: 25 */
      /* 0x0300 */ unsigned long OwnNetRateControl : 1; /* bit position: 26 */
      /* 0x0300 */ unsigned long IoRateControlActive : 1; /* bit position: 27 */
      /* 0x0300 */ unsigned long OwnIoRateControl : 1; /* bit position: 28 */
      /* 0x0300 */ unsigned long DisallowNewProcesses : 1; /* bit position: 29 */
      /* 0x0300 */ unsigned long Silo : 1; /* bit position: 30 */
      /* 0x0300 */ unsigned long ContainerTelemetryIdSet : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0304 */ unsigned long JobFlags2;
    struct /* bitfield */
    {
      /* 0x0304 */ unsigned long ParentLocked : 1; /* bit position: 0 */
      /* 0x0304 */ unsigned long EnableUsermodeSiloThreadImpersonation : 1; /* bit position: 1 */
      /* 0x0304 */ unsigned long DisallowUsermodeSiloThreadImpersonation : 1; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0308 */ struct _PROCESS_EXTENDED_ENERGY_VALUES* EnergyValues;
  /* 0x030c */ volatile unsigned long SharedCommitCharge;
  /* 0x0310 */ unsigned long DiskIoAttributionUserRefCount;
  /* 0x0314 */ unsigned long DiskIoAttributionRefCount;
  union
  {
    /* 0x0318 */ void* DiskIoAttributionContext;
    /* 0x0318 */ struct _EJOB* DiskIoAttributionOwnerJob;
  }; /* size: 0x0004 */
  /* 0x031c */ struct _JOB_RATE_CONTROL_HEADER IoRateControlHeader;
  /* 0x0330 */ struct _PS_IO_CONTROL_ENTRY GlobalIoControl;
  /* 0x034c */ volatile long IoControlStateLock;
  /* 0x0350 */ struct _RTL_RB_TREE VolumeIoControlTree;
  /* 0x0358 */ unsigned __int64 IoRateOverQuotaHistory;
  /* 0x0360 */ unsigned long IoRateCurrentGeneration;
  /* 0x0364 */ unsigned long IoRateLastQueryGeneration;
  /* 0x0368 */ unsigned long IoRateGenerationLength;
  /* 0x036c */ unsigned long IoRateOverQuotaNotifySequenceId;
  /* 0x0370 */ unsigned __int64 LastThrottledIoTime;
  /* 0x0378 */ struct _EX_PUSH_LOCK IoControlLock;
  /* 0x037c */ unsigned long SiloHardReferenceCount;
  /* 0x0380 */ struct _WORK_QUEUE_ITEM RundownWorkItem;
  /* 0x0390 */ void* PartitionObject;
  /* 0x0394 */ struct _EJOB* PartitionOwnerJob;
  /* 0x0398 */ union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;
} EJOB, *PEJOB; /* size: 0x03a0 */
...
} RTL_CSPARSE_BITMAP, *PRTL_CSPARSE_BITMAP; /* size: 0x0014 */
...
typedef union _HEAP_PAGE_SEGMENT
{
  union
  {
    struct
    {
      /* 0x0000 */ struct _LIST_ENTRY ListEntry;
      /* 0x0008 */ unsigned long Signature;
      /* 0x000c */ unsigned char UnusedWatermark;
    }; /* size: 0x000d */
...
typedef struct _RTLP_HP_STACKTRACKING_CONTEXT
{
  /* 0x0000 */ struct _RTL_SRWLOCK Lock;
  /* 0x0004 */ unsigned long Flags;
  /* 0x0008 */ struct _RTL_STACKDB_CONTEXT StackDbContext;
} RTLP_HP_STACKTRACKING_CONTEXT, *PRTLP_HP_STACKTRACKING_CONTEXT; /* size: 0x0034 */
...
typedef struct _MM_DRIVER_VERIFIER_DATA
{
  ...
  /* 0x008c */ volatile unsigned long UnsupportedRelocs;
  /* 0x0090 */ volatile unsigned long IATInExecutableSection;
} MM_DRIVER_VERIFIER_DATA, *PMM_DRIVER_VERIFIER_DATA; /* size: 0x0094 */
...
_CsrpLocalSetupForSecureProcess@0
...
_EtwpAddReloggedPartitionInfoEvent@12
...
_LdrpCompareModuleBaseAddressRange@8
_LdrpCompareModuleBaseAddresses@8
_LdrpCompareModuleMappingInfo@8
...
_LdrpFetchAddressOfSecurityCookie@20
...
_LdrpResolveProcedureAddress@20
...
_PsspCaptureVaSpaceInformation@12
...
_RtlStackDbContextInitialize@16
...
_RtlWow64PopAllCrossProcessWork@4
_RtlWow64PopCrossProcessWork@4
_RtlWow64PushCrossProcessWork@8
...
_RtlpCSparseBitmapPageCommit@8
...
_RtlpDbgPrintCriticalSectionTimeout@12
...
_RtlpHpHeapAllocate@8
_RtlpHpHeapCompact@8
_RtlpHpHeapCreate@12
...
_RtlpHpLfhSubsegmentIncBlockCounts@20
_RtlpHpLfhSubsegmentInitialize@16
...
_RtlpHpMetadataAlloc@8
_RtlpHpMetadataFree@4
_RtlpHpMetadataHeapInit@12
...
_RtlpHpSegPageRangeCoalesce@16
_RtlpHpSegPageRangeCommit@16
_RtlpHpSegPageRangeCountCommittedPages@12
_RtlpHpSegPageRangeDecommit@16
...
_RtlpHpSegSegmentAllocate@8
_RtlpHpSegSegmentFree@12
_RtlpHpSegSegmentInitialize@12
_RtlpHpSegSetExtraPresent@8
_RtlpHpSegSize@16
_RtlpHpSegSizeInternal@20
_RtlpHpSegUpdateCommit@12
_RtlpHpSegVsAllocate@16
_RtlpHpSegWalk@12
...
_RtlpHpVsSubsegmentInitialize@8
...
_RtlpInitializeStaticCriticalSection@4
...
_RtlpLogWaitForCriticalSection@4
