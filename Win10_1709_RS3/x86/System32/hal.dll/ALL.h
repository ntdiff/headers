...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x0134 */ struct _HALP_DMA_DOMAIN_OBJECT* DomainPointer;
  /* 0x0138 */ enum _EXT_IOMMU_TRANSLATION_TYPE TranslationType;
  /* 0x013c */ unsigned char AdapterInUse;
  /* 0x013d */ char Padding_12[3];
  /* 0x0140 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0144 */ struct _IOMMU_DEVICE_PATH* DevicePath;
  /* 0x0148 */ struct _MDL* ScatterGatherMdl;
  /* 0x014c */ unsigned long ScatterGatherBufferLength;
  /* 0x0150 */ struct _SCATTER_GATHER_LIST ScatterGatherBuffer;
} ADAPTER_OBJECT, *PADAPTER_OBJECT; /* size: 0x0158 */
...
} INTERRUPT_FUNCTION_TABLE, *PINTERRUPT_FUNCTION_TABLE; /* size: 0x0054 */
...
typedef struct _REGISTERED_INTERRUPT_CONTROLLER
{
  ...
  /* 0x0064 */ enum _KNOWN_CONTROLLER_TYPE KnownType;
  /* 0x0068 */ unsigned long Capabilities;
  /* 0x006c */ unsigned long Flags;
  /* 0x0070 */ unsigned long MaxPriority;
  /* 0x0074 */ unsigned long UnitId;
  /* 0x0078 */ struct _LIST_ENTRY LinesHead;
  /* 0x0080 */ struct _LIST_ENTRY OutputLinesHead;
  /* 0x0088 */ long MinLine;
  /* 0x008c */ long MaxLine;
  /* 0x0090 */ unsigned long MaxClusterSize;
  /* 0x0094 */ unsigned long MaxClusters;
  /* 0x0098 */ unsigned long InterruptReplayDataSize;
  /* 0x009c */ enum _INTERRUPT_PROBLEM Problem;
  /* 0x00a0 */ long ProblemStatus;
  /* 0x00a4 */ const char* ProblemSourceFile;
  /* 0x00a8 */ unsigned long ProblemSourceLine;
  /* 0x00ac */ unsigned long CustomProblem;
  /* 0x00b0 */ long CustomProblemStatus;
  /* 0x00b4 */ struct _UNICODE_STRING ResourceId;
  /* 0x00bc */ struct POHANDLE__* PowerHandle;
} REGISTERED_INTERRUPT_CONTROLLER, *PREGISTERED_INTERRUPT_CONTROLLER; /* size: 0x00c0 */
...
typedef struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
  ...
  /* 0x00c8 */ void* AllocateDeviceDomain /* function */;
  /* 0x00cc */ void* AttachDeviceDomain /* function */;
  /* 0x00d0 */ void* DetachDeviceDomain /* function */;
  /* 0x00d4 */ void* DeleteDeviceDomain /* function */;
  /* 0x00d8 */ void* MapDeviceLogicalRange /* function */;
  /* 0x00dc */ void* UnmapDeviceLogicalRange /* function */;
} HAL_INTEL_ENLIGHTENMENT_INFORMATION, *PHAL_INTEL_ENLIGHTENMENT_INFORMATION; /* size: 0x00e0 */
...
@HalpTimerAlwaysOnClockInterruptCommon@8
@HalpTimerClockInterruptCommon@8
@HalpTimerClockInterruptStubCommon@8
@HalpTimerClockIpiRoutineCommon@8
...
_HalpAreDriversDmarCompatible@4
...
_HalpCalculateDivisorRate@32
_HalpCalculateScatterGatherListSize@28
_HalpCalculateTickCount@28
...
_HalpDmaAllocateChildAdapterV3@48
...
_HalpHvCounterQuerySyncCounter@4
...
_HalpHvMapIoApicDeviceInterrupt@12
...
_HalpIvtCheckPathMatch@8
_HalpIvtProcessDmarTable@4
_HalpIvtProcessDrhdEntry@8
_HalpIvtValidateDeviceScope@8
...
_HalpTimerAlwaysOnClockInterrupt@0
...
_HalpUsbLegacyStopXhciInterrupt@12
...
_HalpX86InterruptThermalService@0
_HalpX86IommuInterruptRoutine@0
_HalpcGetCmosDataByType@16
_HalpcSetCmosDataByType@16
_HsaConfigureSettings@8
_HsaDisableInterrupt@4
_HsaDismissPageFault@20
_HsaEnableInterrupt@4
_HsaEnsureNoPendingFaults@8
_HsaFindDevice@16
_HsaFlushDeviceTbOnly@16
_HsaFlushTb@24
_HsaGetPageFault@32
_HsaGrowPasidTable@12
_HsaHandleInterrupt@4
_HsaInitializeIommu@8
_HsaInvalidateDTE@8
_HsaIommuSendCommand@12
_HsaMarkHiberRegions@12
_HsaSetDevicePasidTable@16
_HsaSetDeviceSvmCapabilities@16
_HsaSetMessageInterruptRouting@20
_HsaSetPasidAddressSpace@16
...
_IvtUpdateContextEntry@20
_IvtUpdateExtendedContextEntry@28
...
_IvtpGetNextDeviceScope@12
_IvtpGetNextDrhdDeviceScope@8
_IvtpGetNextInternalDeviceScope@8
_IvtpGetNextRemappingStructure@8
