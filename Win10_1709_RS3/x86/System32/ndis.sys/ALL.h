...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0048 */ long Padding_109[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_110[14];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_176;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_177[2];
...
typedef struct _TCP_OFFLOAD_STATE_DELEGATED
{
  ...
  /* 0x004e */ char Padding_197[2];
  struct
  {
    /* 0x0050 */ unsigned char ProbeCount;
    /* 0x0001 */ char Padding_198[3];
...
??0?$KArray@PAUNDIS_BIND_FILTER_LINK@@$00@Rtl@@QAE@I@Z
...
??1?$KStackStorage@UNDIS_SYNCHRONOUS_OID_CALLFRAME@@$06@@QAE@XZ
...
??9const_iterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QBE_NABV012@@Z
??A?$KArray@PAUNDIS_BIND_FILTER_LINK@@$00@Rtl@@QAEAAPAUNDIS_BIND_FILTER_LINK@@I@Z
...
??Diterator@?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QBEAAV?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@XZ
??_EMINIPORT_HOOK_DRIVER@@QAEPAXI@Z
??_G?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@QAEPAXI@Z
...
?QUEUE_WORK_ITEM_PRIORITY@@YGXPAU_WORK_QUEUE_ITEM@@H@Z
...
?allocate_inner@?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@AAE_NPAVKRefHolder@1@@Z
?allocate_inner@?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@AAE_NPAVKRefHolder@1@@Z
...
?ndisPcwEnableAlwaysOnCounterSet@@YGXPAU_NDIS_MINIPORT_BLOCK@@AAVKRegKey@@W4_NDIS_COUNTER_SET_ID@@KPBG@Z
...
_ndisIfInitialize@0
_ndisIfNotifyUpdatePacketFilter@8
