...
} NDIS_WDF_CX_CHARACTERISTICS, *PNDIS_WDF_CX_CHARACTERISTICS; /* size: 0x0030 */
...
typedef struct _NDIS_WDF_CX_DRIVER_BLOCK
{
  ...
  /* 0x0040 */ unsigned long ClientCount;
  /* 0x0044 */ enum _NDIS_WDF_CX_DRIVER_STATE State;
  /* 0x0045 */ char __PADDING__[3];
} NDIS_WDF_CX_DRIVER_BLOCK, *PNDIS_WDF_CX_DRIVER_BLOCK; /* size: 0x0048 */
