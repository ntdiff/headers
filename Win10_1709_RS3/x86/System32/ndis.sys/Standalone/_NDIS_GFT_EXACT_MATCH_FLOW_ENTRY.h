...
typedef struct _NDIS_GFT_EXACT_MATCH_FLOW_ENTRY
{
  ...
  union
  {
    union
    {
      ...
      /* 0x002c */ volatile struct _NDIS_GFT_PACKET_AND_BYTE_COUNTER_VALUE* PacketAndByteCounterAddress;
    }; /* size: 0x0004 */
  ...
  /* 0x0070 */ unsigned long HeaderGroupExactMatchArrayOffset;
  /* 0x0074 */ unsigned long HeaderGroupExactMatchArrayNumElements;
  /* 0x0078 */ unsigned long HeaderGroupExactMatchArrayElementSize;
  /* 0x007c */ unsigned long HeaderGroupTranspositionArrayOffset;
  /* 0x0080 */ unsigned long HeaderGroupTranspositionArrayNumElements;
  /* 0x0084 */ unsigned long HeaderGroupTranspositionArrayElementSize;
  /* 0x0088 */ unsigned long CustomActionOffset;
} NDIS_GFT_EXACT_MATCH_FLOW_ENTRY, *PNDIS_GFT_EXACT_MATCH_FLOW_ENTRY; /* size: 0x008c */
