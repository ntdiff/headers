...
typedef struct _NDIS_MINIPORT_OFFLOAD
{
  ...
  /* 0x04b4 */ void* MiniportRequestBuffer;
  /* 0x04b8 */ unsigned long MiniportRequestOid;
  /* 0x04bc */ unsigned long MiniportRequestBufferLength;
} NDIS_MINIPORT_OFFLOAD, *PNDIS_MINIPORT_OFFLOAD; /* size: 0x04c0 */
