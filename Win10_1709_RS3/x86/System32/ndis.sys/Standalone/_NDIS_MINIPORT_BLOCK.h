...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x0d34 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x0d48 */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x0d5c */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x0d60 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x0d64 */ void* PdcHandle;
  /* 0x0d68 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x0db0 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x0dd8 */ volatile long PdcTaskClientMode;
  /* 0x0ddc */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x0de0 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x0de4 */ volatile long RssV2CompletionCount;
  /* 0x0de8 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x0df8 */ struct _LIST_ENTRY SynchronousOidCalls;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x0e00 */
