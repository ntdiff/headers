...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  /* 0x04e8 */ struct _RTL_BITMAP HookIdMap;
  /* 0x04f0 */ struct _ETW_STACK_CACHE* StackCache;
  /* 0x04f4 */ struct _ETW_PMC_SUPPORT* PmcData;
  /* 0x04f8 */ struct _ETW_LBR_SUPPORT* LbrData;
  /* 0x04fc */ struct _LIST_ENTRY BinaryTrackingList;
  /* 0x0504 */ struct _WMI_BUFFER_HEADER** ScratchArray;
  /* 0x0508 */ struct _DISALLOWED_GUIDS DisallowedGuids;
  /* 0x0510 */ __int64 RelativeTimerDueTime;
  /* 0x0518 */ struct _PERIODIC_CAPTURE_STATE_GUIDS PeriodicCaptureStateGuids;
  /* 0x0520 */ struct _EX_TIMER* PeriodicCaptureStateTimer;
  /* 0x0524 */ enum _ETW_PERIODIC_TIMER_STATE PeriodicCaptureStateTimerState;
  /* 0x0528 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x052c */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x0530 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x0540 */ long CompressionWorkItemState;
  /* 0x0544 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x0548 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x054c */ void* CompressionWorkspace;
  /* 0x0550 */ long CompressionOn;
  /* 0x0554 */ unsigned long CompressionRatioGuess;
  /* 0x0558 */ unsigned long PartialBufferCompressionLevel;
  /* 0x055c */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x0560 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x0564 */ struct _KDPC CompressionDpc;
  /* 0x0588 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x0590 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x0598 */ union _LARGE_INTEGER BufferCompressDuration;
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x05a0 */
