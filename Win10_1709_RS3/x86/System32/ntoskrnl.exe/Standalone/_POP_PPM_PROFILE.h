...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x01a0 */ unsigned __int64 StartTime;
  /* 0x01a8 */ unsigned __int64 Count;
  /* 0x01b0 */ unsigned __int64 MaxDuration;
  /* 0x01b8 */ unsigned __int64 MinDuration;
  /* 0x01c0 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x01c8 */
