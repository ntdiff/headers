    ...
    struct // _TAG_UNNAMED_166
    {
      ...
      union
      {
        ...
        struct /* bitfield */
        {
          ...
          /* 0x0034 */ unsigned long LargePage : 1; /* bit position: 16 */
          /* 0x0034 */ unsigned long SystemImage : 1; /* bit position: 17 */
          /* 0x0034 */ unsigned long StrongCode : 2; /* bit position: 18 */
          /* 0x0034 */ unsigned long CantMove : 1; /* bit position: 20 */
          /* 0x0034 */ unsigned long BitMap : 2; /* bit position: 21 */
          /* 0x0034 */ unsigned long ImageActive : 1; /* bit position: 23 */
        }; /* bitfield */
      }; /* size: 0x0004 */
      union
      {
...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0060 */ struct _CONTROL_AREA PhysicalControlArea;
  /* 0x00b0 */ struct _MMPFNLIST PurgingExtentPages;
  /* 0x00c4 */ struct _MMPFN* DanglingExtentPages;
  /* 0x00c8 */ struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem;
  /* 0x00d8 */ unsigned char DanglingExtentsWorkerActive;
  /* 0x00d9 */ unsigned char PurgingExtentsNeedWatchdog;
  /* 0x00dc */ struct _RTL_AVL_TREE PageFileSectionHead;
  /* 0x00e0 */ volatile long PageFileSectionListSpinLock;
  /* 0x00e4 */ unsigned long ImageBias;
  /* 0x00e8 */ struct _EX_PUSH_LOCK RelocateBitmapsLock;
  /* 0x00ec */ struct _RTL_BITMAP ImageBitMap;
  /* 0x00f4 */ void* ApiSetSection;
  /* 0x00f8 */ void* ApiSetSchema;
  /* 0x00fc */ unsigned long ApiSetSchemaSize;
  /* 0x0100 */ unsigned long LostDataFiles;
  /* 0x0104 */ unsigned long LostDataPages;
  /* 0x0108 */ unsigned long ImageFailureReason;
  /* 0x010c */ struct _SECTION* CfgBitMapSection32;
  /* 0x0110 */ struct _CONTROL_AREA* CfgBitMapControlArea32;
  /* 0x0114 */ unsigned long ImageCfgFailure;
  /* 0x0118 */ unsigned long ImageChecksumBreakpoint;
  /* 0x011c */ unsigned long ImageSizeBreakpoint;
  /* 0x0120 */ volatile long ImageValidationFailed;
  /* 0x0124 */ long __PADDING__[7];
...
typedef struct _MI_SYSTEM_IMAGE_STATE
{
  ...
  /* 0x0008 */ struct _KMUTANT LoadLock;
  /* 0x0028 */ volatile long FixupLock;
...
typedef struct _MI_SESSION_STATE
{
  ...
  /* 0x0014 */ unsigned long DetachTimeStamp;
  /* 0x0018 */ unsigned char CodePageEdited;
  /* 0x001c */ unsigned long* DynamicPoolBitBuffer;
  /* 0x0020 */ long VaReferenceCount[1024];
  /* 0x1020 */ unsigned long* DynamicPtesBitBuffer;
  /* 0x1024 */ struct _EX_PUSH_LOCK IdLock;
  /* 0x1028 */ struct _EPROCESS* LeaderProcess;
  /* 0x102c */ struct _EX_PUSH_LOCK InitializeLock;
  /* 0x1030 */ struct _MMWSL_INSTANCE* WorkingSetList;
  /* 0x1034 */ void* SessionBase;
  /* 0x1038 */ void* SessionCore;
} MI_SESSION_STATE, *PMI_SESSION_STATE; /* size: 0x103c */
...
typedef struct _MI_PROCESS_STATE
{
  ...
  /* 0x0020 */ struct _MMPTE* SharedUserDataPte;
  /* 0x0024 */ unsigned long VadSecureCookie;
  /* 0x0028 */ unsigned long FreePaeEntries;
  /* 0x0030 */ struct _PAE_ENTRY FirstFreePae;
  /* 0x0050 */ volatile long AllocatedPaePages;
  /* 0x0054 */ unsigned long PaeLock;
  /* 0x0058 */ union _SLIST_HEADER PaeEntrySList;
...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x0034 */ unsigned long MediumPageColors;
  ...
  /* 0x0048 */ unsigned long FlushTbThreshold;
  /* 0x004c */ enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4][4];
  /* 0x008c */ unsigned char AttributeChangeRequiresReZero;
...
typedef struct _MI_SYSTEM_VA_STATE
{
  ...
  /* 0x1414 */ volatile long DeleteKvaLock;
  /* 0x1418 */ struct _MI_WSLE* WsleArrays[5];
  /* 0x142c */ struct _MI_HYPER_SPACE* PagableHyperSpace;
  /* 0x1430 */ void* HyperSpaceEnd;
  /* 0x1434 */ struct _KEVENT FreeSystemCacheVa;
  /* 0x1444 */ unsigned long SystemVaLock;
  /* 0x1448 */ unsigned long SystemCacheViewLock;
  /* 0x144c */ struct _MMWSL_INSTANCE SystemWorkingSetList[5];
  /* 0x14c4 */ long __PADDING__[15];
} MI_SYSTEM_VA_STATE, *PMI_SYSTEM_VA_STATE; /* size: 0x1500 */
...
typedef struct _MI_ERROR_STATE
{
  ...
  /* 0x006c */ struct _MI_FORCED_COMMITS ForcedCommits;
  /* 0x0074 */ unsigned long WsleFailures[1];
  ...
  /* 0x0090 */ unsigned long UserViewFailures;
  /* 0x0094 */ unsigned long UserViewCollisionFailures;
  /* 0x0098 */ struct _MI_RESAVAIL_FAILURES ResavailFailures;
  /* 0x00a0 */ unsigned char PendingBadPages;
  /* 0x00a1 */ unsigned char InitFailure;
  /* 0x00a2 */ unsigned char StopBadMaps;
  /* 0x00a3 */ char __PADDING__[5];
...
} MI_STANDBY_STATE, *PMI_STANDBY_STATE; /* size: 0x0038 */
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x0114 */ struct _MI_SYSTEM_PTE_TYPE KernelStackPteInfo;
  /* 0x014c */ unsigned long StackGrowthFailures;
  /* 0x0150 */ unsigned char KernelStackPages;
  /* 0x0151 */ unsigned char TrackPtesAborted;
  /* 0x0152 */ unsigned char AdjustCounter;
  /* 0x0154 */ volatile long ReservedMappingLock;
  /* 0x0158 */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x015c */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x0160 */ struct _RTL_AVL_TREE OutswappedKernelStackRoot;
  /* 0x0164 */ volatile long OutswappedKernelStackLock;
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x00a8 */ volatile unsigned long NonPagedPoolCommit;
  /* 0x00ac */ volatile unsigned long SmallNonPagedPtesCommit;
  ...
  /* 0x00c0 */ volatile unsigned long ProcessCommit;
  /* 0x00c4 */ volatile long DriverCommit;
  /* 0x00c8 */ unsigned long PfnDatabaseCommit;
  ...
  /* 0x037c */ unsigned long SystemVaTypeCount[17];
  /* 0x03c0 */ unsigned char SystemVaType[1024];
  /* 0x07c0 */ unsigned long SystemVaTypeCountFailures[17];
  /* 0x0804 */ unsigned long SystemVaTypeCountLimit[17];
  /* 0x0848 */ unsigned long SystemVaTypeCountPeak[17];
  /* 0x088c */ unsigned long SystemAvailableVa;
  /* 0x0890 */ long __PADDING__[12];
} MI_VISIBLE_STATE, *PMI_VISIBLE_STATE; /* size: 0x08c0 */
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x16e8 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1748 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1840 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x2d40 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x2d58 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x2d60 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x2d98 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x2de0 */ struct _MI_ERROR_STATE Errors;
  /* 0x2ec0 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x2f40 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x2fd0 */ struct _MI_STANDBY_STATE Standby;
  ...
  /* 0x32c0 */ unsigned long Cookie;
  /* 0x32c4 */ void* volatile* BootRegistryRuns;
  /* 0x32c8 */ volatile long ZeroingDisabled;
  /* 0x32cc */ unsigned char FullyInitialized;
  /* 0x32cd */ unsigned char SafeBooted;
  /* 0x32d0 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x32d8 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x3300 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3bc0 */
