...
typedef struct _MI_PARTITION_MODWRITES
{
  ...
  /* 0x016c */ volatile long ClusterWritesDisabled[2];
  /* 0x0174 */ struct _KEVENT NotifyStoreMemoryConditions;
  /* 0x0184 */ volatile unsigned char DelayMappedWrite;
  /* 0x0188 */ volatile unsigned long PagefileReservationsEnabled;
  /* 0x018c */ struct _EX_PUSH_LOCK PageFileCreationLock;
  /* 0x0190 */ struct _WORK_QUEUE_ITEM TrimPagefileWorkItem;
  /* 0x01a0 */ unsigned __int64 LastTrimPagefileTime;
  /* 0x01a8 */ struct _WORK_QUEUE_ITEM WsSwapPagefileContractWorkItem;
  /* 0x01b8 */ volatile long WsSwapPageFileContractionInProgress;
  /* 0x01bc */ struct _EX_PUSH_LOCK WorkingSetSwapLock;
  /* 0x01c0 */ volatile long WorkingSetInswapLock;
  /* 0x01c4 */ long __PADDING__[1];
} MI_PARTITION_MODWRITES, *PMI_PARTITION_MODWRITES; /* size: 0x01c8 */
...
typedef struct _MI_PARTITION_SEGMENTS
{
  ...
  /* 0x003c */ struct _MMPAGE_FILE_EXPANSION AttemptForCantExtend;
  /* 0x0070 */ struct _MMDEREFERENCE_SEGMENT_HEADER DereferenceSegmentHeader;
  /* 0x009c */ struct _LIST_ENTRY DeleteOnCloseList;
  /* 0x00a8 */ struct _KTIMER DeleteOnCloseTimer;
  /* 0x00d0 */ unsigned char DeleteOnCloseTimerActive;
  /* 0x00d1 */ unsigned char SegmentDereferenceThreadExists;
  /* 0x00d4 */ unsigned long UnusedSegmentPagedPool;
  /* 0x00d8 */ struct _LIST_ENTRY UnusedSegmentList;
  /* 0x00e0 */ struct _LIST_ENTRY UnusedSubsectionList;
  /* 0x00e8 */ struct _LIST_ENTRY DeleteSubsectionList;
  /* 0x00f0 */ struct _KEVENT ControlAreaDeleteEvent;
  /* 0x0100 */ struct _SINGLE_LIST_ENTRY ControlAreaDeleteList;
  /* 0x0108 */ struct _MI_PTE_CHAIN_HEAD FreeSystemCache;
  /* 0x0120 */ struct _KEVENT CloneDereferenceEvent;
  /* 0x0130 */ union _SLIST_HEADER CloneProtosSListHead;
  /* 0x0138 */ struct _EX_PUSH_LOCK SystemCacheInitLock;
  /* 0x013c */ unsigned long PagefileExtensionWaiters;
  /* 0x0140 */ unsigned long PagefileExtensionRequests;
  /* 0x0144 */ struct _KEVENT PagefileExtensionWaitEvent;
  /* 0x0154 */ long __PADDING__[11];
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x02b0 */ struct _MI_PARTITION_STORES Store;
  /* 0x0340 */ struct _MI_PARTITION_SEGMENTS Segments;
  /* 0x04c0 */ struct _MI_PARTITION_PAGE_LISTS PageLists;
  /* 0x0c80 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x0d00 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x0d40 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x0e18 */ void* WorkingSetControl;
  /* 0x0e1c */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x0e40 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x1a80 */
