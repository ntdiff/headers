...
typedef struct _ETW_SYSTEM_LOGGER_SETTINGS
{
  ...
  /* 0x0034 */ struct _PERFINFO_GROUPMASK EtwpGroupMasks[9];
} ETW_SYSTEM_LOGGER_SETTINGS, *PETW_SYSTEM_LOGGER_SETTINGS; /* size: 0x0154 */

typedef struct _ETW_SILODRIVERSTATE
{
  /* 0x0000 */ struct _ESERVERSILO_GLOBALS* SiloGlobals;
  /* 0x0004 */ unsigned long MaxLoggers;
  /* 0x0008 */ struct _ETW_GUID_ENTRY EtwpSecurityProviderGuidEntry;
  /* 0x0170 */ struct _EX_RUNDOWN_REF_CACHE_AWARE** EtwpLoggerRundown;
  /* 0x0174 */ struct _WMI_LOGGER_CONTEXT** EtwpLoggerContext;
  /* 0x0178 */ struct _ETW_HASH_BUCKET EtwpGuidHashTable[64];
  /* 0x0878 */ unsigned short EtwpSecurityLoggers[8];
  /* 0x0888 */ unsigned char EtwpSecurityProviderEnableMask;
  /* 0x088c */ long EtwpShutdownInProgress;
  /* 0x0890 */ unsigned long EtwpSecurityProviderPID;
  /* 0x0894 */ struct _ETW_PRIV_HANDLE_DEMUX_TABLE PrivHandleDemuxTable;
  /* 0x08a4 */ struct _ETW_COUNTERS EtwpCounters;
  /* 0x08b8 */ union _LARGE_INTEGER LogfileBytesWritten;
  /* 0x08c0 */ struct _ETW_SILO_TRACING_BLOCK* ProcessorBlocks;
  /* 0x08c4 */ struct _GUID PartitionId;
  /* 0x08d4 */ struct _GUID ParentId;
  /* 0x08e8 */ union _LARGE_INTEGER QpcOffsetFromRoot;
  /* 0x08f0 */ unsigned long PartitionType;
  /* 0x08f4 */ struct _ETW_SYSTEM_LOGGER_SETTINGS SystemLoggerSettings;
} ETW_SILODRIVERSTATE, *PETW_SILODRIVERSTATE; /* size: 0x0a48 */
