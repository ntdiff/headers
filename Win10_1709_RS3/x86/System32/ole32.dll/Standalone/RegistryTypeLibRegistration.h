...
{
  /* 0x0020 */ struct _GUID _typeLibId;
  /* 0x0030 */ wchar_t _version[256];
  /* 0x0230 */ unsigned long _localeId;
  /* 0x0234 */ class Microsoft::WRL::ComPtr<ReferencedRegistryKey> _versionKey;
  /* 0x0238 */ class RegistryKey _localeKey;
}; /* size: 0x023c */
