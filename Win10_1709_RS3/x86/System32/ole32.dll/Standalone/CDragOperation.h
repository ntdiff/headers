...
class CDragOperation
{
  ...
  /* 0x0080 */ struct DPI_AWARENESS_CONTEXT__* _sourceDpiAwarenessContext;
  /* 0x0084 */ struct DPI_AWARENESS_CONTEXT__* _targetDpiAwarenessContext;
  ...
  /* 0x0150 */ BOOL m_isEdpActive;
  /* 0x0151 */ BOOL m_isTargetWinRt;
  /* 0x0154 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (__stdcall*)(void *),&CoTaskMemFree,wistd::integral_constant<unsigned int,0>,unsigned short *,0,std::nullptr_t> > > m_sourceEnterpriseId;
  /* 0x0158 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (__stdcall*)(void *),&CoTaskMemFree,wistd::integral_constant<unsigned int,0>,unsigned short *,0,std::nullptr_t> > > m_dataObjectEnterpriseId;
  /* 0x015c */ BOOL m_dataObjectHasEnterpriseId;
}; /* size: 0x0160 */
