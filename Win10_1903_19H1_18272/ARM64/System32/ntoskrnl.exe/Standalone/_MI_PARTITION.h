typedef struct _MI_PARTITION_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long UseSlabAllocators : 1; /* bit position: 3 */
...
typedef struct _MI_SLAB_ALLOCATOR_CONTEXT
{
  ...
  /* 0x0038 */ struct _MMPFNLIST StandbyList;
  /* 0x0060 */ unsigned __int64 LastReplenishTime;
  /* 0x0068 */ unsigned __int64 LastFailureTime;
} MI_SLAB_ALLOCATOR_CONTEXT, *PMI_SLAB_ALLOCATOR_CONTEXT; /* size: 0x0070 */
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0d30 */ struct _MI_LARGE_PAGE_CANDIDATES LargePageCandidates[2];
  /* 0x1140 */ struct _WORK_QUEUE_ITEM RebuildLargePageWorkItem;
  /* 0x1160 */ unsigned char RebuildLargePageActive;
  /* 0x1164 */ volatile long LargePageRebuildLock;
  /* 0x1168 */ unsigned __int64 LowMemoryThreshold;
  /* 0x1170 */ unsigned __int64 HighMemoryThreshold;
  /* 0x1178 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[3];
  /* 0x12c8 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x12d8 */ long __PADDING__[10];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x1300 */
...
typedef struct _MI_PARTITION_COMMIT
{
  ...
  /* 0x0080 */ volatile unsigned __int64 OverCommit;
  /* 0x0088 */ long __PADDING__[30];
} MI_PARTITION_COMMIT, *PMI_PARTITION_COMMIT; /* size: 0x0100 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1b80 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1c80 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1ce8 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1e70 */ void* WorkingSetControl;
  /* 0x1e78 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1e88 */ unsigned long SessionDetachTimeStamp;
  /* 0x1f00 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x3200 */
