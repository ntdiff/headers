...
typedef struct _VF_TARGET_VERIFIED_DRIVER_DATA
{
  ...
  /* 0x0060 */ volatile unsigned long CurrentPagedPoolAllocations;
  /* 0x0064 */ volatile unsigned long CurrentNonPagedPoolAllocations;
  /* 0x0068 */ unsigned long PeakPagedPoolAllocations;
  /* 0x006c */ unsigned long PeakNonPagedPoolAllocations;
  /* 0x0070 */ volatile unsigned __int64 PagedBytes;
  /* 0x0078 */ volatile unsigned __int64 NonPagedBytes;
  /* 0x0080 */ unsigned __int64 PeakPagedBytes;
  /* 0x0088 */ unsigned __int64 PeakNonPagedBytes;
  ...
  /* 0x00f8 */ struct _LIST_ENTRY ContiguousMemoryListHead;
  /* 0x0108 */ volatile unsigned long ExecutePoolTypes;
  /* 0x010c */ volatile unsigned long ExecutePageProtections;
  /* 0x0110 */ volatile unsigned long ExecutePageMappings;
  /* 0x0114 */ volatile unsigned long ExecuteWriteSections;
  /* 0x0118 */ volatile unsigned long SectionAlignmentFailures;
  /* 0x011c */ volatile unsigned long IATInExecutableSection;
