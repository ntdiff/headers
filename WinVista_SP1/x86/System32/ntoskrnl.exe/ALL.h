...
typedef struct _KALPC_SECTION
{
  ...
  /* 0x0004 */ void* SectionObject;
  /* 0x0008 */ unsigned long Size;
  /* 0x000c */ struct _ALPC_HANDLE_TABLE* HandleTable;
...
} DRIVER_EXTENSION, *PDRIVER_EXTENSION; /* size: 0x001c */
...
typedef struct _HEAP_COUNTERS
{
  ...
  /* 0x0038 */ unsigned long CompactHeapCalls;
  /* 0x003c */ unsigned long CompactedUCRs;
  /* 0x0040 */ unsigned long InBlockDeccommits;
  /* 0x0044 */ unsigned long InBlockDeccomitSize;
} HEAP_COUNTERS, *PHEAP_COUNTERS; /* size: 0x0048 */
...
typedef struct _KUSER_SHARED_DATA
{
  ...
  /* 0x032c */ long Padding_6;
  /* 0x0330 */ unsigned long Cookie;
  /* 0x0334 */ long Padding_7;
...
typedef struct _EX_PUSH_LOCK_WAIT_BLOCK
{
  ...
  /* 0x0014 */ struct _EX_PUSH_LOCK_WAIT_BLOCK* Last;
  /* 0x0018 */ struct _EX_PUSH_LOCK_WAIT_BLOCK* Previous;
  /* 0x001c */ long ShareCount;
  /* 0x0020 */ long Flags;
  /* 0x0024 */ long __PADDING__[3];
} EX_PUSH_LOCK_WAIT_BLOCK, *PEX_PUSH_LOCK_WAIT_BLOCK; /* size: 0x0030 */
...
typedef struct _CM_KEY_CONTROL_BLOCK
{
  ...
  struct /* bitfield */
  {
    /* 0x0004 */ unsigned long ExtFlags : 9; /* bit position: 0 */
    /* 0x0004 */ unsigned long PrivateAlloc : 1; /* bit position: 9 */
    /* 0x0004 */ unsigned long Delete : 1; /* bit position: 10 */
    /* 0x0004 */ unsigned long DelayedCloseIndex : 11; /* bit position: 11 */
...
typedef struct _ALPC_HANDLE_TABLE
{
  ...
  /* 0x0004 */ struct _ALPC_HANDLE_ENTRY* Handles;
...
typedef struct _OBJECT_HEADER_QUOTA_INFO
{
  ...
  /* 0x000c */ struct _EPROCESS* ExclusiveProcess;
...
typedef struct _EPROCESS
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0224 */ unsigned long AffinityPermanent : 1; /* bit position: 18 */
      /* 0x0224 */ unsigned long AffinityUpdateEnable : 1; /* bit position: 19 */
      /* 0x0224 */ unsigned long CrossSessionCreate : 1; /* bit position: 20 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0228 */ unsigned long ProcessSelfDelete : 1; /* bit position: 30 */
      /* 0x0228 */ unsigned long SpareProcessFlags : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
...
typedef struct _HANDLE_TABLE_ENTRY
{
  ...
  union
  {
    ...
    /* 0x0004 */ long NextFreeTableEntry;
  }; /* size: 0x0004 */
...
typedef struct _KQUEUE
{
  ...
  /* 0x0018 */ unsigned long CurrentCount;
...
typedef struct _MI_PAGEFILE_TRACES
{
  ...
  /* 0x0006 */ char Padding_26[2];
  /* 0x0008 */ union _LARGE_INTEGER CurrentTime;
  /* 0x0010 */ unsigned long AvailablePages;
  /* 0x0014 */ unsigned long ModifiedPagesTotal;
  /* 0x0018 */ unsigned long ModifiedPagefilePages;
  /* 0x001c */ unsigned long ModifiedNoWritePages;
  struct // _TAG_UNNAMED_30
  {
    /* 0x0020 */ struct _MDL Mdl;
    /* 0x003c */ unsigned long Page[1];
  } /* size: 0x0020 */ MdlHack;
} MI_PAGEFILE_TRACES, *PMI_PAGEFILE_TRACES; /* size: 0x0040 */
...
typedef struct _POP_HIBER_CONTEXT
{
  ...
  /* 0x0070 */ struct _PO_MEMORY_RANGE_ARRAY* TableHead;
...
{
  /* 0x0000 */ struct _LIST_ENTRY Entry;
  /* 0x0008 */ union _ULARGE_INTEGER Time;
} KTIMER_TABLE_ENTRY, *PKTIMER_TABLE_ENTRY; /* size: 0x0010 */
...
typedef struct _MMVAD_LONG
{
  ...
  union // _TAG_UNNAMED_55
  {
    union
    {
      /* 0x0030 */ struct _LIST_ENTRY List;
      /* 0x0030 */ struct _MMADDRESS_LIST Secured;
    }; /* size: 0x0008 */
  } /* size: 0x0008 */ u3;
  union // _TAG_UNNAMED_56
  {
    union
    {
      /* 0x0038 */ struct _MMBANKED_SECTION* Banked;
      /* 0x0038 */ struct _MMEXTEND_INFO* ExtendedInfo;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u4;
} MMVAD_LONG, *PMMVAD_LONG; /* size: 0x003c */
...
typedef struct _KTRAP_FRAME
{
  ...
  /* 0x0010 */ unsigned short TempSegCs;
  /* 0x0012 */ unsigned char Logging;
  /* 0x0013 */ unsigned char Reserved;
...
} ETW_GUID_ENTRY, *PETW_GUID_ENTRY; /* size: 0x0158 */
...
typedef struct _HEAP
{
  ...
  /* 0x0058 */ unsigned long PointerKey;
  /* 0x005c */ unsigned long Interceptor;
  /* 0x0060 */ unsigned long VirtualMemoryThreshold;
  /* 0x0064 */ unsigned long Signature;
  /* 0x0068 */ unsigned long SegmentReserve;
  /* 0x006c */ unsigned long SegmentCommit;
  /* 0x0070 */ unsigned long DeCommitFreeBlockThreshold;
  /* 0x0074 */ unsigned long DeCommitTotalFreeThreshold;
  /* 0x0078 */ unsigned long TotalFreeSize;
  /* 0x007c */ unsigned long MaximumAllocationSize;
  /* 0x0080 */ unsigned short ProcessHeapsListIndex;
  /* 0x0082 */ unsigned short HeaderValidateLength;
  /* 0x0084 */ void* HeaderValidateCopy;
  /* 0x0088 */ unsigned short NextAvailableTagIndex;
  /* 0x008a */ unsigned short MaximumTagIndex;
  /* 0x008c */ struct _HEAP_TAG_ENTRY* TagEntries;
  /* 0x0090 */ struct _LIST_ENTRY UCRList;
  /* 0x0098 */ unsigned long AlignRound;
  /* 0x009c */ unsigned long AlignMask;
  /* 0x00a0 */ struct _LIST_ENTRY VirtualAllocdBlocks;
  /* 0x00a8 */ struct _LIST_ENTRY SegmentList;
  /* 0x00b0 */ unsigned short AllocatorBackTraceIndex;
  /* 0x00b2 */ char Padding_34[2];
  /* 0x00b4 */ unsigned long NonDedicatedListLength;
  /* 0x00b8 */ void* BlocksIndex;
  /* 0x00bc */ void* UCRIndex;
  /* 0x00c0 */ struct _HEAP_PSEUDO_TAG_ENTRY* PseudoTagEntries;
  /* 0x00c4 */ struct _LIST_ENTRY FreeLists;
  /* 0x00cc */ struct _HEAP_LOCK* LockVariable;
  /* 0x00d0 */ void* CommitRoutine /* function */;
  /* 0x00d4 */ void* FrontEndHeap;
  /* 0x00d8 */ unsigned short FrontHeapLockCount;
  /* 0x00da */ unsigned char FrontEndHeapType;
  /* 0x00db */ char Padding_35;
  /* 0x00dc */ struct _HEAP_COUNTERS Counters;
  /* 0x0124 */ struct _HEAP_TUNING_PARAMETERS TuningParameters;
  /* 0x012c */ long __PADDING__[1];
} HEAP, *PHEAP; /* size: 0x0130 */
...
typedef struct _PPM_DIA_STATS
{
  /* 0x0000 */ unsigned long PerfLevel;
  /* 0x0004 */ unsigned long IdleTime;
  /* 0x0008 */ unsigned long TimeInterval;
} PPM_DIA_STATS, *PPPM_DIA_STATS; /* size: 0x000c */
...
typedef struct _DEVOBJ_EXTENSION
{
  ...
  /* 0x002c */ struct _LIST_ENTRY DependentList;
  /* 0x0034 */ struct _LIST_ENTRY ProviderList;
...
typedef struct _PPM_PERF_STATES
{
  ...
  /* 0x0030 */ unsigned long TargetProcessors;
  /* 0x0034 */ void* PStateHandler /* function */;
  /* 0x0038 */ unsigned long PStateContext;
  /* 0x003c */ void* TStateHandler /* function */;
  /* 0x0040 */ unsigned long TStateContext;
  /* 0x0044 */ void* FeedbackHandler /* function */;
  /* 0x0048 */ struct _PPM_DIA_STATS* DiaStats;
  /* 0x004c */ unsigned long DiaStatsCount;
  /* 0x0050 */ struct _PPM_PERF_STATE State[1];
} PPM_PERF_STATES, *PPPM_PERF_STATES; /* size: 0x0078 */
...
typedef struct _KINTERRUPT
{
  ...
  /* 0x0034 */ char Number;
  /* 0x0035 */ unsigned char ShareVector;
  /* 0x0036 */ char Padding_41[2];
  /* 0x0038 */ enum _KINTERRUPT_MODE Mode;
  /* 0x003c */ enum _KINTERRUPT_POLARITY Polarity;
  /* 0x0040 */ unsigned long ServiceCount;
  /* 0x0044 */ unsigned long DispatchCount;
  /* 0x0048 */ unsigned __int64 Rsvd1;
  /* 0x0050 */ unsigned long DispatchCode[135];
  /* 0x026c */ long __PADDING__[1];
} KINTERRUPT, *PKINTERRUPT; /* size: 0x0270 */
...
typedef struct _PEB
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0028 */ unsigned long ReservedBits0 : 28; /* bit position: 4 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
  ...
  /* 0x0038 */ unsigned long SparePebPtr0;
...
} MMPFNLIST, *PMMPFNLIST; /* size: 0x0010 */
...
typedef struct _MMWSL
{
  ...
  /* 0x0038 */ unsigned long LastVadBit;
  /* 0x003c */ unsigned long MaximumLastVadBit;
  /* 0x0040 */ unsigned long LastAllocationSizeHint;
  /* 0x0044 */ unsigned long LastAllocationSize;
  /* 0x0048 */ struct _MMWSLE_NONDIRECT_HASH* NonDirectHash;
  /* 0x004c */ struct _MMWSLE_HASH* HashTableStart;
  /* 0x0050 */ struct _MMWSLE_HASH* HighestPermittedHashAddress;
  /* 0x0054 */ void* HighestUserAddress;
  /* 0x0058 */ unsigned short UsedPageTableEntries[768];
  /* 0x0658 */ unsigned long CommittedPageTables[24];
} MMWSL, *PMMWSL; /* size: 0x06b8 */
...
typedef struct _PNP_DEVICE_EVENT_ENTRY
{
  ...
  /* 0x0020 */ struct _PLUGPLAY_EVENT_BLOCK Data;
} PNP_DEVICE_EVENT_ENTRY, *PPNP_DEVICE_EVENT_ENTRY; /* size: 0x0060 */
...
typedef struct _PTE_TRACKER
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0024 */ unsigned long Spare : 28; /* bit position: 4 */
  }; /* bitfield */
  /* 0x0028 */ void* CallingAddress;
  /* 0x002c */ void* CallersCaller;
} PTE_TRACKER, *PPTE_TRACKER; /* size: 0x0030 */
...
typedef struct _VACB
{
  ...
  /* 0x0010 */ struct _LIST_ENTRY LruList;
...
typedef struct _SEGMENT
{
  ...
  /* 0x002c */ struct _MMPTE ThePtes[1];
...
typedef struct _MBCB
{
  ...
  /* 0x0020 */ struct _BITMAP_RANGE BitmapRange1;
  /* 0x0040 */ struct _BITMAP_RANGE BitmapRange2;
  /* 0x0060 */ struct _BITMAP_RANGE BitmapRange3;
} MBCB, *PMBCB; /* size: 0x0080 */
...
typedef struct _DEFERRED_WRITE
{
  ...
  /* 0x0024 */ unsigned char LimitModifiedPages;
...
typedef struct _PNP_DEVICE_EVENT_LIST
{
  ...
  /* 0x0024 */ struct _KGUARDED_MUTEX Lock;
...
typedef struct _ETIMER
{
  ...
  /* 0x0028 */ struct _KAPC TimerApc;
  /* 0x0058 */ struct _KDPC TimerDpc;
  /* 0x0078 */ struct _LIST_ENTRY ActiveTimerListEntry;
  /* 0x0080 */ unsigned long Lock;
  /* 0x0084 */ long Period;
  /* 0x0088 */ unsigned char ApcAssociated;
  /* 0x0089 */ unsigned char WakeTimer;
  /* 0x008a */ char Padding_61[2];
  /* 0x008c */ struct _LIST_ENTRY WakeTimerListEntry;
  /* 0x0094 */ long __PADDING__[1];
} ETIMER, *PETIMER; /* size: 0x0098 */
...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0038 */ struct _POP_DISPLAY_RESUME_CONTEXT* DisplayResumeContext;
  /* 0x003c */ struct _POP_HIBER_CONTEXT* HiberContext;
  /* 0x0040 */ unsigned __int64 WakeTime;
  /* 0x0048 */ unsigned __int64 SleepTime;
  /* 0x0050 */ struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;
  /* 0x009c */ long __PADDING__[1];
} POP_POWER_ACTION, *PPOP_POWER_ACTION; /* size: 0x00a0 */
...
typedef struct _POP_SHUTDOWN_BUG_CHECK
{
  ...
  /* 0x0004 */ void* ThreadId;
  /* 0x0008 */ void* ProcessId;
  /* 0x000c */ unsigned long Code;
  /* 0x0010 */ unsigned long Parameter1;
  /* 0x0014 */ unsigned long Parameter2;
  /* 0x0018 */ unsigned long Parameter3;
  /* 0x001c */ unsigned long Parameter4;
} POP_SHUTDOWN_BUG_CHECK, *PPOP_SHUTDOWN_BUG_CHECK; /* size: 0x0020 */
...
typedef struct _CONTROL_AREA
{
  ...
  union // _TAG_UNNAMED_136
  {
    ...
    {
      /* 0x0020 */ unsigned short ModifiedWriteCount;
      /* 0x0022 */ unsigned short FlushInProgressCount;
    } /* size: 0x0004 */ e2;
  } /* size: 0x0004 */ u1;
  /* 0x0024 */ struct _EX_FAST_REF FilePointer;
  /* 0x0028 */ volatile long ControlAreaLock;
  ...
  union // _TAG_UNNAMED_138
  {
    struct // _TAG_UNNAMED_139
    {
      union
      {
        /* 0x0034 */ unsigned long NumberOfSystemCacheViews;
        /* 0x0034 */ unsigned long ImageRelocationStartBit;
      }; /* size: 0x0004 */
      union
      {
        /* 0x0038 */ volatile long WritableUserReferences;
        struct /* bitfield */
        {
          /* 0x0038 */ unsigned long ImageRelocationSizeIn64k : 16; /* bit position: 0 */
          /* 0x0038 */ unsigned long Unused : 14; /* bit position: 16 */
          /* 0x0038 */ unsigned long BitMap64 : 1; /* bit position: 30 */
          /* 0x0038 */ unsigned long ImageActive : 1; /* bit position: 31 */
        }; /* bitfield */
      }; /* size: 0x0004 */
      union
      {
        /* 0x003c */ struct _MM_SUBSECTION_AVL_TABLE* SubsectionRoot;
        /* 0x003c */ struct _MI_IMAGE_SECURITY_REFERENCE* SeImageStub;
      }; /* size: 0x0004 */
    } /* size: 0x000c */ e2;
  } /* size: 0x000c */ u2;
  /* 0x0040 */ volatile __int64 LockedPages;
} CONTROL_AREA, *PCONTROL_AREA; /* size: 0x0048 */
...
typedef struct _OBJECT_TYPE
{
  ...
  /* 0x0078 */ struct _ERESOURCE Mutex;
  /* 0x00b0 */ struct _EX_PUSH_LOCK TypeLock;
  /* 0x00b4 */ unsigned long Key;
  /* 0x00b8 */ struct _EX_PUSH_LOCK ObjectLocks[32];
  /* 0x0138 */ struct _LIST_ENTRY CallbackList;
} OBJECT_TYPE, *POBJECT_TYPE; /* size: 0x0140 */
...
typedef struct _POP_THERMAL_ZONE
{
  ...
  /* 0x000e */ char Padding_68[2];
  /* 0x0010 */ long Throttle;
  /* 0x0014 */ long Padding_69;
...
typedef struct _CMHIVE
{
  ...
  /* 0x0314 */ struct _EX_PUSH_LOCK ViewLock;
  /* 0x0318 */ struct _KTHREAD* ViewLockOwner;
  /* 0x031c */ unsigned long ViewLockLast;
  /* 0x0320 */ unsigned long ViewUnLockLast;
  /* 0x0324 */ struct _FAST_MUTEX* WriterLock;
  /* 0x0328 */ struct _EX_PUSH_LOCK FlusherLock;
  /* 0x032c */ struct _EX_PUSH_LOCK SecurityLock;
  /* 0x0330 */ struct _LIST_ENTRY MappedViewList;
  /* 0x0338 */ struct _LIST_ENTRY PinnedViewList;
  /* 0x0340 */ struct _LIST_ENTRY FlushedViewList;
  /* 0x0348 */ unsigned short MappedViewCount;
  /* 0x034a */ unsigned short PinnedViewCount;
  /* 0x034c */ unsigned long UseCount;
  /* 0x0350 */ unsigned long ViewsPerHive;
  /* 0x0354 */ struct _FILE_OBJECT* FileObject;
  /* 0x0358 */ unsigned long LastShrinkHiveSize;
  /* 0x035c */ long Padding_70;
  /* 0x0360 */ union _LARGE_INTEGER ActualFileSize;
  /* 0x0368 */ struct _UNICODE_STRING FileFullPath;
  /* 0x0370 */ struct _UNICODE_STRING FileUserName;
  /* 0x0378 */ struct _UNICODE_STRING HiveRootPath;
  /* 0x0380 */ unsigned long SecurityCount;
  /* 0x0384 */ unsigned long SecurityCacheSize;
  /* 0x0388 */ long SecurityHitHint;
  /* 0x038c */ struct _CM_KEY_SECURITY_CACHE_ENTRY* SecurityCache;
  /* 0x0390 */ struct _LIST_ENTRY SecurityHash[64];
  /* 0x0590 */ unsigned long UnloadEventCount;
  /* 0x0594 */ struct _KEVENT** UnloadEventArray;
  /* 0x0598 */ struct _CM_KEY_CONTROL_BLOCK* RootKcb;
  /* 0x059c */ unsigned char Frozen;
  /* 0x059d */ char Padding_71[3];
  /* 0x05a0 */ struct _CM_WORKITEM* UnloadWorkItem;
  /* 0x05a4 */ unsigned char GrowOnlyMode;
  /* 0x05a5 */ char Padding_72[3];
  /* 0x05a8 */ unsigned long GrowOffset;
  /* 0x05ac */ struct _LIST_ENTRY KcbConvertListHead;
  /* 0x05b4 */ struct _LIST_ENTRY KnodeConvertListHead;
  /* 0x05bc */ struct _CM_CELL_REMAP_BLOCK* CellRemapArray;
  /* 0x05c0 */ unsigned long Flags;
  /* 0x05c4 */ struct _LIST_ENTRY TrustClassEntry;
  /* 0x05cc */ unsigned long FlushCount;
  /* 0x05d0 */ struct _CM_RM* CmRm;
  /* 0x05d4 */ unsigned long CmRmInitFailPoint;
  /* 0x05d8 */ long CmRmInitFailStatus;
  /* 0x05dc */ struct _KTHREAD* CreatorOwner;
} CMHIVE, *PCMHIVE; /* size: 0x05e0 */
...
typedef struct _PERFINFO_HARDPAGEFAULT_INFORMATION
{
  ...
  /* 0x0010 */ unsigned long ThreadId;
  /* 0x0014 */ unsigned long ByteCount;
} PERFINFO_HARDPAGEFAULT_INFORMATION, *PPERFINFO_HARDPAGEFAULT_INFORMATION; /* size: 0x0018 */
...
typedef struct _PF_HARD_FAULT_INFO
{
  ...
  /* 0x0028 */ union _LARGE_INTEGER IoTimeInTicks;
} PF_HARD_FAULT_INFO, *PPF_HARD_FAULT_INFO; /* size: 0x0030 */
...
typedef struct _ARBITER_INSTANCE
{
  ...
  /* 0x00a8 */ wchar_t PdoDescriptionString[336];
  /* 0x0348 */ char PdoSymbolicNameString[672];
  /* 0x05e8 */ wchar_t PdoAddressString[1];
  /* 0x05ea */ char __PADDING__[2];
} ARBITER_INSTANCE, *PARBITER_INSTANCE; /* size: 0x05ec */
...
} HEADLESS_LOADER_BLOCK, *PHEADLESS_LOADER_BLOCK; /* size: 0x0034 */
...
typedef struct _MAPPED_FILE_SEGMENT
{
  ...
  /* 0x001c */ struct _EX_PUSH_LOCK SegmentLock;
  /* 0x0020 */ struct _MSUBSECTION* LastSubsectionHint;
  /* 0x0024 */ long __PADDING__[1];
...
typedef struct _MMPTE_FLUSH_LIST
{
  ...
  /* 0x0008 */ void* FlushVa[33];
} MMPTE_FLUSH_LIST, *PMMPTE_FLUSH_LIST; /* size: 0x008c */

typedef struct _MI_COLOR_BASE
{
  /* 0x0000 */ unsigned short* ColorPointer;
  /* 0x0004 */ unsigned short ColorMask;
  /* 0x0006 */ unsigned short ColorNode;
} MI_COLOR_BASE, *PMI_COLOR_BASE; /* size: 0x0008 */
  ...
  union // _TAG_UNNAMED_149
  {
    union
    {
      ...
      struct // _TAG_UNNAMED_151
      {
        ...
        /* 0x000f */ unsigned char InterlockedByteFlags;
      } /* size: 0x0004 */ e3;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u3;
  union
...
} MI_SECTION_CREATION_GATE, *PMI_SECTION_CREATION_GATE; /* size: 0x0014 */
...
typedef struct _POP_DISPLAY_RESUME_CONTEXT
{
  ...
  /* 0x0010 */ struct _ETHREAD* WorkerThread;
  /* 0x0014 */ struct _KEVENT PrepareUIEvent;
  /* 0x0024 */ struct _KEVENT PowerOnEvent;
  /* 0x0034 */ struct _KEVENT DoneEvent;
  /* 0x0044 */ unsigned long WorkerQueued;
  /* 0x0048 */ unsigned long WorkerAbort;
  /* 0x004c */ unsigned long NoResumeUI;
} POP_DISPLAY_RESUME_CONTEXT, *PPOP_DISPLAY_RESUME_CONTEXT; /* size: 0x0050 */
...
typedef struct _OBJECT_SYMBOLIC_LINK
{
  ...
  /* 0x0010 */ struct _UNICODE_STRING LinkTargetRemaining;
  /* 0x0018 */ void* LinkTargetObject;
  /* 0x001c */ unsigned long DosDeviceDriveIndex;
...
typedef struct _CM_WORKITEM
{
  ...
  /* 0x0008 */ void* WorkerRoutine /* function */;
  /* 0x000c */ void* Parameter;
} CM_WORKITEM, *PCM_WORKITEM; /* size: 0x0010 */
...
typedef struct _VOLUME_CACHE_MAP
{
  ...
  /* 0x0014 */ unsigned long Flags;
} VOLUME_CACHE_MAP, *PVOLUME_CACHE_MAP; /* size: 0x0018 */
...
} OBJECT_REF_STACK_INFO, *POBJECT_REF_STACK_INFO; /* size: 0x0008 */
...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  /* 0x0030 */ struct _WMI_BUFFER_HEADER* BatchedBufferList;
  /* 0x0034 */ struct _UNICODE_STRING LoggerName;
  /* 0x003c */ struct _UNICODE_STRING LogFileName;
  /* 0x0044 */ struct _UNICODE_STRING LogFilePattern;
  /* 0x004c */ struct _UNICODE_STRING NewLogFileName;
  /* 0x0054 */ unsigned long ClockType;
  /* 0x0058 */ long CollectionOn;
  /* 0x005c */ unsigned long MaximumFileSize;
  /* 0x0060 */ unsigned long LoggerMode;
  /* 0x0064 */ unsigned long LastFlushedBuffer;
  /* 0x0068 */ unsigned long FlushTimer;
  /* 0x006c */ unsigned long FlushThreshold;
  /* 0x0070 */ union _LARGE_INTEGER ByteOffset;
  /* 0x0078 */ union _LARGE_INTEGER FlushTimeStamp;
  /* 0x0080 */ unsigned long MinimumBuffers;
  /* 0x0084 */ volatile long BuffersAvailable;
  /* 0x0088 */ volatile long NumberOfBuffers;
  /* 0x008c */ unsigned long MaximumBuffers;
  /* 0x0090 */ volatile unsigned long EventsLost;
  /* 0x0094 */ unsigned long BuffersWritten;
  /* 0x0098 */ unsigned long LogBuffersLost;
  /* 0x009c */ unsigned long RealTimeBuffersDelivered;
  /* 0x00a0 */ unsigned long RealTimeBuffersLost;
  /* 0x00a4 */ unsigned long BufferSize;
  /* 0x00a8 */ unsigned long MaximumEventSize;
  /* 0x00ac */ long* SequencePtr;
  /* 0x00b0 */ unsigned long LocalSequence;
  /* 0x00b4 */ struct _GUID InstanceGuid;
  /* 0x00c4 */ void* GetCpuClock /* function */;
  /* 0x00c8 */ long FileCounter;
  /* 0x00cc */ void* volatile BufferCallback /* function */;
  /* 0x00d0 */ enum _POOL_TYPE PoolType;
  /* 0x00d4 */ long Padding_87;
  /* 0x00d8 */ struct _ETW_REF_CLOCK ReferenceTime;
  /* 0x00e8 */ unsigned char RealtimeLoggerContextFreed;
  /* 0x00e9 */ char Padding_88[3];
  /* 0x00ec */ struct _LIST_ENTRY Consumers;
  /* 0x00f4 */ unsigned long NumConsumers;
  /* 0x00f8 */ struct _LIST_ENTRY Connecting;
  /* 0x0100 */ unsigned char NewConsumer;
  /* 0x0101 */ char Padding_89[3];
  /* 0x0104 */ void* RealtimeLogfileHandle;
  /* 0x0108 */ struct _UNICODE_STRING RealtimeLogfileName;
  /* 0x0110 */ union _LARGE_INTEGER RealtimeWriteOffset;
  /* 0x0118 */ union _LARGE_INTEGER RealtimeReadOffset;
  /* 0x0120 */ union _LARGE_INTEGER RealtimeLogfileSize;
  /* 0x0128 */ unsigned __int64 RealtimeLogfileUsage;
  /* 0x0130 */ unsigned __int64 RealtimeMaximumFileSize;
  /* 0x0138 */ unsigned long RealtimeBuffersSaved;
  /* 0x013c */ long Padding_90;
  /* 0x0140 */ struct _ETW_REF_CLOCK RealtimeReferenceTime;
  /* 0x0150 */ unsigned long RealtimeDisconnectProcessId;
  /* 0x0154 */ unsigned long RealtimeDisconnectConsumerId;
  /* 0x0158 */ enum _ETW_RT_EVENT_LOSS NewRTEventsLost;
  /* 0x015c */ struct _KEVENT LoggerEvent;
  /* 0x016c */ struct _KEVENT FlushEvent;
  /* 0x017c */ struct _KDPC FlushDpc;
  /* 0x019c */ struct _KMUTANT LoggerMutex;
  /* 0x01bc */ struct _EX_PUSH_LOCK LoggerLock;
  /* 0x01c0 */ struct _SECURITY_CLIENT_CONTEXT ClientSecurityContext;
  /* 0x01fc */ struct _EX_FAST_REF SecurityDescriptor;
  /* 0x0200 */ struct _WMI_BUFFER_HEADER DummyBufferForMarker;
  /* 0x0248 */ __int64 BufferSequenceNumber;
  /* 0x0250 */ long AcceptNewEvents;
  union
  {
    /* 0x0254 */ unsigned long Flags;
    struct /* bitfield */
    {
      /* 0x0254 */ unsigned long Persistent : 1; /* bit position: 0 */
      /* 0x0254 */ unsigned long AutoLogger : 1; /* bit position: 1 */
      /* 0x0254 */ unsigned long FsReady : 1; /* bit position: 2 */
      /* 0x0254 */ unsigned long RealTime : 1; /* bit position: 3 */
      /* 0x0254 */ unsigned long Wow : 1; /* bit position: 4 */
      /* 0x0254 */ unsigned long KernelTrace : 1; /* bit position: 5 */
      /* 0x0254 */ unsigned long NoMoreEnable : 1; /* bit position: 6 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0258 */ unsigned long RequestFlag;
    struct /* bitfield */
    {
      /* 0x0258 */ unsigned long RequestNewFie : 1; /* bit position: 0 */
      /* 0x0258 */ unsigned long RequestUpdateFile : 1; /* bit position: 1 */
      /* 0x0258 */ unsigned long RequestFlush : 1; /* bit position: 2 */
      /* 0x0258 */ unsigned long RequestDisableRealtime : 1; /* bit position: 3 */
      /* 0x0258 */ unsigned long RequestDisconnectConsumer : 1; /* bit position: 4 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x025c */ unsigned short StackTraceFilterHookCount;
  /* 0x025e */ unsigned short StackTraceFilter[16];
  /* 0x027e */ char __PADDING__[2];
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0280 */
...
typedef struct _ALPC_PORT
{
  ...
  /* 0x0010 */ unsigned long SequenceNo;
  /* 0x0014 */ void* CompletionPort;
  /* 0x0018 */ void* CompletionKey;
  /* 0x001c */ struct _ALPC_COMPLETION_PACKET_LOOKASIDE* CompletionPacketLookaside;
  /* 0x0020 */ void* PortContext;
  /* 0x0024 */ struct _SECURITY_CLIENT_CONTEXT StaticSecurity;
  /* 0x0060 */ struct _LIST_ENTRY MainQueue;
  /* 0x0068 */ struct _LIST_ENTRY PendingQueue;
  /* 0x0070 */ struct _LIST_ENTRY LargeMessageQueue;
  /* 0x0078 */ struct _LIST_ENTRY WaitQueue;
  union
  {
    /* 0x0080 */ struct _KSEMAPHORE* Semaphore;
    /* 0x0080 */ struct _KEVENT* DummyEvent;
  }; /* size: 0x0004 */
  /* 0x0084 */ struct _EX_PUSH_LOCK Lock;
  /* 0x0088 */ struct _ALPC_PORT_ATTRIBUTES PortAttributes;
  /* 0x00b4 */ struct _EX_PUSH_LOCK ResourceListLock;
  /* 0x00b8 */ struct _LIST_ENTRY ResourceListHead;
  ...
  union // _TAG_UNNAMED_172
  {
    union
    {
      struct // _TAG_UNNAMED_173
      {
        struct /* bitfield */
        {
          /* 0x00d0 */ unsigned long Initialized : 1; /* bit position: 0 */
          /* 0x00d0 */ unsigned long Type : 2; /* bit position: 1 */
          /* 0x00d0 */ unsigned long ConnectionPending : 1; /* bit position: 3 */
          /* 0x00d0 */ unsigned long ConnectionRefused : 1; /* bit position: 4 */
          /* 0x00d0 */ unsigned long Disconnected : 1; /* bit position: 5 */
          /* 0x00d0 */ unsigned long Closed : 1; /* bit position: 6 */
          /* 0x00d0 */ unsigned long NoFlushOnClose : 1; /* bit position: 7 */
          /* 0x00d0 */ unsigned long ReturnExtendedInfo : 1; /* bit position: 8 */
          /* 0x00d0 */ unsigned long Waitable : 1; /* bit position: 9 */
          /* 0x00d0 */ unsigned long DynamicSecurity : 1; /* bit position: 10 */
          /* 0x00d0 */ unsigned long Wow64CompletionList : 1; /* bit position: 11 */
          /* 0x00d0 */ unsigned long Lpc : 1; /* bit position: 12 */
          /* 0x00d0 */ unsigned long LpcToLpc : 1; /* bit position: 13 */
          /* 0x00d0 */ unsigned long HasCompletionList : 1; /* bit position: 14 */
          /* 0x00d0 */ unsigned long HadCompletionList : 1; /* bit position: 15 */
        }; /* bitfield */
      } /* size: 0x0004 */ s1;
      /* 0x00d0 */ unsigned long State;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u1;
  /* 0x00d4 */ struct _ALPC_PORT* TargetQueuePort;
  /* 0x00d8 */ struct _ALPC_PORT* TargetSequencePort;
  /* 0x00dc */ struct _KALPC_MESSAGE* Message;
  /* 0x00e0 */ unsigned long MainQueueLength;
  /* 0x00e4 */ unsigned long PendingQueueLength;
  /* 0x00e8 */ unsigned long LargeMessageQueueLength;
  /* 0x00ec */ unsigned long CanceledQueueLength;
  /* 0x00f0 */ unsigned long WaitQueueLength;
} ALPC_PORT, *PALPC_PORT; /* size: 0x00f4 */
...
} ALPC_COMMUNICATION_INFO, *PALPC_COMMUNICATION_INFO; /* size: 0x0024 */
...
} KALPC_HANDLE_DATA, *PKALPC_HANDLE_DATA; /* size: 0x000c */
...
{
  /* 0x0000 */ unsigned long BasePhysicalPage;
  /* 0x0004 */ struct _MMPTE* BasedPte;
  /* 0x0008 */ unsigned long BankSize;
  /* 0x000c */ unsigned long BankShift;
  /* 0x0010 */ void* BankedRoutine /* function */;
  /* 0x0014 */ void* Context;
  /* 0x0018 */ struct _MMPTE* CurrentMappedPte;
  /* 0x001c */ struct _MMPTE BankTemplate[1];
} MMBANKED_SECTION, *PMMBANKED_SECTION; /* size: 0x0020 */
...
typedef struct _IOV_FORCED_PENDING_TRACE
{
  ...
  /* 0x0004 */ void* StackTrace[63];
} IOV_FORCED_PENDING_TRACE, *PIOV_FORCED_PENDING_TRACE; /* size: 0x0100 */

typedef struct _LAZY_WRITER
{
  /* 0x0000 */ struct _LIST_ENTRY WorkQueue;
  /* 0x0008 */ struct _KDPC ScanDpc;
  /* 0x0028 */ struct _KTIMER ScanTimer;
  /* 0x0050 */ unsigned char ScanActive;
  /* 0x0051 */ unsigned char OtherWork;
  /* 0x0052 */ unsigned char PendingTeardown;
  /* 0x0053 */ char __PADDING__[5];
} LAZY_WRITER, *PLAZY_WRITER; /* size: 0x0058 */
...
typedef struct _VI_TRACK_IRQL
{
  ...
  /* 0x0006 */ unsigned char Processor;
  /* 0x0007 */ char Padding_95;
...
} MM_DRIVER_VERIFIER_DATA, *PMM_DRIVER_VERIFIER_DATA; /* size: 0x0078 */
...
@PspUpdateAndWriteProcessAffinity@12
@RDMSR@4
@ReadAMDMsr@4
...
@WheapAddErrorSource@8
@WheapAddToDumpFile@8
@WheapGetErrorSource@8
@WmiGetClock@8
...
_DisplayFilter@4
_DisplayIdleStatePolicy@4
_DisplayPerfStatePolicy@4
...
_FsRtlOplockInternalBreakToII@28
_FsRtlOplockInternalBreakToNone@28
...
_MiReleaseExtraPagefileSpace@8
...
_MiSyncSystemPdes@4
_MiSynchronizeWithFaults@0
_MiSystemWsMetaPage@4
_MiTerminateWsle@12
...
_MxGetNextPage@4
_MxMapVa@8
_MyAcquireSpinLock@4
_MyReleaseSpinLock@4
_NTFastDOSIO@8
...
_PnprHardwareMemoryMirroring@8
...
_PoAcquirePowerTransitionLock@0
...
_PpmCalculateDomainPerfLevel@12
_PpmCalculateProcessorBusiness@16
_PpmCallIdleHandler@16
...
_PpmIdleCountToMs@12
_PpmInstallNewIdleStates@12
_PpmInstallPerfStates@16
...
_PspSetupUserProcessAddressSpace@20
...
_TmpIsWriteStatusWorthRetrying@4
...
_WheapTrackCorrectedErrors@4
_WheapTrackCorrectedMemoryErrors@8
