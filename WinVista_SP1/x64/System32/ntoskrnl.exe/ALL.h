...
typedef struct _EPROCESS
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x036c */ unsigned long AffinityPermanent : 1; /* bit position: 18 */
      /* 0x036c */ unsigned long AffinityUpdateEnable : 1; /* bit position: 19 */
      /* 0x036c */ unsigned long CrossSessionCreate : 1; /* bit position: 20 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0370 */ unsigned long ProcessSelfDelete : 1; /* bit position: 30 */
      /* 0x0370 */ unsigned long SpareProcessFlags : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
...
typedef struct _SHARED_CACHE_MAP
{
  ...
  /* 0x01b8 */ void* WriteBehindWorkQueueEntry;
  /* 0x01c0 */ struct _VOLUME_CACHE_MAP* VolumeCacheMap;
  /* 0x01c8 */ unsigned long ProcImagePathHash;
  /* 0x01cc */ unsigned long MappedWritesInProgress;
} SHARED_CACHE_MAP, *PSHARED_CACHE_MAP; /* size: 0x01d0 */
...
typedef struct _ALPC_COMPLETION_PACKET_LOOKASIDE
{
  ...
  /* 0x0038 */ struct _ALPC_COMPLETION_PACKET_LOOKASIDE_ENTRY* Entry /* zero-length array */;
} ALPC_COMPLETION_PACKET_LOOKASIDE, *PALPC_COMPLETION_PACKET_LOOKASIDE; /* size: 0x0038 */
...
typedef struct _LOADER_PARAMETER_EXTENSION
{
  ...
  /* 0x0038 */ unsigned __int64 LoaderPagesSpanned;
  ...
  /* 0x00b8 */ unsigned long ResumePages;
  /* 0x00bc */ long Padding_40;
  /* 0x00c0 */ void* DumpHeader;
} LOADER_PARAMETER_EXTENSION, *PLOADER_PARAMETER_EXTENSION; /* size: 0x00c8 */
...
struct PO_MEMORY_IMAGE
{
  ...
  /* 0x00d8 */ unsigned long FirmwareRuntimeInformationPages;
  /* 0x00dc */ long Padding_62;
  /* 0x00e0 */ unsigned __int64 FirmwareRuntimeInformation[1];
  /* 0x00e8 */ unsigned long NoBootLoaderLogPages;
  /* 0x00ec */ long Padding_63;
  /* 0x00f0 */ unsigned __int64 BootLoaderLogPages[8];
  /* 0x0130 */ unsigned long NotUsed;
  /* 0x0134 */ unsigned long ResumeContextCheck;
  /* 0x0138 */ unsigned long ResumeContextPages;
...
typedef struct _MMPAGING_FILE
{
  ...
  /* 0x006c */ long Padding_138;
  /* 0x0070 */ void* FileHandle;
  /* 0x0078 */ long Padding_139[2];
...
typedef struct _LAZY_WRITER
{
  ...
  /* 0x0010 */ struct _KDPC ScanDpc;
  /* 0x0050 */ struct _KTIMER ScanTimer;
  /* 0x0090 */ unsigned char ScanActive;
  /* 0x0091 */ unsigned char OtherWork;
  /* 0x0092 */ unsigned char PendingTeardown;
  /* 0x0093 */ char __PADDING__[5];
} LAZY_WRITER, *PLAZY_WRITER; /* size: 0x0098 */
...
typedef struct _ALPC_HANDLE_TABLE
{
  ...
  /* 0x0008 */ struct _ALPC_HANDLE_ENTRY* Handles;
  /* 0x0010 */ unsigned long TotalHandles;
  /* 0x0014 */ long Padding_213;
...
typedef struct _OBJECT_TYPE
{
  ...
  /* 0x00b0 */ struct _ERESOURCE Mutex;
  /* 0x0118 */ struct _EX_PUSH_LOCK TypeLock;
  /* 0x0120 */ unsigned long Key;
  /* 0x0124 */ long Padding_227;
  /* 0x0128 */ struct _EX_PUSH_LOCK ObjectLocks[32];
  /* 0x0228 */ struct _LIST_ENTRY CallbackList;
} OBJECT_TYPE, *POBJECT_TYPE; /* size: 0x0238 */
...
} CONTROL_AREA, *PCONTROL_AREA; /* size: 0x0070 */
...
typedef struct _KUSER_SHARED_DATA
{
  ...
  /* 0x032c */ long Padding_374;
  /* 0x0330 */ unsigned long Cookie;
  /* 0x0334 */ long Padding_375;
...
typedef struct _MI_VERIFIER_DRIVER_ENTRY
{
  ...
  /* 0x0038 */ unsigned long Flags;
  /* 0x003c */ long Padding_385;
  /* 0x0040 */ unsigned __int64 Signature;
  /* 0x0048 */ long Padding_386[2];
...
DisplayCharacter
DisplayFilter
DisplayIdleStatePolicy
DisplayPerfStatePolicy
...
FsRtlOplockCleanup
FsRtlOplockFsctrl
FsRtlOplockInternalBreakToII
FsRtlOplockInternalBreakToNone
...
PspUpdateAndWriteProcessAffinity
PspUpdateCreateInfo
...
WheapAddErrorSource
WheapAddToDumpFile
WheapAllocCorrectedErrorTrackingEvent
WheapAllocErrorRecord
WheapApplyThresholdChecks
WheapCalculateSectionLength
...
WheapExtractGenericErrorData
WheapFillOutErrorRecord
WheapFillOutProcessorErrorSection
WheapFreeCorrectedErrorTrackingEvent
WheapFreeErrorRecord
WheapGenerateETWEvents
WheapGetErrorSource
WheapGetGenericErrorSectionCount
WheapGetPreallocatedErrorRecord
WheapGetSectionCount
WheapGetThresholdInfo
WheapInitialize
...
WheapTrackCorrectedErrors
WheapTrackCorrectedMemoryErrors
