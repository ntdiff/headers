...
typedef struct _LFH_HEAP
{
  ...
  /* 0x01e0 */ struct _HEAP_BUCKET Buckets[128];
  /* 0x03e0 */ struct _HEAP_LOCAL_DATA LocalData[1];
} LFH_HEAP, *PLFH_HEAP; /* size: 0x6410 */
