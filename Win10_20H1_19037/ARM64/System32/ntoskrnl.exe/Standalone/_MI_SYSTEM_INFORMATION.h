...
typedef struct _MI_ERROR_STATE
{
  ...
  /* 0x00bd */ unsigned char FatalGraphicsFailures;
  /* 0x00be */ unsigned char InitFailure;
  /* 0x00bf */ char __PADDING__[1];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x25f0 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x26a0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2780 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2800 */ unsigned __int64 Cookie;
  /* 0x2808 */ void* volatile* BootRegistryRuns;
  /* 0x2810 */ volatile long ZeroingDisabled;
  /* 0x2814 */ unsigned char FullyInitialized;
  /* 0x2815 */ unsigned char SafeBooted;
  /* 0x2818 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x2880 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3a80 */
