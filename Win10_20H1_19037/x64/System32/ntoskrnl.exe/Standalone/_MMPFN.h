  ...
  union
  {
    union
    {
      struct /* bitfield */
      {
        ...
        /* 0x0028 */ unsigned __int64 LargePageSize : 2; /* bit position: 36 */
        ...
        /* 0x0028 */ unsigned __int64 FileOnly : 1; /* bit position: 50 */
        /* 0x0028 */ unsigned __int64 PfnExists : 1; /* bit position: 51 */
        /* 0x0028 */ unsigned __int64 Spare : 8; /* bit position: 52 */
