...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x01c0 */ unsigned __int64 ImageBias;
  /* 0x01c8 */ struct _EX_PUSH_LOCK RelocateBitmapsLock;
  /* 0x01d0 */ struct _RTL_BITMAP_EX ImageBitMap;
  /* 0x01e0 */ unsigned __int64 ImageBias64Low;
  /* 0x01e8 */ unsigned __int64 ImageBias64High;
  /* 0x01f0 */ struct _RTL_BITMAP_EX ImageBitMap64Low;
  /* 0x0200 */ struct _RTL_BITMAP_EX ImageBitMap64High;
  /* 0x0210 */ struct _RTL_BITMAP_EX ImageBitMapWow64Dll;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1bd8 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x1c00 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1c60 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1cd8 */ struct _MI_ERROR_STATE Errors;
