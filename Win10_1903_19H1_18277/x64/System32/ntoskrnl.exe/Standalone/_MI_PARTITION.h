...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0fb8 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[3];
  /* 0x1108 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x1118 */ long __PADDING__[10];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x1140 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1980 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1a00 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1a68 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1bf0 */ void* WorkingSetControl;
  /* 0x1bf8 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1c08 */ unsigned long SessionDetachTimeStamp;
  /* 0x1c40 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x2e40 */
