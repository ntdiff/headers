...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0004 */ enum _TAG_UNNAMED_147 Action;
  /* 0x0008 */ enum _SYSTEM_POWER_STATE LightestState;
  /* 0x000c */ unsigned long Flags;
  /* 0x0010 */ long Status;
  /* 0x0014 */ enum _TAG_UNNAMED_221 DeviceType;
  ...
  /* 0x0060 */ enum _TAG_UNNAMED_248 WakeAlarmSignaled;
  /* 0x0068 */ struct // _TAG_UNNAMED_249
  {
