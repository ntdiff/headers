...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0284 */ unsigned long ImageBreakpointEnabled;
  /* 0x0288 */ unsigned long ImageBreakpointChecksum;
  /* 0x028c */ unsigned long ImageBreakpointSize;
  /* 0x0290 */ volatile long ImageValidationFailed;
  /* 0x0294 */ unsigned long HotPatchReserveSize;
  /* 0x0298 */ long __PADDING__[26];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1c98 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x1cc0 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1d20 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1d98 */ struct _MI_ERROR_STATE Errors;
