...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x006c */ unsigned long Reserved : 11; /* bit position: 21 */
    }; /* bitfield */
