...
} INTERRUPT_FUNCTION_TABLE, *PINTERRUPT_FUNCTION_TABLE; /* size: 0x00b0 */
...
typedef struct _REGISTERED_INTERRUPT_CONTROLLER
{
  ...
  /* 0x00d0 */ enum _KNOWN_CONTROLLER_TYPE KnownType;
  /* 0x00d4 */ unsigned long Capabilities;
  /* 0x00d8 */ unsigned long Flags;
  /* 0x00dc */ unsigned long MaxPriority;
  /* 0x00e0 */ unsigned long UnitId;
  /* 0x00e4 */ long Padding_93;
  /* 0x00e8 */ struct _LIST_ENTRY LinesHead;
  /* 0x00f8 */ struct _LIST_ENTRY OutputLinesHead;
  /* 0x0108 */ long MinLine;
  /* 0x010c */ long MaxLine;
  /* 0x0110 */ unsigned long MaxClusterSize;
  /* 0x0114 */ unsigned long MaxClusters;
  /* 0x0118 */ unsigned long InterruptReplayDataSize;
  /* 0x011c */ enum _INTERRUPT_PROBLEM Problem;
  /* 0x0120 */ long ProblemStatus;
  /* 0x0124 */ long Padding_94;
  /* 0x0128 */ const char* ProblemSourceFile;
  /* 0x0130 */ unsigned long ProblemSourceLine;
  /* 0x0134 */ unsigned long CustomProblem;
  /* 0x0138 */ long CustomProblemStatus;
  /* 0x013c */ long Padding_95;
  /* 0x0140 */ struct _UNICODE_STRING ResourceId;
  /* 0x0150 */ struct POHANDLE__* PowerHandle;
} REGISTERED_INTERRUPT_CONTROLLER, *PREGISTERED_INTERRUPT_CONTROLLER; /* size: 0x0158 */
...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x00d9 */ char Padding_102[7];
  /* 0x00e0 */ unsigned long MapRegistersPerChannel;
  /* 0x00e4 */ long Padding_103;
  ...
  union
  {
    /* 0x0228 */ unsigned long LowMemoryLogicalAddressQueueFlags;
    struct /* bitfield */
    {
      /* 0x0228 */ unsigned long LowMemoryLogicalAddressInUse : 1; /* bit position: 0 */
      /* 0x0228 */ unsigned long WaitingOnLowMemoryLogicalAddress : 1; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x022c */ long Padding_108;
  /* 0x0230 */ unsigned __int64 LowMemoryLogicalAddressQueueLock;
  /* 0x0238 */ enum _HALP_DMA_ADAPTER_ALLOCATION_STATE AllocationState;
  /* 0x023c */ unsigned long ScatterGatherBufferLength;
  /* 0x0240 */ struct _SCATTER_GATHER_LIST ScatterGatherBuffer;
} ADAPTER_OBJECT, *PADAPTER_OBJECT; /* size: 0x0250 */
...
HalpDmaRemoveAdapterFromRemapQueue
HalpDmaRemoveWcb
