...
typedef enum _WHEA_EVENT_LOG_ENTRY_ID
{
  ...
  WheaEventLogEntryIdAddErrorSource = -2147483636,
...
} KUSER_SHARED_DATA, *PKUSER_SHARED_DATA; /* size: 0x0710 */
...
typedef struct _KPRCB
{
  ...
  /* 0x4778 */ struct _XSAVE_AREA_HEADER* ExtendedSupervisorState;
  /* 0x477c */ unsigned long PrcbPad100[9];
  /* 0x47a0 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x48e0 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x48e4 */ unsigned char PrcbPad[1532];
  ...
  /* 0x4f08 */ unsigned long DbgLogs[512];
  /* 0x5708 */ unsigned long DbgCount;
  /* 0x570c */ unsigned long PrcbPadRemaingPage[501];
...
} RTL_USER_PROCESS_PARAMETERS, *PRTL_USER_PROCESS_PARAMETERS; /* size: 0x02ac */
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0058 */ unsigned long CetShadowStack : 1; /* bit position: 20 */
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0064 */ unsigned long ActiveGroupsMask : 1; /* bit position: 10 */
      /* 0x0064 */ unsigned long VaSpaceDeleted : 1; /* bit position: 11 */
      /* 0x0064 */ unsigned long ReservedFlags : 20; /* bit position: 12 */
    }; /* bitfield */
...
typedef struct _KNODE
{
  ...
  /* 0x004c */ unsigned long NonIsrTargetedSet;
  /* 0x0050 */ long ParkLock;
  /* 0x0054 */ unsigned long Seed;
  /* 0x0058 */ long Padding_41[10];
  ...
  /* 0x00e0 */ unsigned long PpmConfiguredQosSets[4];
...
typedef struct _PROC_IDLE_ACCOUNTING
{
  ...
  /* 0x0020 */ enum _TAG_UNNAMED_8 TimeUnit;
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x008d */ char Padding_56[3];
  /* 0x0090 */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[4];
  /* 0x0100 */ unsigned long QosDisableReasons[4];
  /* 0x0110 */ unsigned short QosEquivalencyMasks[4];
  /* 0x0118 */ unsigned char QosSupported;
  /* 0x0119 */ char Padding_57[3];
  /* 0x011c */ volatile unsigned long SelectionGeneration;
  /* 0x0120 */ struct _PERF_CONTROL_STATE_SELECTION QosSelection[4];
  /* 0x01c0 */ unsigned __int64 PerfChangeTime;
  /* 0x01c8 */ unsigned long PerfChangeIntervalCount;
  /* 0x01cc */ unsigned char Force;
  /* 0x01cd */ unsigned char Update;
  /* 0x01ce */ unsigned char Apply;
  /* 0x01cf */ char __PADDING__[1];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x01d0 */
...
typedef struct _PROC_PERF_CONSTRAINT
{
  ...
  /* 0x0069 */ unsigned char UseQosUpdateLock;
  /* 0x006a */ char Padding_60[2];
  /* 0x006c */ unsigned long QosUpdateLock;
...
{
  /* 0x0000 */ enum _TAG_UNNAMED_10 Type;
  /* 0x0004 */ unsigned long Vector;
  /* 0x0008 */ unsigned char Irql;
  /* 0x0009 */ char Padding_62[3];
  ...
  union
  {
    ...
    struct
    {
      ...
      {
        /* 0x0040 */ enum _TAG_UNNAMED_11 DestinationMode;
...
typedef struct _EPROCESS
{
  ...
  /* 0x028c */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0294 */ unsigned long ModifiedPageCount;
  /* 0x0298 */ long ExitStatus;
  /* 0x029c */ struct _RTL_AVL_TREE VadRoot;
  /* 0x02a0 */ void* VadHint;
  /* 0x02a4 */ unsigned long VadCount;
  /* 0x02a8 */ volatile unsigned long VadPhysicalPages;
  /* 0x02ac */ unsigned long VadPhysicalPagesLimit;
  /* 0x02b0 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x02c0 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x02c8 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x02cc */ unsigned long RequestedTimerResolution;
  /* 0x02d0 */ unsigned long SmallestTimerResolution;
  /* 0x02d4 */ long Padding_64;
  /* 0x02d8 */ union _LARGE_INTEGER ExitTime;
  /* 0x02e0 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x02e4 */ unsigned long LargePrivateVadCount;
  /* 0x02e8 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x02ec */ void* WnfContext;
  /* 0x02f0 */ struct _EJOB* ServerSilo;
  /* 0x02f4 */ unsigned char SignatureLevel;
  /* 0x02f5 */ unsigned char SectionSignatureLevel;
  /* 0x02f6 */ struct _PS_PROTECTION Protection;
  struct /* bitfield */
  {
    /* 0x02f7 */ unsigned char HangCount : 3; /* bit position: 0 */
    /* 0x02f7 */ unsigned char GhostCount : 3; /* bit position: 3 */
    /* 0x02f7 */ unsigned char PrefilterException : 1; /* bit position: 6 */
  }; /* bitfield */
  union
  {
    /* 0x02f8 */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x02f8 */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x02f8 */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x02f8 */ unsigned long Crashed : 1; /* bit position: 2 */
      /* 0x02f8 */ unsigned long JobVadsAreTracked : 1; /* bit position: 3 */
      /* 0x02f8 */ unsigned long VadTrackingDisabled : 1; /* bit position: 4 */
      /* 0x02f8 */ unsigned long AuxiliaryProcess : 1; /* bit position: 5 */
      /* 0x02f8 */ unsigned long SubsystemProcess : 1; /* bit position: 6 */
      /* 0x02f8 */ unsigned long IndirectCpuSets : 1; /* bit position: 7 */
      /* 0x02f8 */ unsigned long RelinquishedCommit : 1; /* bit position: 8 */
      /* 0x02f8 */ unsigned long HighGraphicsPriority : 1; /* bit position: 9 */
      /* 0x02f8 */ unsigned long CommitFailLogged : 1; /* bit position: 10 */
      /* 0x02f8 */ unsigned long ReserveFailLogged : 1; /* bit position: 11 */
      /* 0x02f8 */ unsigned long SystemProcess : 1; /* bit position: 12 */
      /* 0x02f8 */ unsigned long HideImageBaseAddresses : 1; /* bit position: 13 */
      /* 0x02f8 */ unsigned long AddressPolicyFrozen : 1; /* bit position: 14 */
      /* 0x02f8 */ unsigned long ProcessFirstResume : 1; /* bit position: 15 */
      /* 0x02f8 */ unsigned long ForegroundExternal : 1; /* bit position: 16 */
      /* 0x02f8 */ unsigned long ForegroundSystem : 1; /* bit position: 17 */
      /* 0x02f8 */ unsigned long HighMemoryPriority : 1; /* bit position: 18 */
      /* 0x02f8 */ unsigned long EnableProcessSuspendResumeLogging : 1; /* bit position: 19 */
      /* 0x02f8 */ unsigned long EnableThreadSuspendResumeLogging : 1; /* bit position: 20 */
      /* 0x02f8 */ unsigned long SecurityDomainChanged : 1; /* bit position: 21 */
      /* 0x02f8 */ unsigned long SecurityFreezeComplete : 1; /* bit position: 22 */
      /* 0x02f8 */ unsigned long VmProcessorHost : 1; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02fc */ long DeviceAsid;
  /* 0x0300 */ void* SvmData;
  /* 0x0304 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x0308 */ unsigned long SvmLock;
  /* 0x030c */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x0314 */ long Padding_65;
  /* 0x0318 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x0320 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x0324 */ void* PicoContext;
  /* 0x0328 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x032c */ void* InstrumentationCallback;
  /* 0x0330 */ struct _PO_PROCESS_ENERGY_CONTEXT* EnergyContext;
  /* 0x0334 */ void* VmContext;
  ...
  /* 0x0380 */ void* DiskIoAttribution;
  /* 0x0384 */ void* DxgProcess;
  /* 0x0388 */ unsigned long Win32KFilterSet;
  /* 0x038c */ long Padding_66;
  /* 0x0390 */ volatile union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;
  /* 0x0398 */ volatile unsigned long KTimerSets;
  /* 0x039c */ volatile unsigned long KTimer2Sets;
  /* 0x03a0 */ volatile unsigned long ThreadTimerSets;
  /* 0x03a4 */ unsigned long VirtualTimerListLock;
  /* 0x03a8 */ struct _LIST_ENTRY VirtualTimerListHead;
  union
  {
    /* 0x03b0 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x03b0 */ struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0030 */
  union
  {
    ...
    struct // _TAG_UNNAMED_59
    {
      struct /* bitfield */
      {
        /* 0x03e0 */ unsigned long ControlFlowGuardEnabled : 1; /* bit position: 0 */
        /* 0x03e0 */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 1 */
        /* 0x03e0 */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 2 */
        /* 0x03e0 */ unsigned long DisallowStrippedImages : 1; /* bit position: 3 */
        /* 0x03e0 */ unsigned long ForceRelocateImages : 1; /* bit position: 4 */
        /* 0x03e0 */ unsigned long HighEntropyASLREnabled : 1; /* bit position: 5 */
        /* 0x03e0 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 6 */
        /* 0x03e0 */ unsigned long ExtensionPointDisable : 1; /* bit position: 7 */
        /* 0x03e0 */ unsigned long DisableDynamicCode : 1; /* bit position: 8 */
        /* 0x03e0 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 9 */
        /* 0x03e0 */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 10 */
        /* 0x03e0 */ unsigned long AuditDisableDynamicCode : 1; /* bit position: 11 */
        /* 0x03e0 */ unsigned long DisallowWin32kSystemCalls : 1; /* bit position: 12 */
        /* 0x03e0 */ unsigned long AuditDisallowWin32kSystemCalls : 1; /* bit position: 13 */
        /* 0x03e0 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 14 */
        /* 0x03e0 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 15 */
        /* 0x03e0 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 16 */
        /* 0x03e0 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 17 */
        /* 0x03e0 */ unsigned long PreferSystem32Images : 1; /* bit position: 18 */
        /* 0x03e0 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 19 */
        /* 0x03e0 */ unsigned long AuditProhibitRemoteImageMap : 1; /* bit position: 20 */
        /* 0x03e0 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 21 */
        /* 0x03e0 */ unsigned long AuditProhibitLowILImageMap : 1; /* bit position: 22 */
        /* 0x03e0 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 23 */
        /* 0x03e0 */ unsigned long AuditBlockNonMicrosoftBinaries : 1; /* bit position: 24 */
        /* 0x03e0 */ unsigned long AuditBlockNonMicrosoftBinariesAllowStore : 1; /* bit position: 25 */
        /* 0x03e0 */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 26 */
        /* 0x03e0 */ unsigned long AuditLoaderIntegrityContinuity : 1; /* bit position: 27 */
        /* 0x03e0 */ unsigned long EnableModuleTamperingProtection : 1; /* bit position: 28 */
        /* 0x03e0 */ unsigned long EnableModuleTamperingProtectionNoInherit : 1; /* bit position: 29 */
        /* 0x03e0 */ unsigned long RestrictIndirectBranchPrediction : 1; /* bit position: 30 */
        /* 0x03e0 */ unsigned long IsolateSecurityDomain : 1; /* bit position: 31 */
      }; /* bitfield */
  ...
  union
  {
    ...
    struct // _TAG_UNNAMED_60
    {
      struct /* bitfield */
      {
        /* 0x03e4 */ unsigned long EnableExportAddressFilter : 1; /* bit position: 0 */
        /* 0x03e4 */ unsigned long AuditExportAddressFilter : 1; /* bit position: 1 */
        /* 0x03e4 */ unsigned long EnableExportAddressFilterPlus : 1; /* bit position: 2 */
        /* 0x03e4 */ unsigned long AuditExportAddressFilterPlus : 1; /* bit position: 3 */
        /* 0x03e4 */ unsigned long EnableRopStackPivot : 1; /* bit position: 4 */
        /* 0x03e4 */ unsigned long AuditRopStackPivot : 1; /* bit position: 5 */
        /* 0x03e4 */ unsigned long EnableRopCallerCheck : 1; /* bit position: 6 */
        /* 0x03e4 */ unsigned long AuditRopCallerCheck : 1; /* bit position: 7 */
        /* 0x03e4 */ unsigned long EnableRopSimExec : 1; /* bit position: 8 */
        /* 0x03e4 */ unsigned long AuditRopSimExec : 1; /* bit position: 9 */
        /* 0x03e4 */ unsigned long EnableImportAddressFilter : 1; /* bit position: 10 */
        /* 0x03e4 */ unsigned long AuditImportAddressFilter : 1; /* bit position: 11 */
        /* 0x03e4 */ unsigned long DisablePageCombine : 1; /* bit position: 12 */
        /* 0x03e4 */ unsigned long SpeculativeStoreBypassDisable : 1; /* bit position: 13 */
        /* 0x03e4 */ unsigned long CetShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x03e8 */ void* PartitionObject;
  /* 0x03ec */ long Padding_67;
  /* 0x03f0 */ unsigned __int64 SecurityDomain;
  /* 0x03f8 */ unsigned __int64 ParentSecurityDomain;
  /* 0x0400 */ void* CoverageSamplerContext;
  /* 0x0404 */ void* MmHotPatchContext;
} EPROCESS, *PEPROCESS; /* size: 0x0408 */
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x03cc */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x03cc */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x03d0 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x03d0 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x03d5 */ unsigned char OwnsVadShared : 1; /* bit position: 5 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  ...
  /* 0x0400 */ unsigned long KernelStackReference;
  /* 0x0404 */ struct _LIST_ENTRY BoostList;
  /* 0x040c */ struct _LIST_ENTRY DeboostList;
  /* 0x0414 */ unsigned long BoostListLock;
  /* 0x0418 */ unsigned long IrpListLock;
  /* 0x041c */ void* ReservedForSynchTracking;
  /* 0x0420 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0424 */ const struct _GUID* ActivityId;
  /* 0x0428 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x042c */ void* VerifierContext;
...
typedef struct _IO_STACK_LOCATION
{
  ...
  union // _TAG_UNNAMED_67
  {
    union
    {
      ...
      {
        /* 0x0004 */ enum _TAG_UNNAMED_1 IdType;
      } /* size: 0x0004 */ QueryId;
      struct // _TAG_UNNAMED_95
      {
        /* 0x0004 */ enum _TAG_UNNAMED_2 DeviceTextType;
      ...
      struct // _TAG_UNNAMED_99
      {
        ...
        /* 0x0010 */ enum _TAG_UNNAMED_3 ShutdownType;
      } /* size: 0x0010 */ Power;
...
_IsGlobalizationUserSettingsKeyRedirected@0
_IsHangulLV@4
_IsHangulS@4
_IsLanguageOverlayBlockedByPolicy@0
...
_LdrpInitializeExceptionTable@4
_LdrpInitializeExecutionOptions@24
_LdrpInitializeGraph@8
...
_LdrpOverrideExportSuppression@0
...
_OpenGlobalizationUserSettingsKey@16
_PfxFindPrefix@8
_PfxInitialize@4
_PfxInsertPrefix@12
_PfxRemovePrefix@8
...
_RtlpHpVsDelayFreeContextFlush@4
_RtlpHpVsDelayFreeContextInitialize@4
