...
{
  /* 0x0000 */ enum _TAG_UNNAMED_9 Type;
  ...
  union
  {
    ...
    struct
    {
      struct
      {
        /* 0x0040 */ enum _TAG_UNNAMED_1 DestinationMode;
...
typedef struct _IO_STACK_LOCATION
{
  ...
  union
  {
    union
    {
      ...
      struct
      {
        /* 0x0004 */ enum _TAG_UNNAMED_2 IdType;
      } /* size: 0x0004 */ QueryId;
      struct
      {
        /* 0x0004 */ enum _TAG_UNNAMED_6 DeviceTextType;
      ...
      struct
      {
        ...
        /* 0x0010 */ enum _TAG_UNNAMED_10 ShutdownType;
      } /* size: 0x0010 */ Power;
      struct
      {
...
typedef struct _MCA_EXCEPTION
{
  ...
  /* 0x0004 */ enum _TAG_UNNAMED_8 ExceptionType;
...
typedef struct _PROC_IDLE_ACCOUNTING
{
  ...
  /* 0x0020 */ enum _TAG_UNNAMED_11 TimeUnit;
