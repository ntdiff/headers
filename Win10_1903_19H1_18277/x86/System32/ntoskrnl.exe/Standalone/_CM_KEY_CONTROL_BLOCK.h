...
typedef struct _CM_KEY_CONTROL_BLOCK
{
  ...
  /* 0x0030 */ struct _CACHED_CHILD_LIST ValueCache;
  union
  {
    /* 0x0038 */ struct _CM_INDEX_HINT_BLOCK* IndexHint;
    /* 0x0038 */ unsigned long HashKey;
    /* 0x0038 */ unsigned long SubKeyCount;
  }; /* size: 0x0004 */
  union
  {
    /* 0x003c */ struct _LIST_ENTRY KeyBodyListHead;
    /* 0x003c */ struct _LIST_ENTRY ClonedListEntry;
  }; /* size: 0x0008 */
  /* 0x0044 */ struct _CM_KEY_BODY* KeyBodyArray[4];
