...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0004 */ enum _TAG_UNNAMED_28 Action;
  /* 0x0008 */ enum _SYSTEM_POWER_STATE LightestState;
  /* 0x000c */ unsigned long Flags;
  /* 0x0010 */ long Status;
  /* 0x0014 */ enum _TAG_UNNAMED_55 DeviceType;
  ...
  /* 0x0058 */ enum _TAG_UNNAMED_56 WakeAlarmSignaled;
  /* 0x0060 */ struct // _TAG_UNNAMED_57
  {
...
} POP_POWER_ACTION, *PPOP_POWER_ACTION; /* size: 0x0110 */
