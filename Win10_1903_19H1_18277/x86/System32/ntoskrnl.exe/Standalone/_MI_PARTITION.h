...
typedef struct _MI_SLAB_ALLOCATOR_CONTEXT
{
  ...
  /* 0x0020 */ struct _MMPFNLIST StandbyList;
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0878 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[3];
  /* 0x0950 */ struct _RTL_BITMAP SlabPfnBitMap;
  /* 0x0958 */ long __PADDING__[10];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x0980 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0ec0 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x0f40 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x0f80 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1058 */ void* WorkingSetControl;
  /* 0x105c */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1064 */ unsigned long SessionDetachTimeStamp;
  /* 0x1080 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x1c80 */
