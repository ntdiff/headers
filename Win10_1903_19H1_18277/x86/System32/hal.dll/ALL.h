...
} INTERRUPT_FUNCTION_TABLE, *PINTERRUPT_FUNCTION_TABLE; /* size: 0x0058 */
...
typedef struct _REGISTERED_INTERRUPT_CONTROLLER
{
  ...
  /* 0x0068 */ enum _KNOWN_CONTROLLER_TYPE KnownType;
  /* 0x006c */ unsigned long Capabilities;
  /* 0x0070 */ unsigned long Flags;
  /* 0x0074 */ unsigned long MaxPriority;
  /* 0x0078 */ unsigned long UnitId;
  /* 0x007c */ struct _LIST_ENTRY LinesHead;
  /* 0x0084 */ struct _LIST_ENTRY OutputLinesHead;
  /* 0x008c */ long MinLine;
  /* 0x0090 */ long MaxLine;
  /* 0x0094 */ unsigned long MaxClusterSize;
  /* 0x0098 */ unsigned long MaxClusters;
  /* 0x009c */ unsigned long InterruptReplayDataSize;
  /* 0x00a0 */ enum _INTERRUPT_PROBLEM Problem;
  /* 0x00a4 */ long ProblemStatus;
  /* 0x00a8 */ const char* ProblemSourceFile;
  /* 0x00ac */ unsigned long ProblemSourceLine;
  /* 0x00b0 */ unsigned long CustomProblem;
  /* 0x00b4 */ long CustomProblemStatus;
  /* 0x00b8 */ struct _UNICODE_STRING ResourceId;
  /* 0x00c0 */ struct POHANDLE__* PowerHandle;
} REGISTERED_INTERRUPT_CONTROLLER, *PREGISTERED_INTERRUPT_CONTROLLER; /* size: 0x00c4 */
...
typedef struct _ADAPTER_OBJECT
{
  ...
  union
  {
    /* 0x0160 */ unsigned long LowMemoryLogicalAddressQueueFlags;
    struct /* bitfield */
    {
      /* 0x0160 */ unsigned long LowMemoryLogicalAddressInUse : 1; /* bit position: 0 */
      /* 0x0160 */ unsigned long WaitingOnLowMemoryLogicalAddress : 1; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0164 */ unsigned long LowMemoryLogicalAddressQueueLock;
  /* 0x0168 */ enum _HALP_DMA_ADAPTER_ALLOCATION_STATE AllocationState;
  /* 0x016c */ unsigned long ScatterGatherBufferLength;
  /* 0x0170 */ struct _SCATTER_GATHER_LIST ScatterGatherBuffer;
} ADAPTER_OBJECT, *PADAPTER_OBJECT; /* size: 0x0178 */
...
_HalpMcaReadErrorUncorrected@8
