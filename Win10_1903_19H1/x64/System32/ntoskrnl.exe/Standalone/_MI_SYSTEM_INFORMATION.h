...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x0080 */ unsigned long LargePageColors[3];
  /* 0x0090 */ unsigned __int64 FlushTbThreshold;
  /* 0x0098 */ enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4][4];
  /* 0x00d8 */ unsigned char AttributeChangeRequiresReZero;
  /* 0x00e0 */ struct _MI_ZERO_COST_COUNTS ZeroCostCounts[2];
  /* 0x0100 */ unsigned __int64 VsmKernelPageCount;
  /* 0x0108 */ struct _RTL_AVL_TREE EnclaveRegions;
  /* 0x0110 */ void* EnclaveMetadataPage;
  /* 0x0118 */ struct _RTL_BITMAP* EnclaveMetadataBitMap;
  /* 0x0120 */ struct _EX_PUSH_LOCK EnclaveMetadataEntryLock;
  /* 0x0128 */ volatile long EnclaveMetadataPageLock;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x2380 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2440 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2480 */ unsigned __int64 Cookie;
  /* 0x2488 */ void* volatile* BootRegistryRuns;
  /* 0x2490 */ volatile long ZeroingDisabled;
  /* 0x2494 */ unsigned char FullyInitialized;
  /* 0x2495 */ unsigned char SafeBooted;
  /* 0x2498 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x24c0 */ struct _MI_VISIBLE_STATE Vs;
