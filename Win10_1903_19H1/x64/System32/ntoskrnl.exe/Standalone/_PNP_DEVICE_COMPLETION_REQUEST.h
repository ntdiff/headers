...
typedef struct _PNP_DEVICE_COMPLETION_REQUEST
{
  ...
  /* 0x0040 */ struct _FAST_MUTEX PnpDeviceCompletionQueueWatchdogLock;
  /* 0x0078 */ struct _PNP_WATCHDOG* Watchdog;
} PNP_DEVICE_COMPLETION_REQUEST, *PPNP_DEVICE_COMPLETION_REQUEST; /* size: 0x0080 */
