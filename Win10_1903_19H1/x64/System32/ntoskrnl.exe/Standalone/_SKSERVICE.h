typedef enum _SKSERVICE
{
  ...
  SECURESERVICE_DETERMINE_HOT_PATCH_TYPE = 61,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE_SIZE = 62,
  SECURESERVICE_OBTAIN_PATCH_UNDO_TABLE = 63,
  SECURESERVICE_APPLY_HOT_PATCH = 64,
  SECURESERVICE_REVERT_HOT_PATCH = 65,
  SECURESERVICE_PROVISION_DUMP_KEYS = 66,
  ...
  SECURESERVICE_INITIALIZE_RETPOLINE = 218,
  SECURESERVICE_SET_RETPOLINE_PFN = 219,
