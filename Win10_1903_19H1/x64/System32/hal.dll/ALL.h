...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x00d9 */ char Padding_41[7];
  /* 0x00e0 */ unsigned long MapRegistersPerChannel;
  /* 0x00e4 */ long Padding_42;
