...
typedef struct _HEAP_RUNTIME_MEMORY_STATS
{
  ...
  /* 0x0040 */ struct _RTL_HP_SEG_ALLOC_POLICY LargePagePolicy;
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x0298 */ long Padding_47[2];
  /* 0x02a0 */ struct _HEAP_LFH_CONTEXT LfhContext;
} SEGMENT_HEAP, *PSEGMENT_HEAP; /* size: 0x0790 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_53[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_54[2];
...
typedef struct _KPRCB
{
  ...
  /* 0x06cc */ unsigned long PrcbPad11a;
  union
  {
    struct
    {
...
RtlpHpSegMgrCheckLargeUtilization
RtlpHpSegMgrCommit
