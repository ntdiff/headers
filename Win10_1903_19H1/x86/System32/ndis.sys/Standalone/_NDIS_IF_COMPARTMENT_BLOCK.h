...
typedef struct _NDIS_IF_COMPARTMENT_BLOCK
{
  ...
  /* 0x0690 */ struct _NDIS_IF_BLOCK* LoopbackIf;
  /* 0x0694 */ struct _KEVENT* AsyncEvent;
  /* 0x0698 */ unsigned long JobCount;
  /* 0x069c */ struct _LIST_ENTRY JobLink;
  /* 0x06a4 */ long __PADDING__[1];
