...
typedef struct _KPRCB
{
  ...
  /* 0x21c4 */ unsigned char PrcbPad50[12];
  ...
  union // _TAG_UNNAMED_32
  {
    union
    {
      struct /* bitfield */
      {
        ...
        /* 0x0009 */ unsigned char OpportunisticLargePages : 1; /* bit position: 2 */
        /* 0x0009 */ unsigned char ForceLargePages : 2; /* bit position: 3 */
      }; /* bitfield */
      /* 0x0009 */ unsigned char AllFlags;
    }; /* size: 0x0001 */
  } /* size: 0x0001 */ Flags;
  /* 0x000a */ char Padding_36[2];
...
typedef struct _HEAP_RUNTIME_MEMORY_STATS
{
  ...
  /* 0x0020 */ struct _RTL_HP_SEG_ALLOC_POLICY LargePagePolicy;
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x0164 */ long Padding_82;
  /* 0x0168 */ struct _HEAP_LFH_CONTEXT LfhContext;
} SEGMENT_HEAP, *PSEGMENT_HEAP; /* size: 0x03e8 */
...
_RtlpHpSegMgrAllocate@8
_RtlpHpSegMgrCheckLargeUtilization@4
_RtlpHpSegMgrCommit@24
_RtlpHpSegMgrCommitComplete@24
_RtlpHpSegMgrCommitInitiate@24
_RtlpHpSegMgrRelease@12
_RtlpHpSegMgrReserve@16
