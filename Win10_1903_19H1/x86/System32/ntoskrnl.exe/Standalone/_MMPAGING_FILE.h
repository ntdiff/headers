...
typedef struct _MMPAGING_FILE
{
  ...
  /* 0x0020 */ struct _MMMOD_WRITER_MDL_ENTRY* Entry[2];
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0074 */ unsigned short Spare0 : 4; /* bit position: 11 */
  }; /* bitfield */
  struct /* bitfield */
  {
  ...
  /* 0x0088 */ unsigned long Lock;
  /* 0x008c */ struct _ETHREAD* LockOwner;
  /* 0x0090 */ struct _RTL_AVL_TREE FlowThroughReadRoot;
  /* 0x0094 */ struct _MI_PARTITION* Partition;
  /* 0x0098 */ struct _RTL_BALANCED_NODE FileObjectNode;
