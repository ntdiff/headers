...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1900 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x4040 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x4058 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x4070 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x40a8 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x40f0 */ struct _MI_ERROR_STATE Errors;
  /* 0x41c0 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x4240 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x42d0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x4340 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x44c0 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x4500 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x4538 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x4580 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x45c0 */ unsigned long Cookie;
  /* 0x45c4 */ void* volatile* BootRegistryRuns;
  /* 0x45c8 */ volatile long ZeroingDisabled;
  /* 0x45cc */ unsigned char FullyInitialized;
  /* 0x45cd */ unsigned char SafeBooted;
  /* 0x45d0 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x45d8 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x4600 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x5080 */
