...
struct JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V3
{
  ...
  /* 0x0058 */ __int64 SoftMaxIops;
  /* 0x0060 */ __int64 SoftMaxBandwidth;
  /* 0x0068 */ __int64 SoftMaxTimePercent;
  /* 0x0070 */ __int64 LimitExcessNotifyIops;
  /* 0x0078 */ __int64 LimitExcessNotifyBandwidth;
  /* 0x0080 */ __int64 LimitExcessNotifyTimePercent;
}; /* size: 0x0088 */
