...
typedef struct _MI_PARTITION
{
  ...
  /* 0x18c0 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1928 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1ab8 */ void* WorkingSetControl;
  /* 0x1ac0 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1ad0 */ unsigned long SessionDetachTimeStamp;
