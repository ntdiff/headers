...
typedef struct _KTHREAD
{
  ...
  /* 0x0600 */ unsigned __int64 KernelWaitTime;
  /* 0x0608 */ unsigned __int64 UserWaitTime;
...
typedef struct _PROCESSOR_POWER_STATE
{
  ...
  /* 0x01bc */ unsigned long MediaUtility;
  union
  {
...
typedef struct _KPRCB
{
  ...
  /* 0x3090 */ unsigned __int64 PrcbPad41[6];
  ...
  /* 0x3130 */ unsigned long LastTimerHand;
  ...
  /* 0x5b40 */ struct _KGATE DpcGate;
  /* 0x5b58 */ void* PrcbPad52;
  /* 0x5b60 */ struct _KDPC CallDpc;
  /* 0x5ba0 */ long ClockKeepAlive;
  /* 0x5ba4 */ unsigned char PrcbPad60[2];
  /* 0x5ba6 */ unsigned short NmiActive;
  /* 0x5ba8 */ long DpcWatchdogPeriod;
  /* 0x5bac */ long DpcWatchdogCount;
  /* 0x5bb0 */ volatile long KeSpinLockOrdering;
  /* 0x5bb4 */ unsigned long DpcWatchdogProfileCumulativeDpcThreshold;
  /* 0x5bb8 */ void* CachedPtes;
  /* 0x5bc0 */ struct _LIST_ENTRY WaitListHead;
  /* 0x5bd0 */ unsigned __int64 WaitLock;
  /* 0x5bd8 */ unsigned long ReadySummary;
  /* 0x5bdc */ long AffinitizedSelectionMask;
  /* 0x5be0 */ unsigned long QueueIndex;
  /* 0x5be4 */ unsigned long PrcbPad75[3];
  /* 0x5bf0 */ struct _KDPC TimerExpirationDpc;
  /* 0x5c30 */ struct _RTL_RB_TREE ScbQueue;
  /* 0x5c40 */ struct _LIST_ENTRY DispatcherReadyListHead[32];
  /* 0x5e40 */ unsigned long InterruptCount;
  /* 0x5e44 */ unsigned long KernelTime;
  /* 0x5e48 */ unsigned long UserTime;
  /* 0x5e4c */ unsigned long DpcTime;
  /* 0x5e50 */ unsigned long InterruptTime;
  /* 0x5e54 */ unsigned long AdjustDpcThreshold;
  /* 0x5e58 */ unsigned char DebuggerSavedIRQL;
  /* 0x5e59 */ unsigned char GroupSchedulingOverQuota;
  /* 0x5e5a */ volatile unsigned char DeepSleep;
  /* 0x5e5b */ unsigned char PrcbPad80;
  /* 0x5e5c */ unsigned long DpcTimeCount;
  /* 0x5e60 */ unsigned long DpcTimeLimit;
  /* 0x5e64 */ unsigned long PeriodicCount;
  /* 0x5e68 */ unsigned long PeriodicBias;
  /* 0x5e6c */ unsigned long AvailableTime;
  /* 0x5e70 */ unsigned long KeExceptionDispatchCount;
  /* 0x5e74 */ unsigned long ReadyThreadCount;
  /* 0x5e78 */ unsigned __int64 ReadyQueueExpectedRunTime;
  /* 0x5e80 */ unsigned __int64 StartCycles;
  /* 0x5e88 */ unsigned __int64 TaggedCyclesStart;
  /* 0x5e90 */ unsigned __int64 TaggedCycles[2];
  /* 0x5ea0 */ unsigned __int64 GenerationTarget;
  /* 0x5ea8 */ unsigned __int64 AffinitizedCycles;
  /* 0x5eb0 */ unsigned __int64 ImportantCycles;
  /* 0x5eb8 */ unsigned __int64 UnimportantCycles;
  /* 0x5ec0 */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x5ec4 */ volatile long MmSpinLockOrdering;
  /* 0x5ec8 */ void* volatile CachedStack;
  /* 0x5ed0 */ unsigned long PageColor;
  /* 0x5ed4 */ unsigned long NodeColor;
  /* 0x5ed8 */ unsigned long NodeShiftedColor;
  /* 0x5edc */ unsigned long SecondaryColorMask;
  /* 0x5ee0 */ unsigned char PrcbPad81[6];
  /* 0x5ee6 */ unsigned char ExceptionStackActive;
  /* 0x5ee7 */ unsigned char TbFlushListActive;
  /* 0x5ee8 */ void* ExceptionStack;
  /* 0x5ef0 */ unsigned __int64 PrcbPad82[1];
  /* 0x5ef8 */ unsigned __int64 CycleTime;
  /* 0x5f00 */ unsigned __int64 Cycles[2][4];
  /* 0x5f40 */ unsigned long CcFastMdlReadNoWait;
  /* 0x5f44 */ unsigned long CcFastMdlReadWait;
  /* 0x5f48 */ unsigned long CcFastMdlReadNotPossible;
  /* 0x5f4c */ unsigned long CcMapDataNoWait;
  /* 0x5f50 */ unsigned long CcMapDataWait;
  /* 0x5f54 */ unsigned long CcPinMappedDataCount;
  /* 0x5f58 */ unsigned long CcPinReadNoWait;
  /* 0x5f5c */ unsigned long CcPinReadWait;
  /* 0x5f60 */ unsigned long CcMdlReadNoWait;
  /* 0x5f64 */ unsigned long CcMdlReadWait;
  /* 0x5f68 */ unsigned long CcLazyWriteHotSpots;
  /* 0x5f6c */ unsigned long CcLazyWriteIos;
  /* 0x5f70 */ unsigned long CcLazyWritePages;
  /* 0x5f74 */ unsigned long CcDataFlushes;
  /* 0x5f78 */ unsigned long CcDataPages;
  /* 0x5f7c */ unsigned long CcLostDelayedWrites;
  /* 0x5f80 */ unsigned long CcFastReadResourceMiss;
  /* 0x5f84 */ unsigned long CcCopyReadWaitMiss;
  /* 0x5f88 */ unsigned long CcFastMdlReadResourceMiss;
  /* 0x5f8c */ unsigned long CcMapDataNoWaitMiss;
  /* 0x5f90 */ unsigned long CcMapDataWaitMiss;
  /* 0x5f94 */ unsigned long CcPinReadNoWaitMiss;
  /* 0x5f98 */ unsigned long CcPinReadWaitMiss;
  /* 0x5f9c */ unsigned long CcMdlReadNoWaitMiss;
  /* 0x5fa0 */ unsigned long CcMdlReadWaitMiss;
  /* 0x5fa4 */ unsigned long CcReadAheadIos;
  /* 0x5fa8 */ volatile long MmCacheTransitionCount;
  /* 0x5fac */ volatile long MmCacheReadCount;
  /* 0x5fb0 */ volatile long MmCacheIoCount;
  /* 0x5fb4 */ unsigned long PrcbPad91;
  /* 0x5fb8 */ void* MmInternal;
  /* 0x5fc0 */ struct _PROCESSOR_POWER_STATE PowerState;
  /* 0x61c0 */ void* HyperPte;
  /* 0x61c8 */ struct _LIST_ENTRY ScbList;
  /* 0x61d8 */ struct _KDPC ForceIdleDpc;
  /* 0x6218 */ struct _KDPC DpcWatchdogDpc;
  /* 0x6258 */ struct _KTIMER DpcWatchdogTimer;
  /* 0x6298 */ struct _CACHE_DESCRIPTOR Cache[5];
  /* 0x62d4 */ unsigned long CacheCount;
  /* 0x62d8 */ volatile unsigned long CachedCommit;
  /* 0x62dc */ volatile unsigned long CachedResidentAvailable;
  /* 0x62e0 */ void* WheaInfo;
  /* 0x62e8 */ void* EtwSupport;
  /* 0x62f0 */ void* ExSaPageArray;
  /* 0x62f8 */ unsigned long KeAlignmentFixupCount;
  /* 0x62fc */ unsigned long PrcbPad95;
  /* 0x6300 */ union _SLIST_HEADER HypercallPageList;
  /* 0x6310 */ unsigned __int64* StatisticsPage;
  /* 0x6318 */ unsigned __int64 PrcbPad85[5];
  /* 0x6340 */ void* HypercallCachedPages;
  /* 0x6348 */ void* VirtualApicAssist;
  /* 0x6350 */ struct _KAFFINITY_EX PackageProcessorSet;
  /* 0x63f8 */ unsigned long PackageId;
  /* 0x63fc */ unsigned long PrcbPad86;
  /* 0x6400 */ unsigned __int64 SharedReadyQueueMask;
  /* 0x6408 */ struct _KSHARED_READY_QUEUE* SharedReadyQueue;
  /* 0x6410 */ unsigned long SharedQueueScanOwner;
  /* 0x6414 */ unsigned long ScanSiblingIndex;
  /* 0x6418 */ unsigned __int64 CoreProcessorSet;
  /* 0x6420 */ unsigned __int64 ScanSiblingMask;
  /* 0x6428 */ unsigned __int64 LLCMask;
  /* 0x6430 */ unsigned __int64 CacheProcessorMask[5];
  /* 0x6458 */ struct _PROCESSOR_PROFILE_CONTROL_AREA* ProcessorProfileControlArea;
  /* 0x6460 */ void* ProfileEventIndexAddress;
  /* 0x6468 */ void** DpcWatchdogProfile;
  /* 0x6470 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x6478 */ void* SchedulerAssist;
  /* 0x6480 */ struct _SYNCH_COUNTERS SynchCounters;
  /* 0x6538 */ unsigned __int64 PrcbPad94;
  /* 0x6540 */ struct _FILESYSTEM_DISK_COUNTERS FsCounters;
  /* 0x6550 */ unsigned char VendorString[13];
  /* 0x655d */ unsigned char PrcbPad100[3];
  /* 0x6560 */ unsigned __int64 FeatureBits;
  /* 0x6568 */ union _LARGE_INTEGER UpdateSignature;
  /* 0x6570 */ unsigned __int64 PteBitCache;
  /* 0x6578 */ unsigned long PteBitOffset;
  /* 0x657c */ unsigned long PrcbPad105;
  /* 0x6580 */ struct _CONTEXT* Context;
  /* 0x6588 */ unsigned long ContextFlagsInit;
  /* 0x658c */ unsigned long PrcbPad115;
  /* 0x6590 */ struct _XSAVE_AREA* ExtendedState;
  /* 0x6598 */ void* IsrStack;
  /* 0x65a0 */ struct _KENTROPY_TIMING_STATE EntropyTimingState;
  /* 0x66f0 */ unsigned __int64 PrcbPad110;
  struct
  {
    /* 0x66f8 */ unsigned long UpdateCycle;
    union
    {
      /* 0x66fc */ short PairLocal;
      struct
      {
        /* 0x66fc */ unsigned char PairLocalLow;
        struct /* bitfield */
        {
          /* 0x66fd */ unsigned char PairLocalForceStibp : 1; /* bit position: 0 */
          /* 0x66fd */ unsigned char Reserved : 4; /* bit position: 1 */
          /* 0x66fd */ unsigned char Frozen : 1; /* bit position: 5 */
          /* 0x66fd */ unsigned char ForceUntrusted : 1; /* bit position: 6 */
          /* 0x66fd */ unsigned char SynchIpi : 1; /* bit position: 7 */
        }; /* bitfield */
      }; /* size: 0x0002 */
    }; /* size: 0x0002 */
    union
    {
      /* 0x66fe */ short PairRemote;
      struct
      {
        /* 0x66fe */ unsigned char PairRemoteLow;
        /* 0x66ff */ unsigned char Reserved2;
      }; /* size: 0x0002 */
    }; /* size: 0x0002 */
    /* 0x6700 */ unsigned char Trace[24];
    /* 0x6718 */ unsigned __int64 LocalDomain;
    /* 0x6720 */ unsigned __int64 RemoteDomain;
    /* 0x6728 */ struct _KTHREAD* Thread;
  } /* size: 0x0038 */ StibpPairingTrace;
  /* 0x6730 */ struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;
  /* 0x6738 */ struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;
  /* 0x6740 */ struct _KDPC AbDpc;
  /* 0x6780 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x67d4 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x6828 */ struct _KSECURE_FAULT_INFORMATION SecureFault;
  /* 0x6838 */ unsigned __int64 PrcbPad120;
  /* 0x6840 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x6ab0 */ unsigned __int64 PrcbPad125[2];
  /* 0x6ac0 */ unsigned long TimerExpirationTraceCount;
  /* 0x6ac4 */ unsigned long PrcbPad127;
  /* 0x6ac8 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x6bc8 */ unsigned __int64 PrcbPad128[7];
  /* 0x6c00 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x6c08 */ unsigned __int64 PrcbPad130[7];
  /* 0x6c40 */ struct _MACHINE_CHECK_CONTEXT McheckContext[2];
  /* 0x6ce0 */ unsigned __int64 PrcbPad134[4];
  /* 0x6d00 */ struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
  /* 0x6d60 */ unsigned __int64 PrcbPad134a[4];
  /* 0x6d80 */ unsigned char PrcbPad138[192];
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_42[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_43[2];
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x06f9 */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x06f9 */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x06f9 */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  ...
  /* 0x07c0 */ unsigned __int64 UserFsBase;
  /* 0x07c8 */ unsigned __int64 UserGsBase;
  ...
  /* 0x07f8 */ struct _CONTEXT* SetContextState;
...
typedef struct _KNODE
{
  ...
  /* 0x0068 */ long Padding_75[6];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_76;
  union
  {
...
?RtlpFlsInitialize@@YAXPEAU_RTLP_FLS_CONTEXT@@@Z
