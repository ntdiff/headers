...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x107e */ char Padding_63[2];
  /* 0x1080 */ unsigned long DirectOidRequestCount;
  /* 0x1084 */ long Padding_64;
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_136[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_137[28];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_344;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_345[2];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_422;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_423[2];
...
{
  /* 0x0000 */ long Padding_427[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_428;
...
?IsSameBindingAs@NDIS_BIND_FILTER_LINK@@QEBA_NAEBU1@@Z
...
?NDIS_RELEASE_MINIPORT_SPIN_LOCK@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z
