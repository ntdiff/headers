...
typedef struct _MI_PARTITION
{
  ...
  /* 0x1b80 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1be8 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1d78 */ void* WorkingSetControl;
  /* 0x1d80 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1d90 */ unsigned long SessionDetachTimeStamp;
  /* 0x1e00 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x3100 */
