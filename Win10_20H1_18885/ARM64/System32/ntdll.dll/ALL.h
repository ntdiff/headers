...
typedef struct _KNODE
{
  ...
  /* 0x00a8 */ long Padding_15[22];
  /* 0x0100 */ unsigned long SiblingMask;
  /* 0x0104 */ long Padding_16;
  union
  {
...
typedef struct _KPRCB
{
  ...
  /* 0x6274 */ long Padding_97;
  /* 0x6278 */ void* ExSaPageArray;
  /* 0x6280 */ volatile long FreezePowerOff;
  /* 0x6284 */ long Padding_98;
  /* 0x6288 */ unsigned __int64 LastNonHrTimerExpiration;
  /* 0x6290 */ struct _KSTATIC_AFFINITY_BLOCK StaticAffinity;
  /* 0x6530 */ struct _KSECURE_FAULT_INFORMATION SecureFault;
  /* 0x6540 */ unsigned __int64 ImportantCycles;
  /* 0x6548 */ unsigned __int64 UnimportantCycles;
  /* 0x6550 */ unsigned long ReadyThreadCount;
  /* 0x6554 */ long Padding_99;
  /* 0x6558 */ unsigned __int64 ReadyQueueExpectedRunTime;
  /* 0x6560 */ unsigned long DpcWatchdogProfileCumulativeDpcThreshold;
  /* 0x6564 */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x6568 */ void** DpcWatchdogProfile;
  /* 0x6570 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x6578 */ void* SchedulerAssist;
  /* 0x6580 */ struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
  /* 0x65e0 */ long Padding_100[8];
  /* 0x6600 */ struct _REQUEST_MAILBOX RequestMailbox[1];
  /* 0x6640 */ long __PADDING__[16];
} KPRCB, *PKPRCB; /* size: 0x6680 */
...
typedef struct _KPROCESS
{
  ...
  /* 0x0246 */ char Padding_107[2];
  /* 0x0248 */ volatile union _KSTACK_COUNT StackCount;
  /* 0x024c */ long Padding_108;
