...
typedef struct _KPRCB
{
  ...
  /* 0x3ee0 */ struct _KDPC ForceIdleDpc;
  /* 0x3f00 */ unsigned long PrcbPad91[13];
  /* 0x3f34 */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x3f38 */ struct _KDPC DpcWatchdogDpc;
...
typedef struct _KNODE
{
  ...
  /* 0x0054 */ unsigned short ThreadSeed;
  /* 0x0056 */ unsigned short ProcessSeed;
...
typedef struct _KTHREAD
{
  ...
  /* 0x0350 */ void* volatile AbWaitObject;
  /* 0x0354 */ long Padding_39;
  /* 0x0358 */ unsigned __int64 KernelWaitTime;
  /* 0x0360 */ unsigned __int64 UserWaitTime;
} KTHREAD, *PKTHREAD; /* size: 0x0368 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x00c4 */ void* UniqueProcessId;
  /* 0x00c8 */ struct _LIST_ENTRY ActiveProcessLinks;
  /* 0x00d0 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x00d4 */ void* VdmObjects;
  union
  {
    /* 0x00d8 */ unsigned long Flags2;
    struct /* bitfield */
    {
      /* 0x00d8 */ unsigned long JobNotReallyActive : 1; /* bit position: 0 */
      /* 0x00d8 */ unsigned long AccountingFolded : 1; /* bit position: 1 */
      /* 0x00d8 */ unsigned long NewProcessReported : 1; /* bit position: 2 */
      /* 0x00d8 */ unsigned long ExitProcessReported : 1; /* bit position: 3 */
      /* 0x00d8 */ unsigned long ReportCommitChanges : 1; /* bit position: 4 */
      /* 0x00d8 */ unsigned long LastReportMemory : 1; /* bit position: 5 */
      /* 0x00d8 */ unsigned long ForceWakeCharge : 1; /* bit position: 6 */
      /* 0x00d8 */ unsigned long CrossSessionCreate : 1; /* bit position: 7 */
      /* 0x00d8 */ unsigned long NeedsHandleRundown : 1; /* bit position: 8 */
      /* 0x00d8 */ unsigned long RefTraceEnabled : 1; /* bit position: 9 */
      /* 0x00d8 */ unsigned long PicoCreated : 1; /* bit position: 10 */
      /* 0x00d8 */ unsigned long EmptyJobEvaluated : 1; /* bit position: 11 */
      /* 0x00d8 */ unsigned long DefaultPagePriority : 3; /* bit position: 12 */
      /* 0x00d8 */ unsigned long PrimaryTokenFrozen : 1; /* bit position: 15 */
      /* 0x00d8 */ unsigned long ProcessVerifierTarget : 1; /* bit position: 16 */
      /* 0x00d8 */ unsigned long RestrictSetThreadContext : 1; /* bit position: 17 */
      /* 0x00d8 */ unsigned long AffinityPermanent : 1; /* bit position: 18 */
      /* 0x00d8 */ unsigned long AffinityUpdateEnable : 1; /* bit position: 19 */
      /* 0x00d8 */ unsigned long PropagateNode : 1; /* bit position: 20 */
      /* 0x00d8 */ unsigned long ExplicitAffinity : 1; /* bit position: 21 */
      /* 0x00d8 */ unsigned long ProcessExecutionState : 2; /* bit position: 22 */
      /* 0x00d8 */ unsigned long EnableReadVmLogging : 1; /* bit position: 24 */
      /* 0x00d8 */ unsigned long EnableWriteVmLogging : 1; /* bit position: 25 */
      /* 0x00d8 */ unsigned long FatalAccessTerminationRequested : 1; /* bit position: 26 */
      /* 0x00d8 */ unsigned long DisableSystemAllowedCpuSet : 1; /* bit position: 27 */
      /* 0x00d8 */ unsigned long ProcessStateChangeRequest : 2; /* bit position: 28 */
      /* 0x00d8 */ unsigned long ProcessStateChangeInProgress : 1; /* bit position: 30 */
      /* 0x00d8 */ unsigned long InPrivate : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x00dc */ unsigned long Flags;
    struct /* bitfield */
    {
      /* 0x00dc */ unsigned long CreateReported : 1; /* bit position: 0 */
      /* 0x00dc */ unsigned long NoDebugInherit : 1; /* bit position: 1 */
      /* 0x00dc */ unsigned long ProcessExiting : 1; /* bit position: 2 */
      /* 0x00dc */ unsigned long ProcessDelete : 1; /* bit position: 3 */
      /* 0x00dc */ unsigned long ManageExecutableMemoryWrites : 1; /* bit position: 4 */
      /* 0x00dc */ unsigned long VmDeleted : 1; /* bit position: 5 */
      /* 0x00dc */ unsigned long OutswapEnabled : 1; /* bit position: 6 */
      /* 0x00dc */ unsigned long Outswapped : 1; /* bit position: 7 */
      /* 0x00dc */ unsigned long FailFastOnCommitFail : 1; /* bit position: 8 */
      /* 0x00dc */ unsigned long Wow64VaSpace4Gb : 1; /* bit position: 9 */
      /* 0x00dc */ unsigned long AddressSpaceInitialized : 2; /* bit position: 10 */
      /* 0x00dc */ unsigned long SetTimerResolution : 1; /* bit position: 12 */
      /* 0x00dc */ unsigned long BreakOnTermination : 1; /* bit position: 13 */
      /* 0x00dc */ unsigned long DeprioritizeViews : 1; /* bit position: 14 */
      /* 0x00dc */ unsigned long WriteWatch : 1; /* bit position: 15 */
      /* 0x00dc */ unsigned long ProcessInSession : 1; /* bit position: 16 */
      /* 0x00dc */ unsigned long OverrideAddressSpace : 1; /* bit position: 17 */
      /* 0x00dc */ unsigned long HasAddressSpace : 1; /* bit position: 18 */
      /* 0x00dc */ unsigned long LaunchPrefetched : 1; /* bit position: 19 */
      /* 0x00dc */ unsigned long Background : 1; /* bit position: 20 */
      /* 0x00dc */ unsigned long VmTopDown : 1; /* bit position: 21 */
      /* 0x00dc */ unsigned long ImageNotifyDone : 1; /* bit position: 22 */
      /* 0x00dc */ unsigned long PdeUpdateNeeded : 1; /* bit position: 23 */
      /* 0x00dc */ unsigned long VdmAllowed : 1; /* bit position: 24 */
      /* 0x00dc */ unsigned long ProcessRundown : 1; /* bit position: 25 */
      /* 0x00dc */ unsigned long ProcessInserted : 1; /* bit position: 26 */
      /* 0x00dc */ unsigned long DefaultIoPriority : 3; /* bit position: 27 */
      /* 0x00dc */ unsigned long ProcessSelfDelete : 1; /* bit position: 30 */
      /* 0x00dc */ unsigned long SetTimerResolutionLink : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x00e0 */ union _LARGE_INTEGER CreateTime;
  /* 0x00e8 */ unsigned long ProcessQuotaUsage[2];
  /* 0x00f0 */ unsigned long ProcessQuotaPeak[2];
  /* 0x00f8 */ unsigned long PeakVirtualSize;
  /* 0x00fc */ unsigned long VirtualSize;
  /* 0x0100 */ struct _LIST_ENTRY SessionProcessLinks;
  union
  {
    /* 0x0108 */ void* ExceptionPortData;
    /* 0x0108 */ unsigned long ExceptionPortValue;
    /* 0x0108 */ unsigned long ExceptionPortState : 3; /* bit position: 0 */
  }; /* size: 0x0004 */
  /* 0x010c */ struct _EX_FAST_REF Token;
  /* 0x0110 */ unsigned long MmReserved;
  /* 0x0114 */ struct _EX_PUSH_LOCK AddressCreationLock;
  /* 0x0118 */ struct _EX_PUSH_LOCK PageTableCommitmentLock;
  /* 0x011c */ struct _ETHREAD* RotateInProgress;
  /* 0x0120 */ struct _ETHREAD* ForkInProgress;
  /* 0x0124 */ struct _EJOB* volatile CommitChargeJob;
  /* 0x0128 */ struct _RTL_AVL_TREE CloneRoot;
  /* 0x012c */ volatile unsigned long NumberOfPrivatePages;
  /* 0x0130 */ volatile unsigned long NumberOfLockedPages;
  /* 0x0134 */ void* Win32Process;
  /* 0x0138 */ struct _EJOB* volatile Job;
  /* 0x013c */ void* SectionObject;
  /* 0x0140 */ void* SectionBaseAddress;
  /* 0x0144 */ unsigned long Cookie;
  /* 0x0148 */ struct _PAGEFAULT_HISTORY* WorkingSetWatch;
  /* 0x014c */ void* Win32WindowStation;
  /* 0x0150 */ void* InheritedFromUniqueProcessId;
  /* 0x0154 */ void* LdtInformation;
  /* 0x0158 */ volatile unsigned long OwnerProcessId;
  /* 0x015c */ struct _PEB* Peb;
  /* 0x0160 */ struct _MM_SESSION_SPACE* Session;
  /* 0x0164 */ void* Spare1;
  /* 0x0168 */ struct _EPROCESS_QUOTA_BLOCK* QuotaBlock;
  /* 0x016c */ struct _HANDLE_TABLE* ObjectTable;
  /* 0x0170 */ void* DebugPort;
  /* 0x0174 */ void* PaeTop;
  /* 0x0178 */ void* DeviceMap;
  /* 0x017c */ void* EtwDataSource;
  /* 0x0180 */ unsigned __int64 PageDirectoryPte;
  /* 0x0188 */ struct _FILE_OBJECT* ImageFilePointer;
  /* 0x018c */ unsigned char ImageFileName[15];
  /* 0x019b */ unsigned char PriorityClass;
  /* 0x019c */ void* SecurityPort;
  /* 0x01a0 */ struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;
  /* 0x01a4 */ struct _LIST_ENTRY JobLinks;
  /* 0x01ac */ void* HighestUserAddress;
  /* 0x01b0 */ struct _LIST_ENTRY ThreadListHead;
  /* 0x01b8 */ volatile unsigned long ActiveThreads;
  /* 0x01bc */ unsigned long ImagePathHash;
  /* 0x01c0 */ unsigned long DefaultHardErrorProcessing;
  /* 0x01c4 */ long LastThreadExitStatus;
  /* 0x01c8 */ struct _EX_FAST_REF PrefetchTrace;
  /* 0x01cc */ void* LockedPagesList;
  /* 0x01d0 */ union _LARGE_INTEGER ReadOperationCount;
  /* 0x01d8 */ union _LARGE_INTEGER WriteOperationCount;
  /* 0x01e0 */ union _LARGE_INTEGER OtherOperationCount;
  /* 0x01e8 */ union _LARGE_INTEGER ReadTransferCount;
  /* 0x01f0 */ union _LARGE_INTEGER WriteTransferCount;
  /* 0x01f8 */ union _LARGE_INTEGER OtherTransferCount;
  /* 0x0200 */ unsigned long CommitChargeLimit;
  /* 0x0204 */ volatile unsigned long CommitCharge;
  /* 0x0208 */ volatile unsigned long CommitChargePeak;
  /* 0x020c */ long Padding_65[13];
...
typedef struct _ETHREAD
{
  ...
  /* 0x0368 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0370 */ union _LARGE_INTEGER ExitTime;
    /* 0x0370 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0008 */
  /* 0x0378 */ void* ChargeOnlySession;
  union
  {
    /* 0x037c */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x037c */ void* ForwardLinkShadow;
      /* 0x0380 */ void* StartAddress;
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
  union
  {
    /* 0x0384 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0384 */ struct _ETHREAD* ReaperLink;
    /* 0x0384 */ void* KeyedWaitValue;
  }; /* size: 0x0004 */
  /* 0x0388 */ unsigned long ActiveTimerListLock;
  /* 0x038c */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0394 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x039c */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x039c */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0014 */
  /* 0x03b0 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x03b4 */ struct _LIST_ENTRY IrpList;
  /* 0x03bc */ unsigned long TopLevelIrp;
  /* 0x03c0 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x03c4 */ void* Win32StartAddress;
  /* 0x03c8 */ void* LegacyPowerObject;
  /* 0x03cc */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x03d4 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x03d8 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x03dc */ unsigned long ReadClusterSize;
  /* 0x03e0 */ volatile long MmLockOrdering;
  union
  {
    /* 0x03e4 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x03e4 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x03e4 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x03e4 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x03e4 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x03e4 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x03e4 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x03e4 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x03e4 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x03e4 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x03e4 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x03e4 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x03e4 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x03e4 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x03e4 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x03e4 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x03e4 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x03e4 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x03e4 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x03e4 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x03e4 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x03e4 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03e8 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x03e8 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x03e8 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x03e8 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x03e8 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x03e8 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x03e8 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x03e8 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x03e8 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x03e8 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x03e8 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x03e8 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x03e8 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03ec */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x03ec */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x03ec */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x03ec */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x03ec */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x03ec */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x03ec */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x03ec */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x03ec */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x03ed */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x03ed */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x03ed */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x03ed */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x03ed */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x03f0 */ unsigned char CacheManagerActive;
  /* 0x03f1 */ unsigned char DisablePageFaultClustering;
  /* 0x03f2 */ unsigned char ActiveFaultCount;
  /* 0x03f3 */ unsigned char LockOrderState;
  /* 0x03f4 */ unsigned long AlpcMessageId;
  union
  {
    /* 0x03f8 */ void* AlpcMessage;
    /* 0x03f8 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0004 */
  /* 0x03fc */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x0404 */ long ExitStatus;
  /* 0x0408 */ unsigned long CacheManagerCount;
  /* 0x040c */ unsigned long IoBoostCount;
  /* 0x0410 */ unsigned long IoQoSBoostCount;
  /* 0x0414 */ unsigned long IoQoSThrottleCount;
  /* 0x0418 */ unsigned long KernelStackReference;
  /* 0x041c */ struct _LIST_ENTRY BoostList;
  /* 0x0424 */ struct _LIST_ENTRY DeboostList;
  /* 0x042c */ unsigned long BoostListLock;
  /* 0x0430 */ unsigned long IrpListLock;
  /* 0x0434 */ void* ReservedForSynchTracking;
  /* 0x0438 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x043c */ const struct _GUID* ActivityId;
  /* 0x0440 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0444 */ void* VerifierContext;
  /* 0x0448 */ void* AdjustedClientToken;
  /* 0x044c */ void* WorkOnBehalfThread;
  /* 0x0450 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x045c */ void* PicoContext;
  /* 0x0460 */ unsigned long UserFsBase;
  /* 0x0464 */ unsigned long UserGsBase;
  /* 0x0468 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x046c */ void* CmDbgInfo;
  union
  {
    /* 0x0470 */ unsigned long SelectedCpuSets;
    /* 0x0470 */ unsigned long* SelectedCpuSetsIndirect;
  }; /* size: 0x0004 */
  /* 0x0474 */ struct _EJOB* Silo;
  /* 0x0478 */ struct _UNICODE_STRING* ThreadName;
  /* 0x047c */ unsigned long LastExpectedRunTime;
  /* 0x0480 */ unsigned long HeapData;
  /* 0x0484 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x048c */ unsigned long DisownedOwnerEntryListLock;
  /* 0x0490 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
...
typedef struct _EJOB
{
  ...
  /* 0x038c */ unsigned long SiloHardReferenceCount;
