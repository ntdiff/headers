...
typedef struct _KNODE
{
  ...
  /* 0x00a8 */ long Padding_14[22];
  /* 0x0100 */ unsigned long SiblingMask;
  /* 0x0104 */ long Padding_15;
  union
  {
...
typedef struct _PEB
{
  ...
  /* 0x0340 */ unsigned long SpareUlongs[4];
  union
  {
    /* 0x0350 */ unsigned long Win32Flags;
    struct /* bitfield */
    {
      /* 0x0350 */ unsigned long IsPosixDeleteDisabled : 1; /* bit position: 0 */
      /* 0x0350 */ unsigned long ReservedWin32Flags : 31; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0354 */ long Padding_42;
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_50[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_51[2];
...
typedef struct _KPRCB
{
  ...
  /* 0x0b10 */ unsigned long LastTimerHand;
  /* 0x0b14 */ unsigned long LastTick;
  /* 0x0b18 */ unsigned long ClockInterrupts;
  /* 0x0b1c */ unsigned long ReadyScanTick;
  /* 0x0b20 */ union _KPRCBFLAG PrcbFlags;
  /* 0x0b24 */ long Padding_82;
  /* 0x0b28 */ unsigned __int64 TrappedSecurityDomain;
  /* 0x0b30 */ unsigned long InterruptLastCount;
  /* 0x0b34 */ unsigned long InterruptRate;
  /* 0x0b38 */ long Padding_83[18];
  ...
  /* 0x0be6 */ char Padding_84[2];
  /* 0x0be8 */ long DpcWatchdogPeriod;
  /* 0x0bec */ long DpcWatchdogCount;
  /* 0x0bf0 */ volatile long KeSpinLockOrdering;
  /* 0x0bf4 */ long Padding_85[3];
  ...
  /* 0x0f58 */ unsigned __int64 TaggedCycles[2];
  /* 0x0f68 */ unsigned __int64 GenerationTarget;
  /* 0x0f70 */ struct _KENTROPY_TIMING_STATE EntropyTimingState;
  /* 0x10c0 */ volatile long MmSpinLockOrdering;
  /* 0x10c4 */ long Padding_88;
  ...
  /* 0x11f4 */ long Padding_90[3];
  /* 0x1200 */ struct _PROCESSOR_POWER_STATE PowerState;
  /* 0x13e0 */ struct _KDPC ForceIdleDpc;
  /* 0x1420 */ unsigned long DeviceInterrupts;
  /* 0x1424 */ long Padding_91;
  /* 0x1428 */ void* IsrDpcStats;
  /* 0x1430 */ unsigned long KeAlignmentFixupCount;
  /* 0x1434 */ long Padding_92;
  /* 0x1438 */ struct _KDPC DpcWatchdogDpc;
  /* 0x1478 */ struct _KTIMER DpcWatchdogTimer;
  /* 0x14b8 */ long Padding_93[2];
  /* 0x14c0 */ union _SLIST_HEADER InterruptObjectPool;
  /* 0x14d0 */ struct _KAFFINITY_EX PackageProcessorSet;
  /* 0x1578 */ unsigned long PackageId;
  /* 0x157c */ long Padding_94;
  /* 0x1580 */ unsigned __int64 SharedReadyQueueMask;
  /* 0x1588 */ struct _KSHARED_READY_QUEUE* SharedReadyQueue;
  /* 0x1590 */ unsigned long SharedQueueScanOwner;
  /* 0x1594 */ unsigned long ScanSiblingIndex;
  /* 0x1598 */ unsigned __int64 CoreProcessorSet;
  /* 0x15a0 */ unsigned __int64 ScanSiblingMask;
  /* 0x15a8 */ unsigned __int64 LLCMask;
  /* 0x15b0 */ unsigned __int64 CacheProcessorMask[5];
  /* 0x15d8 */ struct _CACHE_DESCRIPTOR Cache[6];
  /* 0x1620 */ unsigned char CacheCount;
  /* 0x1621 */ unsigned char PrcbPad20[3];
  /* 0x1624 */ volatile unsigned long CachedCommit;
  /* 0x1628 */ volatile unsigned long CachedResidentAvailable;
  /* 0x162c */ long Padding_95;
  /* 0x1630 */ void* HyperPte;
  /* 0x1638 */ void* MmInternal;
  /* 0x1640 */ unsigned __int64 PcbPad21[6];
  /* 0x1670 */ void* WheaInfo;
  /* 0x1678 */ void* EtwSupport;
  /* 0x1680 */ union _SLIST_HEADER HypercallPageList;
  /* 0x1690 */ void* HypercallCachedPages;
  /* 0x1698 */ void* VirtualApicAssist;
  /* 0x16a0 */ unsigned __int64* StatisticsPage;
  /* 0x16a8 */ long Padding_96[22];
  /* 0x1700 */ struct _SYNCH_COUNTERS SynchCounters;
  /* 0x17b8 */ unsigned __int64 PteBitCache;
  /* 0x17c0 */ unsigned long PteBitOffset;
  /* 0x17c4 */ long Padding_97;
  /* 0x17c8 */ struct _FILESYSTEM_DISK_COUNTERS FsCounters;
  /* 0x17d8 */ unsigned __int64 PanicStackBase;
  /* 0x17e0 */ void* IsrStack;
  /* 0x17e8 */ long Padding_98[6];
  /* 0x1800 */ struct _KTIMER_TABLE TimerTable;
  /* 0x3a00 */ struct _GENERAL_LOOKASIDE_POOL PPNxPagedLookasideList[32];
  /* 0x4600 */ struct _GENERAL_LOOKASIDE_POOL PPNPagedLookasideList[32];
  /* 0x5200 */ struct _GENERAL_LOOKASIDE_POOL PPPagedLookasideList[32];
  /* 0x5e00 */ struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;
  /* 0x5e08 */ struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;
  /* 0x5e10 */ struct _KDPC AbDpc;
  /* 0x5e50 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;
  /* 0x5ea4 */ struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;
  /* 0x5ef8 */ long Padding_99[2];
  /* 0x5f00 */ struct _KSHARED_READY_QUEUE LocalSharedReadyQueue;
  /* 0x6170 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x6270 */ unsigned long TimerExpirationTraceCount;
  /* 0x6274 */ long Padding_100;
  /* 0x6278 */ void* ExSaPageArray;
  /* 0x6280 */ volatile long FreezePowerOff;
  /* 0x6284 */ long Padding_101;
  /* 0x6288 */ unsigned __int64 LastNonHrTimerExpiration;
  /* 0x6290 */ struct _KSECURE_FAULT_INFORMATION SecureFault;
  /* 0x62a0 */ unsigned __int64 ImportantCycles;
  /* 0x62a8 */ unsigned __int64 UnimportantCycles;
  /* 0x62b0 */ unsigned long ReadyThreadCount;
  /* 0x62b4 */ long Padding_102;
  /* 0x62b8 */ unsigned __int64 ReadyQueueExpectedRunTime;
  /* 0x62c0 */ unsigned long DpcWatchdogProfileCumulativeDpcThreshold;
  /* 0x62c4 */ unsigned long DpcWatchdogProfileSingleDpcThreshold;
  /* 0x62c8 */ void** DpcWatchdogProfile;
  /* 0x62d0 */ void** DpcWatchdogProfileCurrentEmptyCapture;
  /* 0x62d8 */ void* SchedulerAssist;
  /* 0x62e0 */ struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
  /* 0x6340 */ long Padding_103[16];
  /* 0x6380 */ struct _REQUEST_MAILBOX RequestMailbox[1];
  /* 0x63c0 */ long __PADDING__[16];
} KPRCB, *PKPRCB; /* size: 0x6400 */
...
typedef struct _KPCR
{
  ...
  /* 0x0088 */ void* HalReserved[15];
  /* 0x0100 */ void* Idt[256];
  /* 0x0900 */ void** IdtExt;
  /* 0x0908 */ void* PcrAlign[15];
  /* 0x0980 */ struct _KPRCB Prcb;
} KPCR, *PKPCR; /* size: 0x6d80 */
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x006c */ unsigned long CetShadowStack : 1; /* bit position: 20 */
  ...
  union
  {
    struct /* bitfield */
    {
      /* 0x0070 */ unsigned long BamQosLevel : 2; /* bit position: 0 */
      ...
      /* 0x0070 */ unsigned long ThreadFlagsSpare : 1; /* bit position: 23 */
  ...
  /* 0x0340 */ struct _KLOCK_ENTRY LockEntries[6];
  /* 0x0580 */ struct _SINGLE_LIST_ENTRY PropagateBoostsEntry;
  /* 0x0588 */ struct _SINGLE_LIST_ENTRY IoSelfBoostsEntry;
  /* 0x0590 */ unsigned char PriorityFloorCounts[16];
  /* 0x05a0 */ unsigned long PriorityFloorSummary;
  /* 0x05a4 */ volatile long AbCompletedIoBoostCount;
  /* 0x05a8 */ volatile long AbCompletedIoQoSBoostCount;
  /* 0x05ac */ volatile short KeReferenceCount;
  /* 0x05ae */ unsigned char AbOrphanedEntrySummary;
  /* 0x05af */ unsigned char AbOwnedEntryCount;
  /* 0x05b0 */ unsigned long ForegroundLossTime;
  /* 0x05b4 */ long Padding_111;
  union
  {
    /* 0x05b8 */ struct _LIST_ENTRY GlobalForegroundListEntry;
    struct
    {
      /* 0x05b8 */ struct _SINGLE_LIST_ENTRY ForegroundDpcStackListEntry;
      /* 0x05c0 */ unsigned __int64 InGlobalForegroundList;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  /* 0x05c8 */ __int64 ReadOperationCount;
  /* 0x05d0 */ __int64 WriteOperationCount;
  /* 0x05d8 */ __int64 OtherOperationCount;
  /* 0x05e0 */ __int64 ReadTransferCount;
  /* 0x05e8 */ __int64 WriteTransferCount;
  /* 0x05f0 */ __int64 OtherTransferCount;
  /* 0x05f8 */ struct _KSCB* QueuedScb;
  /* 0x0600 */ volatile unsigned long ThreadTimerDelay;
  union
  {
    /* 0x0604 */ volatile long ThreadFlags2;
    struct /* bitfield */
    {
      /* 0x0604 */ unsigned long PpmPolicy : 2; /* bit position: 0 */
      /* 0x0604 */ unsigned long ThreadFlags2Reserved : 30; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0608 */ unsigned __int64 TracingPrivate[1];
  /* 0x0610 */ void* SchedulerAssist;
  /* 0x0618 */ void* volatile AbWaitObject;
} KTHREAD, *PKTHREAD; /* size: 0x0620 */
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x01c0 */ unsigned long VaSpaceDeleted : 1; /* bit position: 10 */
      /* 0x01c0 */ unsigned long ReservedFlags : 21; /* bit position: 11 */
    }; /* bitfield */
    /* 0x01c0 */ volatile long ProcessFlags;
  }; /* size: 0x0004 */
  /* 0x01c4 */ unsigned long ActiveGroupsMask;
  /* 0x01c8 */ char BasePriority;
  /* 0x01c9 */ char QuantumReset;
  /* 0x01ca */ char Visited;
  /* 0x01cb */ union _KEXECUTE_OPTIONS Flags;
  /* 0x01cc */ unsigned long ThreadSeed[20];
  /* 0x021c */ unsigned short IdealNode[20];
  /* 0x0244 */ unsigned short IdealGlobalNode;
  /* 0x0246 */ char Padding_114[2];
  /* 0x0248 */ volatile union _KSTACK_COUNT StackCount;
  /* 0x024c */ long Padding_115;
  /* 0x0250 */ struct _LIST_ENTRY ProcessListEntry;
  /* 0x0260 */ unsigned __int64 CycleTime;
  /* 0x0268 */ unsigned __int64 ContextSwitches;
  /* 0x0270 */ struct _KSCHEDULING_GROUP* SchedulingGroup;
  /* 0x0278 */ unsigned long FreezeCount;
  /* 0x027c */ unsigned long KernelTime;
  /* 0x0280 */ unsigned long UserTime;
  /* 0x0284 */ unsigned long ReadyTime;
  /* 0x0288 */ void* InstrumentationCallback;
  union
  {
    union
    {
      /* 0x0290 */ unsigned __int64 SecureHandle;
      struct
      {
        struct /* bitfield */
        {
          /* 0x0290 */ unsigned __int64 SecureProcess : 1; /* bit position: 0 */
          /* 0x0290 */ unsigned __int64 Unused : 1; /* bit position: 1 */
        }; /* bitfield */
      } /* size: 0x0008 */ Flags;
    }; /* size: 0x0008 */
  } /* size: 0x0008 */ SecureState;
} KPROCESS, *PKPROCESS; /* size: 0x0298 */
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x02a0 */ unsigned long PerfChangeIntervalCount;
  /* 0x02a4 */ unsigned char Force;
  /* 0x02a5 */ unsigned char Update;
  /* 0x02a6 */ unsigned char Apply;
  /* 0x02a7 */ char __PADDING__[1];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x02a8 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x0298 */ struct _EX_PUSH_LOCK ProcessLock;
  /* 0x02a0 */ void* UniqueProcessId;
  /* 0x02a8 */ struct _LIST_ENTRY ActiveProcessLinks;
  /* 0x02b8 */ struct _EX_RUNDOWN_REF RundownProtect;
  union
  {
    /* 0x02c0 */ unsigned long Flags2;
    struct /* bitfield */
    {
      /* 0x02c0 */ unsigned long JobNotReallyActive : 1; /* bit position: 0 */
      /* 0x02c0 */ unsigned long AccountingFolded : 1; /* bit position: 1 */
      /* 0x02c0 */ unsigned long NewProcessReported : 1; /* bit position: 2 */
      /* 0x02c0 */ unsigned long ExitProcessReported : 1; /* bit position: 3 */
      /* 0x02c0 */ unsigned long ReportCommitChanges : 1; /* bit position: 4 */
      /* 0x02c0 */ unsigned long LastReportMemory : 1; /* bit position: 5 */
      /* 0x02c0 */ unsigned long ForceWakeCharge : 1; /* bit position: 6 */
      /* 0x02c0 */ unsigned long CrossSessionCreate : 1; /* bit position: 7 */
      /* 0x02c0 */ unsigned long NeedsHandleRundown : 1; /* bit position: 8 */
      /* 0x02c0 */ unsigned long RefTraceEnabled : 1; /* bit position: 9 */
      /* 0x02c0 */ unsigned long PicoCreated : 1; /* bit position: 10 */
      /* 0x02c0 */ unsigned long EmptyJobEvaluated : 1; /* bit position: 11 */
      /* 0x02c0 */ unsigned long DefaultPagePriority : 3; /* bit position: 12 */
      /* 0x02c0 */ unsigned long PrimaryTokenFrozen : 1; /* bit position: 15 */
      /* 0x02c0 */ unsigned long ProcessVerifierTarget : 1; /* bit position: 16 */
      /* 0x02c0 */ unsigned long RestrictSetThreadContext : 1; /* bit position: 17 */
      /* 0x02c0 */ unsigned long AffinityPermanent : 1; /* bit position: 18 */
      /* 0x02c0 */ unsigned long AffinityUpdateEnable : 1; /* bit position: 19 */
      /* 0x02c0 */ unsigned long PropagateNode : 1; /* bit position: 20 */
      /* 0x02c0 */ unsigned long ExplicitAffinity : 1; /* bit position: 21 */
      /* 0x02c0 */ unsigned long ProcessExecutionState : 2; /* bit position: 22 */
      /* 0x02c0 */ unsigned long EnableReadVmLogging : 1; /* bit position: 24 */
      /* 0x02c0 */ unsigned long EnableWriteVmLogging : 1; /* bit position: 25 */
      /* 0x02c0 */ unsigned long FatalAccessTerminationRequested : 1; /* bit position: 26 */
      /* 0x02c0 */ unsigned long DisableSystemAllowedCpuSet : 1; /* bit position: 27 */
      /* 0x02c0 */ unsigned long ProcessStateChangeRequest : 2; /* bit position: 28 */
      /* 0x02c0 */ unsigned long ProcessStateChangeInProgress : 1; /* bit position: 30 */
      /* 0x02c0 */ unsigned long InPrivate : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x02c4 */ unsigned long Flags;
    struct /* bitfield */
    {
      /* 0x02c4 */ unsigned long CreateReported : 1; /* bit position: 0 */
      /* 0x02c4 */ unsigned long NoDebugInherit : 1; /* bit position: 1 */
      /* 0x02c4 */ unsigned long ProcessExiting : 1; /* bit position: 2 */
      /* 0x02c4 */ unsigned long ProcessDelete : 1; /* bit position: 3 */
      /* 0x02c4 */ unsigned long ManageExecutableMemoryWrites : 1; /* bit position: 4 */
      /* 0x02c4 */ unsigned long VmDeleted : 1; /* bit position: 5 */
      /* 0x02c4 */ unsigned long OutswapEnabled : 1; /* bit position: 6 */
      /* 0x02c4 */ unsigned long Outswapped : 1; /* bit position: 7 */
      /* 0x02c4 */ unsigned long FailFastOnCommitFail : 1; /* bit position: 8 */
      /* 0x02c4 */ unsigned long Wow64VaSpace4Gb : 1; /* bit position: 9 */
      /* 0x02c4 */ unsigned long AddressSpaceInitialized : 2; /* bit position: 10 */
      /* 0x02c4 */ unsigned long SetTimerResolution : 1; /* bit position: 12 */
      /* 0x02c4 */ unsigned long BreakOnTermination : 1; /* bit position: 13 */
      /* 0x02c4 */ unsigned long DeprioritizeViews : 1; /* bit position: 14 */
      /* 0x02c4 */ unsigned long WriteWatch : 1; /* bit position: 15 */
      /* 0x02c4 */ unsigned long ProcessInSession : 1; /* bit position: 16 */
      /* 0x02c4 */ unsigned long OverrideAddressSpace : 1; /* bit position: 17 */
      /* 0x02c4 */ unsigned long HasAddressSpace : 1; /* bit position: 18 */
      /* 0x02c4 */ unsigned long LaunchPrefetched : 1; /* bit position: 19 */
      /* 0x02c4 */ unsigned long Background : 1; /* bit position: 20 */
      /* 0x02c4 */ unsigned long VmTopDown : 1; /* bit position: 21 */
      /* 0x02c4 */ unsigned long ImageNotifyDone : 1; /* bit position: 22 */
      /* 0x02c4 */ unsigned long PdeUpdateNeeded : 1; /* bit position: 23 */
      /* 0x02c4 */ unsigned long VdmAllowed : 1; /* bit position: 24 */
      /* 0x02c4 */ unsigned long ProcessRundown : 1; /* bit position: 25 */
      /* 0x02c4 */ unsigned long ProcessInserted : 1; /* bit position: 26 */
      /* 0x02c4 */ unsigned long DefaultIoPriority : 3; /* bit position: 27 */
      /* 0x02c4 */ unsigned long ProcessSelfDelete : 1; /* bit position: 30 */
      /* 0x02c4 */ unsigned long SetTimerResolutionLink : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02c8 */ union _LARGE_INTEGER CreateTime;
  /* 0x02d0 */ unsigned __int64 ProcessQuotaUsage[2];
  /* 0x02e0 */ unsigned __int64 ProcessQuotaPeak[2];
  /* 0x02f0 */ unsigned __int64 PeakVirtualSize;
  /* 0x02f8 */ unsigned __int64 VirtualSize;
  /* 0x0300 */ struct _LIST_ENTRY SessionProcessLinks;
  union
  {
    /* 0x0310 */ void* ExceptionPortData;
    /* 0x0310 */ unsigned __int64 ExceptionPortValue;
    /* 0x0310 */ unsigned __int64 ExceptionPortState : 3; /* bit position: 0 */
  }; /* size: 0x0008 */
  /* 0x0318 */ struct _EX_FAST_REF Token;
  /* 0x0320 */ unsigned __int64 MmReserved;
  /* 0x0328 */ struct _EX_PUSH_LOCK AddressCreationLock;
  /* 0x0330 */ struct _EX_PUSH_LOCK PageTableCommitmentLock;
  /* 0x0338 */ struct _ETHREAD* RotateInProgress;
  /* 0x0340 */ struct _ETHREAD* ForkInProgress;
  /* 0x0348 */ struct _EJOB* volatile CommitChargeJob;
  /* 0x0350 */ struct _RTL_AVL_TREE CloneRoot;
  /* 0x0358 */ volatile unsigned __int64 NumberOfPrivatePages;
  /* 0x0360 */ volatile unsigned __int64 NumberOfLockedPages;
  /* 0x0368 */ void* Win32Process;
  /* 0x0370 */ struct _EJOB* volatile Job;
  /* 0x0378 */ void* SectionObject;
  /* 0x0380 */ void* SectionBaseAddress;
  /* 0x0388 */ unsigned long Cookie;
  /* 0x038c */ long Padding_148;
  /* 0x0390 */ struct _PAGEFAULT_HISTORY* WorkingSetWatch;
  /* 0x0398 */ void* Win32WindowStation;
  /* 0x03a0 */ void* InheritedFromUniqueProcessId;
  /* 0x03a8 */ volatile unsigned __int64 OwnerProcessId;
  /* 0x03b0 */ struct _PEB* Peb;
  /* 0x03b8 */ struct _MM_SESSION_SPACE* Session;
  /* 0x03c0 */ void* Spare1;
  /* 0x03c8 */ struct _EPROCESS_QUOTA_BLOCK* QuotaBlock;
  /* 0x03d0 */ struct _HANDLE_TABLE* ObjectTable;
  /* 0x03d8 */ void* DebugPort;
  /* 0x03e0 */ struct _EWOW64PROCESS* WoW64Process;
  /* 0x03e8 */ void* DeviceMap;
  /* 0x03f0 */ void* EtwDataSource;
  /* 0x03f8 */ unsigned __int64 PageDirectoryPte;
  /* 0x0400 */ struct _FILE_OBJECT* ImageFilePointer;
  /* 0x0408 */ unsigned char ImageFileName[15];
  /* 0x0417 */ unsigned char PriorityClass;
  /* 0x0418 */ void* SecurityPort;
  /* 0x0420 */ struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;
  /* 0x0428 */ struct _LIST_ENTRY JobLinks;
  /* 0x0438 */ void* HighestUserAddress;
  /* 0x0440 */ struct _LIST_ENTRY ThreadListHead;
  /* 0x0450 */ volatile unsigned long ActiveThreads;
  /* 0x0454 */ unsigned long ImagePathHash;
  /* 0x0458 */ unsigned long DefaultHardErrorProcessing;
  /* 0x045c */ long LastThreadExitStatus;
  /* 0x0460 */ struct _EX_FAST_REF PrefetchTrace;
  /* 0x0468 */ void* LockedPagesList;
  /* 0x0470 */ union _LARGE_INTEGER ReadOperationCount;
  /* 0x0478 */ union _LARGE_INTEGER WriteOperationCount;
  /* 0x0480 */ union _LARGE_INTEGER OtherOperationCount;
  /* 0x0488 */ union _LARGE_INTEGER ReadTransferCount;
  /* 0x0490 */ union _LARGE_INTEGER WriteTransferCount;
  /* 0x0498 */ union _LARGE_INTEGER OtherTransferCount;
  /* 0x04a0 */ unsigned __int64 CommitChargeLimit;
  /* 0x04a8 */ volatile unsigned __int64 CommitCharge;
  /* 0x04b0 */ volatile unsigned __int64 CommitChargePeak;
  /* 0x04b8 */ long Padding_149[18];
  /* 0x0500 */ struct _MMSUPPORT_FULL Vm;
  /* 0x0700 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0710 */ unsigned long ModifiedPageCount;
  /* 0x0714 */ long ExitStatus;
  /* 0x0718 */ struct _RTL_AVL_TREE VadRoot;
  /* 0x0720 */ void* VadHint;
  /* 0x0728 */ unsigned __int64 VadCount;
  /* 0x0730 */ volatile unsigned __int64 VadPhysicalPages;
  /* 0x0738 */ unsigned __int64 VadPhysicalPagesLimit;
  /* 0x0740 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x0760 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x0770 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x0778 */ unsigned long RequestedTimerResolution;
  /* 0x077c */ unsigned long SmallestTimerResolution;
  /* 0x0780 */ union _LARGE_INTEGER ExitTime;
  /* 0x0788 */ struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
  /* 0x0790 */ struct _EX_PUSH_LOCK InvertedFunctionTableLock;
  /* 0x0798 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x079c */ unsigned long LargePrivateVadCount;
  /* 0x07a0 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x07a8 */ void* WnfContext;
  /* 0x07b0 */ struct _EJOB* ServerSilo;
  /* 0x07b8 */ unsigned char SignatureLevel;
  /* 0x07b9 */ unsigned char SectionSignatureLevel;
  /* 0x07ba */ struct _PS_PROTECTION Protection;
  struct /* bitfield */
  {
    /* 0x07bb */ unsigned char HangCount : 3; /* bit position: 0 */
    /* 0x07bb */ unsigned char GhostCount : 3; /* bit position: 3 */
    /* 0x07bb */ unsigned char PrefilterException : 1; /* bit position: 6 */
  }; /* bitfield */
  union
  {
    /* 0x07bc */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x07bc */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x07bc */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x07bc */ unsigned long Crashed : 1; /* bit position: 2 */
      /* 0x07bc */ unsigned long JobVadsAreTracked : 1; /* bit position: 3 */
      /* 0x07bc */ unsigned long VadTrackingDisabled : 1; /* bit position: 4 */
      /* 0x07bc */ unsigned long AuxiliaryProcess : 1; /* bit position: 5 */
      /* 0x07bc */ unsigned long SubsystemProcess : 1; /* bit position: 6 */
      /* 0x07bc */ unsigned long IndirectCpuSets : 1; /* bit position: 7 */
      /* 0x07bc */ unsigned long RelinquishedCommit : 1; /* bit position: 8 */
      /* 0x07bc */ unsigned long HighGraphicsPriority : 1; /* bit position: 9 */
      /* 0x07bc */ unsigned long CommitFailLogged : 1; /* bit position: 10 */
      /* 0x07bc */ unsigned long ReserveFailLogged : 1; /* bit position: 11 */
      /* 0x07bc */ unsigned long SystemProcess : 1; /* bit position: 12 */
      /* 0x07bc */ unsigned long HideImageBaseAddresses : 1; /* bit position: 13 */
      /* 0x07bc */ unsigned long AddressPolicyFrozen : 1; /* bit position: 14 */
      /* 0x07bc */ unsigned long ProcessFirstResume : 1; /* bit position: 15 */
      /* 0x07bc */ unsigned long ForegroundExternal : 1; /* bit position: 16 */
      /* 0x07bc */ unsigned long ForegroundSystem : 1; /* bit position: 17 */
      /* 0x07bc */ unsigned long HighMemoryPriority : 1; /* bit position: 18 */
      /* 0x07bc */ unsigned long EnableProcessSuspendResumeLogging : 1; /* bit position: 19 */
      /* 0x07bc */ unsigned long EnableThreadSuspendResumeLogging : 1; /* bit position: 20 */
      /* 0x07bc */ unsigned long SecurityDomainChanged : 1; /* bit position: 21 */
      /* 0x07bc */ unsigned long SecurityFreezeComplete : 1; /* bit position: 22 */
      /* 0x07bc */ unsigned long VmProcessorHost : 1; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x07c0 */ long DeviceAsid;
  /* 0x07c4 */ long Padding_150;
  /* 0x07c8 */ void* SvmData;
  /* 0x07d0 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x07d8 */ unsigned __int64 SvmLock;
  /* 0x07e0 */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x07f0 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x07f8 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x0800 */ void* PicoContext;
  /* 0x0808 */ void* EnclaveTable;
  /* 0x0810 */ unsigned __int64 EnclaveNumber;
  /* 0x0818 */ struct _EX_PUSH_LOCK EnclaveLock;
  /* 0x0820 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x0824 */ long Padding_151;
  /* 0x0828 */ struct _PO_PROCESS_ENERGY_CONTEXT* EnergyContext;
  /* 0x0830 */ void* VmContext;
  /* 0x0838 */ unsigned __int64 SequenceNumber;
  /* 0x0840 */ unsigned __int64 CreateInterruptTime;
  /* 0x0848 */ unsigned __int64 CreateUnbiasedInterruptTime;
  /* 0x0850 */ unsigned __int64 TotalUnbiasedFrozenTime;
  /* 0x0858 */ unsigned __int64 LastAppStateUpdateTime;
  struct /* bitfield */
  {
    /* 0x0860 */ unsigned __int64 LastAppStateUptime : 61; /* bit position: 0 */
    /* 0x0860 */ unsigned __int64 LastAppState : 3; /* bit position: 61 */
  }; /* bitfield */
  /* 0x0868 */ volatile unsigned __int64 SharedCommitCharge;
  /* 0x0870 */ struct _EX_PUSH_LOCK SharedCommitLock;
  /* 0x0878 */ struct _LIST_ENTRY SharedCommitLinks;
  union
  {
    struct
    {
      /* 0x0888 */ unsigned __int64 AllowedCpuSets;
      /* 0x0890 */ unsigned __int64 DefaultCpuSets;
    }; /* size: 0x0010 */
    struct
    {
      /* 0x0888 */ unsigned __int64* AllowedCpuSetsIndirect;
      /* 0x0890 */ unsigned __int64* DefaultCpuSetsIndirect;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  /* 0x0898 */ void* DiskIoAttribution;
  /* 0x08a0 */ void* DxgProcess;
  /* 0x08a8 */ unsigned long Win32KFilterSet;
  /* 0x08ac */ long Padding_152;
  /* 0x08b0 */ volatile union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;
  /* 0x08b8 */ volatile unsigned long KTimerSets;
  /* 0x08bc */ volatile unsigned long KTimer2Sets;
  /* 0x08c0 */ volatile unsigned long ThreadTimerSets;
  /* 0x08c4 */ long Padding_153;
  /* 0x08c8 */ unsigned __int64 VirtualTimerListLock;
  /* 0x08d0 */ struct _LIST_ENTRY VirtualTimerListHead;
  union
  {
    /* 0x08e0 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x08e0 */ struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0030 */
  union
  {
    /* 0x0910 */ unsigned long MitigationFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x0910 */ unsigned long ControlFlowGuardEnabled : 1; /* bit position: 0 */
        /* 0x0910 */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 1 */
        /* 0x0910 */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 2 */
        /* 0x0910 */ unsigned long DisallowStrippedImages : 1; /* bit position: 3 */
        /* 0x0910 */ unsigned long ForceRelocateImages : 1; /* bit position: 4 */
        /* 0x0910 */ unsigned long HighEntropyASLREnabled : 1; /* bit position: 5 */
        /* 0x0910 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 6 */
        /* 0x0910 */ unsigned long ExtensionPointDisable : 1; /* bit position: 7 */
        /* 0x0910 */ unsigned long DisableDynamicCode : 1; /* bit position: 8 */
        /* 0x0910 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 9 */
        /* 0x0910 */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 10 */
        /* 0x0910 */ unsigned long AuditDisableDynamicCode : 1; /* bit position: 11 */
        /* 0x0910 */ unsigned long DisallowWin32kSystemCalls : 1; /* bit position: 12 */
        /* 0x0910 */ unsigned long AuditDisallowWin32kSystemCalls : 1; /* bit position: 13 */
        /* 0x0910 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 14 */
        /* 0x0910 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 15 */
        /* 0x0910 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 16 */
        /* 0x0910 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 17 */
        /* 0x0910 */ unsigned long PreferSystem32Images : 1; /* bit position: 18 */
        /* 0x0910 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 19 */
        /* 0x0910 */ unsigned long AuditProhibitRemoteImageMap : 1; /* bit position: 20 */
        /* 0x0910 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 21 */
        /* 0x0910 */ unsigned long AuditProhibitLowILImageMap : 1; /* bit position: 22 */
        /* 0x0910 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 23 */
        /* 0x0910 */ unsigned long AuditBlockNonMicrosoftBinaries : 1; /* bit position: 24 */
        /* 0x0910 */ unsigned long AuditBlockNonMicrosoftBinariesAllowStore : 1; /* bit position: 25 */
        /* 0x0910 */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 26 */
        /* 0x0910 */ unsigned long AuditLoaderIntegrityContinuity : 1; /* bit position: 27 */
        /* 0x0910 */ unsigned long EnableModuleTamperingProtection : 1; /* bit position: 28 */
        /* 0x0910 */ unsigned long EnableModuleTamperingProtectionNoInherit : 1; /* bit position: 29 */
        /* 0x0910 */ unsigned long RestrictIndirectBranchPrediction : 1; /* bit position: 30 */
        /* 0x0910 */ unsigned long IsolateSecurityDomain : 1; /* bit position: 31 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlagsValues;
  }; /* size: 0x0004 */
  union
  {
    /* 0x0914 */ unsigned long MitigationFlags2;
    struct
    {
      struct /* bitfield */
      {
        /* 0x0914 */ unsigned long EnableExportAddressFilter : 1; /* bit position: 0 */
        /* 0x0914 */ unsigned long AuditExportAddressFilter : 1; /* bit position: 1 */
        /* 0x0914 */ unsigned long EnableExportAddressFilterPlus : 1; /* bit position: 2 */
        /* 0x0914 */ unsigned long AuditExportAddressFilterPlus : 1; /* bit position: 3 */
        /* 0x0914 */ unsigned long EnableRopStackPivot : 1; /* bit position: 4 */
        /* 0x0914 */ unsigned long AuditRopStackPivot : 1; /* bit position: 5 */
        /* 0x0914 */ unsigned long EnableRopCallerCheck : 1; /* bit position: 6 */
        /* 0x0914 */ unsigned long AuditRopCallerCheck : 1; /* bit position: 7 */
        /* 0x0914 */ unsigned long EnableRopSimExec : 1; /* bit position: 8 */
        /* 0x0914 */ unsigned long AuditRopSimExec : 1; /* bit position: 9 */
        /* 0x0914 */ unsigned long EnableImportAddressFilter : 1; /* bit position: 10 */
        /* 0x0914 */ unsigned long AuditImportAddressFilter : 1; /* bit position: 11 */
        /* 0x0914 */ unsigned long DisablePageCombine : 1; /* bit position: 12 */
        /* 0x0914 */ unsigned long SpeculativeStoreBypassDisable : 1; /* bit position: 13 */
        /* 0x0914 */ unsigned long CetShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x0918 */ void* PartitionObject;
  /* 0x0920 */ unsigned __int64 SecurityDomain;
  /* 0x0928 */ unsigned __int64 ParentSecurityDomain;
  /* 0x0930 */ void* CoverageSamplerContext;
  /* 0x0938 */ void* MmHotPatchContext;
  /* 0x0940 */ long __PADDING__[16];
} EPROCESS, *PEPROCESS; /* size: 0x0980 */
...
typedef struct _ETHREAD
{
  ...
  /* 0x0620 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0628 */ union _LARGE_INTEGER ExitTime;
    /* 0x0628 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  union
  {
    /* 0x0638 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0638 */ void* ForwardLinkShadow;
      /* 0x0640 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x0648 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0648 */ struct _ETHREAD* ReaperLink;
    /* 0x0648 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x0650 */ unsigned __int64 ActiveTimerListLock;
  /* 0x0658 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0668 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0678 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0678 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x0698 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x06a0 */ struct _LIST_ENTRY IrpList;
  /* 0x06b0 */ unsigned __int64 TopLevelIrp;
  /* 0x06b8 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x06c0 */ void* Win32StartAddress;
  /* 0x06c8 */ void* ChargeOnlySession;
  /* 0x06d0 */ void* LegacyPowerObject;
  /* 0x06d8 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06e8 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x06f0 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x06f8 */ unsigned long ReadClusterSize;
  /* 0x06fc */ volatile long MmLockOrdering;
  union
  {
    /* 0x0700 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x0700 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x0700 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x0700 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x0700 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x0700 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x0700 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x0700 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x0700 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x0700 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x0700 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x0700 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x0700 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x0700 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x0700 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x0700 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x0700 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x0700 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x0700 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x0700 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x0700 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x0700 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0704 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x0704 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x0704 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x0704 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x0704 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x0704 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x0704 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x0704 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x0704 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x0704 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x0704 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x0704 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x0704 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0708 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x0708 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x0708 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x0708 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x0708 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x0708 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x0708 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x0708 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x0708 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x0709 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x0709 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x0709 */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x0709 */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x0709 */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x070c */ unsigned char CacheManagerActive;
  /* 0x070d */ unsigned char DisablePageFaultClustering;
  /* 0x070e */ unsigned char ActiveFaultCount;
  /* 0x070f */ unsigned char LockOrderState;
  /* 0x0710 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x0718 */ void* AlpcMessage;
    /* 0x0718 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x0720 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x0730 */ long ExitStatus;
  /* 0x0734 */ unsigned long CacheManagerCount;
  /* 0x0738 */ unsigned long IoBoostCount;
  /* 0x073c */ unsigned long IoQoSBoostCount;
  /* 0x0740 */ unsigned long IoQoSThrottleCount;
  /* 0x0744 */ unsigned long KernelStackReference;
  /* 0x0748 */ struct _LIST_ENTRY BoostList;
  /* 0x0758 */ struct _LIST_ENTRY DeboostList;
  /* 0x0768 */ unsigned __int64 BoostListLock;
  /* 0x0770 */ unsigned __int64 IrpListLock;
  /* 0x0778 */ void* ReservedForSynchTracking;
  /* 0x0780 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0788 */ const struct _GUID* ActivityId;
  /* 0x0790 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0798 */ void* VerifierContext;
  /* 0x07a0 */ void* AdjustedClientToken;
  /* 0x07a8 */ void* WorkOnBehalfThread;
  /* 0x07b0 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x07c8 */ void* PicoContext;
  /* 0x07d0 */ unsigned __int64 UserRoBase;
  /* 0x07d8 */ unsigned __int64 UserRwBase;
  /* 0x07e0 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x07e8 */ void* CmDbgInfo;
  union
  {
    /* 0x07f0 */ unsigned __int64 SelectedCpuSets;
    /* 0x07f0 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x07f8 */ struct _EJOB* Silo;
  /* 0x0800 */ struct _UNICODE_STRING* ThreadName;
  /* 0x0808 */ unsigned long LastExpectedRunTime;
  /* 0x080c */ unsigned long HeapData;
  /* 0x0810 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x0820 */ unsigned __int64 DisownedOwnerEntryListLock;
  /* 0x0828 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
} ETHREAD, *PETHREAD; /* size: 0x0838 */
  ...
  union
  {
    union
    {
      ...
      struct
      {
        /* 0x0008 */ struct _IO_SECURITY_CONTEXT* SecurityContext;
        /* 0x0010 */ unsigned long Options;
        /* 0x000c */ long Padding_166;
        /* 0x0018 */ unsigned short Reserved;
        /* 0x001a */ unsigned short ShareAccess;
        /* 0x0014 */ long Padding_167;
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0419 */ char Padding_219[7];
  /* 0x0420 */ struct _UNICODE_STRING NtSystemRoot;
  /* 0x0430 */ struct _UNICODE_STRING SiloRootDirectoryName;
  /* 0x0440 */ struct _PSP_STORAGE* Storage;
  /* 0x0448 */ enum _SERVERSILO_STATE State;
  /* 0x044c */ long ExitStatus;
  /* 0x0450 */ struct _KEVENT* DeleteEvent;
  /* 0x0458 */ struct _SILO_USER_SHARED_DATA* UserSharedData;
  /* 0x0460 */ void* UserSharedSection;
  /* 0x0468 */ struct _WORK_QUEUE_ITEM TerminateWorkItem;
} ESERVERSILO_GLOBALS, *PESERVERSILO_GLOBALS; /* size: 0x0488 */
...
?RtlpFlsSetValue@@YAJPEAU_RTLP_FLS_CONTEXT@@PEAU_RTLP_FLS_THREAD_CONTEXT@@KPEAX@Z
?SbFilterProcedure_RTL@@YAPEAXPEAX@Z
?SetValue@?$RTL_BINARY_ARRAY@PEAX$07$03@@SAJPEAU1@KPEAXK@Z
