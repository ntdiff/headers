...
typedef struct _MI_PARTITION_CORE
{
  ...
  /* 0x01a0 */ unsigned __int64 TotalHugeIoRanges;
  /* 0x01a8 */ unsigned __int64 NonChargedSecurePages;
} MI_PARTITION_CORE, *PMI_PARTITION_CORE; /* size: 0x01b0 */
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x1160 */ unsigned char RebuildLargePageCandidates;
  /* 0x1161 */ unsigned char RebuildLargePageActive;
  ...
  /* 0x1178 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[4][2];
  /* 0x1538 */ struct _RTL_BITMAP_EX SlabPfnBitMap;
  /* 0x1548 */ void* HugePfnLists;
  /* 0x1550 */ unsigned __int64 AvailableHugeIoRanges;
  /* 0x1558 */ long __PADDING__[10];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x1580 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x01b0 */ struct _MI_PARTITION_MODWRITES Modwriter;
  ...
  /* 0x1e00 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1f00 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1f68 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x20f8 */ void* WorkingSetControl;
  /* 0x2100 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x2110 */ unsigned long SessionDetachTimeStamp;
  /* 0x2180 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x3480 */
