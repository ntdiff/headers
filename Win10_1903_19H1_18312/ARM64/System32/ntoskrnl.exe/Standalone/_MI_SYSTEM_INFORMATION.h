...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x2540 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2600 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2680 */ unsigned __int64 Cookie;
  /* 0x2688 */ void* volatile* BootRegistryRuns;
  /* 0x2690 */ volatile long ZeroingDisabled;
  /* 0x2694 */ unsigned char FullyInitialized;
  /* 0x2695 */ unsigned char SafeBooted;
  /* 0x2698 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x2700 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3880 */
