...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0400 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x0600 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0608 */ unsigned long TopLevelPteLockBits[32];
  /* 0x0688 */ struct _MMPTE PageDirectory;
  /* 0x0690 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x0698 */ struct _RTL_BITMAP_EX DynamicVaBitMap;
  /* 0x06a8 */ unsigned __int64 DynamicVaHint;
  /* 0x06b0 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x06b8 */ long PoolBigEntriesInUse;
  /* 0x06bc */ volatile long PagedPoolPdeCount;
  /* 0x06c0 */ unsigned long DynamicSessionPdeCount;
  /* 0x06c8 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x0728 */ void* PoolTrackTableExpansion;
  /* 0x0730 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x0738 */ void* PoolTrackBigPages;
  /* 0x0740 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x0748 */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x0750 */ enum _IO_SESSION_STATE IoState;
  /* 0x0754 */ unsigned long IoStateSequence;
  /* 0x0758 */ struct _KEVENT IoNotificationEvent;
  /* 0x0770 */ struct _EJOB* ServerSilo;
  /* 0x0778 */ unsigned __int64 CreateTime;
