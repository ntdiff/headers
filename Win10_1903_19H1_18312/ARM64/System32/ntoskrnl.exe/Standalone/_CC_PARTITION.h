...
typedef struct _CC_PARTITION
{
  ...
  /* 0x0160 */ struct _LIST_ENTRY IdleExtraWriteBehindThreadList;
  /* 0x0170 */ unsigned long ActiveExtraWriteBehindThreads;
  /* 0x0174 */ unsigned long MaxExtraWriteBehindThreads;
  /* 0x0178 */ unsigned char QueueThrottle;
  /* 0x017c */ unsigned long PostTickWorkItemCount;
  /* 0x0180 */ unsigned long ThreadsActiveBeforeThrottle;
  /* 0x0184 */ unsigned long ExtraWBThreadsActiveBeforeThrottle;
  /* 0x0188 */ unsigned long ExecutingWriteBehindWorkItems;
  /* 0x018c */ unsigned long ExecutingHighPriorityWorkItem;
  /* 0x0190 */ struct _KEVENT LowMemoryEvent;
  /* 0x01a8 */ struct _KEVENT PowerEvent;
  /* 0x01c0 */ struct _KEVENT PeriodicEvent;
  /* 0x01d8 */ struct _KEVENT WaitingForTeardownEvent;
  /* 0x01f0 */ struct _KEVENT CoalescingFlushEvent;
  /* 0x0208 */ unsigned long PagesYetToWrite;
  /* 0x0210 */ struct _LAZY_WRITER LazyWriter;
  /* 0x0298 */ struct _DIRTY_PAGE_STATISTICS DirtyPageStatistics;
  /* 0x02b0 */ struct _DIRTY_PAGE_THRESHOLDS DirtyPageThresholds;
  /* 0x02e8 */ struct _WRITE_BEHIND_THROUGHPUT* ThroughputStats;
  /* 0x02f0 */ long ThroughputTrend;
  /* 0x02f8 */ unsigned __int64 AverageAvailablePages;
  /* 0x0300 */ unsigned __int64 AverageDirtyPages;
  /* 0x0308 */ unsigned __int64 PagesSkippedDueToHotSpot;
  /* 0x0310 */ union _LARGE_INTEGER PrevRegularQueueItemRunTime;
  /* 0x0318 */ union _LARGE_INTEGER PrevExtraWBThreadCheckTime;
  /* 0x0320 */ unsigned char AddExtraWriteBehindThreads;
  /* 0x0321 */ unsigned char RemoveExtraThreadPending;
  /* 0x0328 */ struct _LIST_ENTRY DeferredWrites;
