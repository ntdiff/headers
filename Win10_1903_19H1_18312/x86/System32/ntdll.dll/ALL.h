...
typedef struct _PEB
{
  ...
  /* 0x021c */ unsigned long SpareUlongs[4];
  union
  {
    /* 0x022c */ unsigned long Win32Flags;
    struct /* bitfield */
    {
      /* 0x022c */ unsigned long IsPosixDeleteDisabled : 1; /* bit position: 0 */
      /* 0x022c */ unsigned long ReservedWin32Flags : 31; /* bit position: 1 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  ...
  union
  {
    ...
    struct // _TAG_UNNAMED_45
    {
      struct /* bitfield */
      {
        ...
        /* 0x0454 */ unsigned long CetShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x0458 */ void* PartitionObject;
  /* 0x045c */ long Padding_70;
...
typedef struct _ETHREAD
{
  ...
  /* 0x0358 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0360 */ union _LARGE_INTEGER ExitTime;
    /* 0x0360 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0008 */
  /* 0x0368 */ void* ChargeOnlySession;
  union
  {
    /* 0x036c */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x036c */ void* ForwardLinkShadow;
      /* 0x0370 */ void* StartAddress;
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
  union
  {
    /* 0x0374 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0374 */ struct _ETHREAD* ReaperLink;
    /* 0x0374 */ void* KeyedWaitValue;
  }; /* size: 0x0004 */
  /* 0x0378 */ unsigned long ActiveTimerListLock;
  /* 0x037c */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0384 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x038c */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x038c */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0014 */
  /* 0x03a0 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x03a4 */ struct _LIST_ENTRY IrpList;
  /* 0x03ac */ unsigned long TopLevelIrp;
  /* 0x03b0 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x03b4 */ void* Win32StartAddress;
  /* 0x03b8 */ void* LegacyPowerObject;
  /* 0x03bc */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x03c4 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x03c8 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x03cc */ unsigned long ReadClusterSize;
  /* 0x03d0 */ volatile long MmLockOrdering;
  union
  {
    /* 0x03d4 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x03d4 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x03d4 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x03d4 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x03d4 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x03d4 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x03d4 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x03d4 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x03d4 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x03d4 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x03d4 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x03d4 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x03d4 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x03d4 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x03d4 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x03d4 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x03d4 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x03d4 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x03d4 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x03d4 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x03d4 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x03d4 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03d8 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x03d8 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x03d8 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x03d8 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x03d8 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x03d8 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x03d8 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x03d8 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x03d8 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x03d8 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x03d8 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x03d8 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x03d8 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03dc */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x03dc */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x03dc */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x03dc */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x03dc */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x03dc */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x03dc */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x03dc */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x03dc */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x03dd */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x03dd */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x03dd */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x03dd */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x03dd */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x03e0 */ unsigned char CacheManagerActive;
  /* 0x03e1 */ unsigned char DisablePageFaultClustering;
  /* 0x03e2 */ unsigned char ActiveFaultCount;
  /* 0x03e3 */ unsigned char LockOrderState;
  /* 0x03e4 */ unsigned long AlpcMessageId;
  union
  {
    /* 0x03e8 */ void* AlpcMessage;
    /* 0x03e8 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0004 */
  /* 0x03ec */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x03f4 */ long ExitStatus;
  /* 0x03f8 */ unsigned long CacheManagerCount;
  /* 0x03fc */ unsigned long IoBoostCount;
  /* 0x0400 */ unsigned long IoQoSBoostCount;
  /* 0x0404 */ unsigned long IoQoSThrottleCount;
  /* 0x0408 */ unsigned long KernelStackReference;
  /* 0x040c */ struct _LIST_ENTRY BoostList;
  /* 0x0414 */ struct _LIST_ENTRY DeboostList;
  /* 0x041c */ unsigned long BoostListLock;
  /* 0x0420 */ unsigned long IrpListLock;
  /* 0x0424 */ void* ReservedForSynchTracking;
  /* 0x0428 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x042c */ const struct _GUID* ActivityId;
  /* 0x0430 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0434 */ void* VerifierContext;
  /* 0x0438 */ void* AdjustedClientToken;
  /* 0x043c */ void* WorkOnBehalfThread;
  /* 0x0440 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x044c */ void* PicoContext;
  /* 0x0450 */ unsigned long UserFsBase;
  /* 0x0454 */ unsigned long UserGsBase;
  /* 0x0458 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x045c */ void* CmDbgInfo;
  union
  {
    /* 0x0460 */ unsigned long SelectedCpuSets;
    /* 0x0460 */ unsigned long* SelectedCpuSetsIndirect;
  }; /* size: 0x0004 */
  /* 0x0464 */ struct _EJOB* Silo;
  /* 0x0468 */ struct _UNICODE_STRING* ThreadName;
  /* 0x046c */ unsigned long LastExpectedRunTime;
  /* 0x0470 */ unsigned long HeapData;
  /* 0x0474 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x047c */ unsigned long DisownedOwnerEntryListLock;
  /* 0x0480 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
} ETHREAD, *PETHREAD; /* size: 0x0488 */
...
?ChunkAllocate@?$RTL_BINARY_ARRAY@PAX$07$03@@SGPAURTL_BINARY_ARRAY_CHUNK@1@PAU1@K@Z
...
?RtlpFlsSetValue@@YGJPAU_RTLP_FLS_CONTEXT@@PAU_RTLP_FLS_THREAD_CONTEXT@@KPAX@Z
?SbFilterProcedure_RTL@@YGPAXPAX@Z
?SetValue@?$RTL_BINARY_ARRAY@PAX$07$03@@SGJPAU1@KPAXK@Z
...
_RtlFirstFreeAce@8
_RtlFlsAlloc@8
_RtlFlsCloneComplete@4
_RtlFlsClonePrepare@0
_RtlFlsFree@4
_RtlFlsGetValue@8
_RtlFlsInitialize@0
_RtlFlsSetValue@8
