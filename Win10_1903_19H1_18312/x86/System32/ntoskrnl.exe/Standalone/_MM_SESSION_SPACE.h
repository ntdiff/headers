...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0180 */ struct _MMWSL_INSTANCE WorkingSetList;
  /* 0x0198 */ void* HeapState;
  /* 0x01c0 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x02c0 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x02c4 */ unsigned long TopLevelPteLockBits[128];
  /* 0x04c8 */ struct _MMPTE PageTables[1024];
  /* 0x24c8 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x24cc */ long PoolBigEntriesInUse;
  /* 0x24d0 */ volatile long PagedPoolPdeCount;
  /* 0x24d4 */ unsigned long DynamicSessionPdeCount;
  /* 0x24d8 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x250c */ void* PoolTrackTableExpansion;
  /* 0x2510 */ unsigned long PoolTrackTableExpansionSize;
  /* 0x2514 */ void* PoolTrackBigPages;
  /* 0x2518 */ unsigned long PoolTrackBigPagesSize;
  /* 0x251c */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x2520 */ enum _IO_SESSION_STATE IoState;
  /* 0x2524 */ unsigned long IoStateSequence;
  /* 0x2528 */ struct _KEVENT IoNotificationEvent;
  /* 0x2538 */ struct _EJOB* ServerSilo;
  /* 0x2540 */ unsigned __int64 CreateTime;
