...
typedef struct _EPROCESS
{
  ...
  /* 0x0640 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0650 */ unsigned long ModifiedPageCount;
  /* 0x0654 */ long ExitStatus;
  /* 0x0658 */ struct _RTL_AVL_TREE VadRoot;
  /* 0x0660 */ void* VadHint;
  /* 0x0668 */ unsigned __int64 VadCount;
  /* 0x0670 */ volatile unsigned __int64 VadPhysicalPages;
  /* 0x0678 */ unsigned __int64 VadPhysicalPagesLimit;
  /* 0x0680 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x06a0 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x06b0 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x06b8 */ unsigned long RequestedTimerResolution;
  /* 0x06bc */ unsigned long SmallestTimerResolution;
  /* 0x06c0 */ union _LARGE_INTEGER ExitTime;
  /* 0x06c8 */ struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
  /* 0x06d0 */ struct _EX_PUSH_LOCK InvertedFunctionTableLock;
  /* 0x06d8 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x06dc */ unsigned long LargePrivateVadCount;
  /* 0x06e0 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x06e8 */ void* WnfContext;
  /* 0x06f0 */ struct _EJOB* ServerSilo;
  /* 0x06f8 */ unsigned char SignatureLevel;
  /* 0x06f9 */ unsigned char SectionSignatureLevel;
  /* 0x06fa */ struct _PS_PROTECTION Protection;
  struct /* bitfield */
  {
    /* 0x06fb */ unsigned char HangCount : 3; /* bit position: 0 */
    /* 0x06fb */ unsigned char GhostCount : 3; /* bit position: 3 */
    /* 0x06fb */ unsigned char PrefilterException : 1; /* bit position: 6 */
  }; /* bitfield */
  union
  {
    /* 0x06fc */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x06fc */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x06fc */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x06fc */ unsigned long Crashed : 1; /* bit position: 2 */
      /* 0x06fc */ unsigned long JobVadsAreTracked : 1; /* bit position: 3 */
      /* 0x06fc */ unsigned long VadTrackingDisabled : 1; /* bit position: 4 */
      /* 0x06fc */ unsigned long AuxiliaryProcess : 1; /* bit position: 5 */
      /* 0x06fc */ unsigned long SubsystemProcess : 1; /* bit position: 6 */
      /* 0x06fc */ unsigned long IndirectCpuSets : 1; /* bit position: 7 */
      /* 0x06fc */ unsigned long RelinquishedCommit : 1; /* bit position: 8 */
      /* 0x06fc */ unsigned long HighGraphicsPriority : 1; /* bit position: 9 */
      /* 0x06fc */ unsigned long CommitFailLogged : 1; /* bit position: 10 */
      /* 0x06fc */ unsigned long ReserveFailLogged : 1; /* bit position: 11 */
      /* 0x06fc */ unsigned long SystemProcess : 1; /* bit position: 12 */
      /* 0x06fc */ unsigned long HideImageBaseAddresses : 1; /* bit position: 13 */
      /* 0x06fc */ unsigned long AddressPolicyFrozen : 1; /* bit position: 14 */
      /* 0x06fc */ unsigned long ProcessFirstResume : 1; /* bit position: 15 */
      /* 0x06fc */ unsigned long ForegroundExternal : 1; /* bit position: 16 */
      /* 0x06fc */ unsigned long ForegroundSystem : 1; /* bit position: 17 */
      /* 0x06fc */ unsigned long HighMemoryPriority : 1; /* bit position: 18 */
      /* 0x06fc */ unsigned long EnableProcessSuspendResumeLogging : 1; /* bit position: 19 */
      /* 0x06fc */ unsigned long EnableThreadSuspendResumeLogging : 1; /* bit position: 20 */
      /* 0x06fc */ unsigned long SecurityDomainChanged : 1; /* bit position: 21 */
      /* 0x06fc */ unsigned long SecurityFreezeComplete : 1; /* bit position: 22 */
      /* 0x06fc */ unsigned long VmProcessorHost : 1; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0700 */ long DeviceAsid;
  /* 0x0704 */ long Padding_146;
  /* 0x0708 */ void* SvmData;
  /* 0x0710 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x0718 */ unsigned __int64 SvmLock;
  /* 0x0720 */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x0730 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x0738 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x0740 */ void* PicoContext;
  /* 0x0748 */ void* EnclaveTable;
  /* 0x0750 */ unsigned __int64 EnclaveNumber;
  /* 0x0758 */ struct _EX_PUSH_LOCK EnclaveLock;
  /* 0x0760 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x0764 */ long Padding_147;
  /* 0x0768 */ struct _PO_PROCESS_ENERGY_CONTEXT* EnergyContext;
  /* 0x0770 */ void* VmContext;
  /* 0x0778 */ unsigned __int64 SequenceNumber;
  /* 0x0780 */ unsigned __int64 CreateInterruptTime;
  /* 0x0788 */ unsigned __int64 CreateUnbiasedInterruptTime;
  /* 0x0790 */ unsigned __int64 TotalUnbiasedFrozenTime;
  /* 0x0798 */ unsigned __int64 LastAppStateUpdateTime;
  struct /* bitfield */
  {
    /* 0x07a0 */ unsigned __int64 LastAppStateUptime : 61; /* bit position: 0 */
    /* 0x07a0 */ unsigned __int64 LastAppState : 3; /* bit position: 61 */
  }; /* bitfield */
  /* 0x07a8 */ volatile unsigned __int64 SharedCommitCharge;
  /* 0x07b0 */ struct _EX_PUSH_LOCK SharedCommitLock;
  /* 0x07b8 */ struct _LIST_ENTRY SharedCommitLinks;
  union
  {
    struct
    {
      /* 0x07c8 */ unsigned __int64 AllowedCpuSets;
      /* 0x07d0 */ unsigned __int64 DefaultCpuSets;
    }; /* size: 0x0010 */
    struct
    {
      /* 0x07c8 */ unsigned __int64* AllowedCpuSetsIndirect;
      /* 0x07d0 */ unsigned __int64* DefaultCpuSetsIndirect;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  /* 0x07d8 */ void* DiskIoAttribution;
  /* 0x07e0 */ void* DxgProcess;
  /* 0x07e8 */ unsigned long Win32KFilterSet;
  /* 0x07ec */ long Padding_148;
  /* 0x07f0 */ volatile union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;
  /* 0x07f8 */ volatile unsigned long KTimerSets;
  /* 0x07fc */ volatile unsigned long KTimer2Sets;
  /* 0x0800 */ volatile unsigned long ThreadTimerSets;
  /* 0x0804 */ long Padding_149;
  /* 0x0808 */ unsigned __int64 VirtualTimerListLock;
  /* 0x0810 */ struct _LIST_ENTRY VirtualTimerListHead;
  union
  {
    /* 0x0820 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x0820 */ struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0030 */
  union
  {
    /* 0x0850 */ unsigned long MitigationFlags;
    struct // _TAG_UNNAMED_87
    {
      struct /* bitfield */
      {
        /* 0x0850 */ unsigned long ControlFlowGuardEnabled : 1; /* bit position: 0 */
        /* 0x0850 */ unsigned long ControlFlowGuardExportSuppressionEnabled : 1; /* bit position: 1 */
        /* 0x0850 */ unsigned long ControlFlowGuardStrict : 1; /* bit position: 2 */
        /* 0x0850 */ unsigned long DisallowStrippedImages : 1; /* bit position: 3 */
        /* 0x0850 */ unsigned long ForceRelocateImages : 1; /* bit position: 4 */
        /* 0x0850 */ unsigned long HighEntropyASLREnabled : 1; /* bit position: 5 */
        /* 0x0850 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 6 */
        /* 0x0850 */ unsigned long ExtensionPointDisable : 1; /* bit position: 7 */
        /* 0x0850 */ unsigned long DisableDynamicCode : 1; /* bit position: 8 */
        /* 0x0850 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 9 */
        /* 0x0850 */ unsigned long DisableDynamicCodeAllowRemoteDowngrade : 1; /* bit position: 10 */
        /* 0x0850 */ unsigned long AuditDisableDynamicCode : 1; /* bit position: 11 */
        /* 0x0850 */ unsigned long DisallowWin32kSystemCalls : 1; /* bit position: 12 */
        /* 0x0850 */ unsigned long AuditDisallowWin32kSystemCalls : 1; /* bit position: 13 */
        /* 0x0850 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 14 */
        /* 0x0850 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 15 */
        /* 0x0850 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 16 */
        /* 0x0850 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 17 */
        /* 0x0850 */ unsigned long PreferSystem32Images : 1; /* bit position: 18 */
        /* 0x0850 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 19 */
        /* 0x0850 */ unsigned long AuditProhibitRemoteImageMap : 1; /* bit position: 20 */
        /* 0x0850 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 21 */
        /* 0x0850 */ unsigned long AuditProhibitLowILImageMap : 1; /* bit position: 22 */
        /* 0x0850 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 23 */
        /* 0x0850 */ unsigned long AuditBlockNonMicrosoftBinaries : 1; /* bit position: 24 */
        /* 0x0850 */ unsigned long AuditBlockNonMicrosoftBinariesAllowStore : 1; /* bit position: 25 */
        /* 0x0850 */ unsigned long LoaderIntegrityContinuityEnabled : 1; /* bit position: 26 */
        /* 0x0850 */ unsigned long AuditLoaderIntegrityContinuity : 1; /* bit position: 27 */
        /* 0x0850 */ unsigned long EnableModuleTamperingProtection : 1; /* bit position: 28 */
        /* 0x0850 */ unsigned long EnableModuleTamperingProtectionNoInherit : 1; /* bit position: 29 */
        /* 0x0850 */ unsigned long RestrictIndirectBranchPrediction : 1; /* bit position: 30 */
        /* 0x0850 */ unsigned long IsolateSecurityDomain : 1; /* bit position: 31 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlagsValues;
  }; /* size: 0x0004 */
  union
  {
    /* 0x0854 */ unsigned long MitigationFlags2;
    struct // _TAG_UNNAMED_88
    {
      struct /* bitfield */
      {
        /* 0x0854 */ unsigned long EnableExportAddressFilter : 1; /* bit position: 0 */
        /* 0x0854 */ unsigned long AuditExportAddressFilter : 1; /* bit position: 1 */
        /* 0x0854 */ unsigned long EnableExportAddressFilterPlus : 1; /* bit position: 2 */
        /* 0x0854 */ unsigned long AuditExportAddressFilterPlus : 1; /* bit position: 3 */
        /* 0x0854 */ unsigned long EnableRopStackPivot : 1; /* bit position: 4 */
        /* 0x0854 */ unsigned long AuditRopStackPivot : 1; /* bit position: 5 */
        /* 0x0854 */ unsigned long EnableRopCallerCheck : 1; /* bit position: 6 */
        /* 0x0854 */ unsigned long AuditRopCallerCheck : 1; /* bit position: 7 */
        /* 0x0854 */ unsigned long EnableRopSimExec : 1; /* bit position: 8 */
        /* 0x0854 */ unsigned long AuditRopSimExec : 1; /* bit position: 9 */
        /* 0x0854 */ unsigned long EnableImportAddressFilter : 1; /* bit position: 10 */
        /* 0x0854 */ unsigned long AuditImportAddressFilter : 1; /* bit position: 11 */
        /* 0x0854 */ unsigned long DisablePageCombine : 1; /* bit position: 12 */
        /* 0x0854 */ unsigned long SpeculativeStoreBypassDisable : 1; /* bit position: 13 */
        /* 0x0854 */ unsigned long CetShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
    } /* size: 0x0004 */ MitigationFlags2Values;
  }; /* size: 0x0004 */
  /* 0x0858 */ void* PartitionObject;
  /* 0x0860 */ unsigned __int64 SecurityDomain;
  /* 0x0868 */ unsigned __int64 ParentSecurityDomain;
  /* 0x0870 */ void* CoverageSamplerContext;
  /* 0x0878 */ void* MmHotPatchContext;
} EPROCESS, *PEPROCESS; /* size: 0x0880 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_185[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_186[2];
