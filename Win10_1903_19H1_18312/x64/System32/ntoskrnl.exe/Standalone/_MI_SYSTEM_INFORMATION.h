...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0a48 */ unsigned __int64 SystemVaTypeCount[15];
  /* 0x0ac0 */ unsigned char SystemVaType[256];
  /* 0x0bc0 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[12];
} MI_VISIBLE_STATE, *PMI_VISIBLE_STATE; /* size: 0x0c80 */
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1c40 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1d00 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1d78 */ struct _MI_ERROR_STATE Errors;
  /* 0x1e40 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x1ec0 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x1fe0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x2080 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x2280 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x22f0 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x2340 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2400 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2440 */ unsigned __int64 Cookie;
  /* 0x2448 */ void* volatile* BootRegistryRuns;
  /* 0x2450 */ volatile long ZeroingDisabled;
  /* 0x2454 */ unsigned char FullyInitialized;
  /* 0x2455 */ unsigned char SafeBooted;
  /* 0x2458 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x2480 */ struct _MI_VISIBLE_STATE Vs;
