...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x00c8 */ unsigned __int64 CombineDomain;
  ...
  /* 0x02c0 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x03c0 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x03c8 */ unsigned long TopLevelPteLockBits[32];
  /* 0x0448 */ struct _MMPTE PageDirectory;
  /* 0x0450 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x0458 */ struct _RTL_BITMAP_EX DynamicVaBitMap;
  /* 0x0468 */ unsigned __int64 DynamicVaHint;
  /* 0x0470 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x0478 */ long PoolBigEntriesInUse;
  /* 0x047c */ volatile long PagedPoolPdeCount;
  /* 0x0480 */ unsigned long DynamicSessionPdeCount;
  /* 0x0488 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x04e8 */ void* PoolTrackTableExpansion;
  /* 0x04f0 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x04f8 */ void* PoolTrackBigPages;
  /* 0x0500 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x0508 */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x0510 */ enum _IO_SESSION_STATE IoState;
  /* 0x0514 */ unsigned long IoStateSequence;
  /* 0x0518 */ struct _KEVENT IoNotificationEvent;
  /* 0x0530 */ struct _EJOB* ServerSilo;
  /* 0x0538 */ unsigned __int64 CreateTime;
