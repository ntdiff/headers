typedef struct _MEMORY_PARTITION_MEMORY_EVENTS_INFORMATION
{
  ...
  /* 0x000c */ void* LowCommitCondition;
  /* 0x0010 */ void* HighCommitCondition;
  /* 0x0014 */ void* MaximumCommitCondition;
} MEMORY_PARTITION_MEMORY_EVENTS_INFORMATION, *PMEMORY_PARTITION_MEMORY_EVENTS_INFORMATION; /* size: 0x0018 */
