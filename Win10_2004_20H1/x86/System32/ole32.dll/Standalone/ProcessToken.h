...
class ProcessToken
{
  ...
  /* 0x0004 */ struct HSTRING__* volatile _stringSelfSid;
  /* 0x0008 */ void* _pPackageSid;
  /* 0x000c */ struct HSTRING__* volatile _stringPackageSid;
  /* 0x0010 */ struct HSTRING__* volatile _packageMoniker;
  /* 0x0014 */ BOOL _fHasPackageMonikerBeenChecked;
  ...
  /* 0x0030 */ enum ProcessToken::WakeOnIntraPackageCallState _wakeOnIntraPackageCallState;
  /* 0x0034 */ enum ProcessToken::ProcessILState _processILState;
  /* 0x0038 */ BOOL _fHasPkgClaimBeenChecked;
  /* 0x0040 */ unsigned __int64 _pkgFlags;
  /* 0x0048 */ unsigned long _sessionId;
}; /* size: 0x0050 */
