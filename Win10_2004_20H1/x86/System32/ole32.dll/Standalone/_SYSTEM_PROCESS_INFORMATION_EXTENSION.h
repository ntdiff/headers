...
typedef struct _SYSTEM_PROCESS_INFORMATION_EXTENSION
{
  ...
  /* 0x0154 */ unsigned long SharedCommitCharge;
  /* 0x0158 */ unsigned long JobObjectId;
  /* 0x015c */ unsigned long SpareUlong;
  /* 0x0160 */ unsigned __int64 ProcessSequenceNumber;
} SYSTEM_PROCESS_INFORMATION_EXTENSION, *PSYSTEM_PROCESS_INFORMATION_EXTENSION; /* size: 0x0168 */
