...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x107e */ char Padding_151[2];
  /* 0x1080 */ unsigned long DirectOidRequestCount;
  /* 0x1084 */ long Padding_152;
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_267[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_268[28];
...
struct wil_details_StagingConfig
{
  ...
  /* 0x000d */ char Padding_281[3];
  /* 0x0010 */ int modified;
  /* 0x0014 */ long Padding_282;
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_444;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_445[2];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_462;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_463[2];
...
{
  /* 0x0000 */ long Padding_471[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_472;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_473;
  /* 0x0028 */ void* OwnerHandle;
  /* 0x0030 */ void* Allocator;
  /* 0x0038 */ unsigned long Tag;
