...
typedef struct _MI_HARDWARE_STATE
{
  ...
  /* 0x0060 */ unsigned long LogicalProcessorsPerCore;
  /* 0x0064 */ unsigned char ProcessorCachesFlushedOnPowerLoss;
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0f48 */ unsigned __int64 SystemVaTypeCount[15];
  /* 0x0fc0 */ unsigned char SystemVaType[256];
  /* 0x10c0 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[12];
} MI_VISIBLE_STATE, *PMI_VISIBLE_STATE; /* size: 0x1180 */
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0520 */ struct _MI_SESSION_STATE Sessions;
  /* 0x15a0 */ struct _MI_PROCESS_STATE Processes;
  ...
  /* 0x1e00 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1e78 */ struct _MI_ERROR_STATE Errors;
  /* 0x1f80 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x2080 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x21a0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x2280 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x2480 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x24f0 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x25a0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2680 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2700 */ unsigned __int64 Cookie;
  /* 0x2708 */ void* volatile* BootRegistryRuns;
  /* 0x2710 */ volatile long ZeroingDisabled;
  /* 0x2714 */ unsigned char FullyInitialized;
  /* 0x2715 */ unsigned char SafeBooted;
  /* 0x2718 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x2780 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3900 */
