...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0750 */ unsigned char* MediumPagesOnFreeZeroList;
  /* 0x0754 */ struct _RTL_BITMAP LargePageRebuildCandidates;
  /* 0x075c */ struct _KEVENT LargePageCandidatesExistEvent;
  /* 0x076c */ unsigned long LowMemoryThreshold;
  /* 0x0770 */ unsigned long HighMemoryThreshold;
  /* 0x0778 */ struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[4][2];
  /* 0x09b8 */ struct _RTL_BITMAP SlabPfnBitMap;
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x09c0 */
...
typedef struct _MI_PARTITION_ZEROING
{
  ...
  /* 0x002c */ struct _KGATE LargeBootZeroingComplete;
  /* 0x003c */ struct _MI_WRITE_CALIBRATION WriteCalibration;
  /* 0x0054 */ unsigned char IpiCalibrationFailed;
  /* 0x0058 */ volatile long ActiveProcessorsForIpiCalibration;
  /* 0x005c */ volatile long NodesReadyForIpiCalibration;
  /* 0x0060 */ struct _KEVENT ReleaseNodeZeroingThreads;
  /* 0x0070 */ struct _MI_ZERO_THREAD_CONTEXT* ThreadContext;
} MI_PARTITION_ZEROING, *PMI_PARTITION_ZEROING; /* size: 0x0074 */
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0f00 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x0f24 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x0f98 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1078 */ void* WorkingSetControl;
  /* 0x107c */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1084 */ unsigned long SessionDetachTimeStamp;
  /* 0x10c0 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x1cc0 */
