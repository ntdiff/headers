...
typedef struct _KPRCB
{
  ...
  union
  {
    /* 0x21b8 */ unsigned short BpbState;
    struct /* bitfield */
    {
      /* 0x21b8 */ unsigned short BpbIbrsPresent : 1; /* bit position: 0 */
      /* 0x21b8 */ unsigned short BpbStibpPresent : 1; /* bit position: 1 */
      /* 0x21b8 */ unsigned short BpbSmepPresent : 1; /* bit position: 2 */
      /* 0x21b8 */ unsigned short BpbSimulateSpecCtrl : 1; /* bit position: 3 */
      /* 0x21b8 */ unsigned short BpbSimulateIbpb : 1; /* bit position: 4 */
      /* 0x21b8 */ unsigned short BpbIbpbPresent : 1; /* bit position: 5 */
      /* 0x21b8 */ unsigned short BpbCpuIdle : 1; /* bit position: 6 */
      /* 0x21b8 */ unsigned short BpbClearSpecCtrlOnIdle : 1; /* bit position: 7 */
      /* 0x21b8 */ unsigned short BpbHTDisabled : 1; /* bit position: 8 */
      /* 0x21b8 */ unsigned short BpbUserToUserOnly : 1; /* bit position: 9 */
      /* 0x21b8 */ unsigned short BpbReserved : 6; /* bit position: 10 */
    }; /* bitfield */
  }; /* size: 0x0002 */
  /* 0x21ba */ unsigned char BpbSpecCtrlValue;
  /* 0x21bb */ unsigned char BpbCtxSwapSetValue;
  /* 0x21bc */ unsigned char PrcbPad50[20];
...
typedef struct _HEAP_VAMGR_RANGE
{
  union
  {
    ...
    struct
    {
      ...
      /* 0x0002 */ char Padding_36[2];
      /* 0x0004 */ unsigned long OwnerCtx;
      /* 0x0008 */ unsigned long Spare1;
    }; /* size: 0x000a */
  }; /* size: 0x000c */
  union
  {
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x0081 */ char Padding_45[3];
  /* 0x0084 */ unsigned long DesiredPercent;
  /* 0x0088 */ unsigned long GuaranteedPercent;
  /* 0x008c */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[4];
  /* 0x00fc */ unsigned long QosDisableReasons[4];
  /* 0x010c */ unsigned long QosEquivalencyMasks[4];
  /* 0x011c */ unsigned char QosSupported;
  /* 0x011d */ char Padding_46[3];
  /* 0x0120 */ volatile unsigned long SelectionGeneration;
  /* 0x0124 */ long Padding_47;
  /* 0x0128 */ struct _PERF_CONTROL_STATE_SELECTION QosSelection[4];
  /* 0x01c8 */ unsigned __int64 PerfChangeTime;
  /* 0x01d0 */ unsigned long PerfChangeIntervalCount;
  /* 0x01d4 */ unsigned char Force;
  /* 0x01d5 */ char __PADDING__[3];
} PROC_PERF_DOMAIN, *PPROC_PERF_DOMAIN; /* size: 0x01d8 */
...
typedef struct _EPROCESS
{
  ...
  struct /* bitfield */
  {
    /* 0x02f7 */ unsigned char HangCount : 4; /* bit position: 0 */
    /* 0x02f7 */ unsigned char GhostCount : 4; /* bit position: 4 */
  }; /* bitfield */
  union
  {
  ...
  union
  {
    ...
    struct // _TAG_UNNAMED_52
    {
      struct /* bitfield */
      {
        ...
        /* 0x03e0 */ unsigned long Reserved : 1; /* bit position: 30 */
      }; /* bitfield */
  ...
  /* 0x03ec */ long Padding_59;
  /* 0x03f0 */ unsigned __int64 SecurityDomain;
  /* 0x03f8 */ void* CoverageSamplerContext;
  /* 0x03fc */ long __PADDING__[1];
} EPROCESS, *PEPROCESS; /* size: 0x0400 */
...
} RTLP_HP_HEAP_GLOBALS, *PRTLP_HP_HEAP_GLOBALS; /* size: 0x000c */
...
_RealSuccessor@4
_RebalanceNode@4
_RemoveRootDirectoryFromPath@8
...
_RtlpHpLfhAffinitySlotInitialize@16
...
_RtlpHpVaMgrAlloc@16
_RtlpHpVaMgrAllocAligned@12
_RtlpHpVaMgrCtxAlloc@20
...
_RtlpHpVaMgrRangeMarkAllocated@16
...
_RtlpHpVsSubsegmentInitialize@12
