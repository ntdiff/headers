...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x066c */ unsigned long TimestampFlags;
  /* 0x0670 */ unsigned long FilterPnPFlags;
  /* 0x0674 */ unsigned long SupportedStatistics;
  /* 0x0678 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x068c */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x0690 */ struct _LIST_ENTRY PortList;
  /* 0x0698 */ unsigned char* AllocatedPortIndices;
  /* 0x069c */ unsigned long AllocatedPortIndicesLength;
  /* 0x06a0 */ unsigned long NumberOfPorts;
  /* 0x06a4 */ unsigned long NumberOfActivePorts;
  /* 0x06a8 */ unsigned __int64 MiniportXmitLinkSpeed;
  /* 0x06b0 */ unsigned __int64 MiniportRcvLinkSpeed;
  /* 0x06b8 */ struct _NDIS_TIMER InitModeTimeoutTimer;
  /* 0x0700 */ struct _NDIS_WORK_ITEM InitModeTimeoutWorkItem;
  /* 0x0728 */ struct _KEVENT InitModeTimeoutTimerQueuedEvent;
  /* 0x0738 */ unsigned long DataBackFillSize;
  /* 0x073c */ unsigned long ContextBackFillSize;
  /* 0x0740 */ struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;
  /* 0x0790 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;
  /* 0x07a4 */ unsigned long NsiOpenReferences;
  /* 0x07a8 */ void* ProcessingOpen;
  /* 0x07ac */ struct _KEVENT* NsiRequestsCompletedEvent;
  /* 0x07b0 */ enum _DEVICE_POWER_STATE QueryPowerDeviceState;
  /* 0x07b4 */ unsigned char MinimumNdisMajorVersion;
  /* 0x07b5 */ unsigned char MinimumNdisMinorVersion;
  /* 0x07b8 */ struct _NDIS_MINIPORT_STATS* BottomIfStats;
  /* 0x07bc */ struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;
  /* 0x0818 */ struct PNDIS_PER_PROCESSOR_SLOT__* PeriodicReceivesNblCountIndex;
  /* 0x081c */ enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;
  /* 0x0820 */ enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;
  /* 0x0824 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;
  /* 0x0828 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;
  /* 0x082c */ enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;
  /* 0x0830 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;
  /* 0x0834 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;
  /* 0x0838 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;
  /* 0x083c */ struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;
  /* 0x0870 */ void* TopNdis5PacketIndicateHandler /* function */;
  /* 0x0874 */ unsigned long* ndisSupportedOidList;
  /* 0x0878 */ unsigned long ndisSupportedOidListLength;
  /* 0x087c */ unsigned long MsiIntCount;
  /* 0x0880 */ struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;
  /* 0x0890 */ unsigned __int64 InvalidFrames;
  /* 0x0898 */ long PagingPathCount;
  /* 0x089c */ struct _LIST_ENTRY ReceiveQueueList;
  /* 0x08a4 */ unsigned char* AllocatedQueueIndices;
  /* 0x08a8 */ unsigned long AllocatedQueueIndicesLength;
  /* 0x08ac */ unsigned long NumReceiveQueues;
  /* 0x08b0 */ struct _LIST_ENTRY ReceiveFilterList;
  /* 0x08b8 */ unsigned char* AllocatedReceiveFilterIndices;
  /* 0x08bc */ unsigned long AllocatedReceiveFilterIndicesLength;
  /* 0x08c0 */ unsigned long NumReceiveFilters;
  /* 0x08c4 */ unsigned long EnabledReceiveFilterTypes;
  /* 0x08c8 */ unsigned long EnabledReceiveQueueTypes;
  /* 0x08cc */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterHwCapabilities;
  /* 0x08d0 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterCurrentCapabilities;
  /* 0x08d4 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* TopReceiveFilterCurrentCapabilities;
  /* 0x08d8 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchHwCapabilities;
  /* 0x08dc */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchCurrentCapabilities;
  /* 0x08e0 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* TopNicSwitchCurrentCapabilities;
  /* 0x08e4 */ struct _LIST_ENTRY SharedMemoryBlockList;
  /* 0x08ec */ void* AllocateSharedMemoryHandler /* function */;
  /* 0x08f0 */ void* FreeSharedMemoryHandler /* function */;
  /* 0x08f4 */ void* AllocateSharedMemoryContext;
  /* 0x08f8 */ struct PCI_MSI_CAPABILITY MsiCaps;
  /* 0x0910 */ struct PCI_MSIX_CAPABILITY MsiXCaps;
  /* 0x0920 */ unsigned __int64 NumberOfIndirectionTableChanges;
  /* 0x0928 */ unsigned int PciDeviceSriovSupport;
  union
  {
    /* 0x092c */ unsigned char BeginSavedFields;
    /* 0x092c */ unsigned long NumUserOpens;
  }; /* size: 0x0004 */
  /* 0x0930 */ struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;
  /* 0x0934 */ unsigned short MediaDisconnectTimeOut;
  /* 0x0936 */ unsigned short SGMapRegistersNeeded;
  /* 0x0938 */ unsigned long DriverVerifyFlags;
  /* 0x093c */ void* SetBusData /* function */;
  /* 0x0940 */ void* GetBusData /* function */;
  /* 0x0944 */ void* BusDataContext;
  /* 0x0948 */ enum _INTERFACE_TYPE BusType;
  /* 0x094c */ unsigned long BusNumber;
  /* 0x0950 */ unsigned long SlotNumber;
  /* 0x0954 */ struct _NDIS_EVENT OpenReadyEvent;
  /* 0x0964 */ unsigned long NumAdminOpens;
  /* 0x0968 */ struct _NDIS_M_DRIVER_BLOCK* DriverHandle;
  /* 0x096c */ struct _NDIS_BIND_PATHS* BindPaths;
  /* 0x0970 */ enum _NDIS_PHYSICAL_MEDIUM MiniportPhysicalMediumType;
  /* 0x0974 */ void* SecurityDescriptor;
  /* 0x0978 */ struct _UNICODE_STRING BaseName;
  /* 0x0980 */ struct _UNICODE_STRING MiniportName;
  /* 0x0988 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x098c */ struct _DEVICE_OBJECT* PhysicalDeviceObject;
  /* 0x0990 */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x0994 */ struct _NDIS_MINIPORT_BLOCK* NextGlobalMiniport;
  /* 0x0998 */ struct _UNICODE_STRING* pAdapterInstanceName;
  /* 0x099c */ unsigned long PnPCapabilities;
  /* 0x09a0 */ enum _DEVICE_POWER_STATE CurrentDevicePowerState;
  /* 0x09a4 */ unsigned long PowerStateLock;
  /* 0x09a8 */ enum _DEVICE_POWER_STATE DriverPowerState;
  /* 0x09ac */ enum _DEVICE_POWER_STATE PrevDriverPowerState;
  /* 0x09b0 */ struct _NET_BUFFER_LIST* LowPowerRcvReturnNbls;
  /* 0x09b4 */ unsigned long PendingReturnNBLCount;
  /* 0x09b8 */ unsigned char SurpriseRemoveFlushedRcvReturnQueue;
  /* 0x09bc */ struct NDIS_NBL_TRACKER_HANDLE__* LowPowerRcvReturnNblTracker;
  /* 0x09c0 */ struct _NDIS_PM_ADMIN_CONFIG PMAdminConfig;
  /* 0x09c4 */ struct _KSEMAPHORE PMPatternSemaphore;
  /* 0x09d8 */ struct _KSEMAPHORE PMOffloadSemaphore;
  /* 0x09ec */ void* BusInterface;
  /* 0x09f0 */ unsigned short InstanceNumber;
  /* 0x09f4 */ void* ConfigurationHandle;
  /* 0x09f8 */ struct _GUID InterfaceGuid;
  /* 0x0a08 */ union _NET_LUID_LH NetLuid;
  /* 0x0a10 */ unsigned char IfBlockAvailable;
  /* 0x0a14 */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x0a18 */ struct _KEVENT* IfBlockPointerRefZeroEvent;
  /* 0x0a1c */ unsigned int IfIndex;
  /* 0x0a20 */ enum _NET_IF_ADMIN_STATUS AdminStatus;
  /* 0x0a24 */ enum _NET_IF_OPER_STATUS OperStatus;
  /* 0x0a28 */ unsigned long OperStatusFlags;
  union
  {
    /* 0x0a2c */ void* SendHandler /* function */;
    /* 0x0a2c */ void* WanSendHandler /* function */;
  }; /* size: 0x0004 */
  /* 0x0a30 */ struct NDIS_NBL_TRACKER_HANDLE__* NblTracker;
  /* 0x0a34 */ struct _DEVICE_RESET_INTERFACE_STANDARD* ReenumerateSelfInterface;
  /* 0x0a38 */ struct _NDIS_MINIPORT_OFFLOAD* Offload;
  /* 0x0a3c */ void* NDKBlock;
  /* 0x0a40 */ void* AddDeviceContext;
  /* 0x0a44 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x0a5c */ struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;
  /* 0x0a64 */ unsigned long PhysicalMediumInInf;
  /* 0x0a68 */ class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > ExportName;
  /* 0x0a6c */ class wistd::unique_ptr<Rtl::KString,wistd::default_delete<Rtl::KString> > FilterClass;
  /* 0x0a70 */ void* StatusProcessingThread;
  /* 0x0a74 */ unsigned long StatusProcessingDbgX;
  /* 0x0a78 */ struct _UNICODE_STRING FdoName;
  /* 0x0a80 */ struct _KEVENT PowerD0CompleteEvent;
  /* 0x0a90 */ long LastD0CompleteStatus;
  /* 0x0a94 */ enum _NDIS_MINIPORT_EVENT LastD0Reason;
  /* 0x0a98 */ unsigned long DirectOidRequestCount;
  /* 0x0a9c */ struct _KEVENT* AllDirectRequestsCompletedEvent;
  /* 0x0aa0 */ struct _NDIS_HD_SPLIT_CURRENT_CONFIG* HDSplitCurrentConfig;
  /* 0x0aa4 */ void* MSIXConfigContext;
  /* 0x0aa8 */ void* SetMSIXTableEntry /* function */;
  /* 0x0aac */ void* MaskMSIXTableEntry /* function */;
  /* 0x0ab0 */ void* UnmaskMSIXTableEntry /* function */;
  /* 0x0ab4 */ struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;
  /* 0x0ac4 */ struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;
  /* 0x0ad4 */ struct _NDIS_RECEIVE_QUEUE_BLOCK* DefaultReceiveQueue;
  /* 0x0ad8 */ unsigned long MaxNumRssProcessors;
  /* 0x0adc */ struct _PROCESSOR_NUMBER RssBaseProcessor;
  /* 0x0ae0 */ struct _PROCESSOR_NUMBER RssMaxProcessor;
  /* 0x0ae4 */ enum _NDIS_RSS_PROFILE RssProfile;
  /* 0x0ae8 */ unsigned short NumaNodeId;
  /* 0x0aec */ unsigned short* NumaDistances;
  /* 0x0af0 */ struct _UNICODE_STRING* pModifiedInstanceName;
  /* 0x0af4 */ unsigned long SyncFlags;
  /* 0x0af8 */ unsigned long WSyncFlags;
  /* 0x0afc */ unsigned long InterlockedFlags;
  /* 0x0b00 */ struct _ULONG_REFERENCE Ref;
  /* 0x0b0c */ struct _NDIS_SELECTIVE_SUSPEND* SelectiveSuspend;
  /* 0x0b10 */ struct _NDIS_MINIPORT_AOAC* AoAc;
  /* 0x0b14 */ enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;
  /* 0x0b18 */ struct NDIS_EVENT_LOG_HANDLE__* PnpEventLog;
  /* 0x0b1c */ struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;
  /* 0x0b4c */ struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS* PhysicalPerformanceCounters;
  /* 0x0b50 */ union _LARGE_INTEGER TimeOfInitialization;
  /* 0x0b58 */ union _LARGE_INTEGER LastSystemSleepTime;
  /* 0x0b60 */ unsigned __int64 TotalSystemSleepTimeMs;
  /* 0x0b68 */ struct _NDIS_SRIOV_CAPABILITIES* SriovHwCapabilities;
  /* 0x0b6c */ struct _NDIS_SRIOV_CAPABILITIES* SriovCurrentCapabilities;
  /* 0x0b70 */ unsigned __int64 InvalidateBlockMask;
  /* 0x0b78 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x0b7c */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x0b80 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x0b88 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x0b98 */ unsigned short InvalidateVfId;
  /* 0x0b9a */ unsigned char InvalidateBlockCancelling;
  /* 0x0b9c */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x0ba0 */ unsigned long NumSwitches;
  /* 0x0ba4 */ struct _LIST_ENTRY NicSwitchList;
  /* 0x0bac */ unsigned long NumAllocatedVFs;
  /* 0x0bb0 */ struct _LIST_ENTRY VFList;
  /* 0x0bb8 */ unsigned long NumActiveVPorts;
  /* 0x0bbc */ struct _LIST_ENTRY VPortList;
  /* 0x0bc4 */ unsigned char* AllocatedVPortIndices;
  /* 0x0bc8 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x0bcc */ void* SetVirtualFunctionData /* function */;
  /* 0x0bd0 */ void* GetVirtualFunctionData /* function */;
  /* 0x0bd4 */ void* EnableVirtualization /* function */;
  /* 0x0bd8 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x0bdc */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x0be0 */ void* VirtInterfaceContext;
  /* 0x0be4 */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x0bec */ void* VpciInterfaceDereference /* function */;
  /* 0x0bf0 */ void* WriteVfConfigBlock /* function */;
  /* 0x0bf4 */ void* ReadVfConfigBlock /* function */;
  /* 0x0bf8 */ void* VpciInterfaceContext;
  /* 0x0bfc */ unsigned int VfSerialNumber;
  /* 0x0c00 */ struct _LUID SriovLuid;
  /* 0x0c08 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x0c0c */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x0c10 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x0c14 */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x0c18 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x0c1c */ unsigned long QosOperationalParametersBufferSize;
  /* 0x0c20 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x0c24 */ unsigned long QosRemoteParametersBufferSize;
  /* 0x0c28 */ unsigned __int64 DeviceFlags;
  /* 0x0c30 */ void* VerifierContext;
  /* 0x0c34 */ struct _WORK_QUEUE_ITEM SurpriseRemovalWorkItem;
  /* 0x0c44 */ struct Ndis::BindStack Bindings;
  /* 0x0c8c */ struct Ndis::BindEngine BindEngine;
  /* 0x0ccc */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x0ce4 */ BOOL PmInterruptedByPnp;
  /* 0x0ce5 */ BOOL DoNotBlockOnMiniportLock;
  /* 0x0ce6 */ BOOL PoFxDStateReportingEnabled;
  /* 0x0ce8 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x0cec */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x0cfc */ BOOL InterfaceUpdateInProgress;
  /* 0x0cfd */ BOOL MacAddressUpdateQueued;
  /* 0x0cfe */ BOOL MtuUpdateQueued;
  /* 0x0d00 */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x0d24 */ unsigned long PendingMtuSize;
  /* 0x0d28 */ wchar_t* PnPInstanceId;
  /* 0x0d2c */ struct RECORDER_LOG__* BlackBoxHandle;
  /* 0x0d30 */ struct _KEVENT* PowerCompleteEvent;
  /* 0x0d34 */ long PowerCompleteStatus;
  /* 0x0d38 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x0d4c */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x0d60 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x0d64 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x0d68 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__stdcall*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned int,1>,NDISWATCHDOG__ *,4294967295,std::nullptr_t> > > ReenumerateWatchdog;
  /* 0x0d6c */ void* PdcHandle;
  /* 0x0d70 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x0db8 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x0de0 */ volatile long PdcTaskClientMode;
  /* 0x0de4 */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x0de8 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x0dec */ volatile long RssV2CompletionCount;
  /* 0x0df0 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x0e00 */ struct _LIST_ENTRY SynchronousOidCalls;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x0e08 */
