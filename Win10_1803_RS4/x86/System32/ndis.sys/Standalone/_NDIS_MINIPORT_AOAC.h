...
typedef struct _NDIS_MINIPORT_AOAC
{
  ...
  /* 0x00d8 */ struct _NDIS_AOAC_WAKE_FLAGS WakeFlags;
  /* 0x00dc */ struct _KEVENT PowerSuspendCompleteEvent;
  /* 0x00ec */ struct _KEVENT WdfAoAcDisengagedEvent;
  /* 0x00fc */ unsigned char WdfAoAcTransition;
  /* 0x0100 */ struct _KEVENT NicQuietCheckCompleteEvent;
  /* 0x0110 */ unsigned __int64 StartTime;
  /* 0x0118 */ unsigned short LastUnexpectedFailureLine[2];
  /* 0x011c */ unsigned char TakeStartToRefTime;
  /* 0x0120 */ union _LARGE_INTEGER LastWakeTime;
  /* 0x0128 */ unsigned char TakeWakeToRefTime;
  /* 0x012c */ long ComponentRefCounts[17];
  /* 0x0170 */ struct _NDIS_AOAC_COMPONENT_REF_TIME CsRefTimes[17];
  /* 0x0280 */ long CsPowerTransitions;
  /* 0x0288 */ unsigned __int64 TotalCsActiveTime;
  /* 0x0290 */ unsigned __int64 TotalCsResiliencyTime;
  /* 0x0298 */ unsigned __int64 CurrentActiveStartTime;
  /* 0x02a0 */ unsigned __int64 CurrentCsResiliencyStartTime;
  /* 0x02a8 */ unsigned long CsSurpriseWakes;
  /* 0x02ac */ unsigned long CsSpuriousWakes;
  /* 0x02b0 */ struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];
  /* 0x0340 */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;
  /* 0x036c */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX CsSpuriousWakeStatsEx;
  /* 0x0380 */ unsigned char DirectedMacPatternPlumbed;
  /* 0x0381 */ unsigned char IsInCsResiliency;
  /* 0x0384 */ unsigned long LastWakePatternId;
  /* 0x0388 */ unsigned long WakeIrpCount;
  /* 0x0390 */ unsigned __int64 WakeIrpStartTime;
  /* 0x0398 */ unsigned __int64 LastWakeIrpLatencyMs;
  /* 0x03a0 */ unsigned __int64 MaxWakeIrpLatencyMs;
  /* 0x03a8 */ unsigned __int64 TotalWakeIrpLatencyMs;
  /* 0x03b0 */ unsigned long SetPowerOidCount;
  /* 0x03b8 */ unsigned __int64 LastSetPowerOidLatencyMs;
  /* 0x03c0 */ unsigned __int64 MaxSetPowerOidLatencyMs;
  /* 0x03c8 */ unsigned __int64 TotalSetPowerOidLatencyMs;
} NDIS_MINIPORT_AOAC, *PNDIS_MINIPORT_AOAC; /* size: 0x03d0 */
