...
struct EDP_REQUEST_ACCESS_OPTIONS
{
  ...
  /* 0x0004 */ const wchar_t* dialogBlockedBodyText;
  /* 0x0008 */ const wchar_t* dialogOverrideBodyText;
  /* 0x000c */ enum EDP_REQUEST_ACCESS_OVERRIDE overrideOption;
  /* 0x0010 */ enum EDP_TELEMETRY_CALLER telemetryCaller;
  /* 0x0014 */ enum EDP_SOURCE_ENTERPRISEID_OPTION sourceEnterpriseIdOption;
}; /* size: 0x0018 */
