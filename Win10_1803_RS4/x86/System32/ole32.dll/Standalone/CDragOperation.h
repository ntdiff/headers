...
class CDragOperation
{
  ...
  /* 0x014c */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (__stdcall*)(void *),&CoTaskMemFree,wistd::integral_constant<unsigned int,0>,unsigned short *,0,std::nullptr_t> > > m_sourceEnterpriseId;
  /* 0x0150 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (__stdcall*)(void *),&CoTaskMemFree,wistd::integral_constant<unsigned int,0>,unsigned short *,0,std::nullptr_t> > > m_dataObjectEnterpriseId;
