...
struct tagSOleTlsData
{
  ...
  /* 0x00d4 */ struct CallEntryBuffer CallEntry;
  ...
  /* 0x011c */ unsigned long cReentrancyFromUserAPC;
  /* 0x0120 */ class ASTAWaitContext* pASTAWaitContext;
  /* 0x0124 */ volatile unsigned long dwCrossThreadFlags;
  /* 0x0128 */ unsigned long dwNestedRemRelease;
  /* 0x012c */ unsigned long cIncomingTouchedASTACalls;
  /* 0x0130 */ class PushLogicalThreadId* pTopPushedLogicalThreadId;
  /* 0x0134 */ unsigned long iXslockOwnerTableHint;
  /* 0x0138 */ enum OLETLS_PREVENT_RUNDOWN_MITIGATION currentPreventRundownMitigation;
  /* 0x013c */ int fOweForcedBulkUpdateForCurrentMitigation;
  /* 0x0140 */ struct IUnknown* pClipboardBroker;
  /* 0x0144 */ unsigned long dwActivationType;
  /* 0x0148 */ unsigned long cTouchedAstasInActiveCall;
  /* 0x014c */ unsigned __int64* pTouchedAstasInActiveCall;
  /* 0x0150 */ class UnmarshalForQueryInterface* pTopmostUnmarshalForQueryInterface;
  /* 0x0154 */ class CoGetStandardMarshalInProgress* pTopmostCoGetStandardMarshalInProgress;
}; /* size: 0x0158 */
