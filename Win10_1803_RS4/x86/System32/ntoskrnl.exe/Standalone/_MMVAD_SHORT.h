...
typedef struct _MMVAD_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long Enclave : 1; /* bit position: 16 */
    /* 0x0000 */ unsigned long PageSize64K : 1; /* bit position: 17 */
    /* 0x0000 */ unsigned long RfgControlStack : 1; /* bit position: 18 */
    /* 0x0000 */ unsigned long Spare : 8; /* bit position: 19 */
