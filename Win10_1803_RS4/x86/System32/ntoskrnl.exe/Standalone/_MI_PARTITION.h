...
typedef struct _MI_PARTITION_SEGMENTS
{
  ...
  /* 0x00dc */ unsigned long UnusedSegmentPagedPool;
  /* 0x00e0 */ struct _LIST_ENTRY UnusedSegmentList;
  /* 0x00e8 */ struct _LIST_ENTRY UnusedSubsectionList;
  /* 0x00f0 */ struct _LIST_ENTRY DeleteSubsectionList;
  /* 0x00f8 */ struct _KEVENT ControlAreaDeleteEvent;
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0672 */ unsigned char LargePfnBitMapsReady;
  ...
  /* 0x0868 */ unsigned char RebuildLargePageActive;
...
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x0880 */
...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x01e8 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x01f8 */ volatile long PageFileTraceIndex;
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0dc0 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x0e40 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x0e80 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x0f58 */ void* WorkingSetControl;
  /* 0x0f5c */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x0f80 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x1b80 */
