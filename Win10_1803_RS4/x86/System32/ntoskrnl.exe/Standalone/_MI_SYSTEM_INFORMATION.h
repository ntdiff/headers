...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x00e8 */ unsigned char DanglingExtentsWorkerActive;
  /* 0x00e9 */ unsigned char PurgingExtentsNeedWatchdog;
  /* 0x00ec */ struct _RTL_AVL_TREE PrototypePtesTree;
  /* 0x00f0 */ volatile long PrototypePtesTreeSpinLock;
  /* 0x00f4 */ unsigned long ImageBias;
  /* 0x00f8 */ struct _EX_PUSH_LOCK RelocateBitmapsLock;
  /* 0x00fc */ struct _RTL_BITMAP ImageBitMap;
  /* 0x0104 */ void* ApiSetSection;
  /* 0x0108 */ void* ApiSetSchema;
  /* 0x010c */ unsigned long ApiSetSchemaSize;
  /* 0x0110 */ unsigned long LostDataFiles;
  /* 0x0114 */ unsigned long LostDataPages;
  /* 0x0118 */ unsigned long ImageFailureReason;
  /* 0x011c */ struct _SECTION* CfgBitMapSection32;
  /* 0x0120 */ struct _CONTROL_AREA* CfgBitMapControlArea32;
  /* 0x0124 */ unsigned long ImageCfgFailure;
  /* 0x0128 */ unsigned long ImageChecksumBreakpoint;
  /* 0x012c */ unsigned long ImageSizeBreakpoint;
  /* 0x0130 */ volatile long ImageValidationFailed;
  /* 0x0134 */ long __PADDING__[3];
...
typedef struct _MI_SYSTEM_IMAGE_STATE
{
  ...
  /* 0x006c */ struct _RTL_AVL_TREE ImageTree;
} MI_SYSTEM_IMAGE_STATE, *PMI_SYSTEM_IMAGE_STATE; /* size: 0x0070 */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x00c4 */ volatile unsigned long PfnDatabaseCommit;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x06b0 */ struct _MI_SESSION_STATE Sessions;
  /* 0x16f0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1758 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1840 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x3f80 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x3f98 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x3fb0 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x3fe8 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x4030 */ struct _MI_ERROR_STATE Errors;
  /* 0x4100 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x4180 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x4210 */ struct _MI_STANDBY_STATE Standby;
  /* 0x4280 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x4400 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x4440 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x4478 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x44c0 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x4500 */ unsigned long Cookie;
  /* 0x4504 */ void* volatile* BootRegistryRuns;
  /* 0x4508 */ volatile long ZeroingDisabled;
  /* 0x450c */ unsigned char FullyInitialized;
  /* 0x450d */ unsigned char SafeBooted;
  /* 0x4510 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x4518 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x4540 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x4fc0 */
