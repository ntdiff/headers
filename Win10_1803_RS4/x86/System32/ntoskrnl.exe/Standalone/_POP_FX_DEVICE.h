...
} POP_FX_DRIVER_CALLBACKS, *PPOP_FX_DRIVER_CALLBACKS; /* size: 0x0020 */
...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x005c */ void* DriverContext;
  /* 0x0060 */ struct _LIST_ENTRY AcpiLink;
  /* 0x0068 */ struct _UNICODE_STRING DeviceId;
  /* 0x0070 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x0088 */ struct _IO_REMOVE_LOCK AcpiRemoveLock;
  /* 0x00a0 */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x00bc */ unsigned long IdleLock;
  ...
  /* 0x01c8 */ volatile unsigned long Flags;
  /* 0x01cc */ unsigned long ComponentCount;
  /* 0x01d0 */ struct _POP_FX_COMPONENT** Components;
  /* 0x01d4 */ unsigned long LogEntries;
  /* 0x01d8 */ struct _POP_FX_LOG_ENTRY* Log;
  /* 0x01dc */ volatile long LogIndex;
  /* 0x01e0 */ struct _DRIVER_OBJECT* DripsWatchdogDriverObject;
  /* 0x01e4 */ struct _POP_FX_DRIPS_WATCHDOG_CONTEXT DripsWatchdogContext;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x01f8 */
