...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x0130 */ struct _HALP_DMA_DOMAIN_OBJECT* DomainPointer;
  /* 0x0134 */ enum _EXT_IOMMU_TRANSLATION_TYPE TranslationType;
  /* 0x0138 */ unsigned char AdapterInUse;
  /* 0x0139 */ char Padding_9[3];
  /* 0x013c */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0140 */ struct _EXT_IOMMU_DEVICE_ID* DeviceId;
  /* 0x0144 */ void* IommuDevice;
...
} DMA_OPERATIONS, *PDMA_OPERATIONS; /* size: 0x008c */
...
_HalpIommuDetachDeviceDomain@8
...
_HalpIommuProcessReservations@0
_HalpIommuProcessReservationsInternal@4
...
_HalpTimerReadTimeStampCounterWithFence@0
...
_HalpUsbLegacyWritePortUShort@8
