...
} STREAM_INFORMATION_ENTRY::_StreamInformation, *PSTREAM_INFORMATION_ENTRY::_StreamInformation; /* size: 0x0008 */
...
} STREAM_INFORMATION_ENTRY, *PSTREAM_INFORMATION_ENTRY; /* size: 0x0010 */
