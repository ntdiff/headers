...
typedef struct _KPRCB
{
  ...
  union
  {
    struct
    {
      ...
      union
      {
        /* 0x00f8 */ unsigned short BpbState;
        struct
        {
          struct /* bitfield */
          {
            /* 0x00f8 */ unsigned short BpbIbrsPresent : 1; /* bit position: 0 */
            /* 0x00f8 */ unsigned short BpbStibpPresent : 1; /* bit position: 1 */
            /* 0x00f8 */ unsigned short BpbSmepPresent : 1; /* bit position: 2 */
            /* 0x00f8 */ unsigned short BpbSimulateSpecCtrl : 1; /* bit position: 3 */
            /* 0x00f8 */ unsigned short BpbSimulateIbpb : 1; /* bit position: 4 */
            /* 0x00f8 */ unsigned short BpbIbpbPresent : 1; /* bit position: 5 */
            /* 0x00f8 */ unsigned short BpbCpuIdle : 1; /* bit position: 6 */
            /* 0x00f8 */ unsigned short BpbClearSpecCtrlOnIdle : 1; /* bit position: 7 */
            /* 0x00f8 */ unsigned short BpbHTDisabled : 1; /* bit position: 8 */
            /* 0x00f8 */ unsigned short BpbUserToUserOnly : 1; /* bit position: 9 */
            /* 0x00f8 */ unsigned short BpbReserved : 6; /* bit position: 10 */
          }; /* bitfield */
          /* 0x00fa */ unsigned char BpbSpecCtrlValue;
          /* 0x00fb */ unsigned char BpbCtxSwapSetValue;
          /* 0x00fc */ unsigned char BpbPad[4];
        }; /* size: 0x0008 */
      }; /* size: 0x0008 */
    }; /* size: 0x0010 */
  ...
  /* 0x5c20 */ unsigned char PrcbPad81[7];
  /* 0x5c27 */ unsigned char TbFlushListActive;
  /* 0x5c28 */ unsigned __int64 PrcbPad82[2];
  ...
  /* 0x6438 */ unsigned __int64 PrcbPad111[7];
  ...
  /* 0x6980 */ struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
  /* 0x69e0 */ unsigned char PrcbPad135[1184];
  ...
  /* 0x6e9c */ unsigned long PrcbPad139;
  /* 0x6ea0 */ unsigned __int64 PrcbPad140[508];
...
typedef struct _HEAP_SEG_CONTEXT
{
  ...
  /* 0x0060 */ struct RTL_HP_ENV_HANDLE EnvHandle;
  /* 0x0070 */ void* Heap;
} HEAP_SEG_CONTEXT, *PHEAP_SEG_CONTEXT; /* size: 0x0078 */
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x0044 */ unsigned long AllocatedFromMetadata : 1; /* bit position: 0 */
  /* 0x0048 */ unsigned __int64 LargeMetadataLock;
  ...
  /* 0x0160 */ union _RTL_RUN_ONCE StackTraceInitVar;
  /* 0x0168 */ unsigned __int64 ContextExtendLock;
  /* 0x0170 */ unsigned char* AllocatedBase;
  /* 0x0178 */ unsigned char* UncommittedBase;
  /* 0x0180 */ unsigned char* ReservedLimit;
  /* 0x0188 */ struct _HEAP_VS_CONTEXT VsContext;
  /* 0x0200 */ struct _HEAP_LFH_CONTEXT LfhContext;
} SEGMENT_HEAP, *PSEGMENT_HEAP; /* size: 0x06f0 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_87[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_88[2];
  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0828 */ unsigned long Reserved : 1; /* bit position: 30 */
      }; /* bitfield */
...
} EPROCESS, *PEPROCESS; /* size: 0x0848 */
...
typedef struct _HEAP_VAMGR_RANGE
{
  union
  {
    ...
    struct
    {
      ...
      /* 0x0008 */ unsigned __int64 OwnerCtx;
      /* 0x0010 */ unsigned __int64 Spare1;
    }; /* size: 0x0012 */
  }; /* size: 0x0018 */
  union
  {
...
} RTLP_HP_HEAP_GLOBALS, *PRTLP_HP_HEAP_GLOBALS; /* size: 0x0018 */
