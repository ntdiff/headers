...
typedef struct _KPRCB
{
  ...
  /* 0x06d0 */ unsigned __int64 PrcbPad12[4];
...
HalpIommuGetPlatformSpecificPageTableConfigs
...
HalpTimerReadTimeStampCounterWithFence
