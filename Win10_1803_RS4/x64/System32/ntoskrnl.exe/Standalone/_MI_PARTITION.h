...
typedef struct _MI_PARTITION_SEGMENTS
{
  ...
  /* 0x0158 */ unsigned __int64 UnusedSegmentPagedPool;
  /* 0x0160 */ struct _LIST_ENTRY UnusedSegmentList;
  /* 0x0170 */ struct _LIST_ENTRY UnusedSubsectionList;
  ...
  /* 0x01b0 */ struct _MI_PTE_CHAIN_HEAD FreeSystemCache;
  /* 0x01c8 */ struct _KEVENT CloneDereferenceEvent;
  ...
  /* 0x0218 */ struct _MI_CROSS_PARTITION_CHARGES SharedCharges[7];
  /* 0x02f8 */ struct _KEVENT* SharedChargesDrainEvent;
  /* 0x0300 */ struct _KEVENT* ControlAreasDrainEvent;
  /* 0x0308 */ struct _KEVENT* CloneHeaderDrainEvent;
  /* 0x0310 */ struct _EX_RUNDOWN_REF_CACHE_AWARE* ProbeRundownReference;
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0a5e */ unsigned char LargePfnBitMapsReady;
  ...
  /* 0x0b70 */ struct _MI_LARGE_PAGE_CANDIDATES LargePageCandidates[2];
  /* 0x0f80 */ struct _WORK_QUEUE_ITEM RebuildLargePageWorkItem;
  /* 0x0fa0 */ unsigned char RebuildLargePageActive;
  /* 0x0fa4 */ volatile long LargePageRebuildLock;
  /* 0x0fa8 */ unsigned __int64 LowMemoryThreshold;
  /* 0x0fb0 */ unsigned __int64 HighMemoryThreshold;
  /* 0x0fb8 */ long __PADDING__[2];
...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0840 */ struct _MI_PARTITION_PAGE_LISTS PageLists;
  /* 0x1800 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1880 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x18e8 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x1a70 */ void* WorkingSetControl;
  /* 0x1a78 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1ac0 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x2cc0 */
