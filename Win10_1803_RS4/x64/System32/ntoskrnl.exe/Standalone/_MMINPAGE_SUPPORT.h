...
typedef struct _MMINPAGE_SUPPORT
{
  ...
  /* 0x0100 */ volatile __int64 ProbeCount;
  /* 0x0108 */ struct _MDL Mdl;
  union
  {
    /* 0x0138 */ unsigned __int64 Page[16];
    struct
    {
      /* 0x0138 */ struct _MMINPAGE_SUPPORT_FLOW_THROUGH FlowThrough;
      /* 0x0170 */ long __PADDING__[18];
    }; /* size: 0x0080 */
  }; /* size: 0x0080 */
} MMINPAGE_SUPPORT, *PMMINPAGE_SUPPORT; /* size: 0x01b8 */
