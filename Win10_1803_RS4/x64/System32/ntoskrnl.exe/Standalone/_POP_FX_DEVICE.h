...
} POP_FX_DRIVER_CALLBACKS, *PPOP_FX_DRIVER_CALLBACKS; /* size: 0x0040 */
...
typedef struct _POP_FX_ACCOUNTING
{
  ...
  /* 0x0030 */ unsigned __int64 CriticalActiveTimeBuckets[5];
  /* 0x0058 */ unsigned __int64 CsActiveTimeBuckets[5];
} POP_FX_ACCOUNTING, *PPOP_FX_ACCOUNTING; /* size: 0x0080 */
...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x00b0 */ void* DriverContext;
  /* 0x00b8 */ struct _LIST_ENTRY AcpiLink;
  /* 0x00c8 */ struct _UNICODE_STRING DeviceId;
  /* 0x00d8 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x00f8 */ struct _IO_REMOVE_LOCK AcpiRemoveLock;
  /* 0x0118 */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x0150 */ unsigned __int64 IdleLock;
  /* 0x0158 */ struct _KTIMER IdleTimer;
  /* 0x0198 */ struct _KDPC IdleDpc;
  /* 0x01d8 */ unsigned __int64 IdleTimeout;
  /* 0x01e0 */ unsigned __int64 IdleStamp;
  /* 0x01e8 */ struct _DEVICE_OBJECT* NextIrpDeviceObject[2];
  /* 0x01f8 */ union _POWER_STATE NextIrpPowerState[2];
  /* 0x0200 */ void* NextIrpCallerCompletion[2] /* function */;
  /* 0x0210 */ void* NextIrpCallerContext[2];
  /* 0x0220 */ struct _KEVENT IrpCompleteEvent;
  /* 0x0238 */ void* PowerOnDumpDeviceCallback /* function */;
  /* 0x0240 */ struct _POP_FX_ACCOUNTING Accounting;
  /* 0x02c0 */ volatile unsigned long Flags;
  /* 0x02c4 */ unsigned long ComponentCount;
  /* 0x02c8 */ struct _POP_FX_COMPONENT** Components;
  /* 0x02d0 */ unsigned long LogEntries;
  /* 0x02d8 */ struct _POP_FX_LOG_ENTRY* Log;
  /* 0x02e0 */ volatile long LogIndex;
  /* 0x02e8 */ struct _DRIVER_OBJECT* DripsWatchdogDriverObject;
  /* 0x02f0 */ struct _POP_FX_DRIPS_WATCHDOG_CONTEXT DripsWatchdogContext;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x0318 */
