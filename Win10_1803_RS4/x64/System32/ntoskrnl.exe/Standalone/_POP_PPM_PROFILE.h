...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x0071 */ unsigned char HeteroDecreaseThreshold[1280];
  /* 0x0571 */ unsigned char HeteroIncreaseThreshold[1280];
  /* 0x0a71 */ unsigned char Class0FloorPerformance;
  /* 0x0a72 */ unsigned char Class1InitialPerformance;
