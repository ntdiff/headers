...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0190 */ unsigned char DanglingExtentsWorkerActive;
  /* 0x0191 */ unsigned char PurgingExtentsNeedWatchdog;
  /* 0x0198 */ struct _RTL_AVL_TREE PrototypePtesTree;
  /* 0x01a0 */ volatile long PrototypePtesTreeSpinLock;
  /* 0x01a4 */ unsigned long ImageBias;
  /* 0x01a8 */ struct _EX_PUSH_LOCK RelocateBitmapsLock;
  /* 0x01b0 */ struct _RTL_BITMAP ImageBitMap;
  /* 0x01c0 */ unsigned long ImageBias64Low;
  /* 0x01c4 */ unsigned long ImageBias64High;
  /* 0x01c8 */ struct _RTL_BITMAP ImageBitMap64Low;
  /* 0x01d8 */ struct _RTL_BITMAP ImageBitMap64High;
  /* 0x01e8 */ struct _RTL_BITMAP ImageBitMapWow64Dll;
  /* 0x01f8 */ void* ApiSetSection;
  /* 0x0200 */ void* ApiSetSchema;
  /* 0x0208 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x0210 */ unsigned long LostDataFiles;
  /* 0x0214 */ unsigned long LostDataPages;
  /* 0x0218 */ unsigned long ImageFailureReason;
  /* 0x0220 */ struct _SECTION* CfgBitMapSection32;
  /* 0x0228 */ struct _CONTROL_AREA* CfgBitMapControlArea32;
  /* 0x0230 */ struct _SECTION* CfgBitMapSection64;
  /* 0x0238 */ struct _CONTROL_AREA* CfgBitMapControlArea64;
  /* 0x0240 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x0250 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x0258 */ unsigned long ImageCfgFailure;
  /* 0x025c */ unsigned long ImageChecksumBreakpoint;
  /* 0x0260 */ unsigned long ImageSizeBreakpoint;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0548 */ struct _MI_PROCESS_STATE Processes;
  /* 0x0590 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x0700 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x0c00 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x0c18 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x0c40 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x0ca0 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x0d18 */ struct _MI_ERROR_STATE Errors;
  /* 0x0e00 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x0e80 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x0fa0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x1040 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x1240 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x12b0 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x1300 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x13c0 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x1400 */ unsigned __int64 Cookie;
  /* 0x1408 */ void* volatile* BootRegistryRuns;
  /* 0x1410 */ volatile long ZeroingDisabled;
  /* 0x1414 */ unsigned char FullyInitialized;
  /* 0x1415 */ unsigned char SafeBooted;
  /* 0x1418 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x1440 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x2080 */
