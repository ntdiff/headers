...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_67[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_68[12];
...
{
  /* 0x0000 */ long Padding_69[8];
  /* 0x0020 */ unsigned long ItemLength;
  /* 0x0024 */ long Padding_70;
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_200;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_201[2];
...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0041 */ char Padding_221[7];
  /* 0x0048 */ struct _REFERENCE_EX Ref;
  /* 0x0060 */ int FakeStatus;
  /* 0x0064 */ long Padding_222;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1096 */ char Padding_298[2];
  /* 0x1098 */ unsigned long DirectOidRequestCount;
  /* 0x109c */ long Padding_299;
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_399;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_400[2];
...
{
  /* 0x0000 */ long Padding_433[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_434;
...
?Feature_Servicing_WDFPowerReferenceLeak_28414639__private_IsEnabled@@YAHXZ
