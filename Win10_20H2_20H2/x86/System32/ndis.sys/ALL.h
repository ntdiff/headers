...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_140;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_141[2];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_160;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_161[2];
...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0048 */ long Padding_162[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_163[14];
...
{
  /* 0x0000 */ long Padding_192[4];
  /* 0x0010 */ unsigned char ProtocolId;
  /* 0x0011 */ char Padding_193;
...
?Feature_Servicing_WDFPowerReferenceLeak_28414639__private_IsEnabled@@YGHXZ
