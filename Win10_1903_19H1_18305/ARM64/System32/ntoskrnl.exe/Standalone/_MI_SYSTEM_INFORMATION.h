...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x01e8 */ struct _MI_SECTION_WOW_STATE Wow[2];
  /* 0x0228 */ unsigned __int64 ImageBiasWow;
  /* 0x0230 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  /* 0x0240 */ void* ApiSetSection;
  /* 0x0248 */ void* ApiSetSchema;
  /* 0x0250 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x0258 */ unsigned long LostDataFiles;
  /* 0x025c */ unsigned long LostDataPages;
  /* 0x0260 */ unsigned long ImageFailureReason;
  /* 0x0268 */ struct _SECTION* CfgBitMapSection;
  /* 0x0270 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0278 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x0288 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x0290 */ unsigned long ImageCfgFailure;
  /* 0x0294 */ unsigned long ImageBreakpointEnabled;
  /* 0x0298 */ unsigned long ImageBreakpointChecksum;
  /* 0x029c */ unsigned long ImageBreakpointSize;
  /* 0x02a0 */ volatile long ImageValidationFailed;
  /* 0x02a8 */ struct _RTL_AVL_TREE ImageExtentTree;
  /* 0x02b0 */ struct _EX_PUSH_LOCK ImageExtentTreeLock;
  /* 0x02b8 */ unsigned long HotPatchReserveSize;
  /* 0x02bc */ long __PADDING__[17];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x04a0 */ struct _MI_SESSION_STATE Sessions;
  /* 0x1520 */ struct _MI_PROCESS_STATE Processes;
  ...
  /* 0x1c48 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1ca8 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1d20 */ struct _MI_ERROR_STATE Errors;
  /* 0x1e00 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x1f00 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x2020 */ struct _MI_STANDBY_STATE Standby;
  ...
  /* 0x2580 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3100 */
