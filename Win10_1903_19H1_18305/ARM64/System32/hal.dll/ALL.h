...
typedef enum _HAL_INIT_PHASE
{
  ...
  HalInitPhaseInitializeTelemetry = 31,
  HalInitPhaseTelemetryReady = 32,
  HalInitPhaseTelemetryEnd = 33,
...
typedef struct _WHEA_AMD_EXTENDED_REGISTERS
{
  ...
  /* 0x0048 */ unsigned __int64 Reserved[15];
