typedef enum _POWER_INFORMATION_LEVEL_INTERNAL
{
  ...
  PowerInternalDirectedFxQueryDevices = 52,
  PowerInternalDirectedFxAddTestDevice = 53,
  PowerInternalDirectedFxRemoveTestDevice = 54,
  PowerInternalDirectedFxQueryDeviceStats = 55,
  PowerInternalDirectedFxSetMode = 56,
  PowerInternalSessionMonitorState = 57,
  PowerInternalRegisterPowerPlane = 58,
  PowerInternalSetDirectedDripsFlags = 59,
  PowerInternalClearDirectedDripsFlags = 60,
  PowerInformationInternalMaximum = 61,
