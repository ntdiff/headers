...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x0004 */ enum _TAG_UNNAMED_116 Action;
  /* 0x0008 */ enum _SYSTEM_POWER_STATE LightestState;
  /* 0x000c */ unsigned long Flags;
  /* 0x0010 */ long Status;
  /* 0x0014 */ enum _TAG_UNNAMED_245 DeviceType;
  ...
  /* 0x0060 */ enum _TAG_UNNAMED_252 WakeAlarmSignaled;
  /* 0x0068 */ struct // _TAG_UNNAMED_253
  {
  ...
  /* 0x0118 */ struct _KDPC WatchdogDpc;
  /* 0x0158 */ struct _KTIMER WatchdogTimer;
  /* 0x0198 */ unsigned char WatchdogInitialized;
  /* 0x0199 */ unsigned char WatchdogEnabled;
  /* 0x01a0 */ unsigned __int64 WatchdogStartTime;
  /* 0x01a8 */ struct _KTHREAD* ActionWorkerThread;
  /* 0x01b0 */ struct _KTHREAD* PromoteActionWorkerThread;
} POP_POWER_ACTION, *PPOP_POWER_ACTION; /* size: 0x01b8 */
