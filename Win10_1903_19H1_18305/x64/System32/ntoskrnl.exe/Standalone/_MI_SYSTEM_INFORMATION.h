...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x01b0 */ unsigned char DanglingExtentsWorkerActive;
  /* 0x01b1 */ unsigned char PurgingExtentsNeedWatchdog;
  ...
  /* 0x01e8 */ struct _MI_SECTION_WOW_STATE Wow[1];
  /* 0x0208 */ unsigned __int64 ImageBiasWow;
  /* 0x0210 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  /* 0x0220 */ struct _RTL_BITMAP_EX ImageBitMap64Low;
  /* 0x0230 */ unsigned __int64 ImageBias64Low;
  /* 0x0238 */ void* ApiSetSection;
  /* 0x0240 */ void* ApiSetSchema;
  /* 0x0248 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x0250 */ unsigned long LostDataFiles;
  /* 0x0254 */ unsigned long LostDataPages;
  /* 0x0258 */ unsigned long ImageFailureReason;
  /* 0x0260 */ struct _SECTION* CfgBitMapSection;
  /* 0x0268 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0270 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x0280 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x0288 */ unsigned long ImageCfgFailure;
  /* 0x028c */ unsigned long RetpolineReservePages;
  /* 0x0290 */ struct _MDL* RetpolineStubMdl;
  /* 0x0298 */ struct _RTL_BITMAP_EX KernelRetpolineBitMap;
  /* 0x02a8 */ struct _RTL_RETPOLINE_ROUTINES* RetpolineRoutines;
  /* 0x02b0 */ struct _MMPTE* RetpolineRevertPte;
  /* 0x02b8 */ struct _LIST_ENTRY NonRetpolineImageLoadList;
  /* 0x02c8 */ unsigned long RetpolineStubPages;
  /* 0x02cc */ unsigned long ImageBreakpointEnabled;
  /* 0x02d0 */ unsigned long ImageBreakpointChecksum;
  /* 0x02d4 */ unsigned long ImageBreakpointSize;
  /* 0x02d8 */ volatile long ImageValidationFailed;
  /* 0x02e0 */ struct _RTL_AVL_TREE ImageExtentTree;
  /* 0x02e8 */ struct _EX_PUSH_LOCK ImageExtentTreeLock;
  /* 0x02f0 */ unsigned long HotPatchReserveSize;
  /* 0x02f4 */ long __PADDING__[3];
...
typedef struct _MI_SYSTEM_VA_STATE
{
  ...
  /* 0x01c0 */ void* HalPrivateVaStart;
  /* 0x01c8 */ unsigned __int64 HalPrivateVaSize;
  /* 0x01d0 */ unsigned long SystemVaAssignment[8];
  /* 0x01f0 */ unsigned long SystemVaAssignmentHint;
  /* 0x01f4 */ unsigned long TopLevelPteLockBits[32];
  /* 0x0274 */ volatile long DeleteKvaLock;
  /* 0x0278 */ struct _MI_WSLE* WsleArrays[8];
  /* 0x02b8 */ void* PagableHyperSpace;
  /* 0x02c0 */ void* HyperSpaceEnd;
  /* 0x02c8 */ unsigned __int64 PagableHyperSpaceBytes;
  /* 0x02d0 */ unsigned __int64 PageTableCommitmentOffset[2];
  /* 0x02e0 */ struct _KEVENT FreeSystemCacheVa;
  /* 0x02f8 */ unsigned __int64 SystemVaLock;
  /* 0x0300 */ unsigned __int64 SystemCacheViewLock;
  /* 0x0308 */ struct _MMWSL_INSTANCE SystemWorkingSetList[8];
  /* 0x0448 */ unsigned __int64 SelfmapLock[4];
  /* 0x0468 */ long __PADDING__[6];
} MI_SYSTEM_VA_STATE, *PMI_SYSTEM_VA_STATE; /* size: 0x0480 */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0780 */ struct _MMSUPPORT_SHARED SystemCacheShared;
  /* 0x0800 */ struct _MMSUPPORT_AGGREGATION AggregateSystemWs[1];
  /* 0x0820 */ unsigned long MapCacheFailures;
  /* 0x0828 */ unsigned __int64 PagefileHashPages;
  /* 0x0830 */ struct _SYSPTES_HEADER PteHeader;
  /* 0x0948 */ unsigned __int64 SystemVaTypeCount[15];
  /* 0x09c0 */ unsigned char SystemVaType[256];
  /* 0x0ac0 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[12];
} MI_VISIBLE_STATE, *PMI_VISIBLE_STATE; /* size: 0x0b80 */

typedef struct _MI_SYSTEM_INFORMATION
{
  /* 0x0000 */ struct _MI_POOL_STATE Pools;
  /* 0x00c0 */ struct _MI_SECTION_STATE Sections;
  /* 0x03c0 */ struct _MI_SYSTEM_IMAGE_STATE SystemImages;
  /* 0x0460 */ struct _MI_SESSION_STATE Sessions;
  /* 0x14e0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1540 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1700 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x1b80 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x1ba0 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x1bc8 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1c28 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1ca0 */ struct _MI_ERROR_STATE Errors;
  /* 0x1d80 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x1e00 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x1f20 */ struct _MI_STANDBY_STATE Standby;
  /* 0x1fc0 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x21c0 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x2230 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x2280 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2340 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2380 */ unsigned __int64 Cookie;
  /* 0x2388 */ void* volatile* BootRegistryRuns;
  /* 0x2390 */ volatile long ZeroingDisabled;
  /* 0x2394 */ unsigned char FullyInitialized;
  /* 0x2395 */ unsigned char SafeBooted;
  /* 0x2398 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x23c0 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x2f40 */
