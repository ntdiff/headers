...
typedef struct __midl_frag139_t
{
  ...
  struct
  {
    /* 0x0040 */ unsigned short frag1;
    /* 0x0042 */ unsigned char frag2;
    /* 0x0043 */ unsigned char frag3[3];
  } /* size: 0x0006 */ frag5;
  /* 0x0046 */ char __PADDING__[2];
} _midl_frag139_t, *P_midl_frag139_t; /* size: 0x0048 */
