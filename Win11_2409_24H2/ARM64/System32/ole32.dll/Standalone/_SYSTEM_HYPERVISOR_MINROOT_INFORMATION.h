typedef struct _HV_MINROOT_NUMA_LPS
{
  ...
  /* 0x0008 */ unsigned __int64 Mask[32];
} HV_MINROOT_NUMA_LPS, *PHV_MINROOT_NUMA_LPS; /* size: 0x0108 */
...
} SYSTEM_HYPERVISOR_MINROOT_INFORMATION, *PSYSTEM_HYPERVISOR_MINROOT_INFORMATION; /* size: 0x4298 */
