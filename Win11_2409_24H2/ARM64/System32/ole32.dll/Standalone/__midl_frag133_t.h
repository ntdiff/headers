...
typedef struct __midl_frag133_t
{
  ...
  struct
  {
    /* 0x0050 */ unsigned short frag1;
    /* 0x0052 */ unsigned char frag2;
    /* 0x0053 */ unsigned char frag3[4];
    /* 0x0057 */ char __PADDING__[1];
  } /* size: 0x0008 */ frag6;
} _midl_frag133_t, *P_midl_frag133_t; /* size: 0x0058 */
