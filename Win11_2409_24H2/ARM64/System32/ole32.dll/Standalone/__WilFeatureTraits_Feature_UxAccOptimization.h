...
typedef struct __WilFeatureTraits_Feature_UxAccOptimization
{
  union
  {
...
} _WilFeatureTraits_Feature_UxAccOptimization, *P_WilFeatureTraits_Feature_UxAccOptimization; /* size: 0x0001 */
