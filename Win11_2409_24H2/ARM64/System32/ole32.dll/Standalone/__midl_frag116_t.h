...
typedef struct __midl_frag116_t
{
  ...
  struct
  {
    /* 0x00a0 */ unsigned short frag1;
    /* 0x00a2 */ unsigned char frag2;
    /* 0x00a3 */ unsigned char frag3[9];
  } /* size: 0x000c */ frag11;
  /* 0x00ac */ long __PADDING__[1];
} _midl_frag116_t, *P_midl_frag116_t; /* size: 0x00b0 */
