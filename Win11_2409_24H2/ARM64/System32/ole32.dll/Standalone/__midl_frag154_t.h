...
typedef struct __midl_frag154_t
{
  ...
  struct
  {
    /* 0x00f0 */ unsigned short frag1;
    /* 0x00f2 */ unsigned char frag2;
    /* 0x00f3 */ unsigned char frag3[12];
    /* 0x00ff */ char __PADDING__[1];
  } /* size: 0x0010 */ frag16;
} _midl_frag154_t, *P_midl_frag154_t; /* size: 0x0100 */
