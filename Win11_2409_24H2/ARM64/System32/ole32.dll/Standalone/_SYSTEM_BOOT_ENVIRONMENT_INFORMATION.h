...
typedef struct _SYSTEM_BOOT_ENVIRONMENT_INFORMATION
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0018 */ unsigned __int64 DbgBugCheckRecovery : 1; /* bit position: 14 */
      /* 0x0018 */ unsigned __int64 DbgFASR : 1; /* bit position: 15 */
      /* 0x0018 */ unsigned __int64 DbgUseCachedBcd : 1; /* bit position: 16 */
    }; /* bitfield */
  }; /* size: 0x0008 */
