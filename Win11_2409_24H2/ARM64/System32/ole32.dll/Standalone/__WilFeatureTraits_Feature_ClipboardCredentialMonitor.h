...
typedef struct __WilFeatureTraits_Feature_ClipboardCredentialMonitor
{
  union
  {
...
} _WilFeatureTraits_Feature_ClipboardCredentialMonitor, *P_WilFeatureTraits_Feature_ClipboardCredentialMonitor; /* size: 0x0001 */
