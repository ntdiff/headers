...
typedef struct __WilFeatureTraits_Feature_FixCPolicySetErrorSwallow
{
  union
  {
...
} _WilFeatureTraits_Feature_FixCPolicySetErrorSwallow, *P_WilFeatureTraits_Feature_FixCPolicySetErrorSwallow; /* size: 0x0001 */
