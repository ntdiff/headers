...
typedef struct _EXCEPTION_LOG
{
  ...
  /* 0x0430 */ enum _EXCEPTION_LOG_TYPE Type;
  /* 0x0434 */ long Disposition;
  /* 0x0438 */ unsigned __int64 Thread;
  /* 0x0440 */ unsigned __int64 ControlPc;
  /* 0x0448 */ void* Handler;
} EXCEPTION_LOG, *PEXCEPTION_LOG; /* size: 0x0450 */
