...
typedef struct __midl_frag206_t
{
  ...
  struct
  {
    /* 0x00b0 */ unsigned short frag1;
    /* 0x00b2 */ unsigned char frag2;
    /* 0x00b3 */ unsigned char frag3[10];
    /* 0x00bd */ char __PADDING__[1];
  } /* size: 0x000e */ frag12;
  /* 0x00be */ char __PADDING__[2];
} _midl_frag206_t, *P_midl_frag206_t; /* size: 0x00c0 */
