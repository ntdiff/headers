...
typedef struct __midl_frag174_t
{
  ...
  struct
  {
    /* 0x0130 */ unsigned short frag1;
    /* 0x0132 */ unsigned char frag2;
    /* 0x0133 */ unsigned char frag3[12];
    /* 0x013f */ char __PADDING__[1];
  } /* size: 0x0010 */ frag20;
} _midl_frag174_t, *P_midl_frag174_t; /* size: 0x0140 */
