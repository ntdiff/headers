typedef struct _SECURE_SPECULATION_CONTROL_INFORMATION
{
  struct
  {
    struct /* bitfield */
    {
      ...
      /* 0x0000 */ unsigned long ReturnSpeculate : 1; /* bit position: 14 */
      /* 0x0000 */ unsigned long BranchConfusionSafe : 1; /* bit position: 15 */
      /* 0x0000 */ unsigned long SsbsEnabledAlways : 1; /* bit position: 16 */
      /* 0x0000 */ unsigned long SsbsEnabledKernel : 1; /* bit position: 17 */
      /* 0x0000 */ unsigned long Reserved : 14; /* bit position: 18 */
    }; /* bitfield */
