...
typedef struct _WIN32_MEMORY_NUMA_PERFORMANCE_INFORMATION_OUTPUT
{
  ...
  /* 0x0008 */ struct _WIN32_MEMORY_NUMA_PERFORMANCE_ENTRY PerformanceEntries[1];
} WIN32_MEMORY_NUMA_PERFORMANCE_INFORMATION_OUTPUT, *PWIN32_MEMORY_NUMA_PERFORMANCE_INFORMATION_OUTPUT; /* size: 0x0028 */
