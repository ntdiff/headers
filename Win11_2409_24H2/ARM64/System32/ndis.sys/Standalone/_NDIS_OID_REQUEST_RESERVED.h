...
typedef struct _NDIS_OID_REQUEST_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long TelemetryFilter : 2; /* bit position: 28 */
    /* 0x0000 */ unsigned long Remainder : 2; /* bit position: 30 */
  }; /* bitfield */
...
typedef struct _NDIS_OID_REQUEST_RESERVED
{
  ...
  /* 0x0060 */ struct _GUID ActivityID;
} NDIS_OID_REQUEST_RESERVED, *PNDIS_OID_REQUEST_RESERVED; /* size: 0x0070 */
