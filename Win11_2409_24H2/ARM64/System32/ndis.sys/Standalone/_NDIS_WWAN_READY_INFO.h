...
typedef struct _WWAN_READY_INFO
{
  ...
  /* 0x0058 */ unsigned long SlotId;
  /* 0x005c */ struct _WWAN_LIST_HEADER TNListHeader;
} WWAN_READY_INFO, *PWWAN_READY_INFO; /* size: 0x0064 */

typedef struct _NDIS_WWAN_READY_INFO
{
  /* 0x0000 */ struct _NDIS_OBJECT_HEADER Header;
  /* 0x0004 */ struct _WWAN_READY_INFO ReadyInfo;
} NDIS_WWAN_READY_INFO, *PNDIS_WWAN_READY_INFO; /* size: 0x0068 */
