...
typedef struct _NBL_CONTEXT_VERIFIER_CONTEXT
{
  /* 0x0000 */ unsigned __int64 SendNetBufferListsDummyHandlerCallsCounter;
  /* 0x0008 */ unsigned __int64 SendNetBufferListsCompleteDummyHandlerCallsCounter;
  /* 0x0010 */ unsigned __int64 IndicateReceiveNetBufferListsDummyHandlerCallsCounter;
  /* 0x0018 */ unsigned __int64 ReturnNetBufferListsDummyHandlerCallsCounter;
} NBL_CONTEXT_VERIFIER_CONTEXT, *PNBL_CONTEXT_VERIFIER_CONTEXT; /* size: 0x0020 */
...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0350 */ struct _PKTMON_EDGE_CONTEXT PktMonEdgeLower;
  /* 0x0378 */ struct _PKTMON_EDGE_CONTEXT PktMonEdgeUpper;
  /* 0x03a0 */ struct _NBL_CONTEXT_VERIFIER_CONTEXT NblContextVerifierContext;
  /* 0x03c0 */ struct _NDIS_SRIOV_CAPABILITIES SriovHwCapabilities;
  /* 0x03cc */ struct _NDIS_SRIOV_CAPABILITIES SriovCurrentCapabilities;
  /* 0x03d8 */ struct _NDIS_NIC_SWITCH_CAPABILITIES NicSwitchHwCapabilities;
  /* 0x045c */ struct _NDIS_NIC_SWITCH_CAPABILITIES NicSwitchCurrentCapabilities;
  /* 0x04e0 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES ReceiveFilterHwCapabilities;
  /* 0x0534 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES ReceiveFilterCurrentCapabilities;
} NDIS_FILTER_BLOCK, *PNDIS_FILTER_BLOCK; /* size: 0x0588 */
