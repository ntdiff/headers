...
typedef struct _NDIS_MINIPORT_OFFLOAD_REG
{
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0000 */ unsigned long UdpRscDisabled : 1; /* bit position: 30 */
    }; /* bitfield */
...
typedef enum _NDIS_MINIPORT_EVENT
{
  ...
  NdisMEventD0_S0Idle = 25,
  NdisMEventDx_S0Idle = 26,
  NdisMEventD0_Sx = 27,
  NdisMEventDx_Sx = 28,
...
typedef enum _NDIS_PM_WAKE_REASON_TYPE
{
  ...
  NdisWakeReasonWlanIncomingActionFrame = 4100,
  NdisWakeReasonWlanClientDriverDiagnostic = 4101,
...
class Rtl::KArray<KnobDescriptor,1>
{
  /* 0x0000 */ unsigned long m_bufferSize;
  /* 0x0004 */ unsigned long m_numElements;
  /* 0x0008 */ struct KnobDescriptor* _p;
}; /* size: 0x0010 */
...
class wistd::__compressed_pair<NdisWdfIdle *,KFreePoolNP<NdisWdfIdle> >
{
}; /* size: 0x0008 */

class wistd::unique_ptr<NdisWdfIdle,KFreePoolNP<NdisWdfIdle> >
{
  /* 0x0000 */ class wistd::__compressed_pair<NdisWdfIdle *,KFreePoolNP<NdisWdfIdle> > __ptr_;
}; /* size: 0x0008 */
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x11f0 */ struct _NDIS_SRIOV_CAPABILITIES* TopSriovCurrentCapabilities;
  /* 0x11f8 */ unsigned __int64 InvalidateBlockMask;
  /* 0x1200 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x1208 */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x1210 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x1218 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x1230 */ unsigned short InvalidateVfId;
  /* 0x1232 */ unsigned char InvalidateBlockCancelling;
  /* 0x1233 */ unsigned char AllowMultipleVPortsPerVF;
  /* 0x1238 */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x1240 */ unsigned long NumSwitches;
  /* 0x1248 */ struct _LIST_ENTRY NicSwitchList;
  /* 0x1258 */ unsigned long NumAllocatedVFs;
  /* 0x1260 */ struct _LIST_ENTRY VFList;
  /* 0x1270 */ unsigned long NumActiveVPorts;
  /* 0x1278 */ struct _LIST_ENTRY VPortList;
  /* 0x1288 */ unsigned char* AllocatedVPortIndices;
  /* 0x1290 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x1298 */ void* SetVirtualFunctionData /* function */;
  /* 0x12a0 */ void* GetVirtualFunctionData /* function */;
  /* 0x12a8 */ void* EnableVirtualization /* function */;
  /* 0x12b0 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x12b8 */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x12c0 */ void* VirtInterfaceContext;
  /* 0x12c8 */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x12d8 */ void* VpciInterfaceDereference /* function */;
  /* 0x12e0 */ void* WriteVfConfigBlock /* function */;
  /* 0x12e8 */ void* ReadVfConfigBlock /* function */;
  /* 0x12f0 */ void* VpciInterfaceContext;
  /* 0x12f8 */ unsigned int VfSerialNumber;
  /* 0x12fc */ struct _LUID SriovLuid;
  /* 0x1308 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x1310 */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x1318 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x1320 */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x1328 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x1330 */ unsigned long QosOperationalParametersBufferSize;
  /* 0x1338 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x1340 */ unsigned long QosRemoteParametersBufferSize;
  /* 0x1348 */ unsigned __int64 DeviceFlags;
  /* 0x1350 */ void* VerifierContext;
  /* 0x1358 */ struct WORKITEM_WITH_IRP SurpriseRemovalWorkItem;
  /* 0x1380 */ struct Ndis::BindStack Bindings;
  /* 0x13e8 */ struct Ndis::BindEngine BindEngine;
  /* 0x1460 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x1488 */ BOOL PmInterruptedByPnp;
  /* 0x1489 */ BOOL DoNotBlockOnMiniportLock;
  /* 0x148a */ BOOL PoFxDStateReportingEnabled;
  /* 0x1490 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x1498 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x14b8 */ BOOL InterfaceUpdateInProgress;
  /* 0x14b9 */ BOOL MacAddressUpdateQueued;
  /* 0x14ba */ BOOL MtuUpdateQueued;
  /* 0x14bc */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x14e0 */ unsigned long PendingMtuSize;
  /* 0x14e8 */ wchar_t* PnPInstanceId;
  /* 0x14f0 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x1518 */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x1540 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x1548 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x1550 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > ReenumerateWatchdog;
  /* 0x1558 */ struct _NDIS_PD_BLOCK* PDBlock;
  /* 0x1560 */ void* PdcHandle;
  /* 0x1568 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x15e8 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x1638 */ volatile long PdcTaskClientMode;
  /* 0x163c */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x1640 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x1648 */ volatile long RssV2CompletionCount;
  /* 0x1650 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x1668 */ unsigned char RssV2Initialized;
  /* 0x1670 */ struct _LIST_ENTRY SynchronousOidCalls;
  /* 0x1680 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCapabilities;
  /* 0x1688 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCurrentConfig;
  /* 0x1690 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopTimestampConfig;
  /* 0x1698 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopHwTimestampCapabilities;
  /* 0x16a0 */ struct _PKTMON_COMPONENT_CONTEXT PktMonComp;
  /* 0x16e0 */ struct _PKTMON_EDGE_CONTEXT PktMonEdge;
  /* 0x1708 */ class KnobNamespace PollModeConfigKnobsNamespace;
  /* 0x1750 */ class Rtl::KArray<KnobDescriptor,1> PollModeConfigKnobDescriptors;
  /* 0x1760 */ struct _EXECUTION_CONTEXT_RUNTIME_KNOBS PollModeConfigKnobs;
  /* 0x179c */ struct _GUID PnPActivityID;
  /* 0x17b0 */ class wistd::unique_ptr<NdisWdfIdle,KFreePoolNP<NdisWdfIdle> > IdleSm;
  /* 0x17b8 */ BOOL HasConversionFilter;
  /* 0x17b9 */ char __PADDING__[7];
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x17c0 */
