...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0041 */ char Padding_76[7];
  /* 0x0048 */ struct _REFERENCE_EX Ref;
  /* 0x0060 */ int FakeStatus;
  /* 0x0064 */ long Padding_77;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x107e */ char Padding_141[2];
  /* 0x1080 */ unsigned long DirectOidRequestCount;
  /* 0x1084 */ long Padding_142;
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_196[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_197[28];
...
{
  /* 0x0000 */ long Padding_220[10];
  /* 0x0028 */ unsigned char ProtocolId;
  /* 0x0029 */ char Padding_221;
...
typedef struct _TCP_OFFLOAD_STATE_DELEGATED
{
  ...
  /* 0x004e */ char Padding_385[2];
  struct
  {
    /* 0x0050 */ unsigned char ProbeCount;
    /* 0x0001 */ char Padding_386[3];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_473;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_474[2];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_480;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_481[2];
...
??$ndisIterativeDPSaveNumNbls@$01@@YAXPEAU_NET_BUFFER_LIST@@K@Z
...
??1?$out_param_t@V?$unique_ptr@U_UNICODE_STRING@@U?$KFreePool@U_UNICODE_STRING@@@@@wistd@@@details@wil@@QEAA@XZ
??1?$out_param_t@V?$unique_ptr@_WU?$KFreePool@_W@@@wistd@@@details@wil@@QEAA@XZ
...
??1NDIS_BIND_FILTER_LINK@@QEAA@XZ
??1NDIS_BIND_LINK_BASE@@QEAA@XZ
??1NDIS_BIND_PROTOCOL_DRIVER@@QEAA@XZ
??1NDIS_BIND_PROTOCOL_LINK@@QEAA@XZ
...
??3?$KALLOCATOR@$0EDGCGOEL@$00@@SAXPEAX@Z
...
??A?$KArray@PEAU_KStringAtom@Rtl@@$00@Rtl@@QEAAAEAPEAU_KStringAtom@1@_K@Z
??A?$KArray@PEAX$00@Rtl@@QEAAAEAPEAX_K@Z
??A?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@QEAAAEAV?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@_K@Z
??A?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@QEAAAEAV?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@_K@Z
...
?GetDuration_us@?$FunctionCallTracker@H@@QEBA_KXZ
?GetDuration_us@?$FunctionCallTracker@J@@QEBA_KXZ
?GetDuration_us@?$FunctionCallTracker@PEAX@@QEBA_KXZ
?GetDuration_us@?$FunctionCallTracker@X@@QEBA_KXZ
?GetElapsedTimeInMicroseconds@KStopwatch@@QEBA_KXZ
?GetElapsedTimeInMilliseconds@KStopwatch@@QEBA_KXZ
?GetEventIdFromEventIndex@StateMachineEngineImpl@StateMachineEngine@SmFx@@AEBAGG@Z
...
?IsUdpRscSupportedVersion@@YA_NKK@Z
...
?SetValueBlob@KRegKey@@QEAAJPEB_WKPEBE@Z
...
?append@?$KArray@ULwfBindProperties@@$00@Rtl@@QEAA_N$$QEAULwfBindProperties@@@Z
?append@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@$00@Rtl@@QEAA_NAEBV?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@@Z
...
?ndisCallPreviousSendCompleteHandler@@YAXPEAU_NDIS_OBJECT_HEADER@@PEAU_NET_BUFFER_LIST@@K@Z
