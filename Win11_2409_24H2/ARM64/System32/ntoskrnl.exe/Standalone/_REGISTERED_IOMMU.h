...
typedef struct _REGISTERED_IOMMU
{
  ...
  /* 0x0100 */ struct _EXT_IOMMU_FUNCTION_TABLE_EXTENDED FunctionTableExtended;
  /* 0x01b0 */ unsigned long Flags;
  /* 0x01b8 */ struct _IOMMU_PAGE_HANDLING_DATA PageHandling;
  /* 0x01e0 */ unsigned long MaximumDomainIds;
  /* 0x01e8 */ unsigned __int64 DomainIdBitmapLock;
  /* 0x01f0 */ struct _RTL_BITMAP DomainIdBitmap;
  /* 0x0200 */ unsigned long Capabilities;
  /* 0x0204 */ enum _EXT_IOMMU_KNOWN_IOMMU_TYPE KnownType;
  /* 0x0208 */ unsigned long PciSegment;
  /* 0x020c */ unsigned long PciBus;
  /* 0x0210 */ struct _PCI_SLOT_NUMBER PciSlot;
  /* 0x0218 */ union _LARGE_INTEGER MsiAddress;
  /* 0x0220 */ unsigned __int64 MsiData;
  /* 0x0228 */ unsigned long MaximumAsids;
  /* 0x022c */ unsigned long Identifier;
  /* 0x0230 */ struct _UNICODE_STRING ResourceId;
  /* 0x0240 */ struct _IOMMU_RESERVED_DEVICE_LIST* ReservedDevices;
} REGISTERED_IOMMU, *PREGISTERED_IOMMU; /* size: 0x0248 */
