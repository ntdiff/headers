...
{
  /* 0x0000 */ unsigned char Enabled;
} NDIS_UDP_RSC_OFFLOAD, *PNDIS_UDP_RSC_OFFLOAD; /* size: 0x0001 */
...
typedef struct _NDIS_OFFLOAD
{
  ...
  /* 0x00d8 */ struct _NDIS_UDP_RSC_OFFLOAD UdpRsc;
  /* 0x00d9 */ char __PADDING__[3];
} NDIS_OFFLOAD, *PNDIS_OFFLOAD; /* size: 0x00dc */
...
typedef struct _NDIS_MINIPORT_OFFLOAD
{
  ...
  /* 0x0006 */ unsigned char UdpRscDisallowed;
  /* 0x0007 */ unsigned char UdpRscPreviouslyEnabled;
  /* 0x0008 */ struct _NDIS_OFFLOAD MiniportCurrentConfig;
  /* 0x00e4 */ struct _NDIS_OFFLOAD TopCapabilities;
  /* 0x01c0 */ struct _NDIS_OFFLOAD MiniportInitialConfig;
  /* 0x029c */ struct _NDIS_OFFLOAD MiniportHardwareCapabilities;
  /* 0x0378 */ struct _NDIS_OFFLOAD_ENCAPSULATION MiniportSetEncapsulation;
  /* 0x0394 */ struct _NDIS_OFFLOAD_ENCAPSULATION TopSetEncapsulation;
  /* 0x03b0 */ struct _NDIS_OFFLOAD_ENCAPSULATION TopMergedEncapsulation;
  /* 0x03cc */ struct _NDIS_OFFLOAD_ENCAPSULATION MiniportMergedEncapsulation;
  /* 0x03e8 */ struct _NDIS_TCP_CONNECTION_OFFLOAD TopTcpConnectionOffloadCapabilities;
  /* 0x03fc */ struct _NDIS_TCP_CONNECTION_OFFLOAD MiniportTcpConnectionOffloadCurrentConfig;
  /* 0x0410 */ struct _NDIS_TCP_CONNECTION_OFFLOAD MiniportHwTcpConnectionOffloadCapabilities;
  /* 0x0424 */ struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS TopTcpConnectionParameters;
  /* 0x0460 */ struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS MiniportTcpConnectionParameters;
  /* 0x049c */ unsigned char MiniportTask[144];
  /* 0x052c */ unsigned long MiniportTaskSize;
  /* 0x0530 */ unsigned char Ndis5Xsum;
  /* 0x0531 */ unsigned char Ndis5LSO;
  /* 0x0532 */ unsigned char Ndis5IPsec;
  /* 0x0538 */ void* MiniportRequestBuffer;
  /* 0x0540 */ unsigned long MiniportRequestOid;
  /* 0x0544 */ unsigned long MiniportRequestBufferLength;
} NDIS_MINIPORT_OFFLOAD, *PNDIS_MINIPORT_OFFLOAD; /* size: 0x0548 */
