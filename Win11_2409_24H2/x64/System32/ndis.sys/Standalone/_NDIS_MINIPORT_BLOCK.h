...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1208 */ struct _NDIS_SRIOV_CAPABILITIES* TopSriovCurrentCapabilities;
  /* 0x1210 */ unsigned __int64 InvalidateBlockMask;
  /* 0x1218 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x1220 */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x1228 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x1230 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x1248 */ unsigned short InvalidateVfId;
  /* 0x124a */ unsigned char InvalidateBlockCancelling;
  /* 0x124b */ unsigned char AllowMultipleVPortsPerVF;
  /* 0x1250 */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x1258 */ unsigned long NumSwitches;
  /* 0x1260 */ struct _LIST_ENTRY NicSwitchList;
  /* 0x1270 */ unsigned long NumAllocatedVFs;
  /* 0x1278 */ struct _LIST_ENTRY VFList;
  /* 0x1288 */ unsigned long NumActiveVPorts;
  /* 0x1290 */ struct _LIST_ENTRY VPortList;
  /* 0x12a0 */ unsigned char* AllocatedVPortIndices;
  /* 0x12a8 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x12b0 */ void* SetVirtualFunctionData /* function */;
  /* 0x12b8 */ void* GetVirtualFunctionData /* function */;
  /* 0x12c0 */ void* EnableVirtualization /* function */;
  /* 0x12c8 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x12d0 */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x12d8 */ void* VirtInterfaceContext;
  /* 0x12e0 */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x12f0 */ void* VpciInterfaceDereference /* function */;
  /* 0x12f8 */ void* WriteVfConfigBlock /* function */;
  /* 0x1300 */ void* ReadVfConfigBlock /* function */;
  /* 0x1308 */ void* VpciInterfaceContext;
  /* 0x1310 */ unsigned int VfSerialNumber;
  /* 0x1314 */ struct _LUID SriovLuid;
  /* 0x1320 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x1328 */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x1330 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x1338 */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x1340 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x1348 */ unsigned long QosOperationalParametersBufferSize;
  /* 0x1350 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x1358 */ unsigned long QosRemoteParametersBufferSize;
  /* 0x1360 */ unsigned __int64 DeviceFlags;
  /* 0x1368 */ void* VerifierContext;
  /* 0x1370 */ struct WORKITEM_WITH_IRP SurpriseRemovalWorkItem;
  /* 0x1398 */ struct Ndis::BindStack Bindings;
  /* 0x1400 */ struct Ndis::BindEngine BindEngine;
  /* 0x1478 */ class Rtl::KNeutralLock<enum NDIS_MINIPORT_POLICY_OWNER> MiniportOwner;
  /* 0x14a0 */ BOOL PmInterruptedByPnp;
  /* 0x14a1 */ BOOL DoNotBlockOnMiniportLock;
  /* 0x14a2 */ BOOL PoFxDStateReportingEnabled;
  /* 0x14a8 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x14b0 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x14d0 */ BOOL InterfaceUpdateInProgress;
  /* 0x14d1 */ BOOL MacAddressUpdateQueued;
  /* 0x14d2 */ BOOL MtuUpdateQueued;
  /* 0x14d4 */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x14f8 */ unsigned long PendingMtuSize;
  /* 0x1500 */ wchar_t* PnPInstanceId;
  /* 0x1508 */ struct WORKITEM_WITH_IRP DevicePowerOnWorkItem;
  /* 0x1530 */ struct WORKITEM_WITH_IRP DevicePowerDownWorkItem;
  /* 0x1558 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > PendingOidWatchdog;
  /* 0x1560 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > HookedOidWatchdog;
  /* 0x1568 */ class wil::unique_any_t<wil::details::unique_storage<wil::details::resource_policy<NDISWATCHDOG__ *,void (__cdecl*)(NDISWATCHDOG__ *),&ndisFreeWatchdog,wistd::integral_constant<unsigned __int64,1>,NDISWATCHDOG__ *,__int64,-1,std::nullptr_t> > > ReenumerateWatchdog;
  /* 0x1570 */ struct _NDIS_PD_BLOCK* PDBlock;
  /* 0x1578 */ void* PdcHandle;
  /* 0x1580 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x1600 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x1650 */ volatile long PdcTaskClientMode;
  /* 0x1654 */ unsigned long ModernStandbyWoLMagicPacketEnable;
  /* 0x1658 */ struct _NDIS_RSS_DPC_WORKER_CONTEXT* RssV2Context;
  /* 0x1660 */ volatile long RssV2CompletionCount;
  /* 0x1668 */ struct _KEVENT RssV2CompletionEvent;
  /* 0x1680 */ unsigned char RssV2Initialized;
  /* 0x1688 */ struct _LIST_ENTRY SynchronousOidCalls;
  /* 0x1698 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCapabilities;
  /* 0x16a0 */ struct _NDIS_TIMESTAMP_CAPABILITIES* HwTimestampCurrentConfig;
  /* 0x16a8 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopTimestampConfig;
  /* 0x16b0 */ struct _NDIS_TIMESTAMP_CAPABILITIES* TopHwTimestampCapabilities;
  /* 0x16b8 */ struct _PKTMON_COMPONENT_CONTEXT PktMonComp;
  /* 0x16f8 */ struct _PKTMON_EDGE_CONTEXT PktMonEdge;
  /* 0x1720 */ class KnobNamespace PollModeConfigKnobsNamespace;
  /* 0x1768 */ class Rtl::KArray<KnobDescriptor,1> PollModeConfigKnobDescriptors;
  /* 0x1778 */ struct _EXECUTION_CONTEXT_RUNTIME_KNOBS PollModeConfigKnobs;
  /* 0x17b4 */ struct _GUID PnPActivityID;
  /* 0x17c8 */ class wistd::unique_ptr<NdisWdfIdle,KFreePoolNP<NdisWdfIdle> > IdleSm;
  /* 0x17d0 */ BOOL HasConversionFilter;
  /* 0x17d1 */ char __PADDING__[7];
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x17d8 */
