...
typedef struct __WilFeatureTraits_Feature_TelemetryManager
{
  union
  {
...
} _WilFeatureTraits_Feature_TelemetryManager, *P_WilFeatureTraits_Feature_TelemetryManager; /* size: 0x0001 */
