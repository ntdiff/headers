...
typedef struct __WilFeatureTraits_Feature_HStringReferenceUseAfterFree
{
  union
  {
...
} _WilFeatureTraits_Feature_HStringReferenceUseAfterFree, *P_WilFeatureTraits_Feature_HStringReferenceUseAfterFree; /* size: 0x0001 */
