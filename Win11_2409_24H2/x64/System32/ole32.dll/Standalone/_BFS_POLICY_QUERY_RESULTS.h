...
typedef struct _BFS_POLICY_QUERY_RESULTS
{
  /* 0x0000 */ unsigned long NumberOfEntries;
  /* 0x0008 */ struct _BFS_POLICY_INFORMATION PolicyInformation[1];
} BFS_POLICY_QUERY_RESULTS, *PBFS_POLICY_QUERY_RESULTS; /* size: 0x0028 */
