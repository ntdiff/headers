...
typedef struct __WilFeatureTraits_Feature_Standalone_24_05_NonSec
{
  union
  {
...
} _WilFeatureTraits_Feature_Standalone_24_05_NonSec, *P_WilFeatureTraits_Feature_Standalone_24_05_NonSec; /* size: 0x0001 */
