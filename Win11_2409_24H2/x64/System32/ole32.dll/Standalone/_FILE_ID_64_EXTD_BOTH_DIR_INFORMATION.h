...
typedef struct _FILE_ID_64_EXTD_BOTH_DIR_INFORMATION
{
  ...
  /* 0x0050 */ char ShortNameLength;
  /* 0x0052 */ wchar_t ShortName[12];
  /* 0x006a */ wchar_t FileName[1];
  /* 0x006c */ long __PADDING__[1];
} FILE_ID_64_EXTD_BOTH_DIR_INFORMATION, *PFILE_ID_64_EXTD_BOTH_DIR_INFORMATION; /* size: 0x0070 */
