typedef struct _IMAGE_ARM64EC_METADATA_V2
{
  ...
  /* 0x0050 */ unsigned long AuxDelayloadIAT;
  /* 0x0054 */ unsigned long AuxDelayloadIATCopy;
  /* 0x0058 */ unsigned long ReservedBitField;
} IMAGE_ARM64EC_METADATA_V2, *PIMAGE_ARM64EC_METADATA_V2; /* size: 0x005c */
