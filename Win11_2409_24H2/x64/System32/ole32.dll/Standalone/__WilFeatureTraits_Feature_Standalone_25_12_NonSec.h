...
typedef struct __WilFeatureTraits_Feature_Standalone_25_12_NonSec
{
  union
  {
...
} _WilFeatureTraits_Feature_Standalone_25_12_NonSec, *P_WilFeatureTraits_Feature_Standalone_25_12_NonSec; /* size: 0x0001 */
