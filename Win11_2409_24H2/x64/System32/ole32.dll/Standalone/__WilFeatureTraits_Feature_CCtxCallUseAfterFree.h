...
typedef struct __WilFeatureTraits_Feature_CCtxCallUseAfterFree
{
  union
  {
...
} _WilFeatureTraits_Feature_CCtxCallUseAfterFree, *P_WilFeatureTraits_Feature_CCtxCallUseAfterFree; /* size: 0x0001 */
