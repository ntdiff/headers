...
struct REFS_VOLUME_DATA_BUFFER
{
  ...
  /* 0x0050 */ unsigned short MetadataChecksumType;
  /* 0x0052 */ unsigned char Reserved0[6];
  /* 0x0058 */ unsigned long DriverMajorVersion;
  /* 0x005c */ unsigned long DriverMinorVersion;
  /* 0x0060 */ union _LARGE_INTEGER Reserved[7];
}; /* size: 0x0098 */
