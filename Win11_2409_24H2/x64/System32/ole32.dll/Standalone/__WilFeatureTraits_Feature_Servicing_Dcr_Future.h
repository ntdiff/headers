...
typedef struct __WilFeatureTraits_Feature_Servicing_Dcr_Future
{
  union
  {
...
} _WilFeatureTraits_Feature_Servicing_Dcr_Future, *P_WilFeatureTraits_Feature_Servicing_Dcr_Future; /* size: 0x0001 */
