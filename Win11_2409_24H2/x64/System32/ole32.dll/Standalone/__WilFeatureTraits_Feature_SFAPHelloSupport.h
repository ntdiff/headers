...
typedef struct __WilFeatureTraits_Feature_SFAPHelloSupport
{
  union
  {
...
} _WilFeatureTraits_Feature_SFAPHelloSupport, *P_WilFeatureTraits_Feature_SFAPHelloSupport; /* size: 0x0001 */
