...
typedef struct __WilFeatureTraits_Feature_WebThreatDefenseToggle
{
  union
  {
...
} _WilFeatureTraits_Feature_WebThreatDefenseToggle, *P_WilFeatureTraits_Feature_WebThreatDefenseToggle; /* size: 0x0001 */
