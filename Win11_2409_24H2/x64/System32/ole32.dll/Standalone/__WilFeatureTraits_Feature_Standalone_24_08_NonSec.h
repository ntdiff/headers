...
typedef struct __WilFeatureTraits_Feature_Standalone_24_08_NonSec
{
  union
  {
...
} _WilFeatureTraits_Feature_Standalone_24_08_NonSec, *P_WilFeatureTraits_Feature_Standalone_24_08_NonSec; /* size: 0x0001 */
