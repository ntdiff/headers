enum IMMERSIVE_HOT_KEY_ID
{
  ...
  UNUSED_IHKID_TOGGLE_PWILO_UX = 87,
  ...
  IHKID_VIRTUAL_DESKTOPS_MOVEAPP_LEFT = 109,
  IHKID_VIRTUAL_DESKTOPS_MOVEAPP_RIGHT = 110,
  IHKID_LAUNCH_COPILOT = 111,
  IHKID_COPILOT_HARDWARE_KEY = 112,
  IHKID_LAUNCH_SPEAKFORME = 113,
};
