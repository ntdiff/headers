...
typedef struct _RTL_IMAGE_MITIGATION_SYSTEM_CALL_DISABLE_POLICY
{
  ...
  /* 0x0008 */ union _RTL_IMAGE_MITIGATION_POLICY BlockFsctlSystemCalls;
} RTL_IMAGE_MITIGATION_SYSTEM_CALL_DISABLE_POLICY, *PRTL_IMAGE_MITIGATION_SYSTEM_CALL_DISABLE_POLICY; /* size: 0x0010 */
