...
typedef struct __WilFeatureTraits_Feature_SystemLogEvents
{
  union
  {
...
} _WilFeatureTraits_Feature_SystemLogEvents, *P_WilFeatureTraits_Feature_SystemLogEvents; /* size: 0x0001 */
