...
typedef struct __WilFeatureTraits_Feature_Standalone_25_03_NonSec
{
  union
  {
...
} _WilFeatureTraits_Feature_Standalone_25_03_NonSec, *P_WilFeatureTraits_Feature_Standalone_25_03_NonSec; /* size: 0x0001 */
