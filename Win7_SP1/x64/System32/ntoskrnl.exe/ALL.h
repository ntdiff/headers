...
typedef struct _POP_THERMAL_ZONE
{
  ...
  /* 0x0016 */ char Padding_28[2];
  /* 0x0018 */ long Throttle;
  /* 0x001c */ long Padding_29;
    ...
    struct
    {
      ...
      union
      {
        ...
        struct /* bitfield */
        {
          ...
          /* 0x0058 */ volatile unsigned long UmsPerformingSingleStep : 1; /* bit position: 4 */
        }; /* bitfield */
      }; /* size: 0x0004 */
      /* 0x005c */ long Padding_115[13];
...
typedef struct _ETHREAD
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0448 */ unsigned long Reserved : 1; /* bit position: 4 */
...
typedef struct _CMHIVE
{
  ...
  /* 0x0be0 */ union _LARGE_INTEGER LastWriteTime;
} CMHIVE, *PCMHIVE; /* size: 0x0be8 */
...
typedef struct _TEB64
{
  ...
  /* 0x1250 */ unsigned long LastStatusValue;
  /* 0x1254 */ long Padding_294;
  /* 0x1258 */ struct _STRING64 StaticUnicodeString;
  /* 0x1268 */ wchar_t StaticUnicodeBuffer[261];
  /* 0x1472 */ char Padding_295[6];
...
typedef struct _KALPC_SECTION
{
  ...
  union // _TAG_UNNAMED_178
  {
    struct // _TAG_UNNAMED_179
    {
      struct /* bitfield */
      {
...
RtlValidSecurityDescriptorSacl
RtlValidSid
