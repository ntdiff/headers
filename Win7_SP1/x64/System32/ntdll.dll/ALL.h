...
typedef struct _EPROCESS
{
  ...
  union
  {
    /* 0x02c8 */ struct _HARDWARE_PTE PageDirectoryPte;
    /* 0x02c8 */ unsigned __int64 Filler;
  }; /* size: 0x0008 */
  /* 0x02d0 */ void* Session;
  /* 0x02d8 */ unsigned char ImageFileName[15];
  /* 0x02e7 */ unsigned char PriorityClass;
  /* 0x02e8 */ struct _LIST_ENTRY JobLinks;
  /* 0x02f8 */ void* LockedPagesList;
  /* 0x0300 */ struct _LIST_ENTRY ThreadListHead;
  /* 0x0310 */ void* SecurityPort;
  /* 0x0318 */ void* Wow64Process;
  /* 0x0320 */ volatile unsigned long ActiveThreads;
  /* 0x0324 */ unsigned long ImagePathHash;
  /* 0x0328 */ unsigned long DefaultHardErrorProcessing;
  /* 0x032c */ long LastThreadExitStatus;
  /* 0x0330 */ struct _PEB* Peb;
  /* 0x0338 */ struct _EX_FAST_REF PrefetchTrace;
  /* 0x0340 */ union _LARGE_INTEGER ReadOperationCount;
  /* 0x0348 */ union _LARGE_INTEGER WriteOperationCount;
  /* 0x0350 */ union _LARGE_INTEGER OtherOperationCount;
  /* 0x0358 */ union _LARGE_INTEGER ReadTransferCount;
  /* 0x0360 */ union _LARGE_INTEGER WriteTransferCount;
  /* 0x0368 */ union _LARGE_INTEGER OtherTransferCount;
  /* 0x0370 */ unsigned __int64 CommitChargeLimit;
  /* 0x0378 */ volatile unsigned __int64 CommitChargePeak;
  /* 0x0380 */ void* AweInfo;
  /* 0x0388 */ struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;
  /* 0x0390 */ struct _MMSUPPORT Vm;
  /* 0x0418 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0428 */ void* HighestUserAddress;
  /* 0x0430 */ unsigned long ModifiedPageCount;
  union
  {
    /* 0x0434 */ unsigned long Flags2;
    struct /* bitfield */
    {
      /* 0x0434 */ unsigned long JobNotReallyActive : 1; /* bit position: 0 */
      /* 0x0434 */ unsigned long AccountingFolded : 1; /* bit position: 1 */
      /* 0x0434 */ unsigned long NewProcessReported : 1; /* bit position: 2 */
      /* 0x0434 */ unsigned long ExitProcessReported : 1; /* bit position: 3 */
      /* 0x0434 */ unsigned long ReportCommitChanges : 1; /* bit position: 4 */
      /* 0x0434 */ unsigned long LastReportMemory : 1; /* bit position: 5 */
      /* 0x0434 */ unsigned long ReportPhysicalPageChanges : 1; /* bit position: 6 */
      /* 0x0434 */ unsigned long HandleTableRundown : 1; /* bit position: 7 */
      /* 0x0434 */ unsigned long NeedsHandleRundown : 1; /* bit position: 8 */
      /* 0x0434 */ unsigned long RefTraceEnabled : 1; /* bit position: 9 */
      /* 0x0434 */ unsigned long NumaAware : 1; /* bit position: 10 */
      /* 0x0434 */ unsigned long ProtectedProcess : 1; /* bit position: 11 */
      /* 0x0434 */ unsigned long DefaultPagePriority : 3; /* bit position: 12 */
      /* 0x0434 */ unsigned long PrimaryTokenFrozen : 1; /* bit position: 15 */
      /* 0x0434 */ unsigned long ProcessVerifierTarget : 1; /* bit position: 16 */
      /* 0x0434 */ unsigned long StackRandomizationDisabled : 1; /* bit position: 17 */
      /* 0x0434 */ unsigned long AffinityPermanent : 1; /* bit position: 18 */
      /* 0x0434 */ unsigned long AffinityUpdateEnable : 1; /* bit position: 19 */
      /* 0x0434 */ unsigned long PropagateNode : 1; /* bit position: 20 */
      /* 0x0434 */ unsigned long ExplicitAffinity : 1; /* bit position: 21 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0438 */ unsigned long Flags;
    struct /* bitfield */
    {
      /* 0x0438 */ unsigned long CreateReported : 1; /* bit position: 0 */
      /* 0x0438 */ unsigned long NoDebugInherit : 1; /* bit position: 1 */
      /* 0x0438 */ unsigned long ProcessExiting : 1; /* bit position: 2 */
      /* 0x0438 */ unsigned long ProcessDelete : 1; /* bit position: 3 */
      /* 0x0438 */ unsigned long Wow64SplitPages : 1; /* bit position: 4 */
      /* 0x0438 */ unsigned long VmDeleted : 1; /* bit position: 5 */
      /* 0x0438 */ unsigned long OutswapEnabled : 1; /* bit position: 6 */
      /* 0x0438 */ unsigned long Outswapped : 1; /* bit position: 7 */
      /* 0x0438 */ unsigned long ForkFailed : 1; /* bit position: 8 */
      /* 0x0438 */ unsigned long Wow64VaSpace4Gb : 1; /* bit position: 9 */
      /* 0x0438 */ unsigned long AddressSpaceInitialized : 2; /* bit position: 10 */
      /* 0x0438 */ unsigned long SetTimerResolution : 1; /* bit position: 12 */
      /* 0x0438 */ unsigned long BreakOnTermination : 1; /* bit position: 13 */
      /* 0x0438 */ unsigned long DeprioritizeViews : 1; /* bit position: 14 */
      /* 0x0438 */ unsigned long WriteWatch : 1; /* bit position: 15 */
      /* 0x0438 */ unsigned long ProcessInSession : 1; /* bit position: 16 */
      /* 0x0438 */ unsigned long OverrideAddressSpace : 1; /* bit position: 17 */
      /* 0x0438 */ unsigned long HasAddressSpace : 1; /* bit position: 18 */
      /* 0x0438 */ unsigned long LaunchPrefetched : 1; /* bit position: 19 */
      /* 0x0438 */ unsigned long InjectInpageErrors : 1; /* bit position: 20 */
      /* 0x0438 */ unsigned long VmTopDown : 1; /* bit position: 21 */
      /* 0x0438 */ unsigned long ImageNotifyDone : 1; /* bit position: 22 */
      /* 0x0438 */ unsigned long PdeUpdateNeeded : 1; /* bit position: 23 */
      /* 0x0438 */ unsigned long VdmAllowed : 1; /* bit position: 24 */
      /* 0x0438 */ unsigned long CrossSessionCreate : 1; /* bit position: 25 */
      /* 0x0438 */ unsigned long ProcessInserted : 1; /* bit position: 26 */
      /* 0x0438 */ unsigned long DefaultIoPriority : 3; /* bit position: 27 */
      /* 0x0438 */ unsigned long ProcessSelfDelete : 1; /* bit position: 30 */
      /* 0x0438 */ unsigned long SetTimerResolutionLink : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x043c */ long ExitStatus;
  /* 0x0440 */ struct _MM_AVL_TABLE VadRoot;
  /* 0x0480 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x04a0 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x04b0 */ unsigned long RequestedTimerResolution;
  /* 0x04b4 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x04b8 */ unsigned long SmallestTimerResolution;
  /* 0x04bc */ long Padding_109;
  /* 0x04c0 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
} EPROCESS, *PEPROCESS; /* size: 0x04c8 */
