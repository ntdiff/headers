...
typedef struct _NDIS_M_DRIVER_BLOCK
{
  ...
  /* 0x0318 */ struct _UNICODE_STRING ImageName;
} NDIS_M_DRIVER_BLOCK, *PNDIS_M_DRIVER_BLOCK; /* size: 0x0328 */
...
typedef struct _NET_BUFFER_LIST
{
  ...
  /* 0x008c */ int Status;
  /* 0x0090 */ void* NetBufferListInfo[19];
  /* 0x0128 */ long __PADDING__[2];
} NET_BUFFER_LIST, *PNET_BUFFER_LIST; /* size: 0x0130 */
...
typedef struct _NDIS_WORK_QUEUE
{
  ...
  /* 0x0018 */ unsigned long NumEntries;
  /* 0x001c */ long Padding_41;
  /* 0x0020 */ struct _KSEMAPHORE ItemsAvailable;
} NDIS_WORK_QUEUE, *PNDIS_WORK_QUEUE; /* size: 0x0040 */
...
typedef struct _NDIS_IF_COMPARTMENT_BLOCK
{
  ...
  /* 0x0480 */ struct _NDIS_IF_BLOCK* LoopbackIf;
  /* 0x0488 */ struct _KEVENT* AsyncEvent;
} NDIS_IF_COMPARTMENT_BLOCK, *PNDIS_IF_COMPARTMENT_BLOCK; /* size: 0x0490 */
...
} NDIS_BIND_PARAMETERS, *PNDIS_BIND_PARAMETERS; /* size: 0x0118 */
...
typedef struct _NDIS_IF_BLOCK
{
  ...
  /* 0x0578 */ struct _KEVENT* MiniportAsyncEvent;
  /* 0x0580 */ unsigned char bNdisIsProvider;
  /* 0x0581 */ unsigned char MiniportPresent;
  /* 0x0582 */ char Padding_161[2];
  /* 0x0584 */ unsigned long SupportedStatistics;
  /* 0x0588 */ struct _IF_COUNTED_STRING_LH ifL2NetworkInfo;
  /* 0x078c */ long __PADDING__[1];
} NDIS_IF_BLOCK, *PNDIS_IF_BLOCK; /* size: 0x0790 */

typedef struct _IO_INTERRUPT_MESSAGE_INFO
{
  /* 0x0000 */ unsigned char UnifiedIrql;
  /* 0x0001 */ char Padding_162[3];
...
typedef struct _X_FILTER
{
  ...
  /* 0x015e */ char Padding_177[2];
  union
  {
    struct
    {
      /* 0x0160 */ unsigned int MaxMulticastAddresses;
      /* 0x0164 */ long Padding_178;
...
typedef struct _NDIS_FILTER_DRIVER_BLOCK
{
  ...
  /* 0x0030 */ unsigned long Flags;
  /* 0x0034 */ long Padding_188;
  /* 0x0038 */ struct _LIST_ENTRY DeviceList;
  /* 0x0048 */ struct _REFERENCE Ref;
  /* 0x0058 */ struct _NDIS_FILTER_DRIVER_CHARACTERISTICS DefaultFilterCharacteristics;
  /* 0x0138 */ void* InitiateOffloadCompleteHandler /* function */;
  /* 0x0140 */ void* TerminateOffloadCompleteHandler /* function */;
  /* 0x0148 */ void* UpdateOffloadCompleteHandler /* function */;
  /* 0x0150 */ void* InvalidateOffloadCompleteHandler /* function */;
  /* 0x0158 */ void* QueryOffloadCompleteHandler /* function */;
  /* 0x0160 */ void* IndicateOffloadEventHandler /* function */;
  /* 0x0168 */ void* TcpOffloadSendCompleteHandler /* function */;
  /* 0x0170 */ void* TcpOffloadReceiveCompleteHandler /* function */;
  /* 0x0178 */ void* TcpOffloadDisconnectCompleteHandler /* function */;
  /* 0x0180 */ void* TcpOffloadForwardCompleteHandler /* function */;
  /* 0x0188 */ void* TcpOffloadEventHandler /* function */;
  /* 0x0190 */ void* TcpOffloadReceiveIndicateHandler /* function */;
  /* 0x0198 */ void* InitiateOffloadHandler /* function */;
  /* 0x01a0 */ void* TerminateOffloadHandler /* function */;
  /* 0x01a8 */ void* UpdateOffloadHandler /* function */;
  /* 0x01b0 */ void* InvalidateOffloadHandler /* function */;
  /* 0x01b8 */ void* QueryOffloadHandler /* function */;
  /* 0x01c0 */ void* TcpOffloadSendHandler /* function */;
  /* 0x01c8 */ void* TcpOffloadReceiveHandler /* function */;
  /* 0x01d0 */ void* TcpOffloadDisconnectHandler /* function */;
  /* 0x01d8 */ void* TcpOffloadForwardHandler /* function */;
  /* 0x01e0 */ void* TcpOffloadReceiveReturnHandler /* function */;
  /* 0x01e8 */ enum _NDIS_FILTER_TYPE FilterType;
  /* 0x01ec */ enum _NDIS_FILTER_RUN_TYPE FilterRunType;
  /* 0x01f0 */ struct _UNICODE_STRING FilterClass;
  /* 0x0200 */ struct _UNICODE_STRING ImageName;
} NDIS_FILTER_DRIVER_BLOCK, *PNDIS_FILTER_DRIVER_BLOCK; /* size: 0x0210 */
...
} NDIS_FILTER_ATTACH_PARAMETERS, *PNDIS_FILTER_ATTACH_PARAMETERS; /* size: 0x00c8 */
...
typedef struct _NDIS_SG_DMA_BLOCK
{
  ...
  /* 0x003c */ long Padding_270;
  /* 0x0040 */ struct _NPAGED_LOOKASIDE_LIST* SGListLookasideList;
  /* 0x0048 */ long DmaAdapterRefCount;
  /* 0x004c */ long Padding_271;
...
typedef struct _NDIS_OPEN_BLOCK
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x0728 */ void* MiniportCoCreateVcHandler /* function */;
      /* 0x0730 */ void* MiniportCoRequestHandler /* function */;
      /* 0x0738 */ void* CoCreateVcHandler /* function */;
      /* 0x0740 */ void* CoDeleteVcHandler /* function */;
      /* 0x0748 */ void* CmActivateVcCompleteHandler /* function */;
      /* 0x0750 */ void* CmDeactivateVcCompleteHandler /* function */;
      /* 0x0758 */ void* CoRequestCompleteHandler /* function */;
      /* 0x0760 */ void* CoRequestHandler /* function */;
      /* 0x0768 */ struct _LIST_ENTRY ActiveVcHead;
      /* 0x0778 */ struct _LIST_ENTRY InactiveVcHead;
      /* 0x0788 */ long PendingAfNotifications;
      /* 0x078c */ long Padding_288;
      /* 0x0790 */ struct _KEVENT* AfNotifyCompleteEvent;
      /* 0x0798 */ void* MiniportCoOidRequestHandler /* function */;
      /* 0x07a0 */ void* CoOidRequestCompleteHandler /* function */;
      /* 0x07a8 */ void* CoOidRequestHandler /* function */;
    }; /* size: 0x05ce */
  }; /* size: 0x05ce */
} NDIS_OPEN_BLOCK, *PNDIS_OPEN_BLOCK; /* size: 0x07b0 */
...
typedef struct _NDIS_PROTOCOL_BLOCK
{
  ...
  /* 0x02d8 */ void* AllocateSharedMemoryHandler /* function */;
  /* 0x02e0 */ void* FreeSharedMemoryHandler /* function */;
  /* 0x02e8 */ void* AllocateSharedMemoryContext;
  /* 0x02f0 */ struct _UNICODE_STRING ImageName;
} NDIS_PROTOCOL_BLOCK, *PNDIS_PROTOCOL_BLOCK; /* size: 0x0300 */
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_294[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_295[12];
...
typedef struct _NDIS_INTERRUPT_BLOCK
{
  ...
  /* 0x0008 */ unsigned __int64 DpcCountLock;
  /* 0x0010 */ void* MiniportInterruptContext;
  /* 0x0018 */ void* MiniportIsr /* function */;
  /* 0x0020 */ void* MiniportDpc /* function */;
  /* 0x0028 */ struct _KDPC InterruptDpc;
  /* 0x0068 */ struct _NDIS_MINIPORT_BLOCK* Miniport;
  /* 0x0070 */ unsigned char DpcCount;
  /* 0x0071 */ char Padding_309[7];
  /* 0x0078 */ void* MiniportEnableInterrupt /* function */;
  /* 0x0080 */ void* MiniportDisableInterrupt /* function */;
  /* 0x0088 */ struct _KDPC* Dpc;
  union
  {
    /* 0x0090 */ void* Generic;
    /* 0x0090 */ struct _KINTERRUPT* InterruptObject;
    /* 0x0090 */ struct _IO_INTERRUPT_MESSAGE_INFO* MessageInfoTable;
  }; /* size: 0x0008 */
  /* 0x0098 */ struct _KEVENT DpcsCompletedEvent;
  /* 0x00b0 */ unsigned char SharedInterrupt;
  /* 0x00b1 */ unsigned char IsrRequested;
  /* 0x00b2 */ char Padding_310[6];
  /* 0x00b8 */ struct _NDIS_INTERRUPT_BLOCK* NextInterrupt;
  /* 0x00c0 */ unsigned int InterruptVector;
  /* 0x00c4 */ unsigned int InterruptLevel;
  /* 0x00c8 */ enum _KINTERRUPT_MODE InterruptMode;
  /* 0x00cc */ long Padding_311;
  /* 0x00d0 */ void* MiniportMessageIsr /* function */;
  /* 0x00d8 */ void* MiniportMessageInterruptDpc /* function */;
  /* 0x00e0 */ void* MiniportDisableMessageInterrupt /* function */;
  /* 0x00e8 */ void* MiniportEnableMessageInterrupt /* function */;
  /* 0x00f0 */ unsigned char MsiSupported;
  /* 0x00f1 */ unsigned char MessageUsed;
  /* 0x00f2 */ char Padding_312[6];
  /* 0x00f8 */ unsigned __int64 MessagesSyncLock;
  /* 0x0100 */ struct _IO_INTERRUPT_MESSAGE_INFO* NdisMessageInfoTable;
  /* 0x0108 */ struct _NDIS_DPC_WORK_ITEM* DpcWorkItems;
  /* 0x0110 */ struct _KDPC* MsgDpc;
} NDIS_INTERRUPT_BLOCK, *PNDIS_INTERRUPT_BLOCK; /* size: 0x0118 */
...
typedef struct _NDIS_NET_BUFFER_LIST_POOL
{
  ...
  /* 0x0008 */ unsigned __int64 ListLock;
  /* 0x0010 */ struct _LIST_ENTRY AllocatedList;
  /* 0x0020 */ void* Signature;
  /* 0x0028 */ unsigned short ItemLength;
  /* 0x002a */ unsigned short ContextSize;
  /* 0x002c */ long Padding_314;
  /* 0x0030 */ void* OwnerHandle;
  /* 0x0038 */ void* Allocator;
  /* 0x0040 */ unsigned long Tag;
  /* 0x0044 */ unsigned long Flags;
  /* 0x0048 */ unsigned __int64 Lock;
  /* 0x0050 */ struct _LIST_ENTRY GlobalNetBufferListPoolList;
  /* 0x0060 */ unsigned char ProtocolId;
  /* 0x0061 */ char Padding_315[3];
  /* 0x0064 */ unsigned long DataSize;
  /* 0x0068 */ unsigned long MdlSize;
  /* 0x006c */ long Padding_316[5];
...
{
  /* 0x0000 */ struct _LIST_ENTRY Link;
  /* 0x0010 */ struct _LIST_ENTRY IfList;
  /* 0x0020 */ void* IfProviderContext;
  /* 0x0028 */ struct _NDIS_IF_PROVIDER_CHARACTERISTICS ProviderCharacteristics;
} NDIS_IF_PROVIDER_BLOCK, *PNDIS_IF_PROVIDER_BLOCK; /* size: 0x0050 */

typedef struct _NDIS_PKT_POOL_HDR
{
  /* 0x0000 */ struct _LIST_ENTRY List;
  /* 0x0010 */ union _LARGE_INTEGER TimeStamp;
  /* 0x0018 */ long Padding_317[2];
...
typedef struct _NDIS_MINIPORT_OFFLOAD
{
  ...
  /* 0x0403 */ char Padding_319[5];
  /* 0x0408 */ void* MiniportRequestBuffer;
  /* 0x0410 */ unsigned long MiniportRequestOid;
  /* 0x0414 */ unsigned long MiniportRequestBufferLength;
} NDIS_MINIPORT_OFFLOAD, *PNDIS_MINIPORT_OFFLOAD; /* size: 0x0418 */
...
typedef struct _NDIS_RECEIVE_FILTER_BLOCK
{
  ...
  /* 0x0020 */ unsigned long FilterId;
  /* 0x0024 */ long Padding_325;
  /* 0x0028 */ struct _NDIS_MINIPORT_BLOCK* Miniport;
  /* 0x0030 */ struct _NDIS_OPEN_BLOCK* Open;
  /* 0x0038 */ struct _NDIS_RECEIVE_QUEUE_BLOCK* ReceiveQueue;
  /* 0x0040 */ enum _NDIS_RECEIVE_FILTER_STATE FilterState;
  /* 0x0044 */ long Reference;
  /* 0x0048 */ struct _NDIS_CONNECTION_INFO ConnectionInfo;
  /* 0x0078 */ struct _NDIS_RECEIVE_FILTER_PARAMETERS FilterParameters;
  /* 0x009c */ long __PADDING__[1];
} NDIS_RECEIVE_FILTER_BLOCK, *PNDIS_RECEIVE_FILTER_BLOCK; /* size: 0x00a0 */
...
typedef struct _NDIS_NET_BUFFER_POOL
{
  ...
  /* 0x0020 */ void* Signature;
  /* 0x0028 */ unsigned short ItemLength;
  /* 0x002a */ char Padding_338[6];
  /* 0x0030 */ void* OwnerHandle;
  /* 0x0038 */ void* Allocator;
  /* 0x0040 */ unsigned long Tag;
  /* 0x0044 */ long Padding_339;
  /* 0x0048 */ unsigned __int64 Lock;
  /* 0x0050 */ struct _LIST_ENTRY GlobalNetBufferPoolList;
  /* 0x0060 */ unsigned long Flags;
  /* 0x0064 */ unsigned long DataSize;
  /* 0x0068 */ unsigned long MdlSize;
  /* 0x006c */ long Padding_340[5];
...
typedef struct _NDIS_COMMON_OPEN_BLOCK
{
  ...
  /* 0x0130 */ unsigned long WakeUpEnable;
  /* 0x0134 */ struct _NDIS_PM_PARAMETERS PMCurrentParameters;
  /* 0x0144 */ long Padding_345;
  /* 0x0148 */ struct _KEVENT* CloseCompleteEvent;
  /* 0x0150 */ struct _QUEUED_CLOSE QC;
  /* 0x0178 */ long AfReferences;
  /* 0x017c */ long Padding_346;
  /* 0x0180 */ struct _NDIS_OPEN_BLOCK* NextGlobalOpen;
  /* 0x0188 */ struct _NDIS_OPEN_BLOCK* MiniportNextOpen;
  /* 0x0190 */ struct _NDIS_OPEN_BLOCK* ProtocolNextOpen;
  /* 0x0198 */ struct _UNICODE_STRING* BindDeviceName;
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x01c0 */ unsigned char UsingGroupAddress;
      /* 0x01c1 */ unsigned char OldUsingGroupAddress;
      /* 0x01c2 */ char Padding_349[2];
      /* 0x01c4 */ unsigned long FARefCount[32];
      /* 0x0244 */ unsigned long OldFARefCount[32];
      /* 0x02c4 */ long Padding_350[3];
      /* 0x02d0 */ unsigned char RSSParametersBuf[656];
      /* 0x0560 */ struct _NDIS_RECEIVE_SCALE_PARAMETERS* NdisRSSParameters;
      /* 0x0568 */ struct _SINGLE_LIST_ENTRY PatternList;
      /* 0x0570 */ struct _SINGLE_LIST_ENTRY WOLPatternList;
      ...
      /* 0x0620 */ void* TcpOffloadReceiveIndicateHandler /* function */;
      /* 0x0628 */ unsigned long ProtocolMajorVersion;
      /* 0x062c */ long Padding_351;
      /* 0x0630 */ void** IfBlock;
      /* 0x0638 */ struct _NDIS_SPIN_LOCK PnPStateLock;
      /* 0x0648 */ enum _NDIS_NDIS5_DRIVER_STATE PnPState;
      /* 0x064c */ enum _NDIS_OPEN_TRANSLATION_STATE TranslationState;
      /* 0x0650 */ int OutstandingSends;
      /* 0x0654 */ long Padding_352;
      /* 0x0658 */ struct _NDIS_EVENT PauseEvent;
      /* 0x0670 */ void* Ndis5WanSendHandler /* function */;
      /* 0x0678 */ void* ProtSendCompleteHandler /* function */;
      /* 0x0680 */ void* OidRequestCompleteHandler /* function */;
...
NetTrcRegisterCorrelationProvider
NetTrcRegisterCorrelationProviderEx
...
ndisAddNetworkActivityCyclesCounterSet
ndisAddNetworkInterfaceCounterSet
ndisAddPortToList
...
ndisAllocateRWLRefCountPool
ndisAllocateRWLRefCounts
...
ndisConvertPMConfigTpWakeUpEnable
...
ndisGetDefaultNumRssProcessors
ndisGetDevicePowerStateStr
ndisGetDpcWatchdogInfo
ndisGetEncapsulationFromTask
ndisGetFiltersCount
ndisGetHaltActionStr
ndisGetHardwareInfo
...
ndisInitActiveProcessorList
ndisInitHypervisorInfo
ndisInitValidProcessors
...
ndisIsMsHvParentPartitionFromRegistry
...
ndisOpenIndicatePMOffloadReject
ndisOpenIndicateWoLPatternReject
...
ndisReadProcessorAffinityMaskEx
