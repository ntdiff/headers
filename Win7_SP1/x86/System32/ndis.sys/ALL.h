...
struct _NDIS_PER_PROC_COUNTERS;
...
enum _NDIS_OPEN_TRANSLATION_STATE;
...
enum _NDIS_RECEIVE_FILTER_STATE;
...
struct _NDIS_GUID;
struct _OID_LIST;
struct _NDIS_RWL_REFCOUNT_POOL;
...
} NDIS_PER_PROC_PERFORMANCE_COUNTERS, *PNDIS_PER_PROC_PERFORMANCE_COUNTERS; /* size: 0x0118 */

typedef struct _NDIS_PER_PROC_COUNTERS
{
  /* 0x0000 */ struct _NDIS_PER_PROC_PERFORMANCE_COUNTERS PerProcPerfCounters;
  /* 0x0118 */ unsigned __int64 DpcTotalCyclesStart;
  /* 0x0120 */ unsigned __int64 IsrCyclesStart;
  /* 0x0128 */ unsigned __int64 NdisReceiveIndicationCyclesStart;
  /* 0x0130 */ unsigned __int64 StackReceiveIndicationCyclesStart;
  /* 0x0138 */ unsigned __int64 NdisReturnNblCyclesStart;
  /* 0x0140 */ unsigned __int64 MiniportReturnNblCyclesStart;
  /* 0x0148 */ unsigned __int64 NdisSendCyclesStart;
  /* 0x0150 */ unsigned __int64 MiniportSendCyclesStart;
  /* 0x0158 */ unsigned __int64 NdisSendCompleteCyclesStart;
  /* 0x0160 */ unsigned __int64 StackSendCompleteCyclesStart;
  /* 0x0168 */ unsigned __int64 HalBuildSGListCyclesStart;
  /* 0x0170 */ long __PADDING__[4];
} NDIS_PER_PROC_COUNTERS, *PNDIS_PER_PROC_COUNTERS; /* size: 0x0180 */
...
typedef struct _NDIS_WORK_QUEUE
{
  /* 0x0000 */ struct _LIST_ENTRY WorkItemList;
  /* 0x0008 */ unsigned long ListLock;
  /* 0x000c */ unsigned long NumEntries;
  /* 0x0010 */ struct _KSEMAPHORE ItemsAvailable;
} NDIS_WORK_QUEUE, *PNDIS_WORK_QUEUE; /* size: 0x0024 */
...
typedef struct _NDIS_M_DRIVER_BLOCK
{
  ...
  /* 0x00c4 */ struct _REFERENCE Ref;
  /* 0x00cc */ struct _KMUTANT IMStartRemoveMutex;
  /* 0x00ec */ void* IMStartRemoveMutexOwnerThread;
  /* 0x00f0 */ unsigned long DriverVersion;
  /* 0x00f4 */ struct _UNICODE_STRING ServiceName;
  /* 0x00fc */ void* CoCreateVcHandler /* function */;
  /* 0x0100 */ void* CoDeleteVcHandler /* function */;
  /* 0x0104 */ void* CoActivateVcHandler /* function */;
  /* 0x0108 */ void* CoDeactivateVcHandler /* function */;
  /* 0x010c */ void* CoSendNetBufferListsHandler /* function */;
  /* 0x0110 */ void* CoRequestHandler /* function */;
  /* 0x0114 */ void* CoOidRequestHandler /* function */;
  /* 0x0118 */ void* InitiateOffloadHandler /* function */;
  /* 0x011c */ void* TerminateOffloadHandler /* function */;
  /* 0x0120 */ void* UpdateOffloadHandler /* function */;
  /* 0x0124 */ void* InvalidateOffloadHandler /* function */;
  /* 0x0128 */ void* QueryOffloadHandler /* function */;
  /* 0x012c */ void* TcpOffloadSendHandler /* function */;
  /* 0x0130 */ void* TcpOffloadReceiveHandler /* function */;
  /* 0x0134 */ void* TcpOffloadDisconnectHandler /* function */;
  /* 0x0138 */ void* TcpOffloadForwardHandler /* function */;
  /* 0x013c */ void* TcpOffloadReceiveReturnHandler /* function */;
  /* 0x0140 */ struct _NDIS_CO_CALL_MANAGER_OPTIONAL_HANDLERS CallMgrChars;
  /* 0x018c */ void* AddDeviceHandler /* function */;
  /* 0x0190 */ void* RemoveDeviceHandler /* function */;
  /* 0x0194 */ void* FilterResourceRequirementsHandler /* function */;
  /* 0x0198 */ void* StartDeviceHandler /* function */;
  /* 0x019c */ struct _UNICODE_STRING ImageName;
} NDIS_M_DRIVER_BLOCK, *PNDIS_M_DRIVER_BLOCK; /* size: 0x01a4 */
...
typedef struct _NDIS_FILTER_ATTACH_PARAMETERS
{
  ...
  /* 0x009c */ long __PADDING__[1];
} NDIS_FILTER_ATTACH_PARAMETERS, *PNDIS_FILTER_ATTACH_PARAMETERS; /* size: 0x00a0 */
...
} NDIS_RECEIVE_QUEUE_PARAMETERS, *PNDIS_RECEIVE_QUEUE_PARAMETERS; /* size: 0x0434 */
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0048 */ long Padding_32[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_33[14];
...
} NDIS_BIND_PARAMETERS, *PNDIS_BIND_PARAMETERS; /* size: 0x00e0 */
...
} NDIS_RECEIVE_FILTER_CAPABILITIES, *PNDIS_RECEIVE_FILTER_CAPABILITIES; /* size: 0x0038 */
...
typedef struct _NDIS_IF_PROVIDER_BLOCK
{
  ...
  /* 0x0008 */ struct _LIST_ENTRY IfList;
  /* 0x0010 */ void* IfProviderContext;
  /* 0x0014 */ struct _NDIS_IF_PROVIDER_CHARACTERISTICS ProviderCharacteristics;
} NDIS_IF_PROVIDER_BLOCK, *PNDIS_IF_PROVIDER_BLOCK; /* size: 0x0028 */
...
typedef struct _NDIS_IF_BLOCK
{
  ...
  /* 0x0544 */ struct _KEVENT* MiniportAsyncEvent;
  /* 0x0548 */ unsigned char bNdisIsProvider;
  /* 0x0549 */ unsigned char MiniportPresent;
  /* 0x054a */ char Padding_67[2];
  /* 0x054c */ unsigned long SupportedStatistics;
  /* 0x0550 */ struct _IF_COUNTED_STRING_LH ifL2NetworkInfo;
  /* 0x0754 */ long __PADDING__[1];
} NDIS_IF_BLOCK, *PNDIS_IF_BLOCK; /* size: 0x0758 */
...
} NDIS_RECEIVE_QUEUE_BLOCK, *PNDIS_RECEIVE_QUEUE_BLOCK; /* size: 0x0480 */
...
typedef struct _NDIS_PROTOCOL_BLOCK
{
  ...
  /* 0x0188 */ struct _UNICODE_STRING ImageName;
} NDIS_PROTOCOL_BLOCK, *PNDIS_PROTOCOL_BLOCK; /* size: 0x0190 */
...
} NDIS_NSI_COMPARTMENT_RW, *PNDIS_NSI_COMPARTMENT_RW; /* size: 0x0448 */
...
typedef struct _NDIS_IF_COMPARTMENT_BLOCK
{
  ...
  /* 0x0014 */ unsigned long Flags;
  /* 0x0018 */ long Ref;
  /* 0x001c */ struct _NDIS_IF_NETWORK_BLOCK* LoopbackNetwork;
  /* 0x0020 */ struct _NDIS_NSI_COMPARTMENT_RW LoopbackInfo;
  /* 0x0468 */ struct _NDIS_IF_BLOCK* LoopbackIf;
  /* 0x046c */ struct _KEVENT* AsyncEvent;
} NDIS_IF_COMPARTMENT_BLOCK, *PNDIS_IF_COMPARTMENT_BLOCK; /* size: 0x0470 */
...
typedef struct _NDIS_MINIPORT_OFFLOAD
{
  ...
  /* 0x0005 */ char Padding_80[3];
  /* 0x0008 */ struct _NDIS_OFFLOAD MiniportCurrentConfig;
  /* 0x0098 */ struct _NDIS_OFFLOAD TopCapabilities;
  /* 0x0128 */ struct _NDIS_OFFLOAD MiniportInitialConfig;
  /* 0x01b8 */ struct _NDIS_OFFLOAD MiniportHardwareCapabilties;
  /* 0x0248 */ struct _NDIS_OFFLOAD_ENCAPSULATION MiniportSetEncapsulation;
  /* 0x0264 */ struct _NDIS_OFFLOAD_ENCAPSULATION TopSetEncapsulation;
  /* 0x0280 */ struct _NDIS_OFFLOAD_ENCAPSULATION TopMergedEncapsulation;
  /* 0x029c */ struct _NDIS_OFFLOAD_ENCAPSULATION MiniportMergedEncapsulation;
  /* 0x02b8 */ struct _NDIS_TCP_CONNECTION_OFFLOAD TopTcpConnectionOffloadCapabilities;
  /* 0x02cc */ struct _NDIS_TCP_CONNECTION_OFFLOAD MiniportTcpConnectionOffloadCurrentConfig;
  /* 0x02e0 */ struct _NDIS_TCP_CONNECTION_OFFLOAD MiniportHwTcpConnectionOffloadCapabilities;
  /* 0x02f4 */ struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS TopTcpConnectionParameters;
  /* 0x0330 */ struct _NDIS_TCP_CONNECTION_OFFLOAD_PARAMETERS MiniportTcpConnectionParameters;
  /* 0x036c */ unsigned char MiniportTask[144];
  /* 0x03fc */ unsigned long MiniportTaskSize;
  /* 0x0400 */ unsigned char Ndis5Xsum;
  /* 0x0401 */ unsigned char Ndis5LSO;
  /* 0x0402 */ unsigned char Ndis5IPsec;
  /* 0x0403 */ char Padding_81;
  /* 0x0404 */ void* MiniportRequestBuffer;
  /* 0x0408 */ unsigned long MiniportRequestOid;
  /* 0x040c */ unsigned long MiniportRequestBufferLength;
} NDIS_MINIPORT_OFFLOAD, *PNDIS_MINIPORT_OFFLOAD; /* size: 0x0410 */
...
typedef struct _NDIS_COMMON_OPEN_BLOCK
{
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x0544 */ void* FreeSharedMemoryHandler /* function */;
      /* 0x0548 */ void* AllocateSharedMemoryContext;
      /* 0x054c */ long __PADDING__[1];
    }; /* size: 0x0456 */
  }; /* size: 0x0456 */
} NDIS_COMMON_OPEN_BLOCK, *PNDIS_COMMON_OPEN_BLOCK; /* size: 0x0550 */
...
} NDIS_SHARED_MEMORY_BLOCK, *PNDIS_SHARED_MEMORY_BLOCK; /* size: 0x0068 */
...
typedef struct _NDIS_NET_BUFFER_POOL
{
  ...
  /* 0x0004 */ unsigned long ListLock;
  /* 0x0008 */ struct _LIST_ENTRY AllocatedList;
  /* 0x0010 */ void* Signature;
  /* 0x0014 */ unsigned short ItemLength;
  /* 0x0016 */ char Padding_88[2];
  /* 0x0018 */ void* OwnerHandle;
  /* 0x001c */ void* Allocator;
  /* 0x0020 */ unsigned long Tag;
  /* 0x0024 */ unsigned long Lock;
  /* 0x0028 */ struct _LIST_ENTRY GlobalNetBufferPoolList;
  /* 0x0030 */ unsigned long Flags;
  /* 0x0034 */ unsigned long DataSize;
  /* 0x0038 */ unsigned long MdlSize;
  /* 0x003c */ long Padding_89;
...
} NDIS_GLOBAL_TRIAGE_BLOCK, *PNDIS_GLOBAL_TRIAGE_BLOCK; /* size: 0x01b8 */
...
typedef struct _NDIS_NET_BUFFER_LIST_POOL
{
  ...
  /* 0x0010 */ void* Signature;
  /* 0x0014 */ unsigned short ItemLength;
  /* 0x0016 */ unsigned short ContextSize;
  /* 0x0018 */ void* OwnerHandle;
  /* 0x001c */ void* Allocator;
  /* 0x0020 */ unsigned long Tag;
  /* 0x0024 */ unsigned long Flags;
  /* 0x0028 */ unsigned long Lock;
  /* 0x002c */ struct _LIST_ENTRY GlobalNetBufferListPoolList;
  /* 0x0034 */ unsigned char ProtocolId;
  /* 0x0035 */ char Padding_91[3];
  /* 0x0038 */ unsigned long DataSize;
  /* 0x003c */ unsigned long MdlSize;
