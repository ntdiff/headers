...
typedef struct _SE_AUDIT_INFO
{
  ...
  /* 0x0018 */ struct _UNICODE_STRING ObjectTypeName;
  /* 0x0020 */ struct _UNICODE_STRING ObjectName;
  /* 0x0028 */ void* HandleId;
  /* 0x002c */ struct _GUID* TransactionId;
  /* 0x0030 */ struct _LUID* OperationId;
  /* 0x0034 */ unsigned char ObjectCreation;
  /* 0x0035 */ unsigned char GenerateOnClose;
  /* 0x0036 */ char __PADDING__[2];
} SE_AUDIT_INFO, *PSE_AUDIT_INFO; /* size: 0x0038 */
