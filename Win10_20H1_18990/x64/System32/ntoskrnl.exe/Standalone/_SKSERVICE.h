typedef enum _SKSERVICE
{
  ...
  SECURESERVICE_START_PROFILE = 74,
  SECURESERVICE_STOP_PROFILE = 75,
  SECURESERVICE_SET_TRACEPOINT = 76,
  ...
  SECURESERVICE_VERIFY_PAGE = 257,
  SECURESERVICE_PREPARE_FOR_HIBERNATION = 258,
  SECURESERVICE_PREPARE_FOR_CRASHDUMP = 259,
  SECURESERVICE_REPORT_BUGCHECK_PROGRESS = 260,
  SECURESERVICE_SHUTDOWN = 261,
  SECURESERVICE_QUERY_SECURE_PCI_INFO = 262,
  SECURESERVICE_ACCESS_PCI_DEVICE = 263,
  SECURESERVICE_REINITIALIZE_DEBUGGER_TRANSPORT = 264,
  SECURESERVICE_KSR_CALL = 265,
  SECURESERVICE_SVC_CALL = 266,
