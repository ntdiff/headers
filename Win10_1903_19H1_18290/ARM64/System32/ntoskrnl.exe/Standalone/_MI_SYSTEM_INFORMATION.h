...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x01e0 */ struct _MI_SECTION_WOW_STATE Wow[2];
  /* 0x0220 */ unsigned __int64 ImageBiasWow;
  /* 0x0228 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  ...
  /* 0x028c */ unsigned long ImageBreakpointEnabled;
  /* 0x0290 */ unsigned long ImageBreakpointChecksum;
  /* 0x0294 */ unsigned long ImageBreakpointSize;
  /* 0x0298 */ volatile long ImageValidationFailed;
  /* 0x029c */ unsigned long HotPatchReserveSize;
  /* 0x02a0 */ long __PADDING__[24];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x04c0 */ struct _MI_SESSION_STATE Sessions;
  /* 0x1540 */ struct _MI_PROCESS_STATE Processes;
  ...
  /* 0x1cc8 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1d28 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1da0 */ struct _MI_ERROR_STATE Errors;
  /* 0x1e80 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x1f80 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x20a0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x2180 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x2380 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x23f0 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x2440 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2500 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x2580 */ unsigned __int64 Cookie;
  /* 0x2588 */ void* volatile* BootRegistryRuns;
  /* 0x2590 */ volatile long ZeroingDisabled;
  /* 0x2594 */ unsigned char FullyInitialized;
  /* 0x2595 */ unsigned char SafeBooted;
  /* 0x2598 */ const struct _TlgProvider_t* TraceLogging;
