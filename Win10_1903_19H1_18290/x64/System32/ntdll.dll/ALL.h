...
typedef struct _KPRCB
{
  ...
  /* 0x6ac0 */ unsigned char PrcbPad138[960];
  ...
  /* 0x6e9c */ unsigned long DbgMceNestingLevel;
  /* 0x6ea0 */ unsigned long DbgMceFlags;
  /* 0x6ea4 */ unsigned long PrcbPad139;
  /* 0x6ea8 */ unsigned __int64 PrcbPad140[507];
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_57[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_58[2];
...
typedef struct _KNODE
{
  ...
  /* 0x0068 */ long Padding_74[6];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_75;
  union
  {
...
typedef struct _ETHREAD
{
  ...
  /* 0x05f0 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x05f8 */ union _LARGE_INTEGER ExitTime;
    /* 0x05f8 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  union
  {
    /* 0x0608 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0608 */ void* ForwardLinkShadow;
      /* 0x0610 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x0618 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0618 */ struct _ETHREAD* ReaperLink;
    /* 0x0618 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x0620 */ unsigned __int64 ActiveTimerListLock;
  /* 0x0628 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0638 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0648 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0648 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x0668 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x0670 */ struct _LIST_ENTRY IrpList;
  /* 0x0680 */ unsigned __int64 TopLevelIrp;
  /* 0x0688 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x0690 */ void* Win32StartAddress;
  /* 0x0698 */ void* ChargeOnlySession;
  /* 0x06a0 */ void* LegacyPowerObject;
  /* 0x06a8 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06b8 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x06c0 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x06c8 */ unsigned long ReadClusterSize;
  /* 0x06cc */ volatile long MmLockOrdering;
  union
  {
    /* 0x06d0 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x06d0 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x06d0 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x06d0 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x06d0 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x06d0 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x06d0 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x06d0 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x06d0 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x06d0 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x06d0 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x06d0 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x06d0 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x06d0 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x06d0 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x06d0 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x06d0 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x06d0 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x06d0 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x06d0 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x06d0 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x06d0 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06d4 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x06d4 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x06d4 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x06d4 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x06d4 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x06d4 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x06d4 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x06d4 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x06d4 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x06d4 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x06d4 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x06d4 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x06d4 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06d8 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x06d8 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x06d8 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x06d8 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x06d8 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x06d8 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x06d8 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x06d8 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x06d8 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x06d9 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x06d9 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x06d9 */ unsigned char AllowWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x06d9 */ unsigned char OwnsVadShared : 1; /* bit position: 5 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x06dc */ unsigned char CacheManagerActive;
  /* 0x06dd */ unsigned char DisablePageFaultClustering;
  /* 0x06de */ unsigned char ActiveFaultCount;
  /* 0x06df */ unsigned char LockOrderState;
  /* 0x06e0 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x06e8 */ void* AlpcMessage;
    /* 0x06e8 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x06f0 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x0700 */ long ExitStatus;
  /* 0x0704 */ unsigned long CacheManagerCount;
  /* 0x0708 */ unsigned long IoBoostCount;
  /* 0x070c */ unsigned long IoQoSBoostCount;
  /* 0x0710 */ unsigned long IoQoSThrottleCount;
  /* 0x0714 */ unsigned long KernelStackReference;
  /* 0x0718 */ struct _LIST_ENTRY BoostList;
  /* 0x0728 */ struct _LIST_ENTRY DeboostList;
  /* 0x0738 */ unsigned __int64 BoostListLock;
  /* 0x0740 */ unsigned __int64 IrpListLock;
  /* 0x0748 */ void* ReservedForSynchTracking;
  /* 0x0750 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0758 */ const struct _GUID* ActivityId;
  /* 0x0760 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0768 */ void* VerifierContext;
  /* 0x0770 */ void* AdjustedClientToken;
  /* 0x0778 */ void* WorkOnBehalfThread;
  /* 0x0780 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x0798 */ void* PicoContext;
  /* 0x07a0 */ unsigned __int64 UserFsBase;
  /* 0x07a8 */ unsigned __int64 UserGsBase;
  /* 0x07b0 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x07b8 */ void* CmDbgInfo;
  union
  {
    /* 0x07c0 */ unsigned __int64 SelectedCpuSets;
    /* 0x07c0 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x07c8 */ struct _EJOB* Silo;
