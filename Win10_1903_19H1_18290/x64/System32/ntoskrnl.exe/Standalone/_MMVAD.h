...
typedef struct _MM_PRIVATE_VAD_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long FixedLargePageSize : 1; /* bit position: 21 */
    /* 0x0000 */ unsigned long ZeroFillPagesOptional : 1; /* bit position: 22 */
    /* 0x0000 */ unsigned long Graphics : 1; /* bit position: 23 */
    /* 0x0000 */ unsigned long Enclave : 1; /* bit position: 24 */
    /* 0x0000 */ unsigned long ShadowStack : 1; /* bit position: 25 */
  }; /* bitfield */
...
typedef struct _MM_GRAPHICS_VAD_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long FixedLargePageSize : 1; /* bit position: 21 */
    /* 0x0000 */ unsigned long ZeroFillPagesOptional : 1; /* bit position: 22 */
    /* 0x0000 */ unsigned long GraphicsAlwaysSet : 1; /* bit position: 23 */
    /* 0x0000 */ unsigned long GraphicsUseCoherentBus : 1; /* bit position: 24 */
    /* 0x0000 */ unsigned long GraphicsPageProtection : 3; /* bit position: 25 */
  }; /* bitfield */
