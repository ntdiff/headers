...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x009d */ unsigned char HeteroDecreaseThreshold[32];
  /* 0x00bd */ unsigned char HeteroIncreaseThreshold[32];
  /* 0x00dd */ unsigned char Class0FloorPerformance;
  /* 0x00de */ unsigned char Class1InitialPerformance;
  /* 0x00e0 */ enum _KHETERO_CPU_POLICY ThreadPolicies[2];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x00e8 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x01f0 */ unsigned __int64 StartTime;
  /* 0x01f8 */ unsigned __int64 Count;
  /* 0x0200 */ unsigned __int64 MaxDuration;
  /* 0x0208 */ unsigned __int64 MinDuration;
  /* 0x0210 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x0218 */
