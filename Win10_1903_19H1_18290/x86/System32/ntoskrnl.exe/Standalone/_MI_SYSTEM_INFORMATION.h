...
typedef struct _CONTROL_AREA
{
  ...
  union // _TAG_UNNAMED_197
  {
    struct // _TAG_UNNAMED_198
    {
      union
      {
...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0108 */ struct _RTL_BITMAP ImageBitMapNative;
  /* 0x0110 */ unsigned long ImageBiasNative;
  ...
  /* 0x012c */ struct _SECTION* CfgBitMapSection;
  /* 0x0130 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0134 */ unsigned long ImageCfgFailure;
  /* 0x0138 */ unsigned long ImageBreakpointEnabled;
  /* 0x013c */ unsigned long ImageBreakpointChecksum;
  /* 0x0140 */ unsigned long ImageBreakpointSize;
  /* 0x0144 */ volatile long ImageValidationFailed;
  /* 0x0148 */ unsigned long HotPatchReserveSize;
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0400 */ struct _MMSUPPORT_SHARED SystemCacheShared;
  /* 0x042c */ unsigned long MapCacheFailures;
  /* 0x0430 */ unsigned long PagefileHashPages;
  /* 0x0434 */ struct _SYSPTES_HEADER PteHeader;
  /* 0x04c0 */ unsigned long SystemVaTypeCount[15];
  /* 0x04fc */ unsigned char SystemVaType[1024];
  /* 0x08fc */ unsigned long SystemVaTypeCountFailures[15];
  /* 0x0938 */ unsigned long SystemVaTypeCountLimit[15];
  /* 0x0974 */ unsigned long SystemVaTypeCountPeak[15];
  /* 0x09b0 */ unsigned long SystemAvailableVa;
  /* 0x09b4 */ long __PADDING__[3];
} MI_VISIBLE_STATE, *PMI_VISIBLE_STATE; /* size: 0x09c0 */
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0270 */ struct _MI_SESSION_STATE Sessions;
  /* 0x12a8 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1340 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x14c0 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x3c00 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x3c20 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x3c38 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x3c70 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x3cb8 */ struct _MI_ERROR_STATE Errors;
  ...
  /* 0x40c0 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x40f8 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x4140 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x4180 */ unsigned long Cookie;
  /* 0x4184 */ void* volatile* BootRegistryRuns;
  /* 0x4188 */ volatile long ZeroingDisabled;
  /* 0x418c */ unsigned char FullyInitialized;
  /* 0x418d */ unsigned char SafeBooted;
  /* 0x4190 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x4198 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x41c0 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x4b80 */
