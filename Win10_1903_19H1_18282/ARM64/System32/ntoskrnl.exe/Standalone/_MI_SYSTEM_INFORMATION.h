...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x0208 */ void* ApiSetSection;
  /* 0x0210 */ void* ApiSetSchema;
  /* 0x0218 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x0220 */ unsigned long LostDataFiles;
  /* 0x0224 */ unsigned long LostDataPages;
  /* 0x0228 */ unsigned long ImageFailureReason;
  /* 0x0230 */ struct _SECTION* CfgBitMapSection;
  /* 0x0238 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0240 */ struct _SECTION* CfgBitMapSectionWow;
  /* 0x0248 */ struct _CONTROL_AREA* CfgBitMapControlAreaWow;
  /* 0x0250 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x0260 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x0268 */ unsigned long ImageCfgFailure;
  /* 0x026c */ unsigned long ImageBreakpointEnabled;
  /* 0x0270 */ unsigned long ImageBreakpointChecksum;
  /* 0x0274 */ unsigned long ImageBreakpointSize;
  /* 0x0278 */ volatile long ImageValidationFailed;
  /* 0x027c */ unsigned long HotPatchReserveSize;
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x14c0 */ struct _MI_PROCESS_STATE Processes;
