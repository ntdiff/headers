...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x0090 */ unsigned char AllowScaling;
  /* 0x0091 */ unsigned char IdleDisabled;
  /* 0x0094 */ unsigned long IdleTimeCheck;
  /* 0x0098 */ unsigned char IdleDemotePercent;
  /* 0x0099 */ unsigned char IdlePromotePercent;
  /* 0x009a */ unsigned char IdleStateMax;
  /* 0x009b */ unsigned char HeteroDecreaseTime;
  /* 0x009c */ unsigned char HeteroIncreaseTime;
  /* 0x009d */ unsigned char HeteroDecreaseThreshold[1280];
  /* 0x059d */ unsigned char HeteroIncreaseThreshold[1280];
  /* 0x0a9d */ unsigned char Class0FloorPerformance;
  /* 0x0a9e */ unsigned char Class1InitialPerformance;
  /* 0x0aa0 */ enum _KHETERO_CPU_POLICY ThreadPolicies[2];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x0aa8 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x1578 */ unsigned __int64 StartTime;
  /* 0x1580 */ unsigned __int64 Count;
  /* 0x1588 */ unsigned __int64 MaxDuration;
  /* 0x1590 */ unsigned __int64 MinDuration;
  /* 0x1598 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x15a0 */
