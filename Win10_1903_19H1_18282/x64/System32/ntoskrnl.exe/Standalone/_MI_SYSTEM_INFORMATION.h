...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x01e0 */ struct _RTL_BITMAP_EX ImageBitMapWow;
  /* 0x01f0 */ unsigned __int64 ImageBiasWow;
  /* 0x01f8 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  /* 0x0208 */ struct _RTL_BITMAP_EX ImageBitMap64Low;
  /* 0x0218 */ unsigned __int64 ImageBias64Low;
  ...
  /* 0x0248 */ struct _SECTION* CfgBitMapSection;
  /* 0x0250 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0258 */ struct _SECTION* CfgBitMapSectionWow;
  /* 0x0260 */ struct _CONTROL_AREA* CfgBitMapControlAreaWow;
