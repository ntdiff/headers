...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x012f */ char Padding_62;
  /* 0x0130 */ enum _PROCESSOR_PRESENCE Presence;
  /* 0x0134 */ long Padding_63;
  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0b70 */ unsigned long MitigationFlags3Spare : 31; /* bit position: 1 */
      }; /* bitfield */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_192[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_193[2];
...
typedef struct _LDR_DATA_TABLE_ENTRY
{
  ...
  /* 0x011d */ char Padding_209[3];
  /* 0x0120 */ unsigned long CheckSum;
  /* 0x0124 */ long Padding_210;
