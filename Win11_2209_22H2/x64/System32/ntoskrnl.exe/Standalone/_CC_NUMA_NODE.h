...
typedef struct _CC_NUMA_NODE
{
  ...
  /* 0x0118 */ struct _LIST_ENTRY IdleAsyncLazywriteWorkerThreadList;
  /* 0x0128 */ unsigned long NumberActiveAsyncLazywriteWorkerThreads;
  /* 0x0130 */ struct _LIST_ENTRY AsyncLazywriteWorkQueue;
  /* 0x0140 */ struct _KEVENT NewAsyncLazywriteRequestEvent;
  /* 0x0158 */ struct _ASYNC_LAZYWRITE_THREAD_STATS LazywriterThreadsStats;
  /* 0x0188 */ struct _LIST_ENTRY IdleCompleteAsyncLazywriteWorkerThreadList;
  /* 0x0198 */ unsigned long NumberActiveCompleteAsyncLazywriteWorkers;
  /* 0x01a0 */ struct _LIST_ENTRY AsyncLazywriteCompletionWorkQueue;
} CC_NUMA_NODE, *PCC_NUMA_NODE; /* size: 0x01b0 */
