typedef struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
  ...
  /* 0x0160 */ void* SetDeviceAtsEnabled /* function */;
  /* 0x0168 */ void* SetDeviceCapabilities /* function */;
  /* 0x0170 */ void* HvDebuggerPowerHandler /* function */;
  /* 0x0178 */ void* SetQpcBias /* function */;
  /* 0x0180 */ void* GetQpcBias /* function */;
  /* 0x0188 */ void* RegisterDeviceId /* function */;
  /* 0x0190 */ void* UnregisterDeviceId /* function */;
  /* 0x0198 */ void* AllocateDeviceDomain /* function */;
  /* 0x01a0 */ void* AttachDeviceDomain /* function */;
  /* 0x01a8 */ void* DetachDeviceDomain /* function */;
  /* 0x01b0 */ void* DeleteDeviceDomain /* function */;
  /* 0x01b8 */ void* MapDeviceLogicalRange /* function */;
  /* 0x01c0 */ void* UnmapDeviceLogicalRange /* function */;
  /* 0x01c8 */ void* MapDeviceSparsePages /* function */;
  /* 0x01d0 */ void* UnmapDeviceSparsePages /* function */;
  /* 0x01d8 */ void* GetDmaGuardEnabled /* function */;
  /* 0x01e0 */ void* UpdateMicrocode /* function */;
  /* 0x01e8 */ void* GetSintMessage /* function */;
  /* 0x01f0 */ void* RestoreTime /* function */;
  /* 0x01f8 */ void* SetRootFaultReportingReady /* function */;
  /* 0x0200 */ void* ConfigureDeviceDomain /* function */;
  /* 0x0208 */ void* UnblockDefaultDma /* function */;
  /* 0x0210 */ void* FlushDeviceDomain /* function */;
  /* 0x0218 */ void* FlushDeviceDomainVaList /* function */;
  /* 0x0220 */ void* GetHybridPassthroughReservedRegions /* function */;
} HAL_INTEL_ENLIGHTENMENT_INFORMATION, *PHAL_INTEL_ENLIGHTENMENT_INFORMATION; /* size: 0x0228 */
