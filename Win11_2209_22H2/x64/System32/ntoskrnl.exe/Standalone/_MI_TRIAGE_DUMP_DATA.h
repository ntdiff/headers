typedef struct _MI_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long ExceptionHandlingReady : 1; /* bit position: 21 */
    /* 0x0000 */ unsigned long ShadowStacksSupported : 1; /* bit position: 22 */
    /* 0x0000 */ unsigned long AccessBitFenceRequired : 1; /* bit position: 23 */
    /* 0x0000 */ unsigned long AccessBitReplacementCapability : 2; /* bit position: 24 */
    ...
    /* 0x0000 */ unsigned long BootImageUnprivilegedPagesUnregistered : 1; /* bit position: 29 */
    /* 0x0000 */ unsigned long ImageProtectedSlabExecutableOnly : 1; /* bit position: 30 */
    /* 0x0000 */ unsigned long SpecialReadOnlyProtectedSlabPages : 1; /* bit position: 31 */
  }; /* bitfield */
  struct /* bitfield */
  {
    /* 0x0004 */ unsigned long SlabAllocatorsReady : 1; /* bit position: 0 */
    /* 0x0004 */ unsigned long KasanEnabled : 1; /* bit position: 1 */
  }; /* bitfield */
