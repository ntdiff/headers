  ...
  union
  {
    ...
    struct
    {
      ...
      struct /* bitfield */
      {
        ...
        /* 0x0004 */ unsigned long ShortThreadRuntimeThreshold : 1; /* bit position: 21 */
        /* 0x0004 */ unsigned long ShortThreadArchClassUpperThreshold : 1; /* bit position: 22 */
        /* 0x0004 */ unsigned long ShortThreadArchClassLowerThreshold : 1; /* bit position: 23 */
        /* 0x0004 */ unsigned long LongThreadArchClassUpperThreshold : 1; /* bit position: 24 */
        /* 0x0004 */ unsigned long LongThreadArchClassLowerThreshold : 1; /* bit position: 25 */
        /* 0x0004 */ unsigned long ModuleUnparkPolicy : 1; /* bit position: 26 */
        /* 0x0004 */ unsigned long ComplexUnparkPolicy : 1; /* bit position: 27 */
        /* 0x0004 */ unsigned long SmtUnparkPolicy : 1; /* bit position: 28 */
        /* 0x0004 */ unsigned long Spare : 3; /* bit position: 29 */
      }; /* bitfield */
    }; /* size: 0x0008 */
  }; /* size: 0x0008 */
...
typedef struct _PPM_ENGINE_SETTINGS
{
  ...
  /* 0x00a1 */ unsigned char HeteroDecreaseThreshold[64][2];
  /* 0x0121 */ unsigned char HeteroIncreaseThreshold[64][2];
  /* 0x01a1 */ unsigned char Class0FloorPerformance;
  /* 0x01a2 */ unsigned char Class1InitialPerformance;
  /* 0x01a4 */ unsigned long ShortThreadRuntimeThreshold;
  /* 0x01a8 */ enum _KHETERO_CPU_POLICY ThreadPolicies[2];
  /* 0x01b0 */ unsigned char ArchClassLowerThreshold[2];
  /* 0x01b2 */ unsigned char ArchClassUpperThreshold[2];
  /* 0x01b4 */ unsigned char ModuleUnparkPolicy;
  /* 0x01b5 */ unsigned char ComplexUnparkPolicy;
  /* 0x01b6 */ unsigned char SmtUnparkPolicy;
  /* 0x01b7 */ char __PADDING__[1];
} PPM_ENGINE_SETTINGS, *PPPM_ENGINE_SETTINGS; /* size: 0x01b8 */
...
typedef struct _POP_PPM_PROFILE
{
  ...
  /* 0x0398 */ unsigned __int64 StartTime;
  /* 0x03a0 */ unsigned __int64 Count;
  /* 0x03a8 */ unsigned __int64 MaxDuration;
  /* 0x03b0 */ unsigned __int64 MinDuration;
  /* 0x03b8 */ unsigned __int64 TotalDuration;
} POP_PPM_PROFILE, *PPOP_PPM_PROFILE; /* size: 0x03c0 */
