...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x01b0 */ unsigned long WatchdogTimeout;
  /* 0x01b8 */ struct _KTHREAD* ActionWorkerThread;
  /* 0x01c0 */ struct _KTHREAD* PromoteActionWorkerThread;
  /* 0x01c8 */ struct _KTHREAD* UnlockAfterSleepWorkerThread;
} POP_POWER_ACTION, *PPOP_POWER_ACTION; /* size: 0x01d0 */
