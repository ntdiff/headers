...
typedef struct _ETW_STACK_TRACE_BLOCK
{
  ...
  /* 0x0084 */ unsigned long MinimumApcCount;
  /* 0x0088 */ unsigned long MaximumApcCount;
  /* 0x008c */ long Flags;
  /* 0x0090 */ long OutstandingApcCount;
  /* 0x0094 */ long MaxOutstandingApcCount;
  /* 0x0098 */ long __PADDING__[2];
...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  /* 0x0438 */ struct PERIODIC_CAPTURE_STATE_CONTEXT* PeriodicCaptureStateContext;
  /* 0x0440 */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x0448 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x0450 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x0470 */ long CompressionWorkItemState;
  /* 0x0478 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x0480 */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x0488 */ void* CompressionWorkspace;
  /* 0x0490 */ long CompressionOn;
  /* 0x0494 */ unsigned long CompressionRatioGuess;
  /* 0x0498 */ unsigned long PartialBufferCompressionLevel;
  /* 0x049c */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x04a0 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x04a8 */ struct _KDPC CompressionDpc;
  /* 0x04e8 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x04f0 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x04f8 */ union _LARGE_INTEGER BufferCompressDuration;
  /* 0x0500 */ __int64 ReferenceQpcDelta;
  /* 0x0508 */ struct _ETW_EVENT_CALLBACK_CONTEXT* CallbackContext;
  /* 0x0510 */ union _LARGE_INTEGER* LastDroppedTime;
  /* 0x0518 */ union _LARGE_INTEGER* FlushingLastDroppedTime;
  /* 0x0520 */ __int64 FlushingSequenceNumber;
  /* 0x0528 */ struct _ETW_PARTITION_CONTEXT PartitionContext;
  /* 0x0530 */ struct _MDL* BufferMdl;
  /* 0x0538 */ long __PADDING__[2];
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x0540 */
