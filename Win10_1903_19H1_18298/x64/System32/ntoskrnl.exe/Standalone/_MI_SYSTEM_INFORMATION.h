...
typedef struct _MI_SECTION_STATE
{
  ...
  /* 0x01c8 */ struct _RTL_BITMAP_EX ImageBitMapNative;
  /* 0x01d8 */ unsigned __int64 ImageBiasNative;
  /* 0x01e0 */ struct _MI_SECTION_WOW_STATE Wow[1];
  /* 0x0200 */ unsigned __int64 ImageBiasWow;
  /* 0x0208 */ struct _RTL_BITMAP_EX ImageBitMapWowScratch;
  /* 0x0218 */ struct _RTL_BITMAP_EX ImageBitMap64Low;
  /* 0x0228 */ unsigned __int64 ImageBias64Low;
  /* 0x0230 */ void* ApiSetSection;
  /* 0x0238 */ void* ApiSetSchema;
  /* 0x0240 */ unsigned __int64 ApiSetSchemaSize;
  /* 0x0248 */ unsigned long LostDataFiles;
  /* 0x024c */ unsigned long LostDataPages;
  /* 0x0250 */ unsigned long ImageFailureReason;
  /* 0x0258 */ struct _SECTION* CfgBitMapSection;
  /* 0x0260 */ struct _CONTROL_AREA* CfgBitMapControlArea;
  /* 0x0268 */ struct _RTL_BITMAP_EX KernelCfgBitMap;
  /* 0x0278 */ struct _EX_PUSH_LOCK KernelCfgBitMapLock;
  /* 0x0280 */ unsigned long ImageCfgFailure;
  /* 0x0284 */ unsigned long RetpolineReservePages;
  /* 0x0288 */ struct _MDL* RetpolineStubMdl;
  /* 0x0290 */ struct _RTL_BITMAP_EX KernelRetpolineBitMap;
  /* 0x02a0 */ struct _RTL_RETPOLINE_ROUTINES* RetpolineRoutines;
  /* 0x02a8 */ struct _MMPTE* RetpolineRevertPte;
  /* 0x02b0 */ unsigned long RetpolineStubPages;
  /* 0x02b4 */ unsigned long ImageBreakpointEnabled;
  /* 0x02b8 */ unsigned long ImageBreakpointChecksum;
  /* 0x02bc */ unsigned long ImageBreakpointSize;
  /* 0x02c0 */ volatile long ImageValidationFailed;
  /* 0x02c4 */ unsigned long HotPatchReserveSize;
  /* 0x02c8 */ long __PADDING__[14];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0480 */ struct _MI_SESSION_STATE Sessions;
  /* 0x1500 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1580 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1740 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x1bc0 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x1be0 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x1c08 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x1c68 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x1ce0 */ struct _MI_ERROR_STATE Errors;
  /* 0x1dc0 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x1e40 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x1f60 */ struct _MI_STANDBY_STATE Standby;
  /* 0x2000 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x2200 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x2270 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x22c0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x2380 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x23c0 */ unsigned __int64 Cookie;
  /* 0x23c8 */ void* volatile* BootRegistryRuns;
  /* 0x23d0 */ volatile long ZeroingDisabled;
  /* 0x23d4 */ unsigned char FullyInitialized;
  /* 0x23d5 */ unsigned char SafeBooted;
  /* 0x23d8 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x2400 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x2f80 */
