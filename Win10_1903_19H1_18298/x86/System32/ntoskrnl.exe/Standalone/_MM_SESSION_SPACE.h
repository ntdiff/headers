...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0064 */ struct _MMSESSION Session;
  /* 0x0078 */ unsigned __int64 CombineDomain;
  /* 0x0080 */ struct _MMSUPPORT_FULL Vm;
  /* 0x0140 */ struct _MMWSL_INSTANCE WorkingSetList;
  /* 0x0158 */ void* HeapState;
  /* 0x0180 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x0280 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0284 */ unsigned long TopLevelPteLockBits[128];
  /* 0x0488 */ struct _MMPTE PageTables[1024];
  /* 0x2488 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x248c */ long PoolBigEntriesInUse;
  /* 0x2490 */ volatile long PagedPoolPdeCount;
  /* 0x2494 */ unsigned long DynamicSessionPdeCount;
  /* 0x2498 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x24cc */ void* PoolTrackTableExpansion;
  /* 0x24d0 */ unsigned long PoolTrackTableExpansionSize;
  /* 0x24d4 */ void* PoolTrackBigPages;
  /* 0x24d8 */ unsigned long PoolTrackBigPagesSize;
  /* 0x24dc */ struct _RTL_AVL_TREE PermittedFaultsTree;
  /* 0x24e0 */ enum _IO_SESSION_STATE IoState;
  /* 0x24e4 */ unsigned long IoStateSequence;
  /* 0x24e8 */ struct _KEVENT IoNotificationEvent;
  /* 0x24f8 */ struct _EJOB* ServerSilo;
  /* 0x2500 */ unsigned __int64 CreateTime;
