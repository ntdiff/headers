...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x016a */ char Padding_42[6];
  /* 0x0170 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x0208 */ long Padding_43[2];
...
typedef struct _MMSUPPORT_INSTANCE
{
  ...
  /* 0x0060 */ struct _KGATE* ExitOutswapGate;
  /* 0x0068 */ unsigned __int64 MinimumWorkingSetSize;
  /* 0x0070 */ unsigned __int64 WorkingSetLeafSize;
  /* 0x0078 */ unsigned __int64 WorkingSetLeafPrivateSize;
  /* 0x0080 */ unsigned __int64 WorkingSetSize;
  /* 0x0088 */ unsigned __int64 WorkingSetPrivateSize;
  /* 0x0090 */ unsigned __int64 MaximumWorkingSetSize;
  ...
  /* 0x00b0 */ unsigned __int64 Reserved0;
...
} MMSUPPORT_FULL, *PMMSUPPORT_FULL; /* size: 0x0108 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x0608 */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0618 */ unsigned long ModifiedPageCount;
  /* 0x061c */ long ExitStatus;
  /* 0x0620 */ struct _RTL_AVL_TREE VadRoot;
  /* 0x0628 */ void* VadHint;
  /* 0x0630 */ unsigned __int64 VadCount;
  /* 0x0638 */ volatile unsigned __int64 VadPhysicalPages;
  /* 0x0640 */ unsigned __int64 VadPhysicalPagesLimit;
  /* 0x0648 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x0668 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x0678 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x0680 */ unsigned long RequestedTimerResolution;
  /* 0x0684 */ unsigned long SmallestTimerResolution;
  /* 0x0688 */ union _LARGE_INTEGER ExitTime;
  /* 0x0690 */ struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
  /* 0x0698 */ struct _EX_PUSH_LOCK InvertedFunctionTableLock;
  /* 0x06a0 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x06a4 */ unsigned long LargePrivateVadCount;
  /* 0x06a8 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x06b0 */ void* WnfContext;
  /* 0x06b8 */ unsigned __int64 Spare0;
  /* 0x06c0 */ unsigned char SignatureLevel;
  /* 0x06c1 */ unsigned char SectionSignatureLevel;
  /* 0x06c2 */ struct _PS_PROTECTION Protection;
  /* 0x06c3 */ unsigned char HangCount;
  union
  {
    /* 0x06c4 */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x06c4 */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x06c4 */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x06c4 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 2 */
      /* 0x06c4 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 3 */
      /* 0x06c4 */ unsigned long Crashed : 1; /* bit position: 4 */
      /* 0x06c4 */ unsigned long JobVadsAreTracked : 1; /* bit position: 5 */
      /* 0x06c4 */ unsigned long VadTrackingDisabled : 1; /* bit position: 6 */
      /* 0x06c4 */ unsigned long AuxiliaryProcess : 1; /* bit position: 7 */
      /* 0x06c4 */ unsigned long SubsystemProcess : 1; /* bit position: 8 */
      /* 0x06c4 */ unsigned long IndirectCpuSets : 1; /* bit position: 9 */
      /* 0x06c4 */ unsigned long InPrivate : 1; /* bit position: 10 */
      /* 0x06c4 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 11 */
      /* 0x06c4 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 12 */
      /* 0x06c4 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 13 */
      /* 0x06c4 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 14 */
      /* 0x06c4 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 15 */
      /* 0x06c4 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 16 */
      /* 0x06c4 */ unsigned long PreferSystem32Images : 1; /* bit position: 17 */
      /* 0x06c4 */ unsigned long RelinquishedCommit : 1; /* bit position: 18 */
      /* 0x06c4 */ unsigned long AutomaticallyOverrideChildProcessPolicy : 1; /* bit position: 19 */
      /* 0x06c4 */ unsigned long HighGraphicsPriority : 1; /* bit position: 20 */
      /* 0x06c4 */ unsigned long CommitFailLogged : 1; /* bit position: 21 */
      /* 0x06c4 */ unsigned long ReserveFailLogged : 1; /* bit position: 22 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x06c8 */ long DeviceAsid;
  /* 0x06cc */ long Padding_57;
  /* 0x06d0 */ void* SvmData;
  /* 0x06d8 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x06e0 */ unsigned __int64 SvmLock;
  /* 0x06e8 */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x06f8 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x0700 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x0708 */ void* PicoContext;
  /* 0x0710 */ unsigned __int64 TrustletIdentity;
  /* 0x0718 */ unsigned long KeepAliveCounter;
  /* 0x071c */ unsigned long NoWakeKeepAliveCounter;
  /* 0x0720 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x0724 */ long Padding_58;
  /* 0x0728 */ struct _PROCESS_ENERGY_VALUES* EnergyValues;
  ...
  /* 0x07a0 */ unsigned long ReadyTime;
  /* 0x07a4 */ long Padding_59;
  /* 0x07a8 */ void* DxgProcess;
} EPROCESS, *PEPROCESS; /* size: 0x07b0 */
...
typedef struct _EJOB
{
  ...
  /* 0x03a8 */ struct _JOBOBJECT_WAKE_FILTER WakeFilter;
  /* 0x03b0 */ unsigned long LowEdgeLatchFilter;
  /* 0x03b4 */ unsigned long OwnedHighEdgeFilters;
  /* 0x03b8 */ struct _EJOB* NotificationLink;
  /* 0x03c0 */ unsigned __int64 CurrentJobMemoryUsed;
  /* 0x03c8 */ struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
  /* 0x03d0 */ void* NotificationInfoQuotaReference;
  /* 0x03d8 */ struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
  /* 0x03e0 */ struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
  /* 0x03e8 */ void* EffectiveSchedulingGroup;
  /* 0x03f0 */ unsigned __int64 ReadyTime;
  /* 0x03f8 */ struct _EX_PUSH_LOCK MemoryLimitsLock;
  /* 0x0400 */ struct _LIST_ENTRY SiblingJobLinks;
  /* 0x0410 */ struct _LIST_ENTRY ChildJobListHead;
  /* 0x0420 */ struct _EJOB* ParentJob;
  /* 0x0428 */ struct _EJOB* ParentSilo;
  ...
  /* 0x0458 */ unsigned __int64 TimerListLock;
  /* 0x0460 */ struct _LIST_ENTRY TimerListHead;
  /* 0x0470 */ struct _EPROCESS_VALUES Accounting;
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0518 */ unsigned long Spare : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x051c */ unsigned long EffectiveHighEdgeFilters;
  /* 0x0520 */ struct _PROCESS_ENERGY_VALUES* EnergyValues;
  /* 0x0528 */ volatile unsigned __int64 SharedCommitCharge;
  /* 0x0530 */ struct _EJOB* volatile WakeRoot;
  /* 0x0538 */ unsigned long DiskIoAttributionUserRefCount;
  /* 0x053c */ unsigned long DiskIoAttributionRefCount;
  union
  {
    /* 0x0540 */ void* DiskIoAttributionContext;
    /* 0x0540 */ struct _EJOB* DiskIoAttributionOwnerJob;
  }; /* size: 0x0008 */
  /* 0x0548 */ struct _PS_IO_CONTROL_ENTRY GlobalIoControl;
  /* 0x0580 */ volatile long VolumeIoControlLock;
  /* 0x0584 */ long Padding_70;
  /* 0x0588 */ struct _RTL_RB_TREE VolumeIoControlTree;
  /* 0x0598 */ struct _EX_PUSH_LOCK IoControlLock;
  /* 0x05a0 */ unsigned __int64 SiloHardReferenceCount;
  /* 0x05a8 */ struct _WORK_QUEUE_ITEM RundownWorkItem;
} EJOB, *PEJOB; /* size: 0x05c8 */
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x00c4 */ unsigned char EfficiencyClass;
  /* 0x00c5 */ unsigned char NominalPerformanceClass;
  /* 0x00c6 */ unsigned char HighestPerformanceClass;
  /* 0x00c7 */ unsigned char Spare;
...
typedef struct _TEB
{
  ...
  /* 0x0190 */ void* SystemReserved1[37];
...
typedef struct _KLOCK_ENTRY
{
  ...
  union
  {
    /* 0x0058 */ unsigned long AllBoosts : 17; /* bit position: 0 */
    struct
    {
      struct /* bitfield */
      {
        /* 0x0058 */ unsigned short CpuBoostsBitmap : 15; /* bit position: 0 */
        /* 0x0058 */ unsigned short IoBoost : 1; /* bit position: 15 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x005a */ unsigned short IoQoSBoost : 1; /* bit position: 0 */
        /* 0x005a */ unsigned short IoNormalPriorityWaiterCount : 8; /* bit position: 1 */
        /* 0x005a */ unsigned short IoQoSWaiterCount : 7; /* bit position: 9 */
      }; /* bitfield */
    }; /* size: 0x0004 */
  }; /* size: 0x0004 */
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0078 */ unsigned long RestrictedGuiThread : 1; /* bit position: 19 */
      /* 0x0078 */ unsigned long ThreadFlagsSpare : 4; /* bit position: 20 */
...
typedef struct _KPRCB
{
  ...
  /* 0x6864 */ long Padding_100;
  /* 0x6868 */ void* ExSaPageArray;
  /* 0x6870 */ long Padding_101[4];
  /* 0x6880 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x6888 */ long Padding_102[14];
...
typedef struct _KNODE
{
  ...
  /* 0x0060 */ long Padding_120[8];
  /* 0x0080 */ unsigned long SiblingMask;
  /* 0x0084 */ long Padding_121;
  union
  {
...
typedef struct _ETHREAD
{
  ...
  /* 0x05e0 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x05e8 */ union _LARGE_INTEGER ExitTime;
    /* 0x05e8 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  /* 0x05f8 */ void* ChargeOnlySession;
  union
  {
    /* 0x0600 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0600 */ void* ForwardLinkShadow;
      /* 0x0608 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x0610 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0610 */ struct _ETHREAD* ReaperLink;
    /* 0x0610 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x0618 */ unsigned __int64 ActiveTimerListLock;
  /* 0x0620 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0630 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0640 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0640 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x0660 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x0668 */ struct _LIST_ENTRY IrpList;
  /* 0x0678 */ unsigned __int64 TopLevelIrp;
  /* 0x0680 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x0688 */ void* Win32StartAddress;
  /* 0x0690 */ void* LegacyPowerObject;
  /* 0x0698 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06a8 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x06b0 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x06b8 */ unsigned long ReadClusterSize;
  /* 0x06bc */ volatile long MmLockOrdering;
  union
  {
    /* 0x06c0 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x06c0 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x06c0 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x06c0 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x06c0 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x06c0 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x06c0 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x06c0 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x06c0 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x06c0 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x06c0 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x06c0 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x06c0 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x06c0 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x06c0 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x06c0 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x06c0 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x06c0 */ unsigned long ReservedCrossThreadFlags : 12; /* bit position: 20 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06c4 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x06c4 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x06c4 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x06c4 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x06c4 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x06c4 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x06c4 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x06c4 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x06c4 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x06c4 */ unsigned long ReservedSameThreadPassiveFlags : 23; /* bit position: 9 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x06c8 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x06c8 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x06c8 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x06c8 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x06c8 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x06c8 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x06c8 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x06c8 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x06c8 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x06c9 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x06c9 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x06cc */ unsigned char CacheManagerActive;
  /* 0x06cd */ unsigned char DisablePageFaultClustering;
  /* 0x06ce */ unsigned char ActiveFaultCount;
  /* 0x06cf */ unsigned char LockOrderState;
  ...
  /* 0x06f0 */ long ExitStatus;
  /* 0x06f4 */ unsigned long CacheManagerCount;
  /* 0x06f8 */ unsigned long IoBoostCount;
  /* 0x06fc */ unsigned long IoQoSBoostCount;
  /* 0x0700 */ unsigned long IoQoSThrottleCount;
  /* 0x0704 */ long Padding_143;
  /* 0x0708 */ struct _LIST_ENTRY BoostList;
  /* 0x0718 */ struct _LIST_ENTRY DeboostList;
  /* 0x0728 */ unsigned __int64 BoostListLock;
  /* 0x0730 */ unsigned __int64 IrpListLock;
  /* 0x0738 */ void* ReservedForSynchTracking;
  /* 0x0740 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0748 */ const struct _GUID* ActivityId;
  /* 0x0750 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0758 */ void* VerifierContext;
  /* 0x0760 */ unsigned long KernelStackReference;
  /* 0x0764 */ long Padding_144;
  /* 0x0768 */ void* AdjustedClientToken;
  /* 0x0770 */ void* WorkOnBehalfThread;
  /* 0x0778 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x0790 */ void* PicoContext;
  /* 0x0798 */ unsigned __int64 UserFsBase;
  /* 0x07a0 */ unsigned __int64 UserGsBase;
  /* 0x07a8 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x07b0 */ void* CmDbgInfo;
  union
  {
    /* 0x07b8 */ unsigned __int64 SelectedCpuSets;
    /* 0x07b8 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x07c0 */ struct _EJOB* Silo;
  /* 0x07c8 */ struct _UNICODE_STRING* ThreadName;
  /* 0x07d0 */ struct _CONTEXT* SetContextState;
  /* 0x07d8 */ unsigned long ReadyTime;
  /* 0x07dc */ long __PADDING__[1];
} ETHREAD, *PETHREAD; /* size: 0x07e0 */
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0300 */ struct _SEP_RM_LSA_CONNECTION_STATE SeRmSiloState;
  /* 0x0350 */ struct _ETW_SILODRIVERSTATE* EtwSiloState;
  /* 0x0358 */ struct _EPROCESS* MiSessionLeaderProcess;
  /* 0x0360 */ struct _EPROCESS* ExpDefaultErrorPortProcess;
  /* 0x0368 */ void* ExpDefaultErrorPort;
  /* 0x0370 */ unsigned long HardErrorState;
  /* 0x0374 */ long Padding_167;
  /* 0x0378 */ struct _WNF_SILODRIVERSTATE WnfSiloState;
  /* 0x03b0 */ void* ApiSetSection;
  /* 0x03b8 */ void* ApiSetSchema;
  /* 0x03c0 */ unsigned char OneCoreForwardersEnabled;
  /* 0x03c1 */ char Padding_168[7];
  /* 0x03c8 */ struct _UNICODE_STRING SiloRootDirectoryName;
  /* 0x03d8 */ struct _PSP_STORAGE* Storage;
  /* 0x03e0 */ enum _SERVERSILO_STATE State;
  /* 0x03e4 */ long ExitStatus;
  /* 0x03e8 */ struct _KEVENT* DeleteEvent;
  /* 0x03f0 */ struct _SILO_USER_SHARED_DATA UserSharedData;
  /* 0x0410 */ struct _WORK_QUEUE_ITEM TerminateWorkItem;
} ESERVERSILO_GLOBALS, *PESERVERSILO_GLOBALS; /* size: 0x0430 */
...
typedef struct _OBJECT_DIRECTORY
{
  ...
  /* 0x0140 */ unsigned long SessionId;
  /* 0x0144 */ long Padding_169;
  /* 0x0148 */ void* NamespaceEntry;
