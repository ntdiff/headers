...
typedef struct _MI_PARTITION_CORE
{
  ...
  /* 0x0078 */ unsigned __int64 PfnUnmapCount;
  /* 0x0080 */ void* PfnUnmapWaitList;
  /* 0x0088 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* MemoryRuns;
  /* 0x0090 */ struct _KEVENT ExitEvent;
  /* 0x00a8 */ void* SystemThreadHandles[5];
  /* 0x00d0 */ void* PartitionObject;
  /* 0x00d8 */ void* PartitionObjectHandle;
  ...
  /* 0x0108 */ struct _KEVENT* MemoryEvents[11];
} MI_PARTITION_CORE, *PMI_PARTITION_CORE; /* size: 0x0160 */
...
typedef struct _MI_PARTITION_SEGMENTS
{
  ...
  /* 0x0148 */ volatile __int64 ControlAreaCount;
...
typedef struct _MI_PARTITION_PAGE_LISTS
{
  ...
  /* 0x0ad0 */ void* MirrorListLocks;
  /* 0x0ad8 */ unsigned char LargePfnBitMapsReady;
  /* 0x0ae0 */ struct _RTL_BITMAP_EX LargePfnBitMap[2];
  /* 0x0b00 */ unsigned __int64 LargePfnBitMapLock;
  /* 0x0b08 */ long __PADDING__[14];
} MI_PARTITION_PAGE_LISTS, *PMI_PARTITION_PAGE_LISTS; /* size: 0x0b40 */
...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x03a0 */ unsigned char SystemCacheInitialized;
  /* 0x03a8 */ volatile unsigned __int64 TotalCommittedPages;
  /* 0x03c0 */ struct _MMPFNLIST ModifiedPageListHead;
  /* 0x0400 */ struct _MMPFNLIST ModifiedNoWritePageListHead;
  /* 0x0428 */ unsigned __int64 TotalCommitLimit;
  /* 0x0430 */ unsigned __int64 TotalPagesForPagingFile;
  /* 0x0438 */ unsigned __int64 VadPhysicalPages;
  /* 0x0440 */ unsigned __int64 ProcessLockedFilePages;
  /* 0x0448 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x0458 */ volatile unsigned __int64 PageTableBitmapPages;
  /* 0x0460 */ volatile long PageFileTraceIndex;
  /* 0x0468 */ struct _MI_PAGEFILE_TRACES PageFileTraces[32];
  /* 0x1368 */ long __PADDING__[6];
} MI_VISIBLE_PARTITION, *PMI_VISIBLE_PARTITION; /* size: 0x1380 */

typedef struct _MI_PARTITION
{
  /* 0x0000 */ struct _MI_PARTITION_CORE Core;
  /* 0x0160 */ struct _MI_PARTITION_MODWRITES Modwriter;
  ...
  /* 0x1180 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x1200 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x1260 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x13e8 */ void* WorkingSetControl;
  /* 0x13f0 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x1400 */ struct _MI_VISIBLE_PARTITION Vp;
} MI_PARTITION, *PMI_PARTITION; /* size: 0x2780 */
