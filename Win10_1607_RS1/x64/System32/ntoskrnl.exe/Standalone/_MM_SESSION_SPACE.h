...
typedef struct _POOL_DESCRIPTOR
{
  ...
  /* 0x0108 */ volatile long ThreadsProcessingDeferrals;
  /* 0x010c */ volatile long PendingFreeDepth;
...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0068 */ struct _RTL_AVL_TREE ImageTree;
  /* 0x0070 */ unsigned long LocaleId;
  /* 0x0074 */ unsigned long AttachCount;
  /* 0x0078 */ struct _KGATE AttachGate;
  /* 0x0090 */ struct _LIST_ENTRY WsListEntry;
  /* 0x00c0 */ struct _GENERAL_LOOKASIDE Lookaside[21];
  /* 0x0b40 */ struct _MMSESSION Session;
  /* 0x0b60 */ struct _MM_PAGED_POOL_INFO PagedPoolInfo;
  /* 0x0bc0 */ struct _MMSUPPORT_FULL Vm;
  /* 0x0d00 */ struct _MMSUPPORT_AGGREGATION AggregateSessionWs;
  /* 0x0d20 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0d40 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x1e80 */ struct _MMPTE PageDirectory;
  /* 0x1e88 */ struct _EX_PUSH_LOCK SessionVaLock;
  /* 0x1e90 */ struct _RTL_BITMAP DynamicVaBitMap;
  /* 0x1ea0 */ unsigned long DynamicVaHint;
  /* 0x1ea8 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x1ef8 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x1f00 */ long PoolBigEntriesInUse;
  /* 0x1f04 */ unsigned long PagedPoolPdeCount;
  /* 0x1f08 */ unsigned long SpecialPoolPdeCount;
  /* 0x1f0c */ unsigned long DynamicSessionPdeCount;
  /* 0x1f10 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1f78 */ void* PoolTrackTableExpansion;
  /* 0x1f80 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x1f88 */ void* PoolTrackBigPages;
  /* 0x1f90 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x1f98 */ enum _IO_SESSION_STATE IoState;
  /* 0x1f9c */ unsigned long IoStateSequence;
  /* 0x1fa0 */ struct _KEVENT IoNotificationEvent;
  /* 0x1fb8 */ struct _EJOB* ServerSilo;
  /* 0x1fc0 */ unsigned __int64 CreateTime;
  /* 0x2000 */ unsigned char PoolTags[8192];
} MM_SESSION_SPACE, *PMM_SESSION_SPACE; /* size: 0x4000 */
