...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x00a8 */ void* DriverContext;
  /* 0x00b0 */ struct _LIST_ENTRY AcpiLink;
  /* 0x00c0 */ struct _UNICODE_STRING DeviceId;
  /* 0x00d0 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x00f0 */ struct _IO_REMOVE_LOCK AcpiRemoveLock;
  /* 0x0110 */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x0148 */ unsigned __int64 IdleLock;
  /* 0x0150 */ struct _KTIMER IdleTimer;
  /* 0x0190 */ struct _KDPC IdleDpc;
  /* 0x01d0 */ unsigned __int64 IdleTimeout;
  /* 0x01d8 */ unsigned __int64 IdleStamp;
  /* 0x01e0 */ struct _DEVICE_OBJECT* NextIrpDeviceObject[2];
  /* 0x01f0 */ union _POWER_STATE NextIrpPowerState[2];
  /* 0x01f8 */ void* NextIrpCallerCompletion[2] /* function */;
  /* 0x0208 */ void* NextIrpCallerContext[2];
  /* 0x0218 */ struct _KEVENT IrpCompleteEvent;
  /* 0x0230 */ void* PowerOnDumpDeviceCallback /* function */;
  /* 0x0238 */ struct _POP_FX_ACCOUNTING Accounting;
  /* 0x0268 */ volatile unsigned long Flags;
  /* 0x026c */ unsigned long ComponentCount;
  /* 0x0270 */ struct _POP_FX_COMPONENT** Components;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x0278 */
