...
typedef struct _VF_TARGET_VERIFIED_DRIVER_DATA
{
  ...
  /* 0x00f8 */ volatile unsigned long ExecutePoolTypes;
  /* 0x00fc */ volatile unsigned long ExecutePageProtections;
  /* 0x0100 */ volatile unsigned long ExecutePageMappings;
  /* 0x0104 */ volatile unsigned long ExecuteWriteSections;
  /* 0x0108 */ volatile unsigned long SectionAlignmentFailures;
  /* 0x010c */ volatile unsigned long UnsupportedRelocs;
  /* 0x0110 */ volatile unsigned long IATInExecutableSection;
  /* 0x0114 */ long __PADDING__[3];
