...
typedef struct _MI_VAD_EVENT_BLOCK
{
  ...
  union
  {
    ...
    /* 0x0010 */ struct _MI_LARGEPAGE_IMAGE_INFO LargePage;
    /* 0x0010 */ struct _ETHREAD* CreatingThread;
    /* 0x0010 */ struct _MI_SUB64K_FREE_RANGES PebTeb;
  }; /* size: 0x0030 */
} MI_VAD_EVENT_BLOCK, *PMI_VAD_EVENT_BLOCK; /* size: 0x0040 */
