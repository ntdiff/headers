...
typedef struct _MI_SYSTEM_IMAGE_STATE
{
  ...
  /* 0x0070 */ struct _LIST_ENTRY StrongCodeLoadFailureList;
  /* 0x0080 */ struct _KLDR_DATA_TABLE_ENTRY* BeingDeleted;
  /* 0x0088 */ struct _EX_PUSH_LOCK MappingRangesPushLock;
  /* 0x0090 */ struct _MI_DRIVER_VA* MappingRanges[2];
  /* 0x00a0 */ unsigned __int64 PageCount;
  /* 0x00a8 */ struct _MM_SYSTEM_PAGE_COUNTS PageCounts;
  /* 0x00b8 */ struct _EX_PUSH_LOCK CollidedLock;
...
typedef struct _MI_SESSION_STATE
{
  ...
  /* 0x0030 */ unsigned long* DynamicVaBitBuffer;
  ...
  /* 0x0060 */ unsigned long DetachTimeStamp;
  /* 0x0068 */ struct _EPROCESS* LeaderProcess;
  /* 0x0070 */ struct _EX_PUSH_LOCK InitializeLock;
  /* 0x0078 */ struct _MMWSL_FULL* WorkingSetList;
  /* 0x0080 */ struct _MMWSLE_HASH* WsHashStart;
  /* 0x0088 */ struct _MMWSLE_HASH* WsHashEnd;
  /* 0x0090 */ void* SessionBase;
  /* 0x0098 */ void* SessionCore;
} MI_SESSION_STATE, *PMI_SESSION_STATE; /* size: 0x00a0 */
...
typedef struct _MI_SYSTEM_PTE_TYPE
{
  ...
  /* 0x0038 */ struct _MMSUPPORT_INSTANCE* Vm;
  /* 0x0040 */ volatile unsigned __int64 TotalSystemPtes;
  /* 0x0048 */ unsigned __int64 Hint;
  /* 0x0050 */ unsigned __int64 LowestBitEverAllocated;
  /* 0x0058 */ volatile struct _MI_CACHED_PTES* CachedPtes;
  /* 0x0060 */ volatile unsigned __int64 TotalFreeSystemPtes;
...
typedef struct _MI_SYSTEM_PTE_STATE
{
  ...
  /* 0x0150 */ union _SLIST_HEADER QueuedStacks;
  /* 0x0160 */ unsigned long StackGrowthFailures;
  /* 0x0164 */ unsigned char TrackPtesAborted;
  /* 0x0165 */ unsigned char AdjustCounter;
  /* 0x0168 */ volatile long ReservedMappingLock;
  /* 0x0170 */ struct _RTL_AVL_TREE ReservedMappingTree;
  /* 0x0178 */ struct _MMPFN* ReservedMappingPageTablePfns;
  /* 0x0180 */ struct _MI_QUEUED_DEADSTACK_WORKITEM QueuedStacksWorkItem;
  /* 0x01a8 */ long __PADDING__[6];
} MI_SYSTEM_PTE_STATE, *PMI_SYSTEM_PTE_STATE; /* size: 0x01c0 */
...
typedef struct _MI_VISIBLE_STATE
{
  ...
  /* 0x0118 */ volatile unsigned __int64 NonPagedPoolCommit;
  /* 0x0120 */ volatile unsigned __int64 BootCommit;
  /* 0x0128 */ volatile unsigned __int64 MdlPagesAllocated;
  /* 0x0130 */ volatile unsigned __int64 SystemPageTableCommit;
  /* 0x0138 */ volatile unsigned __int64 SpecialPagesInUse;
  /* 0x0140 */ volatile unsigned __int64 WsOverheadPages;
  /* 0x0148 */ volatile unsigned __int64 VadBitmapPages;
  /* 0x0150 */ volatile unsigned __int64 ProcessCommit;
  /* 0x0158 */ volatile unsigned __int64 SharedCommit;
  /* 0x0160 */ volatile long DriverCommit;
  /* 0x0180 */ struct _MMSUPPORT_FULL SystemWs[3];
  /* 0x04c0 */ struct _MMSUPPORT_SHARED SystemCacheShared;
  /* 0x0540 */ struct _MMSUPPORT_AGGREGATION AggregateSystemWs[1];
  /* 0x0560 */ struct _MMWSL_SHARED SystemCacheSharedWorkingSetList;
  /* 0x05c0 */ unsigned long MapCacheFailures;
  /* 0x05c8 */ unsigned __int64 PagefileHashPages;
  /* 0x05d0 */ struct _SYSPTES_HEADER PteHeader;
  /* 0x06e8 */ struct _MI_SPECIAL_POOL* SessionSpecialPool;
  /* 0x06f0 */ unsigned __int64 SystemVaTypeCount[14];
  /* 0x0760 */ struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[14];
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x04e0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x0540 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x0640 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x0940 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x0ae0 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x0af0 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x0b50 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x0bd0 */ struct _MI_ERROR_STATE Errors;
  /* 0x0cc0 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x0d40 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x0e80 */ struct _MI_STANDBY_STATE Standby;
  /* 0x0f40 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x1100 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x1170 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x11c0 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x1280 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x12c0 */ struct _MI_RESAVAIL_TRACKER ResTrack;
  /* 0x1640 */ unsigned __int64 Cookie;
  /* 0x1648 */ volatile long ZeroingDisabled;
  /* 0x1650 */ void* volatile* BootRegistryRuns;
  /* 0x1658 */ unsigned char FullyInitialized;
  /* 0x1659 */ unsigned char SafeBooted;
  /* 0x1660 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x1680 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x1ec0 */
