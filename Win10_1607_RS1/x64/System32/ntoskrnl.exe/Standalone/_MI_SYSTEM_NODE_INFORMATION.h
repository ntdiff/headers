...
typedef struct _MI_SYSTEM_NODE_INFORMATION
{
  ...
  /* 0x0108 */ unsigned __int64 NonPagedPoolLowestPage;
  /* 0x0110 */ unsigned __int64 NonPagedPoolHighestPage;
  /* 0x0118 */ unsigned __int64 AllocatedNonPagedPool;
  /* 0x0120 */ unsigned __int64 PartialLargePoolRegions;
  /* 0x0128 */ unsigned __int64 PagesInPartialLargePoolRegions;
  /* 0x0130 */ unsigned __int64 CachedNonPagedPoolCount;
  /* 0x0138 */ unsigned __int64 NonPagedPoolSpinLock;
  /* 0x0140 */ struct _MMPFN* CachedNonPagedPool;
  /* 0x0148 */ void* NonPagedPoolFirstVa;
  /* 0x0150 */ void* NonPagedPoolLastVa;
  /* 0x0158 */ struct _RTL_BITMAP_EX NonPagedBitMap[3];
  /* 0x0188 */ unsigned __int64 NonPagedHint[2];
  /* 0x0198 */ long __PADDING__[2];
} MI_SYSTEM_NODE_INFORMATION, *PMI_SYSTEM_NODE_INFORMATION; /* size: 0x01a0 */
