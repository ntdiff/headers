...
typedef struct _MI_LARGE_PAGE_REBUILD_WAIT_BLOCK
{
  /* 0x0000 */ struct _MI_LARGE_PAGE_REBUILD_WAIT_BLOCK* Next;
  /* 0x0008 */ struct _KGATE Gate;
} MI_LARGE_PAGE_REBUILD_WAIT_BLOCK, *PMI_LARGE_PAGE_REBUILD_WAIT_BLOCK; /* size: 0x0020 */
