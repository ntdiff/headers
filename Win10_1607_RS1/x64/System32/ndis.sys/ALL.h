...
typedef enum _NDIS_NET_BUFFER_LIST_INFO
{
  ...
  GftFlowEntryId = 25,
  NetBufferListInfoReserved1 = 26,
  NetBufferListInfoReserved2 = 27,
  MaxNetBufferListInfo = 28,
...
class Ndis::BindState
{
  ...
  /* 0x0034 */ long Padding_96;
  /* 0x0038 */ class Rtl::KArray<void *> m_bindContext;
}; /* size: 0x0050 */

struct Ndis::BindStack
{
  /* 0x0000 */ long Padding_97[2];
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x10d6 */ char Padding_137[2];
  /* 0x10d8 */ unsigned long DirectOidRequestCount;
  /* 0x10dc */ long Padding_138;
...
typedef struct _NDIS_FILTER_BLOCK
{
  ...
  /* 0x0041 */ char Padding_303[7];
  /* 0x0048 */ struct _REFERENCE_EX Ref;
  /* 0x0060 */ int FakeStatus;
  /* 0x0064 */ long Padding_304;
...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0060 */ long Padding_363[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_364[12];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_458;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_459[2];
...
typedef struct _DOT11_INCOMING_ASSOC_DECISION
{
  ...
  /* 0x000b */ char Padding_500;
  /* 0x000c */ unsigned short usReasonCode;
  /* 0x000e */ char Padding_501[2];
...
typedef struct _NDIS_NET_BUFFER_LIST_POOL
{
  ...
  /* 0x0059 */ char Padding_522[3];
  /* 0x005c */ unsigned long DataSize;
  /* 0x0060 */ unsigned long MdlSize;
  /* 0x0064 */ long Padding_523[7];
...
??$QueryValueBlob@V<lambda_0a0f4a6e234c0d615b3ff6ea32737ef1>@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V<lambda_0a0f4a6e234c0d615b3ff6ea32737ef1>@@@Z
??$QueryValueBlob@V<lambda_1e1d3c9721006777a03f858ff1740b3c>@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V<lambda_1e1d3c9721006777a03f858ff1740b3c>@@@Z
??$QueryValueBlob@V<lambda_5658d1e45bdcd14f12a9cd7c7449a826>@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V<lambda_5658d1e45bdcd14f12a9cd7c7449a826>@@@Z
??$QueryValueBlob@V<lambda_9de55ca7b1f0fe2b3bf40ef5b9f15f31>@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V<lambda_9de55ca7b1f0fe2b3bf40ef5b9f15f31>@@@Z
??$QueryValueMultisz@V<lambda_43d9c6f647151fdb2f2362c6d885aaea>@@V<lambda_ac55aedf94f20521cfbcaaf74fbc728b>@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V<lambda_43d9c6f647151fdb2f2362c6d885aaea>@@V<lambda_ac55aedf94f20521cfbcaaf74fbc728b>@@@Z
??$QueryValueMultisz@V<lambda_7dba7dab9bc3060b810d705c95db8e00>@@V<lambda_91558b45fed37b56f47adbcac45390b4>@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V<lambda_7dba7dab9bc3060b810d705c95db8e00>@@V<lambda_91558b45fed37b56f47adbcac45390b4>@@@Z
??$QueryValueMultisz@V<lambda_ab37ff936e37ec89cf58545827f832d7>@@V<lambda_b9d9cb4442cf1f3c11bfda5894fd36a4>@@@KRegKey@@QEAAJPEBGV<lambda_ab37ff936e37ec89cf58545827f832d7>@@V<lambda_b9d9cb4442cf1f3c11bfda5894fd36a4>@@@Z
??$QueryValueMultisz@V<lambda_ab37ff936e37ec89cf58545827f832d7>@@V<lambda_b9d9cb4442cf1f3c11bfda5894fd36a4>@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V<lambda_ab37ff936e37ec89cf58545827f832d7>@@V<lambda_b9d9cb4442cf1f3c11bfda5894fd36a4>@@@Z
...
??1?$KPtr@UKString@Rtl@@U?$KDeletePtr@UKString@Rtl@@@@@@QEAA@XZ
...
?NdisTraceLoggingCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_AOAC@@EPEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@3@Z
...
?allocate@?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@QEAA_NXZ
...
?ndisPublishSleepStudyCustomDataCsSpuriousWakeStats@@YAXEPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@@Z
...
?ndisReferenceWithTagCompact@@YAXPEAU_NDIS_REFCOUNT_BLOCK@@E@Z
...
?ndisWdfAcquirePowerReferenceHelper@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z
