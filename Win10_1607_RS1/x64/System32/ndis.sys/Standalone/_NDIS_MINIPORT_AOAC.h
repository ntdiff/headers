...
typedef struct _NDIS_MINIPORT_AOAC
{
  ...
  /* 0x01cc */ long ComponentRefCounts[15];
  /* 0x0208 */ struct _NDIS_AOAC_COMPONENT_REF_TIME CsRefTimes[15];
  /* 0x02f8 */ long CsPowerTransitions;
  /* 0x0300 */ unsigned __int64 TotalCsActiveTime;
  /* 0x0308 */ unsigned __int64 TotalCsResiliencyTime;
  /* 0x0310 */ unsigned __int64 CurrentActiveStartTime;
  /* 0x0318 */ unsigned long CsSurpriseWakes;
  /* 0x031c */ unsigned long CsSpuriousWakes;
  /* 0x0320 */ struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];
  /* 0x03b0 */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;
  /* 0x03dc */ long __PADDING__[1];
} NDIS_MINIPORT_AOAC, *PNDIS_MINIPORT_AOAC; /* size: 0x03e0 */
