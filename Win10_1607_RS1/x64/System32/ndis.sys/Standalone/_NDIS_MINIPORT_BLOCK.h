...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x0a80 */ unsigned long FilterPnPFlags;
  /* 0x0a84 */ unsigned long SupportedStatistics;
  /* 0x0a88 */ unsigned long cDpcSendCompletes;
  /* 0x0a8c */ unsigned long cDpcRcvIndications;
  /* 0x0a90 */ unsigned long cDpcRcvIndicationCalls;
  /* 0x0a94 */ unsigned long cDpcNbSendCompletes;
  /* 0x0a98 */ unsigned long cDpcNblSendCompletes;
  /* 0x0a9c */ unsigned long cDpcNblIndications;
  /* 0x0aa0 */ unsigned long cDpcMaxPacketsIndicated;
  /* 0x0aa4 */ unsigned long cDpcTotalDpcCount;
  /* 0x0aa8 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  ...
  /* 0x0be8 */ unsigned long DataBackFillSize;
  /* 0x0bec */ unsigned long ContextBackFillSize;
  /* 0x0bf0 */ struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;
  /* 0x0c48 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;
  /* 0x0c5c */ unsigned long NsiOpenReferences;
  /* 0x0c60 */ void* ProcessingOpen;
  /* 0x0c68 */ struct _KEVENT* NsiRequestsCompletedEvent;
  /* 0x0c70 */ enum _DEVICE_POWER_STATE QueryPowerDeviceState;
  /* 0x0c74 */ unsigned char MinimumNdisMajorVersion;
  /* 0x0c75 */ unsigned char MinimumNdisMinorVersion;
  /* 0x0c78 */ struct _NDIS_MINIPORT_STATS* BottomIfStats;
  /* 0x0c80 */ struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;
  /* 0x0d10 */ struct PNDIS_PER_PROCESSOR_SLOT__* PeriodicReceivesNblCountIndex;
  /* 0x0d18 */ enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;
  /* 0x0d1c */ enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;
  /* 0x0d20 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;
  /* 0x0d24 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;
  /* 0x0d28 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;
  /* 0x0d2c */ enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;
  /* 0x0d30 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;
  /* 0x0d34 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;
  /* 0x0d38 */ struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;
  /* 0x0d70 */ void* TopNdis5PacketIndicateHandler /* function */;
  /* 0x0d78 */ unsigned long* ndisSupportedOidList;
  /* 0x0d80 */ unsigned long ndisSupportedOidListLength;
  /* 0x0d84 */ unsigned long MsiIntCount;
  /* 0x0d88 */ struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;
  /* 0x0da8 */ unsigned __int64 InvalidFrames;
  /* 0x0db0 */ long PagingPathCount;
  /* 0x0db8 */ struct _LIST_ENTRY ReceiveQueueList;
  /* 0x0dc8 */ unsigned char* AllocatedQueueIndices;
  /* 0x0dd0 */ unsigned long AllocatedQueueIndicesLength;
  /* 0x0dd4 */ unsigned long NumReceiveQueues;
  /* 0x0dd8 */ struct _LIST_ENTRY ReceiveFilterList;
  /* 0x0de8 */ unsigned char* AllocatedReceiveFilterIndices;
  /* 0x0df0 */ unsigned long AllocatedReceiveFilterIndicesLength;
  /* 0x0df4 */ unsigned long NumReceiveFilters;
  /* 0x0df8 */ unsigned long EnabledReceiveFilterTypes;
  /* 0x0dfc */ unsigned long EnabledReceiveQueueTypes;
  /* 0x0e00 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterHwCapabilities;
  /* 0x0e08 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterCurrentCapabilities;
  /* 0x0e10 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* TopReceiveFilterCurrentCapabilities;
  /* 0x0e18 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchHwCapabilities;
  /* 0x0e20 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchCurrentCapabilities;
  /* 0x0e28 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* TopNicSwitchCurrentCapabilities;
  /* 0x0e30 */ struct _LIST_ENTRY SharedMemoryBlockList;
  /* 0x0e40 */ void* AllocateSharedMemoryHandler /* function */;
  /* 0x0e48 */ void* FreeSharedMemoryHandler /* function */;
  /* 0x0e50 */ void* AllocateSharedMemoryContext;
  /* 0x0e58 */ struct PCI_MSI_CAPABILITY MsiCaps;
  /* 0x0e70 */ struct PCI_MSIX_CAPABILITY MsiXCaps;
  /* 0x0e80 */ unsigned __int64 NumberOfIndirectionTableChanges;
  /* 0x0e88 */ unsigned int PciDeviceSriovSupport;
  union
  {
    /* 0x0e8c */ unsigned char BeginSavedFields;
    /* 0x0e8c */ unsigned long NumUserOpens;
  }; /* size: 0x0004 */
  /* 0x0e90 */ struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;
  /* 0x0e94 */ unsigned short MediaDisconnectTimeOut;
  /* 0x0e96 */ unsigned short SGMapRegistersNeeded;
  /* 0x0e98 */ unsigned long DriverVerifyFlags;
  /* 0x0ea0 */ void* SetBusData /* function */;
  /* 0x0ea8 */ void* GetBusData /* function */;
  /* 0x0eb0 */ void* BusDataContext;
  /* 0x0eb8 */ enum _INTERFACE_TYPE BusType;
  /* 0x0ebc */ unsigned long BusNumber;
  /* 0x0ec0 */ unsigned long SlotNumber;
  /* 0x0ec8 */ struct _NDIS_EVENT OpenReadyEvent;
  /* 0x0ee0 */ unsigned long NumAdminOpens;
  /* 0x0ee8 */ struct _NDIS_M_DRIVER_BLOCK* DriverHandle;
  /* 0x0ef0 */ struct _NDIS_BIND_PATHS* BindPaths;
  /* 0x0ef8 */ enum _NDIS_PHYSICAL_MEDIUM MiniportPhysicalMediumType;
  /* 0x0f00 */ void* SecurityDescriptor;
  /* 0x0f08 */ struct _UNICODE_STRING BaseName;
  /* 0x0f18 */ struct _UNICODE_STRING MiniportName;
  /* 0x0f28 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0f30 */ struct _DEVICE_OBJECT* PhysicalDeviceObject;
  /* 0x0f38 */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x0f40 */ struct _NDIS_MINIPORT_BLOCK* NextGlobalMiniport;
  /* 0x0f48 */ struct _UNICODE_STRING* pAdapterInstanceName;
  /* 0x0f50 */ unsigned long PnPCapabilities;
  /* 0x0f54 */ enum _DEVICE_POWER_STATE CurrentDevicePowerState;
  /* 0x0f58 */ unsigned __int64 PowerStateLock;
  /* 0x0f60 */ enum _DEVICE_POWER_STATE DriverPowerState;
  /* 0x0f64 */ enum _DEVICE_POWER_STATE PrevDriverPowerState;
  /* 0x0f68 */ struct _NET_BUFFER_LIST* LowPowerRcvReturnNbls;
  /* 0x0f70 */ unsigned long PendingReturnNBLCount;
  /* 0x0f74 */ unsigned char SurpriseRemoveFlushedRcvReturnQueue;
  /* 0x0f78 */ struct NDIS_NBL_TRACKER_HANDLE__* LowPowerRcvReturnNblTracker;
  /* 0x0f80 */ struct _NDIS_PM_ADMIN_CONFIG PMAdminConfig;
  /* 0x0f88 */ struct _KSEMAPHORE PMPatternSemaphore;
  /* 0x0fa8 */ struct _KSEMAPHORE PMOffloadSemaphore;
  /* 0x0fc8 */ void* BusInterface;
  /* 0x0fd0 */ unsigned short InstanceNumber;
  /* 0x0fd8 */ void* ConfigurationHandle;
  /* 0x0fe0 */ struct _GUID InterfaceGuid;
  /* 0x0ff0 */ union _NET_LUID_LH NetLuid;
  /* 0x0ff8 */ unsigned char IfBlockAvailable;
  /* 0x1000 */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x1008 */ struct _KEVENT* IfBlockPointerRefZeroEvent;
  /* 0x1010 */ unsigned int IfIndex;
  /* 0x1014 */ enum _NET_IF_ADMIN_STATUS AdminStatus;
  /* 0x1018 */ enum _NET_IF_OPER_STATUS OperStatus;
  /* 0x101c */ unsigned long OperStatusFlags;
  union
  {
    /* 0x1020 */ void* SendHandler /* function */;
    /* 0x1020 */ void* WanSendHandler /* function */;
  }; /* size: 0x0008 */
  /* 0x1028 */ struct NDIS_NBL_TRACKER_HANDLE__* NblTracker;
  /* 0x1030 */ struct _DEVICE_RESET_INTERFACE_STANDARD* ReenumerateSelfInterface;
  /* 0x1038 */ struct _NDIS_MINIPORT_OFFLOAD* Offload;
  /* 0x1040 */ void* NDKBlock;
  /* 0x1048 */ void* AddDeviceContext;
  /* 0x1050 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x1070 */ struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;
  /* 0x1080 */ unsigned long PhysicalMediumInInf;
  /* 0x1088 */ class KPtr<Rtl::KString,KDeletePtr<Rtl::KString> > ExportName;
  /* 0x1090 */ class KPtr<Rtl::KString,KDeletePtr<Rtl::KString> > FilterClass;
  /* 0x1098 */ void* StatusProcessingThread;
  /* 0x10a0 */ unsigned long StatusProcessingDbgX;
  /* 0x10a8 */ struct _UNICODE_STRING FdoName;
  /* 0x10b8 */ struct _KEVENT PowerD0CompleteEvent;
  /* 0x10d0 */ long LastD0CompleteStatus;
  /* 0x10d4 */ enum _NDIS_MINIPORT_EVENT LastD0Reason;
  /* 0x10d8 */ unsigned long DirectOidRequestCount;
  /* 0x10e0 */ struct _KEVENT* AllDirectRequestsCompletedEvent;
  /* 0x10e8 */ struct _NDIS_HD_SPLIT_CURRENT_CONFIG* HDSplitCurrentConfig;
  /* 0x10f0 */ void* MSIXConfigContext;
  /* 0x10f8 */ void* SetMSIXTableEntry /* function */;
  /* 0x1100 */ void* MaskMSIXTableEntry /* function */;
  /* 0x1108 */ void* UnmaskMSIXTableEntry /* function */;
  /* 0x1110 */ struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;
  /* 0x1130 */ struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;
  /* 0x1150 */ struct _NDIS_RECEIVE_QUEUE_BLOCK* DefaultReceiveQueue;
  /* 0x1158 */ unsigned long MaxNumRssProcessors;
  /* 0x115c */ struct _PROCESSOR_NUMBER RssBaseProcessor;
  /* 0x1160 */ struct _PROCESSOR_NUMBER RssMaxProcessor;
  /* 0x1164 */ enum _NDIS_RSS_PROFILE RssProfile;
  /* 0x1168 */ unsigned short NumaNodeId;
  /* 0x1170 */ unsigned short* NumaDistances;
  /* 0x1178 */ struct _UNICODE_STRING* pModifiedInstanceName;
  /* 0x1180 */ unsigned long SyncFlags;
  /* 0x1184 */ unsigned long WSyncFlags;
  /* 0x1188 */ unsigned long InterlockedFlags;
  /* 0x1190 */ struct _ULONG_REFERENCE Ref;
  /* 0x11a0 */ struct _NDIS_SELECTIVE_SUSPEND* SelectiveSuspend;
  /* 0x11a8 */ struct _NDIS_MINIPORT_AOAC* AoAc;
  /* 0x11b0 */ enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;
  /* 0x11b8 */ struct NDIS_EVENT_LOG_HANDLE__* PnpEventLog;
  /* 0x11c0 */ struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;
  /* 0x1218 */ struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS* PhysicalPerformanceCounters;
  /* 0x1220 */ union _LARGE_INTEGER TimeOfInitialization;
  /* 0x1228 */ union _LARGE_INTEGER LastSystemSleepTime;
  /* 0x1230 */ unsigned __int64 TotalSystemSleepTimeMs;
  /* 0x1238 */ struct _NDIS_SRIOV_CAPABILITIES* SriovHwCapabilities;
  /* 0x1240 */ struct _NDIS_SRIOV_CAPABILITIES* SriovCurrentCapabilities;
  /* 0x1248 */ unsigned __int64 InvalidateBlockMask;
  /* 0x1250 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x1258 */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x1260 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x1268 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x1280 */ unsigned short InvalidateVfId;
  /* 0x1282 */ unsigned char InvalidateBlockCancelling;
  /* 0x1288 */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x1290 */ unsigned long NumSwitches;
  /* 0x1298 */ struct _LIST_ENTRY NicSwitchList;
  /* 0x12a8 */ unsigned long NumAllocatedVFs;
  /* 0x12b0 */ struct _LIST_ENTRY VFList;
  /* 0x12c0 */ unsigned long NumActiveVPorts;
  /* 0x12c8 */ struct _LIST_ENTRY VPortList;
  /* 0x12d8 */ unsigned char* AllocatedVPortIndices;
  /* 0x12e0 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x12e8 */ void* SetVirtualFunctionData /* function */;
  /* 0x12f0 */ void* GetVirtualFunctionData /* function */;
  /* 0x12f8 */ void* EnableVirtualization /* function */;
  /* 0x1300 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x1308 */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x1310 */ void* VirtInterfaceContext;
  /* 0x1318 */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x1328 */ void* VpciInterfaceDereference /* function */;
  /* 0x1330 */ void* WriteVfConfigBlock /* function */;
  /* 0x1338 */ void* ReadVfConfigBlock /* function */;
  /* 0x1340 */ void* VpciInterfaceContext;
  /* 0x1348 */ unsigned int VfSerialNumber;
  /* 0x134c */ struct _LUID SriovLuid;
  /* 0x1358 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x1360 */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x1368 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x1370 */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x1378 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x1380 */ unsigned long QosOperationalParametersBufferSize;
  /* 0x1388 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x1390 */ unsigned long QosRemoteParametersBufferSize;
  /* 0x1398 */ unsigned __int64 DeviceFlags;
  /* 0x13a0 */ void* VerifierContext;
  /* 0x13a8 */ struct _WORK_QUEUE_ITEM SurpriseRemovalWorkItem;
  /* 0x13c8 */ struct Ndis::BindStack Bindings;
  /* 0x1458 */ struct Ndis::BindEngine BindEngine;
  ...
  /* 0x14fa */ BOOL PoFxDStateReportingEnabled;
  /* 0x1500 */ struct NDIS_MINIPORT_HOOK_ADAPTER_HANDLE__* HookAdapterHandle;
  /* 0x1508 */ struct _WORK_QUEUE_ITEM InterfaceUpdateWorkItem;
  /* 0x1528 */ BOOL InterfaceUpdateInProgress;
  /* 0x1529 */ BOOL MacAddressUpdateQueued;
  /* 0x152a */ BOOL MtuUpdateQueued;
  /* 0x152c */ struct _IF_PHYSICAL_ADDRESS_LH PendingMacAddress;
  /* 0x1550 */ unsigned long PendingMtuSize;
  /* 0x1558 */ struct RECORDER_LOG__* BlackBoxHandle;
  /* 0x1560 */ struct _KEVENT* PowerCompleteEvent;
  /* 0x1568 */ long PowerCompleteStatus;
  /* 0x1570 */ struct _POWER_WORK_ITEM DevicePowerOnWorkItem;
  /* 0x15c8 */ struct _POWER_WORK_ITEM DevicePowerDownWorkItem;
  /* 0x1620 */ struct _NDIS_PD_BLOCK* PDBlock;
  /* 0x1628 */ void* PdcHandle;
  /* 0x1630 */ struct _NDIS_TIMER PdcTaskClientDisableTimer;
  /* 0x16b0 */ struct _NDIS_WORK_ITEM PdcTaskClientDisableWorkItem;
  /* 0x1700 */ volatile long PdcTaskClientMode;
  /* 0x1704 */ unsigned long ModernStandbyWoLMagicPacketEnable;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x1708 */
