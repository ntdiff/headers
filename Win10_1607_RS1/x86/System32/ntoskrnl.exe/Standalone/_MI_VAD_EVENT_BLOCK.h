...
typedef struct _MI_SUB64K_FREE_RANGES
{
  ...
  /* 0x0014 */ unsigned short SubListIndex;
  /* 0x0016 */ unsigned short Hint;
  /* 0x0018 */ unsigned long SetBits;
} MI_SUB64K_FREE_RANGES, *PMI_SUB64K_FREE_RANGES; /* size: 0x001c */
...
} MI_VAD_EVENT_BLOCK, *PMI_VAD_EVENT_BLOCK; /* size: 0x0024 */
