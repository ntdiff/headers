...
typedef struct _MI_POOL_STATE
{
  ...
  /* 0x04b0 */ unsigned long SpecialPoolRejected[9];
  /* 0x04d4 */ volatile unsigned long SpecialPagesNonPaged;
  /* 0x04d8 */ volatile long SpecialPoolPdes;
  /* 0x04dc */ unsigned long SessionSpecialPoolPdesMax;
  /* 0x04e0 */ unsigned long TotalPagedPoolQuota;
  /* 0x04e4 */ unsigned long TotalNonPagedPoolQuota;
} MI_POOL_STATE, *PMI_POOL_STATE; /* size: 0x04e8 */
...
typedef struct _MI_SYSTEM_IMAGE_STATE
{
  ...
  /* 0x003c */ struct _LIST_ENTRY StrongCodeLoadFailureList;
  /* 0x0044 */ struct _KLDR_DATA_TABLE_ENTRY* BeingDeleted;
  /* 0x0048 */ struct _EX_PUSH_LOCK MappingRangesPushLock;
  /* 0x004c */ struct _MI_DRIVER_VA* MappingRanges[2];
  /* 0x0054 */ unsigned long PageCount;
  /* 0x0058 */ struct _MM_SYSTEM_PAGE_COUNTS PageCounts;
  /* 0x0068 */ struct _EX_PUSH_LOCK CollidedLock;
} MI_SYSTEM_IMAGE_STATE, *PMI_SYSTEM_IMAGE_STATE; /* size: 0x006c */
...
typedef struct _MI_SESSION_STATE
{
  ...
  /* 0x0018 */ unsigned long* DynamicPoolBitBuffer;
  /* 0x001c */ long VaReferenceCount[1024];
  /* 0x101c */ unsigned long* DynamicPtesBitBuffer;
  /* 0x1020 */ struct _EX_PUSH_LOCK IdLock;
  /* 0x1024 */ unsigned long DetachTimeStamp;
  /* 0x1028 */ struct _EPROCESS* LeaderProcess;
  /* 0x102c */ struct _EX_PUSH_LOCK InitializeLock;
  /* 0x1030 */ struct _MMWSL_FULL* WorkingSetList;
  /* 0x1034 */ struct _MMWSLE_HASH* WsHashStart;
  /* 0x1038 */ struct _MMWSLE_HASH* WsHashEnd;
  /* 0x103c */ void* SessionBase;
  /* 0x1040 */ void* SessionCore;
} MI_SESSION_STATE, *PMI_SESSION_STATE; /* size: 0x1044 */
...
typedef struct _MI_SYSTEM_VA_STATE
{
  ...
  /* 0x0010 */ struct _MMPTE* HyperSpaceEndPte;
  /* 0x0014 */ void* SystemRangeStart;
  /* 0x0018 */ unsigned char SystemCachePdeCount[1024];
  /* 0x0418 */ void* SystemCacheReverseMaps[1024];
  /* 0x1418 */ void* HyperSpaceEnd;
  ...
  /* 0x145c */ struct _EX_PUSH_LOCK SystemCacheInitLock;
  /* 0x1460 */ unsigned long UnusableWsles[5];
  /* 0x1474 */ unsigned long PossibleWsles[5];
  /* 0x1488 */ struct _MMSUPPORT_INSTANCE* SystemWs[3];
  /* 0x1494 */ long __PADDING__[11];
...
} MI_PAGELIST_STATE, *PMI_PAGELIST_STATE; /* size: 0x0008 */
...
typedef struct _MI_SHUTDOWN_STATE
{
  ...
  /* 0x000c */ struct _MI_RESUME_WORKITEM ResumeItem;
  /* 0x002c */ struct _ETHREAD* MirrorHoldsPfn;
  /* 0x0030 */ unsigned long MirroringActive;
...
typedef struct _MI_ERROR_STATE
{
  ...
  /* 0x0068 */ struct _MI_FORCED_COMMITS ForcedCommits;
  /* 0x0070 */ unsigned long WsleFailures[2];
  /* 0x0078 */ unsigned long WsLinear;
  ...
  /* 0x009c */ struct _MI_RESAVAIL_FAILURES ResavailFailures;
  /* 0x00a4 */ unsigned char PendingBadPages;
  /* 0x00a5 */ unsigned char InitFailure;
  /* 0x00a6 */ unsigned char StopBadMaps;
  /* 0x00a7 */ char __PADDING__[1];
} MI_ERROR_STATE, *PMI_ERROR_STATE; /* size: 0x00a8 */
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x06ac */ struct _MI_SESSION_STATE Sessions;
  /* 0x16f0 */ struct _MI_PROCESS_STATE Processes;
  /* 0x1760 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1840 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x2d00 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x2d18 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x2d20 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x2d58 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x2da0 */ struct _MI_ERROR_STATE Errors;
  /* 0x2e80 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x2f00 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x2fc0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x3040 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x31c0 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x3200 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x3238 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x3280 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x32c0 */ struct _MI_RESAVAIL_TRACKER ResTrack;
  /* 0x34c0 */ unsigned long Cookie;
  /* 0x34c4 */ volatile long ZeroingDisabled;
  /* 0x34c8 */ void* volatile* BootRegistryRuns;
  /* 0x34cc */ unsigned char FullyInitialized;
  /* 0x34cd */ unsigned char SafeBooted;
  /* 0x34d0 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x34d8 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x3500 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x3d80 */
