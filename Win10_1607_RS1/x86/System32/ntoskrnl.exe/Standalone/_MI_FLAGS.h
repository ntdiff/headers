typedef union _MI_FLAGS
{
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0000 */ unsigned long StrongCodeGuarantees : 1; /* bit position: 14 */
      /* 0x0000 */ unsigned long HardCodeGuarantees : 1; /* bit position: 15 */
      /* 0x0000 */ unsigned long ExecutePagePrivilegeRequired : 1; /* bit position: 16 */
      /* 0x0000 */ unsigned long StrongPageIdentity : 1; /* bit position: 17 */
      /* 0x0000 */ unsigned long FullHvci : 1; /* bit position: 18 */
      /* 0x0000 */ unsigned long SecureRelocations : 1; /* bit position: 19 */
      /* 0x0000 */ unsigned long SlatKernelCodeProtected : 1; /* bit position: 20 */
