...
typedef struct _MI_PARTITION_CORE
{
  ...
  /* 0x0014 */ struct _LIST_ENTRY ListEntry;
  /* 0x001c */ struct _MI_NODE_INFORMATION* NodeInformation;
  /* 0x0020 */ struct _RTL_AVL_TREE PageRoot;
  /* 0x0024 */ struct _PHYSICAL_MEMORY_DESCRIPTOR* MemoryNodeRuns;
  /* 0x0028 */ unsigned long MemoryBlockReferences;
  /* 0x002c */ struct _WORK_QUEUE_ITEM PfnUnmapWorkItem;
  /* 0x003c */ unsigned char PfnUnmapActive;
  ...
  /* 0x0078 */ struct _EX_PUSH_LOCK DynamicMemoryPushLock;
  /* 0x007c */ volatile long DynamicMemoryLock;
  /* 0x0080 */ struct _KEVENT TemporaryMemoryEvent;
  /* 0x0090 */ struct _KEVENT* MemoryEvents[11];
} MI_PARTITION_CORE, *PMI_PARTITION_CORE; /* size: 0x00bc */
...
typedef struct _MI_PARTITION_STORES
{
  ...
  /* 0x0050 */ struct _EPROCESS* StoreProcess;
...
typedef struct _MI_PARTITION_SEGMENTS
{
  ...
  /* 0x00c0 */ volatile long SegmentListLock;
  /* 0x00c8 */ volatile __int64 ControlAreaCount;
...
typedef struct _MI_VISIBLE_PARTITION
{
  ...
  /* 0x0238 */ unsigned char SystemCacheInitialized;
  /* 0x023c */ volatile unsigned long TotalCommittedPages;
  /* 0x0240 */ struct _MMPFNLIST ModifiedPageListHead;
  /* 0x0280 */ struct _MMPFNLIST ModifiedNoWritePageListHead;
  /* 0x0294 */ unsigned long TotalCommitLimit;
  /* 0x0298 */ unsigned long TotalPagesForPagingFile;
  /* 0x029c */ unsigned long VadPhysicalPages;
  /* 0x02a0 */ unsigned long ProcessLockedFilePages;
  /* 0x02a4 */ unsigned long ChargeCommitmentFailures[4];
  /* 0x02b4 */ volatile long PageFileTraceIndex;
  /* 0x02b8 */ struct _MI_PAGEFILE_TRACES PageFileTraces[32];
  /* 0x0cb8 */ long __PADDING__[2];
} MI_VISIBLE_PARTITION, *PMI_VISIBLE_PARTITION; /* size: 0x0cc0 */

typedef struct _MI_PARTITION
{
  /* 0x0000 */ struct _MI_PARTITION_CORE Core;
  /* 0x00c0 */ struct _MI_PARTITION_MODWRITES Modwriter;
  /* 0x0290 */ struct _MI_PARTITION_STORES Store;
  /* 0x0300 */ struct _MI_PARTITION_SEGMENTS Segments;
  /* 0x0400 */ struct _MI_PARTITION_PAGE_LISTS PageLists;
  /* 0x0b80 */ struct _MI_PARTITION_COMMIT Commit;
  /* 0x0c00 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x0c40 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x0d18 */ void* WorkingSetControl;
  /* 0x0d1c */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x0d40 */ struct _MI_VISIBLE_PARTITION Vp;
