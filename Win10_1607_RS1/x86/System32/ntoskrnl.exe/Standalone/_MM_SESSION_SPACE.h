...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0cc0 */ struct _MMSUPPORT_FULL Vm;
  /* 0x0d48 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0d80 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x1ec0 */ struct _MMPTE* PageTables;
  /* 0x1ec4 */ unsigned long PagedPoolBitBuffer[32];
  /* 0x1f48 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x1f90 */ struct _EX_PUSH_LOCK SessionPteLock;
  /* 0x1f94 */ long PoolBigEntriesInUse;
  /* 0x1f98 */ unsigned long PagedPoolPdeCount;
  /* 0x1f9c */ unsigned long SpecialPoolPdeCount;
  /* 0x1fa0 */ unsigned long DynamicSessionPdeCount;
  /* 0x1fa4 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1fdc */ void* PoolTrackTableExpansion;
  /* 0x1fe0 */ unsigned long PoolTrackTableExpansionSize;
  /* 0x1fe4 */ void* PoolTrackBigPages;
  /* 0x1fe8 */ unsigned long PoolTrackBigPagesSize;
  /* 0x1fec */ enum _IO_SESSION_STATE IoState;
  /* 0x1ff0 */ unsigned long IoStateSequence;
  /* 0x1ff4 */ struct _KEVENT IoNotificationEvent;
  /* 0x2004 */ struct _EJOB* ServerSilo;
  /* 0x2008 */ unsigned __int64 CreateTime;
