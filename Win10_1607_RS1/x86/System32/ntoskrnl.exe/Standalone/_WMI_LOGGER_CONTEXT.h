...
typedef struct _WMI_LOGGER_CONTEXT
{
  ...
  /* 0x027c */ struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;
  /* 0x0280 */ struct _ETW_SILODRIVERSTATE* SiloState;
  /* 0x0284 */ struct _WORK_QUEUE_ITEM CompressionWorkItem;
  /* 0x0294 */ long CompressionWorkItemState;
  /* 0x0298 */ struct _EX_PUSH_LOCK CompressionLock;
  /* 0x029c */ struct _WMI_BUFFER_HEADER* CompressionTarget;
  /* 0x02a0 */ void* CompressionWorkspace;
  /* 0x02a4 */ long CompressionOn;
  /* 0x02a8 */ unsigned long CompressionRatioGuess;
  /* 0x02ac */ unsigned long PartialBufferCompressionLevel;
  /* 0x02b0 */ enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;
  /* 0x02b4 */ struct _SINGLE_LIST_ENTRY PlaceholderList;
  /* 0x02b8 */ struct _KDPC CompressionDpc;
  /* 0x02d8 */ union _LARGE_INTEGER LastBufferSwitchTime;
  /* 0x02e0 */ union _LARGE_INTEGER BufferWriteDuration;
  /* 0x02e8 */ union _LARGE_INTEGER BufferCompressDuration;
} WMI_LOGGER_CONTEXT, *PWMI_LOGGER_CONTEXT; /* size: 0x02f0 */
