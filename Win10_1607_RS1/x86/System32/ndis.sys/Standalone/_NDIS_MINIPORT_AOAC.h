...
typedef struct _NDIS_MINIPORT_AOAC
{
  ...
  /* 0x0114 */ long ComponentRefCounts[15];
  /* 0x0150 */ struct _NDIS_AOAC_COMPONENT_REF_TIME CsRefTimes[15];
  /* 0x0240 */ long CsPowerTransitions;
  /* 0x0248 */ unsigned __int64 TotalCsActiveTime;
  /* 0x0250 */ unsigned __int64 TotalCsResiliencyTime;
  /* 0x0258 */ unsigned __int64 CurrentActiveStartTime;
  /* 0x0260 */ unsigned long CsSurpriseWakes;
  /* 0x0264 */ unsigned long CsSpuriousWakes;
  /* 0x0268 */ struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];
  /* 0x02f8 */ struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS CsSpuriousWakeStats;
  /* 0x0324 */ long __PADDING__[1];
} NDIS_MINIPORT_AOAC, *PNDIS_MINIPORT_AOAC; /* size: 0x0328 */
