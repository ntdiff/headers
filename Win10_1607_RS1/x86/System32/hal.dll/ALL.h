    ...
    union
    {
      ...
      struct // _TAG_UNNAMED_75
      {
        struct /* bitfield */
        {
          ...
          /* 0x0010 */ unsigned long ZeroBuffer : 1; /* bit position: 5 */
          /* 0x0010 */ unsigned long Address : 26; /* bit position: 6 */
        }; /* bitfield */
      } /* size: 0x0004 */ Flags;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u;
...
} HAL_INTEL_ENLIGHTENMENT_INFORMATION, *PHAL_INTEL_ENLIGHTENMENT_INFORMATION; /* size: 0x00bc */
