...
typedef struct _TEB
{
  ...
  /* 0x010c */ void* SystemReserved1[36];
...
typedef struct _TEB32
{
  ...
  /* 0x010c */ unsigned long SystemReserved1[36];
  /* 0x019c */ unsigned char WorkingOnBehalfTicket[8];
  /* 0x01a4 */ long ExceptionCode;
...
typedef struct _KLOCK_ENTRY
{
  ...
  union
  {
    /* 0x002c */ unsigned long AllBoosts : 17; /* bit position: 0 */
    struct
    {
      struct /* bitfield */
      {
        /* 0x002c */ unsigned short CpuBoostsBitmap : 15; /* bit position: 0 */
        /* 0x002c */ unsigned short IoBoost : 1; /* bit position: 15 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x002e */ unsigned short IoQoSBoost : 1; /* bit position: 0 */
        /* 0x002e */ unsigned short IoNormalPriorityWaiterCount : 8; /* bit position: 1 */
        /* 0x002e */ unsigned short IoQoSWaiterCount : 7; /* bit position: 9 */
      }; /* bitfield */
    }; /* size: 0x0004 */
  }; /* size: 0x0004 */
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x005c */ unsigned long RestrictedGuiThread : 1; /* bit position: 19 */
      /* 0x005c */ unsigned long ThreadFlagsSpare : 4; /* bit position: 20 */
...
typedef struct _ETHREAD
{
  ...
  union
  {
    /* 0x03c4 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x03c4 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x03c4 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x03c4 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x03c4 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x03c4 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x03c4 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x03c4 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x03c4 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x03c4 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x03c4 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x03c4 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x03c4 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x03c4 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x03c4 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x03c4 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x03c4 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x03c4 */ unsigned long ReservedCrossThreadFlags : 12; /* bit position: 20 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03c8 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x03c8 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x03c8 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x03c8 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x03c8 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x03c8 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x03c8 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x03c8 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x03c8 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x03c8 */ unsigned long ReservedSameThreadPassiveFlags : 23; /* bit position: 9 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x03cc */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x03cc */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x03cc */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x03cc */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x03cc */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x03cc */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x03cc */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x03cc */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x03cc */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x03cd */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x03cd */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x03d0 */ unsigned char CacheManagerActive;
  /* 0x03d1 */ unsigned char DisablePageFaultClustering;
  /* 0x03d2 */ unsigned char ActiveFaultCount;
  /* 0x03d3 */ unsigned char LockOrderState;
  /* 0x03d4 */ unsigned long AlpcMessageId;
  union
  {
    /* 0x03d8 */ void* AlpcMessage;
    /* 0x03d8 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0004 */
  /* 0x03dc */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x03e4 */ long ExitStatus;
  /* 0x03e8 */ unsigned long CacheManagerCount;
  /* 0x03ec */ unsigned long IoBoostCount;
  /* 0x03f0 */ unsigned long IoQoSBoostCount;
  /* 0x03f4 */ unsigned long IoQoSThrottleCount;
  /* 0x03f8 */ struct _LIST_ENTRY BoostList;
  /* 0x0400 */ struct _LIST_ENTRY DeboostList;
  /* 0x0408 */ unsigned long BoostListLock;
  /* 0x040c */ unsigned long IrpListLock;
  /* 0x0410 */ void* ReservedForSynchTracking;
  /* 0x0414 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0418 */ const struct _GUID* ActivityId;
  /* 0x041c */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0420 */ void* VerifierContext;
  /* 0x0424 */ unsigned long KernelStackReference;
  /* 0x0428 */ void* AdjustedClientToken;
  /* 0x042c */ void* WorkOnBehalfThread;
  /* 0x0430 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x043c */ void* PicoContext;
  /* 0x0440 */ unsigned long UserFsBase;
  /* 0x0444 */ unsigned long UserGsBase;
  /* 0x0448 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x044c */ void* CmDbgInfo;
  union
  {
    /* 0x0450 */ unsigned long SelectedCpuSets;
    /* 0x0450 */ unsigned long* SelectedCpuSetsIndirect;
  }; /* size: 0x0004 */
  /* 0x0454 */ struct _EJOB* Silo;
  /* 0x0458 */ struct _UNICODE_STRING* ThreadName;
  /* 0x045c */ unsigned long ReadyTime;
} ETHREAD, *PETHREAD; /* size: 0x0460 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x0148 */ struct _MM_SESSION_SPACE* Session;
  /* 0x014c */ void* AweInfo;
  ...
  /* 0x0170 */ struct _FILE_OBJECT* ImageFilePointer;
  /* 0x0174 */ unsigned char ImageFileName[15];
  /* 0x0183 */ unsigned char PriorityClass;
  /* 0x0184 */ void* SecurityPort;
  /* 0x0188 */ struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;
  /* 0x018c */ struct _LIST_ENTRY JobLinks;
  /* 0x0194 */ void* HighestUserAddress;
  /* 0x0198 */ struct _LIST_ENTRY ThreadListHead;
  /* 0x01a0 */ volatile unsigned long ActiveThreads;
  /* 0x01a4 */ unsigned long ImagePathHash;
  /* 0x01a8 */ unsigned long DefaultHardErrorProcessing;
  /* 0x01ac */ long LastThreadExitStatus;
  /* 0x01b0 */ struct _EX_FAST_REF PrefetchTrace;
  /* 0x01b4 */ void* LockedPagesList;
  ...
  /* 0x01f4 */ struct _MMSUPPORT_FULL Vm;
  /* 0x027c */ struct _LIST_ENTRY MmProcessLinks;
  /* 0x0284 */ unsigned long ModifiedPageCount;
  /* 0x0288 */ long ExitStatus;
  /* 0x028c */ struct _RTL_AVL_TREE VadRoot;
  /* 0x0290 */ void* VadHint;
  /* 0x0294 */ unsigned long VadCount;
  /* 0x0298 */ volatile unsigned long VadPhysicalPages;
  /* 0x029c */ unsigned long VadPhysicalPagesLimit;
  /* 0x02a0 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x02b0 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x02b8 */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x02bc */ unsigned long RequestedTimerResolution;
  /* 0x02c0 */ unsigned long SmallestTimerResolution;
  /* 0x02c4 */ long Padding_53;
  /* 0x02c8 */ union _LARGE_INTEGER ExitTime;
  /* 0x02d0 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x02d4 */ unsigned long LargePrivateVadCount;
  /* 0x02d8 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x02dc */ void* WnfContext;
  /* 0x02e0 */ unsigned long Spare0;
  /* 0x02e4 */ unsigned char SignatureLevel;
  /* 0x02e5 */ unsigned char SectionSignatureLevel;
  /* 0x02e6 */ struct _PS_PROTECTION Protection;
  /* 0x02e7 */ unsigned char HangCount;
  union
  {
    /* 0x02e8 */ unsigned long Flags3;
    struct /* bitfield */
    {
      /* 0x02e8 */ unsigned long Minimal : 1; /* bit position: 0 */
      /* 0x02e8 */ unsigned long ReplacingPageRoot : 1; /* bit position: 1 */
      /* 0x02e8 */ unsigned long DisableNonSystemFonts : 1; /* bit position: 2 */
      /* 0x02e8 */ unsigned long AuditNonSystemFontLoading : 1; /* bit position: 3 */
      /* 0x02e8 */ unsigned long Crashed : 1; /* bit position: 4 */
      /* 0x02e8 */ unsigned long JobVadsAreTracked : 1; /* bit position: 5 */
      /* 0x02e8 */ unsigned long VadTrackingDisabled : 1; /* bit position: 6 */
      /* 0x02e8 */ unsigned long AuxiliaryProcess : 1; /* bit position: 7 */
      /* 0x02e8 */ unsigned long SubsystemProcess : 1; /* bit position: 8 */
      /* 0x02e8 */ unsigned long IndirectCpuSets : 1; /* bit position: 9 */
      /* 0x02e8 */ unsigned long InPrivate : 1; /* bit position: 10 */
      /* 0x02e8 */ unsigned long ProhibitRemoteImageMap : 1; /* bit position: 11 */
      /* 0x02e8 */ unsigned long ProhibitLowILImageMap : 1; /* bit position: 12 */
      /* 0x02e8 */ unsigned long SignatureMitigationOptIn : 1; /* bit position: 13 */
      /* 0x02e8 */ unsigned long DisableDynamicCodeAllowOptOut : 1; /* bit position: 14 */
      /* 0x02e8 */ unsigned long EnableFilteredWin32kAPIs : 1; /* bit position: 15 */
      /* 0x02e8 */ unsigned long AuditFilteredWin32kAPIs : 1; /* bit position: 16 */
      /* 0x02e8 */ unsigned long PreferSystem32Images : 1; /* bit position: 17 */
      /* 0x02e8 */ unsigned long RelinquishedCommit : 1; /* bit position: 18 */
      /* 0x02e8 */ unsigned long AutomaticallyOverrideChildProcessPolicy : 1; /* bit position: 19 */
      /* 0x02e8 */ unsigned long HighGraphicsPriority : 1; /* bit position: 20 */
      /* 0x02e8 */ unsigned long CommitFailLogged : 1; /* bit position: 21 */
      /* 0x02e8 */ unsigned long ReserveFailLogged : 1; /* bit position: 22 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02ec */ long DeviceAsid;
  /* 0x02f0 */ void* SvmData;
  /* 0x02f4 */ struct _EX_PUSH_LOCK SvmProcessLock;
  /* 0x02f8 */ unsigned long SvmLock;
  /* 0x02fc */ struct _LIST_ENTRY SvmProcessDeviceListHead;
  /* 0x0304 */ long Padding_54;
  /* 0x0308 */ unsigned __int64 LastFreezeInterruptTime;
  /* 0x0310 */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x0314 */ void* PicoContext;
  /* 0x0318 */ unsigned long KeepAliveCounter;
  /* 0x031c */ unsigned long NoWakeKeepAliveCounter;
  /* 0x0320 */ unsigned long HighPriorityFaultsAllowed;
  /* 0x0324 */ void* InstrumentationCallback;
  /* 0x0328 */ struct _PROCESS_ENERGY_VALUES* EnergyValues;
  ...
  /* 0x037c */ unsigned long ReadyTime;
  /* 0x0380 */ void* DxgProcess;
  /* 0x0384 */ long __PADDING__[1];
} EPROCESS, *PEPROCESS; /* size: 0x0388 */
...
typedef struct _EJOB
{
  ...
  /* 0x0240 */ struct _EJOB* ParentSilo;
  /* 0x0244 */ struct _EJOB* volatile RootJob;
  /* 0x0248 */ struct _LIST_ENTRY IteratorListHead;
  /* 0x0250 */ unsigned long AncestorCount;
  union
  {
    /* 0x0254 */ struct _EJOB** Ancestors;
    /* 0x0254 */ void* SessionObject;
  }; /* size: 0x0004 */
  /* 0x0258 */ unsigned long TimerListLock;
  /* 0x025c */ struct _LIST_ENTRY TimerListHead;
  /* 0x0264 */ long Padding_59;
  /* 0x0268 */ struct _EPROCESS_VALUES Accounting;
  /* 0x02c0 */ unsigned long ShadowActiveProcessCount;
  /* 0x02c4 */ unsigned long ActiveAuxiliaryProcessCount;
  /* 0x02c8 */ unsigned long SequenceNumber;
  /* 0x02cc */ unsigned long JobId;
  /* 0x02d0 */ struct _GUID ContainerId;
  /* 0x02e0 */ struct _ESERVERSILO_GLOBALS* ServerSiloGlobals;
  /* 0x02e4 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x02f0 */ struct _PSP_STORAGE* Storage;
  /* 0x02f4 */ struct _JOB_NET_RATE_CONTROL* NetRateControl;
  union
  {
    /* 0x02f8 */ unsigned long JobFlags;
    struct /* bitfield */
    {
      /* 0x02f8 */ unsigned long CloseDone : 1; /* bit position: 0 */
      /* 0x02f8 */ unsigned long MultiGroup : 1; /* bit position: 1 */
      /* 0x02f8 */ unsigned long OutstandingNotification : 1; /* bit position: 2 */
      /* 0x02f8 */ unsigned long NotificationInProgress : 1; /* bit position: 3 */
      /* 0x02f8 */ unsigned long UILimits : 1; /* bit position: 4 */
      /* 0x02f8 */ unsigned long CpuRateControlActive : 1; /* bit position: 5 */
      /* 0x02f8 */ unsigned long OwnCpuRateControl : 1; /* bit position: 6 */
      /* 0x02f8 */ unsigned long Terminating : 1; /* bit position: 7 */
      /* 0x02f8 */ unsigned long WorkingSetLock : 1; /* bit position: 8 */
      /* 0x02f8 */ unsigned long JobFrozen : 1; /* bit position: 9 */
      /* 0x02f8 */ unsigned long Background : 1; /* bit position: 10 */
      /* 0x02f8 */ unsigned long WakeNotificationAllocated : 1; /* bit position: 11 */
      /* 0x02f8 */ unsigned long WakeNotificationEnabled : 1; /* bit position: 12 */
      /* 0x02f8 */ unsigned long WakeNotificationPending : 1; /* bit position: 13 */
      /* 0x02f8 */ unsigned long LimitNotificationRequired : 1; /* bit position: 14 */
      /* 0x02f8 */ unsigned long ZeroCountNotificationRequired : 1; /* bit position: 15 */
      /* 0x02f8 */ unsigned long CycleTimeNotificationRequired : 1; /* bit position: 16 */
      /* 0x02f8 */ unsigned long CycleTimeNotificationPending : 1; /* bit position: 17 */
      /* 0x02f8 */ unsigned long TimersVirtualized : 1; /* bit position: 18 */
      /* 0x02f8 */ unsigned long JobSwapped : 1; /* bit position: 19 */
      /* 0x02f8 */ unsigned long ViolationDetected : 1; /* bit position: 20 */
      /* 0x02f8 */ unsigned long EmptyJobNotified : 1; /* bit position: 21 */
      /* 0x02f8 */ unsigned long NoSystemCharge : 1; /* bit position: 22 */
      /* 0x02f8 */ unsigned long DropNoWakeCharges : 1; /* bit position: 23 */
      /* 0x02f8 */ unsigned long NoWakeChargePolicyDecided : 1; /* bit position: 24 */
      /* 0x02f8 */ unsigned long NetRateControlActive : 1; /* bit position: 25 */
      /* 0x02f8 */ unsigned long OwnNetRateControl : 1; /* bit position: 26 */
      /* 0x02f8 */ unsigned long IoRateControlActive : 1; /* bit position: 27 */
      /* 0x02f8 */ unsigned long OwnIoRateControl : 1; /* bit position: 28 */
      /* 0x02f8 */ unsigned long DisallowNewProcesses : 1; /* bit position: 29 */
      /* 0x02f8 */ unsigned long Silo : 1; /* bit position: 30 */
      /* 0x02f8 */ unsigned long Spare : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02fc */ unsigned long EffectiveHighEdgeFilters;
  /* 0x0300 */ struct _PROCESS_ENERGY_VALUES* EnergyValues;
  /* 0x0304 */ volatile unsigned long SharedCommitCharge;
  /* 0x0308 */ struct _EJOB* volatile WakeRoot;
  /* 0x030c */ unsigned long DiskIoAttributionUserRefCount;
  /* 0x0310 */ unsigned long DiskIoAttributionRefCount;
  union
  {
    /* 0x0314 */ void* DiskIoAttributionContext;
    /* 0x0314 */ struct _EJOB* DiskIoAttributionOwnerJob;
  }; /* size: 0x0004 */
  /* 0x0318 */ struct _PS_IO_CONTROL_ENTRY GlobalIoControl;
  /* 0x0334 */ volatile long VolumeIoControlLock;
  /* 0x0338 */ struct _RTL_RB_TREE VolumeIoControlTree;
  /* 0x0340 */ struct _EX_PUSH_LOCK IoControlLock;
  /* 0x0344 */ unsigned long SiloHardReferenceCount;
  /* 0x0348 */ struct _WORK_QUEUE_ITEM RundownWorkItem;
} EJOB, *PEJOB; /* size: 0x0358 */
...
typedef struct _TEB64
{
  ...
  /* 0x0190 */ unsigned __int64 SystemReserved1[37];
...
_EtwpGetNextAvaliableLoggerId@8
...
_EtwpRegisterGuidsApiCallback@8
...
_RtlGuardGrantSuppressedCallAccess@8
...
_RtlIsLongPathAwareProcessByManifest@0
...
_RtlSparseBitmapCtxAreAllClear@20
_RtlSparseBitmapCtxAreAllSet@20
...
_RtlSparseBitmapCtxClearBitsEx@32
_RtlSparseBitmapCtxCountBitsSet@4
_RtlSparseBitmapCtxFindNextBitSet@12
_RtlSparseBitmapCtxFindSetRuns@36
_RtlSparseBitmapCtxInitialize@4
_RtlSparseBitmapCtxInitializeRange@8
_RtlSparseBitmapCtxMetadataForBit@16
_RtlSparseBitmapCtxOrBitmap@8
_RtlSparseBitmapCtxPrepareBits@20
_RtlSparseBitmapCtxSetBits@24
_RtlSparseBitmapCtxSetBitsEx@32
_RtlSparseBitmapCtxStart@8
_RtlSparseBitmapCtxSubtractBitmap@12
_RtlSparseBitmapEnumerateBitmap@12
_RtlSplay@4
...
_RtlSubscribeWnfStateChangeNotificationInternal@40
...
_RtlpDecRefWnfUserSubscription@4
...
_RtlpGuardGrantSuppressedCallAccess@4
_RtlpGuardIsSuppressedAddress@4
_RtlpGuardIsSuppressedImageRva@8
...
_RtlpHeapFatalExceptionFilter@8
...
_RtlpHpPerHeapStackTraceCleanup@4
...
_RtlpHpSegPageRangeCalcCommitRegion@20
...
_RtlpHpTagContextFindMapping@12
...
_RtlpInitializeSecondLevelDir@8
...
_RtlpSiloGetNtProductType@4
_RtlpSparseBitmapCheckRangeArrayPage@8
_RtlpSparseBitmapCommitRangeArrayPage@8
_RtlpSparseBitmapCtxAppendNextRangeToRun@32
_RtlpSparseBitmapCtxCheckRangeArray@8
_RtlpSparseBitmapCtxCountRangeBits@20
_RtlpSparseBitmapCtxFindNextBitInternal@16
_RtlpSparseBitmapCtxFindRunsFromNullRange@40
_RtlpSparseBitmapCtxFindRunsFromRange@44
_RtlpSparseBitmapCtxFindRunsInternal@40
...
_RtlpSparseBitmapRangeArrayCleanup@12
...
_RtlpTryAcquireSubSegmentLock@8
