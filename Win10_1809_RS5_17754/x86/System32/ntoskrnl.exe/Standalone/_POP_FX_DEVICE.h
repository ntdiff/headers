...
typedef struct _POP_FX_DRIVER_CALLBACKS
{
  ...
  /* 0x0020 */ void* DirectedPowerTransitionCallback /* function */;
} POP_FX_DRIVER_CALLBACKS, *PPOP_FX_DRIVER_CALLBACKS; /* size: 0x0024 */
...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x0060 */ void* DriverContext;
  /* 0x0064 */ struct _LIST_ENTRY AcpiLink;
  /* 0x006c */ struct _UNICODE_STRING DeviceId;
  /* 0x0074 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x008c */ struct _IO_REMOVE_LOCK AcpiRemoveLock;
  /* 0x00a4 */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x00c0 */ unsigned long IdleLock;
  ...
  /* 0x0280 */ volatile long DirectedTransitionCallCount;
  /* 0x0284 */ void* DirectedTransitionCompletionContext;
  /* 0x0288 */ struct _UNICODE_STRING FriendlyName;
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x0290 */
