    ...
    struct // _TAG_UNNAMED_184
    {
      ...
      union
      {
        ...
        struct /* bitfield */
        {
          ...
          /* 0x0034 */ unsigned long AweSection : 1; /* bit position: 17 */
          /* 0x0034 */ unsigned long SystemImage : 1; /* bit position: 18 */
          /* 0x0034 */ unsigned long StrongCode : 2; /* bit position: 19 */
          /* 0x0034 */ unsigned long CantMove : 1; /* bit position: 21 */
          /* 0x0034 */ unsigned long BitMap : 2; /* bit position: 22 */
          /* 0x0034 */ unsigned long ImageActive : 1; /* bit position: 24 */
          /* 0x0034 */ unsigned long ImageBaseOkToReuse : 1; /* bit position: 25 */
        }; /* bitfield */
      }; /* size: 0x0004 */
      union
      {
...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x0680 */ struct _MI_SYSTEM_IMAGE_STATE SystemImages;
  /* 0x06f0 */ struct _MI_SESSION_STATE Sessions;
  /* 0x1730 */ struct _MI_PROCESS_STATE Processes;
  /* 0x17c0 */ struct _MI_HARDWARE_STATE Hardware;
  /* 0x1940 */ struct _MI_SYSTEM_VA_STATE SystemVa;
  /* 0x4080 */ struct _MI_COMBINE_STATE PageCombines;
  /* 0x4098 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x40b0 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x40e8 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x4130 */ struct _MI_ERROR_STATE Errors;
  /* 0x4200 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x4280 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x4310 */ struct _MI_STANDBY_STATE Standby;
  /* 0x4380 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x4500 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x4540 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x4578 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x45c0 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x4600 */ unsigned long Cookie;
  /* 0x4604 */ void* volatile* BootRegistryRuns;
  /* 0x4608 */ volatile long ZeroingDisabled;
  /* 0x460c */ unsigned char FullyInitialized;
  /* 0x460d */ unsigned char SafeBooted;
  /* 0x4610 */ struct _RTL_BITMAP PfnBitMap;
  /* 0x4618 */ const struct _TlgProvider_t* TraceLogging;
  /* 0x4640 */ struct _MI_VISIBLE_STATE Vs;
