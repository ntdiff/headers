...
typedef struct _MMPAGING_FILE
{
  ...
  /* 0x0040 */ struct _MMMOD_WRITER_MDL_ENTRY* Entry[2];
  ...
  struct /* bitfield */
  {
    ...
    /* 0x00cc */ unsigned short Spare0 : 4; /* bit position: 11 */
  }; /* bitfield */
  struct /* bitfield */
  {
  ...
  /* 0x00f0 */ struct _ETHREAD* LockOwner;
  /* 0x00f8 */ struct _RTL_AVL_TREE FlowThroughReadRoot;
  /* 0x0100 */ struct _MI_PARTITION* Partition;
  /* 0x0108 */ struct _RTL_BALANCED_NODE FileObjectNode;
