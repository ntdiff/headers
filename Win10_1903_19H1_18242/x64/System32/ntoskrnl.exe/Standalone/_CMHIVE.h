...
typedef struct _CMHIVE
{
  ...
  /* 0x06a8 */ unsigned char* FlushLogEntry;
  /* 0x06b0 */ unsigned long FlushLogEntrySize;
  /* 0x06b4 */ unsigned long FlushHiveTruncated;
  /* 0x06b8 */ unsigned char FlushBaseBlockDirty;
  ...
  union
  {
    /* 0x10b8 */ unsigned long FlushFlags;
    struct /* bitfield */
    {
      /* 0x10b8 */ unsigned long FlushActive : 1; /* bit position: 0 */
      /* 0x10b8 */ unsigned long ReconcileActive : 1; /* bit position: 1 */
      /* 0x10b8 */ unsigned long PrimaryFilePurged : 1; /* bit position: 2 */
      /* 0x10b8 */ unsigned long DiskFileBad : 1; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x10bc */ unsigned long PrimaryFileSizeBeforeLastFlush;
  /* 0x10c0 */ volatile long ReferenceCount;
  /* 0x10c4 */ long UnloadHistoryIndex;
  /* 0x10c8 */ unsigned long UnloadHistory[128];
  /* 0x12c8 */ unsigned long BootStart;
  /* 0x12cc */ unsigned long UnaccessedStart;
  /* 0x12d0 */ unsigned long UnaccessedEnd;
  /* 0x12d4 */ unsigned long LoadedKeyCount;
  /* 0x12d8 */ volatile unsigned long HandleClosePending;
  /* 0x12e0 */ struct _EX_PUSH_LOCK HandleClosePendingEvent;
  /* 0x12e8 */ unsigned char FinalFlushSucceeded;
  /* 0x12f0 */ struct _CMP_VOLUME_CONTEXT* VolumeContext;
} CMHIVE, *PCMHIVE; /* size: 0x12f8 */
