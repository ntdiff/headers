...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x005c */ unsigned long EtwStackTraceApcInserted : 8; /* bit position: 16 */
      /* 0x005c */ unsigned long ReservedFlags : 8; /* bit position: 24 */
    }; /* bitfield */
...
@LdrpHandleInvalidUserCallTarget@4
...
_LdrpProtectMutableReadOnlyData@4
...
_RtlpIsUserCallTargetBitMapCheck@4
