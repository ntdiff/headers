...
class CBmpLoader
{
  ...
  union
  {
    /* 0x042c */ unsigned char* m_pbDiskHeadr;
    /* 0x042c */ struct tagBITMAPCOREHEADER* m_pbmchDiskHeadr;
    /* 0x042c */ struct tagBITMAPINFOHEADER* m_pbmihDiskHeadr;
  }; /* size: 0x0004 */
  /* 0x0430 */ long m_lSize;
  /* 0x0434 */ long m_nWidth;
  /* 0x0438 */ long m_nHeight;
  /* 0x043c */ int m_nTableSize;
  /* 0x0440 */ int m_nTableEntries;
  /* 0x0444 */ unsigned char* m_pbBits;
  /* 0x0448 */ int m_fWin;
  /* 0x044c */ int m_fVgaPal;
}; /* size: 0x0450 */
