...
typedef struct _DRIVER_INFO_8W
{
  ...
  /* 0x0050 */ wchar_t* pszPrintProcessor;
  /* 0x0054 */ wchar_t* pszVendorSetup;
  /* 0x0058 */ wchar_t* pszzColorProfiles;
  /* 0x005c */ wchar_t* pszInfPath;
  /* 0x0060 */ unsigned long dwPrinterDriverAttributes;
  /* 0x0064 */ wchar_t* pszzCoreDriverDependencies;
  /* 0x0068 */ struct _FILETIME ftMinInboxDriverVerDate;
  /* 0x0070 */ unsigned __int64 dwlMinInboxDriverVerVersion;
} DRIVER_INFO_8W, *PDRIVER_INFO_8W; /* size: 0x0078 */
