...
{
  /* 0x0000 */ void* _hRpc;
  /* 0x0004 */ const unsigned long _lAuthn;
  /* 0x0008 */ const unsigned long _lImp;
  /* 0x000c */ void* _hToken;
  /* 0x0010 */ const long _eState;
  /* 0x0014 */ int _fFirstCall;
  /* 0x0018 */ unsigned long _cRef;
  /* 0x001c */ BOOL _bExemptFromAstaToAstaBlock;
  /* 0x0020 */ struct _SCHANNEL_CRED _sCred;
  /* 0x0058 */ const struct _CERT_CONTEXT* _pCert;
}; /* size: 0x005c */
