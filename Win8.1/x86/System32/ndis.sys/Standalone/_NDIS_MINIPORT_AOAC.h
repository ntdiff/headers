...
typedef struct _NDIS_MINIPORT_AOAC
{
  ...
  /* 0x0240 */ unsigned __int64 CurrentActiveStartTime;
  /* 0x0248 */ unsigned long CsSurpriseWakes;
  /* 0x024c */ unsigned long CsSpuriousWakes;
  /* 0x0250 */ struct _NDIS_MINIPORT_CS_TRAFFIC_STATS CsTrafficStats[3];
} NDIS_MINIPORT_AOAC, *PNDIS_MINIPORT_AOAC; /* size: 0x02e0 */
