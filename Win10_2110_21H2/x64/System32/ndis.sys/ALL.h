...
typedef struct _X_FILTER
{
  ...
  /* 0x0156 */ char Padding_28[2];
  /* 0x0158 */ unsigned int MaxMulticastAddresses;
  /* 0x015c */ long Padding_29;
...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x1096 */ char Padding_86[2];
  /* 0x1098 */ unsigned long DirectOidRequestCount;
  /* 0x109c */ long Padding_87;
...
{
  /* 0x0000 */ struct _LOOKASIDE_LIST_EX List;
  /* 0x0060 */ long Padding_345[8];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0090 */ long Padding_346[12];
...
{
  /* 0x0000 */ long Padding_357[8];
  /* 0x0020 */ unsigned char ProtocolId;
  /* 0x0021 */ char Padding_358;
  /* 0x0022 */ unsigned short ContextSize;
  /* 0x0024 */ long Padding_359;
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_459;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_460[2];
...
?Feature_Servicing_NDIS_Acquiring_Locks_33288487__private_IsEnabled@@YAHXZ
?Feature_Servicing_StopSelectiveSuspend_31667084__private_IsEnabled@@YAHXZ
...
?NDIS_RELEASE_FILTER_SPIN_LOCK@@YAXPEAU_NDIS_FILTER_BLOCK@@E@Z
...
?ndisWdfSendPmParametersForAoAc@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z
...
?wil_StagingConfig_QueryFeatureState@@YAHW4wil_FeatureStore@@PEAUwil_FeatureState@@IHPEAH@Z
?wil_UninitializeFeatureStaging@@YAXXZ
...
?wil_details_EvaluateFeatureDependencies@@YAXXZ
...
?wil_details_FeatureDescriptors_SkipPadding@@YAPEBUwil_details_FeatureDescriptor@@_K@Z
...
?wil_details_PopulateInitialConfiguredFeatureStates@@YAJXZ
?wil_details_RegisterFeatureStagingChangeNotification@@YAJPEA_K@Z
