typedef struct _RTL_VERIFIER_HELPER_TABLE
{
  ...
  /* 0x003c */ void* VerifierEngStdInitializeStackTrace /* function */;
  /* 0x0040 */ void* VerifierEngStdDeleteStackTrace /* function */;
  /* 0x0044 */ void* VerifierEngStdLogStackTrace /* function */;
  /* 0x0048 */ void* VerifierEngStdReleaseStackTrace /* function */;
} RTL_VERIFIER_HELPER_TABLE, *PRTL_VERIFIER_HELPER_TABLE; /* size: 0x004c */
