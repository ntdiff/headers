...
typedef struct _SYSTEM_VERIFIER_COUNTERS_INFORMATION
{
  ...
  /* 0x0078 */ unsigned long RaiseIrqls;
  /* 0x007c */ unsigned long AcquireSpinLocks;
  /* 0x0080 */ unsigned long SynchronizeExecutions;
  /* 0x0084 */ unsigned long AllocationsWithNoTag;
  /* 0x0088 */ unsigned long AllocationsFailed;
  /* 0x008c */ unsigned long AllocationsFailedDeliberately;
  /* 0x0090 */ unsigned long LockedBytes;
  /* 0x0094 */ unsigned long PeakLockedBytes;
  /* 0x0098 */ unsigned long MappedLockedBytes;
  /* 0x009c */ unsigned long PeakMappedLockedBytes;
  /* 0x00a0 */ unsigned long MappedIoSpaceBytes;
  /* 0x00a4 */ unsigned long PeakMappedIoSpaceBytes;
  /* 0x00a8 */ unsigned long PagesForMdlBytes;
  /* 0x00ac */ unsigned long PeakPagesForMdlBytes;
  /* 0x00b0 */ unsigned long ContiguousMemoryBytes;
  /* 0x00b4 */ unsigned long PeakContiguousMemoryBytes;
  /* 0x00b8 */ unsigned long ExecutePoolTypes;
  /* 0x00bc */ unsigned long ExecutePageProtections;
  /* 0x00c0 */ unsigned long ExecutePageMappings;
  /* 0x00c4 */ unsigned long ExecuteWriteSections;
  /* 0x00c8 */ unsigned long SectionAlignmentFailures;
  /* 0x00cc */ unsigned long IATInExecutableSection;
} SYSTEM_VERIFIER_COUNTERS_INFORMATION, *PSYSTEM_VERIFIER_COUNTERS_INFORMATION; /* size: 0x00d0 */
