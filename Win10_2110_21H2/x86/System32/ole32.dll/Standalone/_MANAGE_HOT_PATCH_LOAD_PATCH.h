...
typedef struct _MANAGE_HOT_PATCH_LOAD_PATCH
{
  ...
  /* 0x0004 */ struct _UNICODE_STRING PatchPath;
  union
  {
    union
    {
  ...
  /* 0x0050 */ struct _HOT_PATCH_IMAGE_INFO BaseInfo;
} MANAGE_HOT_PATCH_LOAD_PATCH, *PMANAGE_HOT_PATCH_LOAD_PATCH; /* size: 0x0058 */
