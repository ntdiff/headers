...
class CMap<unsigned short *,unsigned short * &,unsigned long,unsigned long &>
{
  ...
  /* 0x0004 */ unsigned int m_nHashTableSize;
  /* 0x0008 */ int m_nCount;
  /* 0x000c */ struct CMap<unsigned short *,unsigned short * &,unsigned long,unsigned long &>::CAssoc* m_pFreeList;
  /* 0x0010 */ struct CPlex* m_pBlocks;
  /* 0x0014 */ int m_nBlockSize;
}; /* size: 0x0018 */
...
class CPropertySection
{
  ...
  /* 0x0028 */ class CMap<unsigned short *,unsigned short * &,unsigned long,unsigned long &> m_NameDict;
  /* 0x0040 */ wchar_t* m_pwszSectionName;
}; /* size: 0x0044 */
