...
typedef struct _NDIS_NPAGED_LOOKASIDE_LIST
{
  ...
  /* 0x0048 */ long Padding_11[14];
  /* 0x0080 */ union _SLIST_HEADER BackupList;
  /* 0x0088 */ long Padding_12[14];
...
typedef struct _TCP_OFFLOAD_STATE_CONST
{
  ...
  /* 0x000f */ char Padding_95;
  /* 0x0010 */ unsigned short RemoteMss;
  /* 0x0012 */ char Padding_96[2];
...
typedef struct _TCP_OFFLOAD_STATE_DELEGATED
{
  ...
  /* 0x004e */ char Padding_128[2];
  struct
  {
    /* 0x0050 */ unsigned char ProbeCount;
    /* 0x0001 */ char Padding_129[3];
...
{
  /* 0x0000 */ long Padding_197[4];
  /* 0x0010 */ unsigned char ProtocolId;
  /* 0x0011 */ char Padding_198;
...
?FILTER_CLEAR_ALL_STATE_FLAGS@@YGXPAU_NDIS_FILTER_BLOCK@@@Z
?Feature_ScreenON_NAPS__private_IsEnabledPreCheck@@YGHXZ
?Feature_Servicing_NDIS_Acquiring_Locks_33288487__private_IsEnabled@@YGHXZ
?Feature_Servicing_StopSelectiveSuspend_31667084__private_IsEnabled@@YGHXZ
...
?ndisWdfSendPmParametersForAoAc@@YGXPAU_NDIS_MINIPORT_BLOCK@@@Z
...
?wil_InitializeFeatureStaging@@YGJXZ
...
?wil_UninitializeFeatureStaging@@YGXXZ
?wil_details_BuildFeatureStateCacheFromQueryResults@@YGJJPBU_RTL_FEATURE_CONFIGURATION@@PATwil_details_FeatureStateCache@@@Z
?wil_details_EvaluateFeatureDependencies@@YGXXZ
?wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState@@YG?ATwil_details_FeatureStateCache@@PAT1@PBUwil_details_FeatureDescriptor@@@Z
?wil_details_EvaluateFeatureDependencies_ReevaluateCachedFeatureEnabledState@@YG?ATwil_details_FeatureStateCache@@PAT1@T1@PBUwil_details_FeatureDescriptor@@@Z
?wil_details_EvaluateFeatureDependencies_UpdateFeatureDesiredStates@@YGXXZ
?wil_details_FeatureDescriptors_SkipPadding@@YGPBUwil_details_FeatureDescriptor@@I@Z
...
?wil_details_OnFeatureConfigurationChange@@YGXPAX@Z
?wil_details_PopulateInitialConfiguredFeatureStates@@YGJXZ
?wil_details_RegisterFeatureStagingChangeNotification@@YGJPA_K@Z
...
?wil_details_UpdateFeatureConfiguredStates@@YGXXZ
