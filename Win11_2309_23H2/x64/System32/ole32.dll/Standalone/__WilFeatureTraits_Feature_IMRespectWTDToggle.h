...
typedef struct __WilFeatureTraits_Feature_IMRespectWTDToggle
{
  union
  {
...
} _WilFeatureTraits_Feature_IMRespectWTDToggle, *P_WilFeatureTraits_Feature_IMRespectWTDToggle; /* size: 0x0001 */
