...
typedef struct __WilFeatureTraits_Feature_SettingsHomepage_PermanentId
{
  union
  {
...
} _WilFeatureTraits_Feature_SettingsHomepage_PermanentId, *P_WilFeatureTraits_Feature_SettingsHomepage_PermanentId; /* size: 0x0001 */
