...
typedef struct __WilFeatureTraits_Feature_ThreatExperienceOverlay
{
  union
  {
...
} _WilFeatureTraits_Feature_ThreatExperienceOverlay, *P_WilFeatureTraits_Feature_ThreatExperienceOverlay; /* size: 0x0001 */
