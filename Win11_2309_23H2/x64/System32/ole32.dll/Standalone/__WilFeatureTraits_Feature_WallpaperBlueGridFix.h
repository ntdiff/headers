...
typedef struct __WilFeatureTraits_Feature_WallpaperBlueGridFix
{
  union
  {
...
} _WilFeatureTraits_Feature_WallpaperBlueGridFix, *P_WilFeatureTraits_Feature_WallpaperBlueGridFix; /* size: 0x0001 */
