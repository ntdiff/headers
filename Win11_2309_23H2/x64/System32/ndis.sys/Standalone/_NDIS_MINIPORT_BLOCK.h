...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x16f0 */ struct _PKTMON_EDGE_CONTEXT PktMonEdge;
  /* 0x1718 */ class KnobNamespace PollModeConfigKnobsNamespace;
  /* 0x1760 */ class Rtl::KArray<KnobDescriptor,1> PollModeConfigKnobDescriptors;
  /* 0x1770 */ struct _EXECUTION_CONTEXT_RUNTIME_KNOBS PollModeConfigKnobs;
  /* 0x17ac */ struct _GUID PnPActivityID;
  /* 0x17bc */ long __PADDING__[1];
