...
typedef struct _KSCB
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0070 */ unsigned char UnconstrainedMaxQuota : 1; /* bit position: 4 */
    /* 0x0070 */ unsigned char UnconstrainedMinQuota : 1; /* bit position: 5 */
    /* 0x0070 */ unsigned char ShareRankOwner : 1; /* bit position: 6 */
    /* 0x0070 */ unsigned char Spare1 : 1; /* bit position: 7 */
  }; /* bitfield */
...
typedef struct _KPRCB
{
  ...
  /* 0x00a8 */ unsigned __int64 PrcbPad04[3];
          ...
          union
          {
            ...
            struct
            {
              struct /* bitfield */
              {
                ...
                /* 0x00f9 */ unsigned char BpbKCet : 1; /* bit position: 3 */
                /* 0x00f9 */ unsigned char BpbFeaturesReserved : 4; /* bit position: 4 */
              }; /* bitfield */
  ...
  /* 0x33dc */ unsigned long DpcWatchdogProfileBufferSize;
  /* 0x33e0 */ unsigned long PrcbPad93[8];
  ...
  union
  {
    struct
    {
      /* 0x8818 */ unsigned long ProcessorId;
      /* 0x881c */ unsigned long CoreId;
      /* 0x8820 */ unsigned long ModuleId;
      /* 0x8824 */ unsigned long DieId;
      /* 0x8828 */ unsigned long PackageId;
    }; /* size: 0x0014 */
    /* 0x8818 */ unsigned long TopologyId[5];
  }; /* size: 0x0014 */
  /* 0x882c */ unsigned long NodeRelativeTopologyIndex[5];
  ...
  /* 0x8880 */ struct _KTHREAD* SmtIsolationThread;
  /* 0x8888 */ unsigned __int64 PrcbPad97[2];
  ...
  /* 0x8c88 */ unsigned __int64 PrcbPad125[7];
  /* 0x8cc0 */ unsigned long TimerExpirationTraceCount;
  /* 0x8cc4 */ unsigned long PrcbPad127;
  /* 0x8cc8 */ struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
  /* 0x8dc8 */ unsigned __int64 PrcbPad128[7];
  /* 0x8e00 */ struct _KCLOCK_TIMER_STATE ClockTimerState;
  /* 0x9318 */ unsigned char PrcbPad129[40];
  /* 0x9340 */ struct _REQUEST_MAILBOX* Mailbox;
  /* 0x9348 */ unsigned __int64 PrcbPad130[7];
  /* 0x9380 */ struct _MACHINE_CHECK_CONTEXT McheckContext[2];
  /* 0x9420 */ unsigned __int64 TransitionShadowStack;
  /* 0x9428 */ unsigned __int64 KernelShadowStackInitial;
  /* 0x9430 */ unsigned __int64* IstShadowStacksTable;
  /* 0x9438 */ void* CachedShadowStack;
  /* 0x9440 */ struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
  /* 0x94a0 */ unsigned __int64 PrcbPad134a[4];
  /* 0x94c0 */ struct _KAFFINITY_EX DieProcessorSet;
  /* 0x95c8 */ unsigned long CoresPerPhysicalDie;
  /* 0x95cc */ unsigned long LogicalProcessorsPerModule;
  /* 0x95d0 */ unsigned char PrcbPad137[64];
  /* 0x9610 */ struct _KAFFINITY_EX ModuleProcessorSet;
  /* 0x9718 */ struct _KCORE_CONTROL_BLOCK LocalCoreControlBlock;
  /* 0x9760 */ unsigned char PrcbPad138[1824];
  ...
  /* 0xaec0 */ unsigned __int64 PrcbPad141[512];
...
typedef struct _KTHREAD
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x0074 */ unsigned long Spare : 1; /* bit position: 16 */
  ...
  union
  {
    ...
    struct
    {
      ...
      /* 0x01f8 */ unsigned __int64 Spare19;
    }; /* size: 0x00c0 */
  }; /* size: 0x00c0 */
  union
  {
  ...
  /* 0x0204 */ unsigned char HgsFeedbackClass;
  /* 0x0205 */ unsigned char Spare23[3];
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x03bc */ unsigned long PpmPolicy : 3; /* bit position: 8 */
      /* 0x03bc */ unsigned long ThreadFlags3Reserved2 : 21; /* bit position: 11 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  ...
  /* 0x044c */ unsigned long Spare27;
  /* 0x0450 */ struct _SINGLE_LIST_ENTRY SystemAffinityTokenListHead;
  /* 0x0458 */ void* IptSaveArea;
  /* 0x0460 */ unsigned char ResourceIndex;
  /* 0x0461 */ unsigned char CoreIsolationReasons;
  /* 0x0462 */ unsigned char BamQosLevelFromAssistPage;
  /* 0x0463 */ unsigned char Spare31[1];
  /* 0x0464 */ unsigned long Spare32;
  /* 0x0468 */ unsigned __int64 EndPadding[3];
...
typedef struct _KPROCESS
{
  ...
  /* 0x0430 */ unsigned __int64 EndPadding[1];
...
typedef struct _PROC_PERF_DOMAIN
{
  ...
  /* 0x012f */ char Padding_55;
  /* 0x0130 */ enum _PROCESSOR_PRESENCE Presence;
  /* 0x0134 */ long Padding_56;
  ...
  /* 0x01e8 */ unsigned char TurboRangeKnown;
  /* 0x01e9 */ char Padding_58[3];
  /* 0x01ec */ unsigned long VmFrequencyStepMhz;
  /* 0x01f0 */ unsigned long VmHighestFrequencyMhz;
  /* 0x01f4 */ unsigned long VmNominalFrequencyMhz;
  /* 0x01f8 */ unsigned long VmLowestFrequencyMhz;
  /* 0x01fc */ unsigned char AutonomousMode;
  /* 0x01fd */ unsigned char AutonomousCapability;
  /* 0x01fe */ unsigned char ProvideGuidance;
  /* 0x01ff */ char Padding_59;
  /* 0x0200 */ unsigned long DesiredPercent;
  /* 0x0204 */ unsigned long GuaranteedPercent;
  /* 0x0208 */ unsigned char EngageResponsivenessOverrides;
  /* 0x0209 */ char Padding_60[3];
  /* 0x020c */ struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[7];
  /* 0x02d0 */ unsigned long QosDisableReasons[7];
  /* 0x02ec */ unsigned short QosEquivalencyMasks[7];
  /* 0x02fa */ unsigned char QosSupported;
  /* 0x02fb */ char Padding_61;
  /* 0x02fc */ volatile unsigned long SelectionGeneration;
...
typedef struct _ESERVERSILO_GLOBALS
{
  ...
  /* 0x0419 */ char Padding_70[7];
  /* 0x0420 */ struct _NLS_STATE* NlsState;
  /* 0x0428 */ struct _RTL_NLS_STATE RtlNlsState;
  /* 0x04e0 */ void* ImgFileExecOptions;
  /* 0x04e8 */ struct _EX_TIMEZONE_STATE* ExTimeZoneState;
  /* 0x04f0 */ struct _UNICODE_STRING NtSystemRoot;
  /* 0x0500 */ struct _UNICODE_STRING SiloRootDirectoryName;
  /* 0x0510 */ struct _PSP_STORAGE* Storage;
  /* 0x0518 */ enum _SERVERSILO_STATE State;
  /* 0x051c */ long ExitStatus;
  /* 0x0520 */ struct _KEVENT* DeleteEvent;
  /* 0x0528 */ struct _SILO_USER_SHARED_DATA* UserSharedData;
  /* 0x0530 */ void* UserSharedSection;
  /* 0x0538 */ struct _WORK_QUEUE_ITEM TerminateWorkItem;
  /* 0x0558 */ unsigned char IsDownlevelContainer;
  /* 0x0559 */ char __PADDING__[7];
} ESERVERSILO_GLOBALS, *PESERVERSILO_GLOBALS; /* size: 0x0560 */
...
typedef struct _SEGMENT_HEAP
{
  ...
  /* 0x0108 */ struct _RTL_HP_HEAP_VA_CALLBACKS_ENCODED CallbacksEncoded;
  /* 0x0128 */ long Padding_81[6];
...
typedef struct _PPM_SELECTION_STATISTICS
{
  ...
  /* 0x0080 */ struct _PPM_VETO_ACCOUNTING* PreVetoAccounting;
} PPM_SELECTION_STATISTICS, *PPPM_SELECTION_STATISTICS; /* size: 0x0088 */
...
} PROC_IDLE_STATE_ACCOUNTING, *PPROC_IDLE_STATE_ACCOUNTING; /* size: 0x03f0 */
...
typedef struct _PROC_IDLE_ACCOUNTING
{
  ...
  /* 0x0024 */ long Padding_84;
  /* 0x0028 */ struct _PROC_IDLE_STATE_ACCOUNTING State[1];
} PROC_IDLE_ACCOUNTING, *PPROC_IDLE_ACCOUNTING; /* size: 0x0418 */
...
typedef struct _PROC_PERF_CONSTRAINT
{
  ...
  /* 0x007e */ char Padding_91[2];
  /* 0x0080 */ unsigned __int64 QosUpdateLock;
  /* 0x0088 */ unsigned long IncreasePerfCheckCount;
  /* 0x008c */ unsigned long DecreasePerfCheckCount;
...
typedef struct _EPROCESS
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0464 */ unsigned long Reserved : 1; /* bit position: 20 */
  ...
  /* 0x0848 */ struct _INVERTED_FUNCTION_TABLE_USER_MODE* InvertedFunctionTable;
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x087c */ unsigned long EnableProcessRemoteExecProtectVmLogging : 1; /* bit position: 28 */
      /* 0x087c */ unsigned long EnableProcessLocalExecProtectVmLogging : 1; /* bit position: 29 */
      /* 0x087c */ unsigned long MemoryCompressionProcess : 1; /* bit position: 30 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0880 */ long DeviceAsid;
  /* 0x0884 */ long Padding_110;
  /* 0x0888 */ void* SvmData;
  ...
  /* 0x096c */ unsigned short Machine;
  /* 0x096e */ unsigned short Spare0;
  ...
  /* 0x0b3c */ volatile long PageCombineSequence;
  /* 0x0b40 */ struct _EX_PUSH_LOCK EnableOptionalXStateFeaturesLock;
  /* 0x0b48 */ unsigned long* volatile PathRedirectionHashes;
  /* 0x0b50 */ void* SyscallProviderReserved[4];
  union
  {
    /* 0x0b70 */ unsigned long MitigationFlags3;
    struct
    {
      struct /* bitfield */
      {
        /* 0x0b70 */ unsigned long RestrictCoreSharing : 1; /* bit position: 0 */
...
typedef struct _ETHREAD
{
  ...
  /* 0x0480 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0488 */ union _LARGE_INTEGER ExitTime;
    /* 0x0488 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  union
  {
    /* 0x0498 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0498 */ void* ForwardLinkShadow;
      /* 0x04a0 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x04a8 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x04a8 */ struct _ETHREAD* ReaperLink;
    /* 0x04a8 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x04b0 */ unsigned __int64 ActiveTimerListLock;
  /* 0x04b8 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x04c8 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x04d8 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x04d8 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x04f8 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x0500 */ struct _LIST_ENTRY IrpList;
  /* 0x0510 */ unsigned __int64 TopLevelIrp;
  /* 0x0518 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x0520 */ void* Win32StartAddress;
  /* 0x0528 */ void* ChargeOnlySession;
  /* 0x0530 */ void* LegacyPowerObject;
  /* 0x0538 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x0548 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x0550 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x0558 */ unsigned long ReadClusterSize;
  /* 0x055c */ volatile long MmLockOrdering;
  union
  {
    /* 0x0560 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
  ...
  union
  {
    /* 0x0564 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x0564 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x0564 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x0564 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x0564 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x0564 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x0564 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x0564 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x0564 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x0564 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x0564 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x0564 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x0564 */ unsigned long GenerateDumpOnBadHandleAccess : 1; /* bit position: 12 */
      /* 0x0564 */ unsigned long ReservedSameThreadPassiveFlags : 19; /* bit position: 13 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0568 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x0568 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x0568 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x0568 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x0568 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x0568 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x0568 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x0568 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x0568 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x0569 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x0569 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x0569 */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x0569 */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x0569 */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
        /* 0x0569 */ unsigned char SessionAttachActive : 1; /* bit position: 7 */
      }; /* bitfield */
      /* 0x056a */ unsigned char PasidMsrValid : 1; /* bit position: 0 */
    }; /* size: 0x0003 */
  }; /* size: 0x0004 */
  /* 0x056c */ unsigned char CacheManagerActive;
  /* 0x056d */ unsigned char DisablePageFaultClustering;
  /* 0x056e */ unsigned char ActiveFaultCount;
  /* 0x056f */ unsigned char LockOrderState;
  /* 0x0570 */ unsigned long PerformanceCountLowReserved;
  /* 0x0574 */ long PerformanceCountHighReserved;
  /* 0x0578 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x0580 */ void* AlpcMessage;
    /* 0x0580 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x0588 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x0598 */ long ExitStatus;
  /* 0x059c */ unsigned long CacheManagerCount;
  /* 0x05a0 */ unsigned long IoBoostCount;
  /* 0x05a4 */ unsigned long IoQoSBoostCount;
  /* 0x05a8 */ unsigned long IoQoSThrottleCount;
  /* 0x05ac */ unsigned long KernelStackReference;
  /* 0x05b0 */ struct _LIST_ENTRY BoostList;
  /* 0x05c0 */ struct _LIST_ENTRY DeboostList;
  /* 0x05d0 */ unsigned __int64 BoostListLock;
  /* 0x05d8 */ unsigned __int64 IrpListLock;
  /* 0x05e0 */ void* ReservedForSynchTracking;
  /* 0x05e8 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x05f0 */ const struct _GUID* ActivityId;
  /* 0x05f8 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x0600 */ void* VerifierContext;
  /* 0x0608 */ void* AdjustedClientToken;
  /* 0x0610 */ void* WorkOnBehalfThread;
  /* 0x0618 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x0630 */ void* PicoContext;
  /* 0x0638 */ unsigned __int64 UserFsBase;
  /* 0x0640 */ unsigned __int64 UserGsBase;
  /* 0x0648 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  union
  {
    /* 0x0650 */ unsigned __int64 SelectedCpuSets;
    /* 0x0650 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x0658 */ struct _EJOB* Silo;
  /* 0x0660 */ struct _UNICODE_STRING* ThreadName;
  /* 0x0668 */ struct _CONTEXT* SetContextState;
  /* 0x0670 */ unsigned char LastSoftParkElectionQos;
  /* 0x0671 */ unsigned char LastSoftParkElectionWorkloadType;
  /* 0x0672 */ unsigned char LastSoftParkElectionRunningType;
  /* 0x0673 */ unsigned char Spare1;
  /* 0x0674 */ unsigned long HeapData;
  /* 0x0678 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x0688 */ unsigned __int64 DisownedOwnerEntryListLock;
  /* 0x0690 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
  /* 0x06a0 */ struct _KLOCK_ENTRY LockEntries[6];
  /* 0x08e0 */ void* CmThreadInfo;
  /* 0x08e8 */ void* FlsData;
  /* 0x08f0 */ unsigned long LastExpectedRunTime;
  /* 0x08f4 */ unsigned long LastSoftParkElectionRunTime;
  /* 0x08f8 */ unsigned __int64 LastSoftParkElectionGeneration;
...
typedef struct _EJOB
{
  ...
  /* 0x0428 */ unsigned long EffectiveIoPriorityLimit;
  /* 0x042c */ unsigned long IoPriorityLimit;
  /* 0x0430 */ unsigned long EffectivePagePriorityLimit;
  /* 0x0434 */ unsigned long PagePriorityLimit;
  /* 0x0438 */ unsigned char EffectivePriorityClass;
  /* 0x0439 */ unsigned char PriorityClass;
  /* 0x043a */ unsigned char NestingDepth;
  /* 0x043b */ unsigned char Reserved1[1];
  /* 0x043c */ unsigned long CompletionFilter;
  union
  {
    /* 0x0440 */ struct _WNF_STATE_NAME WakeChannel;
    /* 0x0440 */ struct _PS_JOB_WAKE_INFORMATION WakeInfo;
  }; /* size: 0x0048 */
  /* 0x0488 */ struct _JOBOBJECT_WAKE_FILTER WakeFilter;
  /* 0x0490 */ unsigned long LowEdgeLatchFilter;
  /* 0x0494 */ long Padding_187;
  /* 0x0498 */ struct _EJOB* NotificationLink;
  /* 0x04a0 */ unsigned __int64 CurrentJobMemoryUsed;
  /* 0x04a8 */ struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
  /* 0x04b0 */ void* NotificationInfoQuotaReference;
  /* 0x04b8 */ struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
  /* 0x04c0 */ struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
  /* 0x04c8 */ void* EffectiveSchedulingGroup;
  /* 0x04d0 */ unsigned __int64 ReadyTime;
  /* 0x04d8 */ struct _EX_PUSH_LOCK MemoryLimitsLock;
  /* 0x04e0 */ struct _LIST_ENTRY SiblingJobLinks;
  /* 0x04f0 */ struct _LIST_ENTRY ChildJobListHead;
  /* 0x0500 */ struct _EJOB* ParentJob;
  /* 0x0508 */ struct _EJOB* volatile RootJob;
  /* 0x0510 */ struct _LIST_ENTRY IteratorListHead;
  /* 0x0520 */ unsigned __int64 AncestorCount;
  union
  {
    /* 0x0528 */ struct _EJOB** Ancestors;
    /* 0x0528 */ void* SessionObject;
  }; /* size: 0x0008 */
  /* 0x0530 */ struct _EPROCESS_VALUES Accounting;
  /* 0x0598 */ unsigned long ShadowActiveProcessCount;
  /* 0x059c */ unsigned long ActiveAuxiliaryProcessCount;
  /* 0x05a0 */ unsigned long SequenceNumber;
  /* 0x05a4 */ unsigned long JobId;
  /* 0x05a8 */ struct _GUID ContainerId;
  /* 0x05b8 */ struct _GUID ContainerTelemetryId;
  /* 0x05c8 */ struct _ESERVERSILO_GLOBALS* ServerSiloGlobals;
  /* 0x05d0 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x05e8 */ struct _PSP_STORAGE* Storage;
  /* 0x05f0 */ struct _JOB_NET_RATE_CONTROL* NetRateControl;
  union
  {
    /* 0x05f8 */ unsigned long JobFlags;
    struct /* bitfield */
    {
      /* 0x05f8 */ unsigned long CloseDone : 1; /* bit position: 0 */
      /* 0x05f8 */ unsigned long MultiGroup : 1; /* bit position: 1 */
      /* 0x05f8 */ unsigned long OutstandingNotification : 1; /* bit position: 2 */
      /* 0x05f8 */ unsigned long NotificationInProgress : 1; /* bit position: 3 */
      /* 0x05f8 */ unsigned long UILimits : 1; /* bit position: 4 */
      /* 0x05f8 */ unsigned long CpuRateControlActive : 1; /* bit position: 5 */
      /* 0x05f8 */ unsigned long OwnCpuRateControl : 1; /* bit position: 6 */
      /* 0x05f8 */ unsigned long Terminating : 1; /* bit position: 7 */
      /* 0x05f8 */ unsigned long WorkingSetLock : 1; /* bit position: 8 */
      /* 0x05f8 */ unsigned long JobFrozen : 1; /* bit position: 9 */
      /* 0x05f8 */ unsigned long Background : 1; /* bit position: 10 */
      /* 0x05f8 */ unsigned long WakeNotificationAllocated : 1; /* bit position: 11 */
      /* 0x05f8 */ unsigned long WakeNotificationEnabled : 1; /* bit position: 12 */
      /* 0x05f8 */ unsigned long WakeNotificationPending : 1; /* bit position: 13 */
      /* 0x05f8 */ unsigned long LimitNotificationRequired : 1; /* bit position: 14 */
      /* 0x05f8 */ unsigned long ZeroCountNotificationRequired : 1; /* bit position: 15 */
      /* 0x05f8 */ unsigned long CycleTimeNotificationRequired : 1; /* bit position: 16 */
      /* 0x05f8 */ unsigned long CycleTimeNotificationPending : 1; /* bit position: 17 */
      /* 0x05f8 */ unsigned long TimersVirtualized : 1; /* bit position: 18 */
      /* 0x05f8 */ unsigned long JobSwapped : 1; /* bit position: 19 */
      /* 0x05f8 */ unsigned long ViolationDetected : 1; /* bit position: 20 */
      /* 0x05f8 */ unsigned long EmptyJobNotified : 1; /* bit position: 21 */
      /* 0x05f8 */ unsigned long NoSystemCharge : 1; /* bit position: 22 */
      /* 0x05f8 */ unsigned long DropNoWakeCharges : 1; /* bit position: 23 */
      /* 0x05f8 */ unsigned long NoWakeChargePolicyDecided : 1; /* bit position: 24 */
      /* 0x05f8 */ unsigned long NetRateControlActive : 1; /* bit position: 25 */
      /* 0x05f8 */ unsigned long OwnNetRateControl : 1; /* bit position: 26 */
      /* 0x05f8 */ unsigned long IoRateControlActive : 1; /* bit position: 27 */
      /* 0x05f8 */ unsigned long OwnIoRateControl : 1; /* bit position: 28 */
      /* 0x05f8 */ unsigned long DisallowNewProcesses : 1; /* bit position: 29 */
      /* 0x05f8 */ unsigned long Silo : 1; /* bit position: 30 */
      /* 0x05f8 */ unsigned long ContainerTelemetryIdSet : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x05fc */ unsigned long JobFlags2;
    struct /* bitfield */
    {
      /* 0x05fc */ unsigned long ParentLocked : 1; /* bit position: 0 */
      /* 0x05fc */ unsigned long EnableUsermodeSiloThreadImpersonation : 1; /* bit position: 1 */
      /* 0x05fc */ unsigned long DisallowUsermodeSiloThreadImpersonation : 1; /* bit position: 2 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x0600 */ struct _PROCESS_EXTENDED_ENERGY_VALUES* EnergyValues;
  /* 0x0608 */ volatile unsigned __int64 SharedCommitCharge;
  /* 0x0610 */ unsigned long DiskIoAttributionUserRefCount;
  /* 0x0614 */ unsigned long DiskIoAttributionRefCount;
  union
  {
    /* 0x0618 */ void* DiskIoAttributionContext;
    /* 0x0618 */ struct _EJOB* DiskIoAttributionOwnerJob;
  }; /* size: 0x0008 */
  /* 0x0620 */ struct _JOB_RATE_CONTROL_HEADER IoRateControlHeader;
  /* 0x0648 */ struct _PS_IO_CONTROL_ENTRY GlobalIoControl;
  /* 0x0680 */ volatile long IoControlStateLock;
  /* 0x0684 */ long Padding_188;
  /* 0x0688 */ struct _RTL_RB_TREE VolumeIoControlTree;
  /* 0x0698 */ unsigned __int64 IoRateOverQuotaHistory;
  /* 0x06a0 */ unsigned long IoRateCurrentGeneration;
  /* 0x06a4 */ unsigned long IoRateLastQueryGeneration;
  /* 0x06a8 */ unsigned long IoRateGenerationLength;
  /* 0x06ac */ unsigned long IoRateOverQuotaNotifySequenceId;
  /* 0x06b0 */ unsigned __int64 LastThrottledIoTime;
  /* 0x06b8 */ struct _EX_PUSH_LOCK IoControlLock;
  /* 0x06c0 */ __int64 SiloHardReferenceCount;
  /* 0x06c8 */ struct _WORK_QUEUE_ITEM RundownWorkItem;
  /* 0x06e8 */ void* PartitionObject;
  /* 0x06f0 */ struct _EJOB* PartitionOwnerJob;
  /* 0x06f8 */ union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;
  /* 0x0700 */ unsigned __int64 KernelWaitTime;
  /* 0x0708 */ unsigned __int64 UserWaitTime;
} EJOB, *PEJOB; /* size: 0x0710 */
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_199[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_200[2];
...
typedef struct _LDR_DATA_TABLE_ENTRY
{
  ...
  /* 0x011d */ char Padding_205[3];
  /* 0x0120 */ unsigned long CheckSum;
  /* 0x0124 */ long Padding_206;
