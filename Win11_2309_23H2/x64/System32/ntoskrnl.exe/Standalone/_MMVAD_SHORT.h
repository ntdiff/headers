...
typedef struct _MM_PRIVATE_VAD_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long Graphics : 1; /* bit position: 25 */
    /* 0x0000 */ unsigned long Enclave : 1; /* bit position: 26 */
    /* 0x0000 */ unsigned long ShadowStack : 1; /* bit position: 27 */
    /* 0x0000 */ unsigned long PhysicalMemoryPfnsReferenced : 1; /* bit position: 28 */
  }; /* bitfield */
...
typedef struct _MM_GRAPHICS_VAD_FLAGS
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned long FixedLargePageSize : 1; /* bit position: 23 */
    /* 0x0000 */ unsigned long ZeroFillPagesOptional : 1; /* bit position: 24 */
    /* 0x0000 */ unsigned long GraphicsAlwaysSet : 1; /* bit position: 25 */
    /* 0x0000 */ unsigned long GraphicsUseCoherentBus : 1; /* bit position: 26 */
    /* 0x0000 */ unsigned long GraphicsNoCache : 1; /* bit position: 27 */
    /* 0x0000 */ unsigned long GraphicsPageProtection : 3; /* bit position: 28 */
  }; /* bitfield */
...
typedef struct _MMVAD_SHORT
{
  ...
  union
  {
    union
    {
      /* 0x0038 */ unsigned __int64 EventListULongPtr;
      /* 0x0038 */ unsigned char StartingVpnHigher : 4; /* bit position: 0 */
    }; /* size: 0x0008 */
  } /* size: 0x0008 */ u5;
