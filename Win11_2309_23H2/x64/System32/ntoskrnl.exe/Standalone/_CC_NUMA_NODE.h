...
typedef struct _CC_NUMA_NODE
{
  ...
  /* 0x0190 */ struct _LIST_ENTRY IdleCompleteAsyncLazywriteWorkerThreadList;
  /* 0x01a0 */ unsigned long NumberActiveCompleteAsyncLazywriteWorkers;
  /* 0x01a8 */ struct _LIST_ENTRY AsyncLazywriteCompletionWorkQueue;
} CC_NUMA_NODE, *PCC_NUMA_NODE; /* size: 0x01b8 */
