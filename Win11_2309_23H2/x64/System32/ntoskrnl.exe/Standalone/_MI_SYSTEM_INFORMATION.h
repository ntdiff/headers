...
typedef struct _MI_SYSTEM_INFORMATION
{
  ...
  /* 0x1da0 */ struct _MI_PAGELIST_STATE PageLists;
  /* 0x1ec0 */ struct _MI_PARTITION_STATE Partitions;
  /* 0x2980 */ struct _MI_SHUTDOWN_STATE Shutdowns;
  /* 0x29f8 */ struct _MI_ERROR_STATE Errors;
  /* 0x2b00 */ struct _MI_ACCESS_LOG_STATE AccessLog;
  /* 0x2b80 */ struct _MI_DEBUGGER_STATE Debugger;
  /* 0x2ca0 */ struct _MI_STANDBY_STATE Standby;
  /* 0x2e40 */ struct _MI_SYSTEM_PTE_STATE SystemPtes;
  /* 0x40c0 */ struct _MI_IO_PAGE_STATE IoPages;
  /* 0x4180 */ struct _MI_PAGING_IO_STATE PagingIo;
  /* 0x4230 */ struct _MI_COMMON_PAGE_STATE CommonPages;
  /* 0x4300 */ struct _MI_SYSTEM_TRIM_STATE Trims;
  /* 0x4340 */ struct _MI_SYSTEM_ACCELERATORS Accelerators;
  /* 0x4368 */ struct _MI_HOT_PATCH_STATE HotPatch;
  /* 0x43c8 */ struct _MI_ENCLAVE_STATE Enclaves;
  /* 0x4410 */ unsigned __int64 Cookie;
  /* 0x4418 */ void* volatile* BootRegistryRuns;
  /* 0x4420 */ volatile long ZeroingDisabled;
  /* 0x4424 */ unsigned char FullyInitialized;
  /* 0x4425 */ unsigned char SafeBooted;
  /* 0x4428 */ const struct _tlgProvider_t* TraceLogging;
  /* 0x4440 */ struct _MI_VISIBLE_STATE Vs;
} MI_SYSTEM_INFORMATION, *PMI_SYSTEM_INFORMATION; /* size: 0x5140 */
