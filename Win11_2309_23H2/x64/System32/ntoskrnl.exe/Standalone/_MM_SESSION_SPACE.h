...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0260 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0268 */ unsigned long TopLevelPteLockBits[32];
  /* 0x02e8 */ struct _MMPTE PageTables[1];
  /* 0x02f0 */ enum _IO_SESSION_STATE IoState;
  /* 0x02f4 */ unsigned long IoStateSequence;
  /* 0x02f8 */ struct _KEVENT IoNotificationEvent;
  /* 0x0310 */ struct _EJOB* ServerSilo;
  /* 0x0318 */ unsigned __int64 CreateTime;
  /* 0x0320 */ long __PADDING__[8];
} MM_SESSION_SPACE, *PMM_SESSION_SPACE; /* size: 0x0340 */
