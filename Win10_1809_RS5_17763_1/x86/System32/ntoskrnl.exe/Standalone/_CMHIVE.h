...
typedef struct _CMHIVE
{
  ...
  /* 0x09c4 */ struct _HIVE_WRITE_WAIT_QUEUE ReconcileQueue;
  union
  {
    /* 0x09d0 */ unsigned long FlushFlags;
    struct /* bitfield */
    {
      /* 0x09d0 */ unsigned long FlushActive : 1; /* bit position: 0 */
      /* 0x09d0 */ unsigned long ReconcileActive : 1; /* bit position: 1 */
      /* 0x09d0 */ unsigned long PrimaryFilePurged : 1; /* bit position: 2 */
      /* 0x09d0 */ unsigned long DiskFileBad : 1; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0004 */
