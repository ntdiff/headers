...
typedef struct _LDR_DDAG_NODE
{
  ...
  /* 0x0014 */ unsigned long DependencyCount;
  union
  {
    /* 0x0018 */ struct _LDRP_CSLIST Dependencies;
    /* 0x0018 */ struct _SINGLE_LIST_ENTRY RemovalLink;
  }; /* size: 0x0004 */
  ...
  /* 0x002c */ unsigned long LowestLink;
} LDR_DDAG_NODE, *PLDR_DDAG_NODE; /* size: 0x0030 */
...
} RTL_USER_PROCESS_PARAMETERS, *PRTL_USER_PROCESS_PARAMETERS; /* size: 0x02a0 */
...
typedef struct _XSAVE_FORMAT
{
  ...
  /* 0x0120 */ unsigned char Reserved4[220];
...
typedef struct _KSPECIAL_REGISTERS
{
  ...
  /* 0x0044 */ unsigned long Reserved[4];
...
typedef struct _KPRCB
{
  ...
  /* 0x03d1 */ unsigned char PendingTick;
  /* 0x03d2 */ unsigned char PrcbPad1[70];
  ...
  /* 0x21a8 */ unsigned char PrcbPad50[48];
  /* 0x21d8 */ unsigned long InterruptLastCount;
  /* 0x21dc */ unsigned long InterruptRate;
  /* 0x21e0 */ struct _KDPC_DATA DpcData[2];
  /* 0x2208 */ void* DpcStack;
  /* 0x220c */ long MaximumDpcQueueDepth;
  /* 0x2210 */ unsigned long DpcRequestRate;
  /* 0x2214 */ unsigned long MinimumDpcRate;
  /* 0x2218 */ unsigned long DpcLastCount;
  /* 0x221c */ unsigned long PrcbLock;
  /* 0x2220 */ struct _KGATE DpcGate;
  /* 0x2230 */ unsigned char ThreadDpcEnable;
  /* 0x2231 */ volatile unsigned char QuantumEnd;
  /* 0x2232 */ volatile unsigned char DpcRoutineActive;
  /* 0x2233 */ volatile unsigned char IdleSchedule;
  union
  {
    /* 0x2234 */ volatile long DpcRequestSummary;
    /* 0x2234 */ short DpcRequestSlot[2];
    struct
    {
      /* 0x2234 */ short NormalDpcState;
      /* 0x2236 */ short ThreadDpcState;
    }; /* size: 0x0004 */
    struct /* bitfield */
    {
      /* 0x2234 */ unsigned long DpcNormalProcessingActive : 1; /* bit position: 0 */
      /* 0x2234 */ unsigned long DpcNormalProcessingRequested : 1; /* bit position: 1 */
      /* 0x2234 */ unsigned long DpcNormalThreadSignal : 1; /* bit position: 2 */
      /* 0x2234 */ unsigned long DpcNormalTimerExpiration : 1; /* bit position: 3 */
      /* 0x2234 */ unsigned long DpcNormalDpcPresent : 1; /* bit position: 4 */
      /* 0x2234 */ unsigned long DpcNormalLocalInterrupt : 1; /* bit position: 5 */
      /* 0x2234 */ unsigned long DpcNormalSpare : 10; /* bit position: 6 */
      /* 0x2234 */ unsigned long DpcThreadActive : 1; /* bit position: 16 */
      /* 0x2234 */ unsigned long DpcThreadRequested : 1; /* bit position: 17 */
      /* 0x2234 */ unsigned long DpcThreadSpare : 14; /* bit position: 18 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x2238 */ unsigned long LastTimerHand;
  /* 0x223c */ unsigned long LastTick;
  /* 0x2240 */ unsigned long PeriodicCount;
  /* 0x2244 */ unsigned long PeriodicBias;
  /* 0x2248 */ unsigned long ClockInterrupts;
  /* 0x224c */ unsigned long ReadyScanTick;
  /* 0x2250 */ unsigned char BalanceState;
  /* 0x2251 */ unsigned char GroupSchedulingOverQuota;
  /* 0x2252 */ unsigned char PrcbPad41[10];
  ...
  /* 0x3ae0 */ struct _LIST_ENTRY WaitListHead;
  /* 0x3ae8 */ unsigned long WaitLock;
  /* 0x3aec */ unsigned long ReadySummary;
  /* 0x3af0 */ unsigned long ReadyQueueWeight;
  /* 0x3af4 */ struct _KPRCB* BuddyPrcb;
  /* 0x3af8 */ unsigned __int64 StartCycles;
  /* 0x3b00 */ unsigned __int64 GenerationTarget;
  /* 0x3b08 */ volatile unsigned __int64 CycleTime;
  /* 0x3b10 */ volatile unsigned long HighCycleTime;
  /* 0x3b14 */ unsigned long ScbOffset;
  /* 0x3b18 */ unsigned __int64 AffinitizedCycles;
  ...
  /* 0x3c94 */ long Padding_33;
  /* 0x3c98 */ union _LARGE_INTEGER UpdateSignature;
  /* 0x3ca0 */ volatile unsigned __int64 IsrTime;
  /* 0x3ca8 */ unsigned long Stride;
  /* 0x3cac */ unsigned long PrcbPad90;
  /* 0x3cb0 */ struct _PROCESSOR_POWER_STATE PowerState;
  /* 0x3e30 */ unsigned long PrcbPad91[1];
  /* 0x3e34 */ struct _KDPC DpcWatchdogDpc;
  /* 0x3e54 */ long Padding_34;
  /* 0x3e58 */ struct _KTIMER DpcWatchdogTimer;
  /* 0x3e80 */ union _SLIST_HEADER HypercallPageList;
  /* 0x3e88 */ void* HypercallPageVirtual;
  /* 0x3e8c */ void* VirtualApicAssist;
  /* 0x3e90 */ unsigned __int64* StatisticsPage;
  /* 0x3e94 */ struct _CACHE_DESCRIPTOR Cache[5];
  /* 0x3ed0 */ unsigned long CacheCount;
  /* 0x3ed4 */ struct _KAFFINITY_EX PackageProcessorSet;
  /* 0x3ee0 */ unsigned long CacheProcessorMask[5];
  /* 0x3ef4 */ unsigned long ScanSiblingMask;
  /* 0x3ef8 */ unsigned long CoreProcessorSet;
  /* 0x3efc */ unsigned long ScanSiblingIndex;
  /* 0x3f00 */ unsigned long LLCLevel;
  /* 0x3f04 */ void* WheaInfo;
  /* 0x3f08 */ void* EtwSupport;
  /* 0x3f0c */ long Padding_35;
  /* 0x3f10 */ union _SLIST_HEADER InterruptObjectPool;
  /* 0x3f18 */ unsigned long PrcbPad92[8];
  /* 0x3f38 */ struct _PROCESSOR_PROFILE_CONTROL_AREA* ProcessorProfileControlArea;
  /* 0x3f3c */ void* ProfileEventIndexAddress;
  /* 0x3f40 */ struct _KDPC TimerExpirationDpc;
  /* 0x3f60 */ struct _SYNCH_COUNTERS SynchCounters;
  /* 0x4018 */ struct _FILESYSTEM_DISK_COUNTERS FsCounters;
  /* 0x4028 */ struct _CONTEXT* Context;
  /* 0x402c */ unsigned long ContextFlagsInit;
  /* 0x4030 */ struct _XSAVE_AREA* ExtendedState;
  /* 0x4034 */ struct _KENTROPY_TIMING_STATE EntropyTimingState;
  /* 0x415c */ long __PADDING__[1];
} KPRCB, *PKPRCB; /* size: 0x4160 */
...
typedef struct _KTRAP_FRAME
{
  ...
  /* 0x0013 */ unsigned char FrameType;
...
typedef struct _KPROCESS
{
  ...
  union
  {
    struct /* bitfield */
    {
      ...
      /* 0x005c */ unsigned long ActiveGroupsMask : 1; /* bit position: 6 */
      /* 0x005c */ long ReservedFlags : 25; /* bit position: 7 */
    }; /* bitfield */
...
typedef struct _HANDLE_TABLE_FREE_LIST
{
  ...
  /* 0x0004 */ struct _HANDLE_TABLE_ENTRY* FirstFreeHandleEntry;
  /* 0x0008 */ struct _HANDLE_TABLE_ENTRY* LastFreeHandleEntry;
...
typedef struct _EPROCESS
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x00c0 */ unsigned long NoWakeCharge : 1; /* bit position: 6 */
      /* 0x00c0 */ unsigned long HandleTableRundown : 1; /* bit position: 7 */
      /* 0x00c0 */ unsigned long NeedsHandleRundown : 1; /* bit position: 8 */
      /* 0x00c0 */ unsigned long RefTraceEnabled : 1; /* bit position: 9 */
      /* 0x00c0 */ unsigned long NumaAware : 1; /* bit position: 10 */
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x00c4 */ unsigned long Wow64SplitPages : 1; /* bit position: 4 */
      ...
      /* 0x00c4 */ unsigned long CrossSessionCreate : 1; /* bit position: 25 */
  ...
  /* 0x00f8 */ struct _ETHREAD* RotateInProgress;
  /* 0x00fc */ struct _ETHREAD* ForkInProgress;
  /* 0x0100 */ unsigned long HardwareTrigger;
  /* 0x0104 */ struct _EJOB* volatile CommitChargeJob;
  /* 0x0108 */ struct _MM_AVL_TABLE* CloneRoot;
  ...
  union
  {
    /* 0x013c */ struct _EPROCESS* CreatorProcess;
    /* 0x013c */ unsigned long ConsoleHostProcess;
  }; /* size: 0x0004 */
  ...
  /* 0x01b0 */ struct _MM_AVL_TABLE* LockedPagesList;
  /* 0x01b4 */ long Padding_53;
  ...
  /* 0x0274 */ struct _MM_AVL_TABLE VadRoot;
  /* 0x028c */ volatile unsigned long VadPhysicalPages;
  /* 0x0290 */ unsigned long VadPhysicalPagesLimit;
  /* 0x0294 */ struct _ALPC_PROCESS_CONTEXT AlpcContext;
  /* 0x02a4 */ struct _LIST_ENTRY TimerResolutionLink;
  /* 0x02ac */ struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
  /* 0x02b0 */ unsigned long RequestedTimerResolution;
  /* 0x02b4 */ unsigned long SmallestTimerResolution;
  /* 0x02b8 */ union _LARGE_INTEGER ExitTime;
  /* 0x02c0 */ unsigned long ActiveThreadsHighWatermark;
  /* 0x02c4 */ unsigned long LargePrivateVadCount;
  /* 0x02c8 */ struct _EX_PUSH_LOCK ThreadListLock;
  /* 0x02cc */ void* WnfContext;
  /* 0x02d0 */ unsigned long SectionMappingSize;
  /* 0x02d4 */ unsigned char SignatureLevel;
  /* 0x02d5 */ unsigned char SectionSignatureLevel;
  /* 0x02d6 */ unsigned char SpareByte20[2];
  /* 0x02d8 */ unsigned long KeepAliveCounter;
  /* 0x02dc */ struct _PROCESS_DISK_COUNTERS* DiskCounters;
  /* 0x02e0 */ unsigned __int64 LastFreezeInterruptTime;
} EPROCESS, *PEPROCESS; /* size: 0x02e8 */
...
typedef struct _LDR_DATA_TABLE_ENTRY
{
  ...
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0034 */ unsigned long ReservedFlags2 : 1; /* bit position: 13 */
      /* 0x0034 */ unsigned long EntryProcessed : 1; /* bit position: 14 */
      /* 0x0034 */ unsigned long ReservedFlags3 : 3; /* bit position: 15 */
  ...
  /* 0x005c */ struct _LDRP_DLL_SNAP_CONTEXT* SnapContext;
...
} LDR_DATA_TABLE_ENTRY, *PLDR_DATA_TABLE_ENTRY; /* size: 0x0098 */
...
typedef struct _HEAP_SUBSEGMENT
{
  ...
  /* 0x001c */ struct _SINGLE_LIST_ENTRY SFreeListEntry;
  /* 0x0020 */ volatile unsigned long Lock;
  /* 0x0024 */ long __PADDING__[1];
...
{
  /* 0x0000 */ struct _LIST_ENTRY ListEntry;
  /* 0x0008 */ void* volatile FreePointer;
  /* 0x000c */ void* Limit;
} LFH_BLOCK_ZONE, *PLFH_BLOCK_ZONE; /* size: 0x0010 */
...
typedef struct _LFH_HEAP
{
  ...
  /* 0x002c */ unsigned long SizeInCache;
  /* 0x0030 */ volatile union _HEAP_BUCKET_RUN_INFO RunInfo;
  /* 0x0038 */ struct _USER_MEMORY_CACHE_ENTRY UserBlockCache[12];
  /* 0x01b8 */ struct _HEAP_BUCKET Buckets[129];
  /* 0x03bc */ struct _HEAP_LOCAL_SEGMENT_INFO* SegmentInfoArrays[129];
  /* 0x05c0 */ struct _HEAP_LOCAL_SEGMENT_INFO* AffinitizedInfoArrays[129];
  /* 0x07c4 */ long Padding_63;
  /* 0x07c8 */ struct _HEAP_LOCAL_DATA LocalData[1];
} LFH_HEAP, *PLFH_HEAP; /* size: 0x07e0 */
...
typedef struct _HEAP_USERDATA_HEADER
{
  ...
  /* 0x0010 */ unsigned short FirstAllocationOffset;
  /* 0x0012 */ unsigned short BlockStride;
...
@RtlpWaitOnAddressWithTimeout@8
@RtlpWakeByAddress@8
...
_EtwpFinalizeLogFileHeader@12
_EtwpFinalizeRelogFileHeaderStats@12
...
_EtwpWriteRemainingCompressedData@4
...
_LdrQueryModuleInfoFromLdrEntry@16
...
_LdrpAppxSqmIntegrityFailure@16
...
_LdrpDecrementNodeDependencyCount@4
_LdrpDecrementNodeLoadCount@4
_LdrpDereferenceNode@4
_LdrpDoDebuggerBreak@0
_LdrpDoDeferredNodeRemoval@4
...
_LdrpFindLoadedDll@20
_LdrpFindLoadedDllByAddress@16
_LdrpFindLoadedDllByHandle@16
_LdrpFindLoadedDllByMapping@20
_LdrpFindLoadedDllByName@20
_LdrpFindMessageInAlternateModule@20
_LdrpFindOrMapDependency@24
_LdrpFindOrMapDll@36
_LdrpFixSectionProtection@12
_LdrpForkProcess@0
_LdrpFreeSnapContext@4
_LdrpFreeTls@0
...
_LdrpInitializeGraph@12
_LdrpInitializeLoadContext@8
...
_LdrpInitializeShimDllDependencies@4
...
_LdrpPrepareImportAddressTableForSnap@8
_LdrpPrepareModuleForExecution@16
_LdrpProcessDetachNode@4
_LdrpProcessImageProtectionParameter@8
_LdrpProcessMappedModule@4
...
_LdrpReferenceNode@4
_LdrpReleaseDllPath@4
_LdrpReleaseLoaderLock@16
_LdrpReleaseModuleEnumLock@0
...
_LdrpResolveDllName@36
_LdrpResolveNonStaticDependency@48
...
_RtlValidSid@4
_RtlValidateBoundaryDescriptor@4
_RtlValidateHeap@12
...
_RtlpGetDefaultsSubjectContext@32
_RtlpGetDirPath@8
...
_RtlpGetHeapWalkEntryOverheadBytes@4
...
_RtlpLogExceptionDisposition@8
_RtlpLogExceptionHandler@16
_RtlpLogHeapAffinityManagerEnable@8
_RtlpLogHeapAffinitySlotAssign@4
...
_RtlpQueryFrontEndHeapCommit@4
...
_RtlpSetClearExecutionRequiredRequest@12
_RtlpSetHeapDebuggingInformation@8
_RtlpSetHeapWalkEntryOverheadBytes@8
...
_RtlpWaitOnAddressRemoveWaitBlock@4
...
_SbtLogSystemUsageByDll@32
_SbtLogSystemUsageByExe@20
...
_XpressInitializeBitIndexTable@0
_XpressInitializeHashFunction@0
...
_ZwWaitForWnfNotifications@8
_ZwWaitForWorkViaWorkerFactory@16
