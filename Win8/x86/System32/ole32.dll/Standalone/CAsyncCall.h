...
class CAsyncCall
{
  union
  {
    struct
    {
      ...
      /* 0x00f0 */ unsigned long _iRefCount;
      /* 0x00f4 */ class CChannelObject* _pChnlObj;
      /* 0x00f8 */ void* _pRequestBuffer;
      /* 0x00fc */ unsigned long _lApt;
      /* 0x0100 */ enum tagAPTKIND _clientAptKind;
      /* 0x0104 */ struct _RPC_ASYNC_STATE _AsyncState;
      /* 0x0148 */ struct HWND__* _hwndSTA;
      /* 0x014c */ class CAsyncCall* _pNext;
      /* 0x0150 */ unsigned long _lFlags;
      /* 0x0154 */ enum ESignalState _eSignalState;
    }; /* size: 0x006c */
