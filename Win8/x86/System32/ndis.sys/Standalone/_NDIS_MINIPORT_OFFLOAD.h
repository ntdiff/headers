...
typedef struct _NDIS_MINIPORT_OFFLOAD
{
  ...
  /* 0x0434 */ void* MiniportRequestBuffer;
  /* 0x0438 */ unsigned long MiniportRequestOid;
  /* 0x043c */ unsigned long MiniportRequestBufferLength;
} NDIS_MINIPORT_OFFLOAD, *PNDIS_MINIPORT_OFFLOAD; /* size: 0x0440 */
