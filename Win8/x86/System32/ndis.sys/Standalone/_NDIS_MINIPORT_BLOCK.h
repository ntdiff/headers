...
typedef struct _NDIS_MINIPORT_BLOCK
{
  ...
  /* 0x0408 */ struct _KEVENT* AllOpensClosedEvent;
  /* 0x040c */ struct _KEVENT* AllRequestsCompletedEvent;
  /* 0x0410 */ unsigned long InitTimeMs;
  /* 0x0414 */ struct _NDIS_MINIPORT_WORK_ITEM WorkItemBuffer[6];
  /* 0x045c */ struct _OID_LIST* OidList;
  /* 0x0460 */ unsigned short InternalResetCount;
  /* 0x0462 */ unsigned short MiniportResetCount;
  /* 0x0464 */ unsigned short MediaSenseConnectCount;
  /* 0x0466 */ unsigned short MediaSenseDisconnectCount;
  /* 0x0468 */ struct _NDIS_PACKET** xPackets;
  /* 0x046c */ unsigned long UserModeOpenReferences;
  /* 0x0470 */ void* WSendPacketsHandler /* function */;
  /* 0x0474 */ unsigned long MiniportAttributes;
  /* 0x0478 */ unsigned short NumOpens;
  /* 0x047a */ unsigned short CFHangXTicks;
  /* 0x047c */ unsigned long RequestCount;
  /* 0x0480 */ unsigned long IndicatedPacketsCount;
  /* 0x0484 */ unsigned long PhysicalMediumType;
  /* 0x0488 */ enum _NDIS_MEDIUM MiniportMediaType;
  /* 0x048c */ struct _NDIS_REQUEST* LastRequest;
  /* 0x0490 */ void* FakeMac;
  /* 0x0494 */ unsigned long LockDbg;
  /* 0x0498 */ unsigned long LockDbgX;
  /* 0x049c */ void* LockThread;
  /* 0x04a0 */ unsigned long InfoFlags;
  /* 0x04a4 */ unsigned long TimerQueueLock;
  /* 0x04a8 */ struct _KEVENT* ResetCompletedEvent;
  /* 0x04ac */ void* SavedPacketIndicateHandler /* function */;
  /* 0x04b0 */ long RegisteredInterrupts;
  /* 0x04b4 */ unsigned long SetOid;
  /* 0x04b8 */ struct _KEVENT CFHCompletedEvent;
  /* 0x04c8 */ struct _WORK_QUEUE_ITEM CFHWorkItem;
  /* 0x04d8 */ volatile long CFHWorkItemQueued;
  /* 0x04dc */ void* DeviceContext;
  /* 0x04e0 */ struct _NDIS_MINIPORT_RSS_PARAMETERS_CACHE* RssParametersBuffer;
  /* 0x04e4 */ unsigned char UsingMSIX;
  /* 0x04e5 */ unsigned char Miniport5InNdis6Mode;
  /* 0x04e6 */ unsigned char Miniport5HasNdis6Component;
  /* 0x04e7 */ unsigned char InitMode;
  /* 0x04e8 */ char MediaChangeFilters;
  /* 0x04e9 */ unsigned char FilterPnPLockAcquired;
  /* 0x04ea */ unsigned char LWFilterAllLoaded;
  /* 0x04eb */ unsigned char CheckPacketFilters;
  /* 0x04ec */ unsigned char ReceiveFilters;
  /* 0x04f0 */ void* FilterPnPLockThread;
  /* 0x04f4 */ unsigned long FilterPnPLockDbgX;
  ...
  /* 0x0664 */ long NumOfPauseRestartRequests;
  /* 0x0668 */ unsigned long FilterPnPFlags;
  /* 0x066c */ unsigned long SupportedStatistics;
  /* 0x0670 */ unsigned long cDpcSendCompletes;
  /* 0x0674 */ unsigned long cDpcRcvIndications;
  /* 0x0678 */ unsigned long cDpcRcvIndicationCalls;
  /* 0x067c */ unsigned long cDpcNbSendCompletes;
  /* 0x0680 */ unsigned long cDpcNblSendCompletes;
  /* 0x0684 */ unsigned long cDpcNblIndications;
  /* 0x0688 */ unsigned long cDpcMaxPacketsIndicated;
  /* 0x068c */ unsigned long cDpcTotalDpcCount;
  /* 0x0690 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES RecvScaleCapabilities;
  /* 0x06a4 */ struct _NDIS_MINIPORT_ADAPTER_GENERAL_ATTRIBUTES* GeneralAttributes;
  /* 0x06a8 */ struct _LIST_ENTRY PortList;
  /* 0x06b0 */ unsigned char* AllocatedPortIndices;
  /* 0x06b4 */ unsigned long AllocatedPortIndicesLength;
  /* 0x06b8 */ unsigned long NumberOfPorts;
  /* 0x06bc */ unsigned long NumberOfActivePorts;
  /* 0x06c0 */ unsigned __int64 MiniportXmitLinkSpeed;
  /* 0x06c8 */ unsigned __int64 MiniportRcvLinkSpeed;
  /* 0x06d0 */ struct _NDIS_TIMER InitModeTimeoutTimer;
  /* 0x0718 */ struct _NDIS_WORK_ITEM InitModeTimeoutWorkItem;
  /* 0x0740 */ struct _KEVENT InitModeTimeoutTimerQueuedEvent;
  /* 0x0750 */ unsigned long NumBootProtocols;
  /* 0x0754 */ unsigned long NumMissingBootProtocols;
  /* 0x0758 */ struct _NDIS_PROTOCOL_BLOCK** BootProtocolsArray;
  /* 0x075c */ struct _NDIS_DPC_TRACKER* DpcTrackers;
  /* 0x0760 */ struct _NDIS_DPC_TRACKER* CurrentDpcTracker;
  /* 0x0764 */ unsigned char DpcTrackerIndex;
  /* 0x0765 */ unsigned char SupportedRss;
  /* 0x0768 */ unsigned __int64 DpcWatchDogCycleCount;
  /* 0x0770 */ unsigned long DataBackFillSize;
  /* 0x0774 */ unsigned long ContextBackFillSize;
  /* 0x0778 */ struct _NDIS_RESTART_GENERAL_ATTRIBUTES TopFilterRestartAttributes;
  /* 0x07c8 */ struct _NDIS_RECEIVE_SCALE_CAPABILITIES TopRecvScaleCapabilities;
  /* 0x07dc */ long NumOfOpenPauseRestartRequests;
  /* 0x07e0 */ long MiniportStackPauseCount;
  /* 0x07e4 */ unsigned long NsiOpenReferences;
  /* 0x07e8 */ void* ProcessingOpen;
  /* 0x07ec */ struct _KEVENT* NsiRequestsCompletedEvent;
  /* 0x07f0 */ enum _DEVICE_POWER_STATE QueryPowerDeviceState;
  /* 0x07f4 */ unsigned char MinimumNdisMajorVersion;
  /* 0x07f5 */ unsigned char MinimumNdisMinorVersion;
  /* 0x07f8 */ struct _NDIS_MINIPORT_STATS* BottomIfStats;
  /* 0x07fc */ struct _NDIS_M_PERIODIC_RECEIVES PeriodicReceiveQueue;
  /* 0x0858 */ enum _NDIS_PORT_CONTROL_STATE DefaultSendControlState;
  /* 0x085c */ enum _NDIS_PORT_CONTROL_STATE DefaultRcvControlState;
  /* 0x0860 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultSendAuthorizationState;
  /* 0x0864 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultRcvAuthorizationState;
  /* 0x0868 */ enum _NDIS_PORT_CONTROL_STATE DefaultPortSendControlState;
  /* 0x086c */ enum _NDIS_PORT_CONTROL_STATE DefaultPortRcvControlState;
  /* 0x0870 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortSendAuthorizationState;
  /* 0x0874 */ enum _NDIS_PORT_AUTHORIZATION_STATE DefaultPortRcvAuthorizationState;
  /* 0x0878 */ struct _NDIS_PCI_DEVICE_CUSTOM_PROPERTIES PciDeviceCustomProperties;
  /* 0x08ac */ void* TopNdis5PacketIndicateHandler /* function */;
  /* 0x08b0 */ unsigned long* ndisSupportedOidList;
  /* 0x08b4 */ unsigned long ndisSupportedOidListLength;
  /* 0x08b8 */ unsigned long MsiIntCount;
  /* 0x08bc */ struct _WORK_QUEUE_ITEM MiniportDpcWorkItem;
  /* 0x08d0 */ unsigned __int64 InvalidFrames;
  /* 0x08d8 */ long PagingPathCount;
  /* 0x08dc */ struct _LIST_ENTRY ReceiveQueueList;
  /* 0x08e4 */ unsigned char* AllocatedQueueIndices;
  /* 0x08e8 */ unsigned long AllocatedQueueIndicesLength;
  /* 0x08ec */ unsigned long NumReceiveQueues;
  /* 0x08f0 */ struct _LIST_ENTRY ReceiveFilterList;
  /* 0x08f8 */ unsigned char* AllocatedReceiveFilterIndices;
  /* 0x08fc */ unsigned long AllocatedReceiveFilterIndicesLength;
  /* 0x0900 */ unsigned long NumReceiveFilters;
  /* 0x0904 */ unsigned long EnabledReceiveFilterTypes;
  /* 0x0908 */ unsigned long EnabledReceiveQueueTypes;
  /* 0x090c */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterHwCapabilities;
  /* 0x0910 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* ReceiveFilterCurrentCapabilities;
  /* 0x0914 */ struct _NDIS_RECEIVE_FILTER_CAPABILITIES* TopReceiveFilterCurrentCapabilities;
  /* 0x0918 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchHwCapabilities;
  /* 0x091c */ struct _NDIS_NIC_SWITCH_CAPABILITIES* NicSwitchCurrentCapabilities;
  /* 0x0920 */ struct _NDIS_NIC_SWITCH_CAPABILITIES* TopNicSwitchCurrentCapabilities;
  /* 0x0924 */ struct _LIST_ENTRY SharedMemoryBlockList;
  /* 0x092c */ void* AllocateSharedMemoryHandler /* function */;
  /* 0x0930 */ void* FreeSharedMemoryHandler /* function */;
  /* 0x0934 */ void* AllocateSharedMemoryContext;
  /* 0x0938 */ struct PCI_MSI_CAPABILITY MsiCaps;
  /* 0x0950 */ struct PCI_MSIX_CAPABILITY MsiXCaps;
  /* 0x0960 */ unsigned __int64 NumberOfIndirectionTableChanges;
  /* 0x0968 */ unsigned int PciDeviceSriovSupport;
  union
  {
    /* 0x096c */ unsigned char BeginSavedFields;
    /* 0x096c */ unsigned long NumUserOpens;
  }; /* size: 0x0004 */
  /* 0x0970 */ struct _NDIS_MINIPORT_OFFLOAD_REG OffloadRegistry;
  /* 0x0974 */ unsigned short MediaDisconnectTimeOut;
  /* 0x0976 */ unsigned short SGMapRegistersNeeded;
  /* 0x0978 */ unsigned long DriverVerifyFlags;
  /* 0x097c */ void* SetBusData /* function */;
  /* 0x0980 */ void* GetBusData /* function */;
  /* 0x0984 */ void* BusDataContext;
  /* 0x0988 */ enum _NDIS_INTERFACE_TYPE BusType;
  /* 0x098c */ unsigned long BusNumber;
  /* 0x0990 */ unsigned long SlotNumber;
  /* 0x0994 */ struct _NDIS_EVENT OpenReadyEvent;
  /* 0x09a4 */ unsigned long NumAdminOpens;
  /* 0x09a8 */ struct _NDIS_M_DRIVER_BLOCK* DriverHandle;
  /* 0x09ac */ struct _NDIS_BIND_PATHS* BindPaths;
  /* 0x09b0 */ struct _NDIS_BIND_PATHS* LWFilterList;
  /* 0x09b4 */ unsigned long MiniportPhysicalMediumType;
  /* 0x09b8 */ struct _NDIS_FILTER_ATTACH_LIST* LWFilterAttachList;
  /* 0x09bc */ unsigned long NumFilters;
  /* 0x09c0 */ void* SecurityDescriptor;
  /* 0x09c4 */ struct _UNICODE_STRING BaseName;
  /* 0x09cc */ struct _UNICODE_STRING MiniportName;
  /* 0x09d4 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x09d8 */ struct _DEVICE_OBJECT* PhysicalDeviceObject;
  /* 0x09dc */ struct _DEVICE_OBJECT* NextDeviceObject;
  /* 0x09e0 */ struct _NDIS_MINIPORT_BLOCK* NextGlobalMiniport;
  /* 0x09e4 */ struct _UNICODE_STRING* pAdapterInstanceName;
  /* 0x09e8 */ unsigned long PnPCapabilities;
  /* 0x09ec */ enum _DEVICE_POWER_STATE CurrentDevicePowerState;
  /* 0x09f0 */ unsigned long PowerStateLock;
  /* 0x09f4 */ enum _DEVICE_POWER_STATE DriverPowerState;
  /* 0x09f8 */ enum _DEVICE_POWER_STATE PrevDriverPowerState;
  /* 0x09fc */ struct _NET_BUFFER_LIST* LowPowerRcvReturnNbls;
  /* 0x0a00 */ unsigned long PendingReturnNBLCount;
  /* 0x0a04 */ struct NDIS_NBL_TRACKER_HANDLE__* LowPowerRcvReturnNblTracker;
  /* 0x0a08 */ struct _NDIS_PM_ADMIN_CONFIG PMAdminConfig;
  /* 0x0a0c */ struct _KSEMAPHORE PMPatternSemaphore;
  /* 0x0a20 */ struct _KSEMAPHORE PMOffloadSemaphore;
  /* 0x0a34 */ void* BusInterface;
  /* 0x0a38 */ unsigned short InstanceNumber;
  /* 0x0a3c */ void* ConfigurationHandle;
  /* 0x0a40 */ struct _GUID InterfaceGuid;
  /* 0x0a50 */ union _NET_LUID_LH NetLuid;
  /* 0x0a58 */ unsigned char IfBlockAvailable;
  /* 0x0a5c */ struct _NDIS_IF_BLOCK* IfBlock;
  /* 0x0a60 */ struct _KEVENT* IfBlockPointerRefZeroEvent;
  /* 0x0a64 */ unsigned int IfIndex;
  /* 0x0a68 */ enum _NET_IF_ADMIN_STATUS AdminStatus;
  /* 0x0a6c */ enum _NET_IF_OPER_STATUS OperStatus;
  /* 0x0a70 */ unsigned long OperStatusFlags;
  union
  {
    /* 0x0a74 */ void* SendHandler /* function */;
    /* 0x0a74 */ void* WanSendHandler /* function */;
  }; /* size: 0x0004 */
  /* 0x0a78 */ struct NDIS_NBL_TRACKER_HANDLE__* NblTracker;
  /* 0x0a7c */ struct _NDIS_MINIPORT_OFFLOAD* Offload;
  /* 0x0a80 */ void* NDKBlock;
  /* 0x0a84 */ void* AddDeviceContext;
  /* 0x0a88 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x0aa0 */ struct _UNICODE_STRING DevinterfaceNetSymbolicLinkName;
  /* 0x0aa8 */ unsigned char RssEnable;
  /* 0x0aa9 */ unsigned char ChimneyEnable;
  /* 0x0aac */ unsigned long PhysicalMediumInInf;
  /* 0x0ab0 */ struct _UNICODE_STRING ExportName;
  /* 0x0ab8 */ struct _UNICODE_STRING FilterClass;
  /* 0x0ac0 */ void* StatusProcessingThread;
  /* 0x0ac4 */ unsigned long StatusProcessingDbgX;
  /* 0x0ac8 */ struct _UNICODE_STRING FdoName;
  /* 0x0ad0 */ struct _KEVENT PowerD0CompleteEvent;
  /* 0x0ae0 */ long LastD0CompleteStatus;
  /* 0x0ae4 */ enum _NDIS_MINIPORT_EVENT LastD0Reason;
  /* 0x0ae8 */ unsigned long DirectOidRequestCount;
  /* 0x0aec */ struct _KEVENT* AllDirectRequestsCompletedEvent;
  /* 0x0af0 */ struct _NDIS_HD_SPLIT_CURRENT_CONFIG* HDSplitCurrentConfig;
  /* 0x0af4 */ void* MSIXConfigContext;
  /* 0x0af8 */ void* SetMSIXTableEntry /* function */;
  /* 0x0afc */ void* MaskMSIXTableEntry /* function */;
  /* 0x0b00 */ void* UnmaskMSIXTableEntry /* function */;
  /* 0x0b04 */ struct _WORK_QUEUE_ITEM DevicePowerStateWorkItem;
  /* 0x0b14 */ struct _WORK_QUEUE_ITEM SystemPowerStateWorkItem;
  /* 0x0b24 */ struct _NDIS_RECEIVE_QUEUE_BLOCK* DefaultReceiveQueue;
  /* 0x0b28 */ unsigned long MaxNumRssProcessors;
  /* 0x0b2c */ struct _PROCESSOR_NUMBER RssBaseProcessor;
  /* 0x0b30 */ struct _PROCESSOR_NUMBER RssMaxProcessor;
  /* 0x0b34 */ enum _NDIS_RSS_PROFILE RssProfile;
  /* 0x0b38 */ unsigned short NumaNodeId;
  /* 0x0b3c */ unsigned short* NumaDistances;
  /* 0x0b40 */ struct _UNICODE_STRING* pModifiedInstanceName;
  /* 0x0b44 */ struct _WORK_QUEUE_ITEM DeleteMiniportWorkItem;
  /* 0x0b54 */ unsigned long SyncFlags;
  /* 0x0b58 */ unsigned long WSyncFlags;
  /* 0x0b5c */ unsigned long InterlockedFlags;
  /* 0x0b60 */ struct _ULONG_REFERENCE Ref;
  /* 0x0b6c */ struct _REFERENCE_EX BindWorkItemRef;
  /* 0x0b78 */ struct _KEVENT QueuedBindingCompletedEvent;
  /* 0x0b88 */ struct _NDIS_SELECTIVE_SUSPEND* SelectiveSuspend;
  /* 0x0b8c */ struct _NDIS_MINIPORT_AOAC* AoAc;
  /* 0x0b90 */ enum _NDIS_PM_WAKE_REASON_TYPE LastWakeReason;
  /* 0x0b94 */ struct NDIS_EVENT_LOG_HANDLE__* PnpEventLog;
  /* 0x0b98 */ struct NDIS_EVENT_LOG_HANDLE__* PauseEventLog;
  /* 0x0b9c */ struct _NDIS_D0_SIGNAL_WORK_ITEM D0CompleteSignalWorkItem;
  /* 0x0bcc */ struct _NDIS_PHYSICAL_PERFORMANCE_COUNTERS* PhysicalPerformanceCounters;
  /* 0x0bd0 */ union _LARGE_INTEGER TimeOfInitialization;
  /* 0x0bd8 */ union _LARGE_INTEGER LastSystemSleepTime;
  /* 0x0be0 */ unsigned __int64 TotalSystemSleepTimeMs;
  /* 0x0be8 */ struct _NDIS_SRIOV_CAPABILITIES* SriovHwCapabilities;
  /* 0x0bec */ struct _NDIS_SRIOV_CAPABILITIES* SriovCurrentCapabilities;
  /* 0x0bf0 */ unsigned __int64 InvalidateBlockMask;
  /* 0x0bf8 */ struct _IRP* InvalidateBlockIoctlPf;
  /* 0x0bfc */ struct _IRP* InvalidateBlockIoctlVf;
  /* 0x0c00 */ struct _VPCI_INVALIDATE_BLOCK_OUTPUT InvalidateBlockVfParams;
  /* 0x0c08 */ struct _KEVENT InvalidateBlockEvent;
  /* 0x0c18 */ unsigned short InvalidateVfId;
  /* 0x0c1a */ unsigned char InvalidateBlockCancelling;
  /* 0x0c1c */ struct _NDIS_PF_BLOCK* PFBlock;
  /* 0x0c20 */ unsigned long NumSwitches;
  /* 0x0c24 */ struct _LIST_ENTRY NicSwitchList;
  /* 0x0c2c */ unsigned long NumAllocatedVFs;
  /* 0x0c30 */ struct _LIST_ENTRY VFList;
  /* 0x0c38 */ unsigned long NumActiveVPorts;
  /* 0x0c3c */ struct _LIST_ENTRY VPortList;
  /* 0x0c44 */ unsigned char* AllocatedVPortIndices;
  /* 0x0c48 */ unsigned long AllocatedVPortIndicesLength;
  /* 0x0c4c */ void* SetVirtualFunctionData /* function */;
  /* 0x0c50 */ void* GetVirtualFunctionData /* function */;
  /* 0x0c54 */ void* EnableVirtualization /* function */;
  /* 0x0c58 */ void* GetVirtualDeviceLocation /* function */;
  /* 0x0c5c */ void* GetVirtualFunctionProbedBars /* function */;
  /* 0x0c60 */ void* VirtInterfaceContext;
  /* 0x0c64 */ struct _UNICODE_STRING DevinterfaceVirtSymbolicLinkName;
  /* 0x0c6c */ void* VpciInterfaceDereference /* function */;
  /* 0x0c70 */ void* WriteVfConfigBlock /* function */;
  /* 0x0c74 */ void* ReadVfConfigBlock /* function */;
  /* 0x0c78 */ void* VpciInterfaceContext;
  /* 0x0c7c */ unsigned int VfSerialNumber;
  /* 0x0c80 */ struct _LUID SriovLuid;
  /* 0x0c88 */ struct NDIS_REFCOUNT_HANDLE__* RefCountTracker;
  /* 0x0c8c */ struct NDIS_REFCOUNT_HANDLE__* NsiRefCountTracker;
  /* 0x0c90 */ struct _NDIS_QOS_CAPABILITIES* QosHwCapabilities;
  /* 0x0c94 */ struct _NDIS_QOS_CAPABILITIES* QosCurrentCapabilities;
  /* 0x0c98 */ struct _NDIS_QOS_PARAMETERS* QosOperationalParameters;
  /* 0x0c9c */ unsigned long QosOperationalParametersBufferSize;
  /* 0x0ca0 */ struct _NDIS_QOS_PARAMETERS* QosRemoteParameters;
  /* 0x0ca4 */ unsigned long QosRemoteParametersBufferSize;
  /* 0x0ca8 */ unsigned __int64 DeviceFlags;
} NDIS_MINIPORT_BLOCK, *PNDIS_MINIPORT_BLOCK; /* size: 0x0cb0 */
