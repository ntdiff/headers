...
typedef struct _NDIS_FILTER_DRIVER_BLOCK
{
  ...
  /* 0x00ec */ enum _NDIS_FILTER_TYPE FilterType;
  /* 0x00f0 */ enum _NDIS_FILTER_RUN_TYPE FilterRunType;
  /* 0x00f4 */ struct _UNICODE_STRING FilterClass;
  /* 0x00fc */ struct _UNICODE_STRING ImageName;
} NDIS_FILTER_DRIVER_BLOCK, *PNDIS_FILTER_DRIVER_BLOCK; /* size: 0x0104 */
