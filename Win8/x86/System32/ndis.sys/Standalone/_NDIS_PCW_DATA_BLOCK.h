...
typedef struct _NDIS_PCW_PER_CPU_DATA_BLOCK
{
  ...
  /* 0x019c */ struct _UNICODE_STRING InstanceName;
  /* 0x01a4 */ long __PADDING__[7];
...
typedef struct _NDIS_PCW_DATA_BLOCK
{
  ...
  /* 0x00c0 */ struct _NDIS_PCW_PER_CPU_DATA_BLOCK PerCpu[1];
} NDIS_PCW_DATA_BLOCK, *PNDIS_PCW_DATA_BLOCK; /* size: 0x0280 */
