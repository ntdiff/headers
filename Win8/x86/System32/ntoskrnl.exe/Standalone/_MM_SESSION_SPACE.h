...
typedef struct _MI_SYSTEM_PTE_TYPE
{
  ...
  union
  {
    ...
    /* 0x002c */ struct _FAST_MUTEX* GlobalMutex;
  }; /* size: 0x0004 */
  /* 0x0030 */ volatile struct _MI_CACHED_PTE* CachedPtes;
...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0cec */ struct _MMSUPPORT Vm;
  /* 0x0d5c */ struct _MMWSLE* Wsle;
  /* 0x0d60 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  ...
  /* 0x1f74 */ void* PoolTrackTableExpansion;
  /* 0x1f78 */ unsigned long PoolTrackTableExpansionSize;
  /* 0x1f7c */ void* PoolTrackBigPages;
  /* 0x1f80 */ unsigned long PoolTrackBigPagesSize;
  /* 0x1f84 */ enum _IO_SESSION_STATE IoState;
  /* 0x1f88 */ unsigned long IoStateSequence;
  /* 0x1f8c */ struct _KEVENT IoNotificationEvent;
  /* 0x1f9c */ struct _RTL_BITMAP SessionPoolPdes;
  /* 0x1fa4 */ long __PADDING__[7];
