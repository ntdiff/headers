...
typedef struct _ALPC_PORT
{
  ...
  /* 0x00cc */ struct _ALPC_MESSAGE_ZONE* MessageZone;
  /* 0x00d0 */ struct _CALLBACK_OBJECT* CallbackObject;
  ...
  union // _TAG_UNNAMED_131
  {
    union
    {
      struct // _TAG_UNNAMED_132
      {
        struct /* bitfield */
        {
          /* 0x00e4 */ unsigned long Initialized : 1; /* bit position: 0 */
          /* 0x00e4 */ unsigned long Type : 2; /* bit position: 1 */
          /* 0x00e4 */ unsigned long ConnectionPending : 1; /* bit position: 3 */
          /* 0x00e4 */ unsigned long ConnectionRefused : 1; /* bit position: 4 */
          /* 0x00e4 */ unsigned long Disconnected : 1; /* bit position: 5 */
          /* 0x00e4 */ unsigned long Closed : 1; /* bit position: 6 */
          /* 0x00e4 */ unsigned long NoFlushOnClose : 1; /* bit position: 7 */
          /* 0x00e4 */ unsigned long ReturnExtendedInfo : 1; /* bit position: 8 */
          /* 0x00e4 */ unsigned long Waitable : 1; /* bit position: 9 */
          /* 0x00e4 */ unsigned long DynamicSecurity : 1; /* bit position: 10 */
          /* 0x00e4 */ unsigned long Wow64CompletionList : 1; /* bit position: 11 */
          /* 0x00e4 */ unsigned long Lpc : 1; /* bit position: 12 */
          /* 0x00e4 */ unsigned long LpcToLpc : 1; /* bit position: 13 */
          /* 0x00e4 */ unsigned long HasCompletionList : 1; /* bit position: 14 */
          /* 0x00e4 */ unsigned long HadCompletionList : 1; /* bit position: 15 */
          /* 0x00e4 */ unsigned long EnableCompletionList : 1; /* bit position: 16 */
        }; /* bitfield */
      } /* size: 0x0004 */ s1;
      /* 0x00e4 */ unsigned long State;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u1;
  /* 0x00e8 */ struct _ALPC_PORT* TargetQueuePort;
  /* 0x00ec */ struct _ALPC_PORT* TargetSequencePort;
  /* 0x00f0 */ struct _KALPC_MESSAGE* CachedMessage;
  /* 0x00f4 */ unsigned long MainQueueLength;
  /* 0x00f8 */ unsigned long LargeMessageQueueLength;
  /* 0x00fc */ unsigned long PendingQueueLength;
  /* 0x0100 */ unsigned long CanceledQueueLength;
  /* 0x0104 */ unsigned long WaitQueueLength;
} ALPC_PORT, *PALPC_PORT; /* size: 0x0108 */
