...
typedef struct _MMINPAGE_SUPPORT
{
  ...
  /* 0x000c */ struct _LIST_ENTRY ListHead;
  /* 0x0018 */ struct _KEVENT Event;
  /* 0x0028 */ struct _KEVENT CollidedEvent;
  /* 0x0038 */ struct _IO_STATUS_BLOCK IoStatus;
  /* 0x0040 */ union _LARGE_INTEGER ReadOffset;
  /* 0x0048 */ struct _MMPTE PteContents;
  /* 0x0050 */ struct _MMPFN* LockedProtoPfn;
  /* 0x0054 */ volatile long WaitCount;
  /* 0x0058 */ unsigned long ByteCount;
  union
  {
    union
    {
      /* 0x005c */ unsigned long ImagePteOffset;
      /* 0x005c */ unsigned long TossPage;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u3;
  union
  {
    union
    {
      /* 0x0060 */ struct _MMINPAGE_FLAGS e1;
      /* 0x0060 */ unsigned long LongFlags;
    }; /* size: 0x0004 */
  } /* size: 0x0004 */ u1;
  /* 0x0064 */ struct _FILE_OBJECT* FilePointer;
  /* 0x0068 */ struct _CONTROL_AREA* ControlArea;
  /* 0x006c */ void* FaultingAddress;
  /* 0x0070 */ struct _MMPTE* PointerPte;
  /* 0x0074 */ struct _MMPTE* BasePte;
  /* 0x0078 */ struct _MMPFN* Pfn;
  /* 0x007c */ struct _MDL* PrefetchMdl;
  /* 0x0080 */ struct _MDL Mdl;
  /* 0x009c */ unsigned long Page[16];
  /* 0x00dc */ long __PADDING__[1];
} MMINPAGE_SUPPORT, *PMMINPAGE_SUPPORT; /* size: 0x00e0 */
