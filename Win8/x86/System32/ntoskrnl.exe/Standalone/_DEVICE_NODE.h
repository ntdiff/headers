...
typedef struct _DEVICE_NODE
{
  ...
  /* 0x002c */ union _POWER_STATE CurrentPowerState;
  /* 0x0030 */ struct _PO_DEVICE_NOTIFY Notify;
  /* 0x006c */ struct _PO_IRP_MANAGER PoIrpManager;
  /* 0x007c */ struct _POP_FX_DEVICE* FxDevice;
  /* 0x0080 */ volatile long FxDeviceLock;
  /* 0x0084 */ struct _KEVENT FxRemoveEvent;
  /* 0x0094 */ volatile long FxActivationCount;
  /* 0x0098 */ volatile long FxSleepCount;
  /* 0x009c */ struct _POP_FX_PLUGIN* Plugin;
  ...
  /* 0x01a0 */ unsigned long DeletedChildren;
