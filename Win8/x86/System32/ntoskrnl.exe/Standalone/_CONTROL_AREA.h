...
typedef struct _CONTROL_AREA
{
  ...
  /* 0x0030 */ struct _MI_CONTROL_AREA_WAIT_BLOCK* WaitList;
  union
  {
    struct
    {
      ...
      union
      {
        ...
        struct /* bitfield */
        {
          ...
          /* 0x0038 */ unsigned long Unused : 13; /* bit position: 16 */
          /* 0x0038 */ unsigned long BitMap : 2; /* bit position: 29 */
          /* 0x0038 */ unsigned long ImageActive : 1; /* bit position: 31 */
        }; /* bitfield */
      }; /* size: 0x0004 */
      union
      {
        /* 0x003c */ struct _MM_AVL_TABLE* SubsectionRoot;
