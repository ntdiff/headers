...
typedef struct _POP_FX_PLUGIN
{
  ...
  /* 0x002c */ struct _KQUEUE WorkQueue;
  /* 0x0054 */ void* AcceptDeviceNotification /* function */;
  /* 0x0058 */ void* AcceptProcessorNotification /* function */;
  /* 0x005c */ long __PADDING__[1];
} POP_FX_PLUGIN, *PPOP_FX_PLUGIN; /* size: 0x0060 */
