...
typedef struct _MMMOD_WRITER_MDL_ENTRY
{
  ...
  /* 0x0018 */ unsigned long ByteCount;
  /* 0x001c */ struct _MMPAGING_FILE* PagingFile;
  /* 0x0020 */ struct _FILE_OBJECT* File;
  /* 0x0024 */ struct _CONTROL_AREA* ControlArea;
  /* 0x0028 */ struct _ERESOURCE* FileResource;
  /* 0x0030 */ union _LARGE_INTEGER WriteOffset;
  /* 0x0038 */ union _LARGE_INTEGER IssueTime;
  /* 0x0040 */ struct _MDL* PointerMdl;
  /* 0x0044 */ struct _MDL Mdl;
  /* 0x0060 */ unsigned long Page[1];
  /* 0x0064 */ long __PADDING__[1];
} MMMOD_WRITER_MDL_ENTRY, *PMMMOD_WRITER_MDL_ENTRY; /* size: 0x0068 */
