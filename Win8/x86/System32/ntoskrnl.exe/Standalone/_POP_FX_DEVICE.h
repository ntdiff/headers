...
typedef struct _POP_FX_DEVICE
{
  ...
  /* 0x0008 */ struct _POP_FX_PLUGIN* Plugin;
  /* 0x000c */ struct PEPHANDLE__* PluginHandle;
  /* 0x0010 */ struct _POP_FX_PLUGIN* MiniPlugin;
  /* 0x0014 */ struct PEPHANDLE__* MiniPluginHandle;
  /* 0x0018 */ struct _DEVICE_NODE* DevNode;
  /* 0x001c */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0020 */ struct _DEVICE_OBJECT* TargetDevice;
  /* 0x0024 */ struct _POP_FX_DRIVER_CALLBACKS Callbacks;
  /* 0x0040 */ void* DriverContext;
  /* 0x0044 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x005c */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x0070 */ volatile union _POP_FX_DEVICE_STATUS Status;
  /* 0x0074 */ volatile long PowerReqCall;
  /* 0x0078 */ volatile long PowerNotReqCall;
  /* 0x007c */ unsigned long IdleLock;
  /* 0x0080 */ struct _KTIMER IdleTimer;
  /* 0x00a8 */ struct _KDPC IdleDpc;
  /* 0x00c8 */ unsigned __int64 IdleTimeout;
  /* 0x00d0 */ unsigned __int64 IdleStamp;
  /* 0x00d8 */ struct _IRP* Irp;
  /* 0x00dc */ struct _POP_IRP_DATA* IrpData;
  /* 0x00e0 */ struct _DEVICE_OBJECT* NextIrpDeviceObject;
  /* 0x00e4 */ union _POWER_STATE NextIrpPowerState;
  /* 0x00e8 */ void* NextIrpCallerCompletion /* function */;
  /* 0x00ec */ void* NextIrpCallerContext;
  /* 0x00f0 */ struct _KEVENT IrpCompleteEvent;
  /* 0x0100 */ unsigned long ComponentCount;
  /* 0x0104 */ struct _POP_FX_COMPONENT* Components[1];
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x0108 */
