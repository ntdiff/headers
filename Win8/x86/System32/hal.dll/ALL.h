...
typedef struct _ADAPTER_OBJECT
{
  ...
  /* 0x0058 */ unsigned long LibraryVersion;
  /* 0x005c */ struct _HALP_DMA_MASTER_ADAPTER_OBJECT* MasterAdapter;
  /* 0x0060 */ struct _LIST_ENTRY WaitQueueEntry;
  union
  {
    /* 0x0068 */ struct _KDEVICE_QUEUE ChannelWaitQueue;
    struct
    {
      /* 0x0068 */ unsigned long ResourceWaitLock;
      /* 0x006c */ struct _LIST_ENTRY ResourceWaitQueue;
      /* 0x0074 */ struct _LIST_ENTRY ChannelResourceWaitQueue;
    }; /* size: 0x0014 */
  }; /* size: 0x0014 */
  /* 0x007c */ unsigned char ResourceQueueBusy;
  /* 0x007d */ char Padding_7[3];
  /* 0x0080 */ unsigned long MapRegistersPerChannel;
  /* 0x0084 */ void* MapRegisterBase;
  /* 0x0088 */ unsigned long NumberOfMapRegisters;
  ...
  /* 0x0114 */ long Padding_10;
  /* 0x0118 */ union _LARGE_INTEGER DeviceAddress;
  /* 0x0120 */ struct _LIST_ENTRY AdapterList;
  /* 0x0128 */ struct _WORK_QUEUE_ITEM WorkItem;
  /* 0x0138 */ struct _MDL* ScatterGatherMdl;
  /* 0x013c */ unsigned long ScatterGatherBufferLength;
  /* 0x0140 */ struct _SCATTER_GATHER_LIST ScatterGatherBuffer;
} ADAPTER_OBJECT, *PADAPTER_OBJECT; /* size: 0x0148 */
...
} INTERRUPT_FUNCTION_TABLE, *PINTERRUPT_FUNCTION_TABLE; /* size: 0x0050 */
...
typedef struct _REGISTERED_INTERRUPT_CONTROLLER
{
  ...
  /* 0x0060 */ enum _KNOWN_CONTROLLER_TYPE KnownType;
  /* 0x0064 */ unsigned long Capabilities;
  /* 0x0068 */ unsigned long Flags;
  /* 0x006c */ unsigned long MaxPriority;
  /* 0x0070 */ unsigned long UnitId;
  /* 0x0074 */ struct _LIST_ENTRY LinesHead;
  /* 0x007c */ struct _LIST_ENTRY OutputLinesHead;
  /* 0x0084 */ long MinLine;
  /* 0x0088 */ long MaxLine;
  /* 0x008c */ unsigned long MaxClusterSize;
  /* 0x0090 */ unsigned long MaxClusters;
  /* 0x0094 */ unsigned long InterruptReplayDataSize;
  /* 0x0098 */ enum _INTERRUPT_PROBLEM Problem;
  /* 0x009c */ long ProblemStatus;
  /* 0x00a0 */ const char* ProblemSourceFile;
  /* 0x00a4 */ unsigned long ProblemSourceLine;
  /* 0x00a8 */ unsigned long CustomProblem;
  /* 0x00ac */ long CustomProblemStatus;
  /* 0x00b0 */ struct _UNICODE_STRING ResourceId;
  /* 0x00b8 */ struct POHANDLE__* PowerHandle;
} REGISTERED_INTERRUPT_CONTROLLER, *PREGISTERED_INTERRUPT_CONTROLLER; /* size: 0x00bc */
...
} DMA_OPERATIONS, *PDMA_OPERATIONS; /* size: 0x0074 */
...
@HalpIoDelay@0
@HalpPerfInterruptInternal@8
@HalpSetup440BXWorkaround@0
@HalpTimerClockInterruptCommon@8
@HalpTimerClockInterruptStubCommon@8
@HalpTimerProfileInterruptCommon@8
@KfLowerIrql@4
@KfRaiseIrql@4
@RDMSR@4
...
_Amd64ConfigureCounter@16
_Amd64DisableMonitoring@8
_Amd64EnableMonitoring@12
_Amd64FreeCounter@4
_Amd64GetProfileDescriptor@8
...
_EmonAllocateCounter@12
_EmonConfigureCounter@16
_EmonDisableMonitoring@8
_EmonEnableMonitoring@12
_EmonFreeCounter@4
_EmonGetProfileDescriptor@8
...
_GetPdeAddressEx@8
_GetPteAddress@8
_GsIsReadTimeStampCounterAvailable@0
...
_HalAllocateCommonBufferEx@24
_HalAllocateCommonBufferV2@16
...
_HalProcessorIdle@0
_HalPutDmaAdapter@4
_HalPutDmaAdapterV2@4
_HalPutDmaAdapterV3@4
...
_HalpAllocateAdapterChannel@20
...
_HalpCalculateDivisorRate@28
_HalpCalculateScatterGatherListSize@28
_HalpCalculateTickCount@24
...
_HalpDiagInitDiscard@4
_HalpDiagInitSystem@12
_HalpDiagLogClockModeSwitch@12
_HalpDiagRegisterLogRoutine@4
...
_HalpDmaAllocateChildAdapterV3@40
...
_HalpDmaCommitContiguousMapBuffers@16
_HalpDmaCommitScatterMapBuffers@20
...
_HalpDmaFreeChildAdapterWorker@4
...
_HalpHpetLosslessRateChange@12
_HalpHpetQueryCounter@4
_HalpHpetSetMessageInterruptRouting@20
_HalpHpetStop@4
...
_HalpHvEpWritebackInvalidate@8
...
_HalpHvMapIoApicDeviceInterrupt@8
...
_HalpInitializeInterruptRemappingBspEarly@4
...
_HalpInterruptGetHighestPriorityInterrupt@16
_HalpInterruptGetLocalIdentifier@8
...
_HalpInterruptMarkProcessorStarted@8
...
_HalpInterruptRegisterController@8
...
_HalpInterruptRemapFixedLines@0
...
_HalpInvokeIsrForGsiv@8
_HalpIrtAllocateIndex@8
_HalpIrtFreeIndex@8
...
_HalpOpenDeviceClassRegistryKey@12
...
_HalpPciGetBusMasterDescriptor@12
_HalpPciGetSegmentCount@0
_HalpPciInitSystem@12
_HalpPciInitializeMmConfigAccess@0
_HalpPciLookupSpecialRid@24
...
_HalpProcessEsrtStartDevice@4
_HalpProcessSecondarySignalList@16
_HalpProcessUefiStartDevice@4
_HalpProgramDrhd@0
...
_HalpStopXhciInterrupt@8
_HalpStoreFreeCr3@8
_HalpTimerActivateClock@0
...
_HalpTimerClockInterrupt@0
_HalpTimerClockInterruptStub@0
_HalpTimerClockInterruptWork@0
...
_HalpTimerDisableDynamicTick@4
...
_HalpTimerFindIdealScalingSource@0
_HalpTimerGetClockConfiguration@12
_HalpTimerGetClockOwner@0
_HalpTimerGetNextTickDuration@24
_HalpTimerGetProfilingHandler@0
_HalpTimerGetProfilingTarget@0
...
_HalpTimerLogDynamicTickStatus@0
...
_HalpTimerNotifyProcessorFreeze@4
...
_HalpTimerPrepareProcessorForIdle@12
_HalpTimerProfileInterrupt@0
_HalpTimerProfileInterruptWork@8
...
_HalpTimerResumeClock@0
_HalpTimerResumeClockPn@0
_HalpTimerResumePeriodicTick@8
_HalpTimerResumeProcessorFromIdle@4
_HalpTimerSavePerformanceCounter@0
_HalpTimerSaveProcessorCounter@0
...
_HalpTimerSpecificConstraintsMet@8
...
_HalpWheaNativeWritebackInvalidate@8
...
_HalpX86DmaControllerInterruptRoutine@0
_HalpX86InterruptIpiService@0
_HalpX86InterruptLocalErrorService@0
_HalpX86InterruptRebootService@0
_HalpX86InterruptSpuriousService@0
_HalpX86InterruptStubService@0
