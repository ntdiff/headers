...
typedef struct _HEAP_SUBSEGMENT
{
  ...
  /* 0x0038 */ volatile unsigned long Lock;
  /* 0x003c */ long __PADDING__[1];
...
typedef struct _LFH_HEAP
{
  ...
  /* 0x0048 */ unsigned __int64 SizeInCache;
  /* 0x0050 */ volatile union _HEAP_BUCKET_RUN_INFO RunInfo;
  /* 0x0058 */ long Padding_189[2];
  /* 0x0060 */ struct _USER_MEMORY_CACHE_ENTRY UserBlockCache[12];
  /* 0x02a0 */ struct _HEAP_BUCKET Buckets[129];
  /* 0x04a4 */ long Padding_190;
...
typedef struct _HEAP_USERDATA_HEADER
{
  ...
  /* 0x0018 */ unsigned short FirstAllocationOffset;
  /* 0x001a */ unsigned short BlockStride;
