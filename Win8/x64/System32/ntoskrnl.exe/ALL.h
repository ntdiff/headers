...
typedef struct _MMPTE_SOFTWARE
{
  struct /* bitfield */
  {
    ...
    /* 0x0000 */ unsigned __int64 DbgCrc : 7; /* bit position: 25 */
...
typedef struct _KSCB
{
  ...
  /* 0x0040 */ struct _RTL_BALANCED_NODE QueueNode;
  struct /* bitfield */
  {
    /* 0x0058 */ unsigned char Inserted : 1; /* bit position: 0 */
    /* 0x0058 */ unsigned char OverQuota : 1; /* bit position: 1 */
    /* 0x0058 */ unsigned char HardCap : 1; /* bit position: 2 */
    /* 0x0058 */ unsigned char RankBias : 1; /* bit position: 3 */
    /* 0x0058 */ unsigned char Spare1 : 4; /* bit position: 4 */
  }; /* bitfield */
  /* 0x0059 */ unsigned char Spare2;
  /* 0x005a */ unsigned short ReadySummary;
  /* 0x005c */ unsigned long Rank;
  /* 0x0060 */ struct _LIST_ENTRY ReadyListHead[16];
} KSCB, *PKSCB; /* size: 0x0160 */
...
typedef struct _POP_FX_PLUGIN
{
  ...
  /* 0x0020 */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x0048 */ struct _KQUEUE WorkQueue;
  /* 0x0088 */ void* AcceptDeviceNotification /* function */;
  /* 0x0090 */ void* AcceptProcessorNotification /* function */;
} POP_FX_PLUGIN, *PPOP_FX_PLUGIN; /* size: 0x0098 */
...
typedef struct _TOKEN
{
  ...
  /* 0x0450 */ unsigned __int64 VariablePart;
} TOKEN, *PTOKEN; /* size: 0x0458 */
...
typedef struct _EJOB
{
  ...
  /* 0x03a0 */ struct _JOBOBJECT_WAKE_FILTER WakeFilter;
  /* 0x03a8 */ unsigned long LowEdgeLatchFilter;
  /* 0x03ac */ unsigned long OwnedHighEdgeFilters;
  /* 0x03b0 */ struct _EJOB* NotificationLink;
  /* 0x03b8 */ unsigned __int64 CurrentJobMemoryUsed;
  /* 0x03c0 */ struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
  /* 0x03c8 */ void* NotificationInfoQuotaReference;
  /* 0x03d0 */ struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
  /* 0x03d8 */ struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
  /* 0x03e0 */ void* EffectiveSchedulingGroup;
  /* 0x03e8 */ struct _EX_PUSH_LOCK MemoryLimitsLock;
  /* 0x03f0 */ struct _LIST_ENTRY SiblingJobLinks;
  /* 0x0400 */ struct _LIST_ENTRY ChildJobListHead;
  /* 0x0410 */ struct _EJOB* ParentJob;
  /* 0x0418 */ struct _EJOB* volatile RootJob;
  /* 0x0420 */ struct _LIST_ENTRY IteratorListHead;
  /* 0x0430 */ struct _EPROCESS_VALUES Accounting;
  /* 0x0480 */ unsigned long ShadowActiveProcessCount;
  /* 0x0484 */ unsigned long SequenceNumber;
  /* 0x0488 */ unsigned __int64 TimerListLock;
  /* 0x0490 */ struct _LIST_ENTRY TimerListHead;
  union
  {
    /* 0x04a0 */ unsigned long JobFlags;
    struct /* bitfield */
    {
      /* 0x04a0 */ unsigned long CloseDone : 1; /* bit position: 0 */
      /* 0x04a0 */ unsigned long MultiGroup : 1; /* bit position: 1 */
      /* 0x04a0 */ unsigned long OutstandingNotification : 1; /* bit position: 2 */
      /* 0x04a0 */ unsigned long NotificationInProgress : 1; /* bit position: 3 */
      /* 0x04a0 */ unsigned long UILimits : 1; /* bit position: 4 */
      /* 0x04a0 */ unsigned long CpuRateControlActive : 1; /* bit position: 5 */
      /* 0x04a0 */ unsigned long OwnCpuRateControl : 1; /* bit position: 6 */
      /* 0x04a0 */ unsigned long Terminating : 1; /* bit position: 7 */
      /* 0x04a0 */ unsigned long WorkingSetLock : 1; /* bit position: 8 */
      /* 0x04a0 */ unsigned long JobFrozen : 1; /* bit position: 9 */
      /* 0x04a0 */ unsigned long Background : 1; /* bit position: 10 */
      /* 0x04a0 */ unsigned long WakeNotificationAllocated : 1; /* bit position: 11 */
      /* 0x04a0 */ unsigned long WakeNotificationEnabled : 1; /* bit position: 12 */
      /* 0x04a0 */ unsigned long WakeNotificationPending : 1; /* bit position: 13 */
      /* 0x04a0 */ unsigned long LimitNotificationRequired : 1; /* bit position: 14 */
      /* 0x04a0 */ unsigned long ZeroCountNotificationRequired : 1; /* bit position: 15 */
      /* 0x04a0 */ unsigned long CycleTimeNotificationRequired : 1; /* bit position: 16 */
      /* 0x04a0 */ unsigned long CycleTimeNotificationPending : 1; /* bit position: 17 */
      /* 0x04a0 */ unsigned long TimersVirtualized : 1; /* bit position: 18 */
      /* 0x04a0 */ unsigned long JobSwapped : 1; /* bit position: 19 */
      /* 0x04a0 */ unsigned long ViolationDetected : 1; /* bit position: 20 */
      /* 0x04a0 */ unsigned long EmptyJobNotified : 1; /* bit position: 21 */
      /* 0x04a0 */ unsigned long NoSystemCharge : 1; /* bit position: 22 */
      /* 0x04a0 */ unsigned long SpareJobFlags : 9; /* bit position: 23 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x04a4 */ unsigned long EffectiveHighEdgeFilters;
} EJOB, *PEJOB; /* size: 0x04a8 */
...
} DRIVER_EXTENSION, *PDRIVER_EXTENSION; /* size: 0x0048 */
...
typedef struct _TEB64
{
  ...
  /* 0x1250 */ unsigned long LastStatusValue;
  /* 0x1254 */ long Padding_156;
  /* 0x1258 */ struct _STRING64 StaticUnicodeString;
  /* 0x1268 */ wchar_t StaticUnicodeBuffer[261];
  /* 0x1472 */ char Padding_157[6];
...
typedef struct _IOP_IRP_EXTENSION
{
  union
  {
    ...
    struct /* bitfield */
    {
      ...
      /* 0x0000 */ unsigned short SpareBits : 5; /* bit position: 3 */
    }; /* bitfield */
  }; /* size: 0x0002 */
  /* 0x0002 */ unsigned short TypesAllocated;
  /* 0x0004 */ struct _GUID ActivityId;
  /* 0x0014 */ long Padding_207;
  /* 0x0018 */ union _LARGE_INTEGER Timestamp;
} IOP_IRP_EXTENSION, *PIOP_IRP_EXTENSION; /* size: 0x0020 */
  ...
  union // _TAG_UNNAMED_76
  {
    union
    {
      struct // _TAG_UNNAMED_77
      {
        struct /* bitfield */
        {
          /* 0x0184 */ unsigned long Initialized : 1; /* bit position: 0 */
          /* 0x0184 */ unsigned long Type : 2; /* bit position: 1 */
          /* 0x0184 */ unsigned long ConnectionPending : 1; /* bit position: 3 */
          /* 0x0184 */ unsigned long ConnectionRefused : 1; /* bit position: 4 */
          /* 0x0184 */ unsigned long Disconnected : 1; /* bit position: 5 */
          /* 0x0184 */ unsigned long Closed : 1; /* bit position: 6 */
          /* 0x0184 */ unsigned long NoFlushOnClose : 1; /* bit position: 7 */
          /* 0x0184 */ unsigned long ReturnExtendedInfo : 1; /* bit position: 8 */
          /* 0x0184 */ unsigned long Waitable : 1; /* bit position: 9 */
          /* 0x0184 */ unsigned long DynamicSecurity : 1; /* bit position: 10 */
          /* 0x0184 */ unsigned long Wow64CompletionList : 1; /* bit position: 11 */
          /* 0x0184 */ unsigned long Lpc : 1; /* bit position: 12 */
          /* 0x0184 */ unsigned long LpcToLpc : 1; /* bit position: 13 */
          /* 0x0184 */ unsigned long HasCompletionList : 1; /* bit position: 14 */
          /* 0x0184 */ unsigned long HadCompletionList : 1; /* bit position: 15 */
          /* 0x0184 */ unsigned long EnableCompletionList : 1; /* bit position: 16 */
        }; /* bitfield */
      } /* size: 0x0004 */ s1;
...
} ALPC_PORT, *PALPC_PORT; /* size: 0x01b8 */
  ...
  union // _TAG_UNNAMED_133
  {
    union
    {
      struct /* bitfield */
      {
        ...
        /* 0x0028 */ unsigned __int64 Unused : 16; /* bit position: 38 */
        /* 0x0028 */ unsigned __int64 PfnExists : 1; /* bit position: 54 */
        /* 0x0028 */ unsigned __int64 PageIdentity : 2; /* bit position: 55 */
...
} FSRTL_ADVANCED_FCB_HEADER, *PFSRTL_ADVANCED_FCB_HEADER; /* size: 0x0060 */
...
typedef struct _MI_SYSTEM_PTE_TYPE
{
  ...
  union
  {
    ...
    /* 0x0040 */ struct _FAST_MUTEX* GlobalMutex;
  }; /* size: 0x0008 */
  /* 0x0048 */ volatile struct _MI_CACHED_PTE* CachedPtes;
} MI_SYSTEM_PTE_TYPE, *PMI_SYSTEM_PTE_TYPE; /* size: 0x0050 */
    ...
    struct // _TAG_UNNAMED_136
    {
      ...
      union
      {
        ...
        struct /* bitfield */
        {
          ...
          /* 0x005c */ unsigned long Unused : 13; /* bit position: 16 */
      ...
      union
      {
        /* 0x0060 */ struct _MM_AVL_TABLE* SubsectionRoot;
...
typedef struct _ETW_GUID_ENTRY
{
  ...
  /* 0x0170 */ struct _EVENT_FILTER_HEADER** FilterData;
...
typedef struct _SEP_LOGON_SESSION_REFERENCES
{
  ...
  /* 0x0050 */ struct _SEP_LOWBOX_HANDLES_TABLE LowBoxHandlesTable;
} SEP_LOGON_SESSION_REFERENCES, *PSEP_LOGON_SESSION_REFERENCES; /* size: 0x0060 */
...
typedef struct _DEVICE_NODE
{
  ...
  /* 0x0054 */ union _POWER_STATE CurrentPowerState;
  /* 0x0058 */ struct _PO_DEVICE_NOTIFY Notify;
  /* 0x00c0 */ struct _PO_IRP_MANAGER PoIrpManager;
  /* 0x00e0 */ struct _POP_FX_DEVICE* FxDevice;
  /* 0x00e8 */ volatile long FxDeviceLock;
  /* 0x00ec */ long Padding_299;
  /* 0x00f0 */ struct _KEVENT FxRemoveEvent;
  /* 0x0108 */ volatile long FxActivationCount;
  /* 0x010c */ volatile long FxSleepCount;
  /* 0x0110 */ struct _POP_FX_PLUGIN* Plugin;
...
{
  /* 0x0000 */ struct _LIST_ENTRY Link;
  /* 0x0010 */ struct _POP_FX_PLUGIN* Plugin;
  /* 0x0018 */ struct PEPHANDLE__* PluginHandle;
  /* 0x0020 */ struct _POP_FX_PLUGIN* MiniPlugin;
  /* 0x0028 */ struct PEPHANDLE__* MiniPluginHandle;
  /* 0x0030 */ struct _DEVICE_NODE* DevNode;
  /* 0x0038 */ struct _DEVICE_OBJECT* DeviceObject;
  /* 0x0040 */ struct _DEVICE_OBJECT* TargetDevice;
  /* 0x0048 */ struct _POP_FX_DRIVER_CALLBACKS Callbacks;
  /* 0x0080 */ void* DriverContext;
  /* 0x0088 */ struct _IO_REMOVE_LOCK RemoveLock;
  /* 0x00a8 */ struct _POP_FX_WORK_ORDER WorkOrder;
  /* 0x00d0 */ volatile union _POP_FX_DEVICE_STATUS Status;
  /* 0x00d4 */ volatile long PowerReqCall;
  /* 0x00d8 */ volatile long PowerNotReqCall;
  /* 0x00dc */ long Padding_311;
  /* 0x00e0 */ unsigned __int64 IdleLock;
  /* 0x00e8 */ struct _KTIMER IdleTimer;
  /* 0x0128 */ struct _KDPC IdleDpc;
  /* 0x0168 */ unsigned __int64 IdleTimeout;
  /* 0x0170 */ unsigned __int64 IdleStamp;
  /* 0x0178 */ struct _IRP* Irp;
  /* 0x0180 */ struct _POP_IRP_DATA* IrpData;
  /* 0x0188 */ struct _DEVICE_OBJECT* NextIrpDeviceObject;
  /* 0x0190 */ union _POWER_STATE NextIrpPowerState;
  /* 0x0194 */ long Padding_312;
  /* 0x0198 */ void* NextIrpCallerCompletion /* function */;
  /* 0x01a0 */ void* NextIrpCallerContext;
  /* 0x01a8 */ struct _KEVENT IrpCompleteEvent;
  /* 0x01c0 */ unsigned long ComponentCount;
  /* 0x01c4 */ long Padding_313;
  /* 0x01c8 */ struct _POP_FX_COMPONENT* Components[1];
} POP_FX_DEVICE, *PPOP_FX_DEVICE; /* size: 0x01d0 */
...
typedef struct _KALPC_MESSAGE
{
  ...
  /* 0x00a8 */ void* DataSystemVa;
  /* 0x00b0 */ struct _ALPC_COMMUNICATION_INFO* CommunicationInfo;
  /* 0x00b8 */ struct _ALPC_PORT* ConnectionPort;
  /* 0x00c0 */ struct _ETHREAD* ServerThread;
  /* 0x00c8 */ void* WakeReference;
  /* 0x00d0 */ void* ExtensionBuffer;
  /* 0x00d8 */ unsigned __int64 ExtensionBufferSize;
...
typedef struct _HIVE_WAIT_PACKET
{
  ...
  /* 0x0028 */ unsigned char PrimaryFileWritten;
  /* 0x0029 */ char __PADDING__[7];
} HIVE_WAIT_PACKET, *PHIVE_WAIT_PACKET; /* size: 0x0030 */
...
typedef struct _MMINPAGE_FLAGS
{
  ...
  struct /* bitfield */
  {
    ...
    /* 0x0003 */ unsigned char Spare1 : 2; /* bit position: 6 */
  }; /* bitfield */
...
typedef struct _MMINPAGE_SUPPORT
{
  ...
  /* 0x0028 */ struct _KEVENT Event;
  /* 0x0040 */ struct _KEVENT CollidedEvent;
  /* 0x0058 */ struct _IO_STATUS_BLOCK IoStatus;
  /* 0x0068 */ union _LARGE_INTEGER ReadOffset;
  /* 0x0070 */ struct _MMPTE PteContents;
  ...
  /* 0x00a0 */ void* FaultingAddress;
  /* 0x00a8 */ struct _MMPTE* PointerPte;
  /* 0x00b0 */ struct _MMPTE* BasePte;
  /* 0x00b8 */ struct _MMPFN* Pfn;
  /* 0x00c0 */ struct _MDL* PrefetchMdl;
  /* 0x00c8 */ struct _MDL Mdl;
  /* 0x00f8 */ unsigned __int64 Page[16];
} MMINPAGE_SUPPORT, *PMMINPAGE_SUPPORT; /* size: 0x0178 */
...
typedef struct _POP_POWER_ACTION
{
  ...
  /* 0x005c */ long Padding_408;
  /* 0x0060 */ struct // _TAG_UNNAMED_180
  {
...
typedef struct _MM_PAGED_POOL_INFO
{
  ...
  /* 0x0054 */ long Padding_432;
  /* 0x0058 */ unsigned __int64 AllocatedPagedPool;
} MM_PAGED_POOL_INFO, *PMM_PAGED_POOL_INFO; /* size: 0x0060 */
...
typedef struct _MM_SESSION_SPACE
{
  ...
  /* 0x0bf8 */ struct _MMSUPPORT Vm;
  /* 0x0c88 */ struct _MMWSLE* Wsle;
  /* 0x0c90 */ struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;
  /* 0x0c98 */ long Padding_434[10];
  /* 0x0cc0 */ struct _POOL_DESCRIPTOR PagedPool;
  /* 0x1e00 */ struct _MMPTE PageDirectory;
  /* 0x1e08 */ struct _FAST_MUTEX SessionVaLock;
  /* 0x1e40 */ struct _RTL_BITMAP DynamicVaBitMap;
  /* 0x1e50 */ unsigned long DynamicVaHint;
  /* 0x1e54 */ long Padding_435;
  /* 0x1e58 */ struct _MI_SPECIAL_POOL SpecialPool;
  /* 0x1ea8 */ struct _FAST_MUTEX SessionPteLock;
  /* 0x1ee0 */ long PoolBigEntriesInUse;
  /* 0x1ee4 */ unsigned long PagedPoolPdeCount;
  /* 0x1ee8 */ unsigned long SpecialPoolPdeCount;
  /* 0x1eec */ unsigned long DynamicSessionPdeCount;
  /* 0x1ef0 */ struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;
  /* 0x1f40 */ void* PoolTrackTableExpansion;
  /* 0x1f48 */ unsigned __int64 PoolTrackTableExpansionSize;
  /* 0x1f50 */ void* PoolTrackBigPages;
  /* 0x1f58 */ unsigned __int64 PoolTrackBigPagesSize;
  /* 0x1f60 */ enum _IO_SESSION_STATE IoState;
  /* 0x1f64 */ unsigned long IoStateSequence;
  /* 0x1f68 */ struct _KEVENT IoNotificationEvent;
...
typedef struct _MSUBSECTION
{
  ...
  /* 0x002c */ unsigned long StartingSector;
  /* 0x0030 */ unsigned long NumberOfFullSectors;
  /* 0x0034 */ long Padding_438;
  /* 0x0038 */ struct _MM_AVL_NODE SubsectionNode;
