...
typedef struct _KNODE
{
  ...
  /* 0x00a8 */ long Padding_4[22];
  /* 0x0100 */ unsigned long SiblingMask;
  /* 0x0104 */ long Padding_5;
  union
  {
...
typedef struct _KTHREAD
{
  ...
  /* 0x0620 */ unsigned __int64 KernelWaitTime;
  /* 0x0628 */ unsigned __int64 UserWaitTime;
} KTHREAD, *PKTHREAD; /* size: 0x0630 */
...
typedef struct _KPROCESS
{
  ...
  /* 0x01cc */ unsigned short ThreadSeed[20];
  /* 0x01f4 */ unsigned short IdealProcessor[20];
  /* 0x021c */ unsigned short IdealNode[20];
  /* 0x0244 */ unsigned short IdealGlobalNode;
  /* 0x0246 */ char Padding_98[2];
  /* 0x0248 */ volatile union _KSTACK_COUNT StackCount;
  /* 0x024c */ long Padding_99;
  ...
  /* 0x0298 */ unsigned __int64 KernelWaitTime;
  /* 0x02a0 */ unsigned __int64 UserWaitTime;
} KPROCESS, *PKPROCESS; /* size: 0x02a8 */
...
typedef struct _EPROCESS
{
  ...
  /* 0x02a8 */ struct _EX_PUSH_LOCK ProcessLock;
  /* 0x02b0 */ void* UniqueProcessId;
  /* 0x02b8 */ struct _LIST_ENTRY ActiveProcessLinks;
  /* 0x02c8 */ struct _EX_RUNDOWN_REF RundownProtect;
  union
  {
    /* 0x02d0 */ unsigned long Flags2;
    struct /* bitfield */
    {
      /* 0x02d0 */ unsigned long JobNotReallyActive : 1; /* bit position: 0 */
      /* 0x02d0 */ unsigned long AccountingFolded : 1; /* bit position: 1 */
      /* 0x02d0 */ unsigned long NewProcessReported : 1; /* bit position: 2 */
      /* 0x02d0 */ unsigned long ExitProcessReported : 1; /* bit position: 3 */
      /* 0x02d0 */ unsigned long ReportCommitChanges : 1; /* bit position: 4 */
      /* 0x02d0 */ unsigned long LastReportMemory : 1; /* bit position: 5 */
      /* 0x02d0 */ unsigned long ForceWakeCharge : 1; /* bit position: 6 */
      /* 0x02d0 */ unsigned long CrossSessionCreate : 1; /* bit position: 7 */
      /* 0x02d0 */ unsigned long NeedsHandleRundown : 1; /* bit position: 8 */
      /* 0x02d0 */ unsigned long RefTraceEnabled : 1; /* bit position: 9 */
      /* 0x02d0 */ unsigned long PicoCreated : 1; /* bit position: 10 */
      /* 0x02d0 */ unsigned long EmptyJobEvaluated : 1; /* bit position: 11 */
      /* 0x02d0 */ unsigned long DefaultPagePriority : 3; /* bit position: 12 */
      /* 0x02d0 */ unsigned long PrimaryTokenFrozen : 1; /* bit position: 15 */
      /* 0x02d0 */ unsigned long ProcessVerifierTarget : 1; /* bit position: 16 */
      /* 0x02d0 */ unsigned long RestrictSetThreadContext : 1; /* bit position: 17 */
      /* 0x02d0 */ unsigned long AffinityPermanent : 1; /* bit position: 18 */
      /* 0x02d0 */ unsigned long AffinityUpdateEnable : 1; /* bit position: 19 */
      /* 0x02d0 */ unsigned long PropagateNode : 1; /* bit position: 20 */
      /* 0x02d0 */ unsigned long ExplicitAffinity : 1; /* bit position: 21 */
      /* 0x02d0 */ unsigned long ProcessExecutionState : 2; /* bit position: 22 */
      /* 0x02d0 */ unsigned long EnableReadVmLogging : 1; /* bit position: 24 */
      /* 0x02d0 */ unsigned long EnableWriteVmLogging : 1; /* bit position: 25 */
      /* 0x02d0 */ unsigned long FatalAccessTerminationRequested : 1; /* bit position: 26 */
      /* 0x02d0 */ unsigned long DisableSystemAllowedCpuSet : 1; /* bit position: 27 */
      /* 0x02d0 */ unsigned long ProcessStateChangeRequest : 2; /* bit position: 28 */
      /* 0x02d0 */ unsigned long ProcessStateChangeInProgress : 1; /* bit position: 30 */
      /* 0x02d0 */ unsigned long InPrivate : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x02d4 */ unsigned long Flags;
    struct /* bitfield */
    {
      /* 0x02d4 */ unsigned long CreateReported : 1; /* bit position: 0 */
      /* 0x02d4 */ unsigned long NoDebugInherit : 1; /* bit position: 1 */
      /* 0x02d4 */ unsigned long ProcessExiting : 1; /* bit position: 2 */
      /* 0x02d4 */ unsigned long ProcessDelete : 1; /* bit position: 3 */
      /* 0x02d4 */ unsigned long ManageExecutableMemoryWrites : 1; /* bit position: 4 */
      /* 0x02d4 */ unsigned long VmDeleted : 1; /* bit position: 5 */
      /* 0x02d4 */ unsigned long OutswapEnabled : 1; /* bit position: 6 */
      /* 0x02d4 */ unsigned long Outswapped : 1; /* bit position: 7 */
      /* 0x02d4 */ unsigned long FailFastOnCommitFail : 1; /* bit position: 8 */
      /* 0x02d4 */ unsigned long Wow64VaSpace4Gb : 1; /* bit position: 9 */
      /* 0x02d4 */ unsigned long AddressSpaceInitialized : 2; /* bit position: 10 */
      /* 0x02d4 */ unsigned long SetTimerResolution : 1; /* bit position: 12 */
      /* 0x02d4 */ unsigned long BreakOnTermination : 1; /* bit position: 13 */
      /* 0x02d4 */ unsigned long DeprioritizeViews : 1; /* bit position: 14 */
      /* 0x02d4 */ unsigned long WriteWatch : 1; /* bit position: 15 */
      /* 0x02d4 */ unsigned long ProcessInSession : 1; /* bit position: 16 */
      /* 0x02d4 */ unsigned long OverrideAddressSpace : 1; /* bit position: 17 */
      /* 0x02d4 */ unsigned long HasAddressSpace : 1; /* bit position: 18 */
      /* 0x02d4 */ unsigned long LaunchPrefetched : 1; /* bit position: 19 */
      /* 0x02d4 */ unsigned long Background : 1; /* bit position: 20 */
      /* 0x02d4 */ unsigned long VmTopDown : 1; /* bit position: 21 */
      /* 0x02d4 */ unsigned long ImageNotifyDone : 1; /* bit position: 22 */
      /* 0x02d4 */ unsigned long PdeUpdateNeeded : 1; /* bit position: 23 */
      /* 0x02d4 */ unsigned long VdmAllowed : 1; /* bit position: 24 */
      /* 0x02d4 */ unsigned long ProcessRundown : 1; /* bit position: 25 */
      /* 0x02d4 */ unsigned long ProcessInserted : 1; /* bit position: 26 */
      /* 0x02d4 */ unsigned long DefaultIoPriority : 3; /* bit position: 27 */
      /* 0x02d4 */ unsigned long ProcessSelfDelete : 1; /* bit position: 30 */
      /* 0x02d4 */ unsigned long SetTimerResolutionLink : 1; /* bit position: 31 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  /* 0x02d8 */ union _LARGE_INTEGER CreateTime;
  /* 0x02e0 */ unsigned __int64 ProcessQuotaUsage[2];
  /* 0x02f0 */ unsigned __int64 ProcessQuotaPeak[2];
  /* 0x0300 */ unsigned __int64 PeakVirtualSize;
  /* 0x0308 */ unsigned __int64 VirtualSize;
  /* 0x0310 */ struct _LIST_ENTRY SessionProcessLinks;
  union
  {
    /* 0x0320 */ void* ExceptionPortData;
    /* 0x0320 */ unsigned __int64 ExceptionPortValue;
    /* 0x0320 */ unsigned __int64 ExceptionPortState : 3; /* bit position: 0 */
  }; /* size: 0x0008 */
  /* 0x0328 */ struct _EX_FAST_REF Token;
  /* 0x0330 */ unsigned __int64 MmReserved;
  /* 0x0338 */ struct _EX_PUSH_LOCK AddressCreationLock;
  /* 0x0340 */ struct _EX_PUSH_LOCK PageTableCommitmentLock;
  /* 0x0348 */ struct _ETHREAD* RotateInProgress;
  /* 0x0350 */ struct _ETHREAD* ForkInProgress;
  /* 0x0358 */ struct _EJOB* volatile CommitChargeJob;
  /* 0x0360 */ struct _RTL_AVL_TREE CloneRoot;
  /* 0x0368 */ volatile unsigned __int64 NumberOfPrivatePages;
  /* 0x0370 */ volatile unsigned __int64 NumberOfLockedPages;
  /* 0x0378 */ void* Win32Process;
  /* 0x0380 */ struct _EJOB* volatile Job;
  /* 0x0388 */ void* SectionObject;
  /* 0x0390 */ void* SectionBaseAddress;
  /* 0x0398 */ unsigned long Cookie;
  /* 0x039c */ long Padding_137;
  /* 0x03a0 */ struct _PAGEFAULT_HISTORY* WorkingSetWatch;
  /* 0x03a8 */ void* Win32WindowStation;
  /* 0x03b0 */ void* InheritedFromUniqueProcessId;
  /* 0x03b8 */ volatile unsigned __int64 OwnerProcessId;
  /* 0x03c0 */ struct _PEB* Peb;
  /* 0x03c8 */ struct _MM_SESSION_SPACE* Session;
  /* 0x03d0 */ void* Spare1;
  /* 0x03d8 */ struct _EPROCESS_QUOTA_BLOCK* QuotaBlock;
  /* 0x03e0 */ struct _HANDLE_TABLE* ObjectTable;
  /* 0x03e8 */ void* DebugPort;
  /* 0x03f0 */ struct _EWOW64PROCESS* WoW64Process;
  /* 0x03f8 */ void* DeviceMap;
  /* 0x0400 */ void* EtwDataSource;
  /* 0x0408 */ unsigned __int64 PageDirectoryPte;
  /* 0x0410 */ struct _FILE_OBJECT* ImageFilePointer;
  /* 0x0418 */ unsigned char ImageFileName[15];
  /* 0x0427 */ unsigned char PriorityClass;
  /* 0x0428 */ void* SecurityPort;
  /* 0x0430 */ struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo;
  /* 0x0438 */ struct _LIST_ENTRY JobLinks;
  /* 0x0448 */ void* HighestUserAddress;
  /* 0x0450 */ struct _LIST_ENTRY ThreadListHead;
  /* 0x0460 */ volatile unsigned long ActiveThreads;
  /* 0x0464 */ unsigned long ImagePathHash;
  /* 0x0468 */ unsigned long DefaultHardErrorProcessing;
  /* 0x046c */ long LastThreadExitStatus;
  /* 0x0470 */ struct _EX_FAST_REF PrefetchTrace;
  /* 0x0478 */ void* LockedPagesList;
  /* 0x0480 */ union _LARGE_INTEGER ReadOperationCount;
  /* 0x0488 */ union _LARGE_INTEGER WriteOperationCount;
  /* 0x0490 */ union _LARGE_INTEGER OtherOperationCount;
  /* 0x0498 */ union _LARGE_INTEGER ReadTransferCount;
  /* 0x04a0 */ union _LARGE_INTEGER WriteTransferCount;
  /* 0x04a8 */ union _LARGE_INTEGER OtherTransferCount;
  /* 0x04b0 */ unsigned __int64 CommitChargeLimit;
  /* 0x04b8 */ volatile unsigned __int64 CommitCharge;
  /* 0x04c0 */ volatile unsigned __int64 CommitChargePeak;
  /* 0x04c8 */ long Padding_138[14];
  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0914 */ unsigned long CetUserShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
...
typedef struct _ETHREAD
{
  ...
  /* 0x0630 */ union _LARGE_INTEGER CreateTime;
  union
  {
    /* 0x0638 */ union _LARGE_INTEGER ExitTime;
    /* 0x0638 */ struct _LIST_ENTRY KeyedWaitChain;
  }; /* size: 0x0010 */
  union
  {
    /* 0x0648 */ struct _LIST_ENTRY PostBlockList;
    struct
    {
      /* 0x0648 */ void* ForwardLinkShadow;
      /* 0x0650 */ void* StartAddress;
    }; /* size: 0x0010 */
  }; /* size: 0x0010 */
  union
  {
    /* 0x0658 */ struct _TERMINATION_PORT* TerminationPort;
    /* 0x0658 */ struct _ETHREAD* ReaperLink;
    /* 0x0658 */ void* KeyedWaitValue;
  }; /* size: 0x0008 */
  /* 0x0660 */ unsigned __int64 ActiveTimerListLock;
  /* 0x0668 */ struct _LIST_ENTRY ActiveTimerListHead;
  /* 0x0678 */ struct _CLIENT_ID Cid;
  union
  {
    /* 0x0688 */ struct _KSEMAPHORE KeyedWaitSemaphore;
    /* 0x0688 */ struct _KSEMAPHORE AlpcWaitSemaphore;
  }; /* size: 0x0020 */
  /* 0x06a8 */ union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;
  /* 0x06b0 */ struct _LIST_ENTRY IrpList;
  /* 0x06c0 */ unsigned __int64 TopLevelIrp;
  /* 0x06c8 */ struct _DEVICE_OBJECT* DeviceToVerify;
  /* 0x06d0 */ void* Win32StartAddress;
  /* 0x06d8 */ void* ChargeOnlySession;
  /* 0x06e0 */ void* LegacyPowerObject;
  /* 0x06e8 */ struct _LIST_ENTRY ThreadListEntry;
  /* 0x06f8 */ struct _EX_RUNDOWN_REF RundownProtect;
  /* 0x0700 */ struct _EX_PUSH_LOCK ThreadLock;
  /* 0x0708 */ unsigned long ReadClusterSize;
  /* 0x070c */ volatile long MmLockOrdering;
  union
  {
    /* 0x0710 */ unsigned long CrossThreadFlags;
    struct /* bitfield */
    {
      /* 0x0710 */ unsigned long Terminated : 1; /* bit position: 0 */
      /* 0x0710 */ unsigned long ThreadInserted : 1; /* bit position: 1 */
      /* 0x0710 */ unsigned long HideFromDebugger : 1; /* bit position: 2 */
      /* 0x0710 */ unsigned long ActiveImpersonationInfo : 1; /* bit position: 3 */
      /* 0x0710 */ unsigned long HardErrorsAreDisabled : 1; /* bit position: 4 */
      /* 0x0710 */ unsigned long BreakOnTermination : 1; /* bit position: 5 */
      /* 0x0710 */ unsigned long SkipCreationMsg : 1; /* bit position: 6 */
      /* 0x0710 */ unsigned long SkipTerminationMsg : 1; /* bit position: 7 */
      /* 0x0710 */ unsigned long CopyTokenOnOpen : 1; /* bit position: 8 */
      /* 0x0710 */ unsigned long ThreadIoPriority : 3; /* bit position: 9 */
      /* 0x0710 */ unsigned long ThreadPagePriority : 3; /* bit position: 12 */
      /* 0x0710 */ unsigned long RundownFail : 1; /* bit position: 15 */
      /* 0x0710 */ unsigned long UmsForceQueueTermination : 1; /* bit position: 16 */
      /* 0x0710 */ unsigned long IndirectCpuSets : 1; /* bit position: 17 */
      /* 0x0710 */ unsigned long DisableDynamicCodeOptOut : 1; /* bit position: 18 */
      /* 0x0710 */ unsigned long ExplicitCaseSensitivity : 1; /* bit position: 19 */
      /* 0x0710 */ unsigned long PicoNotifyExit : 1; /* bit position: 20 */
      /* 0x0710 */ unsigned long DbgWerUserReportActive : 1; /* bit position: 21 */
      /* 0x0710 */ unsigned long ForcedSelfTrimActive : 1; /* bit position: 22 */
      /* 0x0710 */ unsigned long SamplingCoverage : 1; /* bit position: 23 */
      /* 0x0710 */ unsigned long ReservedCrossThreadFlags : 8; /* bit position: 24 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0714 */ unsigned long SameThreadPassiveFlags;
    struct /* bitfield */
    {
      /* 0x0714 */ unsigned long ActiveExWorker : 1; /* bit position: 0 */
      /* 0x0714 */ unsigned long MemoryMaker : 1; /* bit position: 1 */
      /* 0x0714 */ unsigned long StoreLockThread : 2; /* bit position: 2 */
      /* 0x0714 */ unsigned long ClonedThread : 1; /* bit position: 4 */
      /* 0x0714 */ unsigned long KeyedEventInUse : 1; /* bit position: 5 */
      /* 0x0714 */ unsigned long SelfTerminate : 1; /* bit position: 6 */
      /* 0x0714 */ unsigned long RespectIoPriority : 1; /* bit position: 7 */
      /* 0x0714 */ unsigned long ActivePageLists : 1; /* bit position: 8 */
      /* 0x0714 */ unsigned long SecureContext : 1; /* bit position: 9 */
      /* 0x0714 */ unsigned long ZeroPageThread : 1; /* bit position: 10 */
      /* 0x0714 */ unsigned long WorkloadClass : 1; /* bit position: 11 */
      /* 0x0714 */ unsigned long ReservedSameThreadPassiveFlags : 20; /* bit position: 12 */
    }; /* bitfield */
  }; /* size: 0x0004 */
  union
  {
    /* 0x0718 */ unsigned long SameThreadApcFlags;
    struct
    {
      struct /* bitfield */
      {
        /* 0x0718 */ unsigned char OwnsProcessAddressSpaceExclusive : 1; /* bit position: 0 */
        /* 0x0718 */ unsigned char OwnsProcessAddressSpaceShared : 1; /* bit position: 1 */
        /* 0x0718 */ unsigned char HardFaultBehavior : 1; /* bit position: 2 */
        /* 0x0718 */ volatile unsigned char StartAddressInvalid : 1; /* bit position: 3 */
        /* 0x0718 */ unsigned char EtwCalloutActive : 1; /* bit position: 4 */
        /* 0x0718 */ unsigned char SuppressSymbolLoad : 1; /* bit position: 5 */
        /* 0x0718 */ unsigned char Prefetching : 1; /* bit position: 6 */
        /* 0x0718 */ unsigned char OwnsVadExclusive : 1; /* bit position: 7 */
      }; /* bitfield */
      struct /* bitfield */
      {
        /* 0x0719 */ unsigned char SystemPagePriorityActive : 1; /* bit position: 0 */
        /* 0x0719 */ unsigned char SystemPagePriority : 3; /* bit position: 1 */
        /* 0x0719 */ unsigned char AllowUserWritesToExecutableMemory : 1; /* bit position: 4 */
        /* 0x0719 */ unsigned char AllowKernelWritesToExecutableMemory : 1; /* bit position: 5 */
        /* 0x0719 */ unsigned char OwnsVadShared : 1; /* bit position: 6 */
      }; /* bitfield */
    }; /* size: 0x0002 */
  }; /* size: 0x0004 */
  /* 0x071c */ unsigned char CacheManagerActive;
  /* 0x071d */ unsigned char DisablePageFaultClustering;
  /* 0x071e */ unsigned char ActiveFaultCount;
  /* 0x071f */ unsigned char LockOrderState;
  /* 0x0720 */ unsigned __int64 AlpcMessageId;
  union
  {
    /* 0x0728 */ void* AlpcMessage;
    /* 0x0728 */ unsigned long AlpcReceiveAttributeSet;
  }; /* size: 0x0008 */
  /* 0x0730 */ struct _LIST_ENTRY AlpcWaitListEntry;
  /* 0x0740 */ long ExitStatus;
  /* 0x0744 */ unsigned long CacheManagerCount;
  /* 0x0748 */ unsigned long IoBoostCount;
  /* 0x074c */ unsigned long IoQoSBoostCount;
  /* 0x0750 */ unsigned long IoQoSThrottleCount;
  /* 0x0754 */ unsigned long KernelStackReference;
  /* 0x0758 */ struct _LIST_ENTRY BoostList;
  /* 0x0768 */ struct _LIST_ENTRY DeboostList;
  /* 0x0778 */ unsigned __int64 BoostListLock;
  /* 0x0780 */ unsigned __int64 IrpListLock;
  /* 0x0788 */ void* ReservedForSynchTracking;
  /* 0x0790 */ struct _SINGLE_LIST_ENTRY CmCallbackListHead;
  /* 0x0798 */ const struct _GUID* ActivityId;
  /* 0x07a0 */ struct _SINGLE_LIST_ENTRY SeLearningModeListHead;
  /* 0x07a8 */ void* VerifierContext;
  /* 0x07b0 */ void* AdjustedClientToken;
  /* 0x07b8 */ void* WorkOnBehalfThread;
  /* 0x07c0 */ struct _PS_PROPERTY_SET PropertySet;
  /* 0x07d8 */ void* PicoContext;
  /* 0x07e0 */ unsigned __int64 UserRoBase;
  /* 0x07e8 */ unsigned __int64 UserRwBase;
  /* 0x07f0 */ struct _THREAD_ENERGY_VALUES* EnergyValues;
  /* 0x07f8 */ void* CmDbgInfo;
  union
  {
    /* 0x0800 */ unsigned __int64 SelectedCpuSets;
    /* 0x0800 */ unsigned __int64* SelectedCpuSetsIndirect;
  }; /* size: 0x0008 */
  /* 0x0808 */ struct _EJOB* Silo;
  /* 0x0810 */ struct _UNICODE_STRING* ThreadName;
  /* 0x0818 */ unsigned long LastExpectedRunTime;
  /* 0x081c */ unsigned long HeapData;
  /* 0x0820 */ struct _LIST_ENTRY OwnerEntryListHead;
  /* 0x0830 */ unsigned __int64 DisownedOwnerEntryListLock;
  /* 0x0838 */ struct _LIST_ENTRY DisownedOwnerEntryListHead;
} ETHREAD, *PETHREAD; /* size: 0x0848 */
...
typedef struct _EJOB
{
  ...
  /* 0x05f0 */ unsigned __int64 SiloHardReferenceCount;
...
typedef struct _HEAP_FAILURE_INFORMATION
{
  ...
  /* 0x015a */ char Padding_224[6];
  /* 0x0160 */ struct _EXCEPTION_RECORD ExceptionRecord;
  /* 0x01f8 */ long Padding_225[2];
