...
} FAULT_INFORMATION_ARM64, *PFAULT_INFORMATION_ARM64; /* size: 0x0018 */

typedef struct _FAULT_INFORMATION
{
  /* 0x0000 */ enum _FAULT_INFORMATION_ARCH Type;
  /* 0x0004 */ struct _FAULT_INFORMATION_ARM64 Arm64;
} FAULT_INFORMATION, *PFAULT_INFORMATION; /* size: 0x001c */
