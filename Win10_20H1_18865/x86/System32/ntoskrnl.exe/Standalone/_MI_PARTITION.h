...
typedef struct _MI_PARTITION
{
  ...
  /* 0x0f80 */ struct _MI_PARTITION_ZEROING Zeroing;
  /* 0x0fc0 */ struct _MI_PAGE_COMBINING_SUPPORT PageCombine;
  /* 0x10a0 */ void* WorkingSetControl;
  /* 0x10a4 */ struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;
  /* 0x10ac */ unsigned long SessionDetachTimeStamp;
