  ...
  union
  {
    ...
    struct
    {
      struct /* bitfield */
      {
        ...
        /* 0x0854 */ unsigned long CetUserShadowStacks : 1; /* bit position: 14 */
      }; /* bitfield */
